...
export class DrawPath extends GraphicsPrimitive {
    ...
    static locate(paramarg0: SurfaceType, paramarg1: CompositeType, paramarg2: SurfaceType): DrawPath;
    ...
    DrawPath(arg0: SunGraphics2D, arg1: SurfaceData, arg2: number, arg3: number, arg4: Path2D$Float): void;
