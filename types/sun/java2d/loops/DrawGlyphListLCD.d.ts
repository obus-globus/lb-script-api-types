...
export class DrawGlyphListLCD extends GraphicsPrimitive {
    ...
    static locate(paramarg0: SurfaceType, paramarg1: CompositeType, paramarg2: SurfaceType): DrawGlyphListLCD;
    ...
    DrawGlyphListLCD(arg0: SunGraphics2D, arg1: SurfaceData, arg2: GlyphList, arg3: number, arg4: number): void;
