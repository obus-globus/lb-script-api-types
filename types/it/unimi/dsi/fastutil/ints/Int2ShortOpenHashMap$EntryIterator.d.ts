...
export class Int2ShortOpenHashMap$EntryIterator extends Int2ShortOpenHashMap$MapIterator<(param0: Int2ShortMap$Entry) => void> implements ObjectIterator<Int2ShortMap$Entry> {
    private constructor(null_: Int2ShortOpenHashMap$EntryIterator)
