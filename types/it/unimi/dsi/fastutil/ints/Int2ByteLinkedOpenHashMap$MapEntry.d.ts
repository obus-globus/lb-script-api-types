...
export class Int2ByteLinkedOpenHashMap$MapEntry extends Object implements Int2ByteMap$Entry, IntBytePair, Map$Entry<number, number> {
    ...
    constructor(null_: Int2ByteLinkedOpenHashMap$MapEntry)
    constructor(null_: Int2ByteLinkedOpenHashMap$MapEntry, arg1: number)
