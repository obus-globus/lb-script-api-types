...
export class Int2ByteOpenHashMap$KeyIterator extends Int2ByteOpenHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Int2ByteOpenHashMap$KeyIterator)
