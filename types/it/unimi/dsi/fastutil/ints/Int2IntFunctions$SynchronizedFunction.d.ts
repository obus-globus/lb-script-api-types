...
export class Int2IntFunctions$SynchronizedFunction extends Object implements Int2IntFunction, Serializable {
    static identity(): (param0: number) => kotlin.Int;
    constructor(arg0: (param0: number) => kotlin.Int)
    constructor(arg0: (param0: number) => kotlin.Int, arg1: Object)
    ...
    composeByte(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Int;
    composeChar(arg0: (param0: string) => kotlin.Int): (param0: string) => kotlin.Int;
    composeDouble(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Int;
    composeFloat(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Int;
    composeInt(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Int;
    composeLong(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Int;
    composeObject(arg0: (param0: T) => kotlin.Int): (param0: T) => kotlin.Int;
    composeReference(arg0: (param0: T) => kotlin.Int): (param0: T) => kotlin.Int;
    composeShort(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Int;
