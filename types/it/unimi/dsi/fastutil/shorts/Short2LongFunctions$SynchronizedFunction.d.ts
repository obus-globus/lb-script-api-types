...
export class Short2LongFunctions$SynchronizedFunction extends Object implements Short2LongFunction, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Short): (param0: number) => kotlin.Long;
    composeChar(arg0: (param0: string) => kotlin.Short): (param0: string) => kotlin.Long;
    composeDouble(arg0: (param0: number) => kotlin.Short): (param0: number) => kotlin.Long;
    composeFloat(arg0: (param0: number) => kotlin.Short): (param0: number) => kotlin.Long;
    composeInt(arg0: (param0: number) => kotlin.Short): (param0: number) => kotlin.Long;
    composeLong(arg0: (param0: number) => kotlin.Short): (param0: number) => kotlin.Long;
    composeObject(arg0: (param0: T) => kotlin.Short): (param0: T) => kotlin.Long;
    composeReference(arg0: (param0: T) => kotlin.Short): (param0: T) => kotlin.Long;
    composeShort(arg0: (param0: number) => kotlin.Short): (param0: number) => kotlin.Long;
