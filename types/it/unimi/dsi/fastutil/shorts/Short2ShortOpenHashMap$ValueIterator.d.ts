...
export class Short2ShortOpenHashMap$ValueIterator extends Short2ShortOpenHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Short2ShortOpenHashMap$ValueIterator)
