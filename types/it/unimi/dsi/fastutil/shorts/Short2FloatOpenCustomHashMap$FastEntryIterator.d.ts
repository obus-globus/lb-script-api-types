...
export class Short2FloatOpenCustomHashMap$FastEntryIterator extends Short2FloatOpenCustomHashMap$MapIterator<(param0: Short2FloatMap$Entry) => void> implements ObjectIterator<Short2FloatMap$Entry> {
    private constructor(null_: Short2FloatOpenCustomHashMap$FastEntryIterator)
