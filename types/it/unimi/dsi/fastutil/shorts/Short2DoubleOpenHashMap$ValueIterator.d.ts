...
export class Short2DoubleOpenHashMap$ValueIterator extends Short2DoubleOpenHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Short2DoubleOpenHashMap$ValueIterator)
