...
export class Short2BooleanOpenCustomHashMap$KeyIterator extends Short2BooleanOpenCustomHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Short2BooleanOpenCustomHashMap$KeyIterator)
