...
export class Short2BooleanOpenHashMap$KeyIterator extends Short2BooleanOpenHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Short2BooleanOpenHashMap$KeyIterator)
