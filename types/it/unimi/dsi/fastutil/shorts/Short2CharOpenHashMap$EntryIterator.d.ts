...
export class Short2CharOpenHashMap$EntryIterator extends Short2CharOpenHashMap$MapIterator<(param0: Short2CharMap$Entry) => void> implements ObjectIterator<Short2CharMap$Entry> {
    private constructor(null_: Short2CharOpenHashMap$EntryIterator)
