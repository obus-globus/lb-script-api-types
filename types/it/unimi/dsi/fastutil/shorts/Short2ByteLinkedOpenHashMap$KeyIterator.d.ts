...
export class Short2ByteLinkedOpenHashMap$KeyIterator extends Short2ByteLinkedOpenHashMap$MapIterator<(param0: number) => void> implements ShortListIterator {
    constructor(null_: Short2ByteLinkedOpenHashMap$KeyIterator)
