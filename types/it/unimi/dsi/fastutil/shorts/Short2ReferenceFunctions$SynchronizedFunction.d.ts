...
export class Short2ReferenceFunctions$SynchronizedFunction<V extends Object | number | string | boolean> extends Object implements Short2ReferenceFunction<V>, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Short): (param0: V) => unknown;
    composeChar(arg0: (param0: string) => kotlin.Short): (param0: V) => unknown;
    composeDouble(arg0: (param0: number) => kotlin.Short): (param0: V) => unknown;
    composeFloat(arg0: (param0: number) => kotlin.Short): (param0: V) => unknown;
    composeInt(arg0: (param0: number) => kotlin.Short): (param0: V) => unknown;
    composeLong(arg0: (param0: number) => kotlin.Short): (param0: V) => unknown;
    composeObject(arg0: (param0: T) => kotlin.Short): (param0: T) => V;
    composeReference(arg0: (param0: T) => kotlin.Short): (param0: T) => V;
    composeShort(arg0: (param0: number) => kotlin.Short): (param0: V) => unknown;
