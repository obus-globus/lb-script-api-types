...
export class Short2BooleanOpenHashMap$EntryIterator extends Short2BooleanOpenHashMap$MapIterator<(param0: Short2BooleanMap$Entry) => void> implements ObjectIterator<Short2BooleanMap$Entry> {
    private constructor(null_: Short2BooleanOpenHashMap$EntryIterator)
