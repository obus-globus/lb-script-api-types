...
export class Short2ReferenceAVLTreeMap$Entry<V extends Object | number | string | boolean> extends AbstractShort2ReferenceMap$BasicEntry<V> implements Cloneable {
    constructor()
