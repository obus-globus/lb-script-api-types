...
export class Short2IntOpenCustomHashMap$EntryIterator extends Short2IntOpenCustomHashMap$MapIterator<(param0: Short2IntMap$Entry) => void> implements ObjectIterator<Short2IntMap$Entry> {
    private constructor(null_: Short2IntOpenCustomHashMap$EntryIterator)
