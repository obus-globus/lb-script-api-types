...
export class Short2FloatOpenHashMap$MapEntry extends Object implements Short2FloatMap$Entry, ShortFloatPair, Map$Entry<number, number> {
    ...
    constructor(null_: Short2FloatOpenHashMap$MapEntry)
    constructor(null_: Short2FloatOpenHashMap$MapEntry, arg1: number)
