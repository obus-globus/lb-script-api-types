...
export class Long2FloatOpenHashMap$EntryIterator extends Long2FloatOpenHashMap$MapIterator<(param0: Long2FloatMap$Entry) => void> implements ObjectIterator<Long2FloatMap$Entry> {
    private constructor(null_: Long2FloatOpenHashMap$EntryIterator)
