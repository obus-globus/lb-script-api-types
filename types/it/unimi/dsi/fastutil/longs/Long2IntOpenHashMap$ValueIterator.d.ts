...
export class Long2IntOpenHashMap$ValueIterator extends Long2IntOpenHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Long2IntOpenHashMap$ValueIterator)
