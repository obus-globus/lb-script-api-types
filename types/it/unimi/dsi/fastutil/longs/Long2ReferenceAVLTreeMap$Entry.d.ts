...
export class Long2ReferenceAVLTreeMap$Entry<V extends Object | number | string | boolean> extends AbstractLong2ReferenceMap$BasicEntry<V> implements Cloneable {
    constructor()
