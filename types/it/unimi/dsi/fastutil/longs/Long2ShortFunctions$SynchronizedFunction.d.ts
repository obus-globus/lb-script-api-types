...
export class Long2ShortFunctions$SynchronizedFunction extends Object implements Long2ShortFunction, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Short;
    composeChar(arg0: (param0: string) => kotlin.Long): (param0: string) => kotlin.Short;
    composeDouble(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Short;
    composeFloat(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Short;
    composeInt(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Short;
    composeLong(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Short;
    composeObject(arg0: (param0: T) => kotlin.Long): (param0: T) => kotlin.Short;
    composeReference(arg0: (param0: T) => kotlin.Long): (param0: T) => kotlin.Short;
    composeShort(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Short;
