...
export class Long2LongOpenHashMap$ValueIterator extends Long2LongOpenHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Long2LongOpenHashMap$ValueIterator)
