...
export class Char2ByteOpenCustomHashMap$EntryIterator extends Char2ByteOpenCustomHashMap$MapIterator<(param0: Char2ByteMap$Entry) => void> implements ObjectIterator<Char2ByteMap$Entry> {
    private constructor(null_: Char2ByteOpenCustomHashMap$EntryIterator)
