...
export class Char2DoubleLinkedOpenHashMap$EntryIterator extends Char2DoubleLinkedOpenHashMap$MapIterator<(param0: Char2DoubleMap$Entry) => void> implements ObjectListIterator<Char2DoubleMap$Entry> {
    constructor(null_: Char2DoubleLinkedOpenHashMap$EntryIterator)
    constructor(null_: Char2DoubleLinkedOpenHashMap$EntryIterator, arg1: string)
