...
export class CharSpliterators extends Object {
    ...
    static asCharSpliterator(paramarg0: Spliterator<Object>, paramarg1: (param0: string, param1: string) => kotlin.Int): CharSpliterator;
    ...
    static asSpliteratorFromSorted(paramarg0: CharIterator, paramarg1: number, paramarg2: number, paramarg3: (param0: string, param1: string) => kotlin.Int): CharSpliterator;
    static asSpliteratorFromSortedUnknownSize(paramarg0: CharIterator, paramarg1: number, paramarg2: (param0: string, param1: string) => kotlin.Int): CharSpliterator;
    ...
    static onEachMatching(paramarg0: CharSpliterator, paramarg1: (param0: string) => kotlin.Boolean, paramarg2: (param0: string) => void): void;
    static onEachMatching(paramarg0: CharSpliterator, paramarg1: (param0: number) => kotlin.Boolean, paramarg2: (param0: number) => void): void;
    static singleton(paramarg0: string): CharSpliterator;
    static singleton(paramarg0: string, paramarg1: (param0: string, param1: string) => kotlin.Int): CharSpliterator;
    ...
    static wrapPreSorted(paramarg0: string[], paramarg1: number, paramarg2: number, paramarg3: number, paramarg4: (param0: string, param1: string) => kotlin.Int): CharSpliterator;
    static wrapPreSorted(paramarg0: string[], paramarg1: number, paramarg2: number, paramarg3: (param0: string, param1: string) => kotlin.Int): CharSpliterator;
    static wrapPreSorted(paramarg0: string[], paramarg1: (param0: string, param1: string) => kotlin.Int): CharSpliterator;
    private constructor()
}