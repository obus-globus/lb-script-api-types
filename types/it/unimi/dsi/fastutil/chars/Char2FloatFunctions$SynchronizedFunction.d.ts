...
export class Char2FloatFunctions$SynchronizedFunction extends Object implements Char2FloatFunction, Serializable {
    constructor(arg0: (param0: string) => kotlin.Float)
    constructor(arg0: (param0: string) => kotlin.Float, arg1: Object)
