...
export class Char2DoubleOpenCustomHashMap$KeyIterator extends Char2DoubleOpenCustomHashMap$MapIterator<(param0: string) => void> implements CharIterator {
    constructor(null_: Char2DoubleOpenCustomHashMap$KeyIterator)
