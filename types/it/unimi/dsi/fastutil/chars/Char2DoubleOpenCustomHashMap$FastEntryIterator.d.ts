...
export class Char2DoubleOpenCustomHashMap$FastEntryIterator extends Char2DoubleOpenCustomHashMap$MapIterator<(param0: Char2DoubleMap$Entry) => void> implements ObjectIterator<Char2DoubleMap$Entry> {
    private constructor(null_: Char2DoubleOpenCustomHashMap$FastEntryIterator)
