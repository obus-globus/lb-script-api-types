...
export class Char2LongOpenHashMap$KeyIterator extends Char2LongOpenHashMap$MapIterator<(param0: string) => void> implements CharIterator {
    constructor(null_: Char2LongOpenHashMap$KeyIterator)
