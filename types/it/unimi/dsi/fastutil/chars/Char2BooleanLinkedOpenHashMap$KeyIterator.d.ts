...
export class Char2BooleanLinkedOpenHashMap$KeyIterator extends Char2BooleanLinkedOpenHashMap$MapIterator<(param0: string) => void> implements CharListIterator {
    constructor(null_: Char2BooleanLinkedOpenHashMap$KeyIterator)
