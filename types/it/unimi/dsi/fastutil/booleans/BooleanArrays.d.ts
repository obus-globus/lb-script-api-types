...
export class BooleanArrays extends Object {
    ...
    static mergeSort(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: (param0: boolean, param1: boolean) => kotlin.Int): void;
    static mergeSort(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: (param0: boolean, param1: boolean) => kotlin.Int, paramarg4: (Object | null)[]): void;
    static mergeSort(paramarg0: (Object | null)[], paramarg1: (param0: boolean, param1: boolean) => kotlin.Int): void;
    ...
    static stableSort(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: (param0: boolean, param1: boolean) => kotlin.Int): void;
    static stableSort(paramarg0: (Object | null)[], paramarg1: (param0: boolean, param1: boolean) => kotlin.Int): void;
    ...
    static unstableSort(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: (param0: boolean, param1: boolean) => kotlin.Int): void;
    static unstableSort(paramarg0: (Object | null)[], paramarg1: (param0: boolean, param1: boolean) => kotlin.Int): void;
    private constructor()
}