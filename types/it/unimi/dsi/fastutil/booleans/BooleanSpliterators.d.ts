...
export class BooleanSpliterators extends Object {
    ...
    static asBooleanSpliterator(paramarg0: Spliterator<Object>, paramarg1: (param0: boolean, param1: boolean) => kotlin.Int): BooleanSpliterator;
    ...
    static asSpliteratorFromSorted(paramarg0: BooleanIterator, paramarg1: number, paramarg2: number, paramarg3: (param0: boolean, param1: boolean) => kotlin.Int): BooleanSpliterator;
    static asSpliteratorFromSortedUnknownSize(paramarg0: BooleanIterator, paramarg1: number, paramarg2: (param0: boolean, param1: boolean) => kotlin.Int): BooleanSpliterator;
    ...
    static onEachMatching(paramarg0: BooleanSpliterator, paramarg1: (param0: boolean) => kotlin.Boolean, paramarg2: (param0: boolean) => void): void;
    static singleton(paramarg0: boolean): BooleanSpliterator;
    static singleton(paramarg0: boolean, paramarg1: (param0: boolean, param1: boolean) => kotlin.Int): BooleanSpliterator;
    ...
    static wrapPreSorted(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: number, paramarg4: (param0: boolean, param1: boolean) => kotlin.Int): BooleanSpliterator;
    static wrapPreSorted(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: (param0: boolean, param1: boolean) => kotlin.Int): BooleanSpliterator;
    static wrapPreSorted(paramarg0: (Object | null)[], paramarg1: (param0: boolean, param1: boolean) => kotlin.Int): BooleanSpliterator;
    private constructor()
}