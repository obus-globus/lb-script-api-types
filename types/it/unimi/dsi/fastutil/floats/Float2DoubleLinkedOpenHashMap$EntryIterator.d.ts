...
export class Float2DoubleLinkedOpenHashMap$EntryIterator extends Float2DoubleLinkedOpenHashMap$MapIterator<(param0: Float2DoubleMap$Entry) => void> implements ObjectListIterator<Float2DoubleMap$Entry> {
    constructor(null_: Float2DoubleLinkedOpenHashMap$EntryIterator)
    constructor(null_: Float2DoubleLinkedOpenHashMap$EntryIterator, arg1: number)
