...
export class Float2LongOpenHashMap$FastEntryIterator extends Float2LongOpenHashMap$MapIterator<(param0: Float2LongMap$Entry) => void> implements ObjectIterator<Float2LongMap$Entry> {
    private constructor(null_: Float2LongOpenHashMap$FastEntryIterator)
