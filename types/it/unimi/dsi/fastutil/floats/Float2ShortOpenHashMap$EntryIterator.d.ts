...
export class Float2ShortOpenHashMap$EntryIterator extends Float2ShortOpenHashMap$MapIterator<(param0: Float2ShortMap$Entry) => void> implements ObjectIterator<Float2ShortMap$Entry> {
    private constructor(null_: Float2ShortOpenHashMap$EntryIterator)
