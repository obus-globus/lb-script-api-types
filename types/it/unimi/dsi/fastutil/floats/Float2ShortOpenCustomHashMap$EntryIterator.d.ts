...
export class Float2ShortOpenCustomHashMap$EntryIterator extends Float2ShortOpenCustomHashMap$MapIterator<(param0: Float2ShortMap$Entry) => void> implements ObjectIterator<Float2ShortMap$Entry> {
    private constructor(null_: Float2ShortOpenCustomHashMap$EntryIterator)
