...
export class Float2ByteFunctions$SynchronizedFunction extends Object implements Float2ByteFunction, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Byte;
    composeChar(arg0: (param0: string) => kotlin.Float): (param0: string) => kotlin.Byte;
    composeDouble(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Byte;
    composeFloat(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Byte;
    composeInt(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Byte;
    composeLong(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Byte;
    composeObject(arg0: (param0: T) => kotlin.Float): (param0: T) => kotlin.Byte;
    composeReference(arg0: (param0: T) => kotlin.Float): (param0: T) => kotlin.Byte;
    composeShort(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Byte;
