...
export class Float2ByteOpenHashMap$ValueIterator extends Float2ByteOpenHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Float2ByteOpenHashMap$ValueIterator)
