...
export class Float2IntLinkedOpenHashMap$FastEntryIterator extends Float2IntLinkedOpenHashMap$MapIterator<(param0: Float2IntMap$Entry) => void> implements ObjectListIterator<Float2IntMap$Entry> {
    constructor(null_: Float2IntLinkedOpenHashMap$FastEntryIterator)
    constructor(null_: Float2IntLinkedOpenHashMap$FastEntryIterator, arg1: number)
