...
export class Float2ShortOpenCustomHashMap$KeyIterator extends Float2ShortOpenCustomHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Float2ShortOpenCustomHashMap$KeyIterator)
