...
export class Float2IntFunctions$SynchronizedFunction extends Object implements Float2IntFunction, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Int;
    composeChar(arg0: (param0: string) => kotlin.Float): (param0: string) => kotlin.Int;
    composeDouble(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Int;
    composeFloat(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Int;
    composeInt(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Int;
    composeLong(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Int;
    composeObject(arg0: (param0: T) => kotlin.Float): (param0: T) => kotlin.Int;
    composeReference(arg0: (param0: T) => kotlin.Float): (param0: T) => kotlin.Int;
    composeShort(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Int;
