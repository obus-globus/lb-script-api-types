...
export class Float2BooleanOpenHashMap$KeyIterator extends Float2BooleanOpenHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Float2BooleanOpenHashMap$KeyIterator)
