...
export class Float2DoubleOpenHashMap$MapEntry extends Object implements Float2DoubleMap$Entry, FloatDoublePair, Map$Entry<number, number> {
    ...
    constructor(null_: Float2DoubleOpenHashMap$MapEntry)
    constructor(null_: Float2DoubleOpenHashMap$MapEntry, arg1: number)
