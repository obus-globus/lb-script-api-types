...
export class Float2FloatOpenHashMap$KeyIterator extends Float2FloatOpenHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Float2FloatOpenHashMap$KeyIterator)
