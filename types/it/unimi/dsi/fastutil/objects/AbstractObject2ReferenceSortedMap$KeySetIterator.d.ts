...
export class AbstractObject2ReferenceSortedMap$KeySetIterator<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends Object implements ObjectBidirectionalIterator<K> {
