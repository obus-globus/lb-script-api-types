...
export abstract class Reference2ReferenceLinkedOpenHashMap$MapIterator<ConsumerType extends Object | number | string | boolean> extends Object {
    private constructor(null_: Reference2ReferenceLinkedOpenHashMap$MapIterator<Object>)
    constructor(null_: Reference2ReferenceLinkedOpenHashMap$MapIterator<Object>)
    // private curr: number;
