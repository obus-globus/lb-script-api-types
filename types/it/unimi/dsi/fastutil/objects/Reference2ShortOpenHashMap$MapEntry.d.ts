...
export class Reference2ShortOpenHashMap$MapEntry extends Object implements Reference2ShortMap$Entry<K>, ReferenceShortPair<K>, Map$Entry<K, number> {
    ...
    constructor(null_: Reference2ShortOpenHashMap$MapEntry)
