...
export class Byte2LongOpenHashMap$FastEntryIterator extends Byte2LongOpenHashMap$MapIterator<(param0: Byte2LongMap$Entry) => void> implements ObjectIterator<Byte2LongMap$Entry> {
    private constructor(null_: Byte2LongOpenHashMap$FastEntryIterator)
