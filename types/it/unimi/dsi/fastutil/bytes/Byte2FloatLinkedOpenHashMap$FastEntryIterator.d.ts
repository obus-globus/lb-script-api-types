...
export class Byte2FloatLinkedOpenHashMap$FastEntryIterator extends Byte2FloatLinkedOpenHashMap$MapIterator<(param0: Byte2FloatMap$Entry) => void> implements ObjectListIterator<Byte2FloatMap$Entry> {
    constructor(null_: Byte2FloatLinkedOpenHashMap$FastEntryIterator)
    constructor(null_: Byte2FloatLinkedOpenHashMap$FastEntryIterator, arg1: number)
