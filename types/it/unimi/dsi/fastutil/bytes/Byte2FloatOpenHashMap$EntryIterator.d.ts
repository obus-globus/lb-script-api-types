...
export class Byte2FloatOpenHashMap$EntryIterator extends Byte2FloatOpenHashMap$MapIterator<(param0: Byte2FloatMap$Entry) => void> implements ObjectIterator<Byte2FloatMap$Entry> {
    private constructor(null_: Byte2FloatOpenHashMap$EntryIterator)
