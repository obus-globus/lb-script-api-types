...
export class Byte2ReferenceAVLTreeMap$Entry<V extends Object | number | string | boolean> extends AbstractByte2ReferenceMap$BasicEntry<V> implements Cloneable {
    constructor()
