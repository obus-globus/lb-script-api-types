...
export class Byte2CharOpenHashMap$KeyIterator extends Byte2CharOpenHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2CharOpenHashMap$KeyIterator)
