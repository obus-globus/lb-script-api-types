...
export class Byte2CharOpenCustomHashMap$KeyIterator extends Byte2CharOpenCustomHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2CharOpenCustomHashMap$KeyIterator)
