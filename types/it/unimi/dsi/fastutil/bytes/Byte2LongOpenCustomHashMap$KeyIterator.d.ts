...
export class Byte2LongOpenCustomHashMap$KeyIterator extends Byte2LongOpenCustomHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2LongOpenCustomHashMap$KeyIterator)
