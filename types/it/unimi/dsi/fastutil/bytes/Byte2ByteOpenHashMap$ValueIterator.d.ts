...
export class Byte2ByteOpenHashMap$ValueIterator extends Byte2ByteOpenHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2ByteOpenHashMap$ValueIterator)
