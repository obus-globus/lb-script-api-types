...
export class Double2LongOpenCustomHashMap$KeyIterator extends Double2LongOpenCustomHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2LongOpenCustomHashMap$KeyIterator)
