...
export class Double2FloatOpenHashMap$EntryIterator extends Double2FloatOpenHashMap$MapIterator<(param0: Double2FloatMap$Entry) => void> implements ObjectIterator<Double2FloatMap$Entry> {
    private constructor(null_: Double2FloatOpenHashMap$EntryIterator)
