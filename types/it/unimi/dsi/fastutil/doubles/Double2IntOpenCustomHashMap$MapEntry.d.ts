...
export class Double2IntOpenCustomHashMap$MapEntry extends Object implements Double2IntMap$Entry, DoubleIntPair, Map$Entry<number, number> {
    static comparingByKey(): (param0: Object | null) => kotlin.Boolean;
    static comparingByKey(paramarg0: (param0: Object | null) => kotlin.Boolean): (param0: Object | null) => kotlin.Boolean;
    static comparingByValue(): (param0: Object | null) => kotlin.Boolean;
    static comparingByValue(paramarg0: (param0: Object | null) => kotlin.Boolean): (param0: Object | null) => kotlin.Boolean;
    static copyOf(paramarg0: Map$Entry<Object, Object>): Map$Entry<Object, Object>;
    static lexComparator(): (param0: DoubleIntPair) => kotlin.Boolean;
    static of(paramarg0: number, paramarg1: number): DoubleIntPair;
    constructor(null_: Double2IntOpenCustomHashMap$MapEntry)
    constructor(null_: Double2IntOpenCustomHashMap$MapEntry, arg1: number)
