...
export class Double2LongOpenHashMap$KeyIterator extends Double2LongOpenHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2LongOpenHashMap$KeyIterator)
