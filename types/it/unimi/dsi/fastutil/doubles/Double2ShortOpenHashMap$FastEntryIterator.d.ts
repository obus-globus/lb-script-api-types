...
export class Double2ShortOpenHashMap$FastEntryIterator extends Double2ShortOpenHashMap$MapIterator<(param0: Double2ShortMap$Entry) => void> implements ObjectIterator<Double2ShortMap$Entry> {
    private constructor(null_: Double2ShortOpenHashMap$FastEntryIterator)
