...
export class Double2ObjectFunctions$SynchronizedFunction<V extends Object | number | string | boolean> extends Object implements Double2ObjectFunction<V>, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Double): (param0: V) => unknown;
    composeChar(arg0: (param0: string) => kotlin.Double): (param0: V) => unknown;
    composeDouble(arg0: (param0: number) => kotlin.Double): (param0: V) => unknown;
    composeFloat(arg0: (param0: number) => kotlin.Double): (param0: V) => unknown;
    composeInt(arg0: (param0: number) => kotlin.Double): (param0: V) => unknown;
    composeLong(arg0: (param0: number) => kotlin.Double): (param0: V) => unknown;
    composeObject(arg0: (param0: T) => kotlin.Double): (param0: T) => V;
    composeReference(arg0: (param0: T) => kotlin.Double): (param0: T) => V;
    composeShort(arg0: (param0: number) => kotlin.Double): (param0: V) => unknown;
