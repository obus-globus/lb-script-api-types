...
export class FormElementCodec extends Object implements JsonDeserializer<FormElement>, JsonSerializer<FormElement> {
    constructor()
    deserialize(arg0: JsonElement, arg1: Type, arg2: JsonDeserializationContext): FormElement;
    serialize(arg0: FormElement, arg1: Type, arg2: JsonSerializationContext): JsonElement;
}