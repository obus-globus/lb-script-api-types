...
export class ExecuteCommand extends Object {
    ...
    static scheduleFunctionConditionsAndTest(paramoriginalSource: Object | null, paramcurrentSources: (Object | null)[], paramfunctionContextModifier: (param0: Object | null) => Object | null, paramcheck: (param0: number) => kotlin.Boolean, paramcurrentStep: ContextChain<Object>, paramparameters: CompoundTag, paramoutput: ExecutionControl<Object>, paramfunctionGetter: (param0: Object | null) => Object | null, parammodifiers: ChainModifiers): void;
    constructor()
}