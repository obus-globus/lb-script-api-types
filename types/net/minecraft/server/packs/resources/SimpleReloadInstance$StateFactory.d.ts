...
export interface SimpleReloadInstance$StateFactory<S extends Object | number | string | boolean> extends Object{
    create(sharedState: PreparableReloadListener$SharedState, previousStep: (param0: Object | null) => java.util.concurrent.CompletableFuture<unknown>, listener: (param0: PreparableReloadListener$SharedState, param1: Executor, param2: (param0: Object | null) => java.util.concurrent.CompletableFuture<unknown>, param3: Executor) => java.util.concurrent.CompletableFuture<java.lang.Void>, taskExecutor: Executor, reloadExecutor: Executor): CompletableFuture<S>;
}