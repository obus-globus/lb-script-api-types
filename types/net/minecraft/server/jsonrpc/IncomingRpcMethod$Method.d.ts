...
export class IncomingRpcMethod$Method<Params extends Object | number | string | boolean, Result extends Object | number | string | boolean> extends Record implements IncomingRpcMethod<Params, Result> {
    ...
    constructor(info: MethodInfo<Params, Result>, attributes: IncomingRpcMethod$Attributes, function_: (param0: Params, param1: Result, param2: MinecraftApi) => unknown)
    // private attributes: IncomingRpcMethod$Attributes;
    // private function: (param0: Params, param1: Result, param2: MinecraftApi) => unknown;
    ...
    function(): (param0: Params, param1: Result, param2: MinecraftApi) => unknown;
    hashCode(): number;
