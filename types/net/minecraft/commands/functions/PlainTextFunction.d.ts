...
export class PlainTextFunction<T extends Object | number | string | boolean> extends Record implements CommandFunction<T>, InstantiatedFunction<T> {
    ...
    constructor(id: Identifier, entries: (param0: T, param1: Object | null, param2: ExecutionContext<Object>) => void[])
    // private entries: (param0: T, param1: Object | null, param2: ExecutionContext<Object>) => void[];
    // private id: Identifier;
    entries(): (param0: T, param1: Object | null, param2: ExecutionContext<Object>) => void[];
