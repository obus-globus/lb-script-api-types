...
export class ComponentPredicateParser$ElementLookupRule<T extends Object | number | string | boolean, C extends Object | number | string | boolean, P extends Object | number | string | boolean> extends ResourceLookupRule<ComponentPredicateParser$Context<T, C, P>, T> {
    ...
    validateElement(reader: ImmutableStringReader, id: Identifier): T;
}