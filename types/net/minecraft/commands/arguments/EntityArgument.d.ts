...
export class EntityArgument extends Object implements ArgumentType<EntitySelector> {
    ...
    static getEntities(paramcontext: CommandContext<CommandSourceStack>, paramname: string): E[];
    static getEntity(paramcontext: CommandContext<CommandSourceStack>, paramname: string): Entity;
    static getOptionalEntities(paramcontext: CommandContext<CommandSourceStack>, paramname: string): E[];
    static getOptionalPlayers(paramcontext: CommandContext<CommandSourceStack>, paramname: string): E[];
    static getPlayer(paramcontext: CommandContext<CommandSourceStack>, paramname: string): ServerPlayer;
    static getPlayers(paramcontext: CommandContext<CommandSourceStack>, paramname: string): E[];
