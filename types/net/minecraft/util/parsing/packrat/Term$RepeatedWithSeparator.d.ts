...
export class Term$RepeatedWithSeparator<S extends Object | number | string | boolean, T extends Object | number | string | boolean> extends Record implements Term<S> {
