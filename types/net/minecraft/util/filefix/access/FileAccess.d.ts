...
export class FileAccess<T extends AutoCloseable> extends Object implements AutoCloseable {
    constructor(fileAccessProvider: FileAccessProvider, type: FileResourceType<T>, fileRelation: (param0: Path[][]) => kotlin.collections.List<java.nio.file.Path>)
    // private fileAccessProvider: FileAccessProvider;
    // private fileRelation: (param0: Path[][]) => kotlin.collections.List<java.nio.file.Path>;
    // private files: T[];
