...
import type { FileToIdConverterAccessor } from '../../../net/fabricmc/fabric/mixin/resource/conditions/FileToIdConverterAccessor.d.ts'
import type { Identifier } from '../../../net/minecraft/resources/Identifier.d.ts'
import type { ResourceKey } from '../../../net/minecraft/resources/ResourceKey.d.ts'
import type { Resource } from '../../../net/minecraft/server/packs/resources/Resource.d.ts'
import type { ResourceManager } from '../../../net/minecraft/server/packs/resources/ResourceManager.d.ts'
export class FileToIdConverter extends Record implements FileToIdConverterAccessor, FileToIdConverterAccessor {
