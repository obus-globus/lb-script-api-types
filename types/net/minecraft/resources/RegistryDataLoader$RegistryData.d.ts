...
export class RegistryDataLoader$RegistryData<T extends Object | number | string | boolean> extends Record {
    ...
    constructor(key: ResourceKey<T[]>, elementCodec: Codec<T>, validator: (param0: T, param1: (Object | null)[]) => void)
    // private elementCodec: Codec<T>;
    // private key: ResourceKey<T[]>;
    // private validator: (param0: T, param1: (Object | null)[]) => void;
    ...
    toString(): string;
    validator(): (param0: T, param1: (Object | null)[]) => void;
}