...
export class ConsumeItemTrigger$TriggerInstance extends Record implements SimpleCriterionTrigger$SimpleInstance {
    ...
    static usedItem(parampredicate: ItemPredicate$Builder): Criterion<ConsumeItemTrigger$TriggerInstance>;
    static usedItem(paramitems: HolderGetter<Item>, paramitem: ItemLike): Criterion<ConsumeItemTrigger$TriggerInstance>;
