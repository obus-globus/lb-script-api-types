...
export class CampfireSmokeParticle extends SingleQuadParticle {
    private constructor(level: ClientLevel, x: number, y: number, z: number, xa: number, ya: number, za: number, isSignalFire: boolean, sprite: TextureAtlasSprite)
