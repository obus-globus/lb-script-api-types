...
export class GustSeedParticle$Provider extends Object implements ParticleProvider<SimpleParticleType> {
    constructor(scale: number, lifetime: number, tickDelayInBetween: number)
