...
export abstract class OverlayRecipeComponent$OverlayRecipeButton extends AbstractWidget {
    ...
    constructor(null_: OverlayRecipeComponent$OverlayRecipeButton, y: number, recipe: RecipeDisplayId, isCraftable: boolean, slots: OverlayRecipeComponent$OverlayRecipeButton$Pos[])
