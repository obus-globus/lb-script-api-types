...
export class ChatComponent$ClickableTextOnlyGraphicsAccess extends Object implements ChatComponent$ChatGraphicsAccess {
    constructor(output: ActiveTextCollector)
    // private output: ActiveTextCollector;
