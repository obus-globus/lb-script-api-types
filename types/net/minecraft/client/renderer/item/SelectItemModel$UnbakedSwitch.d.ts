...
export class SelectItemModel$UnbakedSwitch<P extends SelectItemModelProperty<T>, T extends Object | number | string | boolean> extends Record {
    static MAP_CODEC: MapCodec<Object>;
    ...
    // private createModelGetter(originalModels: Map<T, ItemModel>, registrySwapper: RegistryContextSwapper): (param0: T, param1: Object | null) => net.minecraft.client.renderer.item.ItemModel;
