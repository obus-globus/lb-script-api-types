...
export class BundleSelectedItemSpecialRenderer$Unbaked extends Record implements ItemModel$Unbaked {
    static MAP_CODEC: MapCodec<BundleSelectedItemSpecialRenderer$Unbaked>;
    constructor()
    ...
    toString(): string;
    type(): MapCodec<BundleSelectedItemSpecialRenderer$Unbaked>;
}