...
export class CopperGolemStatueSpecialRenderer extends Object implements NoDataSpecialModelRenderer {
    constructor(model: CopperGolemStatueModel, texture: Identifier)
    // private model: CopperGolemStatueModel;
