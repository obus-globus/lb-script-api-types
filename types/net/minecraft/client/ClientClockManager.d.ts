...
export class ClientClockManager extends Object implements ClockManager {
    constructor()
    // private clocks: Map<Holder<WorldClock>, ClientClockManager$ClockInstance>;
    ...
    handleUpdates(gameTime: number, updates: Map<Holder<WorldClock>, ClockNetworkState>): void;
