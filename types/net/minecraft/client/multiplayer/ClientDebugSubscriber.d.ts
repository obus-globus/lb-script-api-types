...
export class ClientDebugSubscriber extends Object {
    ...
    dropLevel(): void;
    // private forEachValue(subscription: DebugSubscription<V>, type: (param0: K) => V, consumer: (param0: K, param1: V) => void): void;
    // private getValue<V extends Object | number | string | boolean, K extends Object | number | string | boolean>(subscription: DebugSubscription<V>, key: K, type: (param0: K) => V): V;
    // private getValueMap(subscription: DebugSubscription<V>, mapType: (param0: K) => V): ClientDebugSubscriber$ValueMap<K, V>;
    // private getValueMaps(subscription: DebugSubscription<V>): ClientDebugSubscriber$ValueMaps<V>;
    ...
    pushEvent(gameTime: number, event: DebugSubscription$Event<T>): void;
    // private requestedSubscriptions(): DebugSubscription<Object>[];
    tick(gameTime: number): void;
    updateBlock(gameTime: number, blockPos: BlockPos, update: DebugSubscription$Update<T>): void;
    updateChunk(gameTime: number, chunkPos: ChunkPos, update: DebugSubscription$Update<T>): void;
    updateEntity(gameTime: number, entity: Entity, update: DebugSubscription$Update<T>): void;
    // private updateMap<K extends Object | number | string | boolean>(gameTime: number, key: K, update: DebugSubscription$Update<V>, type: (param0: K) => V): void;
}