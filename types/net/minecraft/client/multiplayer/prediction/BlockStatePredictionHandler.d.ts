...
import type { BlockStatePredictionHandler$ServerVerifiedState } from '../../../../../net/minecraft/client/multiplayer/prediction/BlockStatePredictionHandler$ServerVerifiedState.d.ts'
...
export class BlockStatePredictionHandler extends Object implements AutoCloseable {
    ...
    // private serverVerifiedStates: Long2ObjectOpenHashMap<BlockStatePredictionHandler$ServerVerifiedState>;
    close(): void;
