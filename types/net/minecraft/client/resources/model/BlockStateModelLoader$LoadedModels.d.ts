...
export class BlockStateModelLoader$LoadedModels extends Record {
    constructor(models: Map<BlockState, BlockStateModel$UnbakedRoot>)
    // private models: Map<BlockState, BlockStateModel$UnbakedRoot>;
    equals(o: Object | null): boolean;
    hashCode(): number;
    models(): Map<BlockState, BlockStateModel$UnbakedRoot>;
    toString(): string;
}