...
export class GameTestHelper$TestBlockPlaceContext extends BlockPlaceContext {
    ...
    constructor(null_: GameTestHelper$TestBlockPlaceContext, level: Level, hand: InteractionHand, itemStackInHand: ItemStack, hitResult: BlockHitResult, placeDirection: Direction)
