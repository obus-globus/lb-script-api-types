...
export class AttributeType<Value extends Object | number | string | boolean> extends Record {
    static ofInterpolated(paramvalueCodec: Codec<Object>, parammodifierLibrary: { [key in AttributeModifier$OperationId]: Object | null }, paramlerp: LerpFunction<Object>): AttributeType<Object>;
    static ofInterpolated(paramvalueCodec: Codec<Object>, parammodifierLibrary: { [key in AttributeModifier$OperationId]: Object | null }, paramlerp: LerpFunction<Object>, parampartialTickLerp: LerpFunction<Object>, paramtoFloat: (param0: Object | null) => kotlin.Float): AttributeType<Object>;
    static ofNotInterpolated(paramvalueCodec: Codec<Object>): AttributeType<Object>;
    static ofNotInterpolated(paramvalueCodec: Codec<Object>, parammodifierLibrary: { [key in AttributeModifier$OperationId]: Object | null }): AttributeType<Object>;
    constructor(valueCodec: Codec<Value>, modifierLibrary: { [key in AttributeModifier$OperationId]: AttributeModifier<Value, Object> }, modifierCodec: Codec<AttributeModifier<Value, Object>>, keyframeLerp: LerpFunction<Value>, stateChangeLerp: LerpFunction<Value>, spatialLerp: LerpFunction<Value>, partialTickLerp: LerpFunction<Value>, toFloat: (param0: Value) => kotlin.Float)
    ...
    // private toFloat: (param0: Value) => kotlin.Float;
    ...
    toFloat(): (param0: Value) => kotlin.Float;
