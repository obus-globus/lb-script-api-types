...
export class CrafterMenu extends AbstractContainerMenu implements ContainerListener {
    ...
    constructor(containerId: number, inventory: (Object | null)[], container: (Object | null)[], containerData: ContainerData)
    readonly container: (Object | null)[];
    // private containerData: ContainerData;
    // private player: Player;
    // private resultContainer: (Object | null)[];
    // private addSlots(inventory: (Object | null)[]): void;
    dataChanged(container: AbstractContainerMenu, id: number, value: number): void;
    getContainer(): ItemStack[];
    isPowered(): boolean;
    isSlotDisabled(slotId: number): boolean;
    quickMoveStack(player: Player, slotIndex: number): ItemStack;
    // private refreshRecipeResult(): void;
    setSlotState(slotId: number, isEnabled: boolean): void;
