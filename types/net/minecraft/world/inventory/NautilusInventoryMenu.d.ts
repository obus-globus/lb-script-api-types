...
export class NautilusInventoryMenu extends AbstractMountInventoryMenu {
    ...
    constructor(containerId: number, playerInventory: (Object | null)[], nautilusInventory: ItemStack[], nautilus: AbstractNautilus, inventoryColumns: number)
