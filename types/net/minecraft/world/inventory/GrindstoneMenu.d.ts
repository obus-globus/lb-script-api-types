...
export class GrindstoneMenu extends AbstractContainerMenu {
    ...
    // private repairSlots: ItemStack[];
    // private resultSlots: ItemStack[];
    // private computeResult(input: ItemStack, additional: ItemStack): ItemStack;
    // private createResult(): void;
    // private mergeEnchantsFrom(target: ItemStack, source: ItemStack): void;
    // private mergeItems(input: ItemStack, additional: ItemStack): ItemStack;
    quickMoveStack(player: Player, slotIndex: number): ItemStack;
    // private removeNonCursesFrom(item: ItemStack): ItemStack;
