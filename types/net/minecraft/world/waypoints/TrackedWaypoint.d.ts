...
import type { TrackedWaypoint$Type } from '../../../../net/minecraft/world/waypoints/TrackedWaypoint$Type.d.ts'
...
export abstract class TrackedWaypoint extends Object implements Waypoint {
    ...
    private constructor(identifier: Either<UUID, string>, icon: Waypoint$Icon, type: TrackedWaypoint$Type)
    // private icon: Waypoint$Icon;
    // private identifier: Either<UUID, string>;
    // private type: TrackedWaypoint$Type;
