...
export class PlaceOnGroundDecorator extends TreeDecorator {
    static CODEC: Codec<TreeDecorator>;
    static CODEC: MapCodec<PlaceOnGroundDecorator>;
    constructor(tries: number, radius: number, height: number, blockStateProvider: BlockStateProvider)
