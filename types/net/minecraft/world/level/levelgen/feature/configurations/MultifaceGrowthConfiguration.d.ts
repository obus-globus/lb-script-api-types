...
export class MultifaceGrowthConfiguration extends Object implements FeatureConfiguration {
    ...
    constructor(placeBlock: MultifaceSpreadeableBlock, searchRange: number, canPlaceOnFloor: boolean, canPlaceOnCeiling: boolean, canPlaceOnWall: boolean, chanceOfSpreading: number, canBePlacedOn: Holder<T>[])
    canBePlacedOn: Holder<T>[];
    canPlaceOnCeiling: boolean;
    canPlaceOnFloor: boolean;
    canPlaceOnWall: boolean;
    chanceOfSpreading: number;
    placeBlock: MultifaceSpreadeableBlock;
    searchRange: number;
