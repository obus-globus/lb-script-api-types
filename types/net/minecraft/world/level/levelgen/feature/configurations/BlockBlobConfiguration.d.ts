...
export class BlockBlobConfiguration extends Record implements FeatureConfiguration {
    static CODEC: Codec<BlockBlobConfiguration>;
    static NONE: NoneFeatureConfiguration;
    constructor(state: BlockState, canPlaceOn: BlockPredicate)
