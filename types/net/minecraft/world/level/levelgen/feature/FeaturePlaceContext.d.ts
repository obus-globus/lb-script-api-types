...
export class FeaturePlaceContext<FC extends FeatureConfiguration> extends Object {
    constructor(topFeature: Optional<ConfiguredFeature<Object, Object>>, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos, config: FC)
    // private chunkGenerator: ChunkGenerator;
    // private config: FC;
    // private level: WorldGenLevel;
    // private origin: BlockPos;
    // private random: RandomSource;
    // private topFeature: Optional<ConfiguredFeature<Object, Object>>;
    chunkGenerator(): ChunkGenerator;
    config(): FC;
    level(): WorldGenLevel;
    origin(): BlockPos;
    random(): RandomSource;
    topFeature(): Optional<ConfiguredFeature<Object, Object>>;
}