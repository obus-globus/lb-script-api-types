...
export class DripstoneClusterFeature extends Feature<DripstoneClusterConfiguration> {
    ...
    // private canPlacePool(level: WorldGenLevel, pos: BlockPos): boolean;
    // private getChanceOfStalagmiteOrStalactite(xRadius: number, zRadius: number, dx: number, dz: number, config: DripstoneClusterConfiguration): number;
