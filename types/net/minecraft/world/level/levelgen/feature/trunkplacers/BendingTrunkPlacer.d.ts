...
export class BendingTrunkPlacer extends TrunkPlacer {
    ...
    constructor(baseHeight: number, heightRandA: number, heightRandB: number, minHeightForLeaves: number, bendLength: IntProvider)
    // private bendLength: IntProvider;
    // private minHeightForLeaves: number;
