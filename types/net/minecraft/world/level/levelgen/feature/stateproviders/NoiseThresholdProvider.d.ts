...
export class NoiseThresholdProvider extends NoiseBasedStateProvider {
    ...
    constructor(seed: number, parameters: NormalNoise$NoiseParameters, scale: number, threshold: number, highChance: number, defaultState: BlockState, lowStates: BlockState[], highStates: BlockState[])
    // private defaultState: BlockState;
    // private highChance: number;
    // private highStates: BlockState[];
    // private lowStates: BlockState[];
