...
export class NoiseChunk$CacheOnce extends Object implements DensityFunctions$MarkerOrMarked, NoiseChunk$NoiseChunkDensityFunction {
    static CODEC: Codec<Object>;
    static DIRECT_CODEC: Codec<DensityFunction>;
    static HOLDER_HELPER_CODEC: Codec<DensityFunction>;
    private constructor(null_: NoiseChunk$CacheOnce, function_: DensityFunction)
    // private function: DensityFunction;
    // private lastArray: number[];
    // private lastArrayCounter: number;
