...
export class NetherFossilPieces$NetherFossilPiece extends TemplateStructurePiece {
    ...
    constructor(structureTemplateManager: StructureTemplateManager, templateLocation: Identifier, position: BlockPos, rotation: Rotation)
    ...
    // private placeDriedGhast(level: WorldGenLevel, random: RandomSource, fossilBB: BoundingBox, chunkBB: BoundingBox): void;
