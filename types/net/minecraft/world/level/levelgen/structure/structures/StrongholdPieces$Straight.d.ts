...
export class StrongholdPieces$Straight extends StrongholdPieces$StrongholdPiece {
    ...
    static createPiece(paramstructurePieceAccessor: StructurePieceAccessor, paramrandom: RandomSource, paramfootX: number, paramfootY: number, paramfootZ: number, paramdirection: Direction, paramgenDepth: number): StrongholdPieces$Straight;
    ...
    // private leftChild: boolean;
    // private rightChild: boolean;
