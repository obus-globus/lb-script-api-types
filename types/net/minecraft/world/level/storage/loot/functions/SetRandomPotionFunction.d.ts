...
export class SetRandomPotionFunction extends LootItemConditionalFunction {
    ...
    static fromTagKey(paramtagKey: Optional<Object>): LootItemConditionalFunction$Builder<Object>;
    private constructor(predicates: LootItemCondition[], options: Optional<Holder<T>[]>)
