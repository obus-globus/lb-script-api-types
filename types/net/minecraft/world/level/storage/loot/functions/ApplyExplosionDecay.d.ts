...
export class ApplyExplosionDecay extends LootItemConditionalFunction {
    static MAP_CODEC: MapCodec<ApplyExplosionDecay>;
    static explosionDecay(): LootItemConditionalFunction$Builder<Object>;
    private constructor(predicates: LootItemCondition[])
