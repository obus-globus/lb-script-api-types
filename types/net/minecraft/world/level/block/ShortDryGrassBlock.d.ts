...
import type { DryVegetationBlock } from '../../../../../net/minecraft/world/level/block/DryVegetationBlock.d.ts'
...
export class ShortDryGrassBlock extends DryVegetationBlock implements BonemealableBlock {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<Block>;
    static CODEC: MapCodec<DryVegetationBlock>;
    static CODEC: MapCodec<ShortDryGrassBlock>;
    ...
    codec(): MapCodec<ShortDryGrassBlock>;
