...
export class RespawnAnchorBlock extends Block {
    ...
    static charge(paramsourceEntity: Entity, paramlevel: Level, parampos: BlockPos, paramstate: BlockState): void;
    ...
    static findStandUpPosition(paramtype: EntityType<Object>, paramlevel: CollisionGetter, parampos: BlockPos): Optional<Vec3>;
    ...
    static getScaledChargeLevel(paramstate: BlockState, parammaximum: number): number;
    ...
    // private explode(state: BlockState, level: ServerLevel, pos: BlockPos): void;
