...
export class SculkShriekerBlockEntity$VibrationUser extends Object implements VibrationSystem$User {
    constructor(null_: SculkShriekerBlockEntity$VibrationUser)
