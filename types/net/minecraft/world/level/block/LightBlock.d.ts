...
export class LightBlock extends Block implements SimpleWaterloggedBlock {
    ...
    static setLightOnStack(paramresult: ItemStack, paramlightLevel: number): ItemStack;
    ...
    updateShape(state: BlockState, level: LevelReader, ticks: ScheduledTickAccess, pos: BlockPos, direction: Direction, neighbourPos: BlockPos, neighbour: BlockState, random: RandomSource): BlockState;
