...
import type { AmethystBlock } from '../../../../../net/minecraft/world/level/block/AmethystBlock.d.ts'
...
export class BuddingAmethystBlock extends AmethystBlock {
    ...
    static canClusterGrowAtState(paramstate: BlockState): boolean;
    ...
    codec(): MapCodec<BuddingAmethystBlock>;
