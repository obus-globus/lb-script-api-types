...
import type { VegetationBlock } from '../../../../../net/minecraft/world/level/block/VegetationBlock.d.ts'
...
export class StemBlock extends VegetationBlock implements BonemealableBlock {
    ...
    constructor(fruit: ResourceKey<Block>, attachedStem: ResourceKey<Block>, seed: ResourceKey<Item>, stemSupportBlocks: TagKey<Block>, fruitSupportBlocks: TagKey<Block>, properties: BlockBehaviour$Properties)
    // private attachedStem: ResourceKey<Block>;
    // private fruit: ResourceKey<Block>;
    // private fruitSupportBlocks: TagKey<Block>;
    // private seed: ResourceKey<Item>;
    // private stemSupportBlocks: TagKey<Block>;
