...
import type { GameMasterBlock } from '../../../../../net/minecraft/world/level/block/GameMasterBlock.d.ts'
...
export class CommandBlock extends BaseEntityBlock implements GameMasterBlock {
    ...
    // private execute(state: BlockState, level: ServerLevel, pos: BlockPos, baseCommandBlock: BaseCommandBlock, commandSet: boolean): void;
    ...
    // private setPoweredAndUpdate(level: Level, pos: BlockPos, commandBlock: CommandBlockEntity, isPowered: boolean): void;
