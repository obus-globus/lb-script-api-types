...
export class TripWireHookBlock extends Block {
    ...
    static calculateState(paramlevel: Level, parampos: BlockPos, paramstate: BlockState, paramisBeingDestroyed: boolean, paramcanUpdate: boolean, paramwireSource: number, paramwireSourceState: BlockState): void;
