...
export class MemoryModuleType<U extends Object | number | string | boolean> extends Object {
    ...
    static DOORS_TO_CLOSE: MemoryModuleType<Object>;
    ...
    static NEARBY_ADULT_PIGLINS: MemoryModuleType<Object>;
    ...
    static NEAREST_LIVING_ENTITIES: MemoryModuleType<Object>;
    static NEAREST_PLAYERS: MemoryModuleType<Object>;
    ...
    static NEAREST_VISIBLE_ADULT_HOGLINS: MemoryModuleType<Object>;
    static NEAREST_VISIBLE_ADULT_PIGLIN: MemoryModuleType<AbstractPiglin>;
    static NEAREST_VISIBLE_ADULT_PIGLINS: MemoryModuleType<Object>;
    static NEAREST_VISIBLE_ATTACKABLE_PLAYER: MemoryModuleType<Player>;
    static NEAREST_VISIBLE_ATTACKABLE_PLAYERS: MemoryModuleType<Object>;
    ...
    static SECONDARY_JOB_SITE: MemoryModuleType<Object>;
    static SNIFFER_DIGGING: MemoryModuleType<boolean>;
    static SNIFFER_EXPLORED_POSITIONS: MemoryModuleType<Object>;
    ...
    static UNREACHABLE_TONGUE_TARGETS: MemoryModuleType<Object>;
    static UNREACHABLE_TRANSPORT_BLOCK_POSITIONS: MemoryModuleType<Object>;
    ...
    static VISIBLE_VILLAGER_BABIES: MemoryModuleType<Object>;
    static VISITED_BLOCK_POSITIONS: MemoryModuleType<Object>;
