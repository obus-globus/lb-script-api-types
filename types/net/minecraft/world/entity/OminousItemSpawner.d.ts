...
export class OminousItemSpawner extends Entity {
    ...
    static create(paramlevel: Level, paramitem: ItemStack): OminousItemSpawner;
    static getInputVector(paraminput: Vec3, paramspeed: number, paramyRot: number): Vec3;
    static getViewScale(): number;
    static setViewScale(paramviewScale: number): void;
    constructor(type: EntityType<OminousItemSpawner>, level: Level)
    // private spawnItemAfterTicks: number;
    ...
    // private setItem(itemStack: ItemStack): void;
    // private spawnItem(): void;
    // private spawnProjectile(level: ServerLevel, projectileItem: ProjectileItem, item: ItemStack): Entity;
    tick(): void;
    // private tickClient(): void;
    // private tickServer(level: ServerLevel): void;
}