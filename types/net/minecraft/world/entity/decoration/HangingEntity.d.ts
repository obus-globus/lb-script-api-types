...
export abstract class HangingEntity extends BlockAttachedEntity {
    ...
    constructor(type: EntityType<HangingEntity>, level: Level)
    constructor(type: EntityType<HangingEntity>, level: Level, pos: BlockPos)
    calculateBoundingBox(pos: BlockPos, direction: Direction): AABB;
    calculateSupportBox(): AABB;
    canCoexist(allowIntersectingSameType: boolean): boolean;
