...
export class ZombieVillager extends Zombie implements VillagerDataHolder {
    ...
    constructor(type: EntityType<ZombieVillager>, level: Level)
    // private conversionStarter: UUID;
    readonly gossips: GossipContainer;
    readonly tradeOffers: (Object | null)[];
    readonly villagerConversionTime: number;
    ...
    // private initializeVillagerData(): VillagerData;
    ...
    setTradeOffers(tradeOffers: (Object | null)[]): void;
    setVillagerConversionTime(conversionTime: number): void;
    setVillagerData(villagerData: VillagerData): void;
    setVillagerXp(villagerXp: number): void;
    // private startConverting(player: UUID, time: number): void;
    tick(): void;
}