...
export class Zombie extends Monster {
    ...
    convertToZombieType(level: ServerLevel, zombieType: EntityType<Zombie>): void;
    convertVillagerToZombieVillager(level: ServerLevel, villager: Villager): boolean;
    ...
    doUnderWaterConversion(level: ServerLevel): void;
    ...
    handleAttributes(difficultyModifier: number, spawnReason: EntitySpawnReason): void;
    ...
    setConversionTime(conversionTime: number): void;
    setInWaterTime(inWaterTime: number): void;
    // private startUnderWaterConversion(time: number): void;
    tick(): void;
