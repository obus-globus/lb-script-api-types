...
export class Endermite extends Monster {
    ...
    static checkEndermiteSpawnRules(paramtype: EntityType<Endermite>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<Endermite>, level: Level)
    // private life: number;
