...
import type { AgeableWaterCreature } from '../../../../../../net/minecraft/world/entity/animal/AgeableWaterCreature.d.ts'
...
export class Dolphin extends AgeableWaterCreature {
    ...
    constructor(type: EntityType<Dolphin>, level: Level)
    // private treasurePos: BlockPos;
    addAdditionalSaveData(output: ValueOutput): void;
    // private addParticlesAroundSelf(particle: ParticleOptions): void;
    ...
    getBreedOffspring(level: ServerLevel, partner: AgeableMob): Dolphin;
    ...
    gotFish(): boolean;
    handleAirSupply(preTickAirSupply: number): void;
    ...
    setMoisntessLevel(level: number): void;
    tick(): void;
