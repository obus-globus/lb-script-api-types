...
export class Armadillo extends Animal {
    ...
    static checkArmadilloSpawnRules(paramtype: EntityType<Armadillo>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    isScared(): boolean;
    isScaredBy(livingEntity: LivingEntity): boolean;
    makeBrain(packedBrain: Brain$Packed): Brain<Armadillo>;
    ...
    switchToState(state: Armadillo$ArmadilloState): void;
    tick(): void;
}