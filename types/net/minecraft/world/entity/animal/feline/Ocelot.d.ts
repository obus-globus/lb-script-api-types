...
import type { Ocelot$OcelotAvoidEntityGoal } from '../../../../../../net/minecraft/world/entity/animal/feline/Ocelot$OcelotAvoidEntityGoal.d.ts'
import type { Ocelot$OcelotTemptGoal } from '../../../../../../net/minecraft/world/entity/animal/feline/Ocelot$OcelotTemptGoal.d.ts'
...
export class Ocelot extends Animal {
    ...
    static checkOcelotSpawnRules(paramtype: EntityType<Ocelot>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<Ocelot>, level: Level)
    // private ocelotAvoidPlayersGoal: Ocelot$OcelotAvoidEntityGoal<Player>;
    // private temptGoal: Ocelot$OcelotTemptGoal;
    ...
    getBreedOffspring(level: ServerLevel, partner: AgeableMob): Ocelot;
    ...
    // private setTrusting(trusting: boolean): void;
