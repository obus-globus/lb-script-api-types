...
export class ApplyMobEffect extends Record implements EnchantmentEntityEffect {
    ...
    constructor(toApply: Holder<T>[], minDuration: LevelBasedValue, maxDuration: LevelBasedValue, minAmplifier: LevelBasedValue, maxAmplifier: LevelBasedValue)
