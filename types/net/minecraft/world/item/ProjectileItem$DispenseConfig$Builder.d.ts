...
export class ProjectileItem$DispenseConfig$Builder extends Object {
    ...
    // private positionFunction: (param0: BlockSource, param1: Direction) => net.minecraft.core.Position;
    ...
    positionFunction(positionFunction: (param0: BlockSource, param1: Direction) => net.minecraft.core.Position): ProjectileItem$DispenseConfig$Builder;
