...
export class Attributes extends Object {
    ...
    static EXPLOSION_KNOCKBACK_RESISTANCE: string;
    ...
    static LUCK: string;
    static MAX_ABSORPTION: string;
    static MAX_HEALTH: string;
    ...
    static SCALE: string;
    static SNEAKING_SPEED: string;
    static SPAWN_REINFORCEMENTS: string;
    static STEP_HEIGHT: string;
    static SUBMERGED_MINING_SPEED: string;
    static SWEEPING_DAMAGE_RATIO: string;
    static TEMPT_RANGE: string;
    static WATER_MOVEMENT_EFFICIENCY: string;
    static WAYPOINT_RECEIVE_RANGE: string;
    static WAYPOINT_TRANSMIT_RANGE: string;
    constructor()
}