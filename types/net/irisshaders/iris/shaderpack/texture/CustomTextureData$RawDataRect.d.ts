...
import type { CustomTextureData$RawData2D } from '../../../../../net/irisshaders/iris/shaderpack/texture/CustomTextureData$RawData2D.d.ts'
import type { TextureFilteringData } from '../../../../../net/irisshaders/iris/shaderpack/texture/TextureFilteringData.d.ts'
export class CustomTextureData$RawDataRect extends CustomTextureData$RawData2D {
    constructor(arg0: number[], arg1: TextureFilteringData, arg2: InternalTextureFormat, arg3: PixelFormat, arg4: PixelType, arg5: number, arg6: number)
}