...
export class ProcessedText$ProcessedChar extends Record {
    constructor(char: string, font: number, obfuscated: boolean, color: Color4b)
    // private char: string;
    ...
    component3(): boolean;
    component4(): Color4b;
    copy(char: string, font: number, obfuscated: boolean, color: Color4b): ProcessedText$ProcessedChar;
