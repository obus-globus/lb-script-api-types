...
export class McVersionLookup$MethodConstantVisitor extends ClassVisitor implements McVersionLookup$Analyzer {
    constructor(arg0: string)
    // private foundInMethodHint: boolean;
    // private methodNameHint: string;
