...
import type { Xplain } from '../../../../../../../../net/fabricmc/loader/impl/lib/sat4j/tools/xplain/Xplain.d.ts'
export class XplainPB extends Xplain<IPBSolver> implements IPBSolver {
    ...
    // private addPseudoBoolean(arg0: IVecInt, arg1: IVecInt, arg2: boolean, arg3: number): IConstr;
