...
export class ParticleGroupRegistryImpl extends Object {
    ...
    // private factories: Map<ParticleRenderType, (param0: ParticleEngine) => ParticleGroup<Object>>;
    // private nodes: Map<Identifier, ParticleGroupRegistryImpl$ParticleTextureNode>;
    // private renderTypes: ParticleRenderType[];
    getFactory(arg0: ParticleRenderType): (param0: ParticleEngine) => ParticleGroup<Object>;
    getParticleRenderType(arg0: Identifier): ParticleRenderType;
    register(arg0: ParticleRenderType, arg1: (param0: ParticleEngine) => ParticleGroup<Object>): void;
