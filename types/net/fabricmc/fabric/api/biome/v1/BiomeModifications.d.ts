...
export class BiomeModifications extends Object {
    static addCarver(paramarg0: (param0: BiomeSelectionContext) => kotlin.Boolean, paramarg1: ResourceKey<Object>): void;
    static addFeature(paramarg0: (param0: BiomeSelectionContext) => kotlin.Boolean, paramarg1: GenerationStep$Decoration, paramarg2: ResourceKey<PlacedFeature>): void;
    static addSpawn(paramarg0: (param0: BiomeSelectionContext) => kotlin.Boolean, paramarg1: MobCategory, paramarg2: EntityType<Object>, paramarg3: number, paramarg4: number, paramarg5: number): void;
