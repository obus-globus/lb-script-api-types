...
export class ModelStateHelper extends Object {
    static asQuadTransform(paramarg0: ModelState, paramarg1: (param0: QuadAtlas) => net.fabricmc.fabric.api.client.renderer.v1.sprite.SpriteFinder): (param0: MutableQuadView) => kotlin.Boolean;
