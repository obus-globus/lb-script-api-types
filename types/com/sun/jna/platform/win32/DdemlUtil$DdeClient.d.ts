...
import type { DdemlUtil$DdeAdapter } from '../../../../../com/sun/jna/platform/win32/DdemlUtil$DdeAdapter.d.ts'
...
export class DdemlUtil$DdeClient extends Object implements DdemlUtil$IDdeClient {
    constructor()
    // private ddeAdapter: DdemlUtil$DdeAdapter;
