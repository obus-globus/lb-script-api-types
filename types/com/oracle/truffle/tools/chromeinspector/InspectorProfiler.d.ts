...
export class InspectorProfiler extends ProfilerDomain {
    ...
    doDisable(): void;
    doEnable(): void;
    // private fillChildren(node: ProfileNode, childProfilerNodes: E[], nodes: ProfileNode[], timeLine: Profile$TimeLineItem[], lastCounter: number): void;
    getBestEffortCoverage(): Params;
    // private getCoverage(payloads: E[]): Params;
    // private getProfile(rootProfilerNodes: E[], idleHitCount: number, startTime: number, endTime: number): Params;
    // private getTypeProfile(profiles: E[]): Params;
