...
export class AttachResponse extends Response {
    static create(paramrequestSeq: number, paramsuccess: boolean, paramcommand: string, paramseq: number): AttachResponse;
