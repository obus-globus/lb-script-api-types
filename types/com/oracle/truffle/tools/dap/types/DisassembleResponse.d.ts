...
export class DisassembleResponse extends Response {
    static create(paramrequestSeq: number, paramsuccess: boolean, paramcommand: string, paramseq: number): DisassembleResponse;
