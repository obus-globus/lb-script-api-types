...
export class StepBackResponse extends Response {
    ...
    static create(paramrequestSeq: number, paramsuccess: boolean, paramcommand: string, paramseq: number): StepBackResponse;
