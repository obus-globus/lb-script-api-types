...
export class RestartFrameResponse extends Response {
    ...
    static create(paramrequestSeq: number, paramsuccess: boolean, paramcommand: string, paramseq: number): RestartFrameResponse;
