...
export class Token$Quantifier extends Token {
    ...
    constructor(from: Token$Quantifier)
    constructor(min: number, max: number, greedy: boolean, possessive: boolean, singleChar: boolean)
    ...
    readonly zeroWidthIndex: number;
    equals(obj: Object | null): boolean;
    equalsSemantic(o: Token$Quantifier): boolean;
    getIndex(): number;
    getMax(): number;
    getMin(): number;
    getZeroWidthIndex(): number;
    hasIndex(): boolean;
    hasZeroWidthIndex(): boolean;
    hashCode(): number;
    isDead(): boolean;
    isGreedy(): boolean;
    isInfiniteLoop(): boolean;
    isLazy(): boolean;
    isMaxGreaterThan(threshold: number): boolean;
    isPossessive(): boolean;
    isSingleChar(): boolean;
    isUnrollTrivial(): boolean;
    isWithinThreshold(threshold: number): boolean;
    // private minMaxToString(): string;
    setIndex(index: number): void;
    setZeroWidthIndex(zeroWidthIndex: number): void;
    toJson(): JsonObject;
    toString(): string;
    toStringNoSuffix(): string;
}