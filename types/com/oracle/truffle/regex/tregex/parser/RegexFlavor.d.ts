...
export abstract class RegexFlavor extends Object {
    constructor(traits: number)
    // private traits: number;
    backreferenceIgnoreCaseMultiCharExpansion(): boolean;
    backreferencesToUnmatchedGroupsFail(): boolean;
    canHaveEmptyLoopIterations(): boolean;
    ...
    emptyChecksMonitorCaptureGroups(): boolean;
    ...
    lookBehindsRequireFixedWidthPattern(): boolean;
    lookBehindsRunLeftToRight(): boolean;
    matchesTransitionsStepByStep(): boolean;
    needsGroupStartPositions(): boolean;
    nestedCaptureGroupsKeptOnLoopReentry(): boolean;
    supportsRecursiveBackreferences(): boolean;
    usesLastGroupResultField(): boolean;
}