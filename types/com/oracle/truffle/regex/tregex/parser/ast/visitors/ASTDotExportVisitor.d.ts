...
export class ASTDotExportVisitor extends DepthFirstTraversalRegexASTVisitor {
    static exportDot(paramroot: RegexASTNode, parampath: string, paramshowParentPointers: boolean): void;
    private constructor(writer: BufferedWriter, showParentPointers: boolean)
    // private showParentPointers: boolean;
    // private writer: BufferedWriter;
    // private printParentNextPrev(node: RegexASTNode): void;
    ...
    // private visitSubtreeRootNode(subtreeRootNode: RegexASTSubtreeRootNode, nodeLabel: string, edgeLabel: string): void;
