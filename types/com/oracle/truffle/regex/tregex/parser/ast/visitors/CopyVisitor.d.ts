...
export class CopyVisitor extends DepthFirstTraversalRegexASTVisitor {
    constructor(ast: RegexAST)
    // private ast: RegexAST;
    // private copyRoot: Term;
    // private curParent: RegexASTNode;
    copy(term: Term): Term;
    // private doCopy(t: Term): Term;
    // private goToUpperParent(): void;
