...
import type { LiteralRegexExecNode$IndexOfString } from '../../../../../com/oracle/truffle/regex/literal/LiteralRegexExecNode$IndexOfString.d.ts'
...
export class LiteralRegexExecNodeGen$IndexOfStringNodeGen extends LiteralRegexExecNode$IndexOfString {
    static create(parampreCalcResultVisitor: PreCalcResultVisitor): LiteralRegexExecNode$IndexOfString;
