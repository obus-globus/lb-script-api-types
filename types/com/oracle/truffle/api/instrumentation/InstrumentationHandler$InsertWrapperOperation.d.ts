...
export class InstrumentationHandler$InsertWrapperOperation extends InstrumentationHandler$VisitOperation {
    constructor(null_: InstrumentationHandler$InsertWrapperOperation, binding: EventBinding$Source<Object>)
    constructor(null_: InstrumentationHandler$InsertWrapperOperation, bindings: EventBinding$Source<Object>[])
