...
export class InstrumentationHandler$FindSourcesOperation extends InstrumentationHandler$VisitOperation {
    constructor(scope: InstrumentationHandler$VisitOperation$Scope, threadLocalNewSources: ThreadLocal<Map<Source, void>>, sourceInstrumentationHandler: SourceInstrumentationHandler, dontNotifyBindings: boolean, performOnlyOnExecutedAST: boolean)
    // private dontNotifyBindings: boolean;
    // private newSources: Map<Source, void>;
    // private performOnlyOnExecutedAST: boolean;
    // private sourceInstrumentationHandler: SourceInstrumentationHandler;
    // private threadLocalNewSources: ThreadLocal<Map<Source, void>>;
