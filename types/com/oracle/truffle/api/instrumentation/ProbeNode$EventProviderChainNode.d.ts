...
export class ProbeNode$EventProviderChainNode extends ProbeNode$EventChainNode {
    constructor(binding: EventBinding$Source<Object>, eventNode: ExecutionEventNode)
    // private eventNode: ExecutionEventNode;
