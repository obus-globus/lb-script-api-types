...
export abstract class Accessor$EngineSupport extends Accessor$Support {
    ...
    getOrCreateRuntimeData<T extends Object | number | string | boolean>(polyglotEngine: Object): T;
    ...
    leaveAndEnter<R extends Object | number | string | boolean, T extends Object | number | string | boolean>(polyglotContext: Object, interrupter: TruffleSafepoint$Interrupter, runWhileOutsideContext: (param0: T) => R, object: T): R;
