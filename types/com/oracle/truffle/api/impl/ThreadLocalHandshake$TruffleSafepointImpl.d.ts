...
export class ThreadLocalHandshake$TruffleSafepointImpl extends TruffleSafepoint {
    ...
    // private setBlockedBoundary<T extends Object | number | string | boolean>(location: Node, interrupter: TruffleSafepoint$Interrupter, interruptible: (param0: T) => void, object: T, beforeInterrupt: () => void, afterInterrupt: (param0: Throwable) => void): void;
    // private setBlockedCompiled<T extends Object | number | string | boolean>(location: Node, interrupter: TruffleSafepoint$Interrupter, interruptible: (param0: T) => void, object: T, beforeInterrupt: () => void, afterInterrupt: (param0: Throwable) => void): void;
    ...
    // private setBlockedFunctionBoundary<R extends Object | number | string | boolean, T extends Object | number | string | boolean>(location: Node, interrupter: TruffleSafepoint$Interrupter, interruptible: (param0: T) => R, object: T, beforeInterrupt: () => void, afterInterrupt: (param0: Throwable) => void): R;
    // private setBlockedFunctionCompiled<R extends Object | number | string | boolean, T extends Object | number | string | boolean>(location: Node, interrupter: TruffleSafepoint$Interrupter, interruptible: (param0: T) => R, object: T, beforeInterrupt: () => void, afterInterrupt: (param0: Throwable) => void): R;
