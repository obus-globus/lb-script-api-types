...
export class ReflectionLibraryGen$CachedDispatchFirst extends ReflectionLibraryGen$CachedDispatch {
    ...
    constructor(library: ReflectionLibrary, next: ReflectionLibraryGen$CachedDispatch, limit_: number)
