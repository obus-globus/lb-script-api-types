...
export class DynamicObjectLibraryGen$Delegate extends DynamicObjectLibrary {
    static getFactory(): LibraryFactory<DynamicObjectLibrary>;
    static getUncached(): DynamicObjectLibrary;
    constructor(delegateLibrary: DynamicObjectLibrary)
    // private delegateLibrary: DynamicObjectLibrary;
