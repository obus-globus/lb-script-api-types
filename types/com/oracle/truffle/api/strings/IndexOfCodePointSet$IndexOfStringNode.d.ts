...
export abstract class IndexOfCodePointSet$IndexOfStringNode extends IndexOfCodePointSet$OptimizedIndexOfNode {
    constructor(maxCodeRange: number, string: TruffleString)
    // private str: TruffleString;
