...
export class TruffleStringFactory$RepeatNodeGen extends TruffleString$RepeatNode {
    ...
    private constructor()
    // private asTruffleStringNode_: TruffleString$AsTruffleStringNode;
    ...
    // private executeAndSpecialize(arg0Value: AbstractTruffleString, arg1Value: number, arg2Value: TruffleString$Encoding): TruffleString;
}