...
import type { TStringInternalNodes$CodePointAtRawNode } from '../../../../../com/oracle/truffle/api/strings/TStringInternalNodes$CodePointAtRawNode.d.ts'
...
export abstract class TruffleString$CodePointAtByteIndexNode extends AbstractPublicNode {
    ...
    readCodePoint(a: AbstractTruffleString, byteIndex: number, encoding: TruffleString$Encoding, errorHandling: TruffleString$ErrorHandling, managedProfileA: InlinedConditionProfile, nativeProfileA: InlinedConditionProfile, getCodeRangeNode: TStringInternalNodes$GetCodeRangeForIndexCalculationNode, readCodePointNode: TStringInternalNodes$CodePointAtRawNode): number;
}