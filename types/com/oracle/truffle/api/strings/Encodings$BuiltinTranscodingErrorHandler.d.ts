...
export class Encodings$BuiltinTranscodingErrorHandler extends Object implements TranscodingErrorHandler {
    static DEFAULT: (param0: AbstractTruffleString, param1: number, param2: number, param3: TruffleString$Encoding, param4: TruffleString$Encoding) => com.oracle.truffle.api.strings.TranscodingErrorHandler.ReplacementString;
    static DEFAULT_KEEP_SURROGATES_IN_UTF8: (param0: AbstractTruffleString, param1: number, param2: number, param3: TruffleString$Encoding, param4: TruffleString$Encoding) => com.oracle.truffle.api.strings.TranscodingErrorHandler.ReplacementString;
    constructor()
