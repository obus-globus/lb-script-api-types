...
import type { JSRawJSONObject } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSRawJSONObject.d.ts'
...
export class JSRawJSON extends JSNonProxy {
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSRawJSON;
    static RAW_JSON_PROXY: PropertyProxy;
    static checkProtoCycle(paramthisObj: JSDynamicObject, paramnewPrototype: JSDynamicObject): boolean;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramvalue: TruffleString): JSRawJSONObject;
    ...
    static makeInitialShape(paramcontext: JSContext): Shape;
