...
import type { JSWeakRef$TruffleWeakReference } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSWeakRef$TruffleWeakReference.d.ts'
import type { JSWeakRefObject } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSWeakRefObject.d.ts'
...
export class JSWeakRef extends JSNonProxy implements JSConstructorFactory$Default, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSWeakRef;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramreferent: Object): JSWeakRefObject;
    ...
    static getInternalWeakRef(paramobj: JSWeakRefObject): JSWeakRef$TruffleWeakReference<Object>;
    ...
    static isJSWeakRef(paramobj: Object): boolean;
