...
export class JSShadowRealm extends JSNonProxy implements JSConstructorFactory$Default, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSShadowRealm;
    ...
    static create(paramcontext: JSContext, paramcallerRealm: JSRealm, paramproto: JSDynamicObject, paramshadowRealm: JSRealm): JSShadowRealmObject;
    ...
    static isJSShadowRealm(paramobject: Object): boolean;
