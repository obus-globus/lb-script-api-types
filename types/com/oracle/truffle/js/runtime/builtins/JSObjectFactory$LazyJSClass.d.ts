...
export class JSObjectFactory$LazyJSClass<T extends JSClass & PrototypeSupplier> extends JSObjectFactory$Lazy {
    ...
    constructor(context: JSContext, jsclass: T, slot: number)
    // private jsclass: T;
