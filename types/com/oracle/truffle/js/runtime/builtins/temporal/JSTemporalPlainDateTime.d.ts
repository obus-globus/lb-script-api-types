...
export class JSTemporalPlainDateTime extends JSNonProxy implements JSConstructorFactory$WithFunctions, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSTemporalPlainDateTime;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramy: number, paramm: number, paramd: number, paramhour: number, paramminute: number, paramsecond: number, parammillisecond: number, parammicrosecond: number, paramnanosecond: number, paramcalendar: TruffleString): JSTemporalPlainDateTimeObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramy: number, paramm: number, paramd: number, paramhour: number, paramminute: number, paramsecond: number, parammillisecond: number, parammicrosecond: number, paramnanosecond: number, paramcalendar: TruffleString, paramnode: Node, paramerrorBranch: InlinedBranchProfile): JSTemporalPlainDateTimeObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramy: number, paramm: number, paramd: number, paramhour: number, paramminute: number, paramsecond: number, parammillisecond: number, parammicrosecond: number, paramnanosecond: number, paramcalendar: TruffleString): JSTemporalPlainDateTimeObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramy: number, paramm: number, paramd: number, paramhour: number, paramminute: number, paramsecond: number, parammillisecond: number, parammicrosecond: number, paramnanosecond: number, paramcalendar: TruffleString, paramnode: Node, paramerrorBranch: InlinedBranchProfile): JSTemporalPlainDateTimeObject;
    ...
    static isJSTemporalPlainDateTime(paramobj: Object): boolean;
    ...
    static temporalDateTimeToString(paramyear: number, parammonth: number, paramday: number, paramhour: number, paramminute: number, paramsecond: number, parammillisecond: number, parammicrosecond: number, paramnanosecond: number, paramcalendar: Object, paramprecision: Object, paramshowCalendar: TemporalUtil$ShowCalendar): TruffleString;
