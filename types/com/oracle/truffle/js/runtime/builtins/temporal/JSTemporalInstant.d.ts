...
export class JSTemporalInstant extends JSNonProxy implements JSConstructorFactory$WithFunctions, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSTemporalInstant;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramnanoseconds: BigInt): JSTemporalInstantObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramnanoseconds: BigInt): JSTemporalInstantObject;
    ...
    static isJSTemporalInstant(paramobj: Object): boolean;
