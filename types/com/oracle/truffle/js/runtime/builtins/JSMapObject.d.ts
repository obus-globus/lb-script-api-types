...
export class JSMapObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, map: JSHashMap)
    readonly map: JSHashMap;
    getClassName(): TruffleString;
    getHashEntriesIterator(): Object;
    getHashSize(): number;
    getMap(): JSHashMap;
    hasHashEntries(): boolean;
    isHashEntryInsertable(key: Object, thisLibrary: InteropLibrary): boolean;
    isHashEntryModifiable(key: Object, importKeyNode: ImportValueNode, normalizeKeyNode: JSCollectionsNormalizeNode): boolean;
    isHashEntryReadable(key: Object, importKeyNode: ImportValueNode, normalizeKeyNode: JSCollectionsNormalizeNode): boolean;
    readHashValue(key: Object, exportValueNode: ExportValueNode, importKeyNode: ImportValueNode, normalizeKeyNode: JSCollectionsNormalizeNode): Object;
    readHashValueOrDefault(key: Object, defaultValue: Object, exportValueNode: ExportValueNode, importKeyNode: ImportValueNode, normalizeKeyNode: JSCollectionsNormalizeNode): Object;
    removeHashEntry(key: Object, importKeyNode: ImportValueNode, normalizeKeyNode: JSCollectionsNormalizeNode): void;
    toDisplayStringImpl(allowSideEffects: boolean, format: ToDisplayStringFormat, depth: number): TruffleString;
    writeHashEntry(key: Object, value: Object, importKeyNode: ImportValueNode, importValueNode: ImportValueNode, normalizeKeyNode: JSCollectionsNormalizeNode): void;
}