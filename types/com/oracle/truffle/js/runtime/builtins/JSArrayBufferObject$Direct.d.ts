...
export class JSArrayBufferObject$Direct extends JSArrayBufferObject$DirectBase {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, byteBuffer: ByteBuffer, byteLength: number, maxByteLength: number)
