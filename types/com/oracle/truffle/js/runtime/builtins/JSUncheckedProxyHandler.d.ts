...
export class JSUncheckedProxyHandler extends JSNonProxy implements PrototypeSupplier {
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSUncheckedProxyHandler;
    static checkProtoCycle(paramthisObj: JSDynamicObject, paramnewPrototype: JSDynamicObject): boolean;
    static create(paramcontext: JSContext, paramrealm: JSRealm): JSDynamicObject;
