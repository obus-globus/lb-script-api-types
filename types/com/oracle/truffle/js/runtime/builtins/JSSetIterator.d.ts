...
import type { JSSetIteratorObject } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSSetIteratorObject.d.ts'
...
export class JSSetIterator extends JSNonProxy implements JSConstructorFactory, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSSetIterator;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramiteratedObject: Object, paramnextIndex: JSHashMap$Cursor, paramiterationKind: number): JSSetIteratorObject;
