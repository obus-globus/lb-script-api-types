...
import type { JSCollator$InternalState } from '../../../../../../../com/oracle/truffle/js/runtime/builtins/intl/JSCollator$InternalState.d.ts'
...
export class JSCollator extends JSNonProxy implements JSConstructorFactory$WithFunctions, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSCollator;
    ...
    static compare(paramcollatorObj: JSCollatorObject, paramone: string, paramtwo: string): number;
    static create(paramcontext: JSContext, paramrealm: JSRealm): JSCollatorObject;
    ...
    static resolvedOptions(paramcontext: JSContext, paramrealm: JSRealm, paramcollatorObj: JSCollatorObject): JSDynamicObject;
