...
export class JSRelativeTimeFormat extends JSNonProxy implements JSConstructorFactory$WithFunctions, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSRelativeTimeFormat;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject): JSRelativeTimeFormatObject;
    ...
    static format(paramrelativeTimeFormatObj: JSRelativeTimeFormatObject, paramamount: number, paramunit: string): TruffleString;
    static formatToParts(paramcontext: JSContext, paramrealm: JSRealm, paramrelativeTimeFormatObj: JSRelativeTimeFormatObject, paramamount: number, paramunit: string): JSDynamicObject;
    ...
    static isJSRelativeTimeFormat(paramobj: Object): boolean;
    ...
    static resolvedOptions(paramcontext: JSContext, paramrealm: JSRealm, paramrelativeTimeFormatObj: JSRelativeTimeFormatObject): JSObject;
