...
export class JSBigInt extends JSPrimitive implements JSConstructorFactory$WithFunctions {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSBigInt;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramvalue: BigInt): JSBigIntObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramvalue: BigInt): JSBigIntObject;
    ...
    static isJSBigInt(paramobj: Object): boolean;
    ...
    static valueOf(paramobj: JSBigIntObject): BigInt;
    private constructor()
