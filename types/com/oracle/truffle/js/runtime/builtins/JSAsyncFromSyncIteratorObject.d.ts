...
export class JSAsyncFromSyncIteratorObject extends JSNonProxyObject {
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramsyncIteratorRecord: IteratorRecord): JSAsyncFromSyncIteratorObject;
    ...
    constructor(shape: Shape, proto: JSDynamicObject, syncIterator: IteratorRecord)
    // private syncIterator: IteratorRecord;
    getSyncIteratorRecord(): IteratorRecord;
}