...
export class JSBoolean extends JSPrimitive implements JSConstructorFactory$Default {
    static CLASS_NAME: TruffleString;
    static FALSE_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSBoolean;
    static PROTOTYPE_NAME: TruffleString;
    static TRUE_NAME: TruffleString;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramvalue: boolean): JSBooleanObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramvalue: boolean): JSBooleanObject;
    ...
    static isJSBoolean(paramobj: Object): boolean;
    static noBooleanError(): JSException;
    ...
    static valueOf(paramobj: JSBooleanObject): boolean;
    private constructor()
