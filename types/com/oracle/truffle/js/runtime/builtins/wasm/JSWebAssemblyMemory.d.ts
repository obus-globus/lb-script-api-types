...
export class JSWebAssemblyMemory extends JSNonProxy implements JSConstructorFactory$Default, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSWebAssemblyMemory;
    static MAX_MEMORY_SIZE: number;
    static PROTOTYPE_NAME: TruffleString;
    static WEB_ASSEMBLY_MEMORY: TruffleString;
    static checkProtoCycle(paramthisObj: JSDynamicObject, paramnewPrototype: JSDynamicObject): boolean;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramwasmMemory: Object, paramshared: boolean): JSWebAssemblyMemoryObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramwasmMemory: Object, paramshared: boolean): JSWebAssemblyMemoryObject;
    ...
    static isJSWebAssemblyMemory(paramobject: Object): boolean;
    ...
    static resetBuffers(paramrealm: JSRealm, paramwasmMemory: Object): void;
