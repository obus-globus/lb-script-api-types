...
export class JSWebAssemblyMemoryObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, wasmMemory: Object, shared: boolean)
    // private bufferObject: JSArrayBufferObject;
    readonly shared: boolean;
    // private wasmMemory: Object;
    // private createBufferObject(context: JSContext, realm: JSRealm): JSArrayBufferObject;
    getBufferObject(context: JSContext, realm: JSRealm): JSArrayBufferObject;
    getClassName(): TruffleString;
    getWASMMemory(): Object;
    isShared(): boolean;
    resetBufferObject(): void;
}