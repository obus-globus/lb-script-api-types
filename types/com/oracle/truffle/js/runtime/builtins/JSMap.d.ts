...
export class JSMap extends JSNonProxy implements JSConstructorFactory$WithFunctionsAndSpecies, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSMap;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm): JSMapObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject): JSMapObject;
    ...
    static getInternalMap(paramobj: JSMapObject): JSHashMap;
    static getMapSize(paramobj: JSMapObject): number;
    ...
    static isJSMap(paramobj: Object): boolean;
