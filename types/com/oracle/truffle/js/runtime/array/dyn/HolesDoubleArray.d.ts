...
export class HolesDoubleArray extends AbstractContiguousDoubleArray {
    ...
    static makeHolesDoubleArray(paramobject: JSDynamicObject, paramlength: number, paramarray: number[], paramindexOffset: number, paramarrayOffset: number, paramusedLength: number, paramholeCount: number, paramintegrityLevel: number): HolesDoubleArray;
    ...
    // private setInBoundsFastIntl(object: JSDynamicObject, index: number, internalIndex: number, value: number): void;
    ...
    toNonHoles(object: JSDynamicObject, index: number, value: Object): AbstractDoubleArray;
    toObject(object: JSDynamicObject, index: number, value: Object): AbstractWritableArray;
    withIntegrityLevel(newIntegrityLevel: number): HolesDoubleArray;
}