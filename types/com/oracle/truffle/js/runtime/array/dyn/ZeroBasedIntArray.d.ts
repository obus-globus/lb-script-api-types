...
import type { ContiguousIntArray } from '../../../../../../../com/oracle/truffle/js/runtime/array/dyn/ContiguousIntArray.d.ts'
...
export class ZeroBasedIntArray extends AbstractIntArray {
    ...
    static makeZeroBasedIntArray(paramobject: JSDynamicObject, paramlength: number, paramusedLength: number, paramarray: number[], paramintegrityLevel: number): ZeroBasedIntArray;
    ...
    toContiguous(object: JSDynamicObject, index: number, value: Object): ContiguousIntArray;
    toDouble(object: JSDynamicObject, index: number, value: number): ZeroBasedDoubleArray;
    ...
    withIntegrityLevel(newIntegrityLevel: number): ZeroBasedIntArray;
}