...
import type { JSOrdinaryObject } from '../../../../../../com/oracle/truffle/js/runtime/objects/JSOrdinaryObject.d.ts'
...
export class JSOrdinaryObject$InternalFieldLayout extends JSOrdinaryObject {
    ...
    static create(paramshape: Shape, paramproto: JSDynamicObject): JSOrdinaryObject;
    static createWithDefaultLayout(paramshape: Shape, paramproto: JSDynamicObject): JSOrdinaryObject;
    ...
    // private internalObjectFields: Object[];
    // private internalPointerFields: number[];
    // private o0: Object;
    // private o1: Object;
    // private o2: Object;
    copyWithoutProperties(shape: Shape): JSObject;
    getInternalFieldCount(): number;
    getInternalFieldObject(index: number): Object;
    getInternalFieldPointer(index: number): number;
    setInternalFieldCount(internalFieldCount: number): void;
    setInternalFieldObject(index: number, value: Object): void;
    setInternalFieldPointer(index: number, value: number): void;
}