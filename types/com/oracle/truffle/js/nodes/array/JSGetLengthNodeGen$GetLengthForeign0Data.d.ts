...
export class JSGetLengthNodeGen$GetLengthForeign0Data extends Node implements DSLSupport$SpecializationDataNode {
    constructor(next_: JSGetLengthNodeGen$GetLengthForeign0Data)
    // private importValueNode_: ImportValueNode;
    // private interop_: InteropLibrary;
    // private next_: JSGetLengthNodeGen$GetLengthForeign0Data;
}