...
export class WhileNode$ForOfRepeatingNode extends AbstractRepeatingNode implements ResumableNode$WithIntState {
    ...
    constructor(nextResultNode: JavaScriptNode, body: JavaScriptNode, writeNextValueNode: JSWriteFrameSlotNode)
    ...
    // private executeNextResult(frame: VirtualFrame): Object;
