...
import type { InitErrorObjectNodeFactory$DefineStackPropertyNodeGen$Cached0Data } from '../../../../../../com/oracle/truffle/js/nodes/access/InitErrorObjectNodeFactory$DefineStackPropertyNodeGen$Cached0Data.d.ts'
...
export class InitErrorObjectNodeFactory$DefineStackPropertyNodeGen extends InitErrorObjectNode$DefineStackPropertyNode {
    ...
    // private cached1Boundary(state_0: number, arg0Value: JSObject): void;
