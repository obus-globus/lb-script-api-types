...
import type { ReadElementNode$TypedFloatArrayReadElementCacheNode } from '../../../../../../com/oracle/truffle/js/nodes/access/ReadElementNode$TypedFloatArrayReadElementCacheNode.d.ts'
...
export class ReadElementNodeFactory$TypedFloatArrayReadElementCacheNodeGen extends ReadElementNode$TypedFloatArrayReadElementCacheNode {
    static create(paramarrayType: TypedArray): ReadElementNode$TypedFloatArrayReadElementCacheNode;
