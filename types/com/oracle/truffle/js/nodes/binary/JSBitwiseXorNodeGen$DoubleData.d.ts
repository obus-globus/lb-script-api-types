...
export class JSBitwiseXorNodeGen$DoubleData extends Node implements DSLSupport$SpecializationDataNode {
    constructor()
    // private leftInt32_: JSToInt32Node;
    // private rightInt32_: JSToInt32Node;
}