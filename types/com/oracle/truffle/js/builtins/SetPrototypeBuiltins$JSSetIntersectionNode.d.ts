...
export abstract class SetPrototypeBuiltins$JSSetIntersectionNode extends SetPrototypeBuiltins$JSSetNewOperation {
    ...
    intersection(set: JSSetObject, other: Object, getSetRecordNode: GetSetRecordNode, toBooleanNode: JSToBooleanNode, getIteratorFromMethodNode: GetIteratorFromMethodNode, thisSetSmallerProfile: InlinedBranchProfile): JSDynamicObject;
