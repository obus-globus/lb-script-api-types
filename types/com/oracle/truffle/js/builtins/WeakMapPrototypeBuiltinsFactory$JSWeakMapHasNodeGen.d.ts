...
export class WeakMapPrototypeBuiltinsFactory$JSWeakMapHasNodeGen extends WeakMapPrototypeBuiltins$JSWeakMapHasNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: (Object | null)[]): WeakMapPrototypeBuiltins$JSWeakMapHasNode;
    ...
    // private hasJSObject_invertedGetter_: DynamicObjectLibrary;
