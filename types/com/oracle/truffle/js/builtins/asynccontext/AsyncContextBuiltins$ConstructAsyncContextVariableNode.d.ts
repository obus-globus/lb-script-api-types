...
export abstract class AsyncContextBuiltins$ConstructAsyncContextVariableNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    construct(newTarget: JSDynamicObject, options: Object, isObject: IsObjectNode, toString: JSToStringNode, hasName: HasPropertyCacheNode, getName: PropertyGetNode, getDefaultValue: PropertyGetNode): JSObject;
