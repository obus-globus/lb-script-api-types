...
export class JSTextDecoder extends JSNonProxy implements JSConstructorFactory$Default, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSTextDecoder;
    static checkProtoCycle(paramthisObj: JSDynamicObject, paramnewPrototype: JSDynamicObject): boolean;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramencoding: TruffleString, paramtruffleStringEncoding: TruffleString$Encoding, paramfatal: boolean, paramignoreBOM: boolean): JSTextDecoderObject;
