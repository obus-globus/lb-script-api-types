...
export class PromiseFunctionBuiltinsFactory$PromiseCombinatorNodeGen extends PromiseFunctionBuiltins$PromiseCombinatorNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramperformPromiseOp: PerformPromiseCombinatorNode, paramarguments: (Object | null)[]): PromiseFunctionBuiltins$PromiseCombinatorNode;
