...
export class ArrayFunctionBuiltinsFactory$JSArrayFromNodeGen extends ArrayFunctionBuiltins$JSArrayFromNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisTypedArray: boolean, paramarguments: (Object | null)[]): ArrayFunctionBuiltins$JSArrayFromNode;
