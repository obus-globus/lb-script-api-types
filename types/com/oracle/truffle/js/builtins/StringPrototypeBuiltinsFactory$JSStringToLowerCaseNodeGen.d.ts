...
export class StringPrototypeBuiltinsFactory$JSStringToLowerCaseNodeGen extends StringPrototypeBuiltins$JSStringToLowerCaseNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramlocale: boolean, paramarguments: (Object | null)[]): StringPrototypeBuiltins$JSStringToLowerCaseNode;
