...
export class ConstructorBuiltinsFactory$ConstructBooleanNodeGen extends ConstructorBuiltins$ConstructBooleanNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructBooleanNode;
