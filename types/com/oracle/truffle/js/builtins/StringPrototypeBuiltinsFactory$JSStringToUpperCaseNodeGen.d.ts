...
export class StringPrototypeBuiltinsFactory$JSStringToUpperCaseNodeGen extends StringPrototypeBuiltins$JSStringToUpperCaseNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramlocale: boolean, paramarguments: (Object | null)[]): StringPrototypeBuiltins$JSStringToUpperCaseNode;
