...
export abstract class ObjectFunctionBuiltins$ObjectDefineOperation extends ObjectPrototypeBuiltins$ObjectOperation {
    ...
    intlDefineProperties(obj: JSObject, descs: JSDynamicObject): JSObject;
    toPropertyDescriptor(target: Object): PropertyDescriptor;
}