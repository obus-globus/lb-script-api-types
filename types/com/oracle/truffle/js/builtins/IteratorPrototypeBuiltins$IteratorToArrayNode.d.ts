...
export abstract class IteratorPrototypeBuiltins$IteratorToArrayNode extends IteratorPrototypeBuiltins$IteratorMethodNode {
    ...
    // private toArrayNode: IteratorToArrayNode;
    toArray(frame: VirtualFrame, thisObj: Object): Object;
}