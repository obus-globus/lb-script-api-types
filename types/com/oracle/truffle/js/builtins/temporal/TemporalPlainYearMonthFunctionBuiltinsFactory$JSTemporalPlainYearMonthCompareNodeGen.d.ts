...
export class TemporalPlainYearMonthFunctionBuiltinsFactory$JSTemporalPlainYearMonthCompareNodeGen extends TemporalPlainYearMonthFunctionBuiltins$JSTemporalPlainYearMonthCompareNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: (Object | null)[]): TemporalPlainYearMonthFunctionBuiltins$JSTemporalPlainYearMonthCompareNode;
