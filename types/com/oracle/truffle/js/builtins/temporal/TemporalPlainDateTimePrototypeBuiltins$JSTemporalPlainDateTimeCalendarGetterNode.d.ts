...
export abstract class TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeCalendarGetterNode extends JSBuiltinNode {
    ...
    calendarId(dateTime: JSTemporalPlainDateTimeObject, toCalendarIdentifier: ToTemporalCalendarIdentifierNode): TruffleString;
}