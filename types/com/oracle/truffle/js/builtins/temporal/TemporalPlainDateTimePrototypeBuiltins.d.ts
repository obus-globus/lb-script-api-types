...
export class TemporalPlainDateTimePrototypeBuiltins extends JSBuiltinsContainer$SwitchEnum<TemporalPlainDateTimePrototypeBuiltins$TemporalPlainDateTimePrototype> {
    ...
    constructor()
    createNode(context: JSContext, builtin: JSBuiltin, construct: boolean, newTarget: boolean, builtinEnum: TemporalPlainDateTimePrototypeBuiltins$TemporalPlainDateTimePrototype): Object;
}