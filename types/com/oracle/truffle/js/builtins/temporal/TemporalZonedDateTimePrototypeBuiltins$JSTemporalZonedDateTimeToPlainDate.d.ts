...
export abstract class TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeToPlainDate extends JSTemporalBuiltinOperation {
    ...
    toPlainDate(zdt: JSTemporalZonedDateTimeObject, errorBranch: InlinedBranchProfile): Object;
}