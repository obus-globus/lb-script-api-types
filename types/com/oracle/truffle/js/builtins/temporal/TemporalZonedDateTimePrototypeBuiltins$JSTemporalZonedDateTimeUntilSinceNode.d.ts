...
export abstract class TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeUntilSinceNode extends JSTemporalBuiltinOperation {
    ...
    // private sign: number;
    differenceTemporalZonedDateTime(zonedDateTime: JSTemporalZonedDateTimeObject, otherParam: Object, options: Object, node: Node, toTemporalZonedDateTime: ToTemporalZonedDateTimeNode, toCalendarIdentifier: ToTemporalCalendarIdentifierNode, toTimeZoneIdentifier: ToTemporalTimeZoneIdentifierNode, getDifferenceSettings: GetDifferenceSettingsNode, differenceZonedDateTimeWithRounding: DifferenceZonedDateTimeWithRoundingNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): Object;
}