...
export class ConstructorBuiltinsFactory$ConstructTemporalPlainDateTimeNodeGen extends ConstructorBuiltins$ConstructTemporalPlainDateTimeNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructTemporalPlainDateTimeNode;
