...
export interface ModifyExpressionValue extends Annotation, Object{
    constructor(allow: number, at: At[], expect: number, method: string[], order: number, remap: boolean, require: number, slice: Slice[])
