...
export class NewArrayExpression extends SimpleExpression {
    constructor(arg0: ExpressionSource, arg1: TypeIdentifier, arg2: Expression[], arg3: number)
    blankDims: number;
    dims: Expression[];
    innerType: TypeIdentifier;
    // private getBlankDims(arg0: AbstractInsnNode): number;
    // private getInnerType(arg0: AbstractInsnNode): Type;
