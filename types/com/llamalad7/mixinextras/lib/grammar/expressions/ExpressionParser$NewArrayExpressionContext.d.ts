...
export class ExpressionParser$NewArrayExpressionContext extends ExpressionParser$ExpressionContext {
    static EMPTY: ParserRuleContext;
    constructor(arg0: ExpressionParser$ExpressionContext)
    LeftBracket: Token;
    blankDims: Token[];
    dims: ExpressionParser$ExpressionContext[];
    expression: ExpressionParser$ExpressionContext;
    innerType: ExpressionParser$NameContext;
