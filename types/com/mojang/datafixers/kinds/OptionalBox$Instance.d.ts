...
export class OptionalBox$Instance extends Enum<OptionalBox$Instance> implements Applicative<OptionalBox$Mu, OptionalBox$Instance$Mu>, Traversable<OptionalBox$Mu, OptionalBox$Instance$Mu> {
    ...
    lift1(arg0: App<OptionalBox$Mu, (param0: A) => R>): (param0: App<OptionalBox$Mu, A>) => App<OptionalBox$Mu, R>;
    lift2(arg0: App<F, (param0: A, param1: B) => R>): (param0: App<F, A>, param1: App<F, B>) => App<F, R>;
    lift2(arg0: App<OptionalBox$Mu, (param0: A, param1: B) => R>): (param0: App<OptionalBox$Mu, A>, param1: App<OptionalBox$Mu, B>) => App<OptionalBox$Mu, R>;
    ...
    map(arg0: (param0: T) => R, arg1: App<OptionalBox$Mu, T>): App<OptionalBox$Mu, R>;
    point<A extends Object | number | string | boolean>(arg0: A): App<OptionalBox$Mu, A>;
    traverse(arg0: Applicative<F, Object>, arg1: (param0: A) => App<F, B>, arg2: App<OptionalBox$Mu, A>): App<F, App<OptionalBox$Mu, B>>;
    name(): "INSTANCE";
}