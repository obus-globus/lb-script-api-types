...
export class IdF$Instance extends Enum<IdF$Instance> implements Applicative<IdF$Mu, IdF$Instance$Mu>, Functor<IdF$Mu, IdF$Instance$Mu> {
    ...
    lift1(arg0: App<IdF$Mu, (param0: A) => R>): (param0: App<IdF$Mu, A>) => App<IdF$Mu, R>;
    lift2(arg0: App<F, (param0: A, param1: B) => R>): (param0: App<F, A>, param1: App<F, B>) => App<F, R>;
    lift2(arg0: App<IdF$Mu, (param0: A, param1: B) => R>): (param0: App<IdF$Mu, A>, param1: App<IdF$Mu, B>) => App<IdF$Mu, R>;
    ...
    map(arg0: (param0: T) => R, arg1: App<IdF$Mu, T>): App<IdF$Mu, R>;
    point<A extends Object | number | string | boolean>(arg0: A): App<IdF$Mu, A>;
    name(): "INSTANCE";
}