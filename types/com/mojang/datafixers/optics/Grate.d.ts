...
export interface Grate<S extends Object | number | string | boolean, T extends Object | number | string | boolean, A extends Object | number | string | boolean, B extends Object | number | string | boolean> extends App2<Grate$Mu<A, B>, S, T>, Optic<Closed$Mu, S, T, A, B>, Object{
    eval(arg0: App<Closed$Mu, P>): FunctionType<App2<P, A, B>, App2<P, S, T>>;
