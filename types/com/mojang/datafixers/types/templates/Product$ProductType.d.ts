...
export class Product$ProductType<F extends Object | number | string | boolean, G extends Object | number | string | boolean> extends Type<Pair<F, G>> {
    ...
    // private capLeft(arg0: TypedOptic<F, F2, FT, FR>): Either<TypedOptic<Pair<F, G>, Object, FT, FR>, Type$FieldNotFoundException>;
    // private capRight(arg0: TypedOptic<G, G2, FT, FR>): TypedOptic<Pair<F, G>, Object, FT, FR>;
    ...
    findTypeInChildren(arg0: Type<FT>, arg1: Type<FR>, arg2: Type$TypeMatcher<FT, FR>, arg3: boolean): Either<TypedOptic<Pair<F, G>, Object, FT, FR>, Type$FieldNotFoundException>;
    first(): Type<F>;
    hashCode(): number;
    mergeViews(arg0: RewriteResult<F, F2>, arg1: RewriteResult<G, G2>): RewriteResult<Pair<F, G>, Object>;
