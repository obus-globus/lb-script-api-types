...
export class Either$Instance<R2 extends Object | number | string | boolean> extends Object implements Applicative<Either$Mu<R2>, Either$Instance$Mu<R2>>, CocartesianLike<Either$Mu<R2>, R2, Either$Instance$Mu<R2>>, Traversable<Either$Mu<R2>, Either$Instance$Mu<R2>> {
    static unbox(paramarg0: App<Object, Object>): CocartesianLike<Object, Object, Object>;
    ...
    from(arg0: App<Either$Mu<R2>, A>): App<Either$Mu<R2>, A>;
    lift1(arg0: App<Either$Mu<R2>, (param0: A) => R>): (param0: App<Either$Mu<R2>, A>) => App<Either$Mu<R2>, R>;
    lift2(arg0: App<F, (param0: A, param1: B) => R>): (param0: App<F, A>, param1: App<F, B>) => App<F, R>;
    lift2(arg0: App<Either$Mu<R2>, (param0: A, param1: B) => R>): (param0: App<Either$Mu<R2>, A>, param1: App<Either$Mu<R2>, B>) => App<Either$Mu<R2>, R>;
    ...
    map(arg0: (param0: T) => R, arg1: App<Either$Mu<R2>, T>): App<Either$Mu<R2>, R>;
    point<A extends Object | number | string | boolean>(arg0: A): App<Either$Mu<R2>, A>;
    to(arg0: App<Either$Mu<R2>, A>): App<Either$Mu<R2>, A>;
    traverse(arg0: Applicative<F, Object>, arg1: (param0: A) => App<F, B>, arg2: App<T, A>): App<F, App<T, B>>;
    traverse(arg0: Applicative<F, Object>, arg1: (param0: A) => App<F, B>, arg2: App<Either$Mu<R2>, A>): App<F, App<Either$Mu<R2>, B>>;
}