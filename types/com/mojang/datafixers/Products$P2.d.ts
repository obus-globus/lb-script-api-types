...
export class Products$P2<F extends K1, T1 extends Object | number | string | boolean, T2 extends Object | number | string | boolean> extends Object {
    ...
    // private t1: App<F, T1>;
    // private t2: App<F, T2>;
    and(arg0: Products$P2<F, T3, T4>): Products$P4<F, T1, T2, T3, T4>;
    and(arg0: Products$P3<F, T3, T4, T5>): Products$P5<F, T1, T2, T3, T4, T5>;
    and(arg0: Products$P4<F, T3, T4, T5, T6>): Products$P6<F, T1, T2, T3, T4, T5, T6>;
    and(arg0: Products$P5<F, T3, T4, T5, T6, T7>): Products$P7<F, T1, T2, T3, T4, T5, T6, T7>;
    and(arg0: Products$P6<F, T3, T4, T5, T6, T7, T8>): Products$P8<F, T1, T2, T3, T4, T5, T6, T7, T8>;
    and(arg0: App<F, T3>): Products$P3<F, T1, T2, T3>;
    apply(arg0: Applicative<F, Object>, arg1: App<F, (param0: T1, param1: T2) => R>): App<F, R>;
    apply(arg0: Applicative<F, Object>, arg1: (param0: T1, param1: T2) => R): App<F, R>;
    t1(): App<F, T1>;
    t2(): App<F, T2>;
}