...
import type { DataResult$Instance$Mu } from '../../../com/mojang/serialization/DataResult$Instance$Mu.d.ts'
...
export class DataResult$Instance extends Enum<DataResult$Instance> implements Applicative<DataResult$Mu, DataResult$Instance$Mu> {
    ...
    ap2(arg0: App<DataResult$Mu, (param0: A, param1: B) => R>, arg1: App<DataResult$Mu, A>, arg2: App<DataResult$Mu, B>): App<DataResult$Mu, R>;
    ap3(arg0: App<F, Function3<T1, T2, T3, R>>, arg1: App<F, T1>, arg2: App<F, T2>, arg3: App<F, T3>): App<F, R>;
    ap3(arg0: App<DataResult$Mu, Function3<T1, T2, T3, R>>, arg1: App<DataResult$Mu, T1>, arg2: App<DataResult$Mu, T2>, arg3: App<DataResult$Mu, T3>): App<DataResult$Mu, R>;
    ...
    lift1(arg0: App<DataResult$Mu, (param0: A) => R>): (param0: App<DataResult$Mu, A>) => App<DataResult$Mu, R>;
    ...
    map(arg0: (param0: T) => R, arg1: App<DataResult$Mu, T>): App<DataResult$Mu, R>;
    point<A extends Object | number | string | boolean>(arg0: A): App<DataResult$Mu, A>;
    name(): "INSTANCE";
}