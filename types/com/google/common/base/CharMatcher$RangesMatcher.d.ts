...
export class CharMatcher$RangesMatcher extends CharMatcher {
    ...
    constructor(description: string, rangeStarts: string[], rangeEnds: string[])
    // private description: string;
    // private rangeEnds: string[];
    // private rangeStarts: string[];
