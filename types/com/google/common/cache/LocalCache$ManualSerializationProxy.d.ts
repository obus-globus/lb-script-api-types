...
export class LocalCache$ManualSerializationProxy<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends ForwardingCache<K, V> implements Serializable {
    private constructor(keyStrength: LocalCache$Strength, valueStrength: LocalCache$Strength, keyEquivalence: Equivalence<Object>, valueEquivalence: Equivalence<Object>, expireAfterWriteNanos: number, expireAfterAccessNanos: number, maxWeight: number, weigher: (param0: K, param1: V) => kotlin.Int, concurrencyLevel: number, removalListener: (param0: K) => void, ticker: Ticker, loader: CacheLoader<K, V>)
