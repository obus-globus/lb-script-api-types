...
export class TreeRangeMap$RangeMapEntry<K extends Comparable<Object>, V extends Object | number | string | boolean> extends AbstractMap$SimpleImmutableEntry<Range<K>, V> {
