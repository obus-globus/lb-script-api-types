...
export class Iterators extends Object {
    static addAll(paramaddTo: E[], paramiterator: Iterator<Object>): boolean;
    static advance(paramiterator: Iterator<Object>, paramnumberToAdvance: number): number;
    static all(paramiterator: Iterator<Object>, parampredicate: (param0: Object | null) => kotlin.Boolean): boolean;
    static any(paramiterator: Iterator<Object>, parampredicate: (param0: Object | null) => kotlin.Boolean): boolean;
    ...
    static concat(paraminputs: Object | null): Iterator<Object>;
    ...
    static filter(paramunfiltered: Iterator<Object>, paramretainIfTrue: (param0: Object | null) => kotlin.Boolean): UnmodifiableIterator<Object>;
    static find(paramiterator: Iterator<Object>, parampredicate: (param0: Object | null) => kotlin.Boolean, paramdefaultValue: Object | null): Object | null;
    static find(paramiterator: Iterator<Object>, parampredicate: (param0: Object | null) => kotlin.Boolean): Object | null;
    ...
    static indexOf(paramiterator: Iterator<Object>, parampredicate: (param0: Object | null) => kotlin.Boolean): number;
    static limit(paramiterator: Iterator<Object>, paramlimitSize: number): Iterator<Object>;
    static mergeSorted(paramiterators: (Object | null)[], paramcomparator: (param0: Object | null) => kotlin.Boolean): UnmodifiableIterator<Object>;
    static paddedPartition(paramiterator: Iterator<Object>, paramsize: number): UnmodifiableIterator<Object>;
    static partition(paramiterator: Iterator<Object>, paramsize: number): UnmodifiableIterator<Object>;
    ...
    static removeAll(paramremoveFrom: Iterator<Object>, paramelementsToRemove: E[]): boolean;
    static removeIf(paramremoveFrom: Iterator<Object>, parampredicate: (param0: Object | null) => kotlin.Boolean): boolean;
    static retainAll(paramremoveFrom: Iterator<Object>, paramelementsToRetain: E[]): boolean;
    ...
    static transform(paramfromIterator: Iterator<Object>, paramfunction: (param0: Object | null) => Object | null): Iterator<Object>;
    static tryFind(paramiterator: Iterator<Object>, parampredicate: (param0: Object | null) => kotlin.Boolean): Optional<Object>;
