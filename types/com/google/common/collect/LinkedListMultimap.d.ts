...
export class LinkedListMultimap<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
