...
export abstract class ForwardingListMultimap<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends ForwardingMultimap<K, V> implements ListMultimap<K, V> {
    constructor()
