...
export class LinearTransformation$RegularLinearTransformation extends LinearTransformation {
    ...
    constructor(slope: number, yIntercept: number, inverse: LinearTransformation)
