...
export class CrossCollisionStateHandler extends Record implements IBlockStateHandler {
    constructor(customAllowed: (param0: BlockState) => kotlin.Boolean)
    // private customAllowed: (param0: BlockState) => kotlin.Boolean;
    ...
    customAllowed(): (param0: BlockState) => kotlin.Boolean;
