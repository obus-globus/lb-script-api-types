...
export class ParserImpl$ParseBlockSequenceEntryKey extends Object implements Production {
    private constructor(null_: ParserImpl$ParseBlockSequenceEntryKey)
    produce(): Event;
}