...
export class ParserImpl$ParseFlowSequenceEntryMappingKey extends Object implements Production {
    private constructor(null_: ParserImpl$ParseFlowSequenceEntryMappingKey)
    produce(): Event;
}