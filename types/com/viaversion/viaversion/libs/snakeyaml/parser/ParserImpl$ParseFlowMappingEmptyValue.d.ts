...
export class ParserImpl$ParseFlowMappingEmptyValue extends Object implements Production {
    private constructor(null_: ParserImpl$ParseFlowMappingEmptyValue)
    produce(): Event;
}