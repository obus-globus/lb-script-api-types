...
export class ParserImpl$ParseIndentlessSequenceEntryKey extends Object implements Production {
    private constructor(null_: ParserImpl$ParseIndentlessSequenceEntryKey)
    produce(): Event;
}