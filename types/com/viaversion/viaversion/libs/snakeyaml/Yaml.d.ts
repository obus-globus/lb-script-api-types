...
export class Yaml extends Object {
    ...
    getName(): string;
    load<T extends Object | number | string | boolean>(arg0: InputStream): T;
    load<T extends Object | number | string | boolean>(arg0: Reader): T;
    load<T extends Object | number | string | boolean>(arg0: string): T;
    loadAll(arg0: InputStream): Object[];
    loadAll(arg0: Reader): Object[];
    loadAll(arg0: string): Object[];
    loadAs<T extends Object | number | string | boolean>(arg0: InputStream, arg1: Class<T>): T;
    loadAs<T extends Object | number | string | boolean>(arg0: Reader, arg1: Class<T>): T;
    loadAs<T extends Object | number | string | boolean>(arg0: string, arg1: Class<T>): T;
