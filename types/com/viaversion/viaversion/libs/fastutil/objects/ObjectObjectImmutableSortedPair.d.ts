...
export class ObjectObjectImmutableSortedPair<K extends Comparable<K>> extends ObjectObjectImmutablePair<K, K> implements SortedPair<K>, Serializable {
    static of(paramarg0: Object | null, paramarg1: Object | null): SortedPair<Object>;
    static of(paramarg0: Object | null, paramarg1: Object | null): ObjectObjectImmutableSortedPair<Object>;
