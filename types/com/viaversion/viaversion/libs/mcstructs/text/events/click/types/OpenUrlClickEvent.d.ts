...
export class OpenUrlClickEvent extends ClickEvent {
    ...
    // private url: OpenUrlClickEvent$UrlHolder;
    asString(): string;
    asUri(): URI;
    canEqual(arg0: Object): boolean;
    equals(arg0: Object | null): boolean;
    getHolder(): OpenUrlClickEvent$UrlHolder;
    hashCode(): number;
    setHolder(arg0: OpenUrlClickEvent$UrlHolder): OpenUrlClickEvent;
    setUrl(arg0: URI): OpenUrlClickEvent;
    setUrl(arg0: string): OpenUrlClickEvent;
    toString(): string;
}