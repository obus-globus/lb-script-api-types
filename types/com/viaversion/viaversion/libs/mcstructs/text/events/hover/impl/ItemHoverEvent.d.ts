...
import type { ItemHoverEvent$LegacyHolder } from '../../../../../../../../../com/viaversion/viaversion/libs/mcstructs/text/events/hover/impl/ItemHoverEvent$LegacyHolder.d.ts'
import type { ItemHoverEvent$ModernHolder } from '../../../../../../../../../com/viaversion/viaversion/libs/mcstructs/text/events/hover/impl/ItemHoverEvent$ModernHolder.d.ts'
...
export class ItemHoverEvent extends HoverEvent {
    ...
    constructor(arg0: ItemHoverEvent$DataHolder)
    constructor(arg0: string)
    readonly data: ItemHoverEvent$DataHolder;
    asLegacy(): ItemHoverEvent$LegacyHolder;
    asModern(): ItemHoverEvent$ModernHolder;
    canEqual(arg0: Object): boolean;
    equals(arg0: Object | null): boolean;
    getData(): ItemHoverEvent$DataHolder;
    hashCode(): number;
    isLegacy(): boolean;
    isModern(): boolean;
    setData(arg0: string): ItemHoverEvent;
    setLegacyData(arg0: string): ItemHoverEvent;
    setModernData(arg0: Identifier, arg1: number, arg2: Map$Entry<string, Tag>[]): ItemHoverEvent;
    toString(): string;
}