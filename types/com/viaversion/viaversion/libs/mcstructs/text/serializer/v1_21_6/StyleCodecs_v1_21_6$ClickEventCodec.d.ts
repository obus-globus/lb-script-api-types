...
export class StyleCodecs_v1_21_6$ClickEventCodec extends Object {
    ...
    static CUSTOM: MapCodec<CustomClickEvent>;
    ...
    static SHOW_DIALOG: MapCodec<ShowDialogClickEvent>;
