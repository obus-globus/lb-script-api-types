...
export class FieldMapCodec<T extends Object | number | string | boolean> extends Object implements MapCodec<T> {
    static UNIT: MapCodec<boolean>;
    static builder(paramarg0: Codec<Object>, paramarg1: string): FieldMapCodec$Builder$Stage1<Object>;
    static either(paramarg0: MapCodec<Object>, paramarg1: MapCodec<Object>): MapCodec<Object>;
    static failing(paramarg0: string): MapCodec<Object>;
    static lazyInit(paramarg0: () => Object | null): MapCodec<Object>;
    ...
    static recursive(paramarg0: (param0: Object | null) => Object | null): MapCodec<Object>;
    ...
    constructor(arg0: Codec<T>, arg1: string, arg2: boolean, arg3: boolean)
