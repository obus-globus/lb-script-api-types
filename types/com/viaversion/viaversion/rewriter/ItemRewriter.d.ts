...
export class ItemRewriter<C extends ClientboundPacketType, S extends ServerboundPacketType, T extends Protocol<C, Object, Object, S>> extends RewriterBase<T> implements ItemRewriter<T> {
    constructor(arg0: T)
