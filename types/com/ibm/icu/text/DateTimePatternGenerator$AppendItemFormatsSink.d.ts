...
export class DateTimePatternGenerator$AppendItemFormatsSink extends UResource$Sink {
    private constructor(null_: DateTimePatternGenerator$AppendItemFormatsSink)
