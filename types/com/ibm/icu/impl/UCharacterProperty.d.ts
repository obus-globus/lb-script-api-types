...
import type { UCharacterProperty$IntProperty } from '../../../../com/ibm/icu/impl/UCharacterProperty$IntProperty.d.ts'
...
export class UCharacterProperty extends Object {
    ...
    static getEuropeanDigit(paramarg0: number): number;
    ...
    digit(arg0: number): number;
    getAdditional(arg0: number, arg1: number): number;
    getAge(arg0: number): VersionInfo;
    getIDTypes(arg0: number, arg1: UCharacter$IdentifierType[]): number;
    getIntPropertyMaxValue(arg0: number): number;
    getIntPropertyValue(arg0: number, arg1: number): number;
    getMaxValues(arg0: number): number;
    getNumericValue(arg0: number): number;
    getProperty(arg0: number): number;
    getSource(arg0: number): number;
    getType(arg0: number): number;
    getUnicodeNumericValue(arg0: number): number;
    hasBinaryProperty(arg0: number, arg1: number): boolean;
    hasIDType(arg0: number, arg1: UCharacter$IdentifierType): boolean;
    hasIDType(arg0: number, arg1: number): boolean;
    ublock_addPropertyStarts(arg0: string[]): void;
    upropsvec_addPropertyStarts(arg0: string[]): void;
}