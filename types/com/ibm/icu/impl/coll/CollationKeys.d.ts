...
export class CollationKeys extends Object {
    ...
    static writeSortKeyUpToQuaternary(paramarg0: CollationIterator, paramarg1: (Object | null)[], paramarg2: CollationSettings, paramarg3: CollationKeys$SortKeyByteSink, paramarg4: number, paramarg5: CollationKeys$LevelCallback, paramarg6: boolean): void;
    private constructor()
}