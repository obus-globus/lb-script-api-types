...
import type { Precision$IncrementRounderImpl } from '../../../../../../../org/graalvm/shadowed/com/ibm/icu/number/Precision$IncrementRounderImpl.d.ts'
import type { Currency$CurrencyUsage } from '../../../../../../../org/graalvm/shadowed/com/ibm/icu/util/Currency$CurrencyUsage.d.ts'
export class Precision$IncrementFiveRounderImpl extends Precision$IncrementRounderImpl {
    ...
    constructor(increment: BigDecimal, minFrac: number, maxFrac: number)
    // private maxFrac: number;
    // private minFrac: number;
    apply(value: DecimalQuantity): void;
    createCopy(): Precision$IncrementFiveRounderImpl;
}