...
export class Precision$IncrementRounderImpl extends Precision {
    ...
    constructor(increment: BigDecimal)
    // private increment: BigDecimal;
    apply(value: DecimalQuantity): void;
    createCopy(): Precision$IncrementRounderImpl;
}