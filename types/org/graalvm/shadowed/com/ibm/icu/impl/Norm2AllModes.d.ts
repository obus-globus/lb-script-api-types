...
import type { Norm2AllModes$ComposeNormalizer2 } from '../../../../../../../org/graalvm/shadowed/com/ibm/icu/impl/Norm2AllModes$ComposeNormalizer2.d.ts'
import type { Norm2AllModes$DecomposeNormalizer2 } from '../../../../../../../org/graalvm/shadowed/com/ibm/icu/impl/Norm2AllModes$DecomposeNormalizer2.d.ts'
import type { Norm2AllModes$FCDNormalizer2 } from '../../../../../../../org/graalvm/shadowed/com/ibm/icu/impl/Norm2AllModes$FCDNormalizer2.d.ts'
import type { Norm2AllModes$NoopNormalizer2 } from '../../../../../../../org/graalvm/shadowed/com/ibm/icu/impl/Norm2AllModes$NoopNormalizer2.d.ts'
...
export class Norm2AllModes extends Object {
    ...
    static getInstance(parambytes: ByteBuffer, paramname: string): Norm2AllModes;
    static getN2WithImpl(paramindex: number): Norm2AllModes$Normalizer2WithImpl;
    ...
    private constructor(ni: Normalizer2Impl)
