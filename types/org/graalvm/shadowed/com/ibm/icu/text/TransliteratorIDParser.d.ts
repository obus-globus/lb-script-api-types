...
export class TransliteratorIDParser extends Object {
    static IDtoSTV(paramid: string): (Object | null)[];
    static STVtoID(paramsource: string, paramtarget: string, paramvariant: string): string;
    static parseCompoundID(paramid: string, paramdir: number, paramcanonID: StringBuffer, paramlist: TransliteratorIDParser$SingleID[], paramglobalFilter: (Object | null)[]): boolean;
