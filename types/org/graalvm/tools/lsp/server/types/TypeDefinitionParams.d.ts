...
export class TypeDefinitionParams extends TextDocumentPositionParams {
    static create(paramtextDocument: TextDocumentIdentifier, paramposition: Position): TextDocumentPositionParams;
    static create(paramtextDocument: TextDocumentIdentifier, paramposition: Position): TypeDefinitionParams;
    constructor(jsonData: JSONObject)
    equals(obj: Object | null): boolean;
    getPartialResultToken(): Object;
    getWorkDoneToken(): Object;
    hashCode(): number;
    setPartialResultToken(partialResultToken: Object): TypeDefinitionParams;
    setWorkDoneToken(workDoneToken: Object): TypeDefinitionParams;
}