...
export class DocumentColorParams extends WorkDoneProgressParams {
    static create(paramtextDocument: TextDocumentIdentifier): DocumentColorParams;
    ...
    hashCode(): number;
    setPartialResultToken(partialResultToken: Object): DocumentColorParams;
    setTextDocument(textDocument: TextDocumentIdentifier): DocumentColorParams;
}