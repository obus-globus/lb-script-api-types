...
export class ImplementationParams extends TextDocumentPositionParams {
    static create(paramtextDocument: TextDocumentIdentifier, paramposition: Position): ImplementationParams;
    ...
    hashCode(): number;
    setPartialResultToken(partialResultToken: Object): ImplementationParams;
    setWorkDoneToken(workDoneToken: Object): ImplementationParams;
}