...
import type { EXTDebugProc } from '../../../org/lwjgl/openal/EXTDebugProc.d.ts'
import type { EXTDebugProcI } from '../../../org/lwjgl/openal/EXTDebugProcI.d.ts'
import type { Callback$Descriptor } from '../../../org/lwjgl/system/Callback$Descriptor.d.ts'
export class EXTDebugProc$Container extends EXTDebugProc {
    ...
    static create(paramarg0: number): EXTDebugProc;
    static create(paramarg0: (param0: number, param1: number, param2: number, param3: number, param4: number, param5: number, param6: number) => void): EXTDebugProc;
    static createSafe(paramarg0: number): EXTDebugProc;
