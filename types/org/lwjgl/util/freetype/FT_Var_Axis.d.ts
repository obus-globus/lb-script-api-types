...
export class FT_Var_Axis extends Struct<FT_Var_Axis> {
    ...
    static STRID: number;
    static TAG: number;
    static create(paramarg0: number): FT_Var_Axis;
    static create(paramarg0: number, paramarg1: number): (Object | null)[];
    static createSafe(paramarg0: number): FT_Var_Axis;
    static createSafe(paramarg0: number, paramarg1: number): (Object | null)[];
    static ndef(paramarg0: number): number;
