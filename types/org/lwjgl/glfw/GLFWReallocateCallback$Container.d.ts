...
export class GLFWReallocateCallback$Container extends GLFWReallocateCallback {
    ...
    static create(paramarg0: (param0: number, param1: number, param2: number) => kotlin.Long): GLFWReallocateCallback;
    ...
    constructor(arg0: number, arg1: (param0: number, param1: number, param2: number) => kotlin.Long)
    // private delegate: (param0: number, param1: number, param2: number) => kotlin.Long;
