...
import type { GLFWScrollCallback } from '../../../org/lwjgl/glfw/GLFWScrollCallback.d.ts'
import type { GLFWScrollCallbackI } from '../../../org/lwjgl/glfw/GLFWScrollCallbackI.d.ts'
import type { Callback$Descriptor } from '../../../org/lwjgl/system/Callback$Descriptor.d.ts'
export class GLFWScrollCallback$Container extends GLFWScrollCallback {
    ...
    static create(paramarg0: number): GLFWScrollCallback;
    static create(paramarg0: (param0: number, param1: number, param2: number) => void): GLFWScrollCallback;
    static createSafe(paramarg0: number): GLFWScrollCallback;
