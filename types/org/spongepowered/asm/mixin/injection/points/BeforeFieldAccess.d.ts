...
export class BeforeFieldAccess extends BeforeInvoke {
    static ARRAY_SEARCH_FUZZ_DEFAULT: number;
    ...
    // private arrOpcode: number;
    readonly fuzzFactor: number;
    // private opcode: number;
    addInsn(arg0: AbstractInsnNode[], arg1: E[], arg2: AbstractInsnNode): boolean;
    getArrayOpcode(): number;
    // private getArrayOpcode(arg0: string): number;
    getFuzzFactor(): number;
    matchesInsn(arg0: AbstractInsnNode): boolean;
}