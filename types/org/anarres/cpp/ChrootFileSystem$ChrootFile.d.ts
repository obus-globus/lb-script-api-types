...
export class ChrootFileSystem$ChrootFile extends File implements VirtualFile {
    ...
    constructor(null_: ChrootFileSystem$ChrootFile, arg1: File, arg2: string)
    constructor(null_: ChrootFileSystem$ChrootFile, arg1: string)
    constructor(null_: ChrootFileSystem$ChrootFile, arg1: string, arg2: string)
    // private rfile: File;
