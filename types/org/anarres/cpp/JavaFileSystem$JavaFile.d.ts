...
export class JavaFileSystem$JavaFile extends File implements VirtualFile {
    ...
    constructor(null_: JavaFileSystem$JavaFile, arg1: File, arg2: string)
    constructor(null_: JavaFileSystem$JavaFile, arg1: string)
    constructor(null_: JavaFileSystem$JavaFile, arg1: string, arg2: string)
