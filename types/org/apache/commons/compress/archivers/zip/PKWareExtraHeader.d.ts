...
export abstract class PKWareExtraHeader extends Object implements ZipExtraField {
    static EXTRAFIELD_HEADER_SIZE: number;
    constructor(arg0: ZipShort)
    // private centralData: number[];
    readonly headerId: ZipShort;
    // private localData: number[];
    assertMinimalLength(arg0: number, arg1: number): void;
