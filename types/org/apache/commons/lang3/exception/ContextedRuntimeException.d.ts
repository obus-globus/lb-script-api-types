...
export class ContextedRuntimeException extends RuntimeException implements ExceptionContext {
    constructor()
    ...
    addContextValue(arg0: string, arg1: Object): ContextedRuntimeException;
    ...
    setContextValue(arg0: string, arg1: Object): ContextedRuntimeException;
}