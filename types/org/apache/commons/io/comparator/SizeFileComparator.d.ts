...
export class SizeFileComparator extends AbstractFileComparator implements Serializable {
    static SIZE_COMPARATOR: (param0: File) => kotlin.Boolean;
    static SIZE_REVERSE: (param0: File) => kotlin.Boolean;
    static SIZE_SUMDIR_COMPARATOR: (param0: File) => kotlin.Boolean;
    static SIZE_SUMDIR_REVERSE: (param0: File) => kotlin.Boolean;
    constructor()
