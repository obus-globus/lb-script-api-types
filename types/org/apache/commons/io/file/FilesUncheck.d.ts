...
export class FilesUncheck extends Object {
    ...
    static find(paramarg0: Path[][], paramarg1: number, paramarg2: (param0: Path[][], param1: BasicFileAttributes) => kotlin.Boolean, paramarg3: (Object | null)[]): Stream<Path[][]>;
    ...
    static newByteChannel(paramarg0: Path[][], paramarg1: (Object | null)[], paramarg2: Object | null): SeekableByteChannel;
    static newDirectoryStream(paramarg0: Path[][]): T[];
    static newDirectoryStream(paramarg0: Path[][], paramarg1: string): T[];
    static newDirectoryStream(paramarg0: Path[][], paramarg1: (param0: Object | null) => kotlin.Boolean): T[];
    ...
    static write(paramarg0: Path[][], paramarg1: (Object | null)[], paramarg2: Charset, paramarg3: (Object | null)[]): Path[][];
    static write(paramarg0: Path[][], paramarg1: (Object | null)[], paramarg2: (Object | null)[]): Path[][];
    private constructor()
}