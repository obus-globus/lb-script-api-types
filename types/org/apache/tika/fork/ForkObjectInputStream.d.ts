...
export class ForkObjectInputStream extends ObjectInputStream {
    ...
    static readObject(paramarg0: DataInputStream, paramarg1: ClassLoader): Object;
    static sendObject(paramarg0: Object, paramarg1: DataOutputStream): void;
