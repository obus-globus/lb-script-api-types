...
export class AbstractStyleNameConverter$Black extends AbstractStyleNameConverter {
    static CATEGORY: string;
    static newInstance(paramconfig: Configuration, paramoptions: (Object | null)[]): AbstractStyleNameConverter$Black;
