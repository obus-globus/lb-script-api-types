...
export class RollingRandomAccessFileManager$FactoryData extends ConfigurationFactoryData {
    constructor(fileName: string, pattern: string, append: boolean, immediateFlush: boolean, bufferSize: number, policy: TriggeringPolicy, strategy: RolloverStrategy, advertiseURI: string, layout: Layout<Serializable>, filePermissions: string, fileOwner: string, fileGroup: string, configuration: Configuration)
