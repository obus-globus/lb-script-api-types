...
export abstract class AbstractNoSqlConnection<W extends Object | number | string | boolean, T extends NoSqlObject<W>> extends Object implements NoSqlConnection<W, T> {
    constructor()
