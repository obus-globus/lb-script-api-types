...
export class MemoryMappedFileManager extends OutputStreamManager {
    static getFileManager(paramfileName: string, paramappend: boolean, paramimmediateFlush: boolean, paramregionLength: number, paramadvertiseURI: string, paramlayout: Layout<Object>): MemoryMappedFileManager;
