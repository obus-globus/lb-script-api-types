...
export class NetherChannelOption<T extends Object | number | string | boolean> extends ChannelOption<T> {
    ...
    static NETHER_CLIENT_HANDSHAKE_TIMEOUT_MS: ChannelOption<number>;
    static NETHER_CLIENT_MAX_HANDSHAKE_ATTEMPTS: ChannelOption<number>;
    static NETHER_PORT_ALLOCATOR_CONFIG: ChannelOption<PortAllocatorConfig>;
    static NETHER_SERVER_RTC_HANDSHAKE_TIMEOUT_SECONDS: ChannelOption<number>;
