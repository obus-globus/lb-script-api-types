...
export class AnnotationsContainerWithConstants<A extends Object | number | string | boolean, C extends Object | number | string | boolean> extends AbstractBinaryClassAnnotationLoader$AnnotationsContainer<A> {
