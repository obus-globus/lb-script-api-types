...
export class ReadKotlinClassHeaderAnnotationVisitor$KotlinSerializedIrArgumentVisitor extends Object implements KotlinJvmBinaryClass$AnnotationArgumentVisitor {
    private constructor(null_: ReadKotlinClassHeaderAnnotationVisitor$KotlinSerializedIrArgumentVisitor)
    // private serializedIrArrayVisitor(): KotlinJvmBinaryClass$AnnotationArrayArgumentVisitor;
