...
export class DeepRecursiveScopeImpl<T extends Object | number | string | boolean, R extends Object | number | string | boolean> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    constructor(block: Function3<Object, Object, Object, Object>, value: T)
    ...
    // private crossFunctionCompletion(currentFunction: Function3<Object, Object, Object, Object>, cont: Continuation<Object>): Continuation<Object>;
