...
export class FreeBsdOSThread extends AbstractOSThread {
    ...
    constructor(arg0: number, arg1: { [key in FreeBsdOSProcess$PsThreadColumns]: string })
    ...
    // private updateAttributes(arg0: { [key in FreeBsdOSProcess$PsThreadColumns]: string }): boolean;
}