...
export class Placeholder<Ctx extends Object | number | string | boolean, T extends Object | number | string | boolean> extends Record {
    constructor(identifier: Identifier, argumentParser: ArgumentParser<T>, handler: (param0: Ctx, param1: T) => eu.pb4.placeholders.api.PlaceholderResult)
    // private argumentParser: ArgumentParser<T>;
    // private handler: (param0: Ctx, param1: T) => eu.pb4.placeholders.api.PlaceholderResult;
    // private identifier: Identifier;
    argumentParser(): ArgumentParser<T>;
    equals(arg0: Object | null): boolean;
    handler(): (param0: Ctx, param1: T) => eu.pb4.placeholders.api.PlaceholderResult;
    hashCode(): number;
