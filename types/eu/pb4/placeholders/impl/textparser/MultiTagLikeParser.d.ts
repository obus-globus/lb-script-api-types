...
export class MultiTagLikeParser extends TagLikeParser {
    ...
    constructor(arg0: Pair<TagLikeParser$Format, TagLikeParser$Provider>[])
    // private pairs: Pair<TagLikeParser$Format, TagLikeParser$Provider>[];
    handleLiteral(arg0: string, arg1: TagLikeParser$Context): void;
    pairs(): Pair<TagLikeParser$Format, TagLikeParser$Provider>[];
}