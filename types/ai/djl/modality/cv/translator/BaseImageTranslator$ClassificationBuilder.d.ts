...
export abstract class BaseImageTranslator$ClassificationBuilder<T extends BaseImageTranslator$BaseBuilder<BaseImageTranslator$BaseBuilder<Object>>> extends BaseImageTranslator$BaseBuilder<T> {
    constructor()
