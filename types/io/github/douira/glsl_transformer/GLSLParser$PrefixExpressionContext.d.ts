...
export class GLSLParser$PrefixExpressionContext extends GLSLParser$FiniteExpressionContext {
    ...
    BITWISE_NEG_OP(): TerminalNode;
    DEC_OP(): TerminalNode;
    INC_OP(): TerminalNode;
    LOGICAL_NOT_OP(): TerminalNode;
    MINUS_OP(): TerminalNode;
    PLUS_OP(): TerminalNode;
