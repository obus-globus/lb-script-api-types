...
export class SubtractionAssignmentExpression extends BinaryExpression {
    ...
    clone(): SubtractionAssignmentExpression;
    cloneInto(arg0: Root): SubtractionAssignmentExpression;
