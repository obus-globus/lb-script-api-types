...
export class EnumASTTransformer<J extends JobParameters, E extends Enum<E>> extends GroupedASTTransformer<J, E, Map<E, string>, Map<E, TranslationUnit>> {
    static _getInternalInstance(): ASTParser;
    constructor(arg0: Class<E>)
    constructor(arg0: (param0: Map<E, TranslationUnit>) => void, arg1: Class<E>)
    setEnumType(arg0: Class<E>): void;
    setResultMapSupplier(arg0: () => Map<E, string>): void;
    setTuMapSupplier(arg0: () => Map<E, TranslationUnit>): void;
}