...
export class LinkedHashMapSerializer<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends MapLikeSerializer<K, V, Map<K, V>, Map<K, V>> {
