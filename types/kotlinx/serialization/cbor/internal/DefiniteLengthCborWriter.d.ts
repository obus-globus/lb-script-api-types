...
import type { CborWriter$Data } from '../../../../kotlinx/serialization/cbor/internal/CborWriter$Data.d.ts'
import type { SerialDescriptor } from '../../../../kotlinx/serialization/descriptors/SerialDescriptor.d.ts'
import type { CompositeEncoder } from '../../../../kotlinx/serialization/encoding/CompositeEncoder.d.ts'
export class DefiniteLengthCborWriter extends CborWriter {
    constructor(cbor: Cbor, output: ByteArrayOutput)
    // private structureStack: CborWriter$Data[];
