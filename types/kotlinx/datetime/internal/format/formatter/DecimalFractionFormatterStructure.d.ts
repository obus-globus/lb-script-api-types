...
export class DecimalFractionFormatterStructure<T extends Object | number | string | boolean> extends Object implements FormatterStructure<T> {
    constructor(number: Function1<T, DecimalFraction>, minDigits: number, maxDigits: number, zerosToAdd: number[])
