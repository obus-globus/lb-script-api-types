...
export class DateTimeComponents$Companion extends Object {
    Format(block: Function1<DateTimeFormatBuilder$WithDateTimeComponents, void>): DateTimeFormat<DateTimeComponents>;
}