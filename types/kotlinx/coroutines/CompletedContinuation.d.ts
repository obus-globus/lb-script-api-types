...
export class CompletedContinuation<R extends Object | number | string | boolean> extends Object {
    constructor(result: R, cancelHandler: CancelHandler | null, onCancellation: Function3<Throwable, R, CoroutineContext, void> | null, idempotentResume: Object | null, cancelCause: Throwable | null)
    cancelCause: Throwable | null;
    cancelHandler: CancelHandler | null;
    readonly cancelled: boolean;
    idempotentResume: Object | null;
    onCancellation: (param0: Throwable, param1: R, param2: CoroutineContext) => void;
    result: R;
    component1(): R;
    component2(): CancelHandler | null;
    component3(): Function3<Throwable, R, CoroutineContext, void> | null;
    component4(): Object | null;
    component5(): Throwable | null;
    copy(result: R, cancelHandler: CancelHandler | null, onCancellation: Function3<Throwable, R, CoroutineContext, void> | null, idempotentResume: Object | null, cancelCause: Throwable | null): CompletedContinuation<R>;
