...
export abstract class HttpClient extends Object implements AutoCloseable {
    ...
    send(arg0: HttpRequest, arg1: (param0: T) => java.net.http.HttpResponse.BodySubscriber<unknown>): HttpResponse<T>;
    sendAsync(arg0: HttpRequest, arg1: (param0: T) => java.net.http.HttpResponse.BodySubscriber<unknown>): CompletableFuture<HttpResponse<T>>;
    sendAsync(arg0: HttpRequest, arg1: (param0: T) => java.net.http.HttpResponse.BodySubscriber<unknown>, arg2: HttpResponse$PushPromiseHandler<T>): CompletableFuture<HttpResponse<T>>;
    shutdown(): void;
    shutdownNow(): void;
