...
export class ConcurrentHashMap$BaseIterator<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends ConcurrentHashMap$Traverser<K, V> {
