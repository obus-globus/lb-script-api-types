...
export class ConcurrentHashMap$MapReduceKeysToLongTask<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends ConcurrentHashMap$BulkTask<K, V, number> {
    ...
    constructor(arg0: ConcurrentHashMap$BulkTask<K, V, Object>, arg1: number, arg2: number, arg3: number, arg4: ConcurrentHashMap$Node<K, V>[], arg5: ConcurrentHashMap$MapReduceKeysToLongTask<K, V>, arg6: (param0: K) => kotlin.Long, arg7: number, arg8: (param0: number, param1: number) => kotlin.Long)
    // private basis: number;
    // private nextRight: ConcurrentHashMap$MapReduceKeysToLongTask<K, V>;
    // private reducer: (param0: number, param1: number) => kotlin.Long;
    // private result: number;
    // private rights: ConcurrentHashMap$MapReduceKeysToLongTask<K, V>;
    // private transformer: (param0: K) => kotlin.Long;
    compute(): void;
    getRawResult(): number;
}