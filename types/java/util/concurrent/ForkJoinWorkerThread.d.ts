...
export class ForkJoinWorkerThread extends Thread {
    ...
    static yield(): void;
    constructor(arg0: ThreadGroup, arg1: ForkJoinPool, arg2: boolean)
    constructor(arg0: ThreadGroup, arg1: ForkJoinPool, arg2: boolean, arg3: boolean)
    constructor(arg0: ForkJoinPool)
    readonly pool: ForkJoinPool;
    // private workQueue: ForkJoinPool$WorkQueue;
    getPool(): ForkJoinPool;
    getPoolIndex(): number;
    getQueuedTaskCount(): number;
    onStart(): void;
    onTermination(arg0: Throwable): void;
    onThreadLocalReset(): void;
    resetThreadLocals(): void;
    run(): void;
}