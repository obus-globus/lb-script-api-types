...
export class AtomicIntegerArray extends Object implements Serializable {
    constructor(arg0: number)
    constructor(arg0: number[])
    // private array: number[];
    accumulateAndGet(arg0: number, arg1: number, arg2: (param0: number, param1: number) => kotlin.Int): number;
    ...
    getAndAccumulate(arg0: number, arg1: number, arg2: (param0: number, param1: number) => kotlin.Int): number;
    ...
    getAndUpdate(arg0: number, arg1: (param0: number) => kotlin.Int): number;
    ...
    toString(): string;
    updateAndGet(arg0: number, arg1: (param0: number) => kotlin.Int): number;
