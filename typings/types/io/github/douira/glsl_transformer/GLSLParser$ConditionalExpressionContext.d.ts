...
export class GLSLParser$ConditionalExpressionContext extends GLSLParser$FiniteExpressionContext {
    static EMPTY: ParserRuleContext;
    constructor(arg0: GLSLParser$FiniteExpressionContext)
    condition: GLSLParser$FiniteExpressionContext;
    falseAlternative: GLSLParser$FiniteExpressionContext;
    trueAlternative: GLSLParser$FiniteExpressionContext;
    COLON(): TerminalNode;
    QUERY_OP(): TerminalNode;
