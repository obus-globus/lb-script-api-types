...
export class LeftShiftAssignmentExpression extends BinaryExpression {
    ...
    clone(): LeftShiftAssignmentExpression;
    cloneInto(arg0: Root): LeftShiftAssignmentExpression;
