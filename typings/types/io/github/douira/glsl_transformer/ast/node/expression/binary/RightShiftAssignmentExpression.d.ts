...
export class RightShiftAssignmentExpression extends BinaryExpression {
    ...
    clone(): RightShiftAssignmentExpression;
    cloneInto(arg0: Root): RightShiftAssignmentExpression;
