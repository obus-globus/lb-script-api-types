...
export class MultiplicationAssignmentExpression extends BinaryExpression {
    ...
    clone(): MultiplicationAssignmentExpression;
    cloneInto(arg0: Root): MultiplicationAssignmentExpression;
