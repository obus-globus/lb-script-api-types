...
export class BitwiseOrAssignmentExpression extends BinaryExpression {
    ...
    clone(): BitwiseOrAssignmentExpression;
    cloneInto(arg0: Root): BitwiseOrAssignmentExpression;
