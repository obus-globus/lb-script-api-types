...
export class BitwiseAndAssignmentExpression extends BinaryExpression {
    ...
    clone(): BitwiseAndAssignmentExpression;
    cloneInto(arg0: Root): BitwiseAndAssignmentExpression;
