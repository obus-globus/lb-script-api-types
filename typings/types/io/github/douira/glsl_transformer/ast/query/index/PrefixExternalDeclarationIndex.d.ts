...
export class PrefixExternalDeclarationIndex<S extends ExternalDeclarationIndex$DeclarationEntry[], I extends { [key: string]: any }> extends ExternalDeclarationIndex<S, I> implements PrefixQueryable<S, ExternalDeclarationIndex$DeclarationEntry> {
    static withOnlyExact(paramarg0: () => Object | null): ExternalDeclarationIndex<any, { [key: string]: Object | null }>;
    ...
    static withPermuterm(paramarg0: () => Object | null): PrefixExternalDeclarationIndex<any, Map<Object | null, ExternalDeclarationIndex$DeclarationEntry>>;
    ...
    static withPrefix(paramarg0: () => Object | null): PrefixExternalDeclarationIndex<any, Map<Object | null, ExternalDeclarationIndex$DeclarationEntry>>;
    ...
    static withPrefixSuffix(paramarg0: () => Object | null): PrefixExternalDeclarationIndex<any, Map<Object | null, ExternalDeclarationIndex$DeclarationEntry>>;
