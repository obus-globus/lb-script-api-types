...
export class LiteralToken extends PrintToken {
    constructor(arg0: TokenRole, arg1: string)
    constructor(arg0: TokenChannel, arg1: TokenRole, arg2: string)
    constructor(arg0: TokenChannel, arg1: string)
