...
export class ASTPrinter extends ASTPrinterBase {
    static print(paramarg0: PrintType, paramarg1: ASTNode): string;
    static printAST(paramarg0: TokenProcessor, paramarg1: ASTNode): string;
    static printCompact(paramarg0: ASTNode): string;
    ...
    // private visitLoopBody(arg0: Statement): void;
