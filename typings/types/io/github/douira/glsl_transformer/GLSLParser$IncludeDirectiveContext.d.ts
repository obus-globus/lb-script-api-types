...
export class GLSLParser$IncludeDirectiveContext extends ParserRuleContext {
    ...
    NR(): TerminalNode;
    NR_EOL(): TerminalNode;
    NR_INCLUDE(): TerminalNode;
    NR_SA_CONTENT(): TerminalNode;
    NR_SA_STRING_END(): TerminalNode;
    NR_STRING_START(): TerminalNode;
