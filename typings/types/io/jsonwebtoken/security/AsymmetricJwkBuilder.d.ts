...
export interface AsymmetricJwkBuilder<K extends Key, J extends { [key: string]: any }, T extends AsymmetricJwkBuilder<K, J, T>> extends JwkBuilder<K, J, T>, X509Builder<T>, Object{
