...
export class DefaultJwtParser extends AbstractParser<Jwt<Object, Object>> implements JwtParser {
    ...
    constructor(arg0: Provider, arg1: SigningKeyResolver, arg2: boolean, arg3: boolean, arg4: Locator<Key>, arg5: Clock, arg6: string[], arg7: number, arg8: DefaultClaims, arg9: Decoder<InputStream, InputStream>, arg10: Deserializer<{ [key: string]: Object | null }>, arg11: CompressionCodecResolver, arg12: { [key: string]: CompressionAlgorithm }, arg13: { [key: string]: SecureDigestAlgorithm<Object, Object> }, arg14: { [key: string]: KeyAlgorithm<Object, Object> }, arg15: { [key: string]: AeadAlgorithm })
    ...
    // private encAlgs: Function<JweHeader, AeadAlgorithm>;
    // private expectedClaims: ClaimsBuilder;
    // private keyAlgs: Function<JweHeader, KeyAlgorithm<Object, Object>>;
    // private keyLocator: Locator<Key>;
    // private provider: Provider;
    // private sigAlgs: Function<JwsHeader, SecureDigestAlgorithm<Object, Object>>;
    // private signingKeyResolver: SigningKeyResolver;
    // private unsecured: boolean;
    // private unsecuredDecompression: boolean;
    // private zipAlgs: Function<Header, CompressionAlgorithm>;
    ...
    // private parseSignedClaims(arg0: CharSequence, arg1: Payload): Jws<Claims>;
    ...
    // private validateExpectedClaims(arg0: Header, arg1: Claims): void;
    // private verifySignature(arg0: TokenizedJwt, arg1: JwsHeader, arg2: string, arg3: SigningKeyResolver, arg4: Claims, arg5: Payload): number[];
}