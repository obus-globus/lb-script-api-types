...
export class CompressionCodecLocator extends Object implements Locator<CompressionAlgorithm>, Function<{ [key: string]: any }, CompressionAlgorithm> {
    constructor(arg0: CompressionCodecResolver)
    // private resolver: CompressionCodecResolver;
    apply(arg0: { [key: string]: any }): CompressionAlgorithm;
    locate(arg0: { [key: string]: any }): CompressionAlgorithm;
}