...
export class JcaTemplate extends Object {
    ...
    withAlgorithmParameters<R extends unknown>(arg0: CheckedFunction<AlgorithmParameters, R>): R;
    withCertificateFactory<R extends unknown>(arg0: CheckedFunction<CertificateFactory, R>): R;
    withCipher<R extends unknown>(arg0: CheckedFunction<Cipher, R>): R;
    withKeyAgreement<R extends unknown>(arg0: CheckedFunction<KeyAgreement, R>): R;
    withKeyFactory<R extends unknown>(arg0: CheckedFunction<KeyFactory, R>): R;
    withKeyGenerator<R extends unknown>(arg0: CheckedFunction<KeyGenerator, R>): R;
    withKeyPairGenerator<R extends unknown>(arg0: CheckedFunction<KeyPairGenerator, R>): R;
    withMac<R extends unknown>(arg0: CheckedFunction<Mac, R>): R;
    withMessageDigest<R extends unknown>(arg0: CheckedFunction<MessageDigest, R>): R;
    withSecretKeyFactory<R extends unknown>(arg0: CheckedFunction<SecretKeyFactory, R>): R;
    withSignature<R extends unknown>(arg0: CheckedFunction<Signature, R>): R;
}