...
export class DefaultSecureRequest<T extends unknown, K extends Key> extends DefaultRequest<T> implements SecureRequest<T, K> {
    constructor(arg0: T, arg1: JavaMap<any, any>, arg2: SecureRandom, arg3: K)
    // private KEY: K;
    getKey(): K;
}