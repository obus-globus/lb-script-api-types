...
export class DefaultAeadRequest extends DefaultSecureRequest<InputStream, SecretKey> implements AeadRequest, IvSupplier {
    constructor(arg0: InputStream, arg1: JavaMap<any, any>, arg2: SecureRandom, arg3: SecretKey, arg4: InputStream)
    constructor(arg0: InputStream, arg1: JavaMap<any, any>, arg2: SecureRandom, arg3: SecretKey, arg4: InputStream, arg5: number[])
