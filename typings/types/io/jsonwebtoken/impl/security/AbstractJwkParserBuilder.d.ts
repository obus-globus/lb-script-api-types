...
export abstract class AbstractJwkParserBuilder<T extends Object | number | string | boolean, B extends ParserBuilder<T, B> & KeyOperationPolicied<B>> extends AbstractParserBuilder<T, B> implements KeyOperationPolicied<B> {
    constructor()
