...
export abstract class AbstractAudienceCollection<P extends unknown> extends DefaultNestedCollection<string, P> implements ClaimsMutator$AudienceCollection<P> {
