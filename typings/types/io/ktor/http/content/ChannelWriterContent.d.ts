...
export class ChannelWriterContent extends OutgoingContent$WriteChannelContent {
    constructor(body: (param0: ByteWriteChannel) => void, contentType: ContentType | null, status: HttpStatusCode | null, contentLength: number | null)
    // private body: (param0: ByteWriteChannel) => void;
