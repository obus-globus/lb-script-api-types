...
import type { RouteSelectorEvaluation$Success } from '../../../../io/ktor/server/routing/RouteSelectorEvaluation$Success.d.ts'
import type { RoutingResolveContext } from '../../../../io/ktor/server/routing/RoutingResolveContext.d.ts'
import type { Continuation } from '../../../../kotlin/coroutines/Continuation.d.ts'
export class RootRouteSelector extends RouteSelector implements RoutePathComponent {
    constructor(rootPath?: string)
    // private parts: string[];
    // private successEvaluationResult: RouteSelectorEvaluation$Success;
