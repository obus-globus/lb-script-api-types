...
export class PathSegmentOptionalParameterRouteSelector extends RouteSelector implements RouteParameterComponent, RoutePathComponent {
    ...
    copy(name: string, prefix: string | null, suffix: string | null): PathSegmentOptionalParameterRouteSelector;
