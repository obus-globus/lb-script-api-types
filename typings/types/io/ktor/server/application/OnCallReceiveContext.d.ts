...
export class OnCallReceiveContext<PluginConfig extends unknown> extends CallContext<PluginConfig> {
    ...
    transformBody(transform: (param0: TransformBodyContext, param1: ByteReadChannel) => Object, $completion: Continuation<void>): any;
}