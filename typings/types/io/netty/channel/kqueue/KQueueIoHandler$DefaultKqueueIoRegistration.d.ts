...
import type { KQueueIoHandler } from '../../../../io/netty/channel/kqueue/KQueueIoHandler.d.ts'
...
export class KQueueIoHandler$DefaultKqueueIoRegistration extends Object implements IoRegistration {
    constructor(null_: KQueueIoHandler, arg1: ThreadAwareExecutor, arg2: KQueueIoHandle)
    ...
    close(): void;
    // private evSet(arg0: number, arg1: number, arg2: number, arg3: number): void;
