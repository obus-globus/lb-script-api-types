...
import type { LocalIoHandler } from '../../../../io/netty/channel/local/LocalIoHandler.d.ts'
...
export class LocalIoHandler$LocalIoRegistration extends Object implements IoRegistration {
    constructor(null_: LocalIoHandler, arg1: ThreadAwareExecutor, arg2: LocalIoHandle)
