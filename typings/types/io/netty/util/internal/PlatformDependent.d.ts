...
export class PlatformDependent extends Object {
    ...
    static newMpscQueue<T extends unknown>(): T[];
    static newMpscQueue<T extends unknown>(paramarg0: number): T[];
    static newMpscQueue<T extends unknown>(paramarg0: number, paramarg1: number): T[];
    static newSpscQueue<T extends unknown>(): T[];
