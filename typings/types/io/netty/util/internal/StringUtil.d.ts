...
export class StringUtil extends Object {
    ...
    static SPACE: string;
    static TAB: string;
    static byteToHexString(paramarg0: Object | null, paramarg1: number): Object | null;
    static byteToHexString(paramarg0: number): string;
    static byteToHexStringPadded(paramarg0: Object | null, paramarg1: number): Object | null;
    ...
    static join(paramarg0: CharSequence, paramarg1: (Object | null)[]): CharSequence;
    ...
    static toHexString(paramarg0: Object | null, paramarg1: number[]): Object | null;
    static toHexString(paramarg0: Object | null, paramarg1: number[], paramarg2: number, paramarg3: number): Object | null;
    static toHexString(paramarg0: number[]): string;
    static toHexString(paramarg0: number[], paramarg1: number, paramarg2: number): string;
    static toHexStringPadded(paramarg0: Object | null, paramarg1: number[]): Object | null;
    static toHexStringPadded(paramarg0: Object | null, paramarg1: number[], paramarg2: number, paramarg3: number): Object | null;
