import type { AutoScalingEventExecutorChooserFactory } from '../../../../io/netty/util/concurrent/AutoScalingEventExecutorChooserFactory.d.ts'
...
export class AutoScalingEventExecutorChooserFactory$AutoScalingEventExecutorChooser extends Object implements EventExecutorChooserFactory$ObservableEventExecutorChooser {
    constructor(null_: AutoScalingEventExecutorChooserFactory, arg1: (Object | null)[][])
