...
export class Unpooled extends Object {
    ...
    static wrappedBuffer(...paramarg0: number[][]): ByteBuf;
    static wrappedBuffer(paramarg0: number, ...paramarg1: number[][]): ByteBuf;
    static wrappedBuffer(paramarg0: number, ...paramarg1: ByteBuf[]): ByteBuf;
    static wrappedBuffer(paramarg0: number, ...paramarg1: ByteBuffer[]): ByteBuf;
    ...
    static wrappedUnmodifiableBuffer(...paramarg0: ByteBuf[]): ByteBuf;
    private constructor()
}