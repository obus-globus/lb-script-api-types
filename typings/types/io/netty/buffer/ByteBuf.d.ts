...
import type { ByteBufConvertible } from '../../../io/netty/buffer/ByteBufConvertible.d.ts'
...
export abstract class ByteBuf extends Object implements ByteBufConvertible, ReferenceCounted, Comparable<ByteBuf> {
    constructor()
