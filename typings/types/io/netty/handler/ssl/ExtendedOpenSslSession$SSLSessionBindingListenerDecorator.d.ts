import type { ExtendedOpenSslSession } from '../../../../io/netty/handler/ssl/ExtendedOpenSslSession.d.ts'
...
export class ExtendedOpenSslSession$SSLSessionBindingListenerDecorator extends Object implements SSLSessionBindingListener {
    constructor(null_: ExtendedOpenSslSession, arg1: SSLSessionBindingListener)
