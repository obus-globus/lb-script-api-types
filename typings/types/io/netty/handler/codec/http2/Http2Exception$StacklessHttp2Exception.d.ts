...
export class Http2Exception$StacklessHttp2Exception extends Http2Exception {
    ...
    constructor(arg0: Http2Error, arg1: string, arg2: Http2Exception$ShutdownHint, arg3: boolean)
