...
import type { Http2DataWriter } from '../../../../../io/netty/handler/codec/http2/Http2DataWriter.d.ts'
...
export interface Http2FrameWriter extends Http2DataWriter, Closeable, Object{
    close(): void;
