...
export class DecoratingHttp2ConnectionDecoder extends Object implements Http2ConnectionDecoder {
    constructor(arg0: Http2ConnectionDecoder)
    // private delegate: Http2ConnectionDecoder;
    close(): void;
