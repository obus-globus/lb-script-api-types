...
export class WeightedFairQueueByteDistributor$StatePseudoTimeComparator extends Object implements Serializable, Comparator<WeightedFairQueueByteDistributor$State> {
    private constructor()
