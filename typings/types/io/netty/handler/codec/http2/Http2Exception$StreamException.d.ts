...
export class Http2Exception$StreamException extends Http2Exception {
    ...
    constructor(arg0: number, arg1: Http2Error, arg2: string)
    constructor(arg0: number, arg1: Http2Error, arg2: string, arg3: Throwable)
