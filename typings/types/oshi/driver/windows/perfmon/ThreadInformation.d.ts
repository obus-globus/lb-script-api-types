...
export class ThreadInformation extends Object {
    static queryThreadCounters(): Pair<string[], Map<ThreadInformation$ThreadPerformanceProperty, number[]>>;
    static queryThreadCounters(paramarg0: string, paramarg1: number): Pair<string[], Map<ThreadInformation$ThreadPerformanceProperty, number[]>>;
    private constructor()
}