...
export abstract class RequestExecutor extends Object {
    ...
    getHeaders(arg0: HttpRequest, arg1: CookieManager): { [key: string]: string[] };
    getHeaders(arg0: HttpRequest, arg1: CookieManager, arg2: boolean): { [key: string]: string[] };
    isFollowRedirects(arg0: HttpRequest): boolean;
    isIgnoreInvalidSSL(arg0: HttpRequest): boolean;
    setHeaders(arg0: { [key: string]: string[] }, arg1: (param0: string, param1: string) => void, arg2: (param0: string, param1: string) => void): void;
    updateCookies(arg0: CookieManager, arg1: URL, arg2: { [key: string]: string[] }): void;
}