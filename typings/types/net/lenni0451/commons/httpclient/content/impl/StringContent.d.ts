...
import type { ByteArrayContent } from '../../../../../../net/lenni0451/commons/httpclient/content/impl/ByteArrayContent.d.ts'
...
export class StringContent extends ByteArrayContent {
    ...
    constructor(arg0: ContentType, arg1: string)
    constructor(arg0: ContentType, arg1: string, arg2: Charset)
}