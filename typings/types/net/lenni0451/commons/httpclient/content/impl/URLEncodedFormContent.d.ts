...
import type { URLEncodedFormContent$FormEntry } from '../../../../../../net/lenni0451/commons/httpclient/content/impl/URLEncodedFormContent$FormEntry.d.ts'
import type { ContentType } from '../../../../../../net/lenni0451/commons/httpclient/model/ContentType.d.ts'
export class URLEncodedFormContent extends HttpContent {
    ...
    compute(): InputStream;
    getLength(): number;
    put(arg0: string, arg1: string): URLEncodedFormContent;
}