...
export class WireframePlayer extends Object {
    ...
    render(env: WorldRenderEnvironment, color: Color4b, outlineColor: Color4b, noDepthTest: boolean): void;
    render(event: WorldRenderEvent, color: Color4b, outlineColor: Color4b, noDepthTest: boolean): void;
