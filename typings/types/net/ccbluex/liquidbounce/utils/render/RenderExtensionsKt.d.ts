...
export class RenderExtensionsKt extends Object {
    ...
    /**
     * @receiver Should have flag {@link GpuBuffer.USAGE_MAP_READ}
     *
     * @returns A {@link ByteBuffer} allocated with {@link MemoryUtil}
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/affa27f4374c5dc750675ca894a074284c5832d9/src/main/kotlin/net/ccbluex/liquidbounce/utils/render/RenderExtensions.kt#L134 | src/main/kotlin/net/ccbluex/liquidbounce/utils/render/RenderExtensions.kt:134}
     */
    static read(self: GpuBuffer, offset: number, length: number): ByteBuffer;
    static readFully(self: GpuBuffer): ByteBuffer;
    /**
     * Read and close source. Accepts JPEG and PNG.
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/affa27f4374c5dc750675ca894a074284c5832d9/src/main/kotlin/net/ccbluex/liquidbounce/utils/render/RenderExtensions.kt#L454 | src/main/kotlin/net/ccbluex/liquidbounce/utils/render/RenderExtensions.kt:454}
     */
     ...
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/affa27f4374c5dc750675ca894a074284c5832d9/src/main/kotlin/net/ccbluex/liquidbounce/utils/render/RenderExtensions.kt#L440 | src/main/kotlin/net/ccbluex/liquidbounce/utils/render/RenderExtensions.kt:440}
     */
     ...
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/affa27f4374c5dc750675ca894a074284c5832d9/src/main/kotlin/net/ccbluex/liquidbounce/utils/render/RenderExtensions.kt#L265 | src/main/kotlin/net/ccbluex/liquidbounce/utils/render/RenderExtensions.kt:265}
     */
    ...
    static withOutputTextureOverride<T extends unknown>(color: GpuTextureView | null, depth: GpuTextureView | null, block: () => T): T;
