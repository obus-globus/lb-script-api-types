 ...
 *
 * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/fac52d9c85c85141cb327e00599cdf8e0a7afc66/src/main/kotlin/net/ccbluex/liquidbounce/utils/client/error/ErrorHandler.kt#L41 | src/main/kotlin/net/ccbluex/liquidbounce/utils/client/error/ErrorHandler.kt:41}
 */
export class ErrorHandler extends Object {
    ...
    static fatal(paramarg0: Throwable, paramarg1: QuickFix, paramarg2: boolean, paramarg3: string): void;
