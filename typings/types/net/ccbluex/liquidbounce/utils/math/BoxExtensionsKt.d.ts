...
export class BoxExtensionsKt extends Object {
     ...
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/0a21163cac7d7e3736ae038e79bf85f09f24d875/src/main/kotlin/net/ccbluex/liquidbounce/utils/math/BoxExtensions.kt#L120 | src/main/kotlin/net/ccbluex/liquidbounce/utils/math/BoxExtensions.kt:120}
     */
    static distanceToSqr(aABB: AABB, x: number, y: number, z: number): number;
    /**
     * Ray–AABB first hit point (entry or exit).
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/0a21163cac7d7e3736ae038e79bf85f09f24d875/src/main/kotlin/net/ccbluex/liquidbounce/utils/math/BoxExtensions.kt#L101 | src/main/kotlin/net/ccbluex/liquidbounce/utils/math/BoxExtensions.kt:101}
     */
     ...
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/0a21163cac7d7e3736ae038e79bf85f09f24d875/src/main/kotlin/net/ccbluex/liquidbounce/utils/math/BoxExtensions.kt#L107 | src/main/kotlin/net/ccbluex/liquidbounce/utils/math/BoxExtensions.kt:107}
     */
     ...
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/0a21163cac7d7e3736ae038e79bf85f09f24d875/src/main/kotlin/net/ccbluex/liquidbounce/utils/math/BoxExtensions.kt#L93 | src/main/kotlin/net/ccbluex/liquidbounce/utils/math/BoxExtensions.kt:93}
     */
