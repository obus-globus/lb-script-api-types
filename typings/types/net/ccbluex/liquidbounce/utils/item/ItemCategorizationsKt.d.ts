...
export class ItemCategorizationsKt extends Object {
     ...
     * @see Items.SHIELD
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/e1d0801ab2d0c9362f03f42cbfac7b36a2a05b6a/src/main/kotlin/net/ccbluex/liquidbounce/utils/item/ItemCategorizations.kt#L122 | src/main/kotlin/net/ccbluex/liquidbounce/utils/item/ItemCategorizations.kt:122}
     */
    ...
    static isConsumable(paramarg0: DataComponentHolder): boolean;
    static isFood(paramarg0: DataComponentGetter): boolean;
    static isFootArmor(paramarg0: TypedInstance<Item>): boolean;
    static isGlider(paramarg0: DataComponentHolder): boolean;
     ...
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/e1d0801ab2d0c9362f03f42cbfac7b36a2a05b6a/src/main/kotlin/net/ccbluex/liquidbounce/utils/item/ItemCategorizations.kt#L82 | src/main/kotlin/net/ccbluex/liquidbounce/utils/item/ItemCategorizations.kt:82}
     */
