...
export class TargetSelector extends ValueGroup {
     ...
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/5f1d924995c7360e0ec79e16298d37205eea4da3/src/main/kotlin/net/ccbluex/liquidbounce/utils/combat/TargetTracker.kt#L117 | src/main/kotlin/net/ccbluex/liquidbounce/utils/combat/TargetTracker.kt:117}
     */
    countTargets(): number;
    /**
     * Update should be called to always pick the best target out of the current world context
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/5f1d924995c7360e0ec79e16298d37205eea4da3/src/main/kotlin/net/ccbluex/liquidbounce/utils/combat/TargetTracker.kt#L124 | src/main/kotlin/net/ccbluex/liquidbounce/utils/combat/TargetTracker.kt:124}
     */
