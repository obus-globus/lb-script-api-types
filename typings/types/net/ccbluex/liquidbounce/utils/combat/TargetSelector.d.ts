...
export class TargetSelector extends ValueGroup {
     ...
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/fac52d9c85c85141cb327e00599cdf8e0a7afc66/src/main/kotlin/net/ccbluex/liquidbounce/utils/combat/TargetTracker.kt#L117 | src/main/kotlin/net/ccbluex/liquidbounce/utils/combat/TargetTracker.kt:117}
     */
    countTargets(): number;
    /**
     * Update should be called to always pick the best target out of the current world context
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/fac52d9c85c85141cb327e00599cdf8e0a7afc66/src/main/kotlin/net/ccbluex/liquidbounce/utils/combat/TargetTracker.kt#L124 | src/main/kotlin/net/ccbluex/liquidbounce/utils/combat/TargetTracker.kt:124}
     */
