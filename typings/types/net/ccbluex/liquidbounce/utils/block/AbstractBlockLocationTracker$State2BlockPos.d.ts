 ...
 *
 * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/fac52d9c85c85141cb327e00599cdf8e0a7afc66/src/main/kotlin/net/ccbluex/liquidbounce/utils/block/AbstractBlockLocationTracker.kt#L102 | src/main/kotlin/net/ccbluex/liquidbounce/utils/block/AbstractBlockLocationTracker.kt:102}
 */
export abstract class AbstractBlockLocationTracker$State2BlockPos<T extends Object | number | string | boolean> extends AbstractBlockLocationTracker<T> {
    constructor()
