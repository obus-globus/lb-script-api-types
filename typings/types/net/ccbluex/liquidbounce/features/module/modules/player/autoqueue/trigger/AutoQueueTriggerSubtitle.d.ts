...
export class AutoQueueTriggerSubtitle extends AutoQueueTrigger {
    static Companion: Tagged$Companion;
    static INSTANCE: AutoQueueTriggerSubtitle;
    // private isTriggered: boolean;
    /*not mapped: */ isTriggered(): boolean;
    // private keywords: string[];
    // private /*not mapped: */ getKeywords(): string[];
    // private titleHandler: EventHook<TitleEvent$Subtitle>;
}