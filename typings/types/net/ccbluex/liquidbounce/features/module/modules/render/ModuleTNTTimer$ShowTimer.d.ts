...
import type { ModuleTNTTimer$ShowTimer$TimeUnit } from '../../../../../../../net/ccbluex/liquidbounce/features/module/modules/render/ModuleTNTTimer$ShowTimer$TimeUnit.d.ts'
export class ModuleTNTTimer$ShowTimer extends ToggleableValueGroup {
    static INSTANCE: ModuleTNTTimer$ShowTimer;
    // private SECONDS_FORMAT: DecimalFormat;
    readonly ownerName: boolean;
    // private render2DHandler: EventHook<OverlayRenderEvent>;
    readonly renderY: number;
    readonly scale: number;
    readonly timeUnit: ModuleTNTTimer$ShowTimer$TimeUnit;
}