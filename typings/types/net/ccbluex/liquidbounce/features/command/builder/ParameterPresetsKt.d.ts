...
export class ParameterPresetsKt extends Object {
    ...
    static configs(companion: ParameterBuilder$Companion, name: string, predicate: (param0: Object | null) => boolean): ParameterBuilder<Object>;
    static enchantment(companion: ParameterBuilder$Companion, name: string): ParameterBuilder<string>;
    static enumChoice(companion: ParameterBuilder$Companion, name: string, predicate: (param0: Object | null) => boolean): ParameterBuilder<Object>;
    static enumChoices(companion: ParameterBuilder$Companion, name: string, predicate: (param0: Object | null) => boolean): ParameterBuilder<Object>;
    static item(companion: ParameterBuilder$Companion, name: string): ParameterBuilder<string>;
    static module(companion: ParameterBuilder$Companion, name: string, all: (Object | null)[], predicate: (param0: Object | null) => boolean): ParameterBuilder<ClientModule>;
    static modules(companion: ParameterBuilder$Companion, name: string, all: (Object | null)[], predicate: (param0: Object | null) => boolean): ParameterBuilder<Object>;
