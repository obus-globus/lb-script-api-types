...
export class ClientStringArgumentType$QuotedOrUnquoted extends Object implements ArgumentType<string> {
    static INSTANCE: ClientStringArgumentType$QuotedOrUnquoted;
