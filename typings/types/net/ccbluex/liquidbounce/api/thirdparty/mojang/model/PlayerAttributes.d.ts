...
import type { BanStatus } from '../../../../../../../net/ccbluex/liquidbounce/api/thirdparty/mojang/model/BanStatus.d.ts'
import type { ChatPreferences } from '../../../../../../../net/ccbluex/liquidbounce/api/thirdparty/mojang/model/ChatPreferences.d.ts'
import type { FriendsPreferences } from '../../../../../../../net/ccbluex/liquidbounce/api/thirdparty/mojang/model/FriendsPreferences.d.ts'
import type { Privileges } from '../../../../../../../net/ccbluex/liquidbounce/api/thirdparty/mojang/model/Privileges.d.ts'
import type { ProfanityFilterPreferences } from '../../../../../../../net/ccbluex/liquidbounce/api/thirdparty/mojang/model/ProfanityFilterPreferences.d.ts'
