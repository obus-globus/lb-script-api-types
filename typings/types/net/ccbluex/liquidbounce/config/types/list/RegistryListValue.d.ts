...
export class RegistryListValue<T extends E[], E extends unknown> extends ListValue<T, E> {
     ...
     *
     * Source: {@link https://github.com/CCBlueX/LiquidBounce/blob/b759cac57b26e54694d8c4d48af024a8fb598f62/src/main/kotlin/net/ccbluex/liquidbounce/config/types/list/ListValue.kt#L155 | src/main/kotlin/net/ccbluex/liquidbounce/config/types/list/ListValue.kt:155}
     */
