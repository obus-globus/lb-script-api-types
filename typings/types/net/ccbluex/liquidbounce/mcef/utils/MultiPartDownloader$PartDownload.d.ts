...
export class MultiPartDownloader$PartDownload extends Object implements Callable<void> {
    private constructor(null_: MultiPartDownloader$PartDownload, arg1: MultiPartDownloader$Part, arg2: MultiPartDownloader$ProgressReporter, arg3: HttpUrl, arg4: FileChannel, arg5: number)
    ...
    // private url: HttpUrl;
    call(): void;
    // private copyPart(arg0: BufferedSource, arg1: FileChannel): void;
    // private readChunk(arg0: BufferedSource, arg1: number[]): number;
    // private validateContentRange(arg0: Response): void;
