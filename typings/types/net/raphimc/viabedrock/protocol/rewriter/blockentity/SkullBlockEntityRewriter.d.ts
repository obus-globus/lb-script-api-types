...
export class SkullBlockEntityRewriter extends Object implements BlockEntityRewriter$Rewriter {
    constructor()
    // private convertRot(arg0: number): number;
    // private convertRotation(arg0: number): number;
