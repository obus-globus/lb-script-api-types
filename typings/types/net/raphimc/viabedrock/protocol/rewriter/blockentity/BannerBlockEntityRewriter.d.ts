...
import type { DyeColor } from '../../../../../../net/raphimc/viabedrock/protocol/data/enums/DyeColor.d.ts'
import type { BlockEntityRewriter$Rewriter } from '../../../../../../net/raphimc/viabedrock/protocol/rewriter/BlockEntityRewriter$Rewriter.d.ts'
export class BannerBlockEntityRewriter extends Object implements BlockEntityRewriter$Rewriter {
    constructor()
    ...
    // private createBedrockPattern(arg0: string, arg1: DyeColor): Map$Entry<string, Tag>[];
    // private createJavaPattern(arg0: string, arg1: DyeColor): Map$Entry<string, Tag>[];
