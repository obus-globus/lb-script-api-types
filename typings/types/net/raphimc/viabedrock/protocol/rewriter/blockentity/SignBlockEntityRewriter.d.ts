...
export class SignBlockEntityRewriter extends Object implements BlockEntityRewriter$Rewriter {
    static sanitizeData(paramarg0: Map$Entry<string, Tag>[]): void;
    static upgradeData(paramarg0: Map$Entry<string, Tag>[]): void;
    constructor()
    ...
    // private translateText(arg0: Map$Entry<string, Tag>[]): Map$Entry<string, Tag>[];
}