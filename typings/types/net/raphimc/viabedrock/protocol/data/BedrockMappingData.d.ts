...
export class BedrockMappingData extends MappingDataBase {
    ...
    readonly bedrockEntityDataTypes: Map<ActorDataIDs, DataItemType>;
    readonly bedrockEntityFlagMoLangQueries: Map<ActorFlags, string>;
    ...
    readonly bedrockNoteBlockInstrumentSounds: Map<NoteBlockInstrument, string>;
    ...
    readonly bedrockToJavaContainers: Map<ContainerType, number>;
    readonly bedrockToJavaDamageCauses: Map<SharedTypes_Legacy_ActorDamageCause, string>;
    readonly bedrockToJavaEffects: { [key: string]: string };
    readonly bedrockToJavaEnchantments: Map<Enchant_Type, string>;
    readonly bedrockToJavaEntities: { [key: string]: EntityTypes26_2 };
    readonly bedrockToJavaExperimentalFeatures: { [key: string]: string };
    readonly bedrockToJavaLevelEventParticles: Map<ParticleType, BedrockMappingData$JavaParticle>;
    readonly bedrockToJavaLevelEvents: Map<LevelEvent, BedrockMappingData$LevelEventMapping>;
    ...
    readonly javaEntityDataFields: Map<EntityTypes26_2, string[]>;
    ...
    getBedrockEntityDataTypes(): Map<ActorDataIDs, DataItemType>;
    getBedrockEntityFlagMoLangQueries(): Map<ActorFlags, string>;
    ...
    getBedrockNoteBlockInstrumentSounds(): Map<NoteBlockInstrument, string>;
    ...
    getBedrockToJavaContainers(): Map<ContainerType, number>;
    getBedrockToJavaDamageCauses(): Map<SharedTypes_Legacy_ActorDamageCause, string>;
    getBedrockToJavaEffects(): { [key: string]: string };
    getBedrockToJavaEnchantments(): Map<Enchant_Type, string>;
    getBedrockToJavaEntities(): { [key: string]: EntityTypes26_2 };
    getBedrockToJavaExperimentalFeatures(): { [key: string]: string };
    getBedrockToJavaLevelEventParticles(): Map<ParticleType, BedrockMappingData$JavaParticle>;
    getBedrockToJavaLevelEvents(): Map<LevelEvent, BedrockMappingData$LevelEventMapping>;
    ...
    getJavaEntityDataFields(): Map<EntityTypes26_2, string[]>;
