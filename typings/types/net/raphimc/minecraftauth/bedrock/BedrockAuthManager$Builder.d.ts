...
export class BedrockAuthManager$Builder extends Object {
    ...
    login(arg0: (param0: HttpClient, param1: MsaApplicationConfig) => net.raphimc.minecraftauth.msa.service.MsaAuthService): BedrockAuthManager;
    login<T extends Object | number | string | boolean>(arg0: (param0: T, param1: HttpClient, param2: MsaApplicationConfig) => net.raphimc.minecraftauth.msa.service.MsaAuthService, arg1: T): BedrockAuthManager;
