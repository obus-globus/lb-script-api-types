...
export class MinecraftSession extends Object implements Expirable {
    static fromJson(paramarg0: JsonObject): MinecraftSession;
    static fromJson(paramarg0: Map$Entry<string, GsonElement>[]): MinecraftSession;
    static toJson(paramarg0: MinecraftSession): JsonObject;
