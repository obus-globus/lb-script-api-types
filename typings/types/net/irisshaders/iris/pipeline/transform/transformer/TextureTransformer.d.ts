...
export class TextureTransformer extends Object {
    static transform(paramarg0: ASTParser, paramarg1: TranslationUnit, paramarg2: Root, paramarg3: TextureStage, paramarg4: JavaMap<Tri<string, TextureType, TextureStage>, string>): void;
    constructor()
}