...
export class VanillaCoreTransformer extends Object {
    static transform(paramarg0: ASTParser, paramarg1: TranslationUnit, paramarg2: Root, paramarg3: VanillaParameters): void;
    constructor()
}