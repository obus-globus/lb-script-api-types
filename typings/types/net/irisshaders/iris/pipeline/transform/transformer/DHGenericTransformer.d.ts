...
export class DHGenericTransformer extends Object {
    static injectVertInit(paramarg0: ASTParser, paramarg1: TranslationUnit, paramarg2: Root, paramarg3: Parameters): void;
    static transform(paramarg0: ASTParser, paramarg1: TranslationUnit, paramarg2: Root, paramarg3: Parameters): void;
    constructor()
}