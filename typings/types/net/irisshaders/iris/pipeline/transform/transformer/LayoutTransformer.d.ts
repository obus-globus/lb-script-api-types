...
export class LayoutTransformer extends Object {
    ...
    static transformIn(paramarg0: JavaMap<any, any>, paramarg1: ASTParser, paramarg2: TranslationUnit, paramarg3: Root, paramarg4: Parameters): void;
    static transformOut(paramarg0: ASTParser, paramarg1: TranslationUnit, paramarg2: Root, paramarg3: Parameters): JavaMap<any, any>;
    constructor()
}