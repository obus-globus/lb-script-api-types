...
export class TransformPatcher extends Object {
    static patchComposite(paramarg0: string, paramarg1: string, paramarg2: string, paramarg3: string, paramarg4: TextureStage, paramarg5: Map<Tri<string, TextureType, TextureStage>, string>): { [key in PatchShaderType]: string };
