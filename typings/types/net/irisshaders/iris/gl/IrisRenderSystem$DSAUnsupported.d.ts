...
import type { IrisRenderSystem$DSAAccess } from '../../../../net/irisshaders/iris/gl/IrisRenderSystem$DSAAccess.d.ts'
export class IrisRenderSystem$DSAUnsupported extends Object implements IrisRenderSystem$DSAAccess {
    constructor()
