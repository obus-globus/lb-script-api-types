...
export class Int3VectorCachedUniform extends VectorCachedUniform<Vector3i> {
    static forExpression(paramarg0: string, paramarg1: Type, paramarg2: Expression, paramarg3: FunctionContext): CachedUniform;
    constructor(arg0: string, arg1: UniformUpdateFrequency, arg2: () => Vector3i)
    getType(): VectorType;
    push(arg0: number): void;
    setFrom(arg0: Vector3i): void;
}