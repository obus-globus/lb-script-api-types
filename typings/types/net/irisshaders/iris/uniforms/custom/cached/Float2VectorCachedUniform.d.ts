...
export class Float2VectorCachedUniform extends VectorCachedUniform<Vector2f> {
    static forExpression(paramarg0: string, paramarg1: Type, paramarg2: Expression, paramarg3: FunctionContext): CachedUniform;
    constructor(arg0: string, arg1: UniformUpdateFrequency, arg2: () => Vector2f)
    getType(): VectorType;
    push(arg0: number): void;
    setFrom(arg0: Vector2f): void;
}