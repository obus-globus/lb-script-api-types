...
export class ServerPlaceRecipe<R extends Recipe<any>> extends Object {
    static placeRecipe(parammenu: ServerPlaceRecipe$CraftingMenuAccess<any>, paramgridWidth: number, paramgridHeight: number, paraminputGridSlots: Slot[], paramslotsToClear: Slot[], paraminventory: (Object | null)[], paramrecipe: RecipeHolder<any>, paramuseMaxItems: boolean, paramallowDroppingItemsToClear: boolean): RecipeBookMenu$PostPlaceAction;
