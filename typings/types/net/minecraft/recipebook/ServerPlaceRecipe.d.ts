...
export class ServerPlaceRecipe<R extends Recipe<any>> extends Object {
    static placeRecipe<I extends RecipeInput, R extends Recipe<I>>(parammenu: ServerPlaceRecipe$CraftingMenuAccess<R>, paramgridWidth: number, paramgridHeight: number, paraminputGridSlots: Slot[], paramslotsToClear: Slot[], paraminventory: (Object | null)[], paramrecipe: RecipeHolder<R>, paramuseMaxItems: boolean, paramallowDroppingItemsToClear: boolean): RecipeBookMenu$PostPlaceAction;
