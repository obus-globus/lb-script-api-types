...
export class ConfirmationDialog extends Record implements SimpleDialog {
    ...
    static MAP_CODEC: MapCodec<ConfirmationDialog>;
    static STREAM_CODEC: StreamCodec<RegistryFriendlyByteBuf, Holder<Dialog>>;
    static WIDTH_CODEC: Codec<number>;
    constructor(common: CommonDialogData, yesButton: ActionButton, noButton: ActionButton)
    // private common: CommonDialogData;
    // private noButton: ActionButton;
    // private yesButton: ActionButton;
    codec(): MapCodec<ConfirmationDialog>;
