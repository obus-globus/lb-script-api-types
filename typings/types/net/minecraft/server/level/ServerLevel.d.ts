...
export class ServerLevel extends Level implements ServerWorldExtended, ServerLevelAccessor, ServerLevelAccessor_2, ServerLevelAccessor_3, AttachmentTargetImpl, ServerLevelCache, ServerEntityGetter, WorldGenLevel {
    ...
    getEntities<T extends Entity>(type: EntityTypeTest<Entity, T>, selector: (param0: T) => boolean): T[];
    getEntities<T extends Entity>(type: EntityTypeTest<Entity, T>, selector: (param0: T) => boolean, result: T[]): void;
    getEntities<T extends Entity>(type: EntityTypeTest<Entity, T>, selector: (param0: T) => boolean, result: T[], maxResults: number): void;
    ...
    getPlayers(selector: (param0: ServerPlayer) => boolean, maxResults: number): ServerPlayer[];
