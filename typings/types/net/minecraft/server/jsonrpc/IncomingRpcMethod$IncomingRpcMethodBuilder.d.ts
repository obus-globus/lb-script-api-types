...
export class IncomingRpcMethod$IncomingRpcMethodBuilder<Params extends Object | number | string | boolean, Result extends Object | number | string | boolean> extends Object {
    ...
    constructor(function_: (param0: Result, param1: MinecraftApi) => unknown)
    constructor(function_: (param0: Params, param1: Result, param2: MinecraftApi) => unknown)
    // private description: string;
    // private discoverable: boolean;
    // private paramInfo: ParamInfo<Params>;
    // private parameterFunction: (param0: Params, param1: Result, param2: MinecraftApi) => unknown;
    // private parameterlessFunction: (param0: Result, param1: MinecraftApi) => unknown;
