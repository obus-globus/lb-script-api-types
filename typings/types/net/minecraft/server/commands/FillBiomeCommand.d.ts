...
export class FillBiomeCommand extends Object {
    ...
    static fill(paramlevel: ServerLevel, paramrawFrom: BlockPos, paramrawTo: BlockPos, parambiome: Holder<Biome>, paramfilter: (param0: Object | null) => kotlin.Boolean, paramsuccessMessageConsumer: (param0: Object | null) => void): Either<number, CommandSyntaxException>;
