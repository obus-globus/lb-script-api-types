...
export class ReturnCommand$ReturnFailCustomExecutor<T extends ExecutionCommandSource<T>> extends Object implements CustomCommandExecutor$CommandAdapter<T> {
