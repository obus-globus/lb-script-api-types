...
export class SummonCommand extends Object {
    static createEntity(paramsource: CommandSourceStack, paramtype: Holder$Reference<EntityType<any>>, parampos: Vec3, paramnbt: CompoundTag, paramfinalize: boolean): Entity;
