...
export interface LootCommand$TailProvider extends Object {
    construct(root: ArgumentBuilder<CommandSourceStack, Object>, consumer: (param0: CommandContext<CommandSourceStack>, param1: ItemStack[], param2: (param0: ItemStack[]) => void) => number): ArgumentBuilder<CommandSourceStack, Object>;
}