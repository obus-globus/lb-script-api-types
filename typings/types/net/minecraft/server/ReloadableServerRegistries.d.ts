...
export class ReloadableServerRegistries extends Object {
    static reload(paramcontext: LayeredRegistryAccess<RegistryLayer>, paramupdatedContextTags: (Object | null)[], parammanager: ResourceManager, paramexecutor: Executor): CompletableFuture<ReloadableServerRegistries$LoadResult>;
    constructor()
}