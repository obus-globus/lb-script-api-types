...
export class FriendlyByteBuf extends ByteBuf {
    ...
    static limitValue<T extends unknown>(paramoriginal: (param0: number) => T, paramlimit: number): (param0: number) => T;
    ...
    static readNullable<T extends unknown, B extends ByteBuf>(paraminput: B, paramvalueDecoder: (param0: Object) => T): T;
    ...
    static writeNullable<T extends unknown, B extends ByteBuf>(paramoutput: B, paramvalue: T, paramvalueEncoder: (param0: Object, param1: T) => void): void;
    ...
    readBoolean(): boolean;
    readById<T extends unknown>(converter: (param0: number) => T): T;
    readByte(): number;
    ...
    readCollection<C extends T[], T extends unknown>(ctor: (param0: number) => C, elementDecoder: (param0: FriendlyByteBuf) => T): C;
    readContainerId(): number;
    readDouble(): number;
    readEither<L extends unknown, R extends unknown>(leftReader: (param0: FriendlyByteBuf) => L, rightReader: (param0: FriendlyByteBuf) => R): Either<L, R>;
    ...
    readIntLE(): number;
    readLenientJsonWithCodec<T extends unknown>(codec: Codec<T>): T;
    readList<T extends unknown>(elementDecoder: (param0: FriendlyByteBuf) => T): T[];
    readLong(): number;
    ...
    readNullable<T extends unknown>(valueDecoder: (param0: FriendlyByteBuf) => T): T;
    readOptional<T extends unknown>(valueReader: (param0: FriendlyByteBuf) => T): Optional<T>;
    readPublicKey(): PublicKey;
    readQuaternion(): Quaternionf;
    readRegistryKey<T extends unknown>(): ResourceKey<T[]>;
    readResourceKey<T extends unknown>(registry: ResourceKey<T[]>): ResourceKey<T>;
    ...
    readWithCodec<T extends unknown>(ops: DynamicOps<Tag>, codec: Codec<T>, accounter: NbtAccounter): T;
    readWithCodecTrusted<T extends unknown>(ops: DynamicOps<Tag>, codec: Codec<T>): T;
    ...
    writeById<T extends unknown>(converter: (param0: T) => number, value: T): FriendlyByteBuf;
    ...
    writeCollection<T extends unknown>(collection: T[], encoder: (param0: FriendlyByteBuf, param1: T) => void): void;
    writeContainerId(id: number): void;
    writeDouble(value: number): FriendlyByteBuf;
    writeEither<L extends unknown, R extends unknown>(value: Either<L, R>, leftWriter: (param0: FriendlyByteBuf, param1: L) => void, rightWriter: (param0: FriendlyByteBuf, param1: R) => void): void;
    ...
    writeJsonWithCodec<T extends unknown>(codec: Codec<T>, value: T): void;
    ...
    writeNullable<T extends unknown>(value: T, valueEncoder: (param0: FriendlyByteBuf, param1: T) => void): void;
    writeOptional<T extends unknown>(value: Optional<T>, valueWriter: (param0: FriendlyByteBuf, param1: T) => void): void;
    ...
    writeWithCodec<T extends unknown>(ops: DynamicOps<Tag>, codec: Codec<T>, value: T): FriendlyByteBuf;
