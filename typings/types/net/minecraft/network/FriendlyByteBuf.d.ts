...
export class FriendlyByteBuf extends ByteBuf {
    ...
    readBoolean(): boolean;
    readById<T extends Object | number | string | boolean>(converter: (param0: T) => unknown): T;
    readByte(): number;
    ...
    readCollection<C extends E[]>(ctor: (param0: C) => unknown, elementDecoder: (param0: FriendlyByteBuf) => T): C;
    readContainerId(): number;
    readDouble(): number;
    readEither(leftReader: (param0: FriendlyByteBuf) => L, rightReader: (param0: FriendlyByteBuf) => R): Either<L, R>;
    readEnum<T extends Enum<T>>(clazz: Class<T>): T;
    readEnumSet(clazz: Class<E>): E[];
    ...
    readList(elementDecoder: (param0: FriendlyByteBuf) => T): T[];
    readLong(): number;
    readLongArray(): number[];
    readLongLE(): number;
    readMap<M extends Map<K, V>>(ctor: (param0: M) => unknown, keyDecoder: (param0: FriendlyByteBuf) => K, valueDecoder: (param0: FriendlyByteBuf) => V): M;
    readMap(keyDecoder: (param0: FriendlyByteBuf) => K, valueDecoder: (param0: FriendlyByteBuf) => V): Map<K, V>;
    readMedium(): number;
    readMediumLE(): number;
    readNbt(): CompoundTag;
    ...
    readOptional(valueReader: (param0: FriendlyByteBuf) => T): Optional<T>;
    readPublicKey(): PublicKey;
    readQuaternion(): Quaternionf;
    readRegistryKey(): ResourceKey<T[]>;
    readResourceKey(registry: ResourceKey<T[]>): ResourceKey<T>;
    ...
    writeById<T extends Object | number | string | boolean>(converter: (param0: T) => kotlin.Int, value: T): FriendlyByteBuf;
    ...
    writeCollection(collection: E[], encoder: (param0: FriendlyByteBuf, param1: T) => void): void;
    writeContainerId(id: number): void;
    writeDouble(value: number): FriendlyByteBuf;
    writeEither(value: Either<L, R>, leftWriter: (param0: FriendlyByteBuf, param1: L) => void, rightWriter: (param0: FriendlyByteBuf, param1: R) => void): void;
    writeEnum(value: Enum<Object>): FriendlyByteBuf;
    writeEnumSet(set: E[], clazz: Class<E>): void;
    ...
    writeMap(map: Map<K, V>, keyEncoder: (param0: FriendlyByteBuf, param1: K) => void, valueEncoder: (param0: FriendlyByteBuf, param1: V) => void): void;
    ...
    writeOptional(value: Optional<T>, valueWriter: (param0: FriendlyByteBuf, param1: T) => void): void;
