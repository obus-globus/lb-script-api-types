...
export class SignedMessageChain extends Object {
    ...
    decoder(profilePublicKey: ProfilePublicKey): (param0: MessageSignature, param1: SignedMessageBody) => PlayerChatMessage;
    encoder(signer: Signer): (param0: SignedMessageBody) => MessageSignature;
}