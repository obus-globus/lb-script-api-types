...
import type { ClientboundBundleDelimiterPacket } from '../../../../../net/minecraft/network/protocol/game/ClientboundBundleDelimiterPacket.d.ts'
...
import type { ClientboundMoveEntityPacket$Pos } from '../../../../../net/minecraft/network/protocol/game/ClientboundMoveEntityPacket$Pos.d.ts'
import type { ClientboundMoveEntityPacket$PosRot } from '../../../../../net/minecraft/network/protocol/game/ClientboundMoveEntityPacket$PosRot.d.ts'
import type { ClientboundMoveEntityPacket$Rot } from '../../../../../net/minecraft/network/protocol/game/ClientboundMoveEntityPacket$Rot.d.ts'
...
import type { ServerboundMovePlayerPacket$Pos } from '../../../../../net/minecraft/network/protocol/game/ServerboundMovePlayerPacket$Pos.d.ts'
import type { ServerboundMovePlayerPacket$PosRot } from '../../../../../net/minecraft/network/protocol/game/ServerboundMovePlayerPacket$PosRot.d.ts'
import type { ServerboundMovePlayerPacket$Rot } from '../../../../../net/minecraft/network/protocol/game/ServerboundMovePlayerPacket$Rot.d.ts'
import type { ServerboundMovePlayerPacket$StatusOnly } from '../../../../../net/minecraft/network/protocol/game/ServerboundMovePlayerPacket$StatusOnly.d.ts'
...
export class GamePacketTypes extends Object {
    ...
    static CLIENTBOUND_DEBUG_BLOCK_VALUE: PacketType<ClientboundDebugBlockValuePacket>;
    static CLIENTBOUND_DEBUG_CHUNK_VALUE: PacketType<ClientboundDebugChunkValuePacket>;
    static CLIENTBOUND_DEBUG_ENTITY_VALUE: PacketType<ClientboundDebugEntityValuePacket>;
    static CLIENTBOUND_DEBUG_EVENT: PacketType<ClientboundDebugEventPacket>;
    ...
    static CLIENTBOUND_ENTITY_POSITION_SYNC: PacketType<ClientboundEntityPositionSyncPacket>;
    ...
    static CLIENTBOUND_GAME_RULE_VALUES: PacketType<ClientboundGameRuleValuesPacket>;
    static CLIENTBOUND_GAME_TEST_HIGHLIGHT_POS: PacketType<ClientboundGameTestHighlightPosPacket>;
    ...
    static CLIENTBOUND_LOW_DISK_SPACE_WARNING: PacketType<ClientboundLowDiskSpaceWarningPacket>;
    ...
    static CLIENTBOUND_MOUNT_SCREEN_OPEN: PacketType<ClientboundMountScreenOpenPacket>;
    ...
    static CLIENTBOUND_MOVE_MINECART_ALONG_TRACK: PacketType<ClientboundMoveMinecartPacket>;
    ...
    static CLIENTBOUND_PLAYER_ROTATION: PacketType<ClientboundPlayerRotationPacket>;
    static CLIENTBOUND_PROJECTILE_POWER: PacketType<ClientboundProjectilePowerPacket>;
    static CLIENTBOUND_RECIPE_BOOK_ADD: PacketType<ClientboundRecipeBookAddPacket>;
    static CLIENTBOUND_RECIPE_BOOK_REMOVE: PacketType<ClientboundRecipeBookRemovePacket>;
    static CLIENTBOUND_RECIPE_BOOK_SETTINGS: PacketType<ClientboundRecipeBookSettingsPacket>;
    ...
    static CLIENTBOUND_SET_CURSOR_ITEM: PacketType<ClientboundSetCursorItemPacket>;
    ...
    static CLIENTBOUND_SET_HELD_SLOT: PacketType<ClientboundSetHeldSlotPacket>;
    ...
    static CLIENTBOUND_SET_PLAYER_INVENTORY: PacketType<ClientboundSetPlayerInventoryPacket>;
    ...
    static CLIENTBOUND_TEST_INSTANCE_BLOCK_STATUS: PacketType<ClientboundTestInstanceBlockStatus>;
    ...
    static CLIENTBOUND_WAYPOINT: PacketType<ClientboundTrackedWaypointPacket>;
    static SERVERBOUND_ACCEPT_TELEPORTATION: PacketType<ServerboundAcceptTeleportationPacket>;
    static SERVERBOUND_ATTACK: PacketType<ServerboundAttackPacket>;
    static SERVERBOUND_BLOCK_ENTITY_TAG_QUERY: PacketType<ServerboundBlockEntityTagQueryPacket>;
    static SERVERBOUND_BUNDLE_ITEM_SELECTED: PacketType<ServerboundSelectBundleItemPacket>;
    static SERVERBOUND_CHANGE_DIFFICULTY: PacketType<ServerboundChangeDifficultyPacket>;
    static SERVERBOUND_CHANGE_GAME_MODE: PacketType<ServerboundChangeGameModePacket>;
    ...
    static SERVERBOUND_CLIENT_TICK_END: PacketType<ServerboundClientTickEndPacket>;
    ...
    static SERVERBOUND_DEBUG_SUBSCRIPTION_REQUEST: PacketType<ServerboundDebugSubscriptionRequestPacket>;
    ...
    static SERVERBOUND_PICK_ITEM_FROM_BLOCK: PacketType<ServerboundPickItemFromBlockPacket>;
    static SERVERBOUND_PICK_ITEM_FROM_ENTITY: PacketType<ServerboundPickItemFromEntityPacket>;
    ...
    static SERVERBOUND_PLAYER_LOADED: PacketType<ServerboundPlayerLoadedPacket>;
    ...
    static SERVERBOUND_SET_GAME_RULE: PacketType<ServerboundSetGameRulePacket>;
