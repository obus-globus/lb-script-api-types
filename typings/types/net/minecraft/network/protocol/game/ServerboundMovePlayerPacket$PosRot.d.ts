...
export class ServerboundMovePlayerPacket$PosRot extends ServerboundMovePlayerPacket {
    ...
    constructor(x: number, y: number, z: number, yRot: number, xRot: number, onGround: boolean, horizontalCollision: boolean)
    constructor(pos: Vec3, yRot: number, xRot: number, onGround: boolean, horizontalCollision: boolean)
    type(): PacketType<ServerboundMovePlayerPacket$PosRot>;
