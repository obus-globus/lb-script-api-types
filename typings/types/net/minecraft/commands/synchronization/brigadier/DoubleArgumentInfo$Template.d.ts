...
import type { DoubleArgumentInfo } from '../../../../../net/minecraft/commands/synchronization/brigadier/DoubleArgumentInfo.d.ts'
export class DoubleArgumentInfo$Template extends Object implements ArgumentTypeInfo$Template<DoubleArgumentType> {
    private constructor(null_: DoubleArgumentInfo, min: number, max: number)
    // private max: number;
    // private min: number;
