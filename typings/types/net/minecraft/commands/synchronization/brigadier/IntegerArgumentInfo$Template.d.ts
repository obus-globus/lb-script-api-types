...
import type { IntegerArgumentInfo } from '../../../../../net/minecraft/commands/synchronization/brigadier/IntegerArgumentInfo.d.ts'
export class IntegerArgumentInfo$Template extends Object implements ArgumentTypeInfo$Template<IntegerArgumentType> {
    private constructor(null_: IntegerArgumentInfo, min: number, max: number)
    // private max: number;
    // private min: number;
    instantiate(context: CommandBuildContext): IntegerArgumentType;
    type(): ArgumentTypeInfo<IntegerArgumentType, any>;
}