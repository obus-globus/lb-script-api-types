...
export class CommandSourceStack extends Object implements PermissionContextOwner, CommandPermissionContext$Extension, ExecutionCommandSource<CommandSourceStack>, SharedSuggestionProvider {
    ...
    withCallback(newCallback: (param0: boolean, param1: number) => void, combiner: (param0: (param0: boolean, param1: number) => void, param1: (param0: boolean, param1: number) => void) => (param0: boolean, param1: number) => void): CommandSourceStack;
