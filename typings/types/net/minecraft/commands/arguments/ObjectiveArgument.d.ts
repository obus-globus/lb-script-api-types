...
export class ObjectiveArgument extends Object implements ArgumentType<string> {
    static getObjective(paramcontext: CommandContext<CommandSourceStack>, paramname: string): Objective;
    static getWritableObjective(paramcontext: CommandContext<CommandSourceStack>, paramname: string): Objective;
