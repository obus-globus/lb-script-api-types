...
import type { ScoreHolderArgument$Info } from '../../../../net/minecraft/commands/arguments/ScoreHolderArgument$Info.d.ts'
...
export class ScoreHolderArgument$Info$Template extends Object implements ArgumentTypeInfo$Template<ScoreHolderArgument> {
    private constructor(null_: ScoreHolderArgument$Info, multiple: boolean)
