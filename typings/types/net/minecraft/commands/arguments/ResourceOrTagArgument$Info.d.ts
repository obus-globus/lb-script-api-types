...
export class ResourceOrTagArgument$Info<T extends unknown> extends Object implements ArgumentTypeInfo<ResourceOrTagArgument<T>, ResourceOrTagArgument$Info$Template> {
    constructor()
