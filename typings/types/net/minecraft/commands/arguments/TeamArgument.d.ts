...
export class TeamArgument extends Object implements ArgumentType<string> {
    static getTeam(paramcontext: CommandContext<CommandSourceStack>, paramname: string): PlayerTeam;
