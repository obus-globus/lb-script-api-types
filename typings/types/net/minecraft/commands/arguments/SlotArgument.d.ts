...
export class SlotArgument extends Object implements ArgumentType<number> {
    static getSlot(paramcontext: CommandContext<CommandSourceStack>, paramname: string): number;
