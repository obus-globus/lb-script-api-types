...
export class Vec2Argument extends Object implements ArgumentType<Coordinates> {
    static ERROR_NOT_COMPLETE: SimpleCommandExceptionType;
    static getVec2(paramcontext: CommandContext<CommandSourceStack>, paramname: string): Vec2;
    static vec2(): Vec2Argument;
    static vec2(paramcenterCorrect: boolean): Vec2Argument;
