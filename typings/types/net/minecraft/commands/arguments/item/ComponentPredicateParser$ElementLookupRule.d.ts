...
export class ComponentPredicateParser$ElementLookupRule<T extends unknown, C extends unknown, P extends unknown> extends ResourceLookupRule<ComponentPredicateParser$Context<T, C, P>, T> {
