...
export class GameModeArgument extends Object implements ArgumentType<GameType> {
    static gameMode(): GameModeArgument;
    static getGameMode(paramcontext: CommandContext<CommandSourceStack>, paramname: string): GameType;
    constructor()
    getExamples(): string[];
    ...
    parse<S extends Object | number | string | boolean>(arg0: StringReader, arg1: S): GameType;
