...
export class ResourceArgument$Info<T extends Object | number | string | boolean> extends Object implements ArgumentTypeInfo<ResourceArgument<T>, ResourceArgument$Info$Template> {
    constructor()
