...
export class ParticleArgument extends Object implements ArgumentType<ParticleOptions> {
    static ERROR_INVALID_OPTIONS: DynamicCommandExceptionType;
    static ERROR_UNKNOWN_PARTICLE: DynamicCommandExceptionType;
    static getParticle(paramcontext: CommandContext<CommandSourceStack>, paramname: string): ParticleOptions;
    static particle(paramcontext: CommandBuildContext): ParticleArgument;
    ...
    parse<S extends unknown>(arg0: StringReader, arg1: S): ParticleOptions;
