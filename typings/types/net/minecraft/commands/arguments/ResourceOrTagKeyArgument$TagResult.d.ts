...
export class ResourceOrTagKeyArgument$TagResult<T extends Object | number | string | boolean> extends Record implements ResourceOrTagKeyArgument$Result<T> {
    private constructor(key: TagKey<T>)
    // private key: TagKey<T>;
    asPrintable(): string;
