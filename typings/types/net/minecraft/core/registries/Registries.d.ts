...
export class Registries extends Object {
    ...
    static BLOCK_ENTITY_TYPE: ResourceKey<BlockEntityType<Object>[]>;
    static BLOCK_PREDICATE_TYPE: ResourceKey<BlockPredicateType<Object>[]>;
    static BLOCK_STATE_PROVIDER_TYPE: ResourceKey<BlockStateProviderType<Object>[]>;
    static BLOCK_TYPE: ResourceKey<MapCodec<Block>[]>;
    static CARVER: ResourceKey<WorldCarver<Object>[]>;
    ...
    static COMMAND_ARGUMENT_TYPE: ResourceKey<ArgumentTypeInfo<Object, Object>[]>;
    static CONFIGURED_CARVER: ResourceKey<ConfiguredWorldCarver<Object>[]>;
    static CONFIGURED_FEATURE: ResourceKey<ConfiguredFeature<Object, Object>[]>;
    static CONSUME_EFFECT_TYPE: ResourceKey<ConsumeEffect$Type<Object>[]>;
    ...
    static DATA_COMPONENT_PREDICATE_TYPE: ResourceKey<DataComponentPredicate$Type<Object>[]>;
    ...
    static ENTITY_TYPE: ResourceKey<EntityType<Object>[]>;
    static ENVIRONMENT_ATTRIBUTE: ResourceKey<EnvironmentAttribute<Object>[]>;
    static FEATURE: ResourceKey<Feature<Object>[]>;
    static FEATURE_SIZE_TYPE: ResourceKey<FeatureSizeType<Object>[]>;
    ...
    static FOLIAGE_PLACER_TYPE: ResourceKey<FoliagePlacerType<Object>[]>;
    ...
    static HEIGHT_PROVIDER_TYPE: ResourceKey<HeightProviderType<Object>[]>;
    ...
    static MENU: ResourceKey<MenuType<Object>[]>;
    ...
    static NUMBER_FORMAT_TYPE: ResourceKey<NumberFormatType<Object>[]>;
    ...
    static PARTICLE_TYPE: ResourceKey<ParticleType<Object>[]>;
    ...
    static PLACEMENT_MODIFIER_TYPE: ResourceKey<PlacementModifierType<Object>[]>;
    static POINT_OF_INTEREST_TYPE: ResourceKey<PoiType[]>;
    static POOL_ALIAS_BINDING: ResourceKey<MapCodec<PoolAliasBinding>[]>;
    static POSITION_SOURCE_TYPE: ResourceKey<PositionSourceType<Object>[]>;
    static POS_RULE_TEST: ResourceKey<PosRuleTestType<Object>[]>;
    ...
    static RECIPE: ResourceKey<Recipe<Object>[]>;
    static RECIPE_BOOK_CATEGORY: ResourceKey<RecipeBookCategory[]>;
    static RECIPE_DISPLAY: ResourceKey<RecipeDisplay$Type<Object>[]>;
    static RECIPE_SERIALIZER: ResourceKey<RecipeSerializer<Object>[]>;
    static RECIPE_TYPE: ResourceKey<RecipeType<Object>[]>;
    static ROOT_PLACER_TYPE: ResourceKey<RootPlacerType<Object>[]>;
    static ROOT_REGISTRY_NAME: Identifier;
    static RULE_BLOCK_ENTITY_MODIFIER: ResourceKey<RuleBlockEntityModifierType<Object>[]>;
    static RULE_TEST: ResourceKey<RuleTestType<Object>[]>;
    static SENSOR_TYPE: ResourceKey<SensorType<Object>[]>;
    static SLOT_DISPLAY: ResourceKey<SlotDisplay$Type<Object>[]>;
    ...
    static STRUCTURE_PLACEMENT: ResourceKey<StructurePlacementType<Object>[]>;
    static STRUCTURE_POOL_ELEMENT: ResourceKey<StructurePoolElementType<Object>[]>;
    static STRUCTURE_PROCESSOR: ResourceKey<StructureProcessorType<Object>[]>;
    static STRUCTURE_SET: ResourceKey<StructureSet[]>;
    static STRUCTURE_TYPE: ResourceKey<StructureType<Object>[]>;
    ...
    static TREE_DECORATOR_TYPE: ResourceKey<TreeDecoratorType<Object>[]>;
    static TRIAL_SPAWNER_CONFIG: ResourceKey<TrialSpawnerConfig[]>;
    static TRIGGER_TYPE: ResourceKey<CriterionTrigger<Object>[]>;
    static TRIM_MATERIAL: ResourceKey<TrimMaterial[]>;
    static TRIM_PATTERN: ResourceKey<TrimPattern[]>;
    static TRUNK_PLACER_TYPE: ResourceKey<TrunkPlacerType<Object>[]>;
