...
export class BuiltInRegistries extends Object implements BuiltInRegistriesAccessor<Object> {
    ...
    static BLOCK: Block[];
    static BLOCKSTATE_PROVIDER_TYPE: BlockStateProviderType<Object>[];
    static BLOCK_ENTITY_TYPE: BlockEntityType<Object>[];
    static BLOCK_PREDICATE_TYPE: BlockPredicateType<Object>[];
    static BLOCK_TYPE: MapCodec<Block>[];
    static CARVER: WorldCarver<Object>[];
    static CHUNK_GENERATOR: MapCodec<ChunkGenerator>[];
    static CHUNK_STATUS: ChunkStatus[];
    static COMMAND_ARGUMENT_TYPE: ArgumentTypeInfo<Object, Object>[];
    static CONSUME_EFFECT_TYPE: ConsumeEffect$Type<Object>[];
    ...
    static DATA_COMPONENT_PREDICATE_TYPE: DataComponentPredicate$Type<Object>[];
    ...
    static ENTITY_TYPE: EntityType<Object>[];
    static ENVIRONMENT_ATTRIBUTE: EnvironmentAttribute<Object>[];
    static FEATURE: Feature<Object>[];
    static FEATURE_SIZE_TYPE: FeatureSizeType<Object>[];
    static FLOAT_PROVIDER_TYPE: MapCodec<FloatProvider>[];
    static FLUID: Fluid[];
    static FOLIAGE_PLACER_TYPE: FoliagePlacerType<Object>[];
    static GAME_EVENT: GameEvent[];
    static GAME_RULE: GameRule<Object>[];
    static HEIGHT_PROVIDER_TYPE: HeightProviderType<Object>[];
    ...
    static MENU: MenuType<Object>[];
    static MOB_EFFECT: MobEffect[];
    static NUMBER_FORMAT_TYPE: NumberFormatType<Object>[];
    static OUTGOING_RPC_METHOD: OutgoingRpcMethod<Object, Object>[];
    static PARTICLE_TYPE: ParticleType<Object>[];
    static PERMISSION_CHECK_TYPE: MapCodec<PermissionCheck>[];
    static PERMISSION_TYPE: MapCodec<Permission>[];
    static PLACEMENT_MODIFIER_TYPE: PlacementModifierType<Object>[];
    static POINT_OF_INTEREST_TYPE: PoiType[];
    static POOL_ALIAS_BINDING_TYPE: MapCodec<PoolAliasBinding>[];
    static POSITION_SOURCE_TYPE: PositionSourceType<Object>[];
    static POS_RULE_TEST: PosRuleTestType<Object>[];
    static POTION: Potion[];
    static RECIPE_BOOK_CATEGORY: RecipeBookCategory[];
    static RECIPE_DISPLAY: RecipeDisplay$Type<Object>[];
    static RECIPE_SERIALIZER: RecipeSerializer<Object>[];
    static RECIPE_TYPE: RecipeType<Object>[];
    static REGISTRY: Object[][];
    static ROOT_PLACER_TYPE: RootPlacerType<Object>[];
    static RULE_BLOCK_ENTITY_MODIFIER: RuleBlockEntityModifierType<Object>[];
    static RULE_TEST: RuleTestType<Object>[];
    static SENSOR_TYPE: SensorType<Object>[];
    static SLOT_DISPLAY: SlotDisplay$Type<Object>[];
    ...
    static STRUCTURE_PLACEMENT: StructurePlacementType<Object>[];
    static STRUCTURE_POOL_ELEMENT: StructurePoolElementType<Object>[];
    static STRUCTURE_PROCESSOR: StructureProcessorType<Object>[];
    static STRUCTURE_TYPE: StructureType<Object>[];
    ...
    static TREE_DECORATOR_TYPE: TreeDecoratorType<Object>[];
    static TRIGGER_TYPES: CriterionTrigger<Object>[];
    static TRUNK_PLACER_TYPE: TrunkPlacerType<Object>[];
