...
export class ItemTags extends Object {
    ...
    static GLAZED_TERRACOTTA: TagKey<Item>;
    ...
    static SULFUR_CUBE_ARCHETYPE_BOUNCY: TagKey<Item>;
    static SULFUR_CUBE_ARCHETYPE_EXPLOSIVE: TagKey<Item>;
    static SULFUR_CUBE_ARCHETYPE_FAST_FLAT: TagKey<Item>;
    static SULFUR_CUBE_ARCHETYPE_FAST_SLIDING: TagKey<Item>;
    static SULFUR_CUBE_ARCHETYPE_HIGH_RESISTANCE: TagKey<Item>;
    static SULFUR_CUBE_ARCHETYPE_HOT: TagKey<Item>;
    static SULFUR_CUBE_ARCHETYPE_LIGHT: TagKey<Item>;
    static SULFUR_CUBE_ARCHETYPE_REGULAR: TagKey<Item>;
    static SULFUR_CUBE_ARCHETYPE_SLOW_BOUNCY: TagKey<Item>;
    static SULFUR_CUBE_ARCHETYPE_SLOW_FLAT: TagKey<Item>;
    static SULFUR_CUBE_ARCHETYPE_SLOW_SLIDING: TagKey<Item>;
    static SULFUR_CUBE_ARCHETYPE_STICKY: TagKey<Item>;
    static SULFUR_CUBE_FOOD: TagKey<Item>;
    static SULFUR_CUBE_SWALLOWABLE: TagKey<Item>;
