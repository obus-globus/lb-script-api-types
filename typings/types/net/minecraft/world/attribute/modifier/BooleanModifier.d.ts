...
export class BooleanModifier extends Enum<BooleanModifier> implements AttributeModifier<boolean, boolean> {
    ...
    static ARGB_COLOR_LIBRARY: { [key in AttributeModifier$OperationId]: Object | null };
    static BOOLEAN_LIBRARY: { [key in AttributeModifier$OperationId]: Object | null };
    static FLOAT_LIBRARY: { [key in AttributeModifier$OperationId]: Object | null };
    static INTEGER_LIBRARY: { [key in AttributeModifier$OperationId]: Object | null };
    static NAND: BooleanModifier;
    static NOR: BooleanModifier;
    static OR: BooleanModifier;
    static RGB_COLOR_LIBRARY: { [key in AttributeModifier$OperationId]: Object | null };
