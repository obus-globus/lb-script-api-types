...
export class NoiseRouterData extends Object {
    ...
    static registerTerrainNoises(paramcontext: BootstrapContext<DensityFunction>, paramfunctions: HolderGetter<DensityFunction>, paramjaggedNoise: DensityFunction, paramcontinentsFunction: DensityFunction, paramerosionFunction: DensityFunction, paramoffsetName: ResourceKey<DensityFunction>, paramfactorName: ResourceKey<DensityFunction>, paramjaggednessName: ResourceKey<DensityFunction>, paramdepthName: ResourceKey<DensityFunction>, paramslopedCheeseName: ResourceKey<DensityFunction>, paramamplified: boolean): void;
