...
export class CarverConfiguration extends ProbabilityFeatureConfiguration {
    ...
    constructor(probability: number, y: HeightProvider, yScale: FloatProvider, lavaLevel: VerticalAnchor, debugSettings: CarverDebugSettings, replaceable: Holder<T>[])
    debugSettings: CarverDebugSettings;
    lavaLevel: VerticalAnchor;
    replaceable: Holder<T>[];
    y: HeightProvider;
