...
export class SpikeFeature extends Feature<SpikeConfiguration> {
    ...
    place(context: FeaturePlaceContext<SpikeConfiguration>): boolean;
    place(config: SpikeConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}