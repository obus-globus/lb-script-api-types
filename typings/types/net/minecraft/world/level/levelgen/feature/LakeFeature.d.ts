...
export class LakeFeature extends Feature<LakeFeature$Configuration> {
    ...
    constructor(codec: Codec<LakeFeature$Configuration>)
    // private canReplaceBlock(state: BlockState): boolean;
    place(context: FeaturePlaceContext<LakeFeature$Configuration>): boolean;
    place(config: LakeFeature$Configuration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}