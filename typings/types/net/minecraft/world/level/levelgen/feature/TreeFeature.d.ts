...
export class TreeFeature extends Feature<TreeConfiguration> {
    ...
    static getLowestTrunkOrRootOfTree(paramcontext: TreeDecorator$Context): BlockPos[];
    static isAdjacentToAir(paramblockGetter: (param0: BlockPos) => BlockState, parampos: BlockPos): boolean;
    static isAirOrLeaves(paramlevel: LevelSimulatedReader, parampos: BlockPos): boolean;
    static isReplaceable(paramcannotReplaceTag: TagKey<Block>): (param0: BlockState) => boolean;
    static isVine(paramlevel: LevelSimulatedReader, parampos: BlockPos): boolean;
    static validTreePos(paramlevel: LevelSimulatedReader, parampos: BlockPos): boolean;
