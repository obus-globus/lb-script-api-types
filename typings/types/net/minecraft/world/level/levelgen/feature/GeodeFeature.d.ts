...
export class GeodeFeature extends Feature<GeodeConfiguration> {
    ...
    constructor(codec: Codec<GeodeConfiguration>)
    place(context: FeaturePlaceContext<GeodeConfiguration>): boolean;
    place(config: GeodeConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}