...
export class WeightedRandomFeatureConfiguration extends Record implements FeatureConfiguration {
    static CODEC: Codec<WeightedRandomFeatureConfiguration>;
    static NONE: NoneFeatureConfiguration;
    constructor(features: WeightedList<Holder<PlacedFeature>>)
    // private features: WeightedList<Holder<PlacedFeature>>;
    equals(o: Object | null): boolean;
    features(): WeightedList<Holder<PlacedFeature>>;
