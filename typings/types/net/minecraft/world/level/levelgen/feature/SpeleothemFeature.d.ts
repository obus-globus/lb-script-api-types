...
export class SpeleothemFeature extends Feature<SpeleothemConfiguration> {
    ...
    constructor(codec: Codec<SpeleothemConfiguration>)
    place(context: FeaturePlaceContext<SpeleothemConfiguration>): boolean;
    place(config: SpeleothemConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}