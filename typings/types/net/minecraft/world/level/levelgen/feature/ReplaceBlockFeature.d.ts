...
export class ReplaceBlockFeature extends Feature<ReplaceBlockConfiguration> {
    ...
    constructor(codec: Codec<ReplaceBlockConfiguration>)
    place(context: FeaturePlaceContext<ReplaceBlockConfiguration>): boolean;
    place(config: ReplaceBlockConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}