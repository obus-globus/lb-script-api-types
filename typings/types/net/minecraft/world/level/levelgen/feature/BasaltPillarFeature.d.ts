...
export class BasaltPillarFeature extends Feature<NoneFeatureConfiguration> {
    ...
    // private placeBaseHangOff(level: LevelAccessor, random: RandomSource, pos: BlockPos): void;
    // private placeHangOff(level: LevelAccessor, random: RandomSource, hangOffPos: BlockPos): boolean;
}