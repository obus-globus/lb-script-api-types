...
export class MultifaceGrowthConfiguration extends Object implements FeatureConfiguration {
    ...
    constructor(placeBlock: MultifaceSpreadeableBlock, searchRange: number, canPlaceOnFloor: boolean, canPlaceOnCeiling: boolean, canPlaceOnWall: boolean, chanceOfSpreading: number, canBePlacedOn: Holder<Block>[])
