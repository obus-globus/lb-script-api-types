...
export class SpringFeature extends Feature<SpringConfiguration> {
    ...
    constructor(codec: Codec<SpringConfiguration>)
    place(context: FeaturePlaceContext<SpringConfiguration>): boolean;
    place(config: SpringConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}