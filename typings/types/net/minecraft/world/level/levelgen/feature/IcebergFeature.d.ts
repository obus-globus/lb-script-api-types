...
export class IcebergFeature extends Feature<BlockStateConfiguration> {
    ...
    // private belowIsAir(level: BlockGetter, pos: BlockPos): boolean;
    // private carve(radius: number, yOff: number, globalOrigin: BlockPos, level: LevelAccessor, underWater: boolean, angle: number, localOrigin: BlockPos, shapeEllipseA: number, shapeEllipseC: number): void;
    // private generateCutOut(random: RandomSource, level: LevelAccessor, width: number, height: number, globalOrigin: BlockPos, isEllipse: boolean, shapeEllipseA: number, shapeAngle: number, shapeEllipseC: number): void;
    // private generateIcebergBlock(level: LevelAccessor, random: RandomSource, origin: BlockPos, height: number, xo: number, yOff: number, zo: number, radius: number, a: number, isEllipse: boolean, shapeEllipseC: number, shapeAngle: number, snowOnTop: boolean, mainBlockState: BlockState): void;
    // private getEllipseC(yOff: number, height: number, shapeEllipseC: number): number;
    // private heightDependentRadiusEllipse(yOff: number, height: number, width: number): number;
    ...
    // private signedDistanceEllipse(xo: number, zo: number, origin: BlockPos, a: number, c: number, angle: number): number;
    // private smooth(level: LevelAccessor, origin: BlockPos, width: number, height: number, isEllipse: boolean, shapeEllipseA: number): void;
}