...
export class SeaPickleFeature extends Feature<CountConfiguration> {
    ...
    constructor(codec: Codec<CountConfiguration>)
    place(context: FeaturePlaceContext<CountConfiguration>): boolean;
    place(config: CountConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}