...
export class PointedDripstoneFeature extends Feature<PointedDripstoneConfiguration> {
    ...
    place(context: FeaturePlaceContext<PointedDripstoneConfiguration>): boolean;
    place(config: PointedDripstoneConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}