...
export class NetherForestVegetationFeature extends Feature<NetherForestVegetationConfig> {
    ...
    constructor(codec: Codec<NetherForestVegetationConfig>)
    place(context: FeaturePlaceContext<NetherForestVegetationConfig>): boolean;
    place(config: NetherForestVegetationConfig, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}