...
export class DeltaFeature extends Feature<DeltaFeatureConfiguration> {
    ...
    place(context: FeaturePlaceContext<DeltaFeatureConfiguration>): boolean;
    place(config: DeltaFeatureConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}