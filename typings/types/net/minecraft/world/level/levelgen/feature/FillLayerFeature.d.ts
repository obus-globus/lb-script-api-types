...
export class FillLayerFeature extends Feature<LayerConfiguration> {
    ...
    constructor(codec: Codec<LayerConfiguration>)
    place(context: FeaturePlaceContext<LayerConfiguration>): boolean;
    place(config: LayerConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}