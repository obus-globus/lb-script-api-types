...
export class WeightedRandomSelectorFeature extends Feature<WeightedRandomFeatureConfiguration> {
    ...
    constructor(codec: Codec<WeightedRandomFeatureConfiguration>)
    place(context: FeaturePlaceContext<WeightedRandomFeatureConfiguration>): boolean;
    place(config: WeightedRandomFeatureConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}