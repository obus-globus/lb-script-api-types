...
export class EndGatewayFeature extends Feature<EndGatewayConfiguration> {
    ...
    place(context: FeaturePlaceContext<EndGatewayConfiguration>): boolean;
    place(config: EndGatewayConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}