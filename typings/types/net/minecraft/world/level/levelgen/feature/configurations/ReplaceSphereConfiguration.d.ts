...
export class ReplaceSphereConfiguration extends Object implements FeatureConfiguration {
    static CODEC: Codec<ReplaceSphereConfiguration>;
    static NONE: NoneFeatureConfiguration;
    constructor(targetState: BlockState, replaceState: BlockState, radius: IntProvider)
