...
import type { AbstractHugeMushroomFeature } from '../../../../../../net/minecraft/world/level/levelgen/feature/AbstractHugeMushroomFeature.d.ts'
...
export class HugeBrownMushroomFeature extends AbstractHugeMushroomFeature {
    ...
    static MIN_MUSHROOM_HEIGHT: number;
