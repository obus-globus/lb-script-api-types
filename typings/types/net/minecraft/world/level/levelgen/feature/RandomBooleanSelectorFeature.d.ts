...
export class RandomBooleanSelectorFeature extends Feature<RandomBooleanFeatureConfiguration> {
    ...
    constructor(codec: Codec<RandomBooleanFeatureConfiguration>)
    place(context: FeaturePlaceContext<RandomBooleanFeatureConfiguration>): boolean;
    place(config: RandomBooleanFeatureConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}