...
export class TemplateFeature extends Feature<TemplateFeatureConfiguration> {
    ...
    constructor(codec: Codec<TemplateFeatureConfiguration>)
    // private getRotatedOffset(rotation: Rotation, axis: Direction$Axis, template: StructureTemplate): Vec3i;
    place(context: FeaturePlaceContext<TemplateFeatureConfiguration>): boolean;
    place(config: TemplateFeatureConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}