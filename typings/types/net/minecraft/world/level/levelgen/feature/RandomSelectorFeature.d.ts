...
export class RandomSelectorFeature extends Feature<RandomFeatureConfiguration> {
    ...
    constructor(codec: Codec<RandomFeatureConfiguration>)
    place(context: FeaturePlaceContext<RandomFeatureConfiguration>): boolean;
    place(config: RandomFeatureConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}