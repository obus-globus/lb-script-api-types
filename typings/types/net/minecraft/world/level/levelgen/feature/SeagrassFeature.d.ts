...
export class SeagrassFeature extends Feature<ProbabilityFeatureConfiguration> {
    ...
    constructor(codec: Codec<ProbabilityFeatureConfiguration>)
    place(context: FeaturePlaceContext<ProbabilityFeatureConfiguration>): boolean;
    place(config: ProbabilityFeatureConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}