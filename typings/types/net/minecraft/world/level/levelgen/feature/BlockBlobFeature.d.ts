...
export class BlockBlobFeature extends Feature<BlockBlobConfiguration> {
    ...
    constructor(codec: Codec<BlockBlobConfiguration>)
    place(context: FeaturePlaceContext<BlockBlobConfiguration>): boolean;
    place(config: BlockBlobConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}