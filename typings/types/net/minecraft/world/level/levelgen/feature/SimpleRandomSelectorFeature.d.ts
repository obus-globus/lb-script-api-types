...
export class SimpleRandomSelectorFeature extends Feature<CompositeFeatureConfiguration> {
    ...
    constructor(codec: Codec<CompositeFeatureConfiguration>)
    place(context: FeaturePlaceContext<CompositeFeatureConfiguration>): boolean;
    place(config: CompositeFeatureConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}