...
export class SimpleRandomSelectorFeature extends Feature<SimpleRandomFeatureConfiguration> {
    ...
    constructor(codec: Codec<SimpleRandomFeatureConfiguration>)
    place(context: FeaturePlaceContext<SimpleRandomFeatureConfiguration>): boolean;
    place(config: SimpleRandomFeatureConfiguration, level: WorldGenLevel, chunkGenerator: ChunkGenerator, random: RandomSource, origin: BlockPos): boolean;
}