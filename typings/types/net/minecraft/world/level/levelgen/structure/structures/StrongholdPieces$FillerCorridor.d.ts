...
export class StrongholdPieces$FillerCorridor extends StrongholdPieces$StrongholdPiece {
    ...
    static findPieceBox(paramstructurePieceAccessor: StructurePieceAccessor, paramrandom: RandomSource, paramfootX: number, paramfootY: number, paramfootZ: number, paramdirection: Direction): BoundingBox;
