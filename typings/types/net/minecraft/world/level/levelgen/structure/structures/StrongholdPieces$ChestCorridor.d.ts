...
export class StrongholdPieces$ChestCorridor extends StrongholdPieces$StrongholdPiece {
    ...
    static createPiece(paramstructurePieceAccessor: StructurePieceAccessor, paramrandom: RandomSource, paramfootX: number, paramfootY: number, paramfootZ: number, paramdirection: Direction, paramgenDepth: number): StrongholdPieces$ChestCorridor;
