...
export class LavaSubmergedBlockProcessor extends Object implements StructureProcessor {
    static INSTANCE: LavaSubmergedBlockProcessor;
    static MAP_CODEC: MapCodec<LavaSubmergedBlockProcessor>;
    constructor()
    codec(): MapCodec<LavaSubmergedBlockProcessor>;
