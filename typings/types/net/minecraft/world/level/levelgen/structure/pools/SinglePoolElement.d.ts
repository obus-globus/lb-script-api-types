...
export class SinglePoolElement extends StructurePoolElement {
    ...
    constructor(template: Either<Identifier, StructureTemplate>, processors: Holder<StructureProcessorList>, projection: StructureTemplatePool$Projection, overrideLiquidSettings: Optional<LiquidSettings>)
    // private overrideLiquidSettings: Optional<LiquidSettings>;
    // private processors: Holder<StructureProcessorList>;
    // private template: Either<Identifier, StructureTemplate>;
    getBoundingBox(structureTemplateManager: StructureTemplateManager, position: BlockPos, rotation: Rotation): BoundingBox;
    getDataMarkers(structureTemplateManager: StructureTemplateManager, position: BlockPos, rotation: Rotation, absolute: boolean): StructureTemplate$StructureBlockInfo[];
