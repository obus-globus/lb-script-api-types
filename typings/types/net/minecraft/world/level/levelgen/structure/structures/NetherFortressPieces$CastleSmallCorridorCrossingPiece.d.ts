...
export class NetherFortressPieces$CastleSmallCorridorCrossingPiece extends NetherFortressPieces$NetherBridgePiece {
    ...
    static createPiece(paramstructurePieceAccessor: StructurePieceAccessor, paramfootX: number, paramfootY: number, paramfootZ: number, paramdirection: Direction, paramgenDepth: number): NetherFortressPieces$CastleSmallCorridorCrossingPiece;
