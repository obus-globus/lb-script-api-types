...
export class BlockIgnoreProcessor extends Object implements StructureProcessor {
    static AIR: BlockIgnoreProcessor;
    static MAP_CODEC: MapCodec<BlockIgnoreProcessor>;
    static STRUCTURE_AND_AIR: BlockIgnoreProcessor;
    static STRUCTURE_BLOCK: BlockIgnoreProcessor;
    constructor(toIgnore: Block[])
    // private toIgnore: Block[];
