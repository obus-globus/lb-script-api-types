...
export class NetherFortressPieces$MonsterThrone extends NetherFortressPieces$NetherBridgePiece {
    ...
    static createPiece(paramstructurePieceAccessor: StructurePieceAccessor, paramfootX: number, paramfootY: number, paramfootZ: number, paramgenDepth: number, paramdirection: Direction): NetherFortressPieces$MonsterThrone;
    ...
    // private hasPlacedSpawner: boolean;
