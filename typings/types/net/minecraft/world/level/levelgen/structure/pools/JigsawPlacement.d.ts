...
export class JigsawPlacement extends Object {
    static addPieces(paramcontext: Structure$GenerationContext, paramstartPool: Holder<StructureTemplatePool>, paramstartJigsaw: Optional<Identifier>, parammaxDepth: number, paramposition: BlockPos, paramdoExpansionHack: boolean, paramprojectStartToHeightmap: Optional<Heightmap$Types>, parammaxDistanceFromCenter: JigsawStructure$MaxDistance, parampoolAliasLookup: (param0: ResourceKey<StructureTemplatePool>) => ResourceKey<StructureTemplatePool>, paramdimensionPadding: DimensionPadding, paramliquidSettings: LiquidSettings): Optional<Structure$GenerationStub>;
