...
export class MineshaftPieces$MineShaftStairs extends MineshaftPieces$MineShaftPiece {
    ...
    static findStairs(paramstructurePieceAccessor: StructurePieceAccessor, paramrandom: RandomSource, paramfootX: number, paramfootY: number, paramfootZ: number, paramdirection: Direction): BoundingBox;
