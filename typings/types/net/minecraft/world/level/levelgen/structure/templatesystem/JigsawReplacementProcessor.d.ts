...
export class JigsawReplacementProcessor extends Object implements StructureProcessor {
    static INSTANCE: JigsawReplacementProcessor;
    static MAP_CODEC: MapCodec<JigsawReplacementProcessor>;
    private constructor()
    codec(): MapCodec<JigsawReplacementProcessor>;
