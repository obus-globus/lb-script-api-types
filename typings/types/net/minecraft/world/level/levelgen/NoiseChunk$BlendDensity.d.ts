...
export class NoiseChunk$BlendDensity extends Object implements DensityFunctions$MarkerOrMarked, NoiseChunk$NoiseChunkDensityFunction {
    static CODEC: Codec<DensityFunction>;
    private constructor(null_: NoiseChunk, input: DensityFunction)
