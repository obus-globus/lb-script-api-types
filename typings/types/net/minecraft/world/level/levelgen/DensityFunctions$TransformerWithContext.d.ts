...
export interface DensityFunctions$TransformerWithContext extends Object, DensityFunction{
    abs(): DensityFunction;
    ...
    transform(contextSupplier: DensityFunction$FunctionContext, input: number): number;
}