...
export abstract class SpreadingSnowyBlock extends SnowyBlock {
    ...
    constructor(properties: BlockBehaviour$Properties, baseBlock: ResourceKey<Block>)
    // private baseBlock: ResourceKey<Block>;
    codec(): MapCodec<SpreadingSnowyBlock>;
