...
import type { AbstractChestBlock } from '../../../../../net/minecraft/world/level/block/AbstractChestBlock.d.ts'
...
export class ChestBlock extends AbstractChestBlock<(Object | null)[]> implements SimpleWaterloggedBlock {
    ...
    constructor(blockEntityType: () => BlockEntityType<(Object | null)[]>, openSound: SoundEvent, closeSound: SoundEvent, properties: BlockBehaviour$Properties)
    // private closeSound: SoundEvent;
    // private openSound: SoundEvent;
    affectNeighborsAfterRemoval(state: BlockState, level: ServerLevel, pos: BlockPos, movedByPiston: boolean): void;
    blockEntityType(): BlockEntityType<(Object | null)[]>;
    canPlaceLiquid(user: LivingEntity, level: BlockGetter, pos: BlockPos, state: BlockState, type: Fluid): boolean;
    // private candidatePartnerFacing(level: Level, pos: BlockPos, neighbourDirection: Direction): Direction;
    chestCanConnectTo(blockState: BlockState): boolean;
    codec(): MapCodec<ChestBlock>;
    combine(state: BlockState, level: Level, pos: BlockPos, ignoreBeingBlocked: boolean): DoubleBlockCombiner$NeighborCombineResult<(Object | null)[]>;
    ...
    getChestType(level: Level, pos: BlockPos, facingDirection: Direction): ChestType;
    getCloseChestSound(): SoundEvent;
