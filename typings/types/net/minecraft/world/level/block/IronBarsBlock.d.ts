...
export class IronBarsBlock extends CrossCollisionBlock implements ICrossCollisionBlock {
    ...
    // private viaFabricPlus$shape_r1_12_2: VoxelShape[];
    // private viaFabricPlus$shape_r1_8: VoxelShape[];
    attachsTo(state: BlockState, faceSolid: boolean): boolean;
