...
export class CeilingHangingSignBlock extends SignBlock implements HangingSignBlock {
    ...
    // private shouldTryToChainAnotherHangingSign(player: Player, hitResult: BlockHitResult, signEntity: SignBlockEntity, itemStack: ItemStack): boolean;
