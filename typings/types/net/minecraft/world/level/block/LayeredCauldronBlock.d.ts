...
import type { AbstractCauldronBlock } from '../../../../../net/minecraft/world/level/block/AbstractCauldronBlock.d.ts'
...
export class LayeredCauldronBlock extends AbstractCauldronBlock {
    ...
    static lowerFillLevel(paramstate: BlockState, paramlevel: Level, parampos: BlockPos): void;
    ...
    constructor(precipitationType: Biome$Precipitation, interactionMap: CauldronInteraction$Dispatcher, properties: BlockBehaviour$Properties)
    // private precipitationType: Biome$Precipitation;
    ...
    getContentHeight(state: BlockState): number;
    getEntityInsideCollisionShape(state: BlockState, level: BlockGetter, pos: BlockPos, entity: Entity): VoxelShape;
    // private handleEntityOnFireInside(state: BlockState, level: Level, pos: BlockPos): void;
    ...
    receiveStalactiteDrip(state: BlockState, level: Level, pos: BlockPos, fluid: Fluid): void;
}