...
export class SculkVeinBlock extends MultifaceSpreadeableBlock implements SculkBehaviour {
    ...
    static availableFaces(paramstate: BlockState): Direction[];
    ...
    static getFaceProperty(paramfaceDirection: Direction): BooleanProperty;
    static getId(paramblockState: BlockState): number;
    static hasFace(paramstate: BlockState, paramfaceDirection: Direction): boolean;
    static hasSubstrateAccess(paramlevel: LevelAccessor, paramstate: BlockState, parampos: BlockPos): boolean;
    ...
    readonly sameSpaceSpreader: MultifaceSpreader;
    // private veinSpreader: MultifaceSpreader;
    // private attemptPlaceSculk(spreader: SculkSpreader, level: LevelAccessor, pos: BlockPos, random: RandomSource): boolean;
    attemptSpreadVein(level: LevelAccessor, pos: BlockPos, state: BlockState, facings: Direction[], postProcess: boolean): boolean;
