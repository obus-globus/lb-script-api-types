...
export class JigsawBlock extends Block implements EntityBlock, GameMasterBlock {
    ...
    static canAttach(paramsource: StructureTemplate$JigsawBlockInfo, paramtarget: StructureTemplate$JigsawBlockInfo): boolean;
    ...
    static getFrontFacing(paramstate: BlockState): Direction;
    static getId(paramblockState: BlockState): number;
    static getTopFacing(paramstate: BlockState): Direction;
