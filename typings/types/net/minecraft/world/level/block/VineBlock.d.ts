...
export class VineBlock extends Block {
    ...
    static getPropertyForFace(paramdirection: Direction): BooleanProperty;
    static isAcceptableNeighbour(paramlevel: BlockGetter, paramneighbourPos: BlockPos, paramdirectionToNeighbour: Direction): boolean;
    ...
    // private copyRandomFaces(from: BlockState, to: BlockState, random: RandomSource): BlockState;
    // private countFaces(blockState: BlockState): number;
    ...
    // private getUpdatedState(state: BlockState, level: BlockGetter, pos: BlockPos): BlockState;
    // private hasFaces(blockState: BlockState): boolean;
    // private hasHorizontalConnection(state: BlockState): boolean;
