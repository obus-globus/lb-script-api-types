...
import type { CarpetBlock } from '../../../../../net/minecraft/world/level/block/CarpetBlock.d.ts'
...
export class WoolCarpetBlock extends CarpetBlock {
    ...
    codec(): MapCodec<WoolCarpetBlock>;
    getColor(): DyeColor;
}