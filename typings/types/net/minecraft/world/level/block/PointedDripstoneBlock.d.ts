...
import type { SpeleothemBlock } from '../../../../../net/minecraft/world/level/block/SpeleothemBlock.d.ts'
...
export class PointedDripstoneBlock extends SpeleothemBlock {
    ...
    static findStalactiteTipAboveCauldron(paramlevel: Level, paramcauldronPos: BlockPos): BlockPos;
    static getCauldronFillFluidType(paramlevel: ServerLevel, paramstalactitePos: BlockPos): Fluid;
    ...
    static maybeTransferFluid(paramstate: BlockState, paramlevel: ServerLevel, parampos: BlockPos, paramrandomValue: number): void;
    ...
    static spawnDripParticle(paramlevel: Level, paramstalactiteTipPos: BlockPos, paramstalactiteTipState: BlockState): void;
