...
export class PointedDripstoneBlock extends Block implements Fallable, SimpleWaterloggedBlock {
    ...
    static canDrip(paramstate: BlockState): boolean;
    ...
    static growStalactiteOrStalagmiteIfPossible(paramstalactiteStartState: BlockState, paramlevel: ServerLevel, paramstalactiteStartPos: BlockPos, paramrandom: RandomSource): void;
