...
export class TripWireBlock extends Block {
    ...
    // private checkPressed(level: Level, pos: BlockPos): void;
    // private checkPressed(level: Level, pos: BlockPos, entities: Entity[]): void;
    ...
    shouldConnectTo(blockState: BlockState, direction: Direction): boolean;
    ...
    // private updateSource(level: Level, pos: BlockPos, state: BlockState): void;
}