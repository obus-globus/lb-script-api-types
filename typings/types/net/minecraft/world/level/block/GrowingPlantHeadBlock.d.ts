...
import type { GrowingPlantBlock } from '../../../../../net/minecraft/world/level/block/GrowingPlantBlock.d.ts'
...
export abstract class GrowingPlantHeadBlock extends GrowingPlantBlock implements BonemealableBlock {
    ...
    constructor(properties: BlockBehaviour$Properties, growthDirection: Direction, shape: VoxelShape, scheduleFluidTicks: boolean, growPerTickProbability: number)
    // private growPerTickProbability: number;
    canGrowInto(state: BlockState): boolean;
    codec(): MapCodec<GrowingPlantHeadBlock>;
    ...
    getGrowIntoState(growFromState: BlockState, random: RandomSource): BlockState;
    ...
    updateBodyAfterConvertedFromHead(headState: BlockState, bodyState: BlockState): BlockState;
