...
export class CrafterBlock extends BaseEntityBlock {
    ...
    static getPotentialResults(paramlevel: ServerLevel, paraminput: CraftingInput): Optional<RecipeHolder<CraftingRecipe>>;
    ...
    // private setBlockEntityTriggered(blockEntity: BlockEntity, triggered: boolean): void;
