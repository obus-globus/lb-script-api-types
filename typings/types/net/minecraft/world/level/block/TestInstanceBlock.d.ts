...
export class TestInstanceBlock extends BaseEntityBlock implements GameMasterBlock {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<TestInstanceBlock>;
    ...
    codec(): MapCodec<TestInstanceBlock>;
