...
import type { TorchBlock } from '../../../../../net/minecraft/world/level/block/TorchBlock.d.ts'
...
export class WallTorchBlock extends TorchBlock {
    ...
    static canSurvive(paramlevel: LevelReader, parampos: BlockPos, paramfacing: Direction): boolean;
    ...
    static getShape(paramstate: BlockState): VoxelShape;
