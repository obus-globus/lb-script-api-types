...
export class HangingMossBlock extends Block implements BonemealableBlock {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<Block>;
    static CODEC: MapCodec<HangingMossBlock>;
    ...
    // private canGrowInto(state: BlockState): boolean;
    // private canStayAtPosition(level: BlockGetter, pos: BlockPos): boolean;
    canSurvive(state: BlockState, level: LevelReader, pos: BlockPos): boolean;
    codec(): MapCodec<HangingMossBlock>;
    ...
    getTip(level: BlockGetter, pos: BlockPos): BlockPos;
