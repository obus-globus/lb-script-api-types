...
import type { IronBarsBlock } from '../../../../../net/minecraft/world/level/block/IronBarsBlock.d.ts'
...
export class WeatheringCopperBarsBlock extends IronBarsBlock implements WeatheringCopper {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<Block>;
    static CODEC: MapCodec<IronBarsBlock>;
    static CODEC: MapCodec<WeatheringCopperBarsBlock>;
    ...
    codec(): MapCodec<WeatheringCopperBarsBlock>;
