...
export class MushroomBlock extends VegetationBlock implements BonemealableBlock {
    ...
    growMushroom(level: ServerLevel, pos: BlockPos, state: BlockState, random: RandomSource): boolean;
