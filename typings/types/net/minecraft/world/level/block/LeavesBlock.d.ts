...
export abstract class LeavesBlock extends Block implements SimpleWaterloggedBlock {
    ...
    // private leafParticleChance: number;
    ...
    decaying(state: BlockState): boolean;
    ...
    // private makeFallingLeavesParticles(level: Level, pos: BlockPos, random: RandomSource, belowState: BlockState, below: BlockPos): void;
