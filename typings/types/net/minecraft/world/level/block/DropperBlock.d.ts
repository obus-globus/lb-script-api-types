...
import type { DispenserBlock } from '../../../../../net/minecraft/world/level/block/DispenserBlock.d.ts'
...
export class DropperBlock extends DispenserBlock {
    ...
    static getDispensePosition(paramsource: BlockSource): Position;
    static getDispensePosition(paramsource: BlockSource, paramscale: number, paramoffset: Vec3): Position;
    ...
    static registerBehavior(paramitem: ItemLike, parambehavior: DispenseItemBehavior): void;
    static registerProjectileBehavior(paramitem: ItemLike): void;
    ...
    dispenseFrom(level: ServerLevel, state: BlockState, pos: BlockPos): void;
    getDispenseMethod(level: Level, itemStack: ItemStack): DispenseItemBehavior;
