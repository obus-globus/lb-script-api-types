...
import type { SkullBlock } from '../../../../../net/minecraft/world/level/block/SkullBlock.d.ts'
...
export class WitherSkullBlock extends SkullBlock {
    ...
    static canSpawnMob(paramlevel: Level, parampos: BlockPos, paramitemStack: ItemStack): boolean;
    ...
    static checkSpawn(paramlevel: Level, parampos: BlockPos): void;
    static checkSpawn(paramlevel: Level, parampos: BlockPos, paramplacedSkull: SkullBlockEntity): void;
    ...
    codec(): MapCodec<WitherSkullBlock>;
