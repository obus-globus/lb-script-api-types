...
export class CopperGolemStatueBlock extends BaseEntityBlock implements SimpleWaterloggedBlock {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<Block>;
    static CODEC: MapCodec<CopperGolemStatueBlock>;
    ...
    readonly weatheringState: WeatheringCopper$WeatherState;
    ...
    codec(): MapCodec<CopperGolemStatueBlock>;
    ...
    getWeatheringState(): WeatheringCopper$WeatherState;
    ...
    updatePose(level: Level, state: BlockState, pos: BlockPos, player: Player): void;
