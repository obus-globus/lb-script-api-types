...
import type { DoublePlantBlock } from '../../../../../net/minecraft/world/level/block/DoublePlantBlock.d.ts'
import type { PitcherCropBlock$PosAndState } from '../../../../../net/minecraft/world/level/block/PitcherCropBlock$PosAndState.d.ts'
...
export class PitcherCropBlock extends DoublePlantBlock implements BonemealableBlock {
    ...
    static copyWaterloggedFrom(paramlevel: LevelReader, parampos: BlockPos, paramstate: BlockState): BlockState;
    ...
    static placeAt(paramlevel: LevelAccessor, paramstate: BlockState, paramlowerPos: BlockPos, paramupdateType: number): void;
    ...
    // private getLowerHalf(level: LevelReader, pos: BlockPos, state: BlockState): PitcherCropBlock$PosAndState;
    ...
    // private grow(level: ServerLevel, lowerState: BlockState, lowerPos: BlockPos, increase: number): void;
    isBonemealSuccess(level: Level, random: RandomSource, pos: BlockPos, state: BlockState): boolean;
    // private isMaxAge(state: BlockState): boolean;
    ...
    mayPlaceOn(state: BlockState, level: BlockGetter, pos: BlockPos): boolean;
