...
import type { LanternBlock } from '../../../../../net/minecraft/world/level/block/LanternBlock.d.ts'
...
export class WeatheringLanternBlock extends LanternBlock implements WeatheringCopper {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<Block>;
    static CODEC: MapCodec<LanternBlock>;
    static CODEC: MapCodec<WeatheringLanternBlock>;
    ...
    codec(): MapCodec<WeatheringLanternBlock>;
