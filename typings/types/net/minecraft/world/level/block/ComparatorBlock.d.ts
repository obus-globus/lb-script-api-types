...
import type { DiodeBlock } from '../../../../../net/minecraft/world/level/block/DiodeBlock.d.ts'
...
export class ComparatorBlock extends DiodeBlock implements EntityBlock {
    ...
    // private calculateOutputSignal(level: Level, pos: BlockPos, state: BlockState): number;
    ...
    // private getItemFrame(level: Level, direction: Direction, tPos: BlockPos): ItemFrame;
    ...
    // private refreshOutputState(level: Level, pos: BlockPos, state: BlockState): void;
