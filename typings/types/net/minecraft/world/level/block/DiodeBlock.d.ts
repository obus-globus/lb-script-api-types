...
export abstract class DiodeBlock extends HorizontalDirectionalBlock {
    ...
    static isDiode(paramstate: BlockState): boolean;
    ...
    canSurviveOn(level: LevelReader, neightborPos: BlockPos, neighborState: BlockState): boolean;
    checkTickOnNeighbor(level: Level, pos: BlockPos, state: BlockState): void;
    codec(): MapCodec<DiodeBlock>;
    getAlternateSignal(level: SignalGetter, pos: BlockPos, state: BlockState): number;
    getDelay(state: BlockState): number;
    getDirectSignal(state: BlockState, level: BlockGetter, pos: BlockPos, direction: Direction): number;
    getInputSignal(level: Level, pos: BlockPos, state: BlockState): number;
    getOutputSignal(level: BlockGetter, pos: BlockPos, state: BlockState): number;
    ...
    isLocked(level: LevelReader, pos: BlockPos, state: BlockState): boolean;
    ...
    updateNeighborsInFront(level: Level, pos: BlockPos, state: BlockState): void;
}