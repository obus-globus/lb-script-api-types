...
export class BambooStalkBlock extends Block implements BonemealableBlock {
    ...
    getHeightAboveUpToMax(level: BlockGetter, pos: BlockPos): number;
    getHeightBelowUpToMax(level: BlockGetter, pos: BlockPos): number;
    ...
    growBamboo(state: BlockState, level: Level, pos: BlockPos, random: RandomSource, height: number): void;
