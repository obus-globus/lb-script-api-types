...
export class ChorusFlowerBlock extends Block {
    ...
    static generatePlant(paramlevel: LevelAccessor, paramtarget: BlockPos, paramrandom: RandomSource, parammaxHorizontalSpread: number): void;
    ...
    // private placeDeadFlower(level: Level, pos: BlockPos): void;
    // private placeGrownFlower(level: Level, pos: BlockPos, age: number): void;
