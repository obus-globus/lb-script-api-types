...
export class DecoratedPotBlockEntity {
    ...
    static createDecoratedPotInstance(paramdecorations: PotDecorations): ItemStack;
    static createDecoratedPotTemplate(paramdecorations: PotDecorations): ItemStackTemplate;
