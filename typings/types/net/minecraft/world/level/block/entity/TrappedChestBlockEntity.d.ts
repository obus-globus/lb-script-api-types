...
export class TrappedChestBlockEntity {
    ...
    static getOpenCount(paramlevel: BlockGetter, parampos: BlockPos): number;
    static getPosFromTag(parambase: ChunkPos, paramentityTag: CompoundTag): BlockPos;
    static lidAnimateTick(paramlevel: Level, parampos: BlockPos, paramstate: BlockState, paramentity: (Object | null)[]): void;
    ...
    static swapContents(paramone: (Object | null)[], paramtwo: (Object | null)[]): void;
}