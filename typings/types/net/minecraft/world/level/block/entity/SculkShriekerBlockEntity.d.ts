...
export class SculkShriekerBlockEntity extends BlockEntity implements SleepingBlockEntity, GameEventListener$Provider<VibrationSystem$Listener>, VibrationSystem {
    ...
    static tryGetPlayer(paramsourceEntity: Entity): ServerPlayer;
    ...
    // private canRespond(level: ServerLevel): boolean;
    ...
    // private shriek(level: ServerLevel, sourceEntity: Entity): void;
    sleepOnlyCurrentTick(): void;
    tryRespond(level: ServerLevel): void;
    tryShriek(level: ServerLevel, player: ServerPlayer): void;
    // private trySummonWarden(level: ServerLevel): boolean;
    // private tryToWarn(level: ServerLevel, player: ServerPlayer): boolean;
    wakeUpNow(): void;
}