...
import type { RedstoneTorchBlock } from '../../../../../net/minecraft/world/level/block/RedstoneTorchBlock.d.ts'
...
export class RedstoneWallTorchBlock extends RedstoneTorchBlock {
    ...
    hasNeighborSignal(level: Level, pos: BlockPos, state: BlockState): boolean;
