...
export class AttachedStemBlock extends VegetationBlock {
    ...
    constructor(stem: ResourceKey<Block>, fruit: ResourceKey<Block>, seed: ResourceKey<Item>, supportBlocks: TagKey<Block>, properties: BlockBehaviour$Properties)
    // private fruit: ResourceKey<Block>;
    // private seed: ResourceKey<Item>;
    // private stem: ResourceKey<Block>;
