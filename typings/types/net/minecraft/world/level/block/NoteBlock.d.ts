...
export class NoteBlock extends Block {
    ...
    static getPitchFromNote(paramtwoOctaveRangeNote: number): number;
    ...
    // private getCustomSoundId(level: Level, pos: BlockPos): Identifier;
    ...
    // private playNote(source: Entity, state: BlockState, level: Level, pos: BlockPos): void;
    // private setInstrument(level: LevelReader, position: BlockPos, state: BlockState): BlockState;
