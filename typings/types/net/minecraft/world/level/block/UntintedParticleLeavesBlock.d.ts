...
import type { LeavesBlock } from '../../../../../net/minecraft/world/level/block/LeavesBlock.d.ts'
...
export class UntintedParticleLeavesBlock extends LeavesBlock {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<UntintedParticleLeavesBlock>;
    ...
    static setCutoutLeaves(paramcutoutLeaves: boolean): void;
    ...
    constructor(leafParticleChance: number, leafParticle: ParticleOptions, properties: BlockBehaviour$Properties)
    // private leafParticle: ParticleOptions;
    codec(): MapCodec<UntintedParticleLeavesBlock>;
    spawnFallingLeavesParticle(level: Level, pos: BlockPos, random: RandomSource): void;
}