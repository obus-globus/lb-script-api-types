...
export class BeehiveBlock extends BaseEntityBlock {
    ...
    static dropHoneycomb(paramlevel: ServerLevel, paramtool: ItemStack, paramblockState: BlockState, paramblockEntity: BlockEntity, paramentity: Entity, parampos: BlockPos): void;
    ...
    // private angerNearbyBees(level: Level, pos: BlockPos): void;
    ...
    // private hiveContainsBees(level: Level, pos: BlockPos): boolean;
    ...
    releaseBeesAndResetHoneyLevel(level: Level, state: BlockState, pos: BlockPos, player: Player, beeReleaseStatus: BeehiveBlockEntity$BeeReleaseStatus): void;
    resetHoneyLevel(level: Level, state: BlockState, pos: BlockPos): void;
    rotate(state: BlockState, rotation: Rotation): BlockState;
    // private spawnFluidParticle(level: Level, x1: number, x2: number, z1: number, z2: number, y: number): void;
    // private spawnParticle(level: Level, pos: BlockPos, dripShape: VoxelShape, height: number): void;
    // private trySpawnDripParticles(level: Level, pos: BlockPos, state: BlockState): void;
