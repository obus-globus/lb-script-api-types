...
export class CreakingHeartBlock extends BaseEntityBlock {
    ...
    static STATE: EnumProperty<CreakingHeartState>;
    ...
    static hasRequiredLogs(paramstate: BlockState, paramlevel: LevelReader, parampos: BlockPos): boolean;
    ...
    codec(): MapCodec<CreakingHeartBlock>;
    ...
    // private tryAwardExperience(player: Player, state: BlockState, level: Level, pos: BlockPos): void;
