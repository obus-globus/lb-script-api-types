...
export class CarvedPumpkinBlock extends HorizontalDirectionalBlock {
    ...
    static clearPatternBlocks(paramlevel: Level, parammatch: BlockPattern$BlockPatternMatch): void;
    ...
    static updatePatternBlocks(paramlevel: Level, parammatch: BlockPattern$BlockPatternMatch): void;
    constructor(properties: BlockBehaviour$Properties)
    // private copperGolemBase: BlockPattern;
    // private copperGolemFull: BlockPattern;
    // private ironGolemBase: BlockPattern;
    // private ironGolemFull: BlockPattern;
    // private snowGolemBase: BlockPattern;
    // private snowGolemFull: BlockPattern;
    canSpawnGolem(level: LevelReader, topPos: BlockPos): boolean;
    codec(): MapCodec<CarvedPumpkinBlock>;
    createBlockStateDefinition(builder: StateDefinition$Builder<Block, BlockState>): void;
    // private getOrCreateCopperGolemBase(): BlockPattern;
    // private getOrCreateCopperGolemFull(): BlockPattern;
    // private getOrCreateIronGolemBase(): BlockPattern;
    // private getOrCreateIronGolemFull(): BlockPattern;
    // private getOrCreateSnowGolemBase(): BlockPattern;
    // private getOrCreateSnowGolemFull(): BlockPattern;
    getStateForPlacement(context: BlockPlaceContext): BlockState;
    // private getWeatherStateFromPattern(copperGolemMatch: BlockPattern$BlockPatternMatch): WeatheringCopper$WeatherState;
    onPlace(state: BlockState, level: Level, pos: BlockPos, oldState: BlockState, movedByPiston: boolean): void;
    replaceCopperBlockWithChest(level: Level, match: BlockPattern$BlockPatternMatch): void;
    // private trySpawnGolem(level: Level, topPos: BlockPos): void;
}