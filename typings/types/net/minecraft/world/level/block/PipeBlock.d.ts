...
export abstract class PipeBlock extends Block {
    ...
    constructor(size: number, properties: BlockBehaviour$Properties)
    // private shapes: (param0: BlockState) => VoxelShape;
    codec(): MapCodec<PipeBlock>;
    getShape(state: BlockState, level: BlockGetter, pos: BlockPos, context: CollisionContext): VoxelShape;
    // private makeShapes(size: number): (param0: BlockState) => VoxelShape;
