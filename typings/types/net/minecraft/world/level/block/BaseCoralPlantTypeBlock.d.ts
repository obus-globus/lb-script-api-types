...
export abstract class BaseCoralPlantTypeBlock extends Block implements SimpleWaterloggedBlock {
    ...
    codec(): MapCodec<BaseCoralPlantTypeBlock>;
    ...
    tryScheduleDieTick(state: BlockState, level: BlockGetter, ticks: ScheduledTickAccess, random: RandomSource, pos: BlockPos): void;
