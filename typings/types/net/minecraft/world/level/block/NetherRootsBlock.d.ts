...
export class NetherRootsBlock extends VegetationBlock {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<Block>;
    static CODEC: MapCodec<NetherRootsBlock>;
    ...
    constructor(supportBlocks: TagKey<Block>, properties: BlockBehaviour$Properties)
    // private supportBlocks: TagKey<Block>;
    codec(): MapCodec<NetherRootsBlock>;
