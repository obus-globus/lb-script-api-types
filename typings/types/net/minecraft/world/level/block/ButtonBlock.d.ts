...
import type { FaceAttachedHorizontalDirectionalBlock } from '../../../../../net/minecraft/world/level/block/FaceAttachedHorizontalDirectionalBlock.d.ts'
...
export class ButtonBlock extends FaceAttachedHorizontalDirectionalBlock {
    ...
    static canAttach(paramlevel: LevelReader, parampos: BlockPos, paramdirection: Direction): boolean;
    ...
    constructor(type: BlockSetType, ticksToStayPressed: number, properties: BlockBehaviour$Properties)
    // private shapes: (param0: BlockState) => VoxelShape;
    // private ticksToStayPressed: number;
    ...
    checkPressed(state: BlockState, level: Level, pos: BlockPos): void;
