...
export class FlowerBlock extends VegetationBlock implements SuspiciousEffectHolder {
    ...
    constructor(suspiciousStewEffect: Holder<MobEffect>, effectSeconds: number, properties: BlockBehaviour$Properties)
    constructor(suspiciousStewEffects: SuspiciousStewEffects, properties: BlockBehaviour$Properties)
    // private suspiciousStewEffects: SuspiciousStewEffects;
