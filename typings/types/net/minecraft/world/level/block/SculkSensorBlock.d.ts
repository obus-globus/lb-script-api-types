...
export class SculkSensorBlock extends BaseEntityBlock implements SimpleWaterloggedBlock {
    ...
    static deactivate(paramlevel: Level, parampos: BlockPos, paramstate: BlockState): void;
    ...
    static getPhase(paramstate: BlockState): SculkSensorPhase;
    ...
    activate(sourceEntity: Entity, level: Level, pos: BlockPos, state: BlockState, calculatedPower: number, vibrationFrequency: number): void;
