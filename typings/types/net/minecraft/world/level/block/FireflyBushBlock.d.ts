...
export class FireflyBushBlock extends VegetationBlock implements BonemealableBlock {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<Block>;
    static CODEC: MapCodec<FireflyBushBlock>;
    ...
    codec(): MapCodec<FireflyBushBlock>;
