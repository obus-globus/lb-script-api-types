...
export class PotentSulfurBlock extends BaseEntityBlock {
    static ALLOWED_WATER_BLOCKS_ABOVE: number;
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<PotentSulfurBlock>;
    static FILTERED_REGISTRIES: ResourceKey<FeatureElement[]>[];
    static INDESTRUCTIBLE: number;
    static INSTANT: number;
    static STATE: EnumProperty<PotentSulfurState>;
    ...
    codec(): MapCodec<PotentSulfurBlock>;
