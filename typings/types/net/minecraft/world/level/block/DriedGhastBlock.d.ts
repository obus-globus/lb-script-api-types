...
export class DriedGhastBlock extends HorizontalDirectionalBlock implements SimpleWaterloggedBlock {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<DriedGhastBlock>;
    static FACING: EnumProperty<Direction>;
    static FILTERED_REGISTRIES: ResourceKey<FeatureElement[]>[];
    static HYDRATION_LEVEL: IntegerProperty;
    static HYDRATION_TICK_DELAY: number;
    static INDESTRUCTIBLE: number;
    static INSTANT: number;
    static MAX_HYDRATION_LEVEL: number;
    ...
    codec(): MapCodec<DriedGhastBlock>;
    ...
    getHydrationLevel(state: BlockState): number;
    ...
    tick(state: BlockState, level: ServerLevel, position: BlockPos, random: RandomSource): void;
    // private tickWaterlogged(state: BlockState, level: ServerLevel, position: BlockPos, random: RandomSource): void;
