...
import type { DirectionalBlock } from '../../../../../../net/minecraft/world/level/block/DirectionalBlock.d.ts'
...
export class PistonBaseBlock extends DirectionalBlock {
    ...
    static isPushable(paramstate: BlockState, paramlevel: Level, parampos: BlockPos, paramdirection: Direction, paramallowDestroyable: boolean, paramconnectionDirection: Direction): boolean;
    ...
    // private checkIfExtend(level: Level, pos: BlockPos, state: BlockState): void;
    codec(): MapCodec<PistonBaseBlock>;
    createBlockStateDefinition(builder: StateDefinition$Builder<Block, BlockState>): void;
    // private getNeighborSignal(level: SignalGetter, pos: BlockPos, pushDirection: Direction): boolean;
    ...
    // private moveBlocks(level: Level, pistonPos: BlockPos, direction: Direction, extending: boolean): boolean;
