...
export class MovingPistonBlock extends BaseEntityBlock {
    ...
    static newMovingBlockEntity(paramposition: BlockPos, paramblockState: BlockState, parammovedState: BlockState, paramdirection: Direction, paramextending: boolean, paramisSourcePiston: boolean): BlockEntity;
    ...
    // private getBlockEntity(level: BlockGetter, pos: BlockPos): PistonMovingBlockEntity;
