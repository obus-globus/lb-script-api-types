...
export class PoweredRailBlock extends BaseRailBlock {
    ...
    static isRail(paramlevel: Level, parampos: BlockPos): boolean;
    static isRail(paramstate: BlockState): boolean;
    ...
    findPoweredRailSignal(level: Level, pos: BlockPos, state: BlockState, forward: boolean, searchDepth: number): boolean;
    getShapeProperty(): Property<RailShape>;
    isSameRailWithPower(level: Level, pos: BlockPos, forward: boolean, searchDepth: number, dir: RailShape): boolean;
