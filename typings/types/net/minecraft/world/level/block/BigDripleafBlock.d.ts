...
export class BigDripleafBlock extends HorizontalDirectionalBlock implements BonemealableBlock, SimpleWaterloggedBlock {
    ...
    static placeWithRandomHeight(paramlevel: LevelAccessor, paramrandom: RandomSource, paramstemBottomPos: BlockPos, paramfacing: Direction): void;
    ...
    // private setTiltAndScheduleTick(state: BlockState, level: Level, pos: BlockPos, tilt: Tilt, sound: SoundEvent): void;
