...
import type { IceBlock } from '../../../../../net/minecraft/world/level/block/IceBlock.d.ts'
...
export class FrostedIceBlock extends IceBlock {
    ...
    // private fewerNeigboursThan(level: BlockGetter, pos: BlockPos, limit: number): boolean;
    ...
    // private slightlyMelt(state: BlockState, level: Level, pos: BlockPos): boolean;
