...
import type { FallingBlock } from '../../../../../net/minecraft/world/level/block/FallingBlock.d.ts'
...
export class ColoredFallingBlock extends FallingBlock {
    ...
    // private dustColor: ColorRGBA;
    codec(): MapCodec<ColoredFallingBlock>;
    getDustColor(blockState: BlockState, level: BlockGetter, pos: BlockPos): number;
}