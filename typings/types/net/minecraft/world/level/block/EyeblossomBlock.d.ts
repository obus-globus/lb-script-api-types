...
import type { EyeblossomBlock$Type } from '../../../../../net/minecraft/world/level/block/EyeblossomBlock$Type.d.ts'
import type { FlowerBlock } from '../../../../../net/minecraft/world/level/block/FlowerBlock.d.ts'
...
export class EyeblossomBlock extends FlowerBlock {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<EyeblossomBlock>;
    ...
    constructor(open: boolean, properties: BlockBehaviour$Properties)
    constructor(type: EyeblossomBlock$Type, properties: BlockBehaviour$Properties)
    // private type: EyeblossomBlock$Type;
    animateTick(state: BlockState, level: Level, pos: BlockPos, random: RandomSource): void;
    codec(): MapCodec<EyeblossomBlock>;
    ...
    getBeeInteractionEffect(): MobEffectInstance;
    ...
    // private tryChangingState(state: BlockState, level: ServerLevel, pos: BlockPos, random: RandomSource): boolean;
}