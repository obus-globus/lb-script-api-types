...
import type { SegmentableBlock } from '../../../../../net/minecraft/world/level/block/SegmentableBlock.d.ts'
...
export class LeafLitterBlock extends VegetationBlock implements SegmentableBlock {
    ...
    static CODEC: MapCodec<LeafLitterBlock>;
    static FACING: EnumProperty<Direction>;
    static FILTERED_REGISTRIES: ResourceKey<FeatureElement[]>[];
    static INDESTRUCTIBLE: number;
    static INSTANT: number;
    static MAX_SEGMENT: number;
    static MIN_SEGMENT: number;
