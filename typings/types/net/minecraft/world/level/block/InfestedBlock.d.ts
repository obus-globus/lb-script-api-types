...
export class InfestedBlock extends Block {
    ...
    static infestedStateByHost(paramhostState: BlockState): BlockState;
    static isCompatibleHostBlock(paramblockState: BlockState): boolean;
    ...
    readonly hostBlock: Block;
    codec(): MapCodec<InfestedBlock>;
    getHostBlock(): Block;
    hostStateByInfested(infestedState: BlockState): BlockState;
    spawnAfterBreak(state: BlockState, level: ServerLevel, pos: BlockPos, tool: ItemStack, dropExperience: boolean): void;
    // private spawnInfestation(level: ServerLevel, pos: BlockPos): void;
}