...
export class FrogspawnBlock extends Block {
    ...
    static setHatchDelay(paramminDelay: number, parammaxDelay: number): void;
    ...
    // private destroyBlock(level: Level, pos: BlockPos): void;
    ...
    // private getRandomTadpolePositionOffset(random: RandomSource): number;
    getShape(state: BlockState, level: BlockGetter, pos: BlockPos, context: CollisionContext): VoxelShape;
    // private hatchFrogspawn(level: ServerLevel, pos: BlockPos, random: RandomSource): void;
    onPlace(state: BlockState, level: Level, pos: BlockPos, oldState: BlockState, movedByPiston: boolean): void;
    // private spawnTadpoles(level: ServerLevel, pos: BlockPos, random: RandomSource): void;
