...
import type { TrapDoorBlock } from '../../../../../net/minecraft/world/level/block/TrapDoorBlock.d.ts'
...
export class WeatheringCopperTrapDoorBlock extends TrapDoorBlock implements WeatheringCopper {
    ...
    constructor(type: BlockSetType, weatherState: WeatheringCopper$WeatherState, properties: BlockBehaviour$Properties)
