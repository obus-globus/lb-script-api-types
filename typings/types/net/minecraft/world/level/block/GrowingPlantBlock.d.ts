...
export abstract class GrowingPlantBlock extends Block {
    ...
    // private scheduleFluidTicks: boolean;
    // private shape: VoxelShape;
    canAttachTo(state: BlockState): boolean;
    canSurvive(state: BlockState, level: LevelReader, pos: BlockPos): boolean;
    codec(): MapCodec<GrowingPlantBlock>;
    getBodyBlock(): Block;
