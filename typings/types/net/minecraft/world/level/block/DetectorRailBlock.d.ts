...
export class DetectorRailBlock extends BaseRailBlock {
    ...
    // private checkPressed(level: Level, pos: BlockPos, state: BlockState): void;
    ...
    // private getInteractingMinecartOfType(level: Level, pos: BlockPos, type: Class<T>, containerEntitySelector: (param0: Entity) => kotlin.Boolean): T[];
