...
export abstract class AbstractChestBlock<E extends BlockEntity> extends BaseEntityBlock {
    ...
    constructor(properties: BlockBehaviour$Properties, blockEntityType: () => BlockEntityType<E>)
    // private blockEntityType: () => BlockEntityType<E>;
    codec(): MapCodec<AbstractChestBlock<E>>;
