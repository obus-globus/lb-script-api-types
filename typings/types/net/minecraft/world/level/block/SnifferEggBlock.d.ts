...
export class SnifferEggBlock extends Block {
    ...
    static hatchBoost(paramlevel: BlockGetter, parampos: BlockPos): boolean;
    ...
    getHatchLevel(state: BlockState): number;
    ...
    // private isReadyToHatch(state: BlockState): boolean;
