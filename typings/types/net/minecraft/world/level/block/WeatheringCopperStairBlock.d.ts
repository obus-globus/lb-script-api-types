...
import type { StairBlock } from '../../../../../net/minecraft/world/level/block/StairBlock.d.ts'
...
export class WeatheringCopperStairBlock extends StairBlock implements WeatheringCopper {
    ...
    static isStairs(paramstate: BlockState): boolean;
    ...
    constructor(weatherState: WeatheringCopper$WeatherState, baseState: BlockState, properties: BlockBehaviour$Properties)
