...
import type { HangingSignBlock } from '../../../../../net/minecraft/world/level/block/HangingSignBlock.d.ts'
...
export class WallHangingSignBlock extends SignBlock implements HangingSignBlock {
    ...
    canAttachTo(level: LevelReader, state: BlockState, attachPos: BlockPos, attachFace: Direction): boolean;
    canPlace(state: BlockState, level: LevelReader, pos: BlockPos): boolean;
    ...
    // private isHittingEditableSide(hitResult: BlockHitResult, state: BlockState): boolean;
    ...
    // private shouldTryToChainAnotherHangingSign(state: BlockState, player: Player, hitResult: BlockHitResult, signEntity: SignBlockEntity, itemStack: ItemStack): boolean;
