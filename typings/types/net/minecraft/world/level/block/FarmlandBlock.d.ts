...
export class FarmlandBlock extends Block {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<Block>;
    static CODEC: MapCodec<FarmlandBlock>;
    ...
    static turnToDirt(paramsourceEntity: Entity, paramstate: BlockState, paramlevel: Level, parampos: BlockPos): void;
