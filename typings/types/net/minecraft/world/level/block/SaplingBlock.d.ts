...
import type { TreeGrower } from '../../../../../net/minecraft/world/level/block/grower/TreeGrower.d.ts'
...
export class SaplingBlock extends VegetationBlock implements BonemealableBlock {
    ...
    advanceTree(level: ServerLevel, pos: BlockPos, state: BlockState, random: RandomSource): void;
