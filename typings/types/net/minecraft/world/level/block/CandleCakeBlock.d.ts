...
import type { AbstractCandleBlock } from '../../../../../net/minecraft/world/level/block/AbstractCandleBlock.d.ts'
import type { Block } from '../../../../../net/minecraft/world/level/block/Block.d.ts'
import type { CandleBlock } from '../../../../../net/minecraft/world/level/block/CandleBlock.d.ts'
...
export class CandleCakeBlock extends AbstractCandleBlock {
    ...
    static byCandle(paramblock: CandleBlock): BlockState;
    ...
    static extinguish(paramplayer: Player, paramstate: BlockState, paramlevel: LevelAccessor, parampos: BlockPos): void;
    ...
    static isLit(paramstate: BlockState): boolean;
    ...
    constructor(block: Block, properties: BlockBehaviour$Properties)
    // private candleBlock: CandleBlock;
    ...
    getParticleOffsets(state: BlockState): Vec3[];
