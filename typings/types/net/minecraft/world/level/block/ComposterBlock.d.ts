...
import type { WorldlyContainerHolder } from '../../../../../net/minecraft/world/WorldlyContainerHolder.d.ts'
...
export class ComposterBlock extends Block implements WorldlyContainerHolder {
    ...
    static extractProduce(paramsourceEntity: Entity, paramstate: BlockState, paramlevel: Level, parampos: BlockPos): BlockState;
    ...
    static handleFill(paramlevel: Level, parampos: BlockPos, paramsuccess: boolean): void;
    static insertItem(paramsourceEntity: Entity, paramstate: BlockState, paramlevel: ServerLevel, paramitemStack: ItemStack, parampos: BlockPos): BlockState;
