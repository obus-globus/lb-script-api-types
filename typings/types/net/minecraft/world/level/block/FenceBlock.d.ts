...
import type { CrossCollisionBlock } from '../../../../../net/minecraft/world/level/block/CrossCollisionBlock.d.ts'
...
export class FenceBlock extends CrossCollisionBlock implements ICrossCollisionBlock {
    ...
    // private occlusionShapes: (param0: BlockState) => VoxelShape;
    // private viaFabricPlus$collision_shape_r1_4_7: VoxelShape[];
    // private viaFabricPlus$outline_shape_r1_12_2: VoxelShape[];
    // private viaFabricPlus$outline_shape_r1_4_7: VoxelShape[];
    // private viaFabricPlus$shape_b1_8_1: VoxelShape;
    codec(): MapCodec<FenceBlock>;
    connectsTo(state: BlockState, faceSolid: boolean, direction: Direction): boolean;
    createBlockStateDefinition(builder: StateDefinition$Builder<Block, BlockState>): void;
    getCollisionShape(arg0: BlockState, arg1: BlockGetter, arg2: BlockPos, arg3: CollisionContext): VoxelShape;
    getOcclusionShape(state: BlockState): VoxelShape;
    getShape(arg0: BlockState, arg1: BlockGetter, arg2: BlockPos, arg3: CollisionContext): VoxelShape;
    ...
    // private isSameFence(state: BlockState): boolean;
    ...
    // private viaFabricPlus$createShapes1_4_7(arg0: number): VoxelShape[];
}