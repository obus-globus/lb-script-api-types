...
export abstract class SignBlock extends BaseEntityBlock implements SimpleWaterloggedBlock {
    ...
    // private hasEditableText(player: Player, sign: SignBlockEntity, isFrontText: boolean): boolean;
    ...
    openTextEdit(player: Player, sign: SignBlockEntity, isFrontText: boolean): void;
    // private otherPlayerIsEditingSign(player: Player, sign: SignBlockEntity): boolean;
