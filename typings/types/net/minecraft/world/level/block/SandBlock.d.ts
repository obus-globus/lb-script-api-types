...
import type { ColorRGBA } from '../../../../../net/minecraft/util/ColorRGBA.d.ts'
...
import type { ColoredFallingBlock } from '../../../../../net/minecraft/world/level/block/ColoredFallingBlock.d.ts'
...
export class SandBlock extends ColoredFallingBlock {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<SandBlock>;
    ...
    static isFree(paramstate: BlockState): boolean;
    ...
    constructor(dustColor: ColorRGBA, properties: BlockBehaviour$Properties)
    animateTick(state: BlockState, level: Level, pos: BlockPos, random: RandomSource): void;
    codec(): MapCodec<SandBlock>;
}