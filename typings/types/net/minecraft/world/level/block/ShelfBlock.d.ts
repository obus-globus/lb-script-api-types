...
import type { SelectableSlotContainer } from '../../../../../net/minecraft/world/level/block/SelectableSlotContainer.d.ts'
...
export class ShelfBlock extends BaseEntityBlock implements SelectableSlotContainer, SideChainPartBlock, SimpleWaterloggedBlock {
    ...
    // private playSound(level: LevelAccessor, pos: BlockPos, sound: SoundEvent): void;
    ...
    // private swapHotbar(level: Level, pos: BlockPos, inventory: (Object | null)[]): boolean;
