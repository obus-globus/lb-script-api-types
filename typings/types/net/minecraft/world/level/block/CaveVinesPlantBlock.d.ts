...
import type { CaveVines } from '../../../../../net/minecraft/world/level/block/CaveVines.d.ts'
import type { GrowingPlantBodyBlock } from '../../../../../net/minecraft/world/level/block/GrowingPlantBodyBlock.d.ts'
import type { GrowingPlantHeadBlock } from '../../../../../net/minecraft/world/level/block/GrowingPlantHeadBlock.d.ts'
...
export class CaveVinesPlantBlock extends GrowingPlantBodyBlock implements CaveVines {
    ...
    updateHeadAfterConvertedFromBody(bodyState: BlockState, headState: BlockState): BlockState;
