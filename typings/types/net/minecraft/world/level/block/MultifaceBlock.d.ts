...
export class MultifaceBlock extends Block implements SimpleWaterloggedBlock {
    ...
    // private canMirrorX: boolean;
    // private canMirrorZ: boolean;
    ...
    isFaceSupported(faceDirection: Direction): boolean;
    isValidStateForPlacement(level: BlockGetter, oldState: BlockState, placementPos: BlockPos, placementDirection: Direction): boolean;
    // private makeShapes(): (param0: BlockState) => VoxelShape;
    // private mapDirections(state: BlockState, mapping: (param0: Direction) => Direction): BlockState;
