...
export class CampfireBlock extends BaseEntityBlock implements SimpleWaterloggedBlock {
    ...
    static dowse(paramsource: Entity, paramlevel: LevelAccessor, parampos: BlockPos, paramstate: BlockState): void;
    ...
    static isLitCampfire(paramblockState: BlockState): boolean;
    static isShapeFullBlock(paramarg0: VoxelShape): boolean;
    static isSmokeyPos(paramlevel: Level, parampos: BlockPos): boolean;
    static makeParticles(paramlevel: Level, parampos: BlockPos, paramisSignalFire: boolean, paramsmoking: boolean): void;
    ...
    // private isSmokeSource(blockState: BlockState): boolean;
