...
export abstract class AbstractCauldronBlock extends Block {
    ...
    constructor(properties: BlockBehaviour$Properties, interactions: CauldronInteraction$Dispatcher)
    // private interactions: CauldronInteraction$Dispatcher;
    // private viaFabricPlus$requireOriginalShape: boolean;
    canReceiveStalactiteDrip(fluid: Fluid): boolean;
    codec(): MapCodec<AbstractCauldronBlock>;
    ...
    tick(cauldronState: BlockState, level: ServerLevel, pos: BlockPos, random: RandomSource): void;
