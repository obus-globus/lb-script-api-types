...
import type { LightningRodBlock } from '../../../../../net/minecraft/world/level/block/LightningRodBlock.d.ts'
...
export class WeatheringLightningRodBlock extends LightningRodBlock implements WeatheringCopper {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<Block>;
    static CODEC: MapCodec<LightningRodBlock>;
    static CODEC: MapCodec<WeatheringLightningRodBlock>;
    static FACING: EnumProperty<Direction>;
    static FILTERED_REGISTRIES: (Object | null)[];
    static INDESTRUCTIBLE: number;
    static INSTANT: number;
    static NEXT_BY_BLOCK: () => Object | null;
    static POWERED: BooleanProperty;
    static PREVIOUS_BY_BLOCK: () => Object | null;
    static RANGE: number;
    ...
    // private weatherState: WeatheringCopper$WeatherState;
    codec(): MapCodec<WeatheringLightningRodBlock>;
