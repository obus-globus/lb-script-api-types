...
export abstract class AbstractFurnaceBlock extends BaseEntityBlock {
    ...
    codec(): MapCodec<AbstractFurnaceBlock>;
    ...
    openContainer(level: Level, pos: BlockPos, player: Player): void;
