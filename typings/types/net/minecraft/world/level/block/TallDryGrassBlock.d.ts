...
export class TallDryGrassBlock extends DryVegetationBlock implements BonemealableBlock {
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<Block>;
    static CODEC: MapCodec<DryVegetationBlock>;
    static CODEC: MapCodec<TallDryGrassBlock>;
    ...
    codec(): MapCodec<TallDryGrassBlock>;
