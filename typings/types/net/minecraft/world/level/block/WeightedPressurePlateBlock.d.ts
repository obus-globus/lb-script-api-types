...
import type { BasePressurePlateBlock } from '../../../../../net/minecraft/world/level/block/BasePressurePlateBlock.d.ts'
...
export class WeightedPressurePlateBlock extends BasePressurePlateBlock {
    ...
    constructor(maxWeight: number, type: BlockSetType, properties: BlockBehaviour$Properties)
