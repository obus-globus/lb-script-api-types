...
export abstract class AbstractSkullBlock extends BaseEntityBlock {
    ...
    constructor(type: SkullBlock$Type, properties: BlockBehaviour$Properties)
    readonly type: SkullBlock$Type;
    codec(): MapCodec<AbstractSkullBlock>;
