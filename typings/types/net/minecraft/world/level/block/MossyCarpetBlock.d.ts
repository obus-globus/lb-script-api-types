...
export class MossyCarpetBlock extends Block implements BonemealableBlock {
    static BASE: BooleanProperty;
    static BLOCK_STATE_REGISTRY: BlockState[];
    static CODEC: MapCodec<MossyCarpetBlock>;
    ...
    static getPropertyForFace(paramdirection: Direction): EnumProperty<WallSide>;
    ...
    static placeAt(paramlevel: LevelAccessor, parampos: BlockPos, paramrandom: RandomSource, paramupdateType: number): void;
    ...
    codec(): MapCodec<MossyCarpetBlock>;
    ...
    makeShapes(): (param0: BlockState) => VoxelShape;
