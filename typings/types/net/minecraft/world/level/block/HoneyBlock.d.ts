...
export class HoneyBlock extends HalfTransparentBlock {
    ...
    static showJumpParticles(paramentity: Entity): void;
    static showSlideParticles(paramentity: Entity): void;
    ...
    // private doSlideMovement(entity: Entity): void;
    ...
    // private isSlidingDown(pos: BlockPos, entity: Entity): boolean;
    // private maybeDoSlideAchievement(entity: Entity, pos: BlockPos): void;
    // private maybeDoSlideEffects(level: Level, entity: Entity): void;
    stepOn(arg0: Level, arg1: BlockPos, arg2: BlockState, arg3: Entity): void;
}