...
export abstract class BasePressurePlateBlock extends Block {
    ...
    constructor(properties: BlockBehaviour$Properties, type: BlockSetType)
    ...
    // private checkPressed(sourceEntity: Entity, level: Level, pos: BlockPos, state: BlockState, oldSignal: number): void;
    codec(): MapCodec<BasePressurePlateBlock>;
