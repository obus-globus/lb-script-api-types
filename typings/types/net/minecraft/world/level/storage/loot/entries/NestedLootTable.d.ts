...
export class NestedLootTable extends LootPoolSingletonContainer {
    ...
    static INLINE_LOOT_TABLE_PATH_ELEMENT: () => kotlin.String;
    static MAP_CODEC: MapCodec<NestedLootTable>;
    static inlineLootTable(paramtable: LootTable): LootPoolSingletonContainer$Builder<Object>;
    static lootTableReference(paramname: ResourceKey<LootTable>): LootPoolSingletonContainer$Builder<Object>;
