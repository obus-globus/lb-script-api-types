...
export class LocationCheck extends Record implements LootItemCondition {
    ...
    static checkLocation(parampredicate: LocationPredicate$Builder): () => net.minecraft.world.level.storage.loot.predicates.LootItemCondition;
    static checkLocation(parampredicate: LocationPredicate$Builder, paramoffset: BlockPos): () => net.minecraft.world.level.storage.loot.predicates.LootItemCondition;
