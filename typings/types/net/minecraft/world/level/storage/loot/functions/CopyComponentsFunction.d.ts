...
export class CopyComponentsFunction extends LootItemConditionalFunction {
    ...
    static copyComponentsFromBlockEntity(paramsource: ContextKey<BlockEntity>): CopyComponentsFunction$Builder;
    static copyComponentsFromEntity(paramsource: ContextKey<Entity>): CopyComponentsFunction$Builder;
    ...
    // private bakedPredicate: (param0: DataComponentType<Object>) => boolean;
