...
export class EnvironmentAttributeCheck<Value extends Object | number | string | boolean> extends Record implements LootItemCondition {
    ...
    static environmentAttribute(paramattribute: EnvironmentAttribute<Object>, paramvalue: Object | null): () => net.minecraft.world.level.storage.loot.predicates.LootItemCondition;
