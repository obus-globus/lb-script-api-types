...
export class SetItemCountFunction extends LootItemConditionalFunction {
    ...
    static setCount(paramcount: NumberProvider): LootItemConditionalFunction$Builder<any>;
    static setCount(paramcount: NumberProvider, paramadd: boolean): LootItemConditionalFunction$Builder<any>;
