...
export class EnchantmentActiveCheck extends Record implements LootItemCondition {
    ...
    static enchantmentActiveCheck(): () => net.minecraft.world.level.storage.loot.predicates.LootItemCondition;
    static enchantmentInactiveCheck(): () => net.minecraft.world.level.storage.loot.predicates.LootItemCondition;
