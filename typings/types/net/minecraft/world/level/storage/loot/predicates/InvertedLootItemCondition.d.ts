...
export class InvertedLootItemCondition extends Record implements LootItemCondition {
    ...
    static invert(paramterm: () => net.minecraft.world.level.storage.loot.predicates.LootItemCondition): () => net.minecraft.world.level.storage.loot.predicates.LootItemCondition;
