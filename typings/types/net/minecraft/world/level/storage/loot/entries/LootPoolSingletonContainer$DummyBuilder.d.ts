...
export class LootPoolSingletonContainer$DummyBuilder extends LootPoolSingletonContainer$Builder<LootPoolSingletonContainer$DummyBuilder> {
    constructor(constructor: (param0: number, param1: number, param2: LootItemCondition[], param3: LootItemFunction[]) => net.minecraft.world.level.storage.loot.entries.LootPoolSingletonContainer)
    // private constructor: (param0: number, param1: number, param2: LootItemCondition[], param3: LootItemFunction[]) => net.minecraft.world.level.storage.loot.entries.LootPoolSingletonContainer;
