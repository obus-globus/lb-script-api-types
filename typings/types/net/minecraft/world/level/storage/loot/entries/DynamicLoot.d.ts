...
export class DynamicLoot extends LootPoolSingletonContainer {
    ...
    static MAP_CODEC: MapCodec<DynamicLoot>;
    static dynamicEntry(paramname: Identifier): LootPoolSingletonContainer$Builder<Object>;
    ...
    private constructor(name: Identifier, weight: number, quality: number, conditions: LootItemCondition[], functions: LootItemFunction[])
