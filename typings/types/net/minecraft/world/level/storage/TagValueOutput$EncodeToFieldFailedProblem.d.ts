...
export class TagValueOutput$EncodeToFieldFailedProblem extends Record implements ProblemReporter$Problem {
    constructor(name: string, value: Object, error: DataResult$Error<Object>)
