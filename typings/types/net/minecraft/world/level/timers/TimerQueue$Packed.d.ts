...
export class TimerQueue$Packed<T extends Object | number | string | boolean> extends Record {
    static codec(paramcallbackCodec: Codec<TimerCallback<Object>>): Codec<TimerQueue$Packed<Object>>;
