...
export class PersistentEntitySectionManager$Callback extends Object implements ToggleableMovementTracker, EntityInLevelCallback {
    ...
    private constructor(null_: PersistentEntitySectionManager<EntityAccess>, entity: EntityAccess, currentSectionKey: number, currentSection: EntitySection<EntityAccess>)
