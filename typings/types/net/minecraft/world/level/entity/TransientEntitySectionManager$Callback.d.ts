...
export class TransientEntitySectionManager$Callback extends Object implements EntityInLevelCallback {
    ...
    private constructor(null_: TransientEntitySectionManager<EntityAccess>, entity: EntityAccess, currentSectionKey: number, currentSection: EntitySection<EntityAccess>)
