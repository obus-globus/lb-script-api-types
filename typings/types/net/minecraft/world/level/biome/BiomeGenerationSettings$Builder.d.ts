...
export class BiomeGenerationSettings$Builder extends BiomeGenerationSettings$PlainBuilder {
    constructor(placedFeatures: HolderGetter<PlacedFeature>, worldCarvers: HolderGetter<ConfiguredWorldCarver<any>>)
    // private placedFeatures: HolderGetter<PlacedFeature>;
    // private worldCarvers: HolderGetter<ConfiguredWorldCarver<any>>;
    addCarver(carver: Holder<ConfiguredWorldCarver<any>>): BiomeGenerationSettings$PlainBuilder;
    addCarver(carver: ResourceKey<ConfiguredWorldCarver<any>>): BiomeGenerationSettings$Builder;
