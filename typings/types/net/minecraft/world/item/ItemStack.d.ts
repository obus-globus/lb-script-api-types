...
export class ItemStack extends Object implements ChangePublisher<Object>, ChangeSubscriber<Object>, FabricItemStack, ItemStackAccessor, DataComponentHolder, ItemInstance {
    ...
    remove<T extends Object | number | string | boolean>(type: DataComponentType<T>): T;
    set<T extends Object | number | string | boolean>(type: DataComponentType<T>, value: T): T;
    set<T extends Object | number | string | boolean>(value: TypedDataComponent<T>): T;
