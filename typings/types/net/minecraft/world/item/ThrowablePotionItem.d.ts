...
import type { PotionItem } from '../../../../net/minecraft/world/item/PotionItem.d.ts'
...
export abstract class ThrowablePotionItem extends PotionItem implements ProjectileItem {
