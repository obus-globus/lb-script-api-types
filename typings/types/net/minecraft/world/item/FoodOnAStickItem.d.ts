...
export class FoodOnAStickItem<T extends Entity & ItemSteerable> extends Item {
    ...
    constructor(canInteractWith: EntityType<T>, consumeItemDamage: number, properties: Item$Properties)
    // private canInteractWith: EntityType<T>;
    // private consumeItemDamage: number;
