...
export class SulfurCubeContent extends Record implements TooltipProvider {
    static CODEC: Codec<SulfurCubeContent>;
    static STREAM_CODEC: StreamCodec<RegistryFriendlyByteBuf, SulfurCubeContent>;
    static ofNonEmpty(paramitemStack: ItemStack): SulfurCubeContent;
    constructor(absorbedBlockItemStack: ItemStackTemplate)
    // private absorbedBlockItemStack: ItemStackTemplate;
    absorbedBlockItemStack(): ItemStackTemplate;
