...
export class ResolvableProfile$Static extends ResolvableProfile {
    static CODEC: Codec<ResolvableProfile>;
    static EMPTY: ResolvableProfile$Static;
    ...
    private constructor(contents: Either<GameProfile, ResolvableProfile$Partial>, skinPatch: PlayerSkin$Patch)
    // private contents: Either<GameProfile, ResolvableProfile$Partial>;
