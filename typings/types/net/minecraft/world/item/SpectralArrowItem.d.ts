...
import type { ArrowItem } from '../../../../net/minecraft/world/item/ArrowItem.d.ts'
...
export class SpectralArrowItem extends ArrowItem {
    ...
    createArrow(level: Level, itemStack: ItemStack, owner: LivingEntity, firedFromWeapon: ItemStack): AbstractArrow;
}