...
export class BoatItem extends Item {
    ...
    constructor(entityType: EntityType<AbstractBoat>, properties: Item$Properties)
    // private entityType: EntityType<AbstractBoat>;
    // private getBoat(level: Level, hitResult: HitResult, itemStack: ItemStack, player: Player): AbstractBoat;
