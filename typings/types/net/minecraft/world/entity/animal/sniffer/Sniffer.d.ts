...
export class Sniffer extends Animal {
    ...
    constructor(type: EntityType<Animal>, level: Level)
    ...
    calculateDigPosition(): Optional<BlockPos>;
    canDig(): boolean;
    // private canDig(position: BlockPos): boolean;
    ...
    // private dropSeed(): void;
    // private emitDiggingParticles(state: AnimationState): Sniffer;
    getAmbientSound(): SoundEvent;
    getBabyStartAge(): number;
    getBrain(): Brain<Sniffer>;
    ...
    // private getExploredPositions(): Stream<GlobalPos>;
    // private getHeadBlock(): BlockPos;
    // private getHeadPosition(): Vec3;
    getHurtSound(source: DamageSource): SoundEvent;
    getMaxHeadYRot(): number;
    getQuadLeashOffsets(): Vec3[];
    // private getState(): Sniffer$State;
    isFood(itemStack: ItemStack): boolean;
    isSearching(): boolean;
    isTempted(): boolean;
    jumpFromGround(): void;
    makeBrain(packedBrain: Brain$Packed): Brain<Sniffer>;
    mobInteract(player: Player, hand: InteractionHand): InteractionResult;
    onDiggingComplete(success: boolean): Sniffer;
    // private onDiggingStart(): Sniffer;
    onPathfindingDone(): void;
    onPathfindingStart(): void;
    // private onScentingStart(): Sniffer;
    ...
    // private playSearchingSound(): void;
    playStepSound(pos: BlockPos, blockState: BlockState): void;
    // private resetAnimations(): void;
    // private setState(state: Sniffer$State): Sniffer;
    spawnChildFromBreeding(level: ServerLevel, partner: Animal): void;
    // private storeExploredPosition(position: BlockPos): Sniffer;
    supportQuadLeash(): boolean;
    tick(): void;
    transitionTo(state: Sniffer$State): Sniffer;
}