...
import type { ItemBasedSteering } from '../../../../../../net/minecraft/world/entity/ItemBasedSteering.d.ts'
...
export class Pig extends Animal implements ItemSteerable {
    ...
    constructor(type: EntityType<Pig>, level: Level)
    // private steering: ItemBasedSteering;
    ...
    getBreedOffspring(level: ServerLevel, partner: AgeableMob): Pig;
    ...
    // private getSoundSet(): PigSoundVariant$PigSoundSet;
    // private getSoundVariant(): Holder<PigSoundVariant>;
    getVariant(): Holder<PigVariant>;
    ...
    registerGoals(): void;
    // private setSoundVariant(soundVariant: Holder<PigSoundVariant>): void;
    // private setVariant(variant: Holder<PigVariant>): void;
