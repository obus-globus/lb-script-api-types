...
export class Goat extends Animal {
    ...
    static BABY_DEFAULT_X_HEAD_ROT: number;
    ...
    static LONG_JUMPING_DIMENSION_SCALE_FACTOR: number;
    static MAXIMUM_ALLOWED_LEASHED_DIST: number;
    static MAX_ADDED_RAMMING_X_HEAD_ROT: number;
    ...
    static checkGoatSpawnRules(paramtype: EntityType<Animal>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<Goat>, level: Level)
    // private isLoweringHead: boolean;
    // private lowerHeadTick: number;
    ...
    getBrain(): Brain<Goat>;
    getBreedOffspring(level: ServerLevel, partner: AgeableMob): Goat;
    ...
    makeBrain(packedBrain: Brain$Packed): Brain<Goat>;
