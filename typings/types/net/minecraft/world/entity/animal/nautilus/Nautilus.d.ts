...
export class Nautilus extends AbstractNautilus {
    ...
    constructor(type: EntityType<Nautilus>, level: Level)
    baseTick(): void;
    canBeLeashed(): boolean;
    customServerAiStep(level: ServerLevel): void;
    getAmbientSound(): SoundEvent;
    getBrain(): Brain<Nautilus>;
    getBreedOffspring(level: ServerLevel, partner: AgeableMob): Nautilus;
    ...
    makeBrain(packedBrain: Brain$Packed): Brain<Nautilus>;
