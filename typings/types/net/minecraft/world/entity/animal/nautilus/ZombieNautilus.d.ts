...
export class ZombieNautilus extends AbstractNautilus {
    ...
    constructor(type: EntityType<ZombieNautilus>, level: Level)
    ...
    getBrain(): Brain<ZombieNautilus>;
    getBreedOffspring(level: ServerLevel, partner: AgeableMob): ZombieNautilus;
    ...
    getVariant(): Holder<ZombieNautilusVariant>;
    isBaby(): boolean;
    makeBrain(packedBrain: Brain$Packed): Brain<ZombieNautilus>;
    playEatingSound(): void;
    readAdditionalSaveData(input: ValueInput): void;
    setVariant(variant: Holder<ZombieNautilusVariant>): void;
