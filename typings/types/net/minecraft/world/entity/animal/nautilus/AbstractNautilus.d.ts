...
export abstract class AbstractNautilus extends TamableAnimal implements HasCustomInventoryScreen, PlayerRideableJumping {
    ...
    static checkNautilusSpawnRules(paramtype: EntityType<AbstractNautilus>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<AbstractNautilus>, level: Level)
    ...
    executeRidersJump(amount: number, controller: Player): void;
