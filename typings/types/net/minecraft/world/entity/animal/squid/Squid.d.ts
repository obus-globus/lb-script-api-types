...
export class Squid extends AgeableWaterCreature {
    ...
    constructor(type: EntityType<Squid>, level: Level)
    ...
    registerGoals(): void;
    // private rotateVector(vec: Vec3): Vec3;
    // private spawnInk(): void;
