...
export class GlowSquid extends Squid {
    ...
    static checkGlowSquidSpawnRules(paramtype: EntityType<LivingEntity>, paramlevel: ServerLevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<GlowSquid>, level: Level)
    ...
    // private setDarkTicks(ticks: number): void;
}