...
export class Camel extends AbstractHorse {
    ...
    static checkCamelSpawnRules(paramtype: EntityType<Camel>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    getBodyAnchorAnimationYOffset(isFront: boolean, partialTicks: number, dimensions: EntityDimensions, scale: number): number;
    getBrain(): Brain<Camel>;
    getBreedOffspring(level: ServerLevel, partner: AgeableMob): Camel;
    getDashReadySound(): SoundEvent;
    getDashingSound(): SoundEvent;
    ...
    getSaddleSound(): Holder$Reference<SoundEvent>;
    getSitDownSound(): SoundEvent;
    getStandUpSound(): SoundEvent;
    ...
    isTamed(): boolean;
    // private isVisuallySittingDown(): boolean;
    makeBrain(packedBrain: Brain$Packed): Brain<Camel>;
    ...
    positionRider(arg0: Entity, arg1: (param0: Entity, param1: number, param2: number, param3: number) => void): void;
    readAdditionalSaveData(input: ValueInput): void;
    refuseToMove(): boolean;
    registerGoals(): void;
    resetLastPoseChangeTick(syncedPoseTickTime: number): void;
    // private resetLastPoseChangeTickToFullStand(currentTime: number): void;
    ...
    // private viaFabricPlus$clampPassengerYaw1_20_1(arg0: Entity): void;
}