...
export class Turtle extends Animal {
    ...
    static BABY_ON_LAND_SELECTOR: (param0: LivingEntity, param1: ServerLevel) => kotlin.Boolean;
    ...
    static checkTurtleSpawnRules(paramtype: EntityType<Turtle>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<Turtle>, level: Level)
    // private goingHome: boolean;
    readonly homePos: BlockPos;
    // private layEggCounter: number;
    // private travelPos: BlockPos;
    ...
    registerGoals(): void;
    // private setHasEgg(onOff: boolean): void;
    setHomePos(pos: BlockPos): void;
    // private setLayingEgg(on: boolean): void;
