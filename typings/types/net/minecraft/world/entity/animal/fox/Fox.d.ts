...
export class Fox extends Animal {
    ...
    static checkFoxSpawnRules(paramtype: EntityType<Fox>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    static isPathClear(paramfox: Fox, paramtarget: LivingEntity): boolean;
    ...
    constructor(type: EntityType<Fox>, level: Level)
    // private crouchAmount: number;
    // private crouchAmountO: number;
    // private fishTargetGoal: Goal;
    // private interestedAngle: number;
    // private interestedAngleO: number;
    // private landTargetGoal: Goal;
    // private ticksSinceEaten: number;
    // private turtleEggTargetGoal: Goal;
    ...
    // private isConsumableFood(itemStack: ItemStack): boolean;
    isCrouching(): boolean;
    ...
    registerGoals(): void;
    // private setDefending(defending: boolean): void;
    // private setFaceplanted(faceplanted: boolean): void;
    // private setFlag(flag: number, value: boolean): void;
    setIsCrouching(isCrouching: boolean): void;
    setIsInterested(value: boolean): void;
    setIsPouncing(pouncing: boolean): void;
    setSitting(value: boolean): void;
    // private setSleeping(sleeping: boolean): void;
    setTarget(target: LivingEntity): void;
    // private setTargetGoals(): void;
    // private setVariant(variant: Fox$Variant): void;
    // private spitOutItem(itemStack: ItemStack): void;
    tick(): void;
    // private trusts(entity: LivingEntity): boolean;
    // private wakeUp(): void;
}