...
export class Chicken extends Animal {
    ...
    constructor(type: EntityType<Chicken>, level: Level)
    eggTime: number;
    flap: number;
    flapSpeed: number;
    flapping: number;
    ...
    getBreedOffspring(level: ServerLevel, partner: AgeableMob): Chicken;
    ...
    // private setSoundVariant(soundVariant: Holder<ChickenSoundVariant>): void;
    setVariant(variant: Holder<ChickenVariant>): void;
}