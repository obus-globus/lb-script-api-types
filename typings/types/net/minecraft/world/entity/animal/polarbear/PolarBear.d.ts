...
export class PolarBear extends Animal implements NeutralMob {
    ...
    static checkPolarBearSpawnRules(paramtype: EntityType<PolarBear>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<PolarBear>, level: Level)
    // private clientSideStandAnimation: number;
    // private clientSideStandAnimationO: number;
    readonly persistentAngerEndTime: number;
    readonly persistentAngerTarget: EntityReference<LivingEntity>;
    // private warningSoundTicks: number;
    ...
    getStandingAnimationScale(a: number): number;
    ...
    setStanding(value: boolean): void;
