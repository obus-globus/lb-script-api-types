...
export class CopperGolem extends AbstractGolem implements ContainerUser, Shearable {
    ...
    static EQUIPMENT_SLOT_ANTENNA: EquipmentSlot;
    ...
    constructor(type: EntityType<AbstractGolem>, level: Level)
    // private idleAnimationStartTick: number;
    readonly idleAnimationState: AnimationState;
    readonly interactionDropItemAnimationState: AnimationState;
    readonly interactionDropNoItemAnimationState: AnimationState;
    readonly interactionGetItemAnimationState: AnimationState;
    readonly interactionGetNoItemAnimationState: AnimationState;
    // private lastLightningBoltUUID: UUID;
    // private nextWeatheringTick: number;
    readonly openedChestPos: BlockPos;
    actuallyHurt(level: ServerLevel, source: DamageSource, dmg: number): void;
    addAdditionalSaveData(output: ValueOutput): void;
    // private canTurnToStatue(level: Level): boolean;
    clearOpenedChestPos(): void;
    ...
    getBrain(): Brain<CopperGolem>;
    getContainerInteractionRange(): number;
    getDeathSound(): SoundEvent;
    getHurtSound(source: DamageSource): SoundEvent;
    getIdleAnimationState(): AnimationState;
    getInteractionDropItemAnimationState(): AnimationState;
    getInteractionDropNoItemAnimationState(): AnimationState;
    ...
    getWeatherState(): WeatheringCopper$WeatherState;
    hasContainerOpen(container: ContainerOpenersCounter, blockPos: BlockPos): boolean;
    makeBrain(packedBrain: Brain$Packed): Brain<CopperGolem>;
    mobInteract(player: Player, hand: InteractionHand): InteractionResult;
    // private playHeadSpinSound(): void;
    playSpawnSound(): void;
    playStepSound(pos: BlockPos, blockState: BlockState): void;
    readAdditionalSaveData(input: ValueInput): void;
    readyForShearing(): boolean;
    setOpenedChestPos(openedChestPos: BlockPos): void;
    setState(state: CopperGolemState): void;
    setWeatherState(state: WeatheringCopper$WeatherState): void;
    // private setupAnimationStates(): void;
    shear(level: ServerLevel, soundSource: SoundSource, tool: ItemStack): void;
    spawn(weatherState: WeatheringCopper$WeatherState): void;
    thunderHit(level: ServerLevel, lightningBolt: LightningBolt): void;
    tick(): void;
    // private turnToStatue(level: ServerLevel): void;
    // private updateWeathering(level: ServerLevel, random: RandomSource, gameTime: number): void;
}