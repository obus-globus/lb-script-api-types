...
import type { AbstractCow } from '../../../../../../net/minecraft/world/entity/animal/cow/AbstractCow.d.ts'
...
export class MushroomCow extends AbstractCow implements Shearable {
    ...
    static checkMushroomSpawnRules(paramtype: EntityType<MushroomCow>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<MushroomCow>, level: Level)
    ...
    // private setVariant(variant: MushroomCow$Variant): void;
