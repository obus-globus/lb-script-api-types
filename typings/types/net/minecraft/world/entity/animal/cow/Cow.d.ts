...
export class Cow extends AbstractCow {
    ...
    getVariant(): Holder<CowVariant>;
    readAdditionalSaveData(input: ValueInput): void;
    // private setSoundVariant(soundVariant: Holder<CowSoundVariant>): void;
    setVariant(variant: Holder<CowVariant>): void;
}