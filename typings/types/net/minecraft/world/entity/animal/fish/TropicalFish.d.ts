...
import type { TropicalFish$Variant } from '../../../../../../net/minecraft/world/entity/animal/fish/TropicalFish$Variant.d.ts'
...
export class TropicalFish extends AbstractSchoolingFish {
    ...
    static COMMON_VARIANTS: TropicalFish$Variant[];
    ...
    static DEFAULT_VARIANT: TropicalFish$Variant;
    ...
    static checkSurfaceWaterAnimalSpawnRules(paramtype: EntityType<Object>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    static checkTropicalFishSpawnRules(paramtype: EntityType<TropicalFish>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    static getBaseColor(parampackedVariant: number): DyeColor;
    static getEquipmentForSlot(paramslot: EquipmentSlot, paramtype: number): Item;
    static getInputVector(paraminput: Vec3, paramspeed: number, paramyRot: number): Vec3;
    static getPattern(parampackedVariant: number): TropicalFish$Pattern;
    static getPatternColor(parampackedVariant: number): DyeColor;
    static getPredefinedName(paramindex: number): string;
    ...
    // private getPackedVariant(): number;
    ...
    // private setBaseColor(baseColor: DyeColor): void;
    // private setPackedVariant(i: number): void;
    // private setPattern(pattern: TropicalFish$Pattern): void;
    // private setPatternColor(patternColor: DyeColor): void;
}