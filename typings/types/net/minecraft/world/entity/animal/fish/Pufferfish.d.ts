...
export class Pufferfish extends AbstractFish {
    ...
    constructor(type: EntityType<Pufferfish>, level: Level)
    // private deflateTimer: number;
    // private inflateCounter: number;
    ...
    tick(): void;
    // private touch(level: ServerLevel, mob: Mob): void;
}