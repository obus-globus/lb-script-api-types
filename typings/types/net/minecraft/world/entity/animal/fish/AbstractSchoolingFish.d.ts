...
export abstract class AbstractSchoolingFish extends AbstractFish {
    ...
    constructor(type: EntityType<AbstractSchoolingFish>, level: Level)
    // private leader: AbstractSchoolingFish;
    // private schoolSize: number;
    // private addFollower(): void;
    addFollowers(abstractSchoolingFishStream: Stream<AbstractSchoolingFish>): void;
