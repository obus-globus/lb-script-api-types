...
import type { BinaryAnimator } from '../../../../../../net/minecraft/util/BinaryAnimator.d.ts'
...
export class Axolotl extends Animal implements Bucketable {
    ...
    // private ALL_ANIMATIONS: AnimationState[];
    ...
    inWaterAnimator: BinaryAnimator;
    movingAnimator: BinaryAnimator;
    onGroundAnimator: BinaryAnimator;
    playDeadAnimationState: AnimationState;
    playingDeadAnimator: BinaryAnimator;
    swimAnimationState: AnimationState;
    ...
    makeBrain(packedBrain: Brain$Packed): Brain<Axolotl>;
    ...
    // private setVariant(variant: Axolotl$Variant): void;
    // private soloAnimation(toStart: AnimationState): void;
    // private tickAdultAnimations(): void;
    // private tickBabyAnimations(): void;
