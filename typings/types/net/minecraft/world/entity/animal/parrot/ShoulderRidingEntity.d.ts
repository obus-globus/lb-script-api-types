...
export abstract class ShoulderRidingEntity extends TamableAnimal {
    ...
    constructor(type: EntityType<ShoulderRidingEntity>, level: Level)
    // private rideCooldownCounter: number;
