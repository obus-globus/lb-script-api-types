...
export class Rabbit extends Animal {
    ...
    static checkRabbitSpawnRules(paramtype: EntityType<Rabbit>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    // private disableJumpControl(): void;
    ...
    // private setLandingDelay(): void;
    setLeashData(leashData: Leashable$LeashData): void;
    setSpeedModifier(speed: number): void;
    // private setVariant(variant: Rabbit$Variant): void;
    // private setupAnimationStates(): void;
    // private shouldPlayIdleAnimation(): boolean;
    startJumping(): void;
    // private wantsMoreFood(): boolean;
}