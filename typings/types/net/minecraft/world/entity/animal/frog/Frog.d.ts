...
export class Frog extends Animal {
    ...
    static canEat(paramentity: LivingEntity): boolean;
    ...
    static checkFrogSpawnRules(paramtype: EntityType<Animal>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    getTongueTarget(): Optional<Entity>;
    ...
    setTongueTarget(target: Entity): void;
    // private setVariant(variant: Holder<FrogVariant>): void;
