...
export class Tadpole extends AbstractFish {
    ...
    // private age: number;
    // private ageLockParticleTimer: number;
    addAdditionalSaveData(output: ValueOutput): void;
    // private ageUp(): void;
    // private ageUp(ticksToAgeUp: number): void;
    aiStep(): void;
    ...
    // private feed(player: Player, itemStack: ItemStack): void;
    fromBucket(): boolean;
    // private getAge(): number;
    getAmbientSound(): SoundEvent;
    getBrain(): Brain<Tadpole>;
    ...
    // private getTicksLeftUntilAdult(): number;
    isAgeLocked(): boolean;
    // private isFood(itemStack: ItemStack): boolean;
    loadFromBucketTag(tag: CompoundTag): void;
    makeBrain(packedBrain: Brain$Packed): Brain<Tadpole>;
    ...
    setAgeLocked(locked: boolean): void;
