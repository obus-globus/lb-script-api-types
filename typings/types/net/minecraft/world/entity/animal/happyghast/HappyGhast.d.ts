...
export class HappyGhast extends Animal {
    ...
    static FAST_HEALING_TICKS: number;
    ...
    static LARGE_RESTRICTION_RADIUS: number;
    ...
    static RESTRICTION_RADIUS_BUFFER: number;
    static SADDLE_OFFSET: number;
    static SHARED_QUAD_ATTACHMENT_POINTS: Vec3[];
    static SLOW_HEALING_TICKS: number;
    static SMALL_RESTRICTION_RADIUS: number;
    static SPEED_MULTIPLIER_WHEN_PANICKING: number;
    ...
    static WANDER_GROUND_DISTANCE: number;
    ...
    constructor(type: EntityType<HappyGhast>, level: Level)
    // private leashHolderTime: number;
    // private serverStillTimeout: number;
    addAdditionalSaveData(tag: ValueOutput): void;
    addPassenger(passenger: Entity): void;
    // private adultGhastSetup(): void;
    ageBoundaryReached(): void;
    aiStep(): void;
    // private babyGhastSetup(): void;
    ...
    // private continuousHeal(): void;
    // private createBabyNavigation(level: Level): PathNavigation;
    ...
    // private doPlayerRide(player: Player): void;
    getAgeScale(): number;
    getAmbientSound(): SoundEvent;
    getAmbientSoundInterval(): number;
    getBrain(): Brain<HappyGhast>;
    ...
    makeBrain(packedBrain: Brain$Packed): Brain<HappyGhast>;
    ...
    readAdditionalSaveData(tag: ValueInput): void;
    registerGoals(): void;
    removePassenger(passenger: Entity): void;
    sanitizeScale(scale: number): number;
    // private scanPlayerAboveGhast(): boolean;
    // private setLeashHolder(isLeashHolder: boolean): void;
    // private setServerStillTimeout(serverStillTimeout: number): void;
    shouldStayCloseToLeashHolder(): boolean;
    staysStill(): boolean;
    supportQuadLeashAsHolder(): boolean;
    // private syncStayStillFlag(): void;
    tick(): void;
