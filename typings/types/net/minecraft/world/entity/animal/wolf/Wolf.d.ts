...
export class Wolf extends TamableAnimal implements NeutralMob {
    ...
    static DEFAULT_TAIL_ANGLE: number;
    ...
    static PREY_SELECTOR: (param0: LivingEntity, param1: ServerLevel) => kotlin.Boolean;
    ...
    static checkWolfSpawnRules(paramtype: EntityType<Wolf>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<Wolf>, level: Level)
    // private interestedAngle: number;
    // private interestedAngleO: number;
    // private isShaking: boolean;
    // private isWet: boolean;
    readonly persistentAngerTarget: EntityReference<LivingEntity>;
    // private shakeAnim: number;
    // private shakeAnimO: number;
    actuallyHurt(level: ServerLevel, source: DamageSource, damage: number): void;
    ...
    getShakeAnim(a: number): number;
    // private getSoundSet(): WolfSoundVariant$WolfSoundSet;
    // private getSoundVariant(): Holder<WolfSoundVariant>;
    getSoundVolume(): number;
    getTailAngle(): number;
    getTexture(): Identifier;
    // private getVariant(): Holder<WolfVariant>;
    getWetShade(a: number): number;
    ...
    registerGoals(): void;
    // private setCollarColor(color: DyeColor): void;
    ...
    // private setSoundVariant(soundVariant: Holder<WolfSoundVariant>): void;
    setTimeToRemainAngry(remainingTime: number): void;
    // private setVariant(variant: Holder<WolfVariant>): void;
    startPersistentAngerTimer(): void;
    stopBeingAngry(): void;
    tick(): void;
    // private tryToTame(player: Player): void;
