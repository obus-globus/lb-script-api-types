...
import type { Cat$CatAvoidEntityGoal } from '../../../../../../net/minecraft/world/entity/animal/feline/Cat$CatAvoidEntityGoal.d.ts'
...
export class Cat extends TamableAnimal {
    ...
    constructor(type: EntityType<Cat>, level: Level)
    // private avoidPlayersGoal: Cat$CatAvoidEntityGoal<Player>;
    // private isLyingOnTopOfSleepingPlayer: boolean;
    // private lieDownAmount: number;
    // private lieDownAmountO: number;
    // private lieDownAmountOTail: number;
    // private lieDownAmountTail: number;
    // private relaxStateOneAmount: number;
    ...
    getLieDownAmount(a: number): number;
    getLieDownAmountTail(a: number): number;
    getRelaxStateOneAmount(a: number): number;
    // private getSoundSet(): CatSoundVariant$CatSoundSet;
    // private getSoundVariant(): Holder<CatSoundVariant>;
    ...
    // private isRelaxStateOne(): boolean;
    ...
    // private setRelaxStateOne(value: boolean): void;
    // private setSoundVariant(soundVariant: Holder<CatSoundVariant>): void;
    setTame(isTame: boolean, includeSideEffects: boolean): void;
    // private setVariant(variant: Holder<CatVariant>): void;
    tick(): void;
    // private tryToTame(player: Player): void;
    // private updateLieDownAmount(): void;
    // private updateRelaxStateOneAmount(): void;
}