...
export class Llama extends AbstractChestedHorse implements RangedAttackMob {
    ...
    constructor(type: EntityType<Llama>, level: Level)
    readonly caravanHead: Llama;
    ...
    registerGoals(): void;
    // private setDidSpit(b: boolean): void;
    // private setRandomStrength(random: RandomSource): void;
    // private setStrength(strength: number): void;
    // private setVariant(variant: Llama$Variant): void;
