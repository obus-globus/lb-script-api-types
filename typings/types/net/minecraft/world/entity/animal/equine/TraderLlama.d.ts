...
export class TraderLlama extends Llama {
    ...
    constructor(type: EntityType<TraderLlama>, level: Level)
    ...
    // private isLeashedToSomethingOtherThanTheWanderingTrader(): boolean;
    // private isLeashedToWanderingTrader(): boolean;
