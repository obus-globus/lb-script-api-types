...
export class Variant extends Enum<Variant> implements StringRepresentable {
    ...
    static STREAM_CODEC: StreamCodec<ByteBuf, Variant>;
    static WHITE: Variant;
    static byId(paramid: number): Variant;
    ...
    static valueOf(paramname: string): Variant;
    ...
    name(): "WHITE" | "CREAMY" | "CHESTNUT" | "BROWN" | "BLACK" | "GRAY" | "DARK_BROWN";
}