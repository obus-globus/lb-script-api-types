...
export abstract class AbstractChestedHorse extends AbstractHorse {
    ...
    constructor(type: EntityType<AbstractChestedHorse>, level: Level)
    // private babyDimensions: EntityDimensions;
    // private viaFabricPlus$baby_dimensions_r1_21_11: EntityDimensions;
    addAdditionalSaveData(output: ValueOutput): void;
    defineSynchedData(entityData: SynchedEntityData$Builder): void;
    dropEquipment(level: ServerLevel): void;
    // private equipChest(player: Player, itemStack: ItemStack): void;
