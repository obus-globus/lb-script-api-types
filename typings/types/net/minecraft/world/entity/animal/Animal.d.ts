...
export abstract class Animal extends AgeableMob {
    ...
    readonly inLove: number;
    readonly loveCause: EntityReference<ServerPlayer>;
    ...
    finalizeSpawnChildFromBreeding(level: ServerLevel, partner: Animal, offspring: AgeableMob): void;
    ...
    resetLove(): void;
    setInLove(player: Player): void;
    setInLoveTime(time: number): void;
