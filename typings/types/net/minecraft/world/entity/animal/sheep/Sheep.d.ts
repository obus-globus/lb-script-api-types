...
import type { EatBlockGoal } from '../../../../../../net/minecraft/world/entity/ai/goal/EatBlockGoal.d.ts'
...
export class Sheep extends Animal implements Shearable {
    ...
    static getRandomSheepColor(paramlevel: ServerLevelAccessor, parampos: BlockPos): DyeColor;
    ...
    constructor(type: EntityType<Sheep>, level: Level)
    // private eatAnimationTick: number;
    ...
    getHeadEatAngleScale(a: number): number;
    getHeadEatPositionScale(a: number): number;
