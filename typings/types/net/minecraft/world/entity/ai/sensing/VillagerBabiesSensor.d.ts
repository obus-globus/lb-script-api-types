...
export class VillagerBabiesSensor extends Sensor<LivingEntity> {
    ...
    // private getNearestVillagerBabies(myBody: LivingEntity): LivingEntity[];
    // private getVisibleEntities(myBody: LivingEntity): NearestVisibleLivingEntities;
    // private isVillagerBaby(entity: LivingEntity): boolean;
