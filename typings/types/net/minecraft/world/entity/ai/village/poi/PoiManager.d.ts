...
export class PoiManager extends SectionStorage<PoiSection, PoiSection$Packed> implements PointOfInterestStorageExtended, RegionBasedStorageSectionExtended<Object> {
    ...
    find(arg0: (param0: Object) => boolean, arg1: (param0: Object) => boolean, arg2: BlockPos, arg3: number, arg4: PoiManager$Occupancy): Optional<Object>;
    findAll(predicate: (param0: Holder<PoiType>) => boolean, filter: (param0: BlockPos) => boolean, center: BlockPos, radius: number, occupancy: PoiManager$Occupancy): Stream<BlockPos>;
    findAllClosestFirstWithType(predicate: (param0: Holder<PoiType>) => boolean, filter: (param0: BlockPos) => boolean, center: BlockPos, radius: number, occupancy: PoiManager$Occupancy): Stream<Pair<Holder<PoiType>, BlockPos>>;
    findAllWithType(predicate: (param0: Holder<PoiType>) => boolean, filter: (param0: BlockPos) => boolean, center: BlockPos, radius: number, occupancy: PoiManager$Occupancy): Stream<Pair<Holder<PoiType>, BlockPos>>;
    findClosest(arg0: (param0: Object) => boolean, arg1: (param0: Object) => boolean, arg2: BlockPos, arg3: number, arg4: PoiManager$Occupancy): Optional<Object>;
    findClosest(arg0: (param0: Object) => boolean, arg1: BlockPos, arg2: number, arg3: PoiManager$Occupancy): Optional<Object>;
    findClosestWithType(arg0: (param0: Object) => boolean, arg1: BlockPos, arg2: number, arg3: PoiManager$Occupancy): Optional<Object>;
    getCountInRange(arg0: (param0: Object) => boolean, arg1: BlockPos, arg2: number, arg3: PoiManager$Occupancy): number;
    getDebugPoiInfo(pos: BlockPos): DebugPoiInfo;
    getInChunk(predicate: (param0: Holder<PoiType>) => boolean, chunkPos: ChunkPos, occupancy: PoiManager$Occupancy): Stream<PoiRecord>;
    getInRange(arg0: (param0: Object) => boolean, arg1: BlockPos, arg2: number, arg3: PoiManager$Occupancy): Stream<Object>;
    getInSquare(predicate: (param0: Holder<PoiType>) => boolean, center: BlockPos, radius: number, occupancy: PoiManager$Occupancy): Stream<PoiRecord>;
    getRandom(arg0: (param0: Object) => boolean, arg1: (param0: Object) => boolean, arg2: PoiManager$Occupancy, arg3: BlockPos, arg4: number, arg5: RandomSource): Optional<Object>;
    getType(pos: BlockPos): Optional<Holder<PoiType>>;
    // private isVillageCenter(sectionPos: number): boolean;
    lithium$findNearestForPortalLogic(arg0: BlockPos, arg1: number, arg2: Holder<Object>, arg3: PoiManager$Occupancy, arg4: (param0: Object) => boolean, arg5: WorldBorder): Optional<Object>;
    // private lithium$getLowestEmptyOrInvalidSection(arg0: LevelReader, arg1: number, arg2: number): number;
    lithium$getNClosestFirstWithType(arg0: (param0: Object) => boolean, arg1: (param0: Object) => boolean, arg2: BlockPos, arg3: number, arg4: PoiManager$Occupancy, arg5: number): (Object | null)[];
    lithium$takeAt(arg0: (param0: Object) => boolean, arg1: (param0: Object, param1: Object) => boolean, arg2: BlockPos): Optional<Object>;
    ...
    take(predicate: (param0: Holder<PoiType>) => boolean, filter: (param0: Holder<PoiType>, param1: BlockPos) => boolean, center: BlockPos, radius: number): Optional<BlockPos>;
    ...
    // private withinSquareInL2Range(arg0: (param0: Object) => boolean, arg1: BlockPos, arg2: number, arg3: PoiManager$Occupancy): Object[];
}