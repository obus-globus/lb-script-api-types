...
export class NearestAttackableWitchTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
    constructor(raider: Raider, targetType: Class<T>, randomInterval: number, mustSee: boolean, mustReach: boolean, subselector: (param0: LivingEntity, param1: ServerLevel) => kotlin.Boolean)
