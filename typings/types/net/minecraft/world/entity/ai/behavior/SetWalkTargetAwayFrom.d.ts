...
export class SetWalkTargetAwayFrom extends Object {
    static entity(parammemory: MemoryModuleType<Entity>, paramspeedModifier: number, paramdesiredDistance: number, paraminterruptCurrentWalk: boolean): OneShot<PathfinderMob>;
