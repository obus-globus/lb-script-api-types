...
export class TriggerGate extends Object {
    static triggerGate(paramweightedBehaviors: Pair<Trigger<Object>, number>[], paramorderPolicy: GateBehavior$OrderPolicy, paramrunningPolicy: GateBehavior$RunningPolicy): OneShot<LivingEntity>;
    static triggerOneShuffled(paramweightedTriggers: Pair<Trigger<Object>, number>[]): OneShot<LivingEntity>;
    constructor()
}