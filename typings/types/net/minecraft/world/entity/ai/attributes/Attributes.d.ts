...
export class Attributes extends Object {
    ...
    static TEMPT_RANGE: Holder<Attribute>;
    static WATER_MOVEMENT_EFFICIENCY: Holder<Attribute>;
    static WAYPOINT_RECEIVE_RANGE: Holder<Attribute>;
    static WAYPOINT_TRANSMIT_RANGE: Holder<Attribute>;
    static bootstrap(paramregistry: Attribute[]): Holder<Attribute>;
    constructor()
}