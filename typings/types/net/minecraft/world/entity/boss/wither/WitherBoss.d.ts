...
export class WitherBoss extends Monster implements RangedAttackMob {
    ...
    constructor(type: EntityType<WitherBoss>, level: Level)
    // private bossEvent: ServerBossEvent;
    // private destroyBlocksTick: number;
    // private idleHeadUpdates: number[];
    // private nextHeadUpdate: number[];
    // private xRotHeads: number[];
    // private xRotOHeads: number[];
    ...
    getAlternativeTarget(headIndex: number): number;
    getAmbientSound(): SoundEvent;
    getDeathSound(): SoundEvent;
    // private getHeadX(index: number): number;
    getHeadXRots(): number[];
    // private getHeadY(index: number): number;
    getHeadYRots(): number[];
    // private getHeadZ(index: number): number;
    ...
    // private performRangedAttack(head: number, tx: number, ty: number, tz: number, dangerous: boolean): void;
    // private performRangedAttack(head: number, target: LivingEntity): void;
    performRangedAttack(target: LivingEntity, power: number): void;
    readAdditionalSaveData(input: ValueInput): void;
    registerGoals(): void;
    // private rotlerp(a: number, b: number, max: number): number;
    setAlternativeTarget(headIndex: number, entityId: number): void;
