...
export abstract class BlockAttachedEntity extends Entity {
    ...
    constructor(type: EntityType<BlockAttachedEntity>, level: Level)
    constructor(type: EntityType<BlockAttachedEntity>, level: Level, pos: BlockPos)
