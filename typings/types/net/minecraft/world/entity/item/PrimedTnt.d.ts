...
export class PrimedTnt extends Entity implements TraceableEntity {
    ...
    static DEFAULT_FUSE_TIME: number;
    ...
    static getRandomShortFuse(paramfuse: number, paramrandom: RandomSource): number;
    static getViewScale(): number;
    static setViewScale(paramviewScale: number): void;
    constructor(type: EntityType<PrimedTnt>, level: Level)
    constructor(level: Level, x: number, y: number, z: number, owner: LivingEntity)
    // private explosionPower: number;
    readonly owner: EntityReference<LivingEntity>;
    // private usedPortal: boolean;
    ...
    setFuse(time: number): void;
    // private setUsedPortal(usedPortal: boolean): void;
