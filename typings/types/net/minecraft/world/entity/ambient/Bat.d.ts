...
import type { AmbientCreature } from '../../../../../net/minecraft/world/entity/ambient/AmbientCreature.d.ts'
...
export class Bat extends AmbientCreature {
    ...
    static checkBatSpawnRules(paramtype: EntityType<Bat>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<Bat>, level: Level)
    flyAnimationState: AnimationState;
    restAnimationState: AnimationState;
    // private targetPosition: BlockPos;
