...
export class TamableAnimal$TamableAnimalPanicGoal extends PanicGoal {
    ...
    constructor(null_: TamableAnimal$TamableAnimalPanicGoal, speedModifier: number)
    constructor(null_: TamableAnimal$TamableAnimalPanicGoal, panicCausingDamageTypes: TagKey<DamageType>)
    tick(): void;
}