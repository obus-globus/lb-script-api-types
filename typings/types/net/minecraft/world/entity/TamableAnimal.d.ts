...
export abstract class TamableAnimal extends Animal implements OwnableEntity {
    ...
    constructor(type: EntityType<TamableAnimal>, level: Level)
    readonly orderedToSit: boolean;
    addAdditionalSaveData(output: ValueOutput): void;
    applyTamingSideEffects(): void;
    canAttack(target: LivingEntity): boolean;
    canBeLeashed(): boolean;
    canFlyToOwner(): boolean;
    // private canTeleportTo(pos: BlockPos): boolean;
    ...
    feed(player: Player, hand: InteractionHand, itemStack: ItemStack, healingFactor: number, defaultHeal: number): void;
    ...
    isOwnedBy(entity: LivingEntity): boolean;
    isTame(): boolean;
    // private maybeTeleportTo(x: number, y: number, z: number): boolean;
    readAdditionalSaveData(input: ValueInput): void;
    setInSittingPose(value: boolean): void;
    setOrderedToSit(orderedToSit: boolean): void;
    setOwner(owner: LivingEntity): void;
    setOwnerReference(owner: EntityReference<LivingEntity>): void;
    ...
    // private teleportToAroundBlockPos(targetPos: BlockPos): void;
