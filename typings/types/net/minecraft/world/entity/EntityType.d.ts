...
export class EntityType<T extends Entity> extends Object implements FabricEntityTypeImpl, FeatureElement, EntityTypeTest<Entity, T> {
    ...
    static appendComponentsConfig(paraminitialConfig: PostSpawnProcessor<Entity>, paramitemStack: ItemStack): PostSpawnProcessor<Entity>;
    static appendCustomEntityStackConfig(paraminitialConfig: PostSpawnProcessor<Entity>, paramlevel: Level, paramitemStack: ItemStack, paramuser: LivingEntity): PostSpawnProcessor<Entity>;
    static appendDefaultStackConfig(paraminitialConfig: PostSpawnProcessor<Entity>, paramlevel: Level, paramitemStack: ItemStack, paramuser: LivingEntity): PostSpawnProcessor<Entity>;
    ...
    static createDefaultStackConfig(paramlevel: Level, paramitemStack: ItemStack, paramuser: LivingEntity): PostSpawnProcessor<Entity>;
    static forClass(paramcls: Class<Object>): EntityTypeTest<Object, any>;
    static forExactClass(paramcls: Class<Object>): EntityTypeTest<Object, any>;
