...
export class PiglinBrute extends AbstractPiglin {
    ...
    static BRAIN_PROVIDER: Brain$Provider<PiglinBrute>;
    ...
    constructor(type: EntityType<PiglinBrute>, level: Level)
    canHunt(): boolean;
    ...
    makeBrain(packedBrain: Brain$Packed): Brain<PiglinBrute>;
    playAngrySound(): void;
