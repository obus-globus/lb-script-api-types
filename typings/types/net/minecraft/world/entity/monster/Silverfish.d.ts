...
import type { Silverfish$SilverfishWakeUpFriendsGoal } from '../../../../../net/minecraft/world/entity/monster/Silverfish$SilverfishWakeUpFriendsGoal.d.ts'
...
export class Silverfish extends Monster {
    ...
    static checkSilverfishSpawnRules(paramtype: EntityType<Silverfish>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<Silverfish>, level: Level)
    // private friendsGoal: Silverfish$SilverfishWakeUpFriendsGoal;
