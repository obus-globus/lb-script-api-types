...
export class MagmaCube extends AbstractCubeMob implements Enemy {
    ...
    static checkMagmaCubeSpawnRules(paramtype: EntityType<MagmaCube>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<MagmaCube>, level: Level)
