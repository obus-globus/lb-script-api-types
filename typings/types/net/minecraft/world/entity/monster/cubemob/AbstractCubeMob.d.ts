...
export abstract class AbstractCubeMob extends AgeableMob {
    ...
    constructor(type: EntityType<AbstractCubeMob>, level: Level)
    oSquish: number;
    squish: number;
    targetSquish: number;
    ...
    dealDamage(target: LivingEntity): void;
    decreaseSquish(): void;
    ...
    getType(): EntityType<AbstractCubeMob>;
