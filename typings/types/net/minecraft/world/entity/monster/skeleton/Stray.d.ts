...
export class Stray extends AbstractSkeleton {
    ...
    static checkStraySpawnRules(paramtype: EntityType<Stray>, paramlevel: ServerLevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<Stray>, level: Level)
