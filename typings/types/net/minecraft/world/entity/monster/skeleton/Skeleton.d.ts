...
export class Skeleton extends AbstractSkeleton {
    ...
    constructor(type: EntityType<Skeleton>, level: Level)
    // private conversionTime: number;
    // private inPowderSnowTime: number;
    ...
    setFreezeConverting(isConverting: boolean): void;
    startFreezeConversion(time: number): void;
    tick(): void;
}