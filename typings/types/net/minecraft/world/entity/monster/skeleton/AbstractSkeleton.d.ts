...
import type { RangedBowAttackGoal } from '../../../../../../net/minecraft/world/entity/ai/goal/RangedBowAttackGoal.d.ts'
...
export abstract class AbstractSkeleton extends Monster implements RangedAttackMob {
    ...
    constructor(type: EntityType<AbstractSkeleton>, level: Level)
    // private bowGoal: RangedBowAttackGoal<AbstractSkeleton>;
    ...
    getArrow(projectile: ItemStack, power: number, firingWeapon: ItemStack): AbstractArrow;
