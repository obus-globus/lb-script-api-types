...
export class Creaking extends Monster {
    static ARMOR_SLOT_OFFSET: number;
    static ATTACK_INTERVAL: number;
    ...
    static CREAKING_GRAY: number;
    static CREAKING_ORANGE: number;
    ...
    static INVULNERABILITY_ANIMATION_DURATION: number;
    ...
    static SPEED_MULTIPLIER_WHEN_IDLING: number;
    ...
    static TWITCH_DEATH_DURATION: number;
    ...
    constructor(type: EntityType<Creaking>, level: Level)
    // private attackAnimationRemainingTicks: number;
    attackAnimationState: AnimationState;
    deathAnimationState: AnimationState;
    // private eyesGlowing: boolean;
    // private invulnerabilityAnimationRemainingTicks: number;
    invulnerabilityAnimationState: AnimationState;
    // private nextFlickerTime: number;
    // private playerStuckCounter: number;
    activate(player: Player): void;
    addAdditionalSaveData(output: ValueOutput): void;
    aiStep(): void;
    blameSourceForDamage(source: DamageSource): Player;
    canMove(): boolean;
    canUsePortal(ignorePassenger: boolean): boolean;
    checkCanMove(): boolean;
    checkEyeBlink(): void;
    creakingDeathEffects(source: DamageSource): void;
    ...
    makeBrain(packedBrain: Brain$Packed): Brain<Creaking>;
    ...
    setTearingDown(): void;
    setTransient(pos: BlockPos): void;
