...
export class Blaze extends Monster {
    ...
    constructor(blaze: EntityType<Blaze>, level: Level)
    // private allowedHeightOffset: number;
    // private nextHeightOffsetChangeTick: number;
    aiStep(): void;
    ...
    registerGoals(): void;
    // private setCharged(value: boolean): void;
}