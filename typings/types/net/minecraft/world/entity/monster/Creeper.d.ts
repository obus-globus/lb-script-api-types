...
export class Creeper extends Monster {
    ...
    constructor(type: EntityType<Creeper>, level: Level)
    // private droppedSkulls: boolean;
    explosionRadius: number;
    // private maxSwell: number;
    // private oldSwell: number;
    ...
    registerGoals(): void;
    setSwellDir(dir: number): void;
    setTarget(target: LivingEntity): void;
    // private spawnLingeringCloud(): void;
