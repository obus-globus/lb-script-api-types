...
import type { NearestAttackableWitchTargetGoal } from '../../../../../net/minecraft/world/entity/ai/goal/target/NearestAttackableWitchTargetGoal.d.ts'
import type { NearestHealableRaiderTargetGoal } from '../../../../../net/minecraft/world/entity/ai/goal/target/NearestHealableRaiderTargetGoal.d.ts'
...
export class Witch extends Raider implements RangedAttackMob {
    ...
    static checkPatrollingMonsterSpawnRules(paramtype: EntityType<PatrollingMonster>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<Witch>, level: Level)
    // private attackPlayersGoal: NearestAttackableWitchTargetGoal<Player>;
    // private healRaidersGoal: NearestHealableRaiderTargetGoal<Raider>;
    // private usingTime: number;
    aiStep(): void;
    ...
    registerGoals(): void;
    setUsingItem(using: boolean): void;
}