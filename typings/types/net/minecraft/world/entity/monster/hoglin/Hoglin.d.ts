...
export class Hoglin extends Animal implements Enemy, HoglinBase {
    ...
    static PROBABILITY_OF_SPAWNING_AS_BABY: number;
    ...
    static checkHoglinSpawnRules(paramtype: EntityType<Hoglin>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    readonly timeInOverworld: number;
    ...
    // private isImmuneToZombification(): boolean;
    makeBrain(packedBrain: Brain$Packed): Brain<Hoglin>;
    ...
    // private setCannotBeHunted(cannotBeHunted: boolean): void;
    setImmuneToZombification(isImmuneToZombification: boolean): void;
    setTimeInOverworld(timeInOverworld: number): void;
