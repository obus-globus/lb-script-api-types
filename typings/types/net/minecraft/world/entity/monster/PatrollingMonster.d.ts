...
export abstract class PatrollingMonster extends Monster {
    ...
    constructor(type: EntityType<PatrollingMonster>, level: Level)
    readonly patrolLeader: boolean;
    readonly patrolTarget: BlockPos;
    // private patrolling: boolean;
    ...
    setPatrolLeader(isLeader: boolean): void;
    setPatrolTarget(target: BlockPos): void;
    setPatrolling(value: boolean): void;
}