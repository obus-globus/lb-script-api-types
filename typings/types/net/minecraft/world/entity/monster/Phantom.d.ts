...
import type { Phantom$AttackPhase } from '../../../../../net/minecraft/world/entity/monster/Phantom$AttackPhase.d.ts'
...
export class Phantom extends Mob implements Enemy {
    ...
    constructor(type: EntityType<Phantom>, level: Level)
    // private anchorPoint: BlockPos;
    // private attackPhase: Phantom$AttackPhase;
