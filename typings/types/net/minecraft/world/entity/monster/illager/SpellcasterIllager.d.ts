...
export abstract class SpellcasterIllager extends AbstractIllager {
    ...
    constructor(type: EntityType<SpellcasterIllager>, level: Level)
    // private currentSpell: SpellcasterIllager$IllagerSpell;
    // private spellCastingTickCount: number;
    ...
    setIsCastingSpell(spell: SpellcasterIllager$IllagerSpell): void;
    tick(): void;
}