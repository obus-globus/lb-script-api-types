...
export class Illusioner extends SpellcasterIllager implements RangedAttackMob {
    ...
    constructor(type: EntityType<Illusioner>, level: Level)
    // private clientSideIllusionOffsets: Vec3[][];
    // private clientSideIllusionTicks: number;
    aiStep(): void;
    ...
    getIllusionOffsets(a: number): Vec3[];
