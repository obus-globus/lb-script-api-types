...
export class ZombifiedPiglin extends Zombie implements NeutralMob {
    ...
    static checkZombifiedPiglinSpawnRules(paramtype: EntityType<ZombifiedPiglin>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    constructor(type: EntityType<ZombifiedPiglin>, level: Level)
    readonly persistentAngerEndTime: number;
    readonly persistentAngerTarget: EntityReference<LivingEntity>;
    // private playFirstAngerSoundIn: number;
    // private ticksUntilNextAlert: number;
    ...
    // private maybeAlertOthers(): void;
    // private maybePlayFirstAngerSound(): void;
    // private playAngerSound(): void;
