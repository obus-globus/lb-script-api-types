...
export class Zoglin extends Monster implements HoglinBase {
    ...
    isAdult(): boolean;
    isBaby(): boolean;
    makeBrain(packedBrain: Brain$Packed): Brain<Zoglin>;
    ...
    // private setAttackTarget(target: LivingEntity): void;
