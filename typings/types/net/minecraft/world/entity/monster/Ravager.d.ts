...
export class Ravager extends Raider {
    ...
    constructor(type: EntityType<Ravager>, level: Level)
    readonly attackTick: number;
    readonly roarTick: number;
    readonly stunnedTick: number;
    addAdditionalSaveData(output: ValueOutput): void;
    // private addRoarParticleEffects(): void;
    aiStep(): void;
    applyRaidBuffs(level: ServerLevel, wave: number, isCaptain: boolean): void;
    // private applyRoarKnockbackClient(): void;
    ...
    registerGoals(): void;
    // private roar(): void;
    // private strongKnockback(entity: Entity): void;
