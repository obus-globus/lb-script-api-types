...
import type { AbstractThrownPotion } from '../../../../../net/minecraft/world/entity/projectile/throwableitemprojectile/AbstractThrownPotion.d.ts'
...
export class EnderMan extends Monster implements NeutralMob {
    ...
    constructor(type: EntityType<EnderMan>, level: Level)
    // private lastStareSound: number;
    readonly persistentAngerEndTime: number;
    readonly persistentAngerTarget: EntityReference<LivingEntity>;
    // private targetChangeTime: number;
    ...
    // private hurtWithCleanWater(level: ServerLevel, source: DamageSource, thrownPotion: AbstractThrownPotion, damage: number): boolean;
    isAngry(): boolean;
    ...
    setCarriedBlock(carryingBlock: BlockState): void;
