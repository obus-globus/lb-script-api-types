...
export class Strider extends Animal implements ItemSteerable {
    ...
    constructor(strider: EntityType<Strider>, level: Level)
    ...
    registerGoals(): void;
    setSuffocating(flag: boolean): void;
    shouldPassengersInheritMalus(): boolean;
    // private spawnJockey(level: ServerLevelAccessor, difficulty: DifficultyInstance, jockey: Mob, jockeyGroupData: SpawnGroupData): SpawnGroupData;
    tick(): void;
