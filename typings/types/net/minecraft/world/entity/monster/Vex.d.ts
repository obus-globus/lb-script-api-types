...
export class Vex extends Monster implements OwnableEntity, TraceableEntity {
    ...
    constructor(type: EntityType<Vex>, level: Level)
    readonly boundOrigin: BlockPos;
    // private hasLimitedLife: boolean;
    // private limitedLifeTicks: number;
    ...
    // private getVexFlag(flag: number): boolean;
    ...
    setBoundOrigin(boundOrigin: BlockPos): void;
    setIsCharging(value: boolean): void;
    setLimitedLife(lifeTicks: number): void;
    setOwner(owner: Mob): void;
    // private setVexFlag(flag: number, value: boolean): void;
    tick(): void;
}