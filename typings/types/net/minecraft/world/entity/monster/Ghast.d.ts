...
export class Ghast extends Mob implements Enemy {
    ...
    static checkGhastSpawnRules(paramtype: EntityType<Ghast>, paramlevel: LevelAccessor, paramspawnReason: EntitySpawnReason, parampos: BlockPos, paramrandom: RandomSource): boolean;
    ...
    static faceMovementDirection(paramghast: Mob): void;
    ...
    constructor(type: EntityType<Ghast>, level: Level)
    ...
    registerGoals(): void;
    setCharging(onOff: boolean): void;
