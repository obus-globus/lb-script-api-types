...
export class LightningBolt extends Entity {
    ...
    constructor(type: EntityType<LightningBolt>, level: Level)
    readonly blocksSetOnFire: number;
    readonly cause: ServerPlayer;
    // private flashes: number;
    readonly hitEntities: Entity[];
    // private life: number;
    seed: number;
