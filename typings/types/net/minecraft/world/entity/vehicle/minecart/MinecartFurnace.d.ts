...
export class MinecartFurnace extends AbstractMinecart {
    ...
    constructor(type: EntityType<MinecartFurnace>, level: Level)
    // private fuel: number;
    push: Vec3;
    addAdditionalSaveData(output: ValueOutput): void;
    addFuel(interactingPos: Vec3, itemStack: ItemStack): boolean;
    applyNaturalSlowdown(deltaMovement: Vec3): Vec3;
    // private calculateNewPushAlong(deltaMovement: Vec3): Vec3;
