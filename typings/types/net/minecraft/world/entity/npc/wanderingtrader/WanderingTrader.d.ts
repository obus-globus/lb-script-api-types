...
import type { Consumable$OverrideConsumeSound } from '../../../../../../net/minecraft/world/item/component/Consumable$OverrideConsumeSound.d.ts'
...
export class WanderingTrader extends AbstractVillager implements Consumable$OverrideConsumeSound {
    ...
    constructor(type: EntityType<WanderingTrader>, level: Level)
    readonly despawnDelay: number;
    readonly wanderTarget: BlockPos;
    ...
    // private getWanderTarget(): BlockPos;
    ...
    setWanderTarget(pos: BlockPos): void;
