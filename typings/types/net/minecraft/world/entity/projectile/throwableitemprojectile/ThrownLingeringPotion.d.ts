...
export class ThrownLingeringPotion extends AbstractThrownPotion {
    ...
    constructor(type: EntityType<ThrownLingeringPotion>, level: Level)
    constructor(level: Level, x: number, y: number, z: number, itemStack: ItemStack)
    constructor(level: Level, owner: LivingEntity, itemStack: ItemStack)
    getDefaultItem(): Item;
