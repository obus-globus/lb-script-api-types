...
export class ThrownTrident extends AbstractArrow {
    ...
    // private getLoyaltyFromItem(tridentItem: ItemStack): number;
    getWaterInertia(): number;
    getWeaponItem(): ItemStack;
    hitBlockEnchantmentEffects(level: ServerLevel, hitResult: BlockHitResult, weapon: ItemStack): void;
    // private isAcceptibleReturnOwner(): boolean;
    isFoil(): boolean;
