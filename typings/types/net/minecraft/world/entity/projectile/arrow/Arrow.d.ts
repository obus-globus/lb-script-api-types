...
export class Arrow extends AbstractArrow {
    ...
    constructor(type: EntityType<Arrow>, level: Level)
    ...
    // private getPotionContents(): PotionContents;
    // private getPotionDurationScale(): number;
    handleEntityEvent(id: number): void;
    // private makeParticle(amount: number): void;
    setPickupItemStack(itemStack: ItemStack): void;
    // private setPotionContents(potionContents: PotionContents): void;
    tick(): void;
