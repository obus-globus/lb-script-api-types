...
import type { AbstractHurtingProjectile } from '../../../../../../net/minecraft/world/entity/projectile/hurtingprojectile/AbstractHurtingProjectile.d.ts'
...
export abstract class Fireball extends AbstractHurtingProjectile implements ItemSupplier {
    ...
    constructor(type: EntityType<Fireball>, x: number, y: number, z: number, direction: Vec3, level: Level)
    constructor(type: EntityType<Fireball>, mob: LivingEntity, direction: Vec3, level: Level)
    constructor(type: EntityType<Fireball>, level: Level)
