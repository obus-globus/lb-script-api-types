...
export abstract class ThrowableProjectile extends Projectile {
    ...
    constructor(type: EntityType<ThrowableProjectile>, x: number, y: number, z: number, level: Level)
    constructor(type: EntityType<ThrowableProjectile>, level: Level)
    // private applyInertia(): void;
    canUsePortal(ignorePassenger: boolean): boolean;
    getAirDrag(): number;
    getDefaultGravity(): number;
    // private handleFirstTickBubbleColumn(): void;
