...
export class SpawnPlacements$Data extends Record {
    private constructor(heightMap: Heightmap$Types, placement: SpawnPlacementType, predicate: (param0: EntityType<Entity>, param1: ServerLevelAccessor, param2: EntitySpawnReason, param3: BlockPos, param4: RandomSource) => boolean)
    // private heightMap: Heightmap$Types;
    // private placement: SpawnPlacementType;
    // private predicate: (param0: EntityType<Entity>, param1: ServerLevelAccessor, param2: EntitySpawnReason, param3: BlockPos, param4: RandomSource) => boolean;
    equals(o: Object | null): boolean;
    hashCode(): number;
    heightMap(): Heightmap$Types;
    placement(): SpawnPlacementType;
    predicate(): (param0: EntityType<Entity>, param1: ServerLevelAccessor, param2: EntitySpawnReason, param3: BlockPos, param4: RandomSource) => boolean;
    toString(): string;
}