...
export class Timeline$Builder extends Object {
    ...
    addModifierTrack<Value extends unknown, Argument extends unknown>(attribute: EnvironmentAttribute<Value>, modifier: AttributeModifier<Value, Argument>, builder: (param0: KeyframeTrack$Builder<Argument>) => void): Timeline$Builder;
    ...
    addTrack<Value extends unknown>(attribute: EnvironmentAttribute<Value>, builder: (param0: KeyframeTrack$Builder<Value>) => void): Timeline$Builder;
    build(): Timeline;
