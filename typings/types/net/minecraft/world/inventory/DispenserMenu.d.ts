...
export class DispenserMenu extends AbstractContainerMenu {
    ...
    constructor(containerId: number, inventory: (Object | null)[], dispenser: ItemStack[])
    // private dispenser: ItemStack[];
    add3x3GridSlots(container: ItemStack[], left: number, top: number): void;
