...
export class BrewingStandMenu extends AbstractContainerMenu {
    ...
    constructor(containerId: number, inventory: (Object | null)[], brewingStand: ItemStack[], brewingStandData: ContainerData)
    // private brewingStand: ItemStack[];
    // private brewingStandData: ContainerData;
    // private ingredientSlot: Slot;
