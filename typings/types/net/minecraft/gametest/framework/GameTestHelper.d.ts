...
export class GameTestHelper extends Object {
    ...
    assertEntityNotPresent(entityType: EntityType<any>): void;
    assertEntityNotPresent(entityType: EntityType<any>, x: number, y: number, z: number): void;
    assertEntityNotPresent(entityType: EntityType<any>, pos: BlockPos): void;
    assertEntityNotPresent(entityType: EntityType<any>, relativeAABB: AABB): void;
    assertEntityNotTouching(entityType: EntityType<any>, x: number, y: number, z: number): void;
    assertEntityPresent(entityType: EntityType<any>): void;
    assertEntityPresent(entityType: EntityType<any>, x: number, y: number, z: number): void;
    assertEntityPresent(entityType: EntityType<any>, pos: BlockPos): void;
    ...
    succeedWhenEntityPresent(entityType: EntityType<any>, pos: BlockPos): void;
