...
import type { AbstractZombieModel } from '../../../../../../net/minecraft/client/model/monster/zombie/AbstractZombieModel.d.ts'
...
export class GiantZombieModel extends AbstractZombieModel<ZombieRenderState> {
