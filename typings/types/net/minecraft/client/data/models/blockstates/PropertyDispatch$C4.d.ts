...
export class PropertyDispatch$C4<V extends unknown, T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> extends PropertyDispatch<V> {
    ...
    private constructor(property1: Property<T1>, property2: Property<T2>, property3: Property<T3>, property4: Property<T4>)
    // private property1: Property<T1>;
    // private property2: Property<T2>;
    // private property3: Property<T3>;
    // private property4: Property<T4>;
    generate(generator: Function4<T1, T2, T3, T4, V>): PropertyDispatch<V>;
    getDefinedProperties(): Property<any>[];
    select(value1: T1, value2: T2, value3: T3, value4: T4, variants: V): PropertyDispatch$C4<V, T1, T2, T3, T4>;
}