...
export class OptionInstance<T extends Object | number | string | boolean> extends Object {
    ...
    static createBoolean(paramcaptionId: string, paramtooltip: (param0: boolean) => Tooltip, paraminitialValue: boolean, paramonValueUpdate: (param0: boolean) => void): OptionInstance<boolean>;
    static createBoolean(paramcaptionId: string, paramtooltip: (param0: boolean) => Tooltip, paramtoString: OptionInstance$CaptionBasedToString<boolean>, paraminitialValue: boolean, paramonValueUpdate: (param0: boolean) => void): OptionInstance<boolean>;
    static noTooltip(): (param0: Object | null) => Tooltip;
    constructor(captionId: string, tooltip: (param0: T) => Tooltip, toString: OptionInstance$CaptionBasedToString<T>, values: OptionInstance$ValueSet<T>, initialValue: T, onValueUpdate: (param0: T) => void)
    constructor(captionId: string, tooltip: (param0: T) => Tooltip, toString: OptionInstance$CaptionBasedToString<T>, values: OptionInstance$ValueSet<T>, codec: Codec<T>, initialValue: T, onValueUpdate: (param0: T) => void)
