...
export class OptionInstance$OptionInstanceSliderButton<N extends unknown> extends AbstractOptionSliderButton implements ResettableOptionWidget {
    ...
    private constructor(options: Options, x: number, y: number, width: number, height: number, instance: OptionInstance<N>, values: OptionInstance$SliderableValueSet<N>, tooltipSupplier: (param0: N) => Tooltip, onValueChanged: (param0: N) => void, applyValueImmediately: boolean)
    ...
    // private tooltipSupplier: (param0: N) => Tooltip;
