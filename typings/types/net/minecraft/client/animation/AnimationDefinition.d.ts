...
export class AnimationDefinition extends Record {
    constructor(lengthInSeconds: number, looping: boolean, boneAnimations: JavaMap<string, AnimationChannel[]>)
    // private boneAnimations: JavaMap<string, AnimationChannel[]>;
    // private lengthInSeconds: number;
    // private looping: boolean;
    bake(root: ModelPart): KeyframeAnimation;
    boneAnimations(): JavaMap<string, AnimationChannel[]>;
