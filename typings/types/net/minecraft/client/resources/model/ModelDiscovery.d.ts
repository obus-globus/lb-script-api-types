...
export class ModelDiscovery extends Object {
    constructor(unbakedModels: JavaMap<Identifier, UnbakedModel>, missingUnbakedModel: UnbakedModel)
    // private missingModel: ModelDiscovery$ModelWrapper;
    // private modelWrappers: JavaMap<Identifier, ModelDiscovery$ModelWrapper>;
    ...
    resolve(): JavaMap<Identifier, ResolvedModel>;
}