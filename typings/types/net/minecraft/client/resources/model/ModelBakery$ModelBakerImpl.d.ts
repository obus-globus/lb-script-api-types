...
import type { ModelBakery } from '../../../../../net/minecraft/client/resources/model/ModelBakery.d.ts'
...
export class ModelBakery$ModelBakerImpl extends Object implements ModelBaker {
    private constructor(null_: ModelBakery, materials: MaterialBaker, interner: ModelBaker$Interner, missingModels: ModelBakery$MissingModels)
