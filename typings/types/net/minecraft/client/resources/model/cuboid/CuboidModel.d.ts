...
export class CuboidModel extends Record implements CuboidModelAccessor, UnbakedModel {
    ...
    constructor(geometry: (param0: TextureSlots, param1: ModelBaker, param2: ModelState, param3: () => kotlin.String) => net.minecraft.client.resources.model.geometry.QuadCollection, guiLight: UnbakedModel$GuiLight, ambientOcclusion: boolean, transforms: ItemTransforms, textureSlots: TextureSlots$Data, parent: Identifier)
    // private ambientOcclusion: boolean;
    // private geometry: (param0: TextureSlots, param1: ModelBaker, param2: ModelState, param3: () => kotlin.String) => net.minecraft.client.resources.model.geometry.QuadCollection;
