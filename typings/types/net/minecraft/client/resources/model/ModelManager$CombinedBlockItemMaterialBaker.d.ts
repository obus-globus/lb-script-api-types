...
export class ModelManager$CombinedBlockItemMaterialBaker extends MaterialBaker implements FabricMaterialBaker {
    constructor(blockAtlas: SpriteLoader$Preparations, itemAtlas: SpriteLoader$Preparations)
    // private blockAtlas: SpriteLoader$Preparations;
    // private itemAtlas: SpriteLoader$Preparations;
