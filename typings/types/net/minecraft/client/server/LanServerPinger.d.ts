...
export class LanServerPinger extends Thread {
    ...
    static createPingString(parammotd: string, paramaddress: string): string;
    ...
    static parseAddress(parampingString: string): string;
    static parseMotd(parampingString: string): string;
