...
export class ChatComponent$DrawingBackgroundGraphicsAccess extends Object implements ChatComponent$ChatGraphicsAccess {
    constructor(graphics: GuiGraphicsExtractor)
