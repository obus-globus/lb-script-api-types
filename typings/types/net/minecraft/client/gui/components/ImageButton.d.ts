...
export class ImageButton extends Button {
    ...
    constructor(x: number, y: number, width: number, height: number, sprites: WidgetSprites, onPress: Button$OnPress)
    constructor(x: number, y: number, width: number, height: number, sprites: WidgetSprites, onPress: Button$OnPress, message: Component)
    constructor(width: number, height: number, sprites: WidgetSprites, onPress: Button$OnPress, message: Component)
