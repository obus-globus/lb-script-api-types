...
export abstract class ContainerObjectSelectionList$Entry<E extends ContainerObjectSelectionList$Entry<E>> extends AbstractSelectionList$Entry<E> implements ContainerEventHandler {
    ...
    focusPathAtIndex(navigationEvent: FocusNavigationEvent, currentIndex: number): ComponentPath;
