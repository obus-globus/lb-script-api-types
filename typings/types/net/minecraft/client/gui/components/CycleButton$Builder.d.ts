...
export class CycleButton$Builder<T extends Object | number | string | boolean> extends Object {
    ...
    create(x: number, y: number, width: number, height: number, name: Component, valueChangeListener: (param0: T, param1: CycleButton<Object>) => void): CycleButton<T>;
    create(name: Component, valueChangeListener: (param0: T, param1: CycleButton<Object>) => void): CycleButton<T>;
    ...
    withSprite(spriteSupplier: (param0: T, param1: CycleButton<Object>) => net.minecraft.resources.Identifier): CycleButton$Builder<T>;
    withTooltip(tooltipSupplier: (param0: T) => net.minecraft.client.gui.components.Tooltip): CycleButton$Builder<T>;
    withValues(altCondition: () => kotlin.Boolean, values: T[], altValues: T[]): CycleButton$Builder<T>;
    withValues(values: T[]): CycleButton$Builder<T>;
    withValues(values: E[]): CycleButton$Builder<T>;
