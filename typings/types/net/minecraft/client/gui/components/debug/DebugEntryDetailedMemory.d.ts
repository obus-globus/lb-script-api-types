import type { MemoryMXBean } from '../../../../../../java/lang/management/MemoryMXBean.d.ts'
...
export class DebugEntryDetailedMemory extends Object implements DebugScreenEntry {
    constructor()
    // private memoryBean: MemoryMXBean;
