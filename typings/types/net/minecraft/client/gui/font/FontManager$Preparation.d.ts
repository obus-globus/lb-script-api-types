...
export class FontManager$Preparation extends Record {
    private constructor(fontSets: JavaMap<Identifier, GlyphProvider$Conditional[]>, allProviders: GlyphProvider[])
    // private allProviders: GlyphProvider[];
    // private fontSets: JavaMap<Identifier, GlyphProvider$Conditional[]>;
    allProviders(): GlyphProvider[];
    equals(o: Object | null): boolean;
    fontSets(): JavaMap<Identifier, GlyphProvider$Conditional[]>;
    hashCode(): number;
    toString(): string;
}