...
export class AbstractGameRulesScreen$IntegerRuleEntry extends AbstractGameRulesScreen$GameRuleEntry {
    ...
    constructor(null_: AbstractGameRulesScreen, label: Component, tooltip: (param0: (param0: number, param1: Style, param2: number) => boolean) => boolean[], narration: string, gameRule: GameRule<number>)
