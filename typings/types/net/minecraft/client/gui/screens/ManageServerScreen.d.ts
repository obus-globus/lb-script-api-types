...
export class ManageServerScreen extends Screen {
    ...
    constructor(lastScreen: Screen, title: Component, callback: (param0: boolean) => void, serverData: ServerData)
    ...
    // private viaFabricPlus$addressField: string;
