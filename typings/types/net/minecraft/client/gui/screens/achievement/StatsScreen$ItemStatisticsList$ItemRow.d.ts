...
import type { StatsScreen$ItemStatisticsList } from '../../../../../../net/minecraft/client/gui/screens/achievement/StatsScreen$ItemStatisticsList.d.ts'
...
export class StatsScreen$ItemStatisticsList$ItemRow extends StatsScreen$ItemStatisticsList$Entry {
    ...
    private constructor(null_: StatsScreen$ItemStatisticsList, item: Item)
    // private item: Item;
