...
import type { MerchantScreen } from '../../../../../../net/minecraft/client/gui/screens/inventory/MerchantScreen.d.ts'
...
export class MerchantScreen$TradeOfferButton extends Button$Plain {
    ...
    constructor(null_: MerchantScreen, x: number, y: number, index: number, onPress: Button$OnPress)
