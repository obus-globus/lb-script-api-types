...
export class FriendsListConfirmScreen extends ConfirmScreen {
    ...
    constructor(callback: (param0: boolean) => void, title: Component, message: Component, yesButton: Component, noButton: Component)
