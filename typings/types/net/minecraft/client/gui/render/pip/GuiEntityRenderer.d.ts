...
export class GuiEntityRenderer extends PictureInPictureRenderer<GuiEntityRenderState> {
    constructor(bufferSource: MultiBufferSource$BufferSource, entityRenderDispatcher: EntityRenderDispatcher)
    ...
    renderToTexture(entityState: GuiEntityRenderState, poseStack: PoseStack): void;
}