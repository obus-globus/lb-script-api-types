import type { BeaconRenderState$Section } from '../../../../../../net/minecraft/client/renderer/blockentity/state/BeaconRenderState$Section.d.ts'
...
export class BeaconRenderState extends BlockEntityRenderState {
    ...
    sections: BeaconRenderState$Section[];
}