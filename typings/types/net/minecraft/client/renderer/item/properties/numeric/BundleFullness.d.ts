...
export class BundleFullness extends Record implements RangeSelectItemModelProperty {
    static MAP_CODEC: MapCodec<BundleFullness>;
    constructor()
    equals(o: Object | null): boolean;
    get(itemStack: ItemStack, level: ClientLevel, owner: ItemOwner, seed: number): number;
    hashCode(): number;
    toString(): string;
    type(): MapCodec<BundleFullness>;
}