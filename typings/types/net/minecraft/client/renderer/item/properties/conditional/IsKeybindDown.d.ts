...
export class IsKeybindDown extends Record implements ConditionalItemModelProperty {
    static MAP_CODEC: MapCodec<IsKeybindDown>;
    constructor(keybind: KeyMapping)
    // private keybind: KeyMapping;
    equals(o: Object | null): boolean;
    get(itemStack: ItemStack, level: ClientLevel, owner: LivingEntity, seed: number, displayContext: ItemDisplayContext): boolean;
    hashCode(): number;
    keybind(): KeyMapping;
    toString(): string;
    type(): MapCodec<IsKeybindDown>;
}