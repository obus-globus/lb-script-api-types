...
export class AtmosphericFogEnvironment extends FogEnvironment {
    constructor()
    // private rainFogMultiplier: number;
    ...
    // private updateRainFogState(camera: Camera, level: ClientLevel, deltaTracker: DeltaTracker): void;
}