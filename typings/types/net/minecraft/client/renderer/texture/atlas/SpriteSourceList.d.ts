...
export class SpriteSourceList extends Object {
    ...
    list(resourceManager: ResourceManager): (param0: (param0: Identifier, param1: Resource) => net.minecraft.client.renderer.texture.SpriteContents) => net.minecraft.client.renderer.texture.SpriteContents[];
}