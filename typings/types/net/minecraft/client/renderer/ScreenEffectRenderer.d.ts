...
export class ScreenEffectRenderer extends Object {
    ...
    constructor(minecraft: Minecraft, sprites: SpriteGetter)
    ...
    submit(isFirstPerson: boolean, isSleeping: boolean, partialTicks: number, submitNodeCollector: SubmitNodeCollector, hideGui: boolean): void;
    tick(): void;
}