...
export class SubmitNodeCollection extends Object implements OrderedSubmitNodeCollector {
    constructor()
    afterTerrain: SimpleFeatureRenderPhase;
    // private allPhases: FeatureRenderPhase<any>[];
    alwaysOnTop: SimpleFeatureRenderPhase;
    breakingOverlay: SimpleFeatureRenderPhase;
    gizmos: SimpleFeatureRenderPhase;
    nameTags: SimpleFeatureRenderPhase;
    outline: SimpleFeatureRenderPhase;
    seeThroughNameTags: TranslucentFeatureRenderPhase;
    shadows: SimpleFeatureRenderPhase;
    shapeOutlines: SimpleFeatureRenderPhase;
    solid: SimpleFeatureRenderPhase;
    texts: SimpleFeatureRenderPhase;
    translucentBlocksAndItems: TranslucentFeatureRenderPhase;
    translucentCustomGeometry: SimpleFeatureRenderPhase;
    translucentModels: TranslucentFeatureRenderPhase;
    waterMask: SimpleFeatureRenderPhase;
    allPhases(): FeatureRenderPhase<any>[];
    ...
    // private submitCustomGeometry$mixinextras$wrapped$43(arg0: PoseStack, arg1: RenderType, arg2: SubmitNodeCollector$CustomGeometryRenderer): void;
    ...
    // private submitModel$mixinextras$wrapped$41(arg0: Model<Object>, arg1: Object, arg2: PoseStack, arg3: RenderType, arg4: number, arg5: number, arg6: number, arg7: TextureAtlasSprite, arg8: number, arg9: ModelFeatureRenderer$CrumblingOverlay): void;
