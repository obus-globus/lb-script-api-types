...
export class QuadParticleFeatureRenderer$PreparedGroup extends Record {
    private constructor(layers: JavaMap<SingleQuadParticle$Layer, StagedVertexBuffer$Draw>, translucent: boolean)
    // private layers: JavaMap<SingleQuadParticle$Layer, StagedVertexBuffer$Draw>;
    // private translucent: boolean;
    equals(o: Object | null): boolean;
    hashCode(): number;
    layers(): JavaMap<SingleQuadParticle$Layer, StagedVertexBuffer$Draw>;
    toString(): string;
    translucent(): boolean;
}