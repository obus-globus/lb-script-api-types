...
export class ModelFeatureRenderer extends Object {
    ...
    // private renderModel<S extends unknown>(submit: SubmitNodeStorage$ModelSubmit<S>, renderType: RenderType, buffer: VertexConsumer, outlineBufferSource: OutlineBufferSource, crumblingBufferSource: MultiBufferSource$BufferSource): void;
