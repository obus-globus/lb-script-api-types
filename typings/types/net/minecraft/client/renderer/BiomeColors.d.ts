...
export class BiomeColors extends Object {
    static DRY_FOLIAGE_COLOR_RESOLVER: (param0: Biome, param1: number, param2: number) => kotlin.Int;
    static FOLIAGE_COLOR_RESOLVER: (param0: Biome, param1: number, param2: number) => kotlin.Int;
    static GRASS_COLOR_RESOLVER: (param0: Biome, param1: number, param2: number) => kotlin.Int;
    static WATER_COLOR_RESOLVER: (param0: Biome, param1: number, param2: number) => kotlin.Int;
