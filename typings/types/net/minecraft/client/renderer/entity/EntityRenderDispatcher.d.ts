...
export class EntityRenderDispatcher extends Object implements FabricResourceReloader, ResourceManagerReloadListener {
    ...
    // private renderers: Map<EntityType<Object>, EntityRenderer<Object, Object>>;
    ...
    getRenderer<S extends EntityRenderState>(entityRenderState: S): EntityRenderer<Object, S>;
