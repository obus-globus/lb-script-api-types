...
export class ServerNameResolver extends Object {
    ...
    constructor(resolver: (param0: ServerAddress) => java.util.Optional<net.minecraft.client.multiplayer.resolver.ResolvedServerAddress>, redirectHandler: (param0: ServerAddress) => java.util.Optional<net.minecraft.client.multiplayer.resolver.ServerAddress>, addressCheck: AddressCheck)
    // private addressCheck: AddressCheck;
    redirectHandler: (param0: ServerAddress) => java.util.Optional<net.minecraft.client.multiplayer.resolver.ServerAddress>;
    // private resolver: (param0: ServerAddress) => java.util.Optional<net.minecraft.client.multiplayer.resolver.ResolvedServerAddress>;
