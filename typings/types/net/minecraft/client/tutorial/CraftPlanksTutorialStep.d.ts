...
export class CraftPlanksTutorialStep extends Object implements TutorialStepInstance {
    static hasCraftedPlanksPreviously(paramplayer: LocalPlayer, paramtag: TagKey<Item>): boolean;
