...
export class IntersectionIterator<T extends Object | number | string | boolean> extends AbstractIterator<T> {
    constructor(firstIterator: Iterator<T>, secondIterator: Iterator<T>, comparator: (param0: T) => kotlin.Boolean)
