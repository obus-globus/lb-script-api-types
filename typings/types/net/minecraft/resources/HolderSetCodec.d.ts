...
export class HolderSetCodec<E extends Object | number | string | boolean> extends Object implements Codec<Holder<T>[]> {
    ...
    static create(paramregistryKey: ResourceKey<Object>, paramelementCodec: Codec<Object>, paramalwaysUseList: boolean): Codec<Object>;
    ...
    private constructor(registryKey: ResourceKey<E[]>, elementCodec: Codec<Holder<E>>, alwaysUseList: boolean)
    // private elementCodec: Codec<Holder<E>>;
    ...
    encode<T extends Object | number | string | boolean>(input: Holder<T>[], ops: DynamicOps<T>, prefix: T): DataResult<T>;
    // private encodeWithoutRegistry<T extends Object | number | string | boolean>(input: Holder<T>[], ops: DynamicOps<T>, prefix: T): DataResult<T>;
