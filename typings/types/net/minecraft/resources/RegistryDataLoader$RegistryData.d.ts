...
export class RegistryDataLoader$RegistryData<T extends unknown> extends Record {
    constructor(key: ResourceKey<T[]>, elementCodec: Codec<T>, validator: (param0: T[], param1: JavaMap<ResourceKey<Object>, Exception>) => void)
    // private elementCodec: Codec<T>;
    // private key: ResourceKey<T[]>;
    // private validator: (param0: T[], param1: JavaMap<ResourceKey<Object>, Exception>) => void;
    ...
    toString(): string;
    validator(): (param0: T[], param1: JavaMap<ResourceKey<Object>, Exception>) => void;
}