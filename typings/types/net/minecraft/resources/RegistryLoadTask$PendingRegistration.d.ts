...
export class RegistryLoadTask$PendingRegistration<T extends Object | number | string | boolean> extends Record {
    static findAndLoadFromResource(paramelementDecoder: Decoder<Object>, paramops: RegistryOps<JsonElement>, paramelementKey: ResourceKey<Object>, paramconverter: FileToIdConverter, paramresourceProvider: (param0: Identifier) => java.util.Optional<net.minecraft.server.packs.resources.Resource>): Either<Object, Exception>;
