...
export class RegistryFixedCodec<E extends Object | number | string | boolean> extends Object implements Codec<Holder<E>> {
    ...
    static create(paramregistryKey: ResourceKey<(Object | null)[]>): RegistryFixedCodec<Object>;
