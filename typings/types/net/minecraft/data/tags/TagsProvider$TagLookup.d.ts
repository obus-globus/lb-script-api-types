...
export interface TagsProvider$TagLookup<T extends Object | number | string | boolean> extends Function<TagKey<T>, Optional<TagBuilder>>, Object {
    andThen<V extends Object | number | string | boolean>(arg0: (param0: Optional<TagBuilder>) => V): (param0: TagKey<T>) => V;
    compose<V extends Object | number | string | boolean>(arg0: (param0: V) => TagKey<T>): (param0: V) => Optional<TagBuilder>;
