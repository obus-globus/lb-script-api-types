...
export abstract class IntrinsicHolderTagsProvider<T extends Object | number | string | boolean> extends TagsProvider<T> {
    static FIXED_ORDER_FIELDS: (param0: string) => kotlin.Int;
    static KEY_COMPARATOR: (param0: string) => kotlin.Boolean;
    static LOGGER: Logger;
    constructor(output: PackOutput, registryKey: ResourceKey<T[]>, lookupProvider: CompletableFuture<HolderLookup$Provider>, parentProvider: CompletableFuture<(param0: T) => unknown>, keyExtractor: (param0: T) => ResourceKey<T>)
