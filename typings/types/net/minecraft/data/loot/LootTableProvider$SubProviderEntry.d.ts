...
export class LootTableProvider$SubProviderEntry extends Record {
    constructor(provider: (param0: HolderLookup$Provider) => (param0: (param0: ResourceKey<LootTable>, param1: LootTable$Builder) => void) => void, paramSet: ContextKeySet)
    // private paramSet: ContextKeySet;
    // private provider: (param0: HolderLookup$Provider) => (param0: (param0: ResourceKey<LootTable>, param1: LootTable$Builder) => void) => void;
    equals(o: Object | null): boolean;
    hashCode(): number;
    paramSet(): ContextKeySet;
    provider(): (param0: HolderLookup$Provider) => (param0: (param0: ResourceKey<LootTable>, param1: LootTable$Builder) => void) => void;
    toString(): string;
}