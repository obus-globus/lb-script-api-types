...
export class SimpleCookingRecipeBuilder extends Object implements RecipeBuilder {
    ...
    private constructor(craftingCategory: RecipeCategory, cookingCategory: CookingBookCategory, result: ItemStackTemplate, ingredient: Ingredient, experience: number, cookingTime: number, factory: (param0: Recipe$CommonInfo, param1: AbstractCookingRecipe$CookingBookInfo, param2: Ingredient, param3: ItemStackTemplate, param4: number, param5: number) => unknown)
    private constructor(craftingCategory: RecipeCategory, cookingCategory: CookingBookCategory, result: ItemLike, ingredient: Ingredient, experience: number, cookingTime: number, factory: (param0: Recipe$CommonInfo, param1: AbstractCookingRecipe$CookingBookInfo, param2: Ingredient, param3: ItemStackTemplate, param4: number, param5: number) => unknown)
    ...
    // private factory: (param0: Recipe$CommonInfo, param1: AbstractCookingRecipe$CookingBookInfo, param2: Ingredient, param3: ItemStackTemplate, param4: number, param5: number) => unknown;
