...
export class GsonHelper extends Object {
    ...
    static convertToObject<T extends unknown>(paramelement: JsonElement, paramname: string, paramcontext: JsonDeserializationContext, paramclazz: Class<T>): T;
    ...
    static fromJson<T extends unknown>(paramgson: Gson, paramreader: Reader, paramtype: TypeToken<T>): T;
    static fromJson<T extends unknown>(paramgson: Gson, paramreader: Reader, paramtype: Class<T>): T;
    static fromJson<T extends unknown>(paramgson: Gson, paramstring: string, paramtype: Class<T>): T;
    static fromNullableJson<T extends unknown>(paramgson: Gson, paramreader: Reader, paramtype: TypeToken<T>): T;
    static fromNullableJson<T extends unknown>(paramgson: Gson, paramstring: string, paramtype: TypeToken<T>): T;
    ...
    static getAsObject<T extends unknown>(paramobject: JsonObject, paramname: string, paramdef: T, paramcontext: JsonDeserializationContext, paramclazz: Class<T>): T;
    static getAsObject<T extends unknown>(paramobject: JsonObject, paramname: string, paramcontext: JsonDeserializationContext, paramclazz: Class<T>): T;
