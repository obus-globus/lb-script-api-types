...
export class BlockUtil extends Object {
    static getLargestRectangleAround(paramcenter: BlockPos, paramaxis1: Direction$Axis, paramlimit1: number, paramaxis2: Direction$Axis, paramlimit2: number, paramtest: (param0: BlockPos) => kotlin.Boolean): BlockUtil$FoundRectangle;
