...
export interface Rule$SimpleRuleAction<S extends Object | number | string | boolean, T extends Object | number | string | boolean> extends Object, Rule$RuleAction<S, T>{
