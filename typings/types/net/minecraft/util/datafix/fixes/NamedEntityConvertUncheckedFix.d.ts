...
export class NamedEntityConvertUncheckedFix extends NamedEntityFix {
    ...
    constructor(outputSchema: Schema, name: string, type: DSL$TypeReference, entityName: string)
