...
import type { CompoundList$CompoundListType } from '../../../../../com/mojang/datafixers/types/templates/CompoundList$CompoundListType.d.ts'
...
export class NewVillageFix extends DataFix {
    ...
    // private cap(startsType: CompoundList$CompoundListType<string, SF>): TypeRewriteRule;
