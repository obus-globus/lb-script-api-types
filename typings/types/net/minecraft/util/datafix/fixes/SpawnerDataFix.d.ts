...
export class SpawnerDataFix extends DataFix {
    ...
    // private wrapEntityToSpawnData(newType: Type<T>, spawnData: Typed<Object>): Typed<T>;
    // private wrapSpawnPotentialsToWeightedEntries(newType: Type<T>, spawnPotentials: Typed<Object>): Typed<T>;
}