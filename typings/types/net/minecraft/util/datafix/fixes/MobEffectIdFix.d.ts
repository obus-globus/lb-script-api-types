...
export class MobEffectIdFix extends DataFix {
    ...
    // private blockEntityFixer(): TypeRewriteRule;
    // private entityFixer(): TypeRewriteRule;
    // private itemStackFixer(): TypeRewriteRule;
    makeRule(): TypeRewriteRule;
    // private playerFixer(): TypeRewriteRule;
    // private updateNamedChoice(input: Typed<Object>, typeReference: DSL$TypeReference, name: string, function_: (param0: Dynamic<Object>) => Dynamic<Object>): Typed<Object>;
}