...
export class RenameEnchantmentsFix extends DataFix {
    ...
    constructor(outputSchema: Schema, name: string, renames: JavaMap<string, string>)
    // private name: string;
    // private renames: JavaMap<string, string>;
    // private fixEnchantmentList(itemStack: Dynamic<Object>, field: string): Dynamic<Object>;
    // private fixTag(tag: Dynamic<Object>): Dynamic<Object>;
