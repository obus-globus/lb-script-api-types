...
import type { AttributesRenameFix } from '../../../../../net/minecraft/util/datafix/fixes/AttributesRenameFix.d.ts'
export class RenameNameplateToNameTagFix extends AttributesRenameFix {
