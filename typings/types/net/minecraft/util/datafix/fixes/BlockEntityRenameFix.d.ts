...
export class BlockEntityRenameFix extends DataFix {
    ...
    static create(paramoutputSchema: Schema, paramname: string, paramnameChangeLookup: (param0: string) => string): DataFix;
    private constructor(outputSchema: Schema, name: string, nameChangeLookup: (param0: string) => string)
    // private name: string;
    // private nameChangeLookup: (param0: string) => string;
