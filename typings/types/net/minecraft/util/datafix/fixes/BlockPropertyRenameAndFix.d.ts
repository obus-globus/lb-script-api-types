...
export class BlockPropertyRenameAndFix extends AbstractBlockPropertyFix {
    ...
    constructor(outputSchema: Schema, name: string, blockId: string, oldPropertyName: string, newPropertyName: string, valueFixer: (param0: string) => unknown)
    // private blockId: string;
    // private newPropertyName: string;
    // private oldPropertyName: string;
    // private valueFixer: (param0: string) => unknown;
    fixProperties(blockId: string, properties: Dynamic<T>): Dynamic<T>;
