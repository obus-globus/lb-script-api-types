...
export class CriteriaRenameFix extends DataFix {
    ...
    constructor(outputSchema: Schema, name: string, advancementId: string, conversions: (param0: string) => Object | null)
    // private advancementId: string;
    // private conversions: (param0: string) => Object | null;
    // private name: string;
    // private fixAdvancements(tag: Dynamic<Object>): Dynamic<Object>;
