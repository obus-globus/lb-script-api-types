...
export class LevelDebugSynchronizers extends Object {
    ...
    clearBlockValue<T extends unknown>(blockPos: BlockPos, subscription: DebugSubscription<T>): void;
    clearEntityValue<T extends unknown>(entity: Entity, subscription: DebugSubscription<T>): void;
    ...
    // private getSourceSynchronizer<T extends unknown>(subscription: DebugSubscription<T>): TrackingDebugSynchronizer$SourceSynchronizer<T>;
    ...
    sendBlockValue<T extends unknown>(blockPos: BlockPos, subscription: DebugSubscription<T>, value: T): void;
    sendEntityValue<T extends unknown>(entity: Entity, subscription: DebugSubscription<T>, value: T): void;
