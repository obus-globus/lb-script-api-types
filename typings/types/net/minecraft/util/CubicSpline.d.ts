...
export interface CubicSpline<C extends Object | number | string | boolean, I extends BoundedFloatFunction<C>> extends Object, BoundedFloatFunction<C> {
    comap<C2 extends Object | number | string | boolean>(function_: (param0: C2) => C): BoundedFloatFunction<C2>;
