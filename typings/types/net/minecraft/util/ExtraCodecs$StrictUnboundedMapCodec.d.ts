...
export class ExtraCodecs$StrictUnboundedMapCodec<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends Record implements Codec<Map<K, V>>, BaseMapCodec<K, V> {
    ...
    decode<T extends Object | number | string | boolean>(ops: DynamicOps<T>, input: T): DataResult<Pair<Map<K, V>, T>>;
    decode<T extends Object | number | string | boolean>(ops: DynamicOps<T>, input: MapLike<T>): DataResult<Map<K, V>>;
