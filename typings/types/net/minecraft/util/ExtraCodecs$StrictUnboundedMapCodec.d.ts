...
export class ExtraCodecs$StrictUnboundedMapCodec<K extends unknown, V extends unknown> extends Record implements Codec<Map<K, V>>, BaseMapCodec<K, V> {
    ...
    decode<T extends unknown>(ops: DynamicOps<T>, input: T): DataResult<Pair<Map<K, V>, T>>;
    decode<T extends unknown>(ops: DynamicOps<T>, input: MapLike<T>): DataResult<Map<K, V>>;
    ...
    encode<T extends unknown>(input: Map<K, V>, ops: DynamicOps<T>, prefix: T): DataResult<T>;
