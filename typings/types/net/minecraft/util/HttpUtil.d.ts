...
export class HttpUtil extends Object {
    static downloadFile(paramtargetDir: Path, paramurl: URL, paramheaders: JavaMap<string, string>, paramhashFunction: HashFunction, paramrequestedHash: HashCode, parammaxSize: number, paramproxy: Proxy, paramlistener: HttpUtil$DownloadProgressListener): Path;
