...
export class ParallelMapTransform$BatchedTaskSplitter<K extends Object | number | string | boolean, U extends Object | number | string | boolean, V extends Object | number | string | boolean> extends ParallelMapTransform$SplitterBase<K, U, V> {
    private constructor(operation: (param0: K, param1: U) => V, size: number, maxTasks: number)
    // private batchSize: number;
    // private firstUndersizedBatchIndex: number;
    // private result: Map<K, V>;
