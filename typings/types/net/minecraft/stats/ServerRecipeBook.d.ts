...
export class ServerRecipeBook extends RecipeBook {
    ...
    constructor(displayResolver: (param0: ResourceKey<Recipe<Object>>, param1: (param0: RecipeDisplayEntry) => void) => void)
    // private displayResolver: (param0: ResourceKey<Recipe<Object>>, param1: (param0: RecipeDisplayEntry) => void) => void;
    ...
    addRecipes(recipes: RecipeHolder<Object>[], player: ServerPlayer): number;
    ...
    // private loadRecipes(recipes: ResourceKey<Recipe<Object>>[], recipeAddingMethod: (param0: ResourceKey<Recipe<Object>>) => void, validator: (param0: ResourceKey<Recipe<Object>>) => boolean): void;
    loadUntrusted(packed: ServerRecipeBook$Packed, validator: (param0: ResourceKey<Recipe<Object>>) => boolean): void;
    pack(): ServerRecipeBook$Packed;
    remove(id: ResourceKey<Recipe<Object>>): void;
    removeHighlight(id: ResourceKey<Recipe<Object>>): void;
    removeRecipes(recipes: RecipeHolder<Object>[], player: ServerPlayer): number;
