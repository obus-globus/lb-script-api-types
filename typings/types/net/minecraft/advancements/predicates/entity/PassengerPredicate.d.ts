...
export class PassengerPredicate extends Record implements EntitySubPredicate {
    static ALWAYS_TRUE: EntitySubPredicate;
    static CODEC: Codec<PassengerPredicate>;
    constructor(passenger: EntityPredicate)
    // private passenger: EntityPredicate;
