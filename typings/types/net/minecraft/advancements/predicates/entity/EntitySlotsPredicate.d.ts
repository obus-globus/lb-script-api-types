...
export class EntitySlotsPredicate extends Record implements EntitySubPredicate {
    static ALWAYS_TRUE: EntitySubPredicate;
    static CODEC: Codec<EntitySlotsPredicate>;
    constructor(slots: SlotsPredicate)
    // private slots: SlotsPredicate;
