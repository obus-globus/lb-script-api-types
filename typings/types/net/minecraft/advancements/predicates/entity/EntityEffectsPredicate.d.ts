...
export class EntityEffectsPredicate extends Record implements EntitySubPredicate {
    static ALWAYS_TRUE: EntitySubPredicate;
    static CODEC: Codec<EntityEffectsPredicate>;
    constructor(effects: MobEffectsPredicate)
    // private effects: MobEffectsPredicate;
