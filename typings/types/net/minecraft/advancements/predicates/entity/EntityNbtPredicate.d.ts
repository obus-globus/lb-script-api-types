...
export class EntityNbtPredicate extends Record implements EntitySubPredicate {
    static ALWAYS_TRUE: EntitySubPredicate;
    static CODEC: Codec<EntityNbtPredicate>;
    constructor(nbt: NbtPredicate)
    // private nbt: NbtPredicate;
