...
export class TargetedEntityPredicate extends Record implements EntitySubPredicate {
    static ALWAYS_TRUE: EntitySubPredicate;
    static CODEC: Codec<TargetedEntityPredicate>;
    constructor(targetedEntity: EntityPredicate)
    // private targetedEntity: EntityPredicate;
    and(other: EntitySubPredicate): EntitySubPredicate;
    equals(o: Object | null): boolean;
    hashCode(): number;
    matches(entity: Entity, level: ServerLevel, position: Vec3): boolean;
    targetedEntity(): EntityPredicate;
    toString(): string;
}