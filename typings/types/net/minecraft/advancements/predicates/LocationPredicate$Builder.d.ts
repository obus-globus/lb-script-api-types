...
import type { BlockPredicate$Builder } from '../../../../net/minecraft/advancements/predicates/BlockPredicate$Builder.d.ts'
import type { FluidPredicate } from '../../../../net/minecraft/advancements/predicates/FluidPredicate.d.ts'
import type { FluidPredicate$Builder } from '../../../../net/minecraft/advancements/predicates/FluidPredicate$Builder.d.ts'
import type { LightPredicate } from '../../../../net/minecraft/advancements/predicates/LightPredicate.d.ts'
import type { LightPredicate$Builder } from '../../../../net/minecraft/advancements/predicates/LightPredicate$Builder.d.ts'
...
export class LocationPredicate$Builder extends Object {
    ...
    setBiomes(biomes: Holder<Biome>[]): LocationPredicate$Builder;
    ...
    setStructures(structures: Holder<Structure>[]): LocationPredicate$Builder;
