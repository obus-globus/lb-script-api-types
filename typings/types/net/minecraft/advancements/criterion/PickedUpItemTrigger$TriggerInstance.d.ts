...
export class PickedUpItemTrigger$TriggerInstance extends Record implements SimpleCriterionTrigger$SimpleInstance {
    ...
    static thrownItemPickedUpByEntity(paramplayer: ContextAwarePredicate, paramitem: Optional<ItemPredicate>, paramentity: Optional<ContextAwarePredicate>): Criterion<PickedUpItemTrigger$TriggerInstance>;
