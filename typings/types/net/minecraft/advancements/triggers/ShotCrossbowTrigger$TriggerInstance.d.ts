...
export class ShotCrossbowTrigger$TriggerInstance extends Record implements SimpleCriterionTrigger$SimpleInstance {
    ...
    static shotCrossbow(paramitem: Optional<ItemPredicate>): Criterion<ShotCrossbowTrigger$TriggerInstance>;
    static shotCrossbow(paramitems: HolderGetter<Item>, paramitemlike: ItemLike): Criterion<ShotCrossbowTrigger$TriggerInstance>;
