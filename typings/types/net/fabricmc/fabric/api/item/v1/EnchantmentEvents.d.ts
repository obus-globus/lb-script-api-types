...
import type { EnchantmentEvents$ModifyWithLookup } from '../../../../../../net/fabricmc/fabric/api/item/v1/EnchantmentEvents$ModifyWithLookup.d.ts'
...
export class EnchantmentEvents extends Object {
    static ALLOW_ENCHANTING: Event<(param0: Holder<Enchantment>, param1: ItemStack, param2: EnchantingContext) => TriState>;
    static MODIFY: Event<(param0: ResourceKey<Enchantment>, param1: Enchantment$Builder, param2: EnchantmentSource) => void>;
    static MODIFY_WITH_LOOKUP: Event<(param0: ResourceKey<Enchantment>, param1: Enchantment$Builder, param2: EnchantmentSource, param3: RegistryOps$RegistryInfoLookup) => void>;
    private constructor()
}