...
export class FabricDefaultAttributeRegistry extends Object {
    static register(paramarg0: EntityType<LivingEntity>, paramarg1: AttributeSupplier$Builder): void;
    static register(paramarg0: EntityType<LivingEntity>, paramarg1: AttributeSupplier): void;
    private constructor()
}