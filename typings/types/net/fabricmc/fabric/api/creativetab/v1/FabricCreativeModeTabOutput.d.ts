...
export class FabricCreativeModeTabOutput extends Object implements CreativeModeTab$Output {
    ...
    // private getEnabledStacks(arg0: E[]): E[];
    getSearchTabStacks(): ItemStack[];
    insertAfter(arg0: (param0: ItemStack) => kotlin.Boolean, arg1: E[], arg2: CreativeModeTab$TabVisibility): void;
    insertAfter(arg0: ItemStack, arg1: ItemStack[]): void;
    insertAfter(arg0: ItemStack, arg1: ItemLike[]): void;
    insertAfter(arg0: ItemStack, arg1: E[]): void;
    insertAfter(arg0: ItemStack, arg1: E[], arg2: CreativeModeTab$TabVisibility): void;
    insertAfter(arg0: ItemLike, arg1: ItemStack[]): void;
    insertAfter(arg0: ItemLike, arg1: ItemLike[]): void;
    insertAfter(arg0: ItemLike, arg1: E[]): void;
    insertAfter(arg0: ItemLike, arg1: E[], arg2: CreativeModeTab$TabVisibility): void;
    insertBefore(arg0: (param0: ItemStack) => kotlin.Boolean, arg1: E[], arg2: CreativeModeTab$TabVisibility): void;
    insertBefore(arg0: ItemStack, arg1: ItemStack[]): void;
    insertBefore(arg0: ItemStack, arg1: ItemLike[]): void;
    insertBefore(arg0: ItemStack, arg1: E[]): void;
    insertBefore(arg0: ItemStack, arg1: E[], arg2: CreativeModeTab$TabVisibility): void;
    insertBefore(arg0: ItemLike, arg1: ItemStack[]): void;
    insertBefore(arg0: ItemLike, arg1: ItemLike[]): void;
    insertBefore(arg0: ItemLike, arg1: E[]): void;
    insertBefore(arg0: ItemLike, arg1: E[], arg2: CreativeModeTab$TabVisibility): void;
