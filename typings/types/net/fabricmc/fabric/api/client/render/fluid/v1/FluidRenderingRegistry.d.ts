...
export class FluidRenderingRegistry extends Object {
    ...
    static register(paramarg0: Fluid, paramarg1: Fluid, paramarg2: FluidModel$Unbaked): void;
    static register(paramarg0: Fluid, paramarg1: Fluid, paramarg2: FluidModel$Unbaked, paramarg3: FluidRenderHandler): void;
