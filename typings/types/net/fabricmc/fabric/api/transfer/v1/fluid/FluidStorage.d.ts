...
export class FluidStorage extends Object {
    static GENERAL_COMBINED_PROVIDER: Event<(param0: ContainerItemContext) => net.fabricmc.fabric.api.transfer.v1.storage.Storage<net.fabricmc.fabric.api.transfer.v1.fluid.FluidVariant>>;
    static ITEM: ItemApiLookup<Object, ContainerItemContext>;
    static SIDED: BlockApiLookup<Object, Direction>;
    static combinedItemApiProvider(paramarg0: Item): Event<(param0: ContainerItemContext) => net.fabricmc.fabric.api.transfer.v1.storage.Storage<net.fabricmc.fabric.api.transfer.v1.fluid.FluidVariant>>;
    private constructor()
}