...
export class FluidStorageUtil extends Object {
    static interactWithFluidStorage(paramarg0: StorageView<FluidVariant>[], paramarg1: Player, paramarg2: InteractionHand): boolean;
    private constructor()
}