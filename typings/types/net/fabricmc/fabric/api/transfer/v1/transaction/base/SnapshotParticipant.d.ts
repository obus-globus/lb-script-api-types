...
export abstract class SnapshotParticipant<T extends Object | number | string | boolean> extends Object implements TransactionContext$CloseCallback, TransactionContext$OuterCloseCallback {
    constructor()
    // private snapshots: T[];
