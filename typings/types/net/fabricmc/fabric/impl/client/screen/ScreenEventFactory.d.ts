...
export class ScreenEventFactory extends Object {
    ...
    static createAfterMouseClickEvent(): Event<(param0: Screen, param1: MouseButtonEvent, param2: boolean) => kotlin.Boolean>;
    static createAfterMouseDragEvent(): Event<(param0: Screen, param1: MouseButtonEvent, param2: number, param3: number, param4: boolean) => kotlin.Boolean>;
    static createAfterMouseReleaseEvent(): Event<(param0: Screen, param1: MouseButtonEvent, param2: boolean) => kotlin.Boolean>;
    static createAfterMouseScrollEvent(): Event<(param0: Screen, param1: number, param2: number, param3: number, param4: number, param5: boolean) => kotlin.Boolean>;
    ...
    static createAllowKeyPressEvent(): Event<(param0: Screen, param1: KeyEvent) => kotlin.Boolean>;
    static createAllowKeyReleaseEvent(): Event<(param0: Screen, param1: KeyEvent) => kotlin.Boolean>;
    static createAllowMouseClickEvent(): Event<(param0: Screen, param1: MouseButtonEvent) => kotlin.Boolean>;
    static createAllowMouseDragEvent(): Event<(param0: Screen, param1: MouseButtonEvent, param2: number, param3: number) => kotlin.Boolean>;
    static createAllowMouseReleaseEvent(): Event<(param0: Screen, param1: MouseButtonEvent) => kotlin.Boolean>;
    static createAllowMouseScrollEvent(): Event<(param0: Screen, param1: number, param2: number, param3: number, param4: number) => kotlin.Boolean>;
