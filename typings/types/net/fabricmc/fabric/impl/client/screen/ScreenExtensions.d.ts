...
export interface ScreenExtensions extends Object{
    ...
    fabric_getAfterMouseClickEvent(): Event<(param0: Screen, param1: MouseButtonEvent, param2: boolean) => kotlin.Boolean>;
    fabric_getAfterMouseDragEvent(): Event<(param0: Screen, param1: MouseButtonEvent, param2: number, param3: number, param4: boolean) => kotlin.Boolean>;
    fabric_getAfterMouseReleaseEvent(): Event<(param0: Screen, param1: MouseButtonEvent, param2: boolean) => kotlin.Boolean>;
    fabric_getAfterMouseScrollEvent(): Event<(param0: Screen, param1: number, param2: number, param3: number, param4: number, param5: boolean) => kotlin.Boolean>;
    ...
    fabric_getAllowKeyPressEvent(): Event<(param0: Screen, param1: KeyEvent) => kotlin.Boolean>;
    fabric_getAllowKeyReleaseEvent(): Event<(param0: Screen, param1: KeyEvent) => kotlin.Boolean>;
    fabric_getAllowMouseClickEvent(): Event<(param0: Screen, param1: MouseButtonEvent) => kotlin.Boolean>;
    fabric_getAllowMouseDragEvent(): Event<(param0: Screen, param1: MouseButtonEvent, param2: number, param3: number) => kotlin.Boolean>;
    fabric_getAllowMouseReleaseEvent(): Event<(param0: Screen, param1: MouseButtonEvent) => kotlin.Boolean>;
    fabric_getAllowMouseScrollEvent(): Event<(param0: Screen, param1: number, param2: number, param3: number, param4: number) => kotlin.Boolean>;
