...
export class ModelLoadingPluginContextImpl extends Object implements ModelLoadingPlugin$Context {
    constructor()
    // private afterBakeBlockModifiers: Event<(param0: BlockStateModel, param1: ModelModifier$AfterBakeBlock$Context) => net.minecraft.client.renderer.block.dispatch.BlockStateModel>;
    // private afterBakeItemModifiers: Event<(param0: ItemModel, param1: ModelModifier$AfterBakeItem$Context) => net.minecraft.client.renderer.item.ItemModel>;
    // private beforeBakeBlockModifiers: Event<(param0: BlockStateModel$UnbakedRoot, param1: ModelModifier$BeforeBakeBlock$Context) => net.minecraft.client.renderer.block.dispatch.BlockStateModel.UnbakedRoot>;
    // private beforeBakeItemModifiers: Event<(param0: ItemModel$Unbaked, param1: ModelModifier$BeforeBakeItem$Context) => net.minecraft.client.renderer.item.ItemModel.Unbaked>;
    ...
    // private onLoadBlockModifiers: Event<(param0: BlockStateModel$UnbakedRoot, param1: ModelModifier$OnLoadBlock$Context) => net.minecraft.client.renderer.block.dispatch.BlockStateModel.UnbakedRoot>;
    // private onLoadModifiers: Event<(param0: UnbakedModel, param1: ModelModifier$OnLoad$Context) => net.minecraft.client.resources.model.UnbakedModel>;
