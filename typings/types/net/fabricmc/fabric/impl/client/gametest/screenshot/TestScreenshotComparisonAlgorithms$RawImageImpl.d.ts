...
export class TestScreenshotComparisonAlgorithms$RawImageImpl<DATA extends unknown> extends Record implements TestScreenshotComparisonAlgorithm$RawImage<DATA> {
