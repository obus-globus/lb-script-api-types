...
export class ColorResolverRegistryImpl extends Object {
    static createCustomCacheMap(paramarg0: (param0: (param0: Biome, param1: number, param2: number) => number) => BlockTintCache): Map<(param0: Biome, param1: number, param2: number) => number, BlockTintCache>;
