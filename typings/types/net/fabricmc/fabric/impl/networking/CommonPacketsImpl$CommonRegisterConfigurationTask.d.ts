...
export class CommonPacketsImpl$CommonRegisterConfigurationTask extends Record implements ConfigurationTask {
    static KEY: ConfigurationTask$Type;
    private constructor(addon: ServerConfigurationNetworkAddon)
    // private addon: ServerConfigurationNetworkAddon;
