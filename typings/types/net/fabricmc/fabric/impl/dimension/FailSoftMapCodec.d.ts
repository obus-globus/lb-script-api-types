...
export class FailSoftMapCodec<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends Record implements Codec<Map<K, V>>, BaseMapCodec<K, V> {
