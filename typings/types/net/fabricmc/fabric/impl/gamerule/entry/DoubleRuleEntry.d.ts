...
export class DoubleRuleEntry extends AbstractGameRulesScreen$GameRuleEntry {
    ...
    constructor(arg0: AbstractGameRulesScreen, arg1: Component, arg2: (param0: (param0: number, param1: Style, param2: number) => boolean) => boolean[], arg3: string, arg4: GameRule<number>)
