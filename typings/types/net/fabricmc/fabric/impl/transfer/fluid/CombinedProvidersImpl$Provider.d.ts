...
export class CombinedProvidersImpl$Provider extends Object implements ItemApiLookup$ItemApiProvider<StorageView<T>[], ContainerItemContext> {
    private constructor()
    // private event: Event<(param0: ContainerItemContext) => net.fabricmc.fabric.api.transfer.v1.storage.Storage<net.fabricmc.fabric.api.transfer.v1.fluid.FluidVariant>>;
    find(arg0: ItemStack, arg1: ContainerItemContext): StorageView<T>[];
}