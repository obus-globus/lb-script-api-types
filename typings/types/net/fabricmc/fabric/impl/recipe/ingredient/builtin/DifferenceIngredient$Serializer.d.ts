...
import type { DifferenceIngredient } from '../../../../../../../net/fabricmc/fabric/impl/recipe/ingredient/builtin/DifferenceIngredient.d.ts'
...
export class DifferenceIngredient$Serializer extends Object implements CustomIngredientSerializer<DifferenceIngredient> {
    ...
    getStreamCodec(): StreamCodec<RegistryFriendlyByteBuf, DifferenceIngredient>;
}