...
import type { ClientboundRecipeSyncPayload$Entry } from '../../../../../../net/fabricmc/fabric/impl/recipe/sync/ClientboundRecipeSyncPayload$Entry.d.ts'
...
export class ClientboundRecipeSyncPayload extends Record implements CustomPacketPayload {
    static CODEC: StreamCodec<RegistryFriendlyByteBuf, ClientboundRecipeSyncPayload>;
    static TYPE: CustomPacketPayload$Type<ClientboundRecipeSyncPayload>;
    ...
    constructor(entries: ClientboundRecipeSyncPayload$Entry[])
    // private entries: ClientboundRecipeSyncPayload$Entry[];
    entries(): ClientboundRecipeSyncPayload$Entry[];
