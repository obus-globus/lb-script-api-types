...
export class ServerboundSupportedRecipeSerializersPayload extends Record implements CustomPacketPayload {
    static CODEC: StreamCodec<FriendlyByteBuf, ServerboundSupportedRecipeSerializersPayload>;
    static TYPE: CustomPacketPayload$Type<ServerboundSupportedRecipeSerializersPayload>;
    ...
    constructor(synchronizedSerializers: Identifier[])
    // private synchronizedSerializers: Identifier[];
    equals(arg0: Object | null): boolean;
    hashCode(): number;
    synchronizedSerializers(): Identifier[];
    toString(): string;
