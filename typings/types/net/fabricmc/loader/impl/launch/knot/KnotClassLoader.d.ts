...
import type { KnotClassLoader$DynamicURLClassLoader } from '../../../../../../net/fabricmc/loader/impl/launch/knot/KnotClassLoader$DynamicURLClassLoader.d.ts'
import type { AbstractSecureClassLoader } from '../../../../../../net/fabricmc/loader/impl/mrj/AbstractSecureClassLoader.d.ts'
export class KnotClassLoader extends AbstractSecureClassLoader implements KnotClassDelegate$ClassLoaderAccess {
    ...
    // private delegate: KnotClassDelegate<KnotClassLoader>;
    // private originalLoader: ClassLoader;
    // private urlLoader: KnotClassLoader$DynamicURLClassLoader;
