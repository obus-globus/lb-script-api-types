...
export class FlatAsRegularMappingVisitor extends Object implements MappingVisitor {
    constructor(arg0: FlatMappingVisitor)
    // private argIdx: number;
    // private dstClassNames: string[];
    // private dstMemberDescs: string[];
    // private dstMemberNames: string[];
    // private dstNames: string[];
    // private endOpIdx: number;
    // private lvIndex: number;
    // private next: FlatMappingVisitor;
    // private srcClsName: string;
    // private srcMemberDesc: string;
    // private srcMemberName: string;
    // private srcMemberSubName: string;
