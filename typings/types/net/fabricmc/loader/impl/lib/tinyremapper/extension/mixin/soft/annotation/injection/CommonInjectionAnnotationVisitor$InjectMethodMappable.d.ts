...
export class CommonInjectionAnnotationVisitor$InjectMethodMappable extends Object {
    ...
    // private canInject(arg0: string, arg1: number, arg2: Map<Pair<string, string>, TrClass[]>): boolean;
    // private canInject(arg0: string, arg1: string, arg2: Map<Pair<string, string>, TrClass[]>): boolean;
