...
export class MaxWatchPbLong extends WatchPbLong {
    ...
    static normalizedMaxWatchPbNew(paramarg0: UnitPropagationListener, paramarg1: ILits, paramarg2: number[], paramarg3: (Object | null)[], paramarg4: BigInteger, paramarg5: BigInteger): MaxWatchPbLong;
