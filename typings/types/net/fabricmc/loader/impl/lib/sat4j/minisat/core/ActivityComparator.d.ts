...
export class ActivityComparator extends Object implements Serializable, Comparator<Constr> {
    ...
    thenComparing<U extends Comparable<U>>(arg0: (param0: Constr) => U): (param0: Object) => boolean;
    thenComparing<U extends Object | number | string | boolean>(arg0: (param0: Constr) => U, arg1: (param0: Object) => boolean): (param0: Object) => boolean;
    thenComparingDouble(arg0: (param0: Constr) => number): (param0: Object) => boolean;
    thenComparingInt(arg0: (param0: Constr) => number): (param0: Object) => boolean;
    thenComparingLong(arg0: (param0: Constr) => number): (param0: Object) => boolean;
}