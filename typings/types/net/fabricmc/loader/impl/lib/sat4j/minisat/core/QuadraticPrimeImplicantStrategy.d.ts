...
export class QuadraticPrimeImplicantStrategy extends Object implements PrimeImplicantStrategy {
    constructor()
    // private prime: number[];
    compute(arg0: Solver<DataStructureFactory>): number[];
    getPrimeImplicantAsArrayWithHoles(): number[];
    setAndPropagate(arg0: Solver<DataStructureFactory>, arg1: number): boolean;
}