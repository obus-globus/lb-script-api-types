...
export class Log extends Object {
    ...
    static debug(paramarg0: LogCategory, paramarg1: string, ...paramarg2: Object[]): void;
    ...
    static error(paramarg0: LogCategory, paramarg1: string, ...paramarg2: Object[]): void;
    ...
    static info(paramarg0: LogCategory, paramarg1: string, ...paramarg2: Object[]): void;
    ...
    static logFormat(paramarg0: LogLevel, paramarg1: LogCategory, paramarg2: string, ...paramarg3: Object[]): void;
    ...
    static trace(paramarg0: LogCategory, paramarg1: string, ...paramarg2: Object[]): void;
    ...
    static warn(paramarg0: LogCategory, paramarg1: string, ...paramarg2: Object[]): void;
