...
import type { MixinConfig } from '../../../../../net/caffeinemc/mods/sodium/client/data/config/MixinConfig.d.ts'
...
export class SodiumMixinPlugin extends Object implements IMixinConfigPlugin {
    constructor()
    // private config: MixinConfig;
    // private dependencyResolutionFailed: boolean;
