...
export class ExternalPage extends Record implements Page {
    constructor(name: Component, currentScreenConsumer: (param0: Screen) => void)
    // private currentScreenConsumer: (param0: Screen) => void;
    // private name: Component;
    currentScreenConsumer(): (param0: Screen) => void;
