...
export class GLRenderDevice$ImmediateCommandList extends Object implements CommandList {
    private constructor(null_: GLRenderDevice$ImmediateCommandList, arg1: GlStateTracker)
    ...
    // private checkMapDisposed(arg0: GlBufferMapping): void;
    close(): void;
