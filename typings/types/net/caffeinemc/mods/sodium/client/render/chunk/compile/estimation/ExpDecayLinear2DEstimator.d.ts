...
export abstract class ExpDecayLinear2DEstimator<C extends Object | number | string | boolean> extends Abstract2DLinearEstimator<C, C[], ExpDecayLinear2DEstimator$ExpDecayLinearFunction<C>> {
