...
export class Average1DEstimator$Average<C extends Object | number | string | boolean> extends Object implements Estimator$Model<void, number, Average1DEstimator$ValueBatch<C>> {
