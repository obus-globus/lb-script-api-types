...
export class FullTQuad extends RegularTQuad {
    ...
    static fromVertices(paramarg0: ChunkVertexEncoder$Vertex[], paramarg1: ModelQuadFacing, paramarg2: number): FullTQuad;
    static fromVertices(paramarg0: ChunkVertexEncoder$Vertex[], paramarg1: ModelQuadFacing, paramarg2: number): RegularTQuad;
