...
export class ChunkBuilder extends Object {
    ...
    scheduleTask<TASK extends ChunkBuilderTask<OUTPUT>>(arg0: TASK, arg1: boolean, arg2: (param0: ChunkJobResult<OUTPUT>) => void, arg3: boolean): ChunkJobTyped<TASK, OUTPUT>;
    shutdown(): void;
