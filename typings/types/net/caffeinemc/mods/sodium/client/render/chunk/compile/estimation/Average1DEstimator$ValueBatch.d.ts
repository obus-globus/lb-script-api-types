...
export class Average1DEstimator$ValueBatch<BatchCategory extends unknown> extends Object implements Estimator$DataBatch<Average1DEstimator$Value<BatchCategory>> {
    constructor()
