...
export abstract class Abstract2DLinearEstimator$LinearFunction<C extends Object | number | string | boolean, TBatch extends Estimator$DataBatch<Abstract2DLinearEstimator$DataPair<C>>> extends Object implements Estimator$Model<number, number, TBatch> {
