...
export interface EntityMovementTrackerSection extends Object{
    lithium$addListener(arg0: SectionedEntityMovementTracker<any>): void;
    ...
    lithium$removeListener(arg0: EntitySectionStorage<any>, arg1: SectionedEntityMovementTracker<any>): void;
