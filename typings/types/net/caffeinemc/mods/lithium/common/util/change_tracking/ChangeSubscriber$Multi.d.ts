...
export class ChangeSubscriber$Multi<T extends unknown> extends Object implements ChangeSubscriber$CountChangeSubscriber<T>, ChangeSubscriber$EnchantmentSubscriber<T> {
