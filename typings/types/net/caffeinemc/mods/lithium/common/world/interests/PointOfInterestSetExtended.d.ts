...
export interface PointOfInterestSetExtended extends Object {
    ...
    lithium$getFirstMatchingPoint(arg0: BlockPos, arg1: number, arg2: (param0: Holder<PoiType>) => kotlin.Boolean, arg3: (param0: BlockPos) => kotlin.Boolean, arg4: PoiManager$Occupancy): PoiRecord;
    lithium$getL2ClosestMatchingPoint(arg0: BlockPos, arg1: (param0: Holder<PoiType>) => kotlin.Boolean, arg2: (param0: PoiRecord) => kotlin.Boolean): PoiRecord;
    ...
    lithium$iterate(arg0: (param0: Holder<PoiType>) => kotlin.Boolean): Iterator<PoiRecord>;
}