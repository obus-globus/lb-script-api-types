...
export class CCAuthenticationTokenRequest extends Object {
    static send(paramarg0: HttpClient, paramarg1: CCAccount): CompletableFuture<CCAuthenticationResponse>;
    constructor()
}