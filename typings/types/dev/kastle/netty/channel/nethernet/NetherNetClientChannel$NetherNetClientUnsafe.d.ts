...
export class NetherNetClientChannel$NetherNetClientUnsafe extends AbstractChannel$AbstractUnsafe {
    private constructor(null_: NetherNetClientChannel$NetherNetClientUnsafe)
