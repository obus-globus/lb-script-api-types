...
export abstract class BaseModel extends Object implements Model {
    ...
    // private artifacts: JavaMap<string, Object>;
    block: Block;
    dataType: DataType;
    ...
    loadBlock(arg0: string, arg1: JavaMap<string, Object | null>): void;
    ...
    paramPathResolver(arg0: string, arg1: JavaMap<string, Object | null>): Path;
    quantize(): void;
    readParameters(arg0: InputStream, arg1: JavaMap<string, Object | null>): boolean;
    readParameters(arg0: Path, arg1: JavaMap<string, Object | null>): boolean;
