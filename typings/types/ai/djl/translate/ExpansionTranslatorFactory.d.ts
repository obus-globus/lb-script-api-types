...
export abstract class ExpansionTranslatorFactory<IbaseT extends Object | number | string | boolean, ObaseT extends Object | number | string | boolean> extends Object implements TranslatorFactory {
    constructor()
