...
export class ClassLoaderUtils extends Object {
    ...
    static findImplementation<T extends unknown>(paramarg0: Path, paramarg1: Class<T>, paramarg2: string): T;
    ...
    static initClass<T extends unknown>(paramarg0: ClassLoader, paramarg1: Class<T>, paramarg2: string): T;
