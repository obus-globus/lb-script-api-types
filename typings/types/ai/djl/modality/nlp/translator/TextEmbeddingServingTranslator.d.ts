...
export class TextEmbeddingServingTranslator extends Object implements Translator<Input, Output> {
    constructor(arg0: Translator<string, number[]>)
    // private translator: Translator<string, number[]>;
