...
import type { StringPair } from '../../../../../ai/djl/util/StringPair.d.ts'
import type { Object } from '../../../../../java/lang/Object.d.ts'
export class CrossEncoderServingTranslator extends Object implements Translator<Input, Output> {
    constructor(arg0: Translator<StringPair, number[]>)
    // private translator: Translator<StringPair, number[]>;
