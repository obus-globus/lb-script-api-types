...
export class QaServingTranslator extends Object implements NoBatchifyTranslator<Input, Output> {
    constructor(arg0: Translator<QAInput, string>)
    // private translator: Translator<QAInput, string>;
