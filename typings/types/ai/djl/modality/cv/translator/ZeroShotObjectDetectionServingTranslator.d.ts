...
export class ZeroShotObjectDetectionServingTranslator extends Object implements NoBatchifyTranslator<Input, Output> {
    constructor(arg0: Translator<VisionLanguageInput, DetectedObjects>)
    // private translator: Translator<VisionLanguageInput, DetectedObjects>;
