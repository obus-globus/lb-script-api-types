...
export class SimplePoseTranslatorFactory extends BaseImageTranslatorFactory<Joints> implements Serializable {
    constructor()
    buildBaseTranslator(arg0: Model, arg1: JavaMap<string, Object | null>): Translator<Image, Joints>;
    getBaseOutputType(): Class<Joints>;
}