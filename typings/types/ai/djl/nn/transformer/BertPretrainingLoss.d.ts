import type { BertMaskedLanguageModelLoss } from '../../../../ai/djl/nn/transformer/BertMaskedLanguageModelLoss.d.ts'
import type { BertNextSentenceLoss } from '../../../../ai/djl/nn/transformer/BertNextSentenceLoss.d.ts'
import type { AbstractCompositeLoss } from '../../../../ai/djl/training/loss/AbstractCompositeLoss.d.ts'
...
export class BertPretrainingLoss extends AbstractCompositeLoss {
    ...
    constructor()
    readonly bertMaskedLanguageModelLoss: BertMaskedLanguageModelLoss;
    readonly bertNextSentenceLoss: BertNextSentenceLoss;
    getBertMaskedLanguageModelLoss(): BertMaskedLanguageModelLoss;
    getBertNextSentenceLoss(): BertNextSentenceLoss;
    inputForComponent(arg0: number, arg1: (Object | null)[], arg2: (Object | null)[]): Pair<(Object | null)[], (Object | null)[]>;
}