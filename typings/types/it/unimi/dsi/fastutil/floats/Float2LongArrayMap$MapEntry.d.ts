...
export class Float2LongArrayMap$MapEntry extends Object implements Float2LongMap$Entry, FloatLongPair, Map$Entry<number, number> {
    ...
    constructor(null_: Float2LongArrayMap$MapEntry)
    constructor(null_: Float2LongArrayMap$MapEntry, arg1: number)
