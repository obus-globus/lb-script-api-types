...
export class Float2ObjectLinkedOpenHashMap$MapEntry extends Object implements Float2ObjectMap$Entry<V>, FloatObjectPair<V>, Map$Entry<number, V> {
    ...
    constructor(null_: Float2ObjectLinkedOpenHashMap$MapEntry)
    constructor(null_: Float2ObjectLinkedOpenHashMap$MapEntry, arg1: number)
