...
export class Float2ObjectArrayMap$MapEntry extends Object implements Float2ObjectMap$Entry<V>, FloatObjectPair<V>, Map$Entry<number, V> {
    ...
    constructor(null_: Float2ObjectArrayMap$MapEntry)
    constructor(null_: Float2ObjectArrayMap$MapEntry, arg1: number)
