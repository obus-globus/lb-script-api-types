...
export class Float2ReferenceArrayMap$MapEntry extends Object implements Float2ReferenceMap$Entry<V>, FloatReferencePair<V>, Map$Entry<number, V> {
    ...
    constructor(null_: Float2ReferenceArrayMap$MapEntry)
    constructor(null_: Float2ReferenceArrayMap$MapEntry, arg1: number)
