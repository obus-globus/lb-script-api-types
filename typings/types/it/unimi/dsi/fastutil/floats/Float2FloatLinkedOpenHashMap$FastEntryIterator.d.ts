...
export class Float2FloatLinkedOpenHashMap$FastEntryIterator extends Float2FloatLinkedOpenHashMap$MapIterator<(param0: Float2FloatMap$Entry) => void> implements ObjectListIterator<Float2FloatMap$Entry> {
    constructor(null_: Float2FloatLinkedOpenHashMap$FastEntryIterator)
    constructor(null_: Float2FloatLinkedOpenHashMap$FastEntryIterator, arg1: number)
