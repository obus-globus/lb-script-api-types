...
export class Float2DoubleOpenCustomHashMap$MapEntry extends Object implements Float2DoubleMap$Entry, FloatDoublePair, Map$Entry<number, number> {
    ...
    constructor(null_: Float2DoubleOpenCustomHashMap$MapEntry)
    constructor(null_: Float2DoubleOpenCustomHashMap$MapEntry, arg1: number)
