...
export class Float2ShortSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Float2ShortMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Float2ShortMap$Entry>;
