...
export class Float2DoubleOpenCustomHashMap$KeyIterator extends Float2DoubleOpenCustomHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Float2DoubleOpenCustomHashMap$KeyIterator)
