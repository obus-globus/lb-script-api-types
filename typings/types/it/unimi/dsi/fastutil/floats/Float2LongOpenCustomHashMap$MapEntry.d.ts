...
export class Float2LongOpenCustomHashMap$MapEntry extends Object implements Float2LongMap$Entry, FloatLongPair, Map$Entry<number, number> {
    ...
    constructor(null_: Float2LongOpenCustomHashMap$MapEntry)
    constructor(null_: Float2LongOpenCustomHashMap$MapEntry, arg1: number)
