...
export class Float2DoubleFunctions$SynchronizedFunction extends Object implements Float2DoubleFunction, Serializable {
    constructor(arg0: (param0: number) => kotlin.Double)
    constructor(arg0: (param0: number) => kotlin.Double, arg1: Object)
    ...
    composeByte(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Double;
    composeChar(arg0: (param0: string) => kotlin.Float): (param0: string) => kotlin.Double;
    composeDouble(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Double;
    composeFloat(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Double;
    composeInt(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Double;
    composeLong(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Double;
    composeObject(arg0: (param0: T) => kotlin.Float): (param0: T) => kotlin.Double;
    composeReference(arg0: (param0: T) => kotlin.Float): (param0: T) => kotlin.Double;
    composeShort(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Double;
