...
export class Float2FloatOpenCustomHashMap$KeyIterator extends Float2FloatOpenCustomHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Float2FloatOpenCustomHashMap$KeyIterator)
