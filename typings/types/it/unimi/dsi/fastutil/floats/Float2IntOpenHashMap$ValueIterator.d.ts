...
export class Float2IntOpenHashMap$ValueIterator extends Float2IntOpenHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Float2IntOpenHashMap$ValueIterator)
