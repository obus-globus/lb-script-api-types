...
export class Float2CharLinkedOpenHashMap$MapEntry extends Object implements Float2CharMap$Entry, FloatCharPair, Map$Entry<number, string> {
    ...
    constructor(null_: Float2CharLinkedOpenHashMap$MapEntry)
    constructor(null_: Float2CharLinkedOpenHashMap$MapEntry, arg1: number)
