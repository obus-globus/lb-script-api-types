...
export abstract class AbstractFloat2ObjectFunction<V extends Object | number | string | boolean> extends Object implements Float2ObjectFunction<V>, Serializable {
    constructor()
