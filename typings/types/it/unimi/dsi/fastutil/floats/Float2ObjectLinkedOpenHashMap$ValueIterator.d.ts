...
export class Float2ObjectLinkedOpenHashMap$ValueIterator extends Float2ObjectLinkedOpenHashMap$MapIterator<Object> implements ObjectListIterator<V> {
    constructor(null_: Float2ObjectLinkedOpenHashMap$ValueIterator)
