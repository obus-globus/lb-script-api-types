...
export class Float2DoubleOpenHashMap$ValueIterator extends Float2DoubleOpenHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Float2DoubleOpenHashMap$ValueIterator)
