...
export class Float2LongOpenHashMap$ValueSpliterator extends Float2LongOpenHashMap$MapSpliterator<(param0: number) => void, Float2LongOpenHashMap$ValueSpliterator> implements LongSpliterator {
    ...
    constructor(null_: Float2LongOpenHashMap$ValueSpliterator)
    constructor(null_: Float2LongOpenHashMap$ValueSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => number;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Float2LongOpenHashMap$ValueSpliterator;
