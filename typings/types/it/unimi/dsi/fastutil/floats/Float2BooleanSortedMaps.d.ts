...
export class Float2BooleanSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Float2BooleanMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Float2BooleanMap$Entry>;
