...
export class Float2ShortOpenHashMap$KeyIterator extends Float2ShortOpenHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Float2ShortOpenHashMap$KeyIterator)
