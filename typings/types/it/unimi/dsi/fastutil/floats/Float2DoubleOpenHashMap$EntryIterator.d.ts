...
export class Float2DoubleOpenHashMap$EntryIterator extends Float2DoubleOpenHashMap$MapIterator<(param0: Float2DoubleMap$Entry) => void> implements ObjectIterator<Float2DoubleMap$Entry> {
    private constructor(null_: Float2DoubleOpenHashMap$EntryIterator)
