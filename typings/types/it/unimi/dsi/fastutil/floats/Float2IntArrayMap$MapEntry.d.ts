...
export class Float2IntArrayMap$MapEntry extends Object implements Float2IntMap$Entry, FloatIntPair, Map$Entry<number, number> {
    ...
    constructor(null_: Float2IntArrayMap$MapEntry)
    constructor(null_: Float2IntArrayMap$MapEntry, arg1: number)
