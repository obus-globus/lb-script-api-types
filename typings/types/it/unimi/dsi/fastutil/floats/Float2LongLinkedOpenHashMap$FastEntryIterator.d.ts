...
export class Float2LongLinkedOpenHashMap$FastEntryIterator extends Float2LongLinkedOpenHashMap$MapIterator<(param0: Float2LongMap$Entry) => void> implements ObjectListIterator<Float2LongMap$Entry> {
    constructor(null_: Float2LongLinkedOpenHashMap$FastEntryIterator)
    constructor(null_: Float2LongLinkedOpenHashMap$FastEntryIterator, arg1: number)
