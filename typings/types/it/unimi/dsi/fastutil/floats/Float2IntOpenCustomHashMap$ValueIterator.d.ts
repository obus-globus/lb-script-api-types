...
export class Float2IntOpenCustomHashMap$ValueIterator extends Float2IntOpenCustomHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Float2IntOpenCustomHashMap$ValueIterator)
