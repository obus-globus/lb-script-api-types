...
export class Float2ShortOpenCustomHashMap$MapEntry extends Object implements Float2ShortMap$Entry, FloatShortPair, Map$Entry<number, number> {
    ...
    constructor(null_: Float2ShortOpenCustomHashMap$MapEntry)
    constructor(null_: Float2ShortOpenCustomHashMap$MapEntry, arg1: number)
