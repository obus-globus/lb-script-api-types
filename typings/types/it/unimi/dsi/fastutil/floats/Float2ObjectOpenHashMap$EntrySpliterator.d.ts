...
export class Float2ObjectOpenHashMap$EntrySpliterator {
    ...
    makeForSplit<V extends unknown>(arg0: number, arg1: number, arg2: boolean): Float2ObjectOpenHashMap$EntrySpliterator;
}