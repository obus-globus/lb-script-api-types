...
export class Float2DoubleOpenHashMap$KeyIterator extends Float2DoubleOpenHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Float2DoubleOpenHashMap$KeyIterator)
