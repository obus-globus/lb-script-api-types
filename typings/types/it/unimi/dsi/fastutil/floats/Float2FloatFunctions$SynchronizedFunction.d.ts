...
export class Float2FloatFunctions$SynchronizedFunction extends Object implements Float2FloatFunction, Serializable {
    static identity(): (param0: number) => kotlin.Float;
    constructor(arg0: (param0: number) => kotlin.Float)
    constructor(arg0: (param0: number) => kotlin.Float, arg1: Object)
    ...
    composeByte(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Float;
    composeChar(arg0: (param0: string) => kotlin.Float): (param0: string) => kotlin.Float;
    composeDouble(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Float;
    composeFloat(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Float;
    composeInt(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Float;
    composeLong(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Float;
    composeObject(arg0: (param0: T) => kotlin.Float): (param0: T) => kotlin.Float;
    composeReference(arg0: (param0: T) => kotlin.Float): (param0: T) => kotlin.Float;
    composeShort(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Float;
