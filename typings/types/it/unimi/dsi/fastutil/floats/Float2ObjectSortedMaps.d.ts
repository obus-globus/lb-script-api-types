...
export class Float2ObjectSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Float2ObjectMap$Entry<Object>[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Float2ObjectMap$Entry<Object>>;
