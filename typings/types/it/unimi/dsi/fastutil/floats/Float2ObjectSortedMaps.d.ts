...
export class Float2ObjectSortedMaps extends Object {
    ...
    static fastIterable<V extends unknown>(paramarg0: { [key: string]: any }): Float2ObjectMap$Entry<V>[];
    static fastIterator<V extends unknown>(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Float2ObjectMap$Entry<V>>;
