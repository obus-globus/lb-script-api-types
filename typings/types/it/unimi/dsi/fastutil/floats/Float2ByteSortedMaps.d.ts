...
export class Float2ByteSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Float2ByteMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Float2ByteMap$Entry>;
