...
export class Float2LongSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Float2LongMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Float2LongMap$Entry>;
