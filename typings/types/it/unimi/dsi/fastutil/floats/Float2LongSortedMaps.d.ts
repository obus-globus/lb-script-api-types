...
export class Float2LongSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Float2LongMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Float2LongMap$Entry>;
