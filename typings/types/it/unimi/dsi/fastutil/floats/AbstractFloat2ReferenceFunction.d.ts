...
export abstract class AbstractFloat2ReferenceFunction<V extends Object | number | string | boolean> extends Object implements Float2ReferenceFunction<V>, Serializable {
    constructor()
