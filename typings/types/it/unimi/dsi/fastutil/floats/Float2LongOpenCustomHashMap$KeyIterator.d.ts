...
export class Float2LongOpenCustomHashMap$KeyIterator extends Float2LongOpenCustomHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Float2LongOpenCustomHashMap$KeyIterator)
