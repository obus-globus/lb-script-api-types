...
export class Float2FloatLinkedOpenHashMap$MapEntry extends Object implements Float2FloatMap$Entry, FloatFloatPair, Map$Entry<number, number> {
    ...
    constructor(null_: Float2FloatLinkedOpenHashMap$MapEntry)
    constructor(null_: Float2FloatLinkedOpenHashMap$MapEntry, arg1: number)
