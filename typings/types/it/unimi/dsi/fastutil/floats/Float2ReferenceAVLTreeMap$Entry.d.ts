...
export class Float2ReferenceAVLTreeMap$Entry<V extends Object | number | string | boolean> extends AbstractFloat2ReferenceMap$BasicEntry<V> implements Cloneable {
    constructor()
