...
export class Float2FloatOpenCustomHashMap$MapEntry extends Object implements Float2FloatMap$Entry, FloatFloatPair, Map$Entry<number, number> {
    ...
    constructor(null_: Float2FloatOpenCustomHashMap$MapEntry)
    constructor(null_: Float2FloatOpenCustomHashMap$MapEntry, arg1: number)
