...
export class Float2ReferenceRBTreeMap$Entry<V extends Object | number | string | boolean> extends AbstractFloat2ReferenceMap$BasicEntry<V> implements Cloneable {
    constructor()
