...
export class Float2ShortOpenHashMap$ValueIterator extends Float2ShortOpenHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Float2ShortOpenHashMap$ValueIterator)
