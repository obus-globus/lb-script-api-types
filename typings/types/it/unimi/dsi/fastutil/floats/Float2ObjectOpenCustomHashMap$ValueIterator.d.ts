...
export class Float2ObjectOpenCustomHashMap$ValueIterator extends Float2ObjectOpenCustomHashMap$MapIterator<Object> implements ObjectIterator<V> {
    constructor(null_: Float2ObjectOpenCustomHashMap$ValueIterator)
