...
export class Float2ByteLinkedOpenHashMap$MapEntry extends Object implements Float2ByteMap$Entry, FloatBytePair, Map$Entry<number, number> {
    ...
    constructor(null_: Float2ByteLinkedOpenHashMap$MapEntry)
    constructor(null_: Float2ByteLinkedOpenHashMap$MapEntry, arg1: number)
