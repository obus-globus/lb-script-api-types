...
export class Float2ShortLinkedOpenHashMap$MapEntry extends Object implements Float2ShortMap$Entry, FloatShortPair, Map$Entry<number, number> {
    ...
    constructor(null_: Float2ShortLinkedOpenHashMap$MapEntry)
    constructor(null_: Float2ShortLinkedOpenHashMap$MapEntry, arg1: number)
