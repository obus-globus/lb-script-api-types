...
export class Float2IntOpenHashMap$ValueSpliterator extends Float2IntOpenHashMap$MapSpliterator<(param0: number) => void, Float2IntOpenHashMap$ValueSpliterator> implements IntSpliterator {
    ...
    constructor(null_: Float2IntOpenHashMap$ValueSpliterator)
    constructor(null_: Float2IntOpenHashMap$ValueSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => kotlin.Int;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Float2IntOpenHashMap$ValueSpliterator;
