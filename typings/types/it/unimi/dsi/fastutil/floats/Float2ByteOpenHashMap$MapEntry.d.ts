...
export class Float2ByteOpenHashMap$MapEntry extends Object implements Float2ByteMap$Entry, FloatBytePair, Map$Entry<number, number> {
    ...
    constructor(null_: Float2ByteOpenHashMap$MapEntry)
    constructor(null_: Float2ByteOpenHashMap$MapEntry, arg1: number)
