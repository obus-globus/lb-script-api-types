...
export class Float2BooleanFunctions$SynchronizedFunction extends Object implements Float2BooleanFunction, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Boolean;
    composeChar(arg0: (param0: string) => kotlin.Float): (param0: string) => kotlin.Boolean;
    composeDouble(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Boolean;
    composeFloat(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Boolean;
    composeInt(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Boolean;
    composeLong(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Boolean;
    composeObject(arg0: (param0: T) => kotlin.Float): (param0: T) => kotlin.Boolean;
    composeReference(arg0: (param0: T) => kotlin.Float): (param0: T) => kotlin.Boolean;
    composeShort(arg0: (param0: number) => kotlin.Float): (param0: number) => kotlin.Boolean;
