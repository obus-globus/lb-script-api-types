...
export class Float2LongOpenCustomHashMap$FastEntryIterator extends Float2LongOpenCustomHashMap$MapIterator<(param0: Float2LongMap$Entry) => void> implements ObjectIterator<Float2LongMap$Entry> {
    private constructor(null_: Float2LongOpenCustomHashMap$FastEntryIterator)
