...
export class Float2FloatSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Float2FloatMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Float2FloatMap$Entry>;
