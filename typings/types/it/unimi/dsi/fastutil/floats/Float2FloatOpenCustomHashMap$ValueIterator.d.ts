...
export class Float2FloatOpenCustomHashMap$ValueIterator extends Float2FloatOpenCustomHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Float2FloatOpenCustomHashMap$ValueIterator)
