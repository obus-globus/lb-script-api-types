...
export class Float2ByteOpenHashMap$KeyIterator extends Float2ByteOpenHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Float2ByteOpenHashMap$KeyIterator)
