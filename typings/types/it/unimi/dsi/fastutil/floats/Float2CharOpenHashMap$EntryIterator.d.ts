...
export class Float2CharOpenHashMap$EntryIterator extends Float2CharOpenHashMap$MapIterator<(param0: Float2CharMap$Entry) => void> implements ObjectIterator<Float2CharMap$Entry> {
    private constructor(null_: Float2CharOpenHashMap$EntryIterator)
