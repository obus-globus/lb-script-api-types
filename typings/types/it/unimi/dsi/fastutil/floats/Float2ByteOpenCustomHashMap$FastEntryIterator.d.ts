...
export class Float2ByteOpenCustomHashMap$FastEntryIterator extends Float2ByteOpenCustomHashMap$MapIterator<(param0: Float2ByteMap$Entry) => void> implements ObjectIterator<Float2ByteMap$Entry> {
    private constructor(null_: Float2ByteOpenCustomHashMap$FastEntryIterator)
