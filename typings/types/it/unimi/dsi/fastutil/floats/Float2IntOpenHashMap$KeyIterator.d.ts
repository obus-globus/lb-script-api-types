...
export class Float2IntOpenHashMap$KeyIterator extends Float2IntOpenHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Float2IntOpenHashMap$KeyIterator)
