...
export class Float2CharOpenCustomHashMap$FastEntryIterator extends Float2CharOpenCustomHashMap$MapIterator<(param0: Float2CharMap$Entry) => void> implements ObjectIterator<Float2CharMap$Entry> {
    private constructor(null_: Float2CharOpenCustomHashMap$FastEntryIterator)
