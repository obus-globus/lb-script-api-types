...
export class Float2IntSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Float2IntMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Float2IntMap$Entry>;
