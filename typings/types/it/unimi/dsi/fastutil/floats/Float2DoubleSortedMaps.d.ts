...
export class Float2DoubleSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Float2DoubleMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Float2DoubleMap$Entry>;
