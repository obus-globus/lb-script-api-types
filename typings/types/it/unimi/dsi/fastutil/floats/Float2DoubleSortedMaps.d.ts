...
export class Float2DoubleSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Float2DoubleMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Float2DoubleMap$Entry>;
