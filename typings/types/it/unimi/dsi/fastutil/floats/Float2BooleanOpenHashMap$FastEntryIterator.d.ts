...
export class Float2BooleanOpenHashMap$FastEntryIterator extends Float2BooleanOpenHashMap$MapIterator<(param0: Float2BooleanMap$Entry) => void> implements ObjectIterator<Float2BooleanMap$Entry> {
    private constructor(null_: Float2BooleanOpenHashMap$FastEntryIterator)
