...
export class Float2CharOpenCustomHashMap$KeyIterator extends Float2CharOpenCustomHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Float2CharOpenCustomHashMap$KeyIterator)
