...
export class Float2ReferenceSortedMaps extends Object {
    ...
    static fastIterable<V extends unknown>(paramarg0: JavaMap<any, any>): Float2ReferenceMap$Entry<V>[];
    static fastIterator<V extends unknown>(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Float2ReferenceMap$Entry<V>>;
