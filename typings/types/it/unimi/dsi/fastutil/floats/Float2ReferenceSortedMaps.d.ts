...
export class Float2ReferenceSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: Float2ReferenceSortedMap<Object>): (Object | null)[];
    static fastIterator(paramarg0: Float2ReferenceSortedMap<Object>): ObjectBidirectionalIterator<Object>;
    static singleton(paramarg0: number, paramarg1: Object | null): Float2ReferenceSortedMap<Object>;
    static singleton(paramarg0: number, paramarg1: Object | null, paramarg2: (param0: number, param1: number) => kotlin.Int): Float2ReferenceSortedMap<Object>;
    static singleton(paramarg0: number, paramarg1: Object | null): Float2ReferenceSortedMap<Object>;
    static singleton(paramarg0: number, paramarg1: Object | null, paramarg2: (param0: number, param1: number) => kotlin.Int): Float2ReferenceSortedMap<Object>;
