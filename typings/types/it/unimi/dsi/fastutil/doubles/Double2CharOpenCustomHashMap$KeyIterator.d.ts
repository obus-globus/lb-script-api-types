...
export class Double2CharOpenCustomHashMap$KeyIterator extends Double2CharOpenCustomHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2CharOpenCustomHashMap$KeyIterator)
