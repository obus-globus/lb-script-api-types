...
export class Double2ReferenceOpenHashMap$ValueIterator extends Double2ReferenceOpenHashMap$MapIterator<Object> implements ObjectIterator<V> {
    constructor(null_: Double2ReferenceOpenHashMap$ValueIterator)
