...
export class Double2ByteOpenHashMap$FastEntryIterator extends Double2ByteOpenHashMap$MapIterator<(param0: Double2ByteMap$Entry) => void> implements ObjectIterator<Double2ByteMap$Entry> {
    private constructor(null_: Double2ByteOpenHashMap$FastEntryIterator)
