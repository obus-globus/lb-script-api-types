...
export class Double2IntOpenHashMap$KeySpliterator extends Double2IntOpenHashMap$MapSpliterator<(param0: number) => void, Double2IntOpenHashMap$KeySpliterator> implements DoubleSpliterator {
    ...
    constructor(null_: Double2IntOpenHashMap$KeySpliterator)
    constructor(null_: Double2IntOpenHashMap$KeySpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => kotlin.Int;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Double2IntOpenHashMap$KeySpliterator;
