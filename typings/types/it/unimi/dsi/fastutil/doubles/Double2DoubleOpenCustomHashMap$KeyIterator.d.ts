...
export class Double2DoubleOpenCustomHashMap$KeyIterator extends Double2DoubleOpenCustomHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2DoubleOpenCustomHashMap$KeyIterator)
