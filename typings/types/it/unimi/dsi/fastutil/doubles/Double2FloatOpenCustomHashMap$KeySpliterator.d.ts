...
export class Double2FloatOpenCustomHashMap$KeySpliterator extends Double2FloatOpenCustomHashMap$MapSpliterator<(param0: number) => void, Double2FloatOpenCustomHashMap$KeySpliterator> implements DoubleSpliterator {
    ...
    constructor(null_: Double2FloatOpenCustomHashMap$KeySpliterator)
    constructor(null_: Double2FloatOpenCustomHashMap$KeySpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => number;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Double2FloatOpenCustomHashMap$KeySpliterator;
