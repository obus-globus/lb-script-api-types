...
export class Double2DoubleOpenHashMap$ValueIterator extends Double2DoubleOpenHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2DoubleOpenHashMap$ValueIterator)
