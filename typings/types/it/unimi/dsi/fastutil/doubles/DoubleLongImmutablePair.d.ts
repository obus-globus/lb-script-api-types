...
export class DoubleLongImmutablePair extends Object implements DoubleLongPair, Serializable {
    static lexComparator(): (param0: Object) => boolean;
    static of(paramarg0: number, paramarg1: number): DoubleLongImmutablePair;
