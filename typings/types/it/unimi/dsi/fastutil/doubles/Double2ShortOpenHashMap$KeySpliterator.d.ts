...
export class Double2ShortOpenHashMap$KeySpliterator extends Double2ShortOpenHashMap$MapSpliterator<(param0: number) => void, Double2ShortOpenHashMap$KeySpliterator> implements DoubleSpliterator {
    ...
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Double2ShortOpenHashMap$KeySpliterator;
