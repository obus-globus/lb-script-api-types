...
export class Double2ShortArrayMap$MapEntry extends Object implements Double2ShortMap$Entry, DoubleShortPair, Map$Entry<number, number> {
    ...
    constructor(null_: Double2ShortArrayMap$MapEntry)
    constructor(null_: Double2ShortArrayMap$MapEntry, arg1: number)
