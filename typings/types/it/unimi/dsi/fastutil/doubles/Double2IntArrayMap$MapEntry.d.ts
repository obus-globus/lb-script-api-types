...
export class Double2IntArrayMap$MapEntry extends Object implements Double2IntMap$Entry, DoubleIntPair, Map$Entry<number, number> {
    ...
    constructor(null_: Double2IntArrayMap$MapEntry)
    constructor(null_: Double2IntArrayMap$MapEntry, arg1: number)
