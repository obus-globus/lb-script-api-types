...
export class Double2ByteSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Double2ByteMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Double2ByteMap$Entry>;
