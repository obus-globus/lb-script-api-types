...
export class Double2DoubleOpenHashMap$KeyIterator extends Double2DoubleOpenHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2DoubleOpenHashMap$KeyIterator)
