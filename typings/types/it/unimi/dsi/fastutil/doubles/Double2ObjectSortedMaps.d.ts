...
export class Double2ObjectSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Double2ObjectMap$Entry<Object>[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Double2ObjectMap$Entry<Object>>;
