...
export class Double2ShortOpenCustomHashMap$KeyIterator extends Double2ShortOpenCustomHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2ShortOpenCustomHashMap$KeyIterator)
