...
export class Double2CharOpenCustomHashMap$FastEntryIterator extends Double2CharOpenCustomHashMap$MapIterator<(param0: Double2CharMap$Entry) => void> implements ObjectIterator<Double2CharMap$Entry> {
    private constructor(null_: Double2CharOpenCustomHashMap$FastEntryIterator)
