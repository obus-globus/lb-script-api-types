...
export class Double2BooleanOpenHashMap$MapEntry extends Object implements Double2BooleanMap$Entry, DoubleBooleanPair, Map$Entry<number, boolean> {
    ...
    constructor(null_: Double2BooleanOpenHashMap$MapEntry)
    constructor(null_: Double2BooleanOpenHashMap$MapEntry, arg1: number)
