...
export class Double2ShortSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Double2ShortMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Double2ShortMap$Entry>;
