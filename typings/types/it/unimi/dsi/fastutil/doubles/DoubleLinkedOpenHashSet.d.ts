...
export class DoubleLinkedOpenHashSet {
    ...
    static of(...paramarg0: number[]): (Object | null)[];
    static toSet(paramarg0: DoubleStream): (Object | null)[];
    static toSetWithExpectedSize(paramarg0: DoubleStream, paramarg1: number): (Object | null)[];
}