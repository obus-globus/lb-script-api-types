...
export class Double2BooleanOpenHashMap$KeyIterator extends Double2BooleanOpenHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2BooleanOpenHashMap$KeyIterator)
