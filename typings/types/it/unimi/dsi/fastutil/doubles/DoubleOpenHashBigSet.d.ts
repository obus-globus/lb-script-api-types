...
export class DoubleOpenHashBigSet {
    ...
    static toBigSet(paramarg0: DoubleStream): (Object | null)[];
    static toBigSetWithExpectedSize(paramarg0: DoubleStream, paramarg1: number): (Object | null)[];
}