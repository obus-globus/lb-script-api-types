...
export class Double2ShortOpenCustomHashMap$ValueIterator extends Double2ShortOpenCustomHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Double2ShortOpenCustomHashMap$ValueIterator)
