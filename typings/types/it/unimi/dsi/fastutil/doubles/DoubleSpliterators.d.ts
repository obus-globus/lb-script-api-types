...
export class DoubleSpliterators extends Object {
    ...
    static asDoubleSpliterator(paramarg0: Spliterator<Object>, paramarg1: (param0: number, param1: number) => kotlin.Int): DoubleSpliterator;
    ...
    static asSpliteratorFromSorted(paramarg0: DoubleIterator, paramarg1: number, paramarg2: number, paramarg3: (param0: number, param1: number) => kotlin.Int): DoubleSpliterator;
    static asSpliteratorFromSortedUnknownSize(paramarg0: DoubleIterator, paramarg1: number, paramarg2: (param0: number, param1: number) => kotlin.Int): DoubleSpliterator;
    ...
    static onEachMatching(paramarg0: DoubleSpliterator, paramarg1: (param0: number) => kotlin.Boolean, paramarg2: (param0: number) => void): void;
    static singleton(paramarg0: number): DoubleSpliterator;
    static singleton(paramarg0: number, paramarg1: (param0: number, param1: number) => kotlin.Int): DoubleSpliterator;
    ...
    static wrapPreSorted(paramarg0: number[], paramarg1: number, paramarg2: number, paramarg3: number, paramarg4: (param0: number, param1: number) => kotlin.Int): DoubleSpliterator;
    static wrapPreSorted(paramarg0: number[], paramarg1: number, paramarg2: number, paramarg3: (param0: number, param1: number) => kotlin.Int): DoubleSpliterator;
    static wrapPreSorted(paramarg0: number[], paramarg1: (param0: number, param1: number) => kotlin.Int): DoubleSpliterator;
    private constructor()
}