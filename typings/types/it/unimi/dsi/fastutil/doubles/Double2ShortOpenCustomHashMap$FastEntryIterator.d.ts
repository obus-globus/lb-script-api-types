...
export class Double2ShortOpenCustomHashMap$FastEntryIterator extends Double2ShortOpenCustomHashMap$MapIterator<(param0: Double2ShortMap$Entry) => void> implements ObjectIterator<Double2ShortMap$Entry> {
    private constructor(null_: Double2ShortOpenCustomHashMap$FastEntryIterator)
