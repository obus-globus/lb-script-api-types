...
export class Double2ShortOpenHashMap$MapEntry extends Object implements Double2ShortMap$Entry, DoubleShortPair, Map$Entry<number, number> {
    ...
    constructor(null_: Double2ShortOpenHashMap$MapEntry)
    constructor(null_: Double2ShortOpenHashMap$MapEntry, arg1: number)
