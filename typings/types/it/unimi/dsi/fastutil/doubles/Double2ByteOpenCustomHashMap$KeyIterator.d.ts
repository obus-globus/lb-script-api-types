...
export class Double2ByteOpenCustomHashMap$KeyIterator extends Double2ByteOpenCustomHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2ByteOpenCustomHashMap$KeyIterator)
