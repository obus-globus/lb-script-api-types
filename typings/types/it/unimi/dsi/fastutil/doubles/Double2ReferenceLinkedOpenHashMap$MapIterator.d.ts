...
export abstract class Double2ReferenceLinkedOpenHashMap$MapIterator<ConsumerType extends Object | number | string | boolean> extends Object {
    constructor(null_: Double2ReferenceLinkedOpenHashMap$MapIterator<Object>)
    private constructor(null_: Double2ReferenceLinkedOpenHashMap$MapIterator<Object>, arg1: number)
    // private curr: number;
