...
export class Double2LongLinkedOpenHashMap$MapEntry extends Object implements Double2LongMap$Entry, DoubleLongPair, Map$Entry<number, number> {
    ...
    constructor(null_: Double2LongLinkedOpenHashMap$MapEntry)
    constructor(null_: Double2LongLinkedOpenHashMap$MapEntry, arg1: number)
