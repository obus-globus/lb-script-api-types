...
export class Double2CharOpenHashMap$MapEntry extends Object implements Double2CharMap$Entry, DoubleCharPair, Map$Entry<number, string> {
    ...
    constructor(null_: Double2CharOpenHashMap$MapEntry)
    constructor(null_: Double2CharOpenHashMap$MapEntry, arg1: number)
