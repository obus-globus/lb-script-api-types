...
export class Double2FloatOpenHashMap$ValueIterator extends Double2FloatOpenHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Double2FloatOpenHashMap$ValueIterator)
