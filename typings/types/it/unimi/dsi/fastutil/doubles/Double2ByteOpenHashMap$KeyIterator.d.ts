...
export class Double2ByteOpenHashMap$KeyIterator extends Double2ByteOpenHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2ByteOpenHashMap$KeyIterator)
