...
export class Double2BooleanArrayMap$MapEntry extends Object implements Double2BooleanMap$Entry, DoubleBooleanPair, Map$Entry<number, boolean> {
    ...
    constructor(null_: Double2BooleanArrayMap$MapEntry)
    constructor(null_: Double2BooleanArrayMap$MapEntry, arg1: number)
