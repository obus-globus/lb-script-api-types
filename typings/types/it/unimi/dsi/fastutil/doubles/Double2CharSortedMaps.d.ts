...
export class Double2CharSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Double2CharMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Double2CharMap$Entry>;
