...
export class Double2CharSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Double2CharMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Double2CharMap$Entry>;
