...
export class DoubleOpenHashSet$SetSpliterator extends Object implements DoubleSpliterator {
    ...
    constructor(null_: DoubleOpenHashSet$SetSpliterator)
    constructor(null_: DoubleOpenHashSet$SetSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    // private c: number;
    ...
    trySplit(): DoubleOpenHashSet$SetSpliterator;
}