...
export class Double2FloatOpenHashMap$KeyIterator extends Double2FloatOpenHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2FloatOpenHashMap$KeyIterator)
