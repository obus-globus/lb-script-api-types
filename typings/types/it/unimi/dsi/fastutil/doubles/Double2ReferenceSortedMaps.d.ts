...
export class Double2ReferenceSortedMaps extends Object {
    ...
    static fastIterable<V extends unknown>(paramarg0: JavaMap<any, any>): Double2ReferenceMap$Entry<V>[];
    static fastIterator<V extends unknown>(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Double2ReferenceMap$Entry<V>>;
