...
export class Double2CharLinkedOpenHashMap$FastEntryIterator extends Double2CharLinkedOpenHashMap$MapIterator<(param0: Double2CharMap$Entry) => void> implements ObjectListIterator<Double2CharMap$Entry> {
    constructor(null_: Double2CharLinkedOpenHashMap$FastEntryIterator)
    constructor(null_: Double2CharLinkedOpenHashMap$FastEntryIterator, arg1: number)
