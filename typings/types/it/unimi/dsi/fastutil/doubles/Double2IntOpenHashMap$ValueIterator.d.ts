...
export class Double2IntOpenHashMap$ValueIterator extends Double2IntOpenHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Double2IntOpenHashMap$ValueIterator)
