...
export class Double2DoubleArrayMap$MapEntry extends Object implements Double2DoubleMap$Entry, DoubleDoublePair, Map$Entry<number, number> {
    ...
    constructor(null_: Double2DoubleArrayMap$MapEntry)
    constructor(null_: Double2DoubleArrayMap$MapEntry, arg1: number)
