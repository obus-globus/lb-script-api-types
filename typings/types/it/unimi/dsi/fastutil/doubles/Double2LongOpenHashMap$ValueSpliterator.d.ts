...
export class Double2LongOpenHashMap$ValueSpliterator extends Double2LongOpenHashMap$MapSpliterator<(param0: number) => void, Double2LongOpenHashMap$ValueSpliterator> implements LongSpliterator {
    ...
    constructor(null_: Double2LongOpenHashMap$ValueSpliterator)
    constructor(null_: Double2LongOpenHashMap$ValueSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => kotlin.Int;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Double2LongOpenHashMap$ValueSpliterator;
