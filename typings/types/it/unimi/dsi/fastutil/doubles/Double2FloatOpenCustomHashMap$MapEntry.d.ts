...
export class Double2FloatOpenCustomHashMap$MapEntry extends Object implements Double2FloatMap$Entry, DoubleFloatPair, Map$Entry<number, number> {
    ...
    constructor(null_: Double2FloatOpenCustomHashMap$MapEntry)
    constructor(null_: Double2FloatOpenCustomHashMap$MapEntry, arg1: number)
