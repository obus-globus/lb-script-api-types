...
export class Double2ShortOpenHashMap$KeyIterator extends Double2ShortOpenHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2ShortOpenHashMap$KeyIterator)
