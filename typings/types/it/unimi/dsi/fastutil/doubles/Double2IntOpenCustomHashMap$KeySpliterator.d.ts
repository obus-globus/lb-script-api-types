...
export class Double2IntOpenCustomHashMap$KeySpliterator extends Double2IntOpenCustomHashMap$MapSpliterator<(param0: number) => void, Double2IntOpenCustomHashMap$KeySpliterator> implements DoubleSpliterator {
    ...
    constructor(null_: Double2IntOpenCustomHashMap$KeySpliterator)
    constructor(null_: Double2IntOpenCustomHashMap$KeySpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => number;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Double2IntOpenCustomHashMap$KeySpliterator;
