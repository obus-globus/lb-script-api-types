...
export class Double2BooleanOpenHashMap$KeySpliterator extends Double2BooleanOpenHashMap$MapSpliterator<(param0: number) => void, Double2BooleanOpenHashMap$KeySpliterator> implements DoubleSpliterator {
    ...
    constructor(null_: Double2BooleanOpenHashMap$KeySpliterator)
    constructor(null_: Double2BooleanOpenHashMap$KeySpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => kotlin.Int;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Double2BooleanOpenHashMap$KeySpliterator;
