...
export class Double2IntOpenCustomHashMap$KeyIterator extends Double2IntOpenCustomHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2IntOpenCustomHashMap$KeyIterator)
