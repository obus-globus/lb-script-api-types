...
export class Double2DoubleOpenCustomHashMap$EntrySpliterator extends Double2DoubleOpenCustomHashMap$MapSpliterator<(param0: Double2DoubleMap$Entry) => void, Double2DoubleOpenCustomHashMap$EntrySpliterator> implements ObjectSpliterator<Double2DoubleMap$Entry> {
