...
export class Double2FloatOpenCustomHashMap$KeyIterator extends Double2FloatOpenCustomHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2FloatOpenCustomHashMap$KeyIterator)
