...
export class Double2LongLinkedOpenHashMap$EntryIterator extends Double2LongLinkedOpenHashMap$MapIterator<(param0: Double2LongMap$Entry) => void> implements ObjectListIterator<Double2LongMap$Entry> {
    constructor(null_: Double2LongLinkedOpenHashMap$EntryIterator)
    constructor(null_: Double2LongLinkedOpenHashMap$EntryIterator, arg1: number)
