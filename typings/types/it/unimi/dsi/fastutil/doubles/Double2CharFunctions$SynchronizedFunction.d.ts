...
export class Double2CharFunctions$SynchronizedFunction extends Object implements Double2CharFunction, Serializable {
    constructor(arg0: (param0: number) => kotlin.Char)
    constructor(arg0: (param0: number) => kotlin.Char, arg1: Object)
    ...
    composeByte(arg0: (param0: number) => kotlin.Double): (param0: number) => kotlin.Char;
    composeChar(arg0: (param0: string) => kotlin.Double): (param0: string) => kotlin.Char;
    composeDouble(arg0: (param0: number) => kotlin.Double): (param0: number) => kotlin.Char;
    composeFloat(arg0: (param0: number) => kotlin.Double): (param0: number) => kotlin.Char;
    composeInt(arg0: (param0: number) => kotlin.Double): (param0: number) => kotlin.Char;
    composeLong(arg0: (param0: number) => kotlin.Double): (param0: number) => kotlin.Char;
    composeObject(arg0: (param0: T) => kotlin.Double): (param0: T) => kotlin.Char;
    composeReference(arg0: (param0: T) => kotlin.Double): (param0: T) => kotlin.Char;
    composeShort(arg0: (param0: number) => kotlin.Double): (param0: number) => kotlin.Char;
