...
export class Double2LongOpenHashMap$FastEntryIterator extends Double2LongOpenHashMap$MapIterator<(param0: Double2LongMap$Entry) => void> implements ObjectIterator<Double2LongMap$Entry> {
    private constructor(null_: Double2LongOpenHashMap$FastEntryIterator)
