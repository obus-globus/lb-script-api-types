...
export class Double2DoubleLinkedOpenHashMap$MapEntry extends Object implements Double2DoubleMap$Entry, DoubleDoublePair, Map$Entry<number, number> {
    ...
    constructor(null_: Double2DoubleLinkedOpenHashMap$MapEntry)
    constructor(null_: Double2DoubleLinkedOpenHashMap$MapEntry, arg1: number)
