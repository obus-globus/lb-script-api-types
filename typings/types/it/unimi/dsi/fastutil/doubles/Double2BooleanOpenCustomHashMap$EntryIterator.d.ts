...
export class Double2BooleanOpenCustomHashMap$EntryIterator extends Double2BooleanOpenCustomHashMap$MapIterator<(param0: Double2BooleanMap$Entry) => void> implements ObjectIterator<Double2BooleanMap$Entry> {
    private constructor(null_: Double2BooleanOpenCustomHashMap$EntryIterator)
