...
export class Double2FloatSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Double2FloatMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Double2FloatMap$Entry>;
