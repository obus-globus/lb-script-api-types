...
export class Double2DoubleOpenCustomHashMap$ValueIterator extends Double2DoubleOpenCustomHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2DoubleOpenCustomHashMap$ValueIterator)
