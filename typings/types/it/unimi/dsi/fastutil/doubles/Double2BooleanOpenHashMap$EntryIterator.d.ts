...
export class Double2BooleanOpenHashMap$EntryIterator extends Double2BooleanOpenHashMap$MapIterator<(param0: Double2BooleanMap$Entry) => void> implements ObjectIterator<Double2BooleanMap$Entry> {
    private constructor(null_: Double2BooleanOpenHashMap$EntryIterator)
