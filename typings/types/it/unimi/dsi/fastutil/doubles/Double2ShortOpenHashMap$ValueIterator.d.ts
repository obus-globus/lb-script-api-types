...
export class Double2ShortOpenHashMap$ValueIterator extends Double2ShortOpenHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Double2ShortOpenHashMap$ValueIterator)
