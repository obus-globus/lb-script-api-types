...
export class Double2ReferenceArrayMap$MapEntry extends Object implements Double2ReferenceMap$Entry<V>, DoubleReferencePair<V>, Map$Entry<number, V> {
    ...
    static of<V extends unknown>(paramarg0: number, paramarg1: V): DoubleReferencePair<V>;
