...
export class Double2IntOpenHashMap$KeyIterator extends Double2IntOpenHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Double2IntOpenHashMap$KeyIterator)
