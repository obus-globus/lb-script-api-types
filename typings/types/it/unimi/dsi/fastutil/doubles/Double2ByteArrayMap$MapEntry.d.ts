...
export class Double2ByteArrayMap$MapEntry extends Object implements Double2ByteMap$Entry, DoubleBytePair, Map$Entry<number, number> {
    ...
    constructor(null_: Double2ByteArrayMap$MapEntry)
    constructor(null_: Double2ByteArrayMap$MapEntry, arg1: number)
