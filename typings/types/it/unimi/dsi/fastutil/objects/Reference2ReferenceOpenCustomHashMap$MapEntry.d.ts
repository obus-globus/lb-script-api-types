...
export class Reference2ReferenceOpenCustomHashMap$MapEntry extends Object implements Reference2ReferenceMap$Entry<K, V>, ReferenceReferencePair<K, V>, Map$Entry<K, V> {
    ...
    constructor(null_: Reference2ReferenceOpenCustomHashMap$MapEntry)
    constructor(null_: Reference2ReferenceOpenCustomHashMap$MapEntry, arg1: number)
    ...
    right<K extends Object | number | string | boolean, V extends Object | number | string | boolean>(arg0: V): ReferenceReferencePair<K, V>;
