...
export class Reference2FloatSortedMaps extends Object {
    ...
    static fastIterable<K extends unknown>(paramarg0: { [key: string]: any }): Reference2FloatMap$Entry<K>[];
    static fastIterator<K extends unknown>(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Reference2FloatMap$Entry<K>>;
