...
export class Reference2BooleanArrayMap$MapEntry extends Object implements Reference2BooleanMap$Entry<K>, ReferenceBooleanPair<K>, Map$Entry<K, boolean> {
    ...
    constructor(null_: Reference2BooleanArrayMap$MapEntry)
