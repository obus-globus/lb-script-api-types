...
export class Reference2DoubleSortedMaps extends Object {
    ...
    static fastIterable<K extends unknown>(paramarg0: JavaMap<any, any>): Reference2DoubleMap$Entry<K>[];
    static fastIterator<K extends unknown>(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Reference2DoubleMap$Entry<K>>;
