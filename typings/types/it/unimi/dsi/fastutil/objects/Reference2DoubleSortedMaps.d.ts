...
export class Reference2DoubleSortedMaps extends Object {
    ...
    static fastIterable<K extends unknown>(paramarg0: { [key: string]: any }): Reference2DoubleMap$Entry<K>[];
    static fastIterator<K extends unknown>(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Reference2DoubleMap$Entry<K>>;
