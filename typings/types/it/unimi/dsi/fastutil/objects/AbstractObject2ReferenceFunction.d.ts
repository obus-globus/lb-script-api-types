...
export abstract class AbstractObject2ReferenceFunction<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends Object implements Object2ReferenceFunction<K, V>, Serializable {
    constructor()
