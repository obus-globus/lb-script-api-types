...
export abstract class AbstractObject2ReferenceFunction<K extends unknown, V extends unknown> extends Object implements Object2ReferenceFunction<K, V>, Serializable {
    constructor()
