...
export class Object2ObjectLinkedOpenHashMap$FastEntryIterator extends Object2ObjectLinkedOpenHashMap$MapIterator<Object> implements ObjectListIterator<Object2ObjectMap$Entry<K, V>> {
    constructor(null_: Object2ObjectLinkedOpenHashMap$FastEntryIterator)
    constructor(null_: Object2ObjectLinkedOpenHashMap$FastEntryIterator)
    ...
    next<K extends Object | number | string | boolean, V extends Object | number | string | boolean>(): Object2ObjectLinkedOpenHashMap$MapEntry;
    previous<K extends Object | number | string | boolean, V extends Object | number | string | boolean>(): Object2ObjectLinkedOpenHashMap$MapEntry;
    remove(): void;
