...
export class Reference2IntOpenHashMap$MapEntry extends Object implements Reference2IntMap$Entry<K>, ReferenceIntPair<K>, Map$Entry<K, number> {
    ...
    constructor(null_: Reference2IntOpenHashMap$MapEntry)
