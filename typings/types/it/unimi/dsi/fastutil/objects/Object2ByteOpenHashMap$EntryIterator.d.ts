...
export class Object2ByteOpenHashMap$EntryIterator extends Object2ByteOpenHashMap$MapIterator<Object> implements ObjectIterator<Object2ByteMap$Entry<K>> {
    private constructor(null_: Object2ByteOpenHashMap$EntryIterator)
    ...
    next<K extends Object | number | string | boolean>(): Object2ByteOpenHashMap$MapEntry;
    remove(): void;
