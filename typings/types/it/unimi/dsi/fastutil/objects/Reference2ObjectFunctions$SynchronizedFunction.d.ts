...
export class Reference2ObjectFunctions$SynchronizedFunction<K extends unknown, V extends unknown> extends Object implements Reference2ObjectFunction<K, V>, Serializable {
