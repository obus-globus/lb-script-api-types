...
export abstract class AbstractReference2ObjectFunction<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends Object implements Reference2ObjectFunction<K, V>, Serializable {
    constructor()
