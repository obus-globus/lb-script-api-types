...
export class Reference2CharOpenCustomHashMap$KeyIterator extends Reference2CharOpenCustomHashMap$MapIterator<Object> implements ObjectIterator<K> {
    constructor(null_: Reference2CharOpenCustomHashMap$KeyIterator)
