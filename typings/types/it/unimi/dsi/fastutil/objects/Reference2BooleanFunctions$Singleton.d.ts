...
export class Reference2BooleanFunctions$Singleton<K extends Object | number | string | boolean> extends AbstractReference2BooleanFunction<K> implements Serializable, Cloneable {
