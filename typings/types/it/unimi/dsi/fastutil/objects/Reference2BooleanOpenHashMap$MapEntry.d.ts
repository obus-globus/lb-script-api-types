...
export class Reference2BooleanOpenHashMap$MapEntry extends Object implements Reference2BooleanMap$Entry<K>, ReferenceBooleanPair<K>, Map$Entry<K, boolean> {
    ...
    constructor(null_: Reference2BooleanOpenHashMap$MapEntry)
