...
export abstract class AbstractReference2ReferenceFunction<K extends unknown, V extends unknown> extends Object implements Reference2ReferenceFunction<K, V>, Serializable {
    constructor()
