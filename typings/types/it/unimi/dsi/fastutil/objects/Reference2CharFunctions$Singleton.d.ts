...
export class Reference2CharFunctions$Singleton<K extends Object | number | string | boolean> extends AbstractReference2CharFunction<K> implements Serializable, Cloneable {
