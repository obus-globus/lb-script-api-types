...
export class Object2CharSortedMaps extends Object {
    ...
    static fastIterable<K extends unknown>(paramarg0: { [key: string]: any }): Object2CharMap$Entry<K>[];
    static fastIterator<K extends unknown>(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Object2CharMap$Entry<K>>;
