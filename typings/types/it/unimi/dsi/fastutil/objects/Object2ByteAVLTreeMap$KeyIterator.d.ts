...
export class Object2ByteAVLTreeMap$KeyIterator extends Object2ByteAVLTreeMap$TreeIterator implements ObjectListIterator<K> {
    constructor(null_: Object2ByteAVLTreeMap$KeyIterator)
    constructor(null_: Object2ByteAVLTreeMap$KeyIterator)
