...
export abstract class AbstractObjectBigListIterator<K extends unknown> extends AbstractObjectBidirectionalIterator<K> implements ObjectBigListIterator<K> {
    constructor()
    add(arg0: K): void;
