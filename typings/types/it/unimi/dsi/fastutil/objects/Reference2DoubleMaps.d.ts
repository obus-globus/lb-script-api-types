...
export class Reference2DoubleMaps extends Object {
    ...
    static fastForEach(paramarg0: Reference2DoubleMap<Object>, paramarg1: (param0: Object | null) => void): void;
    static fastIterable(paramarg0: Reference2DoubleMap<Object>): K[];
    static fastIterator(paramarg0: Reference2DoubleMap<Object>): ObjectIterator<Object>;
