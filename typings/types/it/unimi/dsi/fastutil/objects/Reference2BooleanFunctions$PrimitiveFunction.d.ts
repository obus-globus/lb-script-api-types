...
export class Reference2BooleanFunctions$PrimitiveFunction<K extends Object | number | string | boolean> extends Object implements Reference2BooleanFunction<K> {
    constructor(arg0: (param0: K) => boolean)
    // private function: (param0: K) => boolean;
