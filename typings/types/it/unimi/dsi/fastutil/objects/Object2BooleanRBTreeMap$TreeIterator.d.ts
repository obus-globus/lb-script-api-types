...
export class Object2BooleanRBTreeMap$TreeIterator extends Object {
    constructor(null_: Object2BooleanRBTreeMap$TreeIterator)
    constructor(null_: Object2BooleanRBTreeMap$TreeIterator)
    ...
    hasNext(): boolean;
    hasPrevious(): boolean;
    nextEntry<K extends Object | number | string | boolean>(): Object2BooleanRBTreeMap$Entry<K>;
    nextIndex(): number;
    previousEntry<K extends Object | number | string | boolean>(): Object2BooleanRBTreeMap$Entry<K>;
