...
export class Reference2ReferenceOpenHashMap$MapEntry extends Object implements Reference2ReferenceMap$Entry<K, V>, ReferenceReferencePair<K, V>, Map$Entry<K, V> {
    ...
    constructor(null_: Reference2ReferenceOpenHashMap$MapEntry)
    constructor(null_: Reference2ReferenceOpenHashMap$MapEntry, arg1: number)
