...
export class Object2ReferenceRBTreeMap$Entry<K extends unknown, V extends unknown> extends AbstractObject2ReferenceMap$BasicEntry<K, V> implements Cloneable {
    constructor()
