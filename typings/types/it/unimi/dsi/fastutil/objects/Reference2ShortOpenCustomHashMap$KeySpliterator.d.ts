...
export class Reference2ShortOpenCustomHashMap$KeySpliterator extends Reference2ShortOpenCustomHashMap$MapSpliterator<Object, any> implements ObjectSpliterator<K> {
    ...
    makeForSplit<K extends unknown>(arg0: number, arg1: number, arg2: boolean): Reference2ShortOpenCustomHashMap$KeySpliterator;
