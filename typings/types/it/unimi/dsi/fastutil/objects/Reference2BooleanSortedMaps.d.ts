...
export class Reference2BooleanSortedMaps extends Object {
    ...
    static fastIterable<K extends unknown>(paramarg0: JavaMap<any, any>): Reference2BooleanMap$Entry<K>[];
    static fastIterator<K extends unknown>(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Reference2BooleanMap$Entry<K>>;
    static singleton<K extends unknown>(paramarg0: K, paramarg1: boolean): JavaMap<any, any>;
    static singleton<K extends unknown>(paramarg0: K, paramarg1: boolean, paramarg2: (param0: Object, param1: Object) => number): JavaMap<any, any>;
