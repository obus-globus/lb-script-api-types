...
export class Reference2BooleanSortedMaps extends Object {
    ...
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Reference2BooleanMap$Entry<Object>>;
    static singleton(paramarg0: Object | null, paramarg1: boolean): { [key: string]: any };
    static singleton(paramarg0: Object | null, paramarg1: boolean, paramarg2: (param0: Object, param1: Object) => number): { [key: string]: any };
