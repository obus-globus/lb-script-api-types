...
export class Reference2BooleanSortedMaps extends Object {
    ...
    static fastIterator<K extends unknown>(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Reference2BooleanMap$Entry<K>>;
    static singleton<K extends unknown>(paramarg0: K, paramarg1: boolean): { [key: string]: any };
    static singleton<K extends unknown>(paramarg0: K, paramarg1: boolean, paramarg2: (param0: Object, param1: Object) => number): { [key: string]: any };
