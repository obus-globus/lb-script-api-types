...
export class Reference2CharSortedMaps extends Object {
    ...
    static fastIterable<K extends unknown>(paramarg0: { [key: string]: any }): Reference2CharMap$Entry<K>[];
    static fastIterator<K extends unknown>(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Reference2CharMap$Entry<K>>;
    static singleton<K extends unknown>(paramarg0: K, paramarg1: string): { [key: string]: any };
    static singleton<K extends unknown>(paramarg0: K, paramarg1: string, paramarg2: (param0: Object, param1: Object) => number): { [key: string]: any };
