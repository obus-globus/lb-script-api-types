...
export class Reference2CharOpenHashMap$EntrySpliterator {
    ...
    makeForSplit<K extends unknown>(arg0: number, arg1: number, arg2: boolean): Reference2CharOpenHashMap$EntrySpliterator;
}