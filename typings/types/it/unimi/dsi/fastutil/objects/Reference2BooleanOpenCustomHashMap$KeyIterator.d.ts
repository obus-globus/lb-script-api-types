...
export class Reference2BooleanOpenCustomHashMap$KeyIterator extends Reference2BooleanOpenCustomHashMap$MapIterator<Object> implements ObjectIterator<K> {
    constructor(null_: Reference2BooleanOpenCustomHashMap$KeyIterator)
