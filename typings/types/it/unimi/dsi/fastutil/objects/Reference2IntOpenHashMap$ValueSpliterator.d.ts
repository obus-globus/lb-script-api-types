...
export class Reference2IntOpenHashMap$ValueSpliterator extends Reference2IntOpenHashMap$MapSpliterator<Object, any> implements IntSpliterator {
    ...
    constructor(null_: Reference2IntOpenHashMap$ValueSpliterator)
    constructor(null_: Reference2IntOpenHashMap$ValueSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => number;
    makeForSplit<K extends Object | number | string | boolean>(arg0: number, arg1: number, arg2: boolean): Reference2IntOpenHashMap$ValueSpliterator;
