...
export class ObjectArrays$ForkJoinQuickSortIndirect<K extends Object | number | string | boolean> extends RecursiveAction {
    ...
    constructor(arg0: number[], arg1: K[], arg2: number, arg3: number)
    // private from: number;
    // private perm: number[];
    // private to: number;
    // private x: K[];
