...
export class Reference2CharLinkedOpenHashMap$MapEntry extends Object implements Reference2CharMap$Entry<K>, ReferenceCharPair<K>, Map$Entry<K, string> {
    ...
    constructor(null_: Reference2CharLinkedOpenHashMap$MapEntry)
    constructor(null_: Reference2CharLinkedOpenHashMap$MapEntry, arg1: number)
