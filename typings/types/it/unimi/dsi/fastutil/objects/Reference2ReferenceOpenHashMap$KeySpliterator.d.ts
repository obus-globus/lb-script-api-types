...
export class Reference2ReferenceOpenHashMap$KeySpliterator extends Reference2ReferenceOpenHashMap$MapSpliterator<Object, any> implements ObjectSpliterator<K> {
    ...
    makeForSplit<K extends unknown, V extends unknown>(arg0: number, arg1: number, arg2: boolean): Reference2ReferenceOpenHashMap$KeySpliterator;
