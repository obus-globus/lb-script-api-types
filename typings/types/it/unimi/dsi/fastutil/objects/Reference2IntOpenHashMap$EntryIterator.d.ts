...
export class Reference2IntOpenHashMap$EntryIterator extends Reference2IntOpenHashMap$MapIterator<Object> implements ObjectIterator<Reference2IntMap$Entry<K>> {
    private constructor(null_: Reference2IntOpenHashMap$EntryIterator)
    ...
    next<K extends unknown>(): Reference2IntOpenHashMap$MapEntry;
    remove(): void;
