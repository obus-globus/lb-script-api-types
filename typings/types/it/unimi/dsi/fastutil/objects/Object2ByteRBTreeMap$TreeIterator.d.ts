...
export class Object2ByteRBTreeMap$TreeIterator extends Object {
    constructor(null_: Object2ByteRBTreeMap$TreeIterator)
    constructor(null_: Object2ByteRBTreeMap$TreeIterator)
    ...
    hasNext(): boolean;
    hasPrevious(): boolean;
    nextEntry<K extends Object | number | string | boolean>(): Object2ByteRBTreeMap$Entry<K>;
    nextIndex(): number;
    previousEntry<K extends Object | number | string | boolean>(): Object2ByteRBTreeMap$Entry<K>;
