...
export class Reference2LongFunctions$SynchronizedFunction<K extends Object | number | string | boolean> extends Object implements Reference2LongFunction<K>, Serializable {
    constructor(arg0: (param0: K) => kotlin.Long)
    constructor(arg0: (param0: K) => kotlin.Long, arg1: Object)
    ...
    applyAsLong(arg0: K): number;
    clear(): void;
    composeByte(arg0: (param0: K) => unknown): (param0: number) => kotlin.Long;
    composeChar(arg0: (param0: K) => unknown): (param0: string) => kotlin.Long;
    composeDouble(arg0: (param0: K) => unknown): (param0: number) => kotlin.Long;
    composeFloat(arg0: (param0: K) => unknown): (param0: number) => kotlin.Long;
    composeInt(arg0: (param0: K) => unknown): (param0: number) => kotlin.Long;
    composeLong(arg0: (param0: K) => unknown): (param0: number) => kotlin.Long;
    composeObject(arg0: (param0: T) => K): (param0: T) => kotlin.Long;
    composeReference(arg0: (param0: T) => K): (param0: T) => kotlin.Long;
    composeShort(arg0: (param0: K) => unknown): (param0: number) => kotlin.Long;
