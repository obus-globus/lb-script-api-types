...
export class Reference2CharOpenCustomHashMap$EntrySpliterator {
    ...
    makeForSplit<K extends unknown>(arg0: number, arg1: number, arg2: boolean): Reference2CharOpenCustomHashMap$EntrySpliterator;
}