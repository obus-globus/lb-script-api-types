...
export class Object2LongMaps extends Object {
    ...
    static fastForEach(paramarg0: Object2LongMap<Object>, paramarg1: (param0: Object | null) => void): void;
    static fastIterable(paramarg0: Object2LongMap<Object>): K[];
    static fastIterator(paramarg0: Object2LongMap<Object>): ObjectIterator<Object>;
