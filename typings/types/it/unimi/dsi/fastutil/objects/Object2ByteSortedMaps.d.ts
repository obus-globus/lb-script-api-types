...
export class Object2ByteSortedMaps extends Object {
    ...
    static fastIterable<K extends unknown>(paramarg0: JavaMap<any, any>): Object2ByteMap$Entry<K>[];
    static fastIterator<K extends unknown>(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Object2ByteMap$Entry<K>>;
