...
export class Reference2ShortOpenHashMap$KeySpliterator extends Reference2ShortOpenHashMap$MapSpliterator<Object, any> implements ObjectSpliterator<K> {
    ...
    makeForSplit<K extends unknown>(arg0: number, arg1: number, arg2: boolean): Reference2ShortOpenHashMap$KeySpliterator;
