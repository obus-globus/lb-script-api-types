...
export class Object2ShortMaps extends Object {
    ...
    static fastForEach(paramarg0: Object2ShortMap<Object>, paramarg1: (param0: Object | null) => void): void;
    static fastIterable(paramarg0: Object2ShortMap<Object>): K[];
    static fastIterator(paramarg0: Object2ShortMap<Object>): ObjectIterator<Object>;
