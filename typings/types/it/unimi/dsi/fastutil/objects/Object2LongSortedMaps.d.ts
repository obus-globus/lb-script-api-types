...
export class Object2LongSortedMaps extends Object {
    ...
    static fastIterable<K extends unknown>(paramarg0: JavaMap<any, any>): Object2LongMap$Entry<K>[];
    static fastIterator<K extends unknown>(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Object2LongMap$Entry<K>>;
