...
export class Reference2BooleanMaps extends Object {
    ...
    static fastForEach(paramarg0: Reference2BooleanMap<Object>, paramarg1: (param0: Object) => void): void;
    static fastIterable(paramarg0: Reference2BooleanMap<Object>): Reference2BooleanMap$Entry<Object>[];
    static fastIterator(paramarg0: Reference2BooleanMap<Object>): ObjectIterator<Reference2BooleanMap$Entry<Object>>;
