...
export class Object2ReferenceAVLTreeMap$Entry<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends AbstractObject2ReferenceMap$BasicEntry<K, V> implements Cloneable {
    constructor()
