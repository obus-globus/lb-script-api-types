...
export class AbstractObject2ReferenceSortedMap$ValuesIterator<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends Object implements ObjectIterator<V> {
