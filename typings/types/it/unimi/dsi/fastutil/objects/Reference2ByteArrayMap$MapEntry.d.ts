...
export class Reference2ByteArrayMap$MapEntry extends Object implements Reference2ByteMap$Entry<K>, ReferenceBytePair<K>, Map$Entry<K, number> {
    ...
    constructor(null_: Reference2ByteArrayMap$MapEntry)
    constructor(null_: Reference2ByteArrayMap$MapEntry, arg1: number)
