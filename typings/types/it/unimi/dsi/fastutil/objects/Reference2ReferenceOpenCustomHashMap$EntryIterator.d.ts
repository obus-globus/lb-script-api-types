...
export class Reference2ReferenceOpenCustomHashMap$EntryIterator extends Reference2ReferenceOpenCustomHashMap$MapIterator<Object> implements ObjectIterator<Reference2ReferenceMap$Entry<K, V>> {
    private constructor(null_: Reference2ReferenceOpenCustomHashMap$EntryIterator)
    ...
    next<K extends Object | number | string | boolean, V extends Object | number | string | boolean>(): Reference2ReferenceOpenCustomHashMap$MapEntry;
    remove(): void;
