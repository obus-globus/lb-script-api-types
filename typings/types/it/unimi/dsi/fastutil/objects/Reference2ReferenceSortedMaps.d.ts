...
export class Reference2ReferenceSortedMaps extends Object {
    ...
    static fastIterable<K extends unknown, V extends unknown>(paramarg0: JavaMap<K, V>): Reference2ReferenceMap$Entry<K, V>[];
    static fastIterator<K extends unknown, V extends unknown>(paramarg0: JavaMap<K, V>): ObjectBidirectionalIterator<Reference2ReferenceMap$Entry<K, V>>;
