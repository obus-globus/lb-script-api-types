...
export class Reference2ReferenceSortedMaps extends Object {
    ...
    static fastIterable<K extends unknown, V extends unknown>(paramarg0: Map<K, V>): Reference2ReferenceMap$Entry<K, V>[];
    static fastIterator<K extends unknown, V extends unknown>(paramarg0: Map<K, V>): ObjectBidirectionalIterator<Reference2ReferenceMap$Entry<K, V>>;
