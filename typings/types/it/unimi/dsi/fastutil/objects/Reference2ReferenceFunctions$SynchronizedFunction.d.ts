...
export class Reference2ReferenceFunctions$SynchronizedFunction<K extends unknown, V extends unknown> extends Object implements Reference2ReferenceFunction<K, V>, Serializable {
