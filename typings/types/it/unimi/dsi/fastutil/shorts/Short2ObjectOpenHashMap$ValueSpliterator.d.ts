...
export class Short2ObjectOpenHashMap$ValueSpliterator extends Short2ObjectOpenHashMap$MapSpliterator<Object, any> implements ObjectSpliterator<V> {
    ...
    makeForSplit<V extends unknown>(arg0: number, arg1: number, arg2: boolean): Short2ObjectOpenHashMap$ValueSpliterator;
