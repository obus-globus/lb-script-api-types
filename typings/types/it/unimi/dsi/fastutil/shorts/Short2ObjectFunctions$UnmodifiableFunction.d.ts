...
export class Short2ObjectFunctions$UnmodifiableFunction<V extends Object | number | string | boolean> extends AbstractShort2ObjectFunction<V> implements Serializable {
