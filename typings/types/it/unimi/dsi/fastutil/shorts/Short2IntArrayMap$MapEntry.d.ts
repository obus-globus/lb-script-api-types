...
export class Short2IntArrayMap$MapEntry extends Object implements Short2IntMap$Entry, ShortIntPair, Map$Entry<number, number> {
    ...
    constructor(null_: Short2IntArrayMap$MapEntry)
    constructor(null_: Short2IntArrayMap$MapEntry, arg1: number)
