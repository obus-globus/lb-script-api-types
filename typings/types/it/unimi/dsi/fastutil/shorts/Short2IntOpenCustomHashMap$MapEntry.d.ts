...
export class Short2IntOpenCustomHashMap$MapEntry extends Object implements Short2IntMap$Entry, ShortIntPair, Map$Entry<number, number> {
    ...
    constructor(null_: Short2IntOpenCustomHashMap$MapEntry)
    constructor(null_: Short2IntOpenCustomHashMap$MapEntry, arg1: number)
