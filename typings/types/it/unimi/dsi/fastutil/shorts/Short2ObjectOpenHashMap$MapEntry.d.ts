...
export class Short2ObjectOpenHashMap$MapEntry extends Object implements Short2ObjectMap$Entry<V>, ShortObjectPair<V>, Map$Entry<number, V> {
    ...
    constructor(null_: Short2ObjectOpenHashMap$MapEntry)
    constructor(null_: Short2ObjectOpenHashMap$MapEntry, arg1: number)
