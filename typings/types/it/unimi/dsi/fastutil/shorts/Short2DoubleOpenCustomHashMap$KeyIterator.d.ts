...
export class Short2DoubleOpenCustomHashMap$KeyIterator extends Short2DoubleOpenCustomHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Short2DoubleOpenCustomHashMap$KeyIterator)
