...
export class Short2ByteOpenHashMap$MapEntry extends Object implements Short2ByteMap$Entry, ShortBytePair, Map$Entry<number, number> {
    ...
    constructor(null_: Short2ByteOpenHashMap$MapEntry)
    constructor(null_: Short2ByteOpenHashMap$MapEntry, arg1: number)
