...
export class Short2ReferenceMaps extends Object {
    ...
    static fastForEach(paramarg0: Short2ReferenceMap<Object>, paramarg1: (param0: Object | null) => void): void;
    static fastIterable(paramarg0: Short2ReferenceMap<Object>): K[];
    static fastIterator(paramarg0: Short2ReferenceMap<Object>): ObjectIterator<Object>;
