...
export class Short2CharOpenCustomHashMap$EntryIterator extends Short2CharOpenCustomHashMap$MapIterator<(param0: Short2CharMap$Entry) => void> implements ObjectIterator<Short2CharMap$Entry> {
    private constructor(null_: Short2CharOpenCustomHashMap$EntryIterator)
