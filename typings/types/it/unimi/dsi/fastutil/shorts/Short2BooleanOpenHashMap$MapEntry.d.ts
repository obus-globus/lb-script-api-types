...
export class Short2BooleanOpenHashMap$MapEntry extends Object implements Short2BooleanMap$Entry, ShortBooleanPair, Map$Entry<number, boolean> {
    ...
    constructor(null_: Short2BooleanOpenHashMap$MapEntry)
    constructor(null_: Short2BooleanOpenHashMap$MapEntry, arg1: number)
