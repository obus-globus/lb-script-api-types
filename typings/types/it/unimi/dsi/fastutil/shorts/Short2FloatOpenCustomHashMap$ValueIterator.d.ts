...
export class Short2FloatOpenCustomHashMap$ValueIterator extends Short2FloatOpenCustomHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Short2FloatOpenCustomHashMap$ValueIterator)
