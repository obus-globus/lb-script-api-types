...
export class Short2DoubleLinkedOpenHashMap$MapEntry extends Object implements Short2DoubleMap$Entry, ShortDoublePair, Map$Entry<number, number> {
    ...
    constructor(null_: Short2DoubleLinkedOpenHashMap$MapEntry)
    constructor(null_: Short2DoubleLinkedOpenHashMap$MapEntry, arg1: number)
