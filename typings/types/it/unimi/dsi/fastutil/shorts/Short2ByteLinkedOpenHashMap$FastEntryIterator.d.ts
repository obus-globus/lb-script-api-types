...
export class Short2ByteLinkedOpenHashMap$FastEntryIterator extends Short2ByteLinkedOpenHashMap$MapIterator<(param0: Short2ByteMap$Entry) => void> implements ObjectListIterator<Short2ByteMap$Entry> {
    constructor(null_: Short2ByteLinkedOpenHashMap$FastEntryIterator)
    constructor(null_: Short2ByteLinkedOpenHashMap$FastEntryIterator, arg1: number)
