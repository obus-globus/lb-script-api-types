...
export class Short2IntOpenHashMap$KeyIterator extends Short2IntOpenHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Short2IntOpenHashMap$KeyIterator)
