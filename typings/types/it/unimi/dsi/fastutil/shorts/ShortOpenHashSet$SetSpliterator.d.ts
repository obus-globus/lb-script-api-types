...
export class ShortOpenHashSet$SetSpliterator extends Object implements ShortSpliterator {
    ...
    constructor(null_: ShortOpenHashSet$SetSpliterator)
    constructor(null_: ShortOpenHashSet$SetSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    // private c: number;
    ...
    trySplit(): ShortOpenHashSet$SetSpliterator;
}