...
export class Short2FloatArrayMap$MapEntry extends Object implements Short2FloatMap$Entry, ShortFloatPair, Map$Entry<number, number> {
    ...
    constructor(null_: Short2FloatArrayMap$MapEntry)
    constructor(null_: Short2FloatArrayMap$MapEntry, arg1: number)
