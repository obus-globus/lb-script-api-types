...
export class Short2CharLinkedOpenHashMap$MapEntry extends Object implements Short2CharMap$Entry, ShortCharPair, Map$Entry<number, string> {
    ...
    constructor(null_: Short2CharLinkedOpenHashMap$MapEntry)
    constructor(null_: Short2CharLinkedOpenHashMap$MapEntry, arg1: number)
