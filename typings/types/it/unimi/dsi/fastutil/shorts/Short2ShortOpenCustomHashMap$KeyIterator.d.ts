...
export class Short2ShortOpenCustomHashMap$KeyIterator extends Short2ShortOpenCustomHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Short2ShortOpenCustomHashMap$KeyIterator)
