...
export class Short2CharSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Short2CharMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Short2CharMap$Entry>;
