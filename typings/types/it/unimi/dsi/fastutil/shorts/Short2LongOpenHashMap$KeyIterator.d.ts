...
export class Short2LongOpenHashMap$KeyIterator extends Short2LongOpenHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Short2LongOpenHashMap$KeyIterator)
