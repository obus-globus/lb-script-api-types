...
export class Short2DoubleOpenHashMap$ValueSpliterator extends Short2DoubleOpenHashMap$MapSpliterator<(param0: number) => void, Short2DoubleOpenHashMap$ValueSpliterator> implements DoubleSpliterator {
    ...
    constructor(null_: Short2DoubleOpenHashMap$ValueSpliterator)
    constructor(null_: Short2DoubleOpenHashMap$ValueSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => kotlin.Int;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Short2DoubleOpenHashMap$ValueSpliterator;
