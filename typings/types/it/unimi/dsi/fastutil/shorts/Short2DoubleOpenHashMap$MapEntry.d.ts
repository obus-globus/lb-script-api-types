...
export class Short2DoubleOpenHashMap$MapEntry extends Object implements Short2DoubleMap$Entry, ShortDoublePair, Map$Entry<number, number> {
    ...
    constructor(null_: Short2DoubleOpenHashMap$MapEntry)
    constructor(null_: Short2DoubleOpenHashMap$MapEntry, arg1: number)
