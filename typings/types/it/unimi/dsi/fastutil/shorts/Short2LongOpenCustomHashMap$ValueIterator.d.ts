...
export class Short2LongOpenCustomHashMap$ValueIterator extends Short2LongOpenCustomHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Short2LongOpenCustomHashMap$ValueIterator)
