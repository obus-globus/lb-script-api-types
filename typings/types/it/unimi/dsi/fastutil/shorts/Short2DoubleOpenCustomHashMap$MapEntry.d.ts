...
export class Short2DoubleOpenCustomHashMap$MapEntry extends Object implements Short2DoubleMap$Entry, ShortDoublePair, Map$Entry<number, number> {
    ...
    constructor(null_: Short2DoubleOpenCustomHashMap$MapEntry)
    constructor(null_: Short2DoubleOpenCustomHashMap$MapEntry, arg1: number)
