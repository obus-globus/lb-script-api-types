...
export class Short2CharOpenHashMap$MapEntry extends Object implements Short2CharMap$Entry, ShortCharPair, Map$Entry<number, string> {
    ...
    constructor(null_: Short2CharOpenHashMap$MapEntry)
    constructor(null_: Short2CharOpenHashMap$MapEntry, arg1: number)
