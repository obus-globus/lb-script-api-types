...
export class Short2LongSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Short2LongMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Short2LongMap$Entry>;
