...
export class Short2IntOpenCustomHashMap$KeyIterator extends Short2IntOpenCustomHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Short2IntOpenCustomHashMap$KeyIterator)
