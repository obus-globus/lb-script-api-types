...
export class Short2ByteOpenCustomHashMap$MapEntry extends Object implements Short2ByteMap$Entry, ShortBytePair, Map$Entry<number, number> {
    ...
    constructor(null_: Short2ByteOpenCustomHashMap$MapEntry)
    constructor(null_: Short2ByteOpenCustomHashMap$MapEntry, arg1: number)
