...
export class Short2IntSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Short2IntMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Short2IntMap$Entry>;
