...
export class Short2ByteOpenCustomHashMap$KeyIterator extends Short2ByteOpenCustomHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Short2ByteOpenCustomHashMap$KeyIterator)
