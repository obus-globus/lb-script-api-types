...
export class Short2LongOpenHashMap$MapEntry extends Object implements Short2LongMap$Entry, ShortLongPair, Map$Entry<number, number> {
    ...
    constructor(null_: Short2LongOpenHashMap$MapEntry)
    constructor(null_: Short2LongOpenHashMap$MapEntry, arg1: number)
