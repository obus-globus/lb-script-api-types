...
export class Short2ObjectLinkedOpenHashMap$MapEntry extends Object implements Short2ObjectMap$Entry<V>, ShortObjectPair<V>, Map$Entry<number, V> {
    ...
    static lexComparator(): (param0: ShortObjectPair<Object>, param1: ShortObjectPair<Object>) => number;
