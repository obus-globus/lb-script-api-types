...
export class ShortLongMutablePair extends Object implements ShortLongPair, Serializable {
    static lexComparator(): (param0: Object) => boolean;
    static of(paramarg0: number, paramarg1: number): ShortLongMutablePair;
    ...
    left(arg0: number): ShortLongMutablePair;
    leftShort(): number;
    right(): number;
    right(arg0: number): ShortLongPair;
    right(arg0: number): ShortLongMutablePair;
    rightLong(): number;
    second(): number;
