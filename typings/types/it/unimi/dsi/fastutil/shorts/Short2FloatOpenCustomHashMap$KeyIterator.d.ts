...
export class Short2FloatOpenCustomHashMap$KeyIterator extends Short2FloatOpenCustomHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Short2FloatOpenCustomHashMap$KeyIterator)
