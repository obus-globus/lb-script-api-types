...
export class Short2ReferenceSortedMaps extends Object {
    ...
    static fastIterable<V extends unknown>(paramarg0: JavaMap<any, any>): Short2ReferenceMap$Entry<V>[];
    static fastIterator<V extends unknown>(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Short2ReferenceMap$Entry<V>>;
