...
export class Short2ReferenceSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: Short2ReferenceSortedMap<Object>): Short2ReferenceMap$Entry<Object>[];
    static fastIterator(paramarg0: Short2ReferenceSortedMap<Object>): ObjectBidirectionalIterator<Short2ReferenceMap$Entry<Object>>;
    static singleton(paramarg0: number, paramarg1: Object | null): Short2ReferenceSortedMap<Object>;
    static singleton(paramarg0: number, paramarg1: Object | null, paramarg2: (param0: number, param1: number) => number): Short2ReferenceSortedMap<Object>;
    static singleton(paramarg0: number, paramarg1: Object | null): Short2ReferenceSortedMap<Object>;
    static singleton(paramarg0: number, paramarg1: Object | null, paramarg2: (param0: number, param1: number) => number): Short2ReferenceSortedMap<Object>;
