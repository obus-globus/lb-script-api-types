...
export class Short2ShortLinkedOpenHashMap$MapEntry extends Object implements Short2ShortMap$Entry, ShortShortPair, Map$Entry<number, number> {
    ...
    constructor(null_: Short2ShortLinkedOpenHashMap$MapEntry)
    constructor(null_: Short2ShortLinkedOpenHashMap$MapEntry, arg1: number)
