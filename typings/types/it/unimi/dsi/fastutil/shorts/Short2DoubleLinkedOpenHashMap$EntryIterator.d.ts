...
export class Short2DoubleLinkedOpenHashMap$EntryIterator extends Short2DoubleLinkedOpenHashMap$MapIterator<(param0: Short2DoubleMap$Entry) => void> implements ObjectListIterator<Short2DoubleMap$Entry> {
    constructor(null_: Short2DoubleLinkedOpenHashMap$EntryIterator)
    constructor(null_: Short2DoubleLinkedOpenHashMap$EntryIterator, arg1: number)
