...
export class Short2FloatLinkedOpenHashMap$FastEntryIterator extends Short2FloatLinkedOpenHashMap$MapIterator<(param0: Short2FloatMap$Entry) => void> implements ObjectListIterator<Short2FloatMap$Entry> {
    constructor(null_: Short2FloatLinkedOpenHashMap$FastEntryIterator)
    constructor(null_: Short2FloatLinkedOpenHashMap$FastEntryIterator, arg1: number)
