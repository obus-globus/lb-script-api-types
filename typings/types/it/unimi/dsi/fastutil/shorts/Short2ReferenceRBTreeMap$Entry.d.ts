...
export class Short2ReferenceRBTreeMap$Entry<V extends Object | number | string | boolean> extends AbstractShort2ReferenceMap$BasicEntry<V> implements Cloneable {
    constructor()
