...
export class Short2LongLinkedOpenHashMap$MapEntry extends Object implements Short2LongMap$Entry, ShortLongPair, Map$Entry<number, number> {
    ...
    constructor(null_: Short2LongLinkedOpenHashMap$MapEntry)
    constructor(null_: Short2LongLinkedOpenHashMap$MapEntry, arg1: number)
