...
export class Short2DoubleSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Short2DoubleMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Short2DoubleMap$Entry>;
