...
export class Short2IntOpenHashMap$ValueIterator extends Short2IntOpenHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Short2IntOpenHashMap$ValueIterator)
