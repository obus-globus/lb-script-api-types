...
export class BooleanIntImmutablePair extends Object implements BooleanIntPair, Serializable {
    static lexComparator(): (param0: BooleanIntPair) => kotlin.Boolean;
    static of(paramarg0: boolean, paramarg1: number): BooleanIntImmutablePair;
