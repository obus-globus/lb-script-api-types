...
export class BooleanCharMutablePair extends Object implements BooleanCharPair, Serializable {
    static lexComparator(): (param0: BooleanCharPair) => kotlin.Boolean;
    static of(paramarg0: boolean, paramarg1: string): BooleanCharMutablePair;
    ...
    key(arg0: boolean): BooleanCharPair;
    keyBoolean(): boolean;
    left(arg0: boolean): BooleanCharMutablePair;
    left(): boolean;
    left(arg0: boolean): BooleanCharPair;
    left(arg0: boolean): BooleanCharPair;
    leftBoolean(): boolean;
    right(arg0: string): BooleanCharMutablePair;
    right(): string;
