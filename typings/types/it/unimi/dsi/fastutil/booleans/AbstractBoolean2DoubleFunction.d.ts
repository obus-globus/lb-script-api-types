...
export abstract class AbstractBoolean2DoubleFunction extends Object implements Boolean2DoubleFunction, Serializable {
    constructor()
    ...
    composeByte(arg0: (param0: number) => kotlin.Boolean): (param0: number) => kotlin.Double;
    composeChar(arg0: (param0: string) => kotlin.Boolean): (param0: string) => kotlin.Double;
    composeDouble(arg0: (param0: number) => kotlin.Boolean): (param0: number) => kotlin.Double;
    composeFloat(arg0: (param0: number) => kotlin.Boolean): (param0: number) => kotlin.Double;
    composeInt(arg0: (param0: number) => kotlin.Boolean): (param0: number) => kotlin.Double;
    composeLong(arg0: (param0: number) => kotlin.Boolean): (param0: number) => kotlin.Double;
    composeObject(arg0: (param0: T) => kotlin.Boolean): (param0: T) => kotlin.Double;
    composeReference(arg0: (param0: T) => kotlin.Boolean): (param0: T) => kotlin.Double;
    composeShort(arg0: (param0: number) => kotlin.Boolean): (param0: number) => kotlin.Double;
