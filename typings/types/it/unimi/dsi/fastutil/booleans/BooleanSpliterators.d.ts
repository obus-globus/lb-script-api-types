...
export class BooleanSpliterators extends Object {
    ...
    static concat(...paramarg0: BooleanSpliterator[]): BooleanSpliterator;
    static concat(paramarg0: BooleanSpliterator[], paramarg1: number, paramarg2: number): BooleanSpliterator;
    ...
    static wrap(paramarg0: boolean[]): BooleanSpliterator;
    static wrap(paramarg0: boolean[], paramarg1: number, paramarg2: number): BooleanSpliterator;
    static wrap(paramarg0: boolean[], paramarg1: number, paramarg2: number, paramarg3: number): BooleanSpliterator;
    static wrapPreSorted(paramarg0: boolean[], paramarg1: number, paramarg2: number, paramarg3: number, paramarg4: (param0: boolean, param1: boolean) => number): BooleanSpliterator;
    static wrapPreSorted(paramarg0: boolean[], paramarg1: number, paramarg2: number, paramarg3: (param0: boolean, param1: boolean) => number): BooleanSpliterator;
    static wrapPreSorted(paramarg0: boolean[], paramarg1: (param0: boolean, param1: boolean) => number): BooleanSpliterator;
    private constructor()
}