...
export class Long2ShortSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Long2ShortMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Long2ShortMap$Entry>;
