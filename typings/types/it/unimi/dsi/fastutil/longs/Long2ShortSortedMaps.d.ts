...
export class Long2ShortSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Long2ShortMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Long2ShortMap$Entry>;
