...
export class Long2IntOpenCustomHashMap$KeyIterator extends Long2IntOpenCustomHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Long2IntOpenCustomHashMap$KeyIterator)
