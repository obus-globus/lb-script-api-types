...
export class Long2FloatOpenHashMap$ValueIterator extends Long2FloatOpenHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Long2FloatOpenHashMap$ValueIterator)
