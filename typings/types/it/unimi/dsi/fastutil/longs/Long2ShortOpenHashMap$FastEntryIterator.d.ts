...
export class Long2ShortOpenHashMap$FastEntryIterator extends Long2ShortOpenHashMap$MapIterator<(param0: Long2ShortMap$Entry) => void> implements ObjectIterator<Long2ShortMap$Entry> {
    private constructor(null_: Long2ShortOpenHashMap$FastEntryIterator)
