...
export class Long2ObjectArrayMap$MapEntry extends Object implements Long2ObjectMap$Entry<V>, LongObjectPair<V>, Map$Entry<number, V> {
    ...
    constructor(null_: Long2ObjectArrayMap$MapEntry)
    constructor(null_: Long2ObjectArrayMap$MapEntry, arg1: number)
