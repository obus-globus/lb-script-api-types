...
export class Long2ShortOpenCustomHashMap$ValueIterator extends Long2ShortOpenCustomHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Long2ShortOpenCustomHashMap$ValueIterator)
