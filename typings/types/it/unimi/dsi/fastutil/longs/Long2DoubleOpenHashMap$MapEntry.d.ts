...
export class Long2DoubleOpenHashMap$MapEntry extends Object implements Long2DoubleMap$Entry, LongDoublePair, Map$Entry<number, number> {
    ...
    constructor(null_: Long2DoubleOpenHashMap$MapEntry)
    constructor(null_: Long2DoubleOpenHashMap$MapEntry, arg1: number)
