...
export class Long2ObjectOpenHashMap$ValueIterator extends Long2ObjectOpenHashMap$MapIterator<Object> implements ObjectIterator<V> {
    constructor(null_: Long2ObjectOpenHashMap$ValueIterator)
