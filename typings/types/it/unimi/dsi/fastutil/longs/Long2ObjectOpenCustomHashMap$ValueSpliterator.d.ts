...
export class Long2ObjectOpenCustomHashMap$ValueSpliterator extends Long2ObjectOpenCustomHashMap$MapSpliterator<Object, Object> implements ObjectSpliterator<V> {
    ...
    makeForSplit<V extends Object | number | string | boolean>(arg0: number, arg1: number, arg2: boolean): Long2ObjectOpenCustomHashMap$ValueSpliterator;
