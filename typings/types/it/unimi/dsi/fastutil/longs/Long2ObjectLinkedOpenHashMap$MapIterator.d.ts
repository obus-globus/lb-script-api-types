...
export abstract class Long2ObjectLinkedOpenHashMap$MapIterator<ConsumerType extends Object | number | string | boolean> extends Object {
    constructor(null_: Long2ObjectLinkedOpenHashMap$MapIterator<Object>)
    private constructor(null_: Long2ObjectLinkedOpenHashMap$MapIterator<Object>, arg1: number)
    // private curr: number;
