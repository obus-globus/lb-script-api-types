...
export class Long2LongLinkedOpenHashMap$MapEntry extends Object implements Long2LongMap$Entry, LongLongPair, Map$Entry<number, number> {
    ...
    constructor(null_: Long2LongLinkedOpenHashMap$MapEntry)
    constructor(null_: Long2LongLinkedOpenHashMap$MapEntry, arg1: number)
