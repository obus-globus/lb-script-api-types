...
export class Long2LongOpenHashMap$EntryIterator extends Long2LongOpenHashMap$MapIterator<(param0: Long2LongMap$Entry) => void> implements ObjectIterator<Long2LongMap$Entry> {
    private constructor(null_: Long2LongOpenHashMap$EntryIterator)
