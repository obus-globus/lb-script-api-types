...
export class Long2CharOpenHashMap$ValueIterator extends Long2CharOpenHashMap$MapIterator<(param0: string) => void> implements CharIterator {
    constructor(null_: Long2CharOpenHashMap$ValueIterator)
