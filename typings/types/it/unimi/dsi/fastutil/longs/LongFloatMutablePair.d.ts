...
export class LongFloatMutablePair extends Object implements LongFloatPair, Serializable {
    static lexComparator(): (param0: LongFloatPair, param1: LongFloatPair) => number;
    static of(paramarg0: number, paramarg1: number): LongFloatMutablePair;
