...
export class Long2CharOpenHashMap$KeyIterator extends Long2CharOpenHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Long2CharOpenHashMap$KeyIterator)
