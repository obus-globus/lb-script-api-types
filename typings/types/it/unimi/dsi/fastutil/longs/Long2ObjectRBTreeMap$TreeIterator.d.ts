...
export class Long2ObjectRBTreeMap$TreeIterator extends Object {
    constructor(null_: Long2ObjectRBTreeMap$TreeIterator)
    constructor(null_: Long2ObjectRBTreeMap$TreeIterator, arg1: number)
    ...
    hasNext(): boolean;
    hasPrevious(): boolean;
    nextEntry<V extends Object | number | string | boolean>(): Long2ObjectRBTreeMap$Entry<V>;
    nextIndex(): number;
    previousEntry<V extends Object | number | string | boolean>(): Long2ObjectRBTreeMap$Entry<V>;
