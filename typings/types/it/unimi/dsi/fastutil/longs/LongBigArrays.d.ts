...
export class LongBigArrays extends Object {
    static DEFAULT_EMPTY_BIG_ARRAY: (Object | null)[];
    static EMPTY_BIG_ARRAY: (Object | null)[];
    static EMPTY_BIG_ATOMIC_ARRAY: (Object | null)[];
    ...
    static binarySearch(paramarg0: (Object | null)[], paramarg1: number, paramarg2: (param0: number, param1: number) => number): number;
    static binarySearch(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: number): number;
    static binarySearch(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: number, paramarg4: (param0: number, param1: number) => number): number;
    ...
    static newBigAtomicArray(paramarg0: number): (Object | null)[];
    static parallelQuickSort(paramarg0: (Object | null)[]): void;
    static parallelQuickSort(paramarg0: (Object | null)[], paramarg1: (param0: number, param1: number) => number): void;
    static parallelQuickSort(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number): void;
    static parallelQuickSort(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: (param0: number, param1: number) => number): void;
    static quickSort(paramarg0: (Object | null)[]): void;
    static quickSort(paramarg0: (Object | null)[], paramarg1: (param0: number, param1: number) => number): void;
    static quickSort(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number): void;
    static quickSort(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: (param0: number, param1: number) => number): void;
