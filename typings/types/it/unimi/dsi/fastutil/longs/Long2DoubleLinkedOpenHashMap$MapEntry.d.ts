...
export class Long2DoubleLinkedOpenHashMap$MapEntry extends Object implements Long2DoubleMap$Entry, LongDoublePair, Map$Entry<number, number> {
    ...
    constructor(null_: Long2DoubleLinkedOpenHashMap$MapEntry)
    constructor(null_: Long2DoubleLinkedOpenHashMap$MapEntry, arg1: number)
