...
export class Long2ShortOpenHashMap$KeyIterator extends Long2ShortOpenHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Long2ShortOpenHashMap$KeyIterator)
