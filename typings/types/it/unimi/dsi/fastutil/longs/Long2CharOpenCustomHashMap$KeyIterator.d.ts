...
export class Long2CharOpenCustomHashMap$KeyIterator extends Long2CharOpenCustomHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Long2CharOpenCustomHashMap$KeyIterator)
