...
export class Long2CharOpenHashMap$MapEntry extends Object implements Long2CharMap$Entry, LongCharPair, Map$Entry<number, string> {
    ...
    constructor(null_: Long2CharOpenHashMap$MapEntry)
    constructor(null_: Long2CharOpenHashMap$MapEntry, arg1: number)
