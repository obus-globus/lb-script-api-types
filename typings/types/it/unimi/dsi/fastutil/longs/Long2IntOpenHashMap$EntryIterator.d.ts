...
export class Long2IntOpenHashMap$EntryIterator extends Long2IntOpenHashMap$MapIterator<(param0: Long2IntMap$Entry) => void> implements ObjectIterator<Long2IntMap$Entry> {
    private constructor(null_: Long2IntOpenHashMap$EntryIterator)
