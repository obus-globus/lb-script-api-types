...
export class Long2ReferenceLinkedOpenHashMap$FastEntryIterator extends Long2ReferenceLinkedOpenHashMap$MapIterator<Object> implements ObjectListIterator<Long2ReferenceMap$Entry<V>> {
    constructor(null_: Long2ReferenceLinkedOpenHashMap$FastEntryIterator)
    constructor(null_: Long2ReferenceLinkedOpenHashMap$FastEntryIterator, arg1: number)
    ...
    next<V extends Object | number | string | boolean>(): Long2ReferenceLinkedOpenHashMap$MapEntry;
    previous<V extends Object | number | string | boolean>(): Long2ReferenceLinkedOpenHashMap$MapEntry;
    remove(): void;
