...
export class Long2FloatLinkedOpenHashMap$MapEntry extends Object implements Long2FloatMap$Entry, LongFloatPair, Map$Entry<number, number> {
    ...
    constructor(null_: Long2FloatLinkedOpenHashMap$MapEntry)
    constructor(null_: Long2FloatLinkedOpenHashMap$MapEntry, arg1: number)
