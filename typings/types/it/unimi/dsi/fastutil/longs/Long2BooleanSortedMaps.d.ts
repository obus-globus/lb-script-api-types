...
export class Long2BooleanSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Long2BooleanMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Long2BooleanMap$Entry>;
