...
export class Long2ObjectLinkedOpenHashMap$MapEntry extends Object implements Long2ObjectMap$Entry<V>, LongObjectPair<V>, Map$Entry<number, V> {
    ...
    constructor(null_: Long2ObjectLinkedOpenHashMap$MapEntry)
    constructor(null_: Long2ObjectLinkedOpenHashMap$MapEntry, arg1: number)
