...
export class LongOpenHashBigSet$SetSpliterator extends Object implements LongSpliterator {
    ...
    constructor(null_: LongOpenHashBigSet$SetSpliterator)
    constructor(null_: LongOpenHashBigSet$SetSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    // private c: number;
    ...
    trySplit(): LongOpenHashBigSet$SetSpliterator;
}