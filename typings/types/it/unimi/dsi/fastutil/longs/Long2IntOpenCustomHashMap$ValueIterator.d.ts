...
export class Long2IntOpenCustomHashMap$ValueIterator extends Long2IntOpenCustomHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Long2IntOpenCustomHashMap$ValueIterator)
