...
export class Long2ByteOpenCustomHashMap$KeySpliterator extends Long2ByteOpenCustomHashMap$MapSpliterator<(param0: number) => void, Long2ByteOpenCustomHashMap$KeySpliterator> implements LongSpliterator {
    ...
    constructor(null_: Long2ByteOpenCustomHashMap$KeySpliterator)
    constructor(null_: Long2ByteOpenCustomHashMap$KeySpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => number;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Long2ByteOpenCustomHashMap$KeySpliterator;
