...
export class Long2ObjectOpenCustomHashMap$ValueIterator extends Long2ObjectOpenCustomHashMap$MapIterator<Object> implements ObjectIterator<V> {
    constructor(null_: Long2ObjectOpenCustomHashMap$ValueIterator)
