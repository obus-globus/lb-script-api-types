...
export class Long2IntLinkedOpenHashMap$MapEntry extends Object implements Long2IntMap$Entry, LongIntPair, Map$Entry<number, number> {
    ...
    constructor(null_: Long2IntLinkedOpenHashMap$MapEntry)
    constructor(null_: Long2IntLinkedOpenHashMap$MapEntry, arg1: number)
