...
export class Long2LongOpenHashMap$KeyIterator extends Long2LongOpenHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Long2LongOpenHashMap$KeyIterator)
