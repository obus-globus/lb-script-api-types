...
export class Long2IntSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Long2IntMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Long2IntMap$Entry>;
