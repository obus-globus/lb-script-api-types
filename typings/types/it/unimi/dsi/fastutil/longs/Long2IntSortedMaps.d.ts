...
export class Long2IntSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Long2IntMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Long2IntMap$Entry>;
