...
export class Long2ShortOpenHashMap$ValueIterator extends Long2ShortOpenHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Long2ShortOpenHashMap$ValueIterator)
