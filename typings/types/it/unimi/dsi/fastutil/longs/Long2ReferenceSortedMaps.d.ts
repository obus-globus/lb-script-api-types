...
export class Long2ReferenceSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Long2ReferenceMap$Entry<Object>[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Long2ReferenceMap$Entry<Object>>;
