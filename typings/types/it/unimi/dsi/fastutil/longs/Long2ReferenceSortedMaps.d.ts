...
export class Long2ReferenceSortedMaps extends Object {
    ...
    static fastIterable<V extends unknown>(paramarg0: { [key: string]: any }): Long2ReferenceMap$Entry<V>[];
    static fastIterator<V extends unknown>(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Long2ReferenceMap$Entry<V>>;
