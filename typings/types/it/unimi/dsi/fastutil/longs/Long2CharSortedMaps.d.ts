...
export class Long2CharSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Long2CharMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Long2CharMap$Entry>;
