...
export class Long2CharSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Long2CharMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Long2CharMap$Entry>;
