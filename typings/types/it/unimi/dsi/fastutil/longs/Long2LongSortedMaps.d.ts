...
export class Long2LongSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Long2LongMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Long2LongMap$Entry>;
