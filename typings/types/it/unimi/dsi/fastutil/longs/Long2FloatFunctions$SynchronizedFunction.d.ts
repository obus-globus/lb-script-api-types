...
export class Long2FloatFunctions$SynchronizedFunction extends Object implements Long2FloatFunction, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Float;
    composeChar(arg0: (param0: string) => kotlin.Long): (param0: string) => kotlin.Float;
    composeDouble(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Float;
    composeFloat(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Float;
    composeInt(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Float;
    composeLong(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Float;
    composeObject(arg0: (param0: T) => kotlin.Long): (param0: T) => kotlin.Float;
    composeReference(arg0: (param0: T) => kotlin.Long): (param0: T) => kotlin.Float;
    composeShort(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Float;
