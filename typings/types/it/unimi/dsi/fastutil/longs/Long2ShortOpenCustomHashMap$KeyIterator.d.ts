...
export class Long2ShortOpenCustomHashMap$KeyIterator extends Long2ShortOpenCustomHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Long2ShortOpenCustomHashMap$KeyIterator)
