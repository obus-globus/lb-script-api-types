...
export class Long2ByteOpenCustomHashMap$MapEntry extends Object implements Long2ByteMap$Entry, LongBytePair, Map$Entry<number, number> {
    ...
    constructor(null_: Long2ByteOpenCustomHashMap$MapEntry)
    constructor(null_: Long2ByteOpenCustomHashMap$MapEntry, arg1: number)
