...
export class Long2FloatOpenCustomHashMap$EntryIterator extends Long2FloatOpenCustomHashMap$MapIterator<(param0: Long2FloatMap$Entry) => void> implements ObjectIterator<Long2FloatMap$Entry> {
    private constructor(null_: Long2FloatOpenCustomHashMap$EntryIterator)
