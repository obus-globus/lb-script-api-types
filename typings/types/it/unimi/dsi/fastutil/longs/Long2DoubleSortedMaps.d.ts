...
export class Long2DoubleSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Long2DoubleMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Long2DoubleMap$Entry>;
