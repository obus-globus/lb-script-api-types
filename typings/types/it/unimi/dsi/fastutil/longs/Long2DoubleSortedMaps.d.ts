...
export class Long2DoubleSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Long2DoubleMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Long2DoubleMap$Entry>;
