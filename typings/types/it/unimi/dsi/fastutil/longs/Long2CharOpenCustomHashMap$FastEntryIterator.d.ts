...
export class Long2CharOpenCustomHashMap$FastEntryIterator extends Long2CharOpenCustomHashMap$MapIterator<(param0: Long2CharMap$Entry) => void> implements ObjectIterator<Long2CharMap$Entry> {
    private constructor(null_: Long2CharOpenCustomHashMap$FastEntryIterator)
