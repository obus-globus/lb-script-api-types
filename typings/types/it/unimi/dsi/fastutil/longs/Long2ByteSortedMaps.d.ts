...
export class Long2ByteSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Long2ByteMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Long2ByteMap$Entry>;
