...
export class Long2IntOpenHashMap$KeySpliterator extends Long2IntOpenHashMap$MapSpliterator<(param0: number) => void, Long2IntOpenHashMap$KeySpliterator> implements LongSpliterator {
    ...
    constructor(null_: Long2IntOpenHashMap$KeySpliterator)
    constructor(null_: Long2IntOpenHashMap$KeySpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => kotlin.Int;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Long2IntOpenHashMap$KeySpliterator;
