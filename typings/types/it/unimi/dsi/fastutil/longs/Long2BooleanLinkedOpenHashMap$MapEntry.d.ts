...
export class Long2BooleanLinkedOpenHashMap$MapEntry extends Object implements Long2BooleanMap$Entry, LongBooleanPair, Map$Entry<number, boolean> {
    ...
    constructor(null_: Long2BooleanLinkedOpenHashMap$MapEntry)
    constructor(null_: Long2BooleanLinkedOpenHashMap$MapEntry, arg1: number)
