...
export class Long2FloatOpenHashMap$KeyIterator extends Long2FloatOpenHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Long2FloatOpenHashMap$KeyIterator)
