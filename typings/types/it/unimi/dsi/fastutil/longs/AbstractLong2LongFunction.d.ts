...
export abstract class AbstractLong2LongFunction extends Object implements Long2LongFunction, Serializable {
    static identity(): (param0: number) => kotlin.Long;
    constructor()
    ...
    composeByte(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Long;
    composeChar(arg0: (param0: string) => kotlin.Long): (param0: string) => kotlin.Long;
    composeDouble(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Long;
    composeFloat(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Long;
    composeInt(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Long;
    composeLong(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Long;
    composeObject(arg0: (param0: T) => kotlin.Long): (param0: T) => kotlin.Long;
    composeReference(arg0: (param0: T) => kotlin.Long): (param0: T) => kotlin.Long;
    composeShort(arg0: (param0: number) => kotlin.Long): (param0: number) => kotlin.Long;
