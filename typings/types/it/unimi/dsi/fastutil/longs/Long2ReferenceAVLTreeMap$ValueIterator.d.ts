...
export class Long2ReferenceAVLTreeMap$ValueIterator extends Long2ReferenceAVLTreeMap$TreeIterator implements ObjectListIterator<V> {
    private constructor(null_: Long2ReferenceAVLTreeMap$ValueIterator)
