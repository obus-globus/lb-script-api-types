...
export class LongOpenHashSet$SetSpliterator extends Object implements LongSpliterator {
    ...
    constructor(null_: LongOpenHashSet$SetSpliterator)
    constructor(null_: LongOpenHashSet$SetSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    // private c: number;
    ...
    tryAdvance(arg0: (param0: number) => void): boolean;
    tryAdvance(arg0: (param0: number) => void): boolean;
    trySplit(): LongOpenHashSet$SetSpliterator;
}