...
export class Long2DoubleOpenHashMap$KeyIterator extends Long2DoubleOpenHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Long2DoubleOpenHashMap$KeyIterator)
