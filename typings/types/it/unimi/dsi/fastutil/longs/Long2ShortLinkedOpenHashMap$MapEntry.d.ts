...
export class Long2ShortLinkedOpenHashMap$MapEntry extends Object implements Long2ShortMap$Entry, LongShortPair, Map$Entry<number, number> {
    ...
    constructor(null_: Long2ShortLinkedOpenHashMap$MapEntry)
    constructor(null_: Long2ShortLinkedOpenHashMap$MapEntry, arg1: number)
