...
export class Long2ReferenceMaps extends Object {
    ...
    static fastForEach(paramarg0: Long2ReferenceMap<Object>, paramarg1: (param0: Object) => void): void;
    static fastIterable(paramarg0: Long2ReferenceMap<Object>): Long2ReferenceMap$Entry<Object>[];
    static fastIterator(paramarg0: Long2ReferenceMap<Object>): ObjectIterator<Long2ReferenceMap$Entry<Object>>;
