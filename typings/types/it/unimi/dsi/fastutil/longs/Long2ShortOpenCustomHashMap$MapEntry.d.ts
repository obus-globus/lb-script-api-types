...
export class Long2ShortOpenCustomHashMap$MapEntry extends Object implements Long2ShortMap$Entry, LongShortPair, Map$Entry<number, number> {
    ...
    constructor(null_: Long2ShortOpenCustomHashMap$MapEntry)
    constructor(null_: Long2ShortOpenCustomHashMap$MapEntry, arg1: number)
