...
export class Long2ReferenceOpenHashMap$EntrySpliterator extends Long2ReferenceOpenHashMap$MapSpliterator<Object, any> implements ObjectSpliterator<Long2ReferenceMap$Entry<V>> {
    ...
    makeForSplit<V extends Object | number | string | boolean>(arg0: number, arg1: number, arg2: boolean): Long2ReferenceOpenHashMap$EntrySpliterator;
