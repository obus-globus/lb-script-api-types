...
export class Byte2IntOpenHashMap$FastEntryIterator extends Byte2IntOpenHashMap$MapIterator<(param0: Byte2IntMap$Entry) => void> implements ObjectIterator<Byte2IntMap$Entry> {
    private constructor(null_: Byte2IntOpenHashMap$FastEntryIterator)
