...
export class Byte2IntSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Byte2IntMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Byte2IntMap$Entry>;
