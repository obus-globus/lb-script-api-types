...
export class Byte2IntSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Byte2IntMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Byte2IntMap$Entry>;
