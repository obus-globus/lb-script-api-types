...
export class Byte2ReferenceOpenHashMap$ValueSpliterator extends Byte2ReferenceOpenHashMap$MapSpliterator<Object, Object> implements ObjectSpliterator<V> {
    ...
    makeForSplit<V extends Object | number | string | boolean>(arg0: number, arg1: number, arg2: boolean): Byte2ReferenceOpenHashMap$ValueSpliterator;
