...
export class Byte2ReferenceSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Byte2ReferenceMap$Entry<Object>[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Byte2ReferenceMap$Entry<Object>>;
