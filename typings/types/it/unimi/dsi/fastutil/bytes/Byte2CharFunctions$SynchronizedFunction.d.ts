...
export class Byte2CharFunctions$SynchronizedFunction extends Object implements Byte2CharFunction, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Char;
    composeChar(arg0: (param0: string) => kotlin.Byte): (param0: string) => kotlin.Char;
    composeDouble(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Char;
    composeFloat(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Char;
    composeInt(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Char;
    composeLong(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Char;
    composeObject(arg0: (param0: T) => kotlin.Byte): (param0: T) => kotlin.Char;
    composeReference(arg0: (param0: T) => kotlin.Byte): (param0: T) => kotlin.Char;
    composeShort(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Char;
