...
export class Byte2BooleanOpenCustomHashMap$KeyIterator extends Byte2BooleanOpenCustomHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2BooleanOpenCustomHashMap$KeyIterator)
