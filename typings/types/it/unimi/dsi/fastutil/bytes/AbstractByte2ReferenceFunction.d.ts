...
export abstract class AbstractByte2ReferenceFunction<V extends Object | number | string | boolean> extends Object implements Byte2ReferenceFunction<V>, Serializable {
    constructor()
