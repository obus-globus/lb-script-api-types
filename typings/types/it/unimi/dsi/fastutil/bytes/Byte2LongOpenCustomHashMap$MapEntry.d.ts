...
export class Byte2LongOpenCustomHashMap$MapEntry extends Object implements Byte2LongMap$Entry, ByteLongPair, Map$Entry<number, number> {
    ...
    constructor(null_: Byte2LongOpenCustomHashMap$MapEntry)
    constructor(null_: Byte2LongOpenCustomHashMap$MapEntry, arg1: number)
