...
export class ByteFloatImmutablePair extends Object implements ByteFloatPair, Serializable {
    static lexComparator(): (param0: ByteFloatPair) => kotlin.Boolean;
    static of(paramarg0: number, paramarg1: number): ByteFloatImmutablePair;
