...
export class Byte2DoubleArrayMap$MapEntry extends Object implements Byte2DoubleMap$Entry, ByteDoublePair, Map$Entry<number, number> {
    ...
    constructor(null_: Byte2DoubleArrayMap$MapEntry)
    constructor(null_: Byte2DoubleArrayMap$MapEntry, arg1: number)
