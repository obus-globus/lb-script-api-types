...
export class Byte2LongSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Byte2LongMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Byte2LongMap$Entry>;
