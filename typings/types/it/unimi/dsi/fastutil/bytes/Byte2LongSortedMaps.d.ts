...
export class Byte2LongSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Byte2LongMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Byte2LongMap$Entry>;
