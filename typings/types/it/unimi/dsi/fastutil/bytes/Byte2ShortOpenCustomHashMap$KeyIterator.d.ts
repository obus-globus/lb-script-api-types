...
export class Byte2ShortOpenCustomHashMap$KeyIterator extends Byte2ShortOpenCustomHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2ShortOpenCustomHashMap$KeyIterator)
