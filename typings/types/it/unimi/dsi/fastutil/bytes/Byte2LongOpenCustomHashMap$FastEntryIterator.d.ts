...
export class Byte2LongOpenCustomHashMap$FastEntryIterator extends Byte2LongOpenCustomHashMap$MapIterator<(param0: Byte2LongMap$Entry) => void> implements ObjectIterator<Byte2LongMap$Entry> {
    private constructor(null_: Byte2LongOpenCustomHashMap$FastEntryIterator)
