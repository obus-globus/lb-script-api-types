...
export class Byte2BooleanOpenCustomHashMap$MapEntry extends Object implements Byte2BooleanMap$Entry, ByteBooleanPair, Map$Entry<number, boolean> {
    ...
    constructor(null_: Byte2BooleanOpenCustomHashMap$MapEntry)
    constructor(null_: Byte2BooleanOpenCustomHashMap$MapEntry, arg1: number)
