...
export class Byte2ObjectOpenHashMap$EntrySpliterator extends Byte2ObjectOpenHashMap$MapSpliterator<Object, any> implements ObjectSpliterator<Byte2ObjectMap$Entry<V>> {
    ...
    makeForSplit<V extends Object | number | string | boolean>(arg0: number, arg1: number, arg2: boolean): Byte2ObjectOpenHashMap$EntrySpliterator;
