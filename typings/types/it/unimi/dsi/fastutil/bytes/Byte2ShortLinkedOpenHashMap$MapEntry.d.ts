...
export class Byte2ShortLinkedOpenHashMap$MapEntry extends Object implements Byte2ShortMap$Entry, ByteShortPair, Map$Entry<number, number> {
    ...
    constructor(null_: Byte2ShortLinkedOpenHashMap$MapEntry)
    constructor(null_: Byte2ShortLinkedOpenHashMap$MapEntry, arg1: number)
