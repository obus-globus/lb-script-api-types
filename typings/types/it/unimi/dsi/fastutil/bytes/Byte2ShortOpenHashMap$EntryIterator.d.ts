...
export class Byte2ShortOpenHashMap$EntryIterator extends Byte2ShortOpenHashMap$MapIterator<(param0: Byte2ShortMap$Entry) => void> implements ObjectIterator<Byte2ShortMap$Entry> {
    private constructor(null_: Byte2ShortOpenHashMap$EntryIterator)
