...
export class Byte2ByteOpenCustomHashMap$ValueIterator extends Byte2ByteOpenCustomHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2ByteOpenCustomHashMap$ValueIterator)
