...
export class Byte2IntLinkedOpenHashMap$MapEntry extends Object implements Byte2IntMap$Entry, ByteIntPair, Map$Entry<number, number> {
    ...
    constructor(null_: Byte2IntLinkedOpenHashMap$MapEntry)
    constructor(null_: Byte2IntLinkedOpenHashMap$MapEntry, arg1: number)
