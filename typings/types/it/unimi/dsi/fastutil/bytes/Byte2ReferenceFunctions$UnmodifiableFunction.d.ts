...
export class Byte2ReferenceFunctions$UnmodifiableFunction<V extends Object | number | string | boolean> extends AbstractByte2ReferenceFunction<V> implements Serializable {
