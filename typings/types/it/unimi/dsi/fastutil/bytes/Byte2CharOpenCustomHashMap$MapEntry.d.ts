...
export class Byte2CharOpenCustomHashMap$MapEntry extends Object implements Byte2CharMap$Entry, ByteCharPair, Map$Entry<number, string> {
    ...
    constructor(null_: Byte2CharOpenCustomHashMap$MapEntry)
    constructor(null_: Byte2CharOpenCustomHashMap$MapEntry, arg1: number)
