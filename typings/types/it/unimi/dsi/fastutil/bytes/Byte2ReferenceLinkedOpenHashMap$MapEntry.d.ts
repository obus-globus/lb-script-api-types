...
export class Byte2ReferenceLinkedOpenHashMap$MapEntry extends Object implements Byte2ReferenceMap$Entry<V>, ByteReferencePair<V>, Map$Entry<number, V> {
    ...
    constructor(null_: Byte2ReferenceLinkedOpenHashMap$MapEntry)
    constructor(null_: Byte2ReferenceLinkedOpenHashMap$MapEntry, arg1: number)
