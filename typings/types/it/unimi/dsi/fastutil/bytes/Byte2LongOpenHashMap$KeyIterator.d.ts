...
export class Byte2LongOpenHashMap$KeyIterator extends Byte2LongOpenHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2LongOpenHashMap$KeyIterator)
