...
export class Byte2ShortOpenHashMap$KeyIterator extends Byte2ShortOpenHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2ShortOpenHashMap$KeyIterator)
