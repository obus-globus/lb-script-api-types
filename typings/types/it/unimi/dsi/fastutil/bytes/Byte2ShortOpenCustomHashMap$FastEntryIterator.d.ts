...
export class Byte2ShortOpenCustomHashMap$FastEntryIterator extends Byte2ShortOpenCustomHashMap$MapIterator<(param0: Byte2ShortMap$Entry) => void> implements ObjectIterator<Byte2ShortMap$Entry> {
    private constructor(null_: Byte2ShortOpenCustomHashMap$FastEntryIterator)
