...
export class Byte2CharOpenHashMap$ValueIterator extends Byte2CharOpenHashMap$MapIterator<(param0: string) => void> implements CharIterator {
    constructor(null_: Byte2CharOpenHashMap$ValueIterator)
