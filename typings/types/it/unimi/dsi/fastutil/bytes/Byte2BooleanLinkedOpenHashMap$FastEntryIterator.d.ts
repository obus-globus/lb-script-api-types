...
export class Byte2BooleanLinkedOpenHashMap$FastEntryIterator extends Byte2BooleanLinkedOpenHashMap$MapIterator<(param0: Byte2BooleanMap$Entry) => void> implements ObjectListIterator<Byte2BooleanMap$Entry> {
    constructor(null_: Byte2BooleanLinkedOpenHashMap$FastEntryIterator)
    constructor(null_: Byte2BooleanLinkedOpenHashMap$FastEntryIterator, arg1: number)
