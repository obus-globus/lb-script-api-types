...
export class Byte2ShortSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Byte2ShortMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Byte2ShortMap$Entry>;
