...
export class Byte2CharOpenHashMap$EntryIterator extends Byte2CharOpenHashMap$MapIterator<(param0: Byte2CharMap$Entry) => void> implements ObjectIterator<Byte2CharMap$Entry> {
    private constructor(null_: Byte2CharOpenHashMap$EntryIterator)
