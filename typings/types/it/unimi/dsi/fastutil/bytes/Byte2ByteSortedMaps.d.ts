...
export class Byte2ByteSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Byte2ByteMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Byte2ByteMap$Entry>;
