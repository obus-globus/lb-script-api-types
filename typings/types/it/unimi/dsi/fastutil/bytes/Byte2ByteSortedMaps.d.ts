...
export class Byte2ByteSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Byte2ByteMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Byte2ByteMap$Entry>;
