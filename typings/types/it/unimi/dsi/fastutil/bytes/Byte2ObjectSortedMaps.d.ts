...
export class Byte2ObjectSortedMaps extends Object {
    ...
    static fastIterable<V extends unknown>(paramarg0: JavaMap<any, any>): Byte2ObjectMap$Entry<V>[];
    static fastIterator<V extends unknown>(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Byte2ObjectMap$Entry<V>>;
