...
export class Byte2FloatOpenHashMap$KeyIterator extends Byte2FloatOpenHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2FloatOpenHashMap$KeyIterator)
