...
export class Byte2IntOpenCustomHashMap$KeyIterator extends Byte2IntOpenCustomHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2IntOpenCustomHashMap$KeyIterator)
