...
export class Byte2DoubleOpenCustomHashMap$KeyIterator extends Byte2DoubleOpenCustomHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2DoubleOpenCustomHashMap$KeyIterator)
