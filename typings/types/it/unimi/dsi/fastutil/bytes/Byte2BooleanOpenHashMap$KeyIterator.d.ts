...
export class Byte2BooleanOpenHashMap$KeyIterator extends Byte2BooleanOpenHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2BooleanOpenHashMap$KeyIterator)
