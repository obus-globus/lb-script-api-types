...
export class Byte2ByteFunctions$SynchronizedFunction extends Object implements Byte2ByteFunction, Serializable {
    static identity(): (param0: number) => kotlin.Byte;
