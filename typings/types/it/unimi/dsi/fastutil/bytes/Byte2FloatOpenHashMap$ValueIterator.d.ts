...
export class Byte2FloatOpenHashMap$ValueIterator extends Byte2FloatOpenHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Byte2FloatOpenHashMap$ValueIterator)
