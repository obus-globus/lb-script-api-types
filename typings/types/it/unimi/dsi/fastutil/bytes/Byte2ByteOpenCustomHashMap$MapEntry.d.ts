...
export class Byte2ByteOpenCustomHashMap$MapEntry extends Object implements Byte2ByteMap$Entry, ByteBytePair, Map$Entry<number, number> {
    ...
    constructor(null_: Byte2ByteOpenCustomHashMap$MapEntry)
    constructor(null_: Byte2ByteOpenCustomHashMap$MapEntry, arg1: number)
