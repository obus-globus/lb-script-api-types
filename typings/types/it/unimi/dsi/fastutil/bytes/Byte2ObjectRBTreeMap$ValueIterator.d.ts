...
export class Byte2ObjectRBTreeMap$ValueIterator extends Byte2ObjectRBTreeMap$TreeIterator implements ObjectListIterator<V> {
    private constructor(null_: Byte2ObjectRBTreeMap$ValueIterator)
