...
export class Byte2ByteOpenHashMap$MapEntry extends Object implements Byte2ByteMap$Entry, ByteBytePair, Map$Entry<number, number> {
    ...
    constructor(null_: Byte2ByteOpenHashMap$MapEntry)
    constructor(null_: Byte2ByteOpenHashMap$MapEntry, arg1: number)
