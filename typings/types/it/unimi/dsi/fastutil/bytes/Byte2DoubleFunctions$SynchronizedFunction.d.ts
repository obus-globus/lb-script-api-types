...
export class Byte2DoubleFunctions$SynchronizedFunction extends Object implements Byte2DoubleFunction, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Double;
    composeChar(arg0: (param0: string) => kotlin.Byte): (param0: string) => kotlin.Double;
    composeDouble(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Double;
    composeFloat(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Double;
    composeInt(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Double;
    composeLong(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Double;
    composeObject(arg0: (param0: T) => kotlin.Byte): (param0: T) => kotlin.Double;
