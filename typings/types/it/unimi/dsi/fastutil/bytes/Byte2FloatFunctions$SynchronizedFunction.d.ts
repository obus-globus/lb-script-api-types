...
export class Byte2FloatFunctions$SynchronizedFunction extends Object implements Byte2FloatFunction, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Float;
    composeChar(arg0: (param0: string) => kotlin.Byte): (param0: string) => kotlin.Float;
    composeDouble(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Float;
    composeFloat(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Float;
    composeInt(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Float;
    composeLong(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Float;
    composeObject(arg0: (param0: T) => kotlin.Byte): (param0: T) => kotlin.Float;
    composeReference(arg0: (param0: T) => kotlin.Byte): (param0: T) => kotlin.Float;
    composeShort(arg0: (param0: number) => kotlin.Byte): (param0: number) => kotlin.Float;
