...
export class Byte2DoubleOpenHashMap$KeyIterator extends Byte2DoubleOpenHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Byte2DoubleOpenHashMap$KeyIterator)
