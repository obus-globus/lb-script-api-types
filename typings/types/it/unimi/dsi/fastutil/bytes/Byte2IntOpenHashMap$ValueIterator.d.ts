...
export class Byte2IntOpenHashMap$ValueIterator extends Byte2IntOpenHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Byte2IntOpenHashMap$ValueIterator)
