...
export class Byte2FloatSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Byte2FloatMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Byte2FloatMap$Entry>;
