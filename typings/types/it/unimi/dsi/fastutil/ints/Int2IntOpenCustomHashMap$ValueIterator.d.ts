...
export class Int2IntOpenCustomHashMap$ValueIterator extends Int2IntOpenCustomHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Int2IntOpenCustomHashMap$ValueIterator)
