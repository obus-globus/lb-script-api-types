...
export class IntOpenHashSet$SetSpliterator extends Object implements IntSpliterator {
    ...
    constructor(null_: IntOpenHashSet$SetSpliterator)
    constructor(null_: IntOpenHashSet$SetSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    // private c: number;
    ...
    trySplit(): IntOpenHashSet$SetSpliterator;
}