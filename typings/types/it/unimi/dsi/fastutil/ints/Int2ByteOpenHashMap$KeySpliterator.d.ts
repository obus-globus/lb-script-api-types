...
export class Int2ByteOpenHashMap$KeySpliterator extends Int2ByteOpenHashMap$MapSpliterator<(param0: number) => void, Int2ByteOpenHashMap$KeySpliterator> implements IntSpliterator {
    ...
    constructor(null_: Int2ByteOpenHashMap$KeySpliterator)
    constructor(null_: Int2ByteOpenHashMap$KeySpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => kotlin.Int;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Int2ByteOpenHashMap$KeySpliterator;
