...
export class Int2ReferenceOpenCustomHashMap$KeyIterator extends Int2ReferenceOpenCustomHashMap$MapIterator<Object> implements IntIterator {
    constructor(null_: Int2ReferenceOpenCustomHashMap$KeyIterator)
