...
export class Int2FloatOpenCustomHashMap$MapEntry extends Object implements Int2FloatMap$Entry, IntFloatPair, Map$Entry<number, number> {
    ...
    constructor(null_: Int2FloatOpenCustomHashMap$MapEntry)
    constructor(null_: Int2FloatOpenCustomHashMap$MapEntry, arg1: number)
