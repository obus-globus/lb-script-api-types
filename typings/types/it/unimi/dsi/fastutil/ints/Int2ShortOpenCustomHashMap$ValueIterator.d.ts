...
export class Int2ShortOpenCustomHashMap$ValueIterator extends Int2ShortOpenCustomHashMap$MapIterator<(param0: number) => void> implements ShortIterator {
    constructor(null_: Int2ShortOpenCustomHashMap$ValueIterator)
