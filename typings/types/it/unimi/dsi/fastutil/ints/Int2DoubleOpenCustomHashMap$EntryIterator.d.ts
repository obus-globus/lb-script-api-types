...
export class Int2DoubleOpenCustomHashMap$EntryIterator extends Int2DoubleOpenCustomHashMap$MapIterator<(param0: Int2DoubleMap$Entry) => void> implements ObjectIterator<Int2DoubleMap$Entry> {
    private constructor(null_: Int2DoubleOpenCustomHashMap$EntryIterator)
