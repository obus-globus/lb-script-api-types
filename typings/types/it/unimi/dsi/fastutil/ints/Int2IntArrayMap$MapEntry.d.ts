...
export class Int2IntArrayMap$MapEntry extends Object implements Int2IntMap$Entry, IntIntPair, Map$Entry<number, number> {
    ...
    constructor(null_: Int2IntArrayMap$MapEntry)
    constructor(null_: Int2IntArrayMap$MapEntry, arg1: number)
