...
export class Int2ShortLinkedOpenHashMap$FastEntryIterator extends Int2ShortLinkedOpenHashMap$MapIterator<(param0: Int2ShortMap$Entry) => void> implements ObjectListIterator<Int2ShortMap$Entry> {
    constructor(null_: Int2ShortLinkedOpenHashMap$FastEntryIterator)
    constructor(null_: Int2ShortLinkedOpenHashMap$FastEntryIterator, arg1: number)
