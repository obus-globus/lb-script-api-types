...
export class Int2FloatOpenHashMap$MapEntry extends Object implements Int2FloatMap$Entry, IntFloatPair, Map$Entry<number, number> {
    ...
    constructor(null_: Int2FloatOpenHashMap$MapEntry)
    constructor(null_: Int2FloatOpenHashMap$MapEntry, arg1: number)
