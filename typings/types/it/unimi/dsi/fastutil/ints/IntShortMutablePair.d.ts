...
export class IntShortMutablePair extends Object implements IntShortPair, Serializable {
    static lexComparator(): (param0: IntShortPair, param1: IntShortPair) => number;
    static of(paramarg0: number, paramarg1: number): IntShortMutablePair;
    ...
    left(arg0: number): IntShortMutablePair;
    leftInt(): number;
    right(): number;
    right(arg0: number): IntShortPair;
    right(arg0: number): IntShortMutablePair;
    rightShort(): number;
    second(): number;
