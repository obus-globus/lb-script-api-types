...
export class Int2ShortOpenHashMap$KeySpliterator extends Int2ShortOpenHashMap$MapSpliterator<(param0: number) => void, Int2ShortOpenHashMap$KeySpliterator> implements IntSpliterator {
    ...
    constructor(null_: Int2ShortOpenHashMap$KeySpliterator)
    constructor(null_: Int2ShortOpenHashMap$KeySpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => kotlin.Int;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Int2ShortOpenHashMap$KeySpliterator;
