...
export class Int2BooleanSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Int2BooleanMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Int2BooleanMap$Entry>;
