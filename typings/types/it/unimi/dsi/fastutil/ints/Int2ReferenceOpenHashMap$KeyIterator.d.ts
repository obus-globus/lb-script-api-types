...
export class Int2ReferenceOpenHashMap$KeyIterator extends Int2ReferenceOpenHashMap$MapIterator<Object> implements IntIterator {
    constructor(null_: Int2ReferenceOpenHashMap$KeyIterator)
