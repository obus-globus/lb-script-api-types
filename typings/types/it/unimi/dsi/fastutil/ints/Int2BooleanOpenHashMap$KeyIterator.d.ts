...
export class Int2BooleanOpenHashMap$KeyIterator extends Int2BooleanOpenHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Int2BooleanOpenHashMap$KeyIterator)
