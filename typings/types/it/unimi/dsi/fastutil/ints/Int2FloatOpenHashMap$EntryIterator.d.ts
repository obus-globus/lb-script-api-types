...
export class Int2FloatOpenHashMap$EntryIterator extends Int2FloatOpenHashMap$MapIterator<(param0: Int2FloatMap$Entry) => void> implements ObjectIterator<Int2FloatMap$Entry> {
    private constructor(null_: Int2FloatOpenHashMap$EntryIterator)
