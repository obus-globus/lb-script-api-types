...
export class Int2DoubleSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Int2DoubleMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Int2DoubleMap$Entry>;
