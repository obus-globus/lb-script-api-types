...
export class Int2LongOpenCustomHashMap$EntryIterator extends Int2LongOpenCustomHashMap$MapIterator<(param0: Int2LongMap$Entry) => void> implements ObjectIterator<Int2LongMap$Entry> {
    private constructor(null_: Int2LongOpenCustomHashMap$EntryIterator)
