...
export class Int2ShortOpenCustomHashMap$KeyIterator extends Int2ShortOpenCustomHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Int2ShortOpenCustomHashMap$KeyIterator)
