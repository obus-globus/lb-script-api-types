...
export class Int2ShortOpenCustomHashMap$MapEntry extends Object implements Int2ShortMap$Entry, IntShortPair, Map$Entry<number, number> {
    ...
    constructor(null_: Int2ShortOpenCustomHashMap$MapEntry)
    constructor(null_: Int2ShortOpenCustomHashMap$MapEntry, arg1: number)
