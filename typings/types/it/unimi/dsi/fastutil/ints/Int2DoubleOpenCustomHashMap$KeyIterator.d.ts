...
export class Int2DoubleOpenCustomHashMap$KeyIterator extends Int2DoubleOpenCustomHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Int2DoubleOpenCustomHashMap$KeyIterator)
