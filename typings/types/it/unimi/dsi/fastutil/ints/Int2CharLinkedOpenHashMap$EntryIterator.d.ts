...
export class Int2CharLinkedOpenHashMap$EntryIterator extends Int2CharLinkedOpenHashMap$MapIterator<(param0: Int2CharMap$Entry) => void> implements ObjectListIterator<Int2CharMap$Entry> {
    constructor(null_: Int2CharLinkedOpenHashMap$EntryIterator)
    constructor(null_: Int2CharLinkedOpenHashMap$EntryIterator, arg1: number)
