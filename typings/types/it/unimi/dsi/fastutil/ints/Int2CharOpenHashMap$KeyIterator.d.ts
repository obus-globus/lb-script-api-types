...
export class Int2CharOpenHashMap$KeyIterator extends Int2CharOpenHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Int2CharOpenHashMap$KeyIterator)
