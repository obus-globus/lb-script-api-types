...
export class Int2LongOpenHashMap$MapEntry extends Object implements Int2LongMap$Entry, IntLongPair, Map$Entry<number, number> {
    ...
    constructor(null_: Int2LongOpenHashMap$MapEntry)
    constructor(null_: Int2LongOpenHashMap$MapEntry, arg1: number)
