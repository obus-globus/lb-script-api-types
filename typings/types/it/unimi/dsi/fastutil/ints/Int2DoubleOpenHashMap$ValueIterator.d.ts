...
export class Int2DoubleOpenHashMap$ValueIterator extends Int2DoubleOpenHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Int2DoubleOpenHashMap$ValueIterator)
