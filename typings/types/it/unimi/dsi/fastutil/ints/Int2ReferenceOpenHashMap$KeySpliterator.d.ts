...
export class Int2ReferenceOpenHashMap$KeySpliterator extends Int2ReferenceOpenHashMap$MapSpliterator<Object, any> implements IntSpliterator {
    ...
    constructor(null_: Int2ReferenceOpenHashMap$KeySpliterator)
    constructor(null_: Int2ReferenceOpenHashMap$KeySpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => number;
    makeForSplit<V extends Object | number | string | boolean>(arg0: number, arg1: number, arg2: boolean): Int2ReferenceOpenHashMap$KeySpliterator;
