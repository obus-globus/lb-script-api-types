...
export class Int2ByteSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Int2ByteMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Int2ByteMap$Entry>;
