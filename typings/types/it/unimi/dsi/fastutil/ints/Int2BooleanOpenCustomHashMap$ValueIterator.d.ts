...
export class Int2BooleanOpenCustomHashMap$ValueIterator extends Int2BooleanOpenCustomHashMap$MapIterator<(param0: boolean) => void> implements BooleanIterator {
    constructor(null_: Int2BooleanOpenCustomHashMap$ValueIterator)
