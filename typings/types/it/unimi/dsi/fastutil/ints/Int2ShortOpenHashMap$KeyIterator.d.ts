...
export class Int2ShortOpenHashMap$KeyIterator extends Int2ShortOpenHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Int2ShortOpenHashMap$KeyIterator)
