...
export class Int2ShortArrayMap$MapEntry extends Object implements Int2ShortMap$Entry, IntShortPair, Map$Entry<number, number> {
    ...
    constructor(null_: Int2ShortArrayMap$MapEntry)
    constructor(null_: Int2ShortArrayMap$MapEntry, arg1: number)
