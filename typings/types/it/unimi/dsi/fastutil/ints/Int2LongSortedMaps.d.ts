...
export class Int2LongSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Int2LongMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Int2LongMap$Entry>;
