...
export class Int2LongArrayMap$MapEntry extends Object implements Int2LongMap$Entry, IntLongPair, Map$Entry<number, number> {
    ...
    constructor(null_: Int2LongArrayMap$MapEntry)
    constructor(null_: Int2LongArrayMap$MapEntry, arg1: number)
