...
export class Int2ReferenceLinkedOpenHashMap$MapEntry extends Object implements Int2ReferenceMap$Entry<V>, IntReferencePair<V>, Map$Entry<number, V> {
    ...
    constructor(null_: Int2ReferenceLinkedOpenHashMap$MapEntry)
    constructor(null_: Int2ReferenceLinkedOpenHashMap$MapEntry, arg1: number)
