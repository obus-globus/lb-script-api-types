...
export class Int2LongOpenCustomHashMap$ValueIterator extends Int2LongOpenCustomHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Int2LongOpenCustomHashMap$ValueIterator)
