...
export class Int2ReferenceOpenCustomHashMap$MapEntry extends Object implements Int2ReferenceMap$Entry<V>, IntReferencePair<V>, Map$Entry<number, V> {
    ...
    constructor(null_: Int2ReferenceOpenCustomHashMap$MapEntry)
    constructor(null_: Int2ReferenceOpenCustomHashMap$MapEntry, arg1: number)
