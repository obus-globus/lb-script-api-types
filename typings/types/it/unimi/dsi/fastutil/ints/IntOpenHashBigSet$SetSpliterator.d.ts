...
export class IntOpenHashBigSet$SetSpliterator extends Object implements IntSpliterator {
    ...
    constructor(null_: IntOpenHashBigSet$SetSpliterator)
    constructor(null_: IntOpenHashBigSet$SetSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    // private c: number;
    ...
    trySplit(): IntOpenHashBigSet$SetSpliterator;
}