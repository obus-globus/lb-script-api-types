...
export class Int2DoubleFunctions$SynchronizedFunction extends Object implements Int2DoubleFunction, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Double;
    composeChar(arg0: (param0: string) => kotlin.Int): (param0: string) => kotlin.Double;
    composeDouble(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Double;
    composeFloat(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Double;
    composeInt(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Double;
    composeLong(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Double;
    composeObject(arg0: (param0: T) => kotlin.Int): (param0: T) => kotlin.Double;
    composeReference(arg0: (param0: T) => kotlin.Int): (param0: T) => kotlin.Double;
    composeShort(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Double;
