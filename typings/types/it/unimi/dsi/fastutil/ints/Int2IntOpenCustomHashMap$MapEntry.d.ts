...
export class Int2IntOpenCustomHashMap$MapEntry extends Object implements Int2IntMap$Entry, IntIntPair, Map$Entry<number, number> {
    ...
    constructor(null_: Int2IntOpenCustomHashMap$MapEntry)
    constructor(null_: Int2IntOpenCustomHashMap$MapEntry, arg1: number)
