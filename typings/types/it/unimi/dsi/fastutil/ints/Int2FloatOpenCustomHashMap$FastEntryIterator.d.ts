...
export class Int2FloatOpenCustomHashMap$FastEntryIterator extends Int2FloatOpenCustomHashMap$MapIterator<(param0: Int2FloatMap$Entry) => void> implements ObjectIterator<Int2FloatMap$Entry> {
    private constructor(null_: Int2FloatOpenCustomHashMap$FastEntryIterator)
