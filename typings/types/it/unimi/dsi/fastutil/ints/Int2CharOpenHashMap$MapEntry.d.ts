...
export class Int2CharOpenHashMap$MapEntry extends Object implements Int2CharMap$Entry, IntCharPair, Map$Entry<number, string> {
    ...
    constructor(null_: Int2CharOpenHashMap$MapEntry)
    constructor(null_: Int2CharOpenHashMap$MapEntry, arg1: number)
