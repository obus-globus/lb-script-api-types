...
export class Int2ByteArrayMap$MapEntry extends Object implements Int2ByteMap$Entry, IntBytePair, Map$Entry<number, number> {
    ...
    constructor(null_: Int2ByteArrayMap$MapEntry)
    constructor(null_: Int2ByteArrayMap$MapEntry, arg1: number)
