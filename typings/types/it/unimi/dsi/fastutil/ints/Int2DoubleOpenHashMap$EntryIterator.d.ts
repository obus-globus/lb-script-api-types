...
export class Int2DoubleOpenHashMap$EntryIterator extends Int2DoubleOpenHashMap$MapIterator<(param0: Int2DoubleMap$Entry) => void> implements ObjectIterator<Int2DoubleMap$Entry> {
    private constructor(null_: Int2DoubleOpenHashMap$EntryIterator)
