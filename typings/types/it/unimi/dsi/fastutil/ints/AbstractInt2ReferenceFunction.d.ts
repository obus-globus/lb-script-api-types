...
export abstract class AbstractInt2ReferenceFunction<V extends Object | number | string | boolean> extends Object implements Int2ReferenceFunction<V>, Serializable {
    constructor()
