...
export class Int2LongFunctions$SynchronizedFunction extends Object implements Int2LongFunction, Serializable {
    ...
    composeByte(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Long;
    composeChar(arg0: (param0: string) => kotlin.Int): (param0: string) => kotlin.Long;
    composeDouble(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Long;
    composeFloat(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Long;
    composeInt(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Long;
    composeLong(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Long;
    composeObject(arg0: (param0: T) => kotlin.Int): (param0: T) => kotlin.Long;
    composeReference(arg0: (param0: T) => kotlin.Int): (param0: T) => kotlin.Long;
    composeShort(arg0: (param0: number) => kotlin.Int): (param0: number) => kotlin.Long;
