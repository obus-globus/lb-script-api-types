...
export class Int2ReferenceSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Int2ReferenceMap$Entry<Object>[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Int2ReferenceMap$Entry<Object>>;
