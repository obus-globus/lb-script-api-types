...
export class Int2LongOpenHashMap$ValueIterator extends Int2LongOpenHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Int2LongOpenHashMap$ValueIterator)
