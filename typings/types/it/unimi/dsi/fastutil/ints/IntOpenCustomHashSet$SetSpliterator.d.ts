...
export class IntOpenCustomHashSet$SetSpliterator extends Object implements IntSpliterator {
    ...
    constructor(null_: IntOpenCustomHashSet$SetSpliterator)
    constructor(null_: IntOpenCustomHashSet$SetSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    // private c: number;
    ...
    trySplit(): IntOpenCustomHashSet$SetSpliterator;
}