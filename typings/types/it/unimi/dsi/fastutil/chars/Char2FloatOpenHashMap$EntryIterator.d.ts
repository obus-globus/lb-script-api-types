...
export class Char2FloatOpenHashMap$EntryIterator extends Char2FloatOpenHashMap$MapIterator<(param0: Char2FloatMap$Entry) => void> implements ObjectIterator<Char2FloatMap$Entry> {
    private constructor(null_: Char2FloatOpenHashMap$EntryIterator)
