...
export class Char2ObjectOpenHashMap$ValueIterator extends Char2ObjectOpenHashMap$MapIterator<Object> implements ObjectIterator<V> {
    constructor(null_: Char2ObjectOpenHashMap$ValueIterator)
