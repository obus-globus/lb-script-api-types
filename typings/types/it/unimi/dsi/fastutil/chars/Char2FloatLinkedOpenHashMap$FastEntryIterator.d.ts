...
export class Char2FloatLinkedOpenHashMap$FastEntryIterator extends Char2FloatLinkedOpenHashMap$MapIterator<(param0: Char2FloatMap$Entry) => void> implements ObjectListIterator<Char2FloatMap$Entry> {
    constructor(null_: Char2FloatLinkedOpenHashMap$FastEntryIterator)
    constructor(null_: Char2FloatLinkedOpenHashMap$FastEntryIterator, arg1: string)
