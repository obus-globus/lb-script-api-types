...
export class Char2ByteOpenCustomHashMap$ValueIterator extends Char2ByteOpenCustomHashMap$MapIterator<(param0: number) => void> implements ByteIterator {
    constructor(null_: Char2ByteOpenCustomHashMap$ValueIterator)
