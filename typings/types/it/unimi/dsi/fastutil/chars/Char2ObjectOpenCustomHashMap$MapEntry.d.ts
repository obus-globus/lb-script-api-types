...
export class Char2ObjectOpenCustomHashMap$MapEntry extends Object implements Char2ObjectMap$Entry<V>, CharObjectPair<V>, Map$Entry<string, V> {
    ...
    constructor(null_: Char2ObjectOpenCustomHashMap$MapEntry)
    constructor(null_: Char2ObjectOpenCustomHashMap$MapEntry, arg1: number)
