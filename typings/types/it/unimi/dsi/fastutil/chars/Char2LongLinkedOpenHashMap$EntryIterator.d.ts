...
export class Char2LongLinkedOpenHashMap$EntryIterator extends Char2LongLinkedOpenHashMap$MapIterator<(param0: Char2LongMap$Entry) => void> implements ObjectListIterator<Char2LongMap$Entry> {
    constructor(null_: Char2LongLinkedOpenHashMap$EntryIterator)
    constructor(null_: Char2LongLinkedOpenHashMap$EntryIterator, arg1: string)
