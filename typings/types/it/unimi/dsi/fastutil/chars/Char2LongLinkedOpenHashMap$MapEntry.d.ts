...
export class Char2LongLinkedOpenHashMap$MapEntry extends Object implements Char2LongMap$Entry, CharLongPair, Map$Entry<string, number> {
    ...
    constructor(null_: Char2LongLinkedOpenHashMap$MapEntry)
    constructor(null_: Char2LongLinkedOpenHashMap$MapEntry, arg1: number)
