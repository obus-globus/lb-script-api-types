...
export class Char2FloatOpenCustomHashMap$EntryIterator extends Char2FloatOpenCustomHashMap$MapIterator<(param0: Char2FloatMap$Entry) => void> implements ObjectIterator<Char2FloatMap$Entry> {
    private constructor(null_: Char2FloatOpenCustomHashMap$EntryIterator)
