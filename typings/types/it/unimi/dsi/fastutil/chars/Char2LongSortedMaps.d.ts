...
export class Char2LongSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Char2LongMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Char2LongMap$Entry>;
