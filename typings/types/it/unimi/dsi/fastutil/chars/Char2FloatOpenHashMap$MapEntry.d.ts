...
export class Char2FloatOpenHashMap$MapEntry extends Object implements Char2FloatMap$Entry, CharFloatPair, Map$Entry<string, number> {
    ...
    constructor(null_: Char2FloatOpenHashMap$MapEntry)
    constructor(null_: Char2FloatOpenHashMap$MapEntry, arg1: number)
