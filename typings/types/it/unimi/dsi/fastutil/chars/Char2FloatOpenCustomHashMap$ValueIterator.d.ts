...
export class Char2FloatOpenCustomHashMap$ValueIterator extends Char2FloatOpenCustomHashMap$MapIterator<(param0: number) => void> implements FloatIterator {
    constructor(null_: Char2FloatOpenCustomHashMap$ValueIterator)
