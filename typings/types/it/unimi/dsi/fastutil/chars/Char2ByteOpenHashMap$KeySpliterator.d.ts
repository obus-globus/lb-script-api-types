...
export class Char2ByteOpenHashMap$KeySpliterator extends Char2ByteOpenHashMap$MapSpliterator<(param0: string) => void, Char2ByteOpenHashMap$KeySpliterator> implements CharSpliterator {
    ...
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Char2ByteOpenHashMap$KeySpliterator;
