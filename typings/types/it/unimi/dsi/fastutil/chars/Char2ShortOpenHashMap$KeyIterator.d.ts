...
export class Char2ShortOpenHashMap$KeyIterator extends Char2ShortOpenHashMap$MapIterator<(param0: string) => void> implements CharIterator {
    constructor(null_: Char2ShortOpenHashMap$KeyIterator)
