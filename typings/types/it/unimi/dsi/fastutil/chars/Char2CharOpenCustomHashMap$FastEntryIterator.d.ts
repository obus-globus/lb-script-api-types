...
export class Char2CharOpenCustomHashMap$FastEntryIterator extends Char2CharOpenCustomHashMap$MapIterator<(param0: Char2CharMap$Entry) => void> implements ObjectIterator<Char2CharMap$Entry> {
    private constructor(null_: Char2CharOpenCustomHashMap$FastEntryIterator)
