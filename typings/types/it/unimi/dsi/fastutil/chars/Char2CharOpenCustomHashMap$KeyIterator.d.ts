...
export class Char2CharOpenCustomHashMap$KeyIterator extends Char2CharOpenCustomHashMap$MapIterator<(param0: string) => void> implements CharIterator {
    constructor(null_: Char2CharOpenCustomHashMap$KeyIterator)
