...
export class Char2ReferenceLinkedOpenHashMap$ValueIterator extends Char2ReferenceLinkedOpenHashMap$MapIterator<Object> implements ObjectListIterator<V> {
    constructor(null_: Char2ReferenceLinkedOpenHashMap$ValueIterator)
