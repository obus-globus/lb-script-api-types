...
export abstract class AbstractChar2ReferenceFunction<V extends Object | number | string | boolean> extends Object implements Char2ReferenceFunction<V>, Serializable {
    constructor()
