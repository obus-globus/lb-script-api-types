...
export class CharBigArrays extends Object {
    ...
    static binarySearch(paramarg0: (Object | null)[], paramarg1: string, paramarg2: (param0: string, param1: string) => number): number;
    static binarySearch(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: string): number;
    static binarySearch(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: string, paramarg4: (param0: string, param1: string) => number): number;
    ...
    static parallelQuickSort(paramarg0: (Object | null)[], paramarg1: (param0: string, param1: string) => number): void;
    static parallelQuickSort(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number): void;
    static parallelQuickSort(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: (param0: string, param1: string) => number): void;
    static quickSort(paramarg0: (Object | null)[]): void;
    static quickSort(paramarg0: (Object | null)[], paramarg1: (param0: string, param1: string) => number): void;
    static quickSort(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number): void;
    static quickSort(paramarg0: (Object | null)[], paramarg1: number, paramarg2: number, paramarg3: (param0: string, param1: string) => number): void;
