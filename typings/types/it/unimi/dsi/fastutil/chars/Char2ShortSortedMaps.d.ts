...
export class Char2ShortSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Char2ShortMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Char2ShortMap$Entry>;
