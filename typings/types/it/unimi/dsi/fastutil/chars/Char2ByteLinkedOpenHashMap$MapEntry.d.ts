...
export class Char2ByteLinkedOpenHashMap$MapEntry extends Object implements Char2ByteMap$Entry, CharBytePair, Map$Entry<string, number> {
    ...
    constructor(null_: Char2ByteLinkedOpenHashMap$MapEntry)
    constructor(null_: Char2ByteLinkedOpenHashMap$MapEntry, arg1: number)
