...
export class Char2DoubleSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Char2DoubleMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Char2DoubleMap$Entry>;
    static singleton(paramarg0: string, paramarg1: number): JavaMap<any, any>;
    static singleton(paramarg0: string, paramarg1: number, paramarg2: (param0: string, param1: string) => number): JavaMap<any, any>;
