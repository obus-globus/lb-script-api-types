...
export class Char2LongOpenHashMap$ValueIterator extends Char2LongOpenHashMap$MapIterator<(param0: number) => void> implements LongIterator {
    constructor(null_: Char2LongOpenHashMap$ValueIterator)
