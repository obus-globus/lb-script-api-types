...
export class Char2LongOpenCustomHashMap$KeyIterator extends Char2LongOpenCustomHashMap$MapIterator<(param0: string) => void> implements CharIterator {
    constructor(null_: Char2LongOpenCustomHashMap$KeyIterator)
