...
export class Char2DoubleOpenCustomHashMap$ValueSpliterator extends Char2DoubleOpenCustomHashMap$MapSpliterator<(param0: number) => void, Char2DoubleOpenCustomHashMap$ValueSpliterator> implements DoubleSpliterator {
    ...
    constructor(null_: Char2DoubleOpenCustomHashMap$ValueSpliterator)
    constructor(null_: Char2DoubleOpenCustomHashMap$ValueSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => kotlin.Int;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Char2DoubleOpenCustomHashMap$ValueSpliterator;
