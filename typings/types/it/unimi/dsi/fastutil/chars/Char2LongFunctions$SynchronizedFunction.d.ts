...
export class Char2LongFunctions$SynchronizedFunction extends Object implements Char2LongFunction, Serializable {
    constructor(arg0: (param0: string) => kotlin.Long)
    constructor(arg0: (param0: string) => kotlin.Long, arg1: Object)
    ...
    composeByte(arg0: (param0: number) => kotlin.Char): (param0: number) => kotlin.Long;
    composeChar(arg0: (param0: string) => kotlin.Char): (param0: string) => kotlin.Long;
    composeDouble(arg0: (param0: number) => kotlin.Char): (param0: number) => kotlin.Long;
    composeFloat(arg0: (param0: number) => kotlin.Char): (param0: number) => kotlin.Long;
    composeInt(arg0: (param0: number) => kotlin.Char): (param0: number) => kotlin.Long;
    composeLong(arg0: (param0: number) => kotlin.Char): (param0: number) => kotlin.Long;
    composeObject(arg0: (param0: T) => kotlin.Char): (param0: T) => kotlin.Long;
    composeReference(arg0: (param0: T) => kotlin.Char): (param0: T) => kotlin.Long;
    composeShort(arg0: (param0: number) => kotlin.Char): (param0: number) => kotlin.Long;
