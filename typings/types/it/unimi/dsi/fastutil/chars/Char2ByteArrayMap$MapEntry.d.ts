...
export class Char2ByteArrayMap$MapEntry extends Object implements Char2ByteMap$Entry, CharBytePair, Map$Entry<string, number> {
    ...
    constructor(null_: Char2ByteArrayMap$MapEntry)
    constructor(null_: Char2ByteArrayMap$MapEntry, arg1: number)
