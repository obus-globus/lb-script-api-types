...
export class Char2LongOpenHashMap$ValueSpliterator extends Char2LongOpenHashMap$MapSpliterator<(param0: number) => void, Char2LongOpenHashMap$ValueSpliterator> implements LongSpliterator {
    ...
    constructor(null_: Char2LongOpenHashMap$ValueSpliterator)
    constructor(null_: Char2LongOpenHashMap$ValueSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => number;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Char2LongOpenHashMap$ValueSpliterator;
