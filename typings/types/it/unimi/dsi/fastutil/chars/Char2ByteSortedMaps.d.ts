...
export class Char2ByteSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Char2ByteMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Char2ByteMap$Entry>;
