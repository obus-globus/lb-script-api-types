...
export class Char2DoubleFunctions$SynchronizedFunction extends Object implements Char2DoubleFunction, Serializable {
    constructor(arg0: (param0: string) => kotlin.Double)
    constructor(arg0: (param0: string) => kotlin.Double, arg1: Object)
