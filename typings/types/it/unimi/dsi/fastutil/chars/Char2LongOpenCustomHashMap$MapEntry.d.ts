...
export class Char2LongOpenCustomHashMap$MapEntry extends Object implements Char2LongMap$Entry, CharLongPair, Map$Entry<string, number> {
    ...
    constructor(null_: Char2LongOpenCustomHashMap$MapEntry)
    constructor(null_: Char2LongOpenCustomHashMap$MapEntry, arg1: number)
