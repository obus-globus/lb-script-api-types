...
export class Char2CharSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Char2CharMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Char2CharMap$Entry>;
    static singleton(paramarg0: string, paramarg1: string): JavaMap<any, any>;
    static singleton(paramarg0: string, paramarg1: string, paramarg2: (param0: string, param1: string) => number): JavaMap<any, any>;
