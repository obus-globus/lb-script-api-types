...
export class Char2ObjectMaps extends Object {
    ...
    static fastForEach(paramarg0: Char2ObjectMap<Object>, paramarg1: (param0: Object | null) => void): void;
    static fastIterable(paramarg0: Char2ObjectMap<Object>): K[];
    static fastIterator(paramarg0: Char2ObjectMap<Object>): ObjectIterator<Object>;
