...
export class Char2ReferenceOpenCustomHashMap$EntrySpliterator {
    ...
    makeForSplit<V extends unknown>(arg0: number, arg1: number, arg2: boolean): Char2ReferenceOpenCustomHashMap$EntrySpliterator;
}