...
export class Char2ObjectOpenHashMap$EntrySpliterator {
    ...
    makeForSplit<V extends unknown>(arg0: number, arg1: number, arg2: boolean): Char2ObjectOpenHashMap$EntrySpliterator;
}