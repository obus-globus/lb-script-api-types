...
export class Char2IntOpenHashMap$ValueSpliterator extends Char2IntOpenHashMap$MapSpliterator<(param0: number) => void, Char2IntOpenHashMap$ValueSpliterator> implements IntSpliterator {
    ...
    constructor(null_: Char2IntOpenHashMap$ValueSpliterator)
    constructor(null_: Char2IntOpenHashMap$ValueSpliterator, arg1: number, arg2: number, arg3: boolean, arg4: boolean)
    acceptOnIndex(arg0: (param0: number) => void, arg1: number): void;
    characteristics(): number;
    forEachRemaining(arg0: (param0: number) => void): void;
    getComparator(): (param0: number, param1: number) => kotlin.Int;
    makeForSplit(arg0: number, arg1: number, arg2: boolean): Char2IntOpenHashMap$ValueSpliterator;
