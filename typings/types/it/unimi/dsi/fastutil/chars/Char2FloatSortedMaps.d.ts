...
export class Char2FloatSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Char2FloatMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Char2FloatMap$Entry>;
