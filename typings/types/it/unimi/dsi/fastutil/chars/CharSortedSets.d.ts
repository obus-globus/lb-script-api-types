...
export class CharSortedSets extends Object {
    ...
    static singleton(paramarg0: string, paramarg1: (param0: string, param1: string) => kotlin.Int): (Object | null)[];
    static singleton(paramarg0: Object): (Object | null)[];
    static singleton(paramarg0: Object, paramarg1: (param0: string, param1: string) => kotlin.Int): (Object | null)[];
