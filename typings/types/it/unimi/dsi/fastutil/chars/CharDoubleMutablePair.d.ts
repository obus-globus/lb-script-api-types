...
export class CharDoubleMutablePair extends Object implements CharDoublePair, Serializable {
    static lexComparator(): (param0: CharDoublePair) => kotlin.Boolean;
    static of(paramarg0: string, paramarg1: number): CharDoubleMutablePair;
