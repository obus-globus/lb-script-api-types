...
export class Char2ShortLinkedOpenHashMap$MapEntry extends Object implements Char2ShortMap$Entry, CharShortPair, Map$Entry<string, number> {
    ...
    constructor(null_: Char2ShortLinkedOpenHashMap$MapEntry)
    constructor(null_: Char2ShortLinkedOpenHashMap$MapEntry, arg1: number)
