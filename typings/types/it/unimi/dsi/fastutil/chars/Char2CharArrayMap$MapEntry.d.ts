...
export class Char2CharArrayMap$MapEntry extends Object implements Char2CharMap$Entry, CharCharPair, Map$Entry<string, string> {
    ...
    constructor(null_: Char2CharArrayMap$MapEntry)
    constructor(null_: Char2CharArrayMap$MapEntry, arg1: number)
