...
export class Char2IntSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: JavaMap<any, any>): Char2IntMap$Entry[];
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Char2IntMap$Entry>;
