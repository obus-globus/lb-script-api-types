...
export class Char2IntSortedMaps extends Object {
    ...
    static fastIterable(paramarg0: { [key: string]: any }): Char2IntMap$Entry[];
    static fastIterator(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Char2IntMap$Entry>;
