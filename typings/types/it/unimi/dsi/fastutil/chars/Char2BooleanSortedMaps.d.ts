...
export class Char2BooleanSortedMaps extends Object {
    ...
    static fastIterator(paramarg0: JavaMap<any, any>): ObjectBidirectionalIterator<Char2BooleanMap$Entry>;
    static singleton(paramarg0: string, paramarg1: boolean): JavaMap<any, any>;
    static singleton(paramarg0: string, paramarg1: boolean, paramarg2: (param0: string, param1: string) => number): JavaMap<any, any>;
