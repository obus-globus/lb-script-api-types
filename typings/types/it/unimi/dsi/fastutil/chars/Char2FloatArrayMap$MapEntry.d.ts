...
export class Char2FloatArrayMap$MapEntry extends Object implements Char2FloatMap$Entry, CharFloatPair, Map$Entry<string, number> {
    ...
    constructor(null_: Char2FloatArrayMap$MapEntry)
    constructor(null_: Char2FloatArrayMap$MapEntry, arg1: number)
