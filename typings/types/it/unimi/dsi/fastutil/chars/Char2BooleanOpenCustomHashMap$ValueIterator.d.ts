...
export class Char2BooleanOpenCustomHashMap$ValueIterator extends Char2BooleanOpenCustomHashMap$MapIterator<(param0: boolean) => void> implements BooleanIterator {
    constructor(null_: Char2BooleanOpenCustomHashMap$ValueIterator)
