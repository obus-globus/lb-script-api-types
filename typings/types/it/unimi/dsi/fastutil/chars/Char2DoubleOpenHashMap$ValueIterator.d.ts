...
export class Char2DoubleOpenHashMap$ValueIterator extends Char2DoubleOpenHashMap$MapIterator<(param0: number) => void> implements DoubleIterator {
    constructor(null_: Char2DoubleOpenHashMap$ValueIterator)
