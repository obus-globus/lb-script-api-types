...
export class CallServerInterceptor extends Object implements Interceptor {
    static Companion: Interceptor$Companion;
    static INSTANCE: CallServerInterceptor;
    intercept(chain: Interceptor$Chain): Response;
    // private shouldIgnoreAndWaitForRealResponse(code: number): boolean;
}