...
export class RetryAndFollowUpInterceptor extends Object implements Interceptor {
    ...
    constructor()
    // private buildRedirectRequest(userResponse: Response, method: string, chain: Interceptor$Chain): Request | null;
    // private followUpRequest(userResponse: Response, exchange: Exchange | null, chain: Interceptor$Chain): Request | null;
    intercept(chain: Interceptor$Chain): Response;
    // private isRecoverable(e: IOException, requestSendStarted: boolean): boolean;
    // private recover(e: IOException, call: RealCall, chain: Interceptor$Chain, userRequest: Request): boolean;
