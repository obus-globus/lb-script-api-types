...
export class _UtilCommonKt extends Object {
    ...
    static hasIntersection(paramarg0: string[], paramarg1: string[], paramarg2: (param0: Object, param1: Object) => number): boolean;
    static ignoreIoExceptions(paramarg0: () => void): void;
    static indexOf(paramarg0: string[], paramarg1: string, paramarg2: (param0: string, param1: string) => number): number;
    ...
    static intersect(paramarg0: string[], paramarg1: string[], paramarg2: (param0: Object, param1: Object) => number): string[];
