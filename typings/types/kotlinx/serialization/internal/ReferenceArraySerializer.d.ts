...
export class ReferenceArraySerializer<ElementKlass extends unknown, Element extends ElementKlass> extends CollectionLikeSerializer<Element, Element[], Element[]> {
