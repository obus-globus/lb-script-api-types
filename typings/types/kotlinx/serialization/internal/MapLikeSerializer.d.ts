...
export class MapLikeSerializer<Key extends unknown, Value extends unknown, Collection extends unknown, Builder extends JavaMap<Key, Value>> extends AbstractCollectionSerializer<Map$Entry<Key, Value>, Collection, Builder> {
