...
export class JsonArraySerializer$JsonArrayDescriptor extends Object implements SerialDescriptor {
    static INSTANCE: JsonArraySerializer$JsonArrayDescriptor;
