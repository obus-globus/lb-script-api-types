...
export class SerializersModuleBuildersKt extends Object {
    ...
    static SerializersModule(paramarg0: (param0: Object) => void): SerializersModule;
    static contextual(paramarg0: SerializersModuleBuilder, paramarg1: KSerializer<Object>): void;
    static polymorphic(paramarg0: SerializersModuleBuilder, paramarg1: KClass<Object>, paramarg2: KSerializer<Object>, paramarg3: (param0: Object) => void): void;
