...
import type { LocalTime as LocalTime_2 } from '../../java/time/LocalTime.d.ts'
...
export class LocalTime extends Object implements Serializable, Comparable<LocalTime> {
    ...
    constructor(value: LocalTime_2)
    constructor(hour: number, minute: number, second: number, nanosecond: number)
    readonly hour: number;
    readonly minute: number;
    readonly nanosecond: number;
    readonly second: number;
    // private value: LocalTime_2;
    /*not mapped: */ getValue$kotlinx_datetime(): LocalTime_2;
