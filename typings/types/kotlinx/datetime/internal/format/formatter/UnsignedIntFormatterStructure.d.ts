...
export class UnsignedIntFormatterStructure<T extends Object | number | string | boolean> extends Object implements FormatterStructure<T> {
    constructor(number: Function1<T, number>, zeroPadding: number)
