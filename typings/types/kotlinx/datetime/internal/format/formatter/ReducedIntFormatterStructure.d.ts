...
export class ReducedIntFormatterStructure<T extends Object | number | string | boolean> extends Object implements FormatterStructure<T> {
    constructor(number: Function1<T, number>, digits: number, base: number)
    // private base: number;
