...
export class CancellableContinuationImpl<T extends Object | number | string | boolean> extends DispatchedTask<T> implements CoroutineStackFrame, CancellableContinuation<T>, Waiter {
    ...
    // private callCancelHandlerSafely(block: Function0<void>): void;
    callOnCancellation<R extends Object | number | string | boolean>(onCancellation: Function3<Throwable, R, CoroutineContext, void>, cause: Throwable, value: R): void;
    ...
    resumeImpl<R extends Object | number | string | boolean>(proposedUpdate: R, resumeMode: number, onCancellation: Function3<Throwable, R, CoroutineContext, void> | null): void;
    resumeWith(result: Result<T>): void;
    // private resumedState<R extends Object | number | string | boolean>(state: NotCompleted, proposedUpdate: R, resumeMode: number, onCancellation: Function3<Throwable, R, CoroutineContext, void> | null, idempotent: Object | null): Object | null;
    ...
    // private tryResumeImpl<R extends Object | number | string | boolean>(proposedUpdate: R, idempotent: Object | null, onCancellation: Function3<Throwable, R, CoroutineContext, void> | null): Symbol | null;
