...
export class ChannelsKt__DeprecatedKt extends Object {
    ...
    static consume<E extends unknown, R extends unknown>(paramarg0: BroadcastChannel<E>, paramarg1: (param0: Object) => R): R;
    static consumeEach<E extends unknown>(paramarg0: BroadcastChannel<E>, paramarg1: (param0: Object) => void, paramarg2: Continuation<Object>): Object;
    ...
    static distinctBy<E extends unknown, K extends unknown>(paramarg0: ReceiveChannel<E>, paramarg1: CoroutineContext, paramarg2: (param0: Object, param1: Object) => Object): ReceiveChannel<E>;
    ...
    static filter<E extends unknown>(paramarg0: ReceiveChannel<E>, paramarg1: CoroutineContext, paramarg2: (param0: Object, param1: Object) => Object): ReceiveChannel<E>;
    ...
    static filterNotNull<E extends unknown>(paramarg0: ReceiveChannel<E>): ReceiveChannel<E>;
    ...
    static map<E extends unknown, R extends unknown>(paramarg0: ReceiveChannel<E>, paramarg1: CoroutineContext, paramarg2: (param0: Object, param1: Object) => Object): ReceiveChannel<R>;
    static mapIndexed<E extends unknown, R extends unknown>(paramarg0: ReceiveChannel<E>, paramarg1: CoroutineContext, paramarg2: (param0: Object, param1: Object, param2: Object) => Object): ReceiveChannel<R>;
    ...
    static produce<E extends unknown>(paramarg0: CoroutineScope, paramarg1: Job, paramarg2: number, paramarg3: (param0: Object, param1: Object) => Object): ReceiveChannel<E>;
    ...
    static zip<E extends unknown, R extends unknown, V extends unknown>(paramarg0: ReceiveChannel<E>, paramarg1: ReceiveChannel<R>, paramarg2: CoroutineContext, paramarg3: (param0: Object, param1: Object) => V): ReceiveChannel<V>;
