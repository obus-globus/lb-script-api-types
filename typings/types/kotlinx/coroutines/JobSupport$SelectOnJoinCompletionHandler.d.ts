...
export class JobSupport$SelectOnJoinCompletionHandler extends JobNode {
    constructor(null_: JobSupport$SelectOnJoinCompletionHandler, select: SelectInstance<Object>)
