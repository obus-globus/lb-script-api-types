...
export class ReadonlyDeferred<T extends unknown> extends Object implements Deferred<T> {
    static Key: Job$Key;
    constructor(deferred: CompletableDeferred<T>)
    readonly children: Sequence<Job>;
    readonly deferred: CompletableDeferred<T>;
