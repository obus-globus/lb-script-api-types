...
export class DynamicTextNode extends Record implements TextNode {
    ...
    constructor(id: string, key: ParserContext$Key<(param0: string) => Component>)
    // private id: string;
    // private key: ParserContext$Key<(param0: string) => Component>;
