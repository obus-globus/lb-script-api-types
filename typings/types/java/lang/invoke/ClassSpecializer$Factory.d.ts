...
export class ClassSpecializer$Factory extends Object {
    ...
    // private findFactories<T extends unknown>(arg0: Class<T>, arg1: Class<Object>[]): MethodHandle[];
    findFactory<T extends unknown>(arg0: Class<T>, arg1: Class<Object>[]): MethodHandle;
    ...
    generateConcreteSpeciesCode<T extends unknown, K extends unknown, S extends ClassSpecializer$SpeciesData>(arg0: string, arg1: ClassSpecializer$SpeciesData): Class<T>;
    generateConcreteSpeciesCodeFile<T extends unknown, K extends unknown, S extends ClassSpecializer$SpeciesData>(arg0: string, arg1: ClassSpecializer$SpeciesData): number[];
    linkCodeToSpeciesData<T extends unknown, K extends unknown, S extends ClassSpecializer$SpeciesData>(arg0: Class<T>, arg1: ClassSpecializer$SpeciesData, arg2: boolean): void;
    linkSpeciesDataToCode<T extends unknown, K extends unknown, S extends ClassSpecializer$SpeciesData>(arg0: ClassSpecializer$SpeciesData, arg1: Class<T>): void;
    loadSpecies<S extends ClassSpecializer$SpeciesData>(arg0: S): S;
    loadSpeciesDataFromCode<S extends ClassSpecializer$SpeciesData, T extends unknown>(arg0: Class<T>): S;
    makeNominalGetters(arg0: Class<Object>[], arg1: MethodHandle[]): LambdaForm$NamedFunction[];
    // private readSpeciesDataFromCode<S extends ClassSpecializer$SpeciesData, T extends unknown>(arg0: Class<T>): S;
    // private reflectSDField<T extends unknown>(arg0: Class<T>): Field;
}