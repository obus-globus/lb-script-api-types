...
export interface IntStream extends BaseStream<number, IntStream>, Object{
    ...
    count(): number;
    distinct(): IntStream;
    dropWhile(arg0: (param0: number) => kotlin.Boolean): IntStream;
    filter(arg0: (param0: number) => kotlin.Boolean): IntStream;
    findAny(): OptionalInt;
    findFirst(): OptionalInt;
    flatMap(arg0: (param0: IntStream) => unknown): IntStream;
    ...
    map(arg0: (param0: number) => kotlin.Int): IntStream;
    ...
    reduce(arg0: (param0: number, param1: number) => kotlin.Int): OptionalInt;
    reduce(arg0: number, arg1: (param0: number, param1: number) => kotlin.Int): number;
    ...
    takeWhile(arg0: (param0: number) => kotlin.Boolean): IntStream;
    toArray(): number[];
}