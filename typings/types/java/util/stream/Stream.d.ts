...
export interface Stream<T extends Object | number | string | boolean> extends BaseStream<T, Stream<T>>, Object {
    ...
    count(): number;
    distinct(): Stream<T>;
    dropWhile(arg0: (param0: T) => kotlin.Boolean): Stream<T>;
    filter(arg0: (param0: T) => kotlin.Boolean): Stream<T>;
    findAny(): Optional<T>;
    findFirst(): Optional<T>;
    flatMap(arg0: (param0: T) => Stream<R>): Stream<R>;
    ...
    gather(arg0: Gatherer<T, Object, R>): Stream<R>;
    limit(arg0: number): Stream<T>;
    map(arg0: (param0: T) => R): Stream<R>;
    mapMulti(arg0: (param0: T, param1: (param0: R) => void) => void): Stream<R>;
    ...
    max(arg0: (param0: T) => kotlin.Boolean): Optional<T>;
    min(arg0: (param0: T) => kotlin.Boolean): Optional<T>;
    ...
    sorted(): Stream<T>;
    sorted(arg0: (param0: T) => kotlin.Boolean): Stream<T>;
    takeWhile(arg0: (param0: T) => kotlin.Boolean): Stream<T>;
    toArray(): Object[];
