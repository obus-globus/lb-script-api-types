...
export class Pattern extends Object implements Serializable {
    ...
    // private predicate: (param0: number) => boolean;
    ...
    asMatchPredicate(): (param0: string) => boolean;
    asPredicate(): (param0: string) => boolean;
    // private atom(): Pattern$Node;
    // private bitsOrSingle(arg0: Pattern$BitClass, arg1: number): (param0: number) => boolean;
    // private c(): number;
    // private clazz(arg0: boolean): (param0: number) => boolean;
    ...
    // private family(arg0: boolean, arg1: boolean): (param0: number) => boolean;
    ...
    // private range(arg0: Pattern$BitClass): (param0: number) => boolean;
    // private read(): number;
    ...
    // private single(arg0: number): (param0: number) => boolean;
    // private skip(): number;
