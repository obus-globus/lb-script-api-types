...
export class HashMap$EntrySpliterator<K extends unknown, V extends unknown> extends HashMap$HashMapSpliterator<K, V> implements Spliterator<Map$Entry<K, V>> {
    ...
    getComparator(): (param0: Map$Entry<K, V>, param1: Map$Entry<K, V>) => number;
