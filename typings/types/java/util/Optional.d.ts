...
export class Optional<T extends Object | number | string | boolean> extends Object {
    ...
    flatMap<U extends Object | number | string | boolean>(arg0: (param0: T) => Optional<U>): Optional<U>;
    get(): T;
    hashCode(): number;
    ...
    isEmpty(): boolean;
    isPresent(): boolean;
    map<U extends Object | number | string | boolean>(arg0: (param0: T) => U): Optional<U>;
