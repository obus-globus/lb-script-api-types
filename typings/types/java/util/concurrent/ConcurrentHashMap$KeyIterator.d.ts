...
export class ConcurrentHashMap$KeyIterator<K extends unknown, V extends unknown> extends ConcurrentHashMap$BaseIterator<K, V> implements Enumeration<K>, Iterator<K> {
    constructor(arg0: ConcurrentHashMap$Node<K, V>[], arg1: number, arg2: number, arg3: number, arg4: JavaMap<K, V>)
    asIterator(): Iterator<K>;
