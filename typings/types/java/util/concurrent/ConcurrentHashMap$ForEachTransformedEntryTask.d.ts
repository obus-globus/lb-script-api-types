...
export class ConcurrentHashMap$ForEachTransformedEntryTask<K extends unknown, V extends unknown, U extends unknown> extends ConcurrentHashMap$BulkTask<K, V, void> {
    ...
    constructor(arg0: ConcurrentHashMap$BulkTask<K, V, Object>, arg1: number, arg2: number, arg3: number, arg4: ConcurrentHashMap$Node<K, V>[], arg5: (param0: Map$Entry<K, V>) => U, arg6: (param0: U) => void)
