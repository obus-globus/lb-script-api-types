...
export abstract class CompletableFuture$BiCompletion<T extends unknown, U extends unknown, V extends unknown> extends CompletableFuture$UniCompletion<T, V> {
