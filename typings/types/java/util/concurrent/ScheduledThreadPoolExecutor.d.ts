...
export class ScheduledThreadPoolExecutor extends ThreadPoolExecutor implements ScheduledExecutorService {
    ...
    decorateTask(arg0: () => void, arg1: RunnableScheduledFuture<V>): RunnableScheduledFuture<V>;
    decorateTask(arg0: () => V, arg1: RunnableScheduledFuture<V>): RunnableScheduledFuture<V>;
