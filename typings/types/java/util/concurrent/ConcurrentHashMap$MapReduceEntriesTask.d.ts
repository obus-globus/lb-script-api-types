...
export class ConcurrentHashMap$MapReduceEntriesTask<K extends Object | number | string | boolean, V extends Object | number | string | boolean, U extends Object | number | string | boolean> extends ConcurrentHashMap$BulkTask<K, V, U> {
    ...
    constructor(arg0: ConcurrentHashMap$BulkTask<K, V, Object>, arg1: number, arg2: number, arg3: number, arg4: ConcurrentHashMap$Node<K, V>[], arg5: ConcurrentHashMap$MapReduceEntriesTask<K, V, U>, arg6: (param0: Map$Entry<K, V>) => U, arg7: (param0: U, param1: U) => U)
    // private nextRight: ConcurrentHashMap$MapReduceEntriesTask<K, V, U>;
    // private reducer: (param0: U, param1: U) => U;
    // private result: U;
    // private rights: ConcurrentHashMap$MapReduceEntriesTask<K, V, U>;
    // private transformer: (param0: Map$Entry<K, V>) => U;
    compute(): void;
    getRawResult(): U;
}