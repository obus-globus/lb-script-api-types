...
export abstract class AtomicLongFieldUpdater<T extends Object | number | string | boolean> extends Object {
    ...
    constructor()
    accumulateAndGet(arg0: T, arg1: number, arg2: (param0: number, param1: number) => kotlin.Long): number;
    addAndGet(arg0: T, arg1: number): number;
    compareAndSet(arg0: T, arg1: number, arg2: number): boolean;
    decrementAndGet(arg0: T): number;
    get(arg0: T): number;
    getAndAccumulate(arg0: T, arg1: number, arg2: (param0: number, param1: number) => kotlin.Long): number;
    ...
    getAndUpdate(arg0: T, arg1: (param0: number) => kotlin.Long): number;
    incrementAndGet(arg0: T): number;
    lazySet(arg0: T, arg1: number): void;
    set(arg0: T, arg1: number): void;
    updateAndGet(arg0: T, arg1: (param0: number) => kotlin.Long): number;
