...
export abstract class Striped64 extends Number {
    ...
    doubleAccumulate(arg0: number, arg1: (param0: number, param1: number) => number, arg2: boolean, arg3: number): void;
    getAndSetBase(arg0: number): number;
    longAccumulate(arg0: number, arg1: (param0: number, param1: number) => number, arg2: boolean, arg3: number): void;
}