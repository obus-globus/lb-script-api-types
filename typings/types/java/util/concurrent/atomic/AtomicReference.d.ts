...
export class AtomicReference<V extends Object | number | string | boolean> extends Object implements Serializable {
    ...
    constructor(arg0: V)
    // private value: V;
    accumulateAndGet(arg0: V, arg1: (param0: V, param1: Object | null) => unknown): V;
    ...
    get(): V;
    getAcquire(): V;
    getAndAccumulate(arg0: V, arg1: (param0: V, param1: Object | null) => unknown): V;
    getAndSet(arg0: V): V;
    getAndUpdate(arg0: (param0: V) => unknown): V;
    getOpaque(): V;
    getPlain(): V;
    lazySet(arg0: V): void;
    set(arg0: V): void;
    ...
    toString(): string;
    updateAndGet(arg0: (param0: V) => unknown): V;
