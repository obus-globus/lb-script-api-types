...
export class ConcurrentHashMap$MapReduceKeysTask<K extends Object | number | string | boolean, V extends Object | number | string | boolean, U extends Object | number | string | boolean> extends ConcurrentHashMap$BulkTask<K, V, U> {
    ...
    // private result: U;
    // private rights: ConcurrentHashMap$MapReduceKeysTask<K, V, U>;
