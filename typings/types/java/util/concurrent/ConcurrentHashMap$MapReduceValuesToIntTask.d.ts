...
export class ConcurrentHashMap$MapReduceValuesToIntTask<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends ConcurrentHashMap$BulkTask<K, V, number> {
    ...
    constructor(arg0: ConcurrentHashMap$BulkTask<K, V, Object>, arg1: number, arg2: number, arg3: number, arg4: ConcurrentHashMap$Node<K, V>[], arg5: ConcurrentHashMap$MapReduceValuesToIntTask<K, V>, arg6: (param0: V) => kotlin.Int, arg7: number, arg8: (param0: number, param1: number) => kotlin.Int)
    // private basis: number;
    // private nextRight: ConcurrentHashMap$MapReduceValuesToIntTask<K, V>;
    // private reducer: (param0: number, param1: number) => kotlin.Int;
    // private result: number;
    // private rights: ConcurrentHashMap$MapReduceValuesToIntTask<K, V>;
    // private transformer: (param0: V) => kotlin.Int;
    compute(): void;
    getRawResult(): number;
}