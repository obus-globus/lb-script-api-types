...
export class ConcurrentHashMap$MapReduceEntriesToLongTask<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends ConcurrentHashMap$BulkTask<K, V, number> {
    ...
    constructor(arg0: ConcurrentHashMap$BulkTask<K, V, Object>, arg1: number, arg2: number, arg3: number, arg4: ConcurrentHashMap$Node<K, V>[], arg5: ConcurrentHashMap$MapReduceEntriesToLongTask<K, V>, arg6: (param0: Map$Entry<K, V>) => kotlin.Long, arg7: number, arg8: (param0: number, param1: number) => kotlin.Long)
    ...
    // private rights: ConcurrentHashMap$MapReduceEntriesToLongTask<K, V>;
    // private transformer: (param0: Map$Entry<K, V>) => kotlin.Long;
    compute(): void;
    getRawResult(): number;
}