...
export class CompletableFuture$BiAccept<T extends Object | number | string | boolean, U extends Object | number | string | boolean> extends CompletableFuture$BiCompletion<T, U, void> {
    ...
    // private fn: (param0: T, param1: U) => void;
