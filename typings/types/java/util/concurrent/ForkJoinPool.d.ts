...
export class ForkJoinPool extends AbstractExecutorService implements ScheduledExecutorService {
    ...
    externalSubmit<T extends unknown>(arg0: ForkJoinTask<T>): ForkJoinTask<T>;
    ...
    invoke<T extends unknown>(arg0: ForkJoinTask<T>): T;
    invokeAll<T extends unknown>(arg0: () => T[]): Future<T>[];
    // private invokeAll<T extends unknown>(arg0: () => T[], arg1: number): Future<T>[];
    invokeAll<T extends unknown>(arg0: () => T[], arg1: number, arg2: TimeUnit): Future<T>[];
    invokeAllUninterruptibly<T extends unknown>(arg0: () => T[]): Future<T>[];
    ...
    lazySubmit<T extends unknown>(arg0: ForkJoinTask<T>): ForkJoinTask<T>;
    // private lockRunState(): number;
    newTaskFor<T extends unknown>(arg0: () => void, arg1: T): RunnableFuture<T>;
    newTaskFor<T extends unknown>(arg0: () => T): RunnableFuture<T>;
    ...
    // private poolSubmit<T extends unknown>(arg0: boolean, arg1: ForkJoinTask<T>): ForkJoinTask<T>;
    ...
    scheduleDelayedTask<T extends unknown>(arg0: DelayScheduler$ScheduledForkJoinTask<T>): DelayScheduler$ScheduledForkJoinTask<T>;
    ...
    submit<T extends unknown>(arg0: () => void, arg1: T): ForkJoinTask<T>;
    submit<T extends unknown>(arg0: () => T): ForkJoinTask<T>;
    submit<T extends unknown>(arg0: ForkJoinTask<T>): ForkJoinTask<T>;
    submitWithTimeout<V extends unknown>(arg0: () => V, arg1: number, arg2: TimeUnit, arg3: (param0: ForkJoinTask<V>) => void): ForkJoinTask<V>;
