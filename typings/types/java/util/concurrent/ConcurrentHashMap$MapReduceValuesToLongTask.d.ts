...
export class ConcurrentHashMap$MapReduceValuesToLongTask<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends ConcurrentHashMap$BulkTask<K, V, number> {
    ...
    constructor(arg0: ConcurrentHashMap$BulkTask<K, V, Object>, arg1: number, arg2: number, arg3: number, arg4: ConcurrentHashMap$Node<K, V>[], arg5: ConcurrentHashMap$MapReduceValuesToLongTask<K, V>, arg6: (param0: V) => kotlin.Long, arg7: number, arg8: (param0: number, param1: number) => kotlin.Long)
    // private basis: number;
    // private nextRight: ConcurrentHashMap$MapReduceValuesToLongTask<K, V>;
    // private reducer: (param0: number, param1: number) => kotlin.Long;
    // private result: number;
    // private rights: ConcurrentHashMap$MapReduceValuesToLongTask<K, V>;
    // private transformer: (param0: V) => kotlin.Long;
    compute(): void;
    getRawResult(): number;
}