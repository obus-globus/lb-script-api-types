...
export class ConcurrentHashMap$MapReduceValuesToLongTask<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends ConcurrentHashMap$BulkTask<K, V, number> {
    ...
    constructor(arg0: ConcurrentHashMap$BulkTask<K, V, Object>, arg1: number, arg2: number, arg3: number, arg4: ConcurrentHashMap$Node<K, V>[], arg5: ConcurrentHashMap$MapReduceValuesToLongTask<K, V>, arg6: (param0: V) => number, arg7: number, arg8: (param0: number, param1: number) => number)
