...
export class ConcurrentHashMap$ReduceValuesTask<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends ConcurrentHashMap$BulkTask<K, V, V> {
    ...
    // private result: V;
    // private rights: ConcurrentHashMap$ReduceValuesTask<K, V>;
    compute(): void;
    getRawResult(): V;
}