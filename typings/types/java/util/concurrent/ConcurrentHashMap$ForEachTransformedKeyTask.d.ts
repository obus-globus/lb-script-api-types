...
export class ConcurrentHashMap$ForEachTransformedKeyTask<K extends Object | number | string | boolean, V extends Object | number | string | boolean, U extends Object | number | string | boolean> extends ConcurrentHashMap$BulkTask<K, V, void> {
    ...
    constructor(arg0: ConcurrentHashMap$BulkTask<K, V, Object>, arg1: number, arg2: number, arg3: number, arg4: ConcurrentHashMap$Node<K, V>[], arg5: (param0: K) => U, arg6: (param0: U) => void)
    // private action: (param0: U) => void;
    // private transformer: (param0: K) => U;
    compute(): void;
}