...
export interface CompletionStage<T extends Object | number | string | boolean> extends Object {
    ...
    applyToEither(arg0: CompletionStage<T>, arg1: (param0: T) => U): CompletionStage<U>;
    applyToEitherAsync(arg0: CompletionStage<T>, arg1: (param0: T) => U): CompletionStage<U>;
    applyToEitherAsync(arg0: CompletionStage<T>, arg1: (param0: T) => U, arg2: Executor): CompletionStage<U>;
    ...
    handle(arg0: (param0: T, param1: Throwable) => U): CompletionStage<U>;
    handleAsync(arg0: (param0: T, param1: Throwable) => U): CompletionStage<U>;
    handleAsync(arg0: (param0: T, param1: Throwable) => U, arg1: Executor): CompletionStage<U>;
    ...
    thenAcceptBoth(arg0: CompletionStage<U>, arg1: (param0: T, param1: U) => void): CompletionStage<void>;
    thenAcceptBothAsync(arg0: CompletionStage<U>, arg1: (param0: T, param1: U) => void): CompletionStage<void>;
    thenAcceptBothAsync(arg0: CompletionStage<U>, arg1: (param0: T, param1: U) => void, arg2: Executor): CompletionStage<void>;
    thenApply(arg0: (param0: T) => U): CompletionStage<U>;
    thenApplyAsync(arg0: (param0: T) => U): CompletionStage<U>;
    thenApplyAsync(arg0: (param0: T) => U, arg1: Executor): CompletionStage<U>;
    thenCombine(arg0: CompletionStage<U>, arg1: (param0: T, param1: U) => V): CompletionStage<V>;
    thenCombineAsync(arg0: CompletionStage<U>, arg1: (param0: T, param1: U) => V): CompletionStage<V>;
    thenCombineAsync(arg0: CompletionStage<U>, arg1: (param0: T, param1: U) => V, arg2: Executor): CompletionStage<V>;
    thenCompose(arg0: (param0: T) => CompletionStage<U>): CompletionStage<U>;
    thenComposeAsync(arg0: (param0: T) => CompletionStage<U>): CompletionStage<U>;
    thenComposeAsync(arg0: (param0: T) => CompletionStage<U>, arg1: Executor): CompletionStage<U>;
