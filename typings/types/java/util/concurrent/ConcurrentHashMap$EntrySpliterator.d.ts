...
export class ConcurrentHashMap$EntrySpliterator<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends ConcurrentHashMap$Traverser<K, V> implements Spliterator<Map$Entry<K, V>> {
