...
export class HashMap$TreeNode<K extends unknown, V extends unknown> extends LinkedHashMap$Entry<K, V> {
    ...
    putTreeVal(arg0: Map<K, V>, arg1: HashMap$Node<K, V>[], arg2: number, arg3: K, arg4: V): HashMap$TreeNode<K, V>;
    removeTreeNode(arg0: Map<K, V>, arg1: HashMap$Node<K, V>[], arg2: boolean): void;
    root(): HashMap$TreeNode<K, V>;
    split(arg0: Map<K, V>, arg1: HashMap$Node<K, V>[], arg2: number, arg3: number): void;
    treeify(arg0: HashMap$Node<K, V>[]): void;
    untreeify(arg0: Map<K, V>): HashMap$Node<K, V>;
}