...
export interface HttpResponse$PushPromiseHandler<T extends unknown> extends Object {
    applyPushPromise(arg0: HttpRequest, arg1: HttpRequest, arg2: (param0: (param0: HttpResponse$ResponseInfo) => HttpResponse$BodySubscriber<T>) => CompletableFuture<HttpResponse<T>>): void;
}