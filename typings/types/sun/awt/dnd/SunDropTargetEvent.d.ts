...
import type { SunDropTargetContextPeer$EventDispatcher } from '../../../sun/awt/dnd/SunDropTargetContextPeer$EventDispatcher.d.ts'
export class SunDropTargetEvent extends MouseEvent {
    ...
    constructor(arg0: Component, arg1: number, arg2: number, arg3: number, arg4: SunDropTargetContextPeer$EventDispatcher)
    readonly dispatcher: SunDropTargetContextPeer$EventDispatcher;
    consume(): void;
    dispatch(): void;
    dispose(): void;
    getDispatcher(): SunDropTargetContextPeer$EventDispatcher;
    paramString(): string;
}