...
export class Reifier extends Object implements TypeTreeVisitor<Type> {
    static make(paramarg0: GenericsFactory): Reifier;
    private constructor(arg0: GenericsFactory)
    // private factory: GenericsFactory;
    // private resultType: Type;
    // private getFactory(): GenericsFactory;
    getResult(): Type;
    // private reifyTypeArguments(arg0: TypeArgument[]): Type[];
