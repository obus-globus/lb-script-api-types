import type { GLDebugMessageCallback } from '../../../org/lwjgl/opengl/GLDebugMessageCallback.d.ts'
import type { GLDebugMessageCallbackI } from '../../../org/lwjgl/opengl/GLDebugMessageCallbackI.d.ts'
import type { Callback$Descriptor } from '../../../org/lwjgl/system/Callback$Descriptor.d.ts'
import type { CallbackI } from '../../../org/lwjgl/system/CallbackI.d.ts'
export class GLDebugMessageCallback$Container extends GLDebugMessageCallback {
    ...
    static create(paramarg0: number): GLDebugMessageCallback;
    static create(paramarg0: (param0: number, param1: number, param2: number, param3: number, param4: number, param5: number, param6: number) => void): GLDebugMessageCallback;
    static createSafe(paramarg0: number): GLDebugMessageCallback;
