...
export class VkPhysicalDeviceCopyMemoryIndirectPropertiesKHR extends Struct<VkPhysicalDeviceCopyMemoryIndirectPropertiesKHR> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceCopyMemoryIndirectPropertiesKHR;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceCopyMemoryIndirectPropertiesKHR;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceCopyMemoryIndirectPropertiesKHR;
    sType$Default(): VkPhysicalDeviceCopyMemoryIndirectPropertiesKHR;
    set(arg0: number, arg1: number): VkPhysicalDeviceCopyMemoryIndirectPropertiesKHR;
