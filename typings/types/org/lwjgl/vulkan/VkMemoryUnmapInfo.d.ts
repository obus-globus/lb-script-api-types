...
export class VkMemoryUnmapInfo extends Struct<VkMemoryUnmapInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkMemoryUnmapInfo;
    flags(): number;
    flags(arg0: number): VkMemoryUnmapInfo;
    memory(): number;
    memory(arg0: number): VkMemoryUnmapInfo;
    pNext(): number;
    pNext(arg0: number): VkMemoryUnmapInfo;
    sType(): number;
    sType(arg0: number): VkMemoryUnmapInfo;
    sType$Default(): VkMemoryUnmapInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number): VkMemoryUnmapInfo;
