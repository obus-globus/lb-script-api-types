...
export class VkCopyMemoryIndirectCommandKHR extends Struct<VkCopyMemoryIndirectCommandKHR> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkCopyMemoryIndirectCommandKHR;
    dstAddress(): number;
    dstAddress(arg0: number): VkCopyMemoryIndirectCommandKHR;
    set(arg0: number, arg1: number, arg2: number): VkCopyMemoryIndirectCommandKHR;
    set(arg0: VkCopyMemoryIndirectCommandKHR): VkCopyMemoryIndirectCommandKHR;
    size(): number;
    size(arg0: number): VkCopyMemoryIndirectCommandKHR;
    sizeof(): number;
    srcAddress(): number;
    srcAddress(arg0: number): VkCopyMemoryIndirectCommandKHR;
}