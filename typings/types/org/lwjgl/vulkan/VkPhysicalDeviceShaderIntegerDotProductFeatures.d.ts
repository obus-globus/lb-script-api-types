...
export class VkPhysicalDeviceShaderIntegerDotProductFeatures extends Struct<VkPhysicalDeviceShaderIntegerDotProductFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceShaderIntegerDotProductFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceShaderIntegerDotProductFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceShaderIntegerDotProductFeatures;
    sType$Default(): VkPhysicalDeviceShaderIntegerDotProductFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceShaderIntegerDotProductFeatures;
    ...
    shaderIntegerDotProduct(arg0: boolean): VkPhysicalDeviceShaderIntegerDotProductFeatures;
    sizeof(): number;
}