...
export class VkSwapchainPresentModesCreateInfoKHR extends Struct<VkSwapchainPresentModesCreateInfoKHR> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkSwapchainPresentModesCreateInfoKHR;
    pNext(): number;
    pNext(arg0: number): VkSwapchainPresentModesCreateInfoKHR;
    pPresentModes(): IntBuffer;
    pPresentModes(arg0: IntBuffer): VkSwapchainPresentModesCreateInfoKHR;
    presentModeCount(): number;
    sType(): number;
    sType(arg0: number): VkSwapchainPresentModesCreateInfoKHR;
    sType$Default(): VkSwapchainPresentModesCreateInfoKHR;
    set(arg0: number, arg1: number, arg2: IntBuffer): VkSwapchainPresentModesCreateInfoKHR;
