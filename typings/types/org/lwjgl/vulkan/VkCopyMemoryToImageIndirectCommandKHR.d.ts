...
export class VkCopyMemoryToImageIndirectCommandKHR extends Struct<VkCopyMemoryToImageIndirectCommandKHR> implements NativeResource {
    ...
    bufferImageHeight(arg0: number): VkCopyMemoryToImageIndirectCommandKHR;
    bufferRowLength(): number;
    bufferRowLength(arg0: number): VkCopyMemoryToImageIndirectCommandKHR;
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkCopyMemoryToImageIndirectCommandKHR;
    imageExtent(): VkExtent3D;
    imageExtent(arg0: (param0: VkExtent3D) => void): VkCopyMemoryToImageIndirectCommandKHR;
    imageExtent(arg0: VkExtent3D): VkCopyMemoryToImageIndirectCommandKHR;
    imageOffset(): VkOffset3D;
    imageOffset(arg0: (param0: VkOffset3D) => void): VkCopyMemoryToImageIndirectCommandKHR;
    imageOffset(arg0: VkOffset3D): VkCopyMemoryToImageIndirectCommandKHR;
    imageSubresource(): VkImageSubresourceLayers;
    imageSubresource(arg0: (param0: VkImageSubresourceLayers) => void): VkCopyMemoryToImageIndirectCommandKHR;
    imageSubresource(arg0: VkImageSubresourceLayers): VkCopyMemoryToImageIndirectCommandKHR;
    set(arg0: number, arg1: number, arg2: number, arg3: VkImageSubresourceLayers, arg4: VkOffset3D, arg5: VkExtent3D): VkCopyMemoryToImageIndirectCommandKHR;
    set(arg0: VkCopyMemoryToImageIndirectCommandKHR): VkCopyMemoryToImageIndirectCommandKHR;
    sizeof(): number;
    srcAddress(): number;
    srcAddress(arg0: number): VkCopyMemoryToImageIndirectCommandKHR;
}