...
export class VkPhysicalDeviceVariablePointerFeatures extends VkPhysicalDeviceVariablePointersFeatures {
    ...
    static calloc(): VkPhysicalDeviceVariablePointerFeatures;
    static calloc(paramarg0: MemoryStack): VkPhysicalDeviceVariablePointerFeatures;
    ...
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceVariablePointerFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceVariablePointerFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceVariablePointerFeatures;
    sType$Default(): VkPhysicalDeviceVariablePointerFeatures;
    set(arg0: number, arg1: number, arg2: boolean, arg3: boolean): VkPhysicalDeviceVariablePointerFeatures;
    set(arg0: VkPhysicalDeviceVariablePointerFeatures): VkPhysicalDeviceVariablePointerFeatures;
    set(arg0: VkPhysicalDeviceVariablePointersFeatures): VkPhysicalDeviceVariablePointersFeatures;
    variablePointers(): boolean;
    variablePointers(arg0: boolean): VkPhysicalDeviceVariablePointerFeatures;
    variablePointersStorageBuffer(): boolean;
    variablePointersStorageBuffer(arg0: boolean): VkPhysicalDeviceVariablePointerFeatures;
}