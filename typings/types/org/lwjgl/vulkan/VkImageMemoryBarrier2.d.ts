...
export class VkImageMemoryBarrier2 extends Struct<VkImageMemoryBarrier2> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkImageMemoryBarrier2;
    dstAccessMask(): number;
    dstAccessMask(arg0: number): VkImageMemoryBarrier2;
    dstQueueFamilyIndex(): number;
    dstQueueFamilyIndex(arg0: number): VkImageMemoryBarrier2;
    dstStageMask(): number;
    dstStageMask(arg0: number): VkImageMemoryBarrier2;
    image(): number;
    image(arg0: number): VkImageMemoryBarrier2;
    newLayout(): number;
    newLayout(arg0: number): VkImageMemoryBarrier2;
    oldLayout(): number;
    oldLayout(arg0: number): VkImageMemoryBarrier2;
    pNext(): number;
    pNext(arg0: number): VkImageMemoryBarrier2;
    ...
    sType(): number;
    sType(arg0: number): VkImageMemoryBarrier2;
    sType$Default(): VkImageMemoryBarrier2;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: number, arg7: number, arg8: number, arg9: number, arg10: number, arg11: VkImageSubresourceRange): VkImageMemoryBarrier2;
    set(arg0: VkImageMemoryBarrier2): VkImageMemoryBarrier2;
    sizeof(): number;
    srcAccessMask(): number;
    srcAccessMask(arg0: number): VkImageMemoryBarrier2;
    srcQueueFamilyIndex(): number;
    srcQueueFamilyIndex(arg0: number): VkImageMemoryBarrier2;
    srcStageMask(): number;
    srcStageMask(arg0: number): VkImageMemoryBarrier2;
    subresourceRange(): VkImageSubresourceRange;
    subresourceRange(arg0: (param0: VkImageSubresourceRange) => void): VkImageMemoryBarrier2;
    subresourceRange(arg0: VkImageSubresourceRange): VkImageMemoryBarrier2;
}