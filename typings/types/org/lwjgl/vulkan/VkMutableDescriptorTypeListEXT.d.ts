...
export class VkMutableDescriptorTypeListEXT extends Struct<VkMutableDescriptorTypeListEXT> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkMutableDescriptorTypeListEXT;
    descriptorTypeCount(): number;
    pDescriptorTypes(): IntBuffer;
    pDescriptorTypes(arg0: IntBuffer): VkMutableDescriptorTypeListEXT;
