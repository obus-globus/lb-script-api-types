...
export class VkPhysicalDeviceTexelBufferAlignmentProperties extends Struct<VkPhysicalDeviceTexelBufferAlignmentProperties> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceTexelBufferAlignmentProperties;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceTexelBufferAlignmentProperties;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceTexelBufferAlignmentProperties;
    sType$Default(): VkPhysicalDeviceTexelBufferAlignmentProperties;
    set(arg0: number, arg1: number): VkPhysicalDeviceTexelBufferAlignmentProperties;
