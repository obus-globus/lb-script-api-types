...
export class VkPushDescriptorSetWithTemplateInfoKHR extends VkPushDescriptorSetWithTemplateInfo {
    ...
    create(arg0: number, arg1: ByteBuffer): VkPushDescriptorSetWithTemplateInfoKHR;
    descriptorUpdateTemplate(): number;
    descriptorUpdateTemplate(arg0: number): VkPushDescriptorSetWithTemplateInfoKHR;
    layout(): number;
    layout(arg0: number): VkPushDescriptorSetWithTemplateInfoKHR;
    pData(): number;
    pData(arg0: number): VkPushDescriptorSetWithTemplateInfoKHR;
    pNext(): number;
    pNext(arg0: number): VkPushDescriptorSetWithTemplateInfoKHR;
    pNext(arg0: VkPipelineLayoutCreateInfo): VkPushDescriptorSetWithTemplateInfo;
    sType(): number;
    sType(arg0: number): VkPushDescriptorSetWithTemplateInfoKHR;
    sType$Default(): VkPushDescriptorSetWithTemplateInfoKHR;
    set(): number;
    set(arg0: number): VkPushDescriptorSetWithTemplateInfoKHR;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number): VkPushDescriptorSetWithTemplateInfoKHR;
    set(arg0: VkPushDescriptorSetWithTemplateInfo): VkPushDescriptorSetWithTemplateInfo;
    set(arg0: VkPushDescriptorSetWithTemplateInfoKHR): VkPushDescriptorSetWithTemplateInfoKHR;
}