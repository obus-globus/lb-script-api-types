...
export class VkQueueFamilyGlobalPriorityProperties extends Struct<VkQueueFamilyGlobalPriorityProperties> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkQueueFamilyGlobalPriorityProperties;
    pNext(): number;
    pNext(arg0: number): VkQueueFamilyGlobalPriorityProperties;
    priorities(): IntBuffer;
    priorities(arg0: number): number;
    priorityCount(): number;
    sType(): number;
    sType(arg0: number): VkQueueFamilyGlobalPriorityProperties;
    sType$Default(): VkQueueFamilyGlobalPriorityProperties;
    set(arg0: number, arg1: number): VkQueueFamilyGlobalPriorityProperties;
