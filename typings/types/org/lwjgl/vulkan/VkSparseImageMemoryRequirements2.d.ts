...
export class VkSparseImageMemoryRequirements2 extends Struct<VkSparseImageMemoryRequirements2> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkSparseImageMemoryRequirements2;
    memoryRequirements(): VkSparseImageMemoryRequirements;
    pNext(): number;
    pNext(arg0: number): VkSparseImageMemoryRequirements2;
    sType(): number;
    sType(arg0: number): VkSparseImageMemoryRequirements2;
    sType$Default(): VkSparseImageMemoryRequirements2;
    set(arg0: number, arg1: number): VkSparseImageMemoryRequirements2;
