...
export class VkCopyMemoryToImageInfo extends Struct<VkCopyMemoryToImageInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkCopyMemoryToImageInfo;
    dstImage(): number;
    dstImage(arg0: number): VkCopyMemoryToImageInfo;
    dstImageLayout(): number;
    dstImageLayout(arg0: number): VkCopyMemoryToImageInfo;
    flags(): number;
    flags(arg0: number): VkCopyMemoryToImageInfo;
    pNext(): number;
    pNext(arg0: number): VkCopyMemoryToImageInfo;
    pRegions(): (Object | null)[];
    pRegions(arg0: (Object | null)[]): VkCopyMemoryToImageInfo;
    regionCount(): number;
    sType(): number;
    sType(arg0: number): VkCopyMemoryToImageInfo;
    sType$Default(): VkCopyMemoryToImageInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: (Object | null)[]): VkCopyMemoryToImageInfo;
