...
export class VkBlitImageInfo2 extends Struct<VkBlitImageInfo2> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkBlitImageInfo2;
    dstImage(): number;
    dstImage(arg0: number): VkBlitImageInfo2;
    dstImageLayout(): number;
    dstImageLayout(arg0: number): VkBlitImageInfo2;
    filter(): number;
    filter(arg0: number): VkBlitImageInfo2;
    pNext(): number;
    pNext(arg0: number): VkBlitImageInfo2;
    pNext(arg0: VkBlitImageCubicWeightsInfoQCOM): VkBlitImageInfo2;
    pRegions(): (Object | null)[];
    pRegions(arg0: (Object | null)[]): VkBlitImageInfo2;
    regionCount(): number;
    sType(): number;
    sType(arg0: number): VkBlitImageInfo2;
    sType$Default(): VkBlitImageInfo2;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: (Object | null)[], arg7: number): VkBlitImageInfo2;
    set(arg0: VkBlitImageInfo2): VkBlitImageInfo2;
    sizeof(): number;
    srcImage(): number;
    srcImage(arg0: number): VkBlitImageInfo2;
    srcImageLayout(): number;
    srcImageLayout(arg0: number): VkBlitImageInfo2;
}