...
export class VkMemoryRequirements2KHR extends VkMemoryRequirements2 {
    ...
    static calloc(): VkMemoryRequirements2KHR;
    static calloc(paramarg0: MemoryStack): VkMemoryRequirements2KHR;
    static create(): VkMemoryRequirements2;
    static create(paramarg0: number): VkMemoryRequirements2;
    static create(paramarg0: number): (Object | null)[];
    static create(paramarg0: number, paramarg1: number): (Object | null)[];
    static create(): VkMemoryRequirements2KHR;
    static create(paramarg0: number): VkMemoryRequirements2KHR;
    static createSafe(paramarg0: number): VkMemoryRequirements2;
    static createSafe(paramarg0: number, paramarg1: number): (Object | null)[];
    static createSafe(paramarg0: number): VkMemoryRequirements2KHR;
    static malloc(): VkMemoryRequirements2;
    static malloc(paramarg0: MemoryStack): VkMemoryRequirements2;
    static malloc(paramarg0: number): (Object | null)[];
    static malloc(paramarg0: number, paramarg1: MemoryStack): (Object | null)[];
    static malloc(): VkMemoryRequirements2KHR;
    static malloc(paramarg0: MemoryStack): VkMemoryRequirements2KHR;
    ...
    create(arg0: number, arg1: ByteBuffer): VkMemoryRequirements2KHR;
    pNext(): number;
    pNext(arg0: number): VkMemoryRequirements2KHR;
    ...
    sType(): number;
    sType(arg0: number): VkMemoryRequirements2KHR;
    sType$Default(): VkMemoryRequirements2KHR;
    set(arg0: number, arg1: number): VkMemoryRequirements2KHR;
    set(arg0: VkMemoryRequirements2): VkMemoryRequirements2;
    set(arg0: VkMemoryRequirements2KHR): VkMemoryRequirements2KHR;
}