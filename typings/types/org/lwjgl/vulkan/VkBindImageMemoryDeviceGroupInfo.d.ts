...
export class VkBindImageMemoryDeviceGroupInfo extends Struct<VkBindImageMemoryDeviceGroupInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkBindImageMemoryDeviceGroupInfo;
    deviceIndexCount(): number;
    pDeviceIndices(): IntBuffer;
    pDeviceIndices(arg0: IntBuffer): VkBindImageMemoryDeviceGroupInfo;
    pNext(): number;
    pNext(arg0: number): VkBindImageMemoryDeviceGroupInfo;
    pSplitInstanceBindRegions(): (Object | null)[];
    pSplitInstanceBindRegions(arg0: (Object | null)[]): VkBindImageMemoryDeviceGroupInfo;
    sType(): number;
    sType(arg0: number): VkBindImageMemoryDeviceGroupInfo;
    sType$Default(): VkBindImageMemoryDeviceGroupInfo;
    set(arg0: number, arg1: number, arg2: IntBuffer, arg3: (Object | null)[]): VkBindImageMemoryDeviceGroupInfo;
