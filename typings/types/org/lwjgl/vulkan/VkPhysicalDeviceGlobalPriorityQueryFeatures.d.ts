...
export class VkPhysicalDeviceGlobalPriorityQueryFeatures extends Struct<VkPhysicalDeviceGlobalPriorityQueryFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceGlobalPriorityQueryFeatures;
    globalPriorityQuery(): boolean;
    globalPriorityQuery(arg0: boolean): VkPhysicalDeviceGlobalPriorityQueryFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceGlobalPriorityQueryFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceGlobalPriorityQueryFeatures;
    sType$Default(): VkPhysicalDeviceGlobalPriorityQueryFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceGlobalPriorityQueryFeatures;
