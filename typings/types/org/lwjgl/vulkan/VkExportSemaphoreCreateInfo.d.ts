...
export class VkExportSemaphoreCreateInfo extends Struct<VkExportSemaphoreCreateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkExportSemaphoreCreateInfo;
    handleTypes(): number;
    handleTypes(arg0: number): VkExportSemaphoreCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkExportSemaphoreCreateInfo;
    sType(): number;
    sType(arg0: number): VkExportSemaphoreCreateInfo;
    sType$Default(): VkExportSemaphoreCreateInfo;
    set(arg0: number, arg1: number, arg2: number): VkExportSemaphoreCreateInfo;
