...
export class VkPhysicalDeviceMaintenance4Properties extends Struct<VkPhysicalDeviceMaintenance4Properties> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceMaintenance4Properties;
    maxBufferSize(): number;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceMaintenance4Properties;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceMaintenance4Properties;
    sType$Default(): VkPhysicalDeviceMaintenance4Properties;
    set(arg0: number, arg1: number): VkPhysicalDeviceMaintenance4Properties;
