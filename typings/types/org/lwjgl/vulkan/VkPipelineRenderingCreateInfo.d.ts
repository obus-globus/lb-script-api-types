...
export class VkPipelineRenderingCreateInfo extends Struct<VkPipelineRenderingCreateInfo> implements NativeResource {
    ...
    colorAttachmentCount(arg0: number): VkPipelineRenderingCreateInfo;
    create(arg0: number, arg1: ByteBuffer): VkPipelineRenderingCreateInfo;
    depthAttachmentFormat(): number;
    depthAttachmentFormat(arg0: number): VkPipelineRenderingCreateInfo;
    pColorAttachmentFormats(): IntBuffer;
    pColorAttachmentFormats(arg0: IntBuffer): VkPipelineRenderingCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkPipelineRenderingCreateInfo;
    sType(): number;
    sType(arg0: number): VkPipelineRenderingCreateInfo;
    sType$Default(): VkPipelineRenderingCreateInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: IntBuffer, arg5: number, arg6: number): VkPipelineRenderingCreateInfo;
    set(arg0: VkPipelineRenderingCreateInfo): VkPipelineRenderingCreateInfo;
    sizeof(): number;
    stencilAttachmentFormat(): number;
    stencilAttachmentFormat(arg0: number): VkPipelineRenderingCreateInfo;
    viewMask(): number;
    viewMask(arg0: number): VkPipelineRenderingCreateInfo;
}