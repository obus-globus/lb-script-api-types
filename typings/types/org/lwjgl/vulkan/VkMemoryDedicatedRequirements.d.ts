...
export class VkMemoryDedicatedRequirements extends Struct<VkMemoryDedicatedRequirements> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkMemoryDedicatedRequirements;
    pNext(): number;
    pNext(arg0: number): VkMemoryDedicatedRequirements;
    prefersDedicatedAllocation(): boolean;
    requiresDedicatedAllocation(): boolean;
    sType(): number;
    sType(arg0: number): VkMemoryDedicatedRequirements;
    sType$Default(): VkMemoryDedicatedRequirements;
    set(arg0: number, arg1: number): VkMemoryDedicatedRequirements;
