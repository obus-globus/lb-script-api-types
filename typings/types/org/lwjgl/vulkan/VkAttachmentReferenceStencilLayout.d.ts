...
export class VkAttachmentReferenceStencilLayout extends Struct<VkAttachmentReferenceStencilLayout> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkAttachmentReferenceStencilLayout;
    pNext(): number;
    pNext(arg0: number): VkAttachmentReferenceStencilLayout;
    sType(): number;
    sType(arg0: number): VkAttachmentReferenceStencilLayout;
    sType$Default(): VkAttachmentReferenceStencilLayout;
    set(arg0: number, arg1: number, arg2: number): VkAttachmentReferenceStencilLayout;
    set(arg0: VkAttachmentReferenceStencilLayout): VkAttachmentReferenceStencilLayout;
    sizeof(): number;
    stencilLayout(): number;
    stencilLayout(arg0: number): VkAttachmentReferenceStencilLayout;
}