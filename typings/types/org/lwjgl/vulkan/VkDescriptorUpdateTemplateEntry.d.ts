...
export class VkDescriptorUpdateTemplateEntry extends Struct<VkDescriptorUpdateTemplateEntry> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkDescriptorUpdateTemplateEntry;
    descriptorCount(): number;
    descriptorCount(arg0: number): VkDescriptorUpdateTemplateEntry;
    descriptorType(): number;
    descriptorType(arg0: number): VkDescriptorUpdateTemplateEntry;
    dstArrayElement(): number;
    dstArrayElement(arg0: number): VkDescriptorUpdateTemplateEntry;
    dstBinding(): number;
    dstBinding(arg0: number): VkDescriptorUpdateTemplateEntry;
    offset(): number;
    offset(arg0: number): VkDescriptorUpdateTemplateEntry;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number): VkDescriptorUpdateTemplateEntry;
    set(arg0: VkDescriptorUpdateTemplateEntry): VkDescriptorUpdateTemplateEntry;
    sizeof(): number;
    stride(): number;
    stride(arg0: number): VkDescriptorUpdateTemplateEntry;
}