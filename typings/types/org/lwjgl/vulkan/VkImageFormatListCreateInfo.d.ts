...
export class VkImageFormatListCreateInfo extends Struct<VkImageFormatListCreateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkImageFormatListCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkImageFormatListCreateInfo;
    pViewFormats(): IntBuffer;
    pViewFormats(arg0: IntBuffer): VkImageFormatListCreateInfo;
    sType(): number;
    sType(arg0: number): VkImageFormatListCreateInfo;
    sType$Default(): VkImageFormatListCreateInfo;
    set(arg0: number, arg1: number, arg2: IntBuffer): VkImageFormatListCreateInfo;
