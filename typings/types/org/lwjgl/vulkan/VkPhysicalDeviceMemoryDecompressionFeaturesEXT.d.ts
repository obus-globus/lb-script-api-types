...
export class VkPhysicalDeviceMemoryDecompressionFeaturesEXT extends Struct<VkPhysicalDeviceMemoryDecompressionFeaturesEXT> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceMemoryDecompressionFeaturesEXT;
    memoryDecompression(): boolean;
    memoryDecompression(arg0: boolean): VkPhysicalDeviceMemoryDecompressionFeaturesEXT;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceMemoryDecompressionFeaturesEXT;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceMemoryDecompressionFeaturesEXT;
    sType$Default(): VkPhysicalDeviceMemoryDecompressionFeaturesEXT;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceMemoryDecompressionFeaturesEXT;
