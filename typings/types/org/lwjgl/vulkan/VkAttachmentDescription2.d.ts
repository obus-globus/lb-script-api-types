...
export class VkAttachmentDescription2 extends Struct<VkAttachmentDescription2> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkAttachmentDescription2;
    finalLayout(): number;
    finalLayout(arg0: number): VkAttachmentDescription2;
    flags(): number;
    flags(arg0: number): VkAttachmentDescription2;
    format(): number;
    format(arg0: number): VkAttachmentDescription2;
    initialLayout(): number;
    initialLayout(arg0: number): VkAttachmentDescription2;
    loadOp(): number;
    loadOp(arg0: number): VkAttachmentDescription2;
    pNext(): number;
    pNext(arg0: number): VkAttachmentDescription2;
    ...
    sType(): number;
    sType(arg0: number): VkAttachmentDescription2;
    sType$Default(): VkAttachmentDescription2;
    samples(): number;
    samples(arg0: number): VkAttachmentDescription2;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: number, arg7: number, arg8: number, arg9: number, arg10: number): VkAttachmentDescription2;
    set(arg0: VkAttachmentDescription2): VkAttachmentDescription2;
    sizeof(): number;
    stencilLoadOp(): number;
    stencilLoadOp(arg0: number): VkAttachmentDescription2;
    stencilStoreOp(): number;
    stencilStoreOp(arg0: number): VkAttachmentDescription2;
    storeOp(): number;
    storeOp(arg0: number): VkAttachmentDescription2;
}