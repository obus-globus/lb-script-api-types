...
export class VkPhysicalDeviceMaintenance6Properties extends Struct<VkPhysicalDeviceMaintenance6Properties> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceMaintenance6Properties;
    fragmentShadingRateClampCombinerInputs(): boolean;
    maxCombinedImageSamplerDescriptorCount(): number;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceMaintenance6Properties;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceMaintenance6Properties;
    sType$Default(): VkPhysicalDeviceMaintenance6Properties;
    set(arg0: number, arg1: number): VkPhysicalDeviceMaintenance6Properties;
