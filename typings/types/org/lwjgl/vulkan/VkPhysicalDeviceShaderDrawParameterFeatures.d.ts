...
export class VkPhysicalDeviceShaderDrawParameterFeatures extends VkPhysicalDeviceShaderDrawParametersFeatures {
    ...
    static STYPE: number;
    static calloc(): VkPhysicalDeviceShaderDrawParameterFeatures;
    static calloc(paramarg0: MemoryStack): VkPhysicalDeviceShaderDrawParameterFeatures;
    ...
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceShaderDrawParameterFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceShaderDrawParameterFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceShaderDrawParameterFeatures;
    sType$Default(): VkPhysicalDeviceShaderDrawParameterFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceShaderDrawParameterFeatures;
    set(arg0: VkPhysicalDeviceShaderDrawParameterFeatures): VkPhysicalDeviceShaderDrawParameterFeatures;
    set(arg0: VkPhysicalDeviceShaderDrawParametersFeatures): VkPhysicalDeviceShaderDrawParametersFeatures;
    shaderDrawParameters(): boolean;
    shaderDrawParameters(arg0: boolean): VkPhysicalDeviceShaderDrawParameterFeatures;
}