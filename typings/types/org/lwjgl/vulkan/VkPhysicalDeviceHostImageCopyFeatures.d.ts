...
export class VkPhysicalDeviceHostImageCopyFeatures extends Struct<VkPhysicalDeviceHostImageCopyFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceHostImageCopyFeatures;
    hostImageCopy(): boolean;
    hostImageCopy(arg0: boolean): VkPhysicalDeviceHostImageCopyFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceHostImageCopyFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceHostImageCopyFeatures;
    sType$Default(): VkPhysicalDeviceHostImageCopyFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceHostImageCopyFeatures;
