...
export class VkCopyImageToImageInfo extends Struct<VkCopyImageToImageInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkCopyImageToImageInfo;
    dstImage(): number;
    dstImage(arg0: number): VkCopyImageToImageInfo;
    dstImageLayout(): number;
    dstImageLayout(arg0: number): VkCopyImageToImageInfo;
    flags(): number;
    flags(arg0: number): VkCopyImageToImageInfo;
    pNext(): number;
    pNext(arg0: number): VkCopyImageToImageInfo;
    pRegions(): (Object | null)[];
    pRegions(arg0: (Object | null)[]): VkCopyImageToImageInfo;
    regionCount(): number;
    sType(): number;
    sType(arg0: number): VkCopyImageToImageInfo;
    sType$Default(): VkCopyImageToImageInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: number, arg7: (Object | null)[]): VkCopyImageToImageInfo;
    set(arg0: VkCopyImageToImageInfo): VkCopyImageToImageInfo;
    sizeof(): number;
    srcImage(): number;
    srcImage(arg0: number): VkCopyImageToImageInfo;
    srcImageLayout(): number;
    srcImageLayout(arg0: number): VkCopyImageToImageInfo;
}