...
export class VkSamplerReductionModeCreateInfo extends Struct<VkSamplerReductionModeCreateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkSamplerReductionModeCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkSamplerReductionModeCreateInfo;
    reductionMode(): number;
    reductionMode(arg0: number): VkSamplerReductionModeCreateInfo;
    sType(): number;
    sType(arg0: number): VkSamplerReductionModeCreateInfo;
    sType$Default(): VkSamplerReductionModeCreateInfo;
    set(arg0: number, arg1: number, arg2: number): VkSamplerReductionModeCreateInfo;
