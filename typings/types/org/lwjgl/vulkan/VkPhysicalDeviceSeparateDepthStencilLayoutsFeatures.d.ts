...
export class VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures extends Struct<VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures;
    sType$Default(): VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures;
    separateDepthStencilLayouts(): boolean;
    separateDepthStencilLayouts(arg0: boolean): VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures;
