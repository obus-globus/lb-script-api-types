...
export class VkDeviceGroupBindSparseInfo extends Struct<VkDeviceGroupBindSparseInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkDeviceGroupBindSparseInfo;
    memoryDeviceIndex(): number;
    memoryDeviceIndex(arg0: number): VkDeviceGroupBindSparseInfo;
    pNext(): number;
    pNext(arg0: number): VkDeviceGroupBindSparseInfo;
    resourceDeviceIndex(): number;
    resourceDeviceIndex(arg0: number): VkDeviceGroupBindSparseInfo;
    sType(): number;
    sType(arg0: number): VkDeviceGroupBindSparseInfo;
    sType$Default(): VkDeviceGroupBindSparseInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number): VkDeviceGroupBindSparseInfo;
