...
export class VkPhysicalDeviceLineRasterizationFeaturesEXT extends VkPhysicalDeviceLineRasterizationFeatures {
    ...
    bresenhamLines(arg0: boolean): VkPhysicalDeviceLineRasterizationFeaturesEXT;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceLineRasterizationFeaturesEXT;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceLineRasterizationFeaturesEXT;
    rectangularLines(): boolean;
    rectangularLines(arg0: boolean): VkPhysicalDeviceLineRasterizationFeaturesEXT;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceLineRasterizationFeaturesEXT;
    sType$Default(): VkPhysicalDeviceLineRasterizationFeaturesEXT;
    set(arg0: number, arg1: number, arg2: boolean, arg3: boolean, arg4: boolean, arg5: boolean, arg6: boolean, arg7: boolean): VkPhysicalDeviceLineRasterizationFeaturesEXT;
    set(arg0: VkPhysicalDeviceLineRasterizationFeatures): VkPhysicalDeviceLineRasterizationFeatures;
    set(arg0: VkPhysicalDeviceLineRasterizationFeaturesEXT): VkPhysicalDeviceLineRasterizationFeaturesEXT;
    smoothLines(): boolean;
    smoothLines(arg0: boolean): VkPhysicalDeviceLineRasterizationFeaturesEXT;
    stippledBresenhamLines(): boolean;
    stippledBresenhamLines(arg0: boolean): VkPhysicalDeviceLineRasterizationFeaturesEXT;
    stippledRectangularLines(): boolean;
    stippledRectangularLines(arg0: boolean): VkPhysicalDeviceLineRasterizationFeaturesEXT;
    stippledSmoothLines(): boolean;
    stippledSmoothLines(arg0: boolean): VkPhysicalDeviceLineRasterizationFeaturesEXT;
}