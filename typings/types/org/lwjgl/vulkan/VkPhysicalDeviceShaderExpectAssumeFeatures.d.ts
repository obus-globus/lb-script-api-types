...
export class VkPhysicalDeviceShaderExpectAssumeFeatures extends Struct<VkPhysicalDeviceShaderExpectAssumeFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceShaderExpectAssumeFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceShaderExpectAssumeFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceShaderExpectAssumeFeatures;
    sType$Default(): VkPhysicalDeviceShaderExpectAssumeFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceShaderExpectAssumeFeatures;
    set(arg0: VkPhysicalDeviceShaderExpectAssumeFeatures): VkPhysicalDeviceShaderExpectAssumeFeatures;
    shaderExpectAssume(): boolean;
    shaderExpectAssume(arg0: boolean): VkPhysicalDeviceShaderExpectAssumeFeatures;
    sizeof(): number;
}