...
export class VkExportFenceCreateInfo extends Struct<VkExportFenceCreateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkExportFenceCreateInfo;
    handleTypes(): number;
    handleTypes(arg0: number): VkExportFenceCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkExportFenceCreateInfo;
    sType(): number;
    sType(arg0: number): VkExportFenceCreateInfo;
    sType$Default(): VkExportFenceCreateInfo;
    set(arg0: number, arg1: number, arg2: number): VkExportFenceCreateInfo;
