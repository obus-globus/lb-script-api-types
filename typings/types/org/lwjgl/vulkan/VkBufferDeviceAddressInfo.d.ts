...
export class VkBufferDeviceAddressInfo extends Struct<VkBufferDeviceAddressInfo> implements NativeResource {
    ...
    buffer(): number;
    buffer(arg0: number): VkBufferDeviceAddressInfo;
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkBufferDeviceAddressInfo;
    pNext(): number;
    pNext(arg0: number): VkBufferDeviceAddressInfo;
    sType(): number;
    sType(arg0: number): VkBufferDeviceAddressInfo;
    sType$Default(): VkBufferDeviceAddressInfo;
    set(arg0: number, arg1: number, arg2: number): VkBufferDeviceAddressInfo;
