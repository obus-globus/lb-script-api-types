...
export class VkBindBufferMemoryDeviceGroupInfo extends Struct<VkBindBufferMemoryDeviceGroupInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkBindBufferMemoryDeviceGroupInfo;
    deviceIndexCount(): number;
    pDeviceIndices(): IntBuffer;
    pDeviceIndices(arg0: IntBuffer): VkBindBufferMemoryDeviceGroupInfo;
    pNext(): number;
    pNext(arg0: number): VkBindBufferMemoryDeviceGroupInfo;
    sType(): number;
    sType(arg0: number): VkBindBufferMemoryDeviceGroupInfo;
    sType$Default(): VkBindBufferMemoryDeviceGroupInfo;
    set(arg0: number, arg1: number, arg2: IntBuffer): VkBindBufferMemoryDeviceGroupInfo;
