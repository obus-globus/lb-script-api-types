...
export class VkDescriptorSetLayoutBindingFlagsCreateInfo extends Struct<VkDescriptorSetLayoutBindingFlagsCreateInfo> implements NativeResource {
    ...
    bindingCount(): number;
    bindingCount(arg0: number): VkDescriptorSetLayoutBindingFlagsCreateInfo;
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkDescriptorSetLayoutBindingFlagsCreateInfo;
    pBindingFlags(): IntBuffer;
    pBindingFlags(arg0: IntBuffer): VkDescriptorSetLayoutBindingFlagsCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkDescriptorSetLayoutBindingFlagsCreateInfo;
    sType(): number;
    sType(arg0: number): VkDescriptorSetLayoutBindingFlagsCreateInfo;
    sType$Default(): VkDescriptorSetLayoutBindingFlagsCreateInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: IntBuffer): VkDescriptorSetLayoutBindingFlagsCreateInfo;
