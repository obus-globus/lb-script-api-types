...
export class VkCopyImageToMemoryInfo extends Struct<VkCopyImageToMemoryInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkCopyImageToMemoryInfo;
    flags(): number;
    flags(arg0: number): VkCopyImageToMemoryInfo;
    pNext(): number;
    pNext(arg0: number): VkCopyImageToMemoryInfo;
    pRegions(): (Object | null)[];
    pRegions(arg0: (Object | null)[]): VkCopyImageToMemoryInfo;
    regionCount(): number;
    sType(): number;
    sType(arg0: number): VkCopyImageToMemoryInfo;
    sType$Default(): VkCopyImageToMemoryInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: (Object | null)[]): VkCopyImageToMemoryInfo;
    set(arg0: VkCopyImageToMemoryInfo): VkCopyImageToMemoryInfo;
    sizeof(): number;
    srcImage(): number;
    srcImage(arg0: number): VkCopyImageToMemoryInfo;
    srcImageLayout(): number;
    srcImageLayout(arg0: number): VkCopyImageToMemoryInfo;
}