...
export class VkCommandBufferInheritanceRenderingInfo extends Struct<VkCommandBufferInheritanceRenderingInfo> implements NativeResource {
    ...
    create(arg0: number, arg1: ByteBuffer): VkCommandBufferInheritanceRenderingInfo;
    depthAttachmentFormat(): number;
    depthAttachmentFormat(arg0: number): VkCommandBufferInheritanceRenderingInfo;
    flags(): number;
    flags(arg0: number): VkCommandBufferInheritanceRenderingInfo;
    pColorAttachmentFormats(): IntBuffer;
    pColorAttachmentFormats(arg0: IntBuffer): VkCommandBufferInheritanceRenderingInfo;
    pNext(): number;
    pNext(arg0: number): VkCommandBufferInheritanceRenderingInfo;
    rasterizationSamples(): number;
    rasterizationSamples(arg0: number): VkCommandBufferInheritanceRenderingInfo;
    sType(): number;
    sType(arg0: number): VkCommandBufferInheritanceRenderingInfo;
    sType$Default(): VkCommandBufferInheritanceRenderingInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: IntBuffer, arg5: number, arg6: number, arg7: number): VkCommandBufferInheritanceRenderingInfo;
    set(arg0: VkCommandBufferInheritanceRenderingInfo): VkCommandBufferInheritanceRenderingInfo;
    sizeof(): number;
    stencilAttachmentFormat(): number;
    stencilAttachmentFormat(arg0: number): VkCommandBufferInheritanceRenderingInfo;
    viewMask(): number;
    viewMask(arg0: number): VkCommandBufferInheritanceRenderingInfo;
}