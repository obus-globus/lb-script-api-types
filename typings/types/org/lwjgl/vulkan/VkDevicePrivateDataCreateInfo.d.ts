...
export class VkDevicePrivateDataCreateInfo extends Struct<VkDevicePrivateDataCreateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkDevicePrivateDataCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkDevicePrivateDataCreateInfo;
    privateDataSlotRequestCount(): number;
    privateDataSlotRequestCount(arg0: number): VkDevicePrivateDataCreateInfo;
    sType(): number;
    sType(arg0: number): VkDevicePrivateDataCreateInfo;
    sType$Default(): VkDevicePrivateDataCreateInfo;
    set(arg0: number, arg1: number, arg2: number): VkDevicePrivateDataCreateInfo;
