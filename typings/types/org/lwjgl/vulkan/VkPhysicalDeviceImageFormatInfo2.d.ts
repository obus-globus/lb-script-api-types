...
export class VkPhysicalDeviceImageFormatInfo2 extends Struct<VkPhysicalDeviceImageFormatInfo2> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceImageFormatInfo2;
    flags(): number;
    flags(arg0: number): VkPhysicalDeviceImageFormatInfo2;
    format(): number;
    format(arg0: number): VkPhysicalDeviceImageFormatInfo2;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceImageFormatInfo2;
    ...
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceImageFormatInfo2;
    sType$Default(): VkPhysicalDeviceImageFormatInfo2;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: number): VkPhysicalDeviceImageFormatInfo2;
    set(arg0: VkPhysicalDeviceImageFormatInfo2): VkPhysicalDeviceImageFormatInfo2;
    sizeof(): number;
    tiling(): number;
    tiling(arg0: number): VkPhysicalDeviceImageFormatInfo2;
    type(): number;
    type(arg0: number): VkPhysicalDeviceImageFormatInfo2;
    usage(): number;
    usage(arg0: number): VkPhysicalDeviceImageFormatInfo2;
}