...
export class VkExternalMemoryBufferCreateInfo extends Struct<VkExternalMemoryBufferCreateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkExternalMemoryBufferCreateInfo;
    handleTypes(): number;
    handleTypes(arg0: number): VkExternalMemoryBufferCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkExternalMemoryBufferCreateInfo;
    sType(): number;
    sType(arg0: number): VkExternalMemoryBufferCreateInfo;
    sType$Default(): VkExternalMemoryBufferCreateInfo;
    set(arg0: number, arg1: number, arg2: number): VkExternalMemoryBufferCreateInfo;
