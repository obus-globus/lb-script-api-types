...
export class VkImageMemoryRequirementsInfo2KHR extends VkImageMemoryRequirementsInfo2 {
    ...
    static calloc(): VkImageMemoryRequirementsInfo2KHR;
    static calloc(paramarg0: MemoryStack): VkImageMemoryRequirementsInfo2KHR;
    ...
    static create(): VkImageMemoryRequirementsInfo2KHR;
    static create(paramarg0: number): VkImageMemoryRequirementsInfo2KHR;
    static createSafe(paramarg0: number): VkImageMemoryRequirementsInfo2;
    static createSafe(paramarg0: number, paramarg1: number): (Object | null)[];
    static createSafe(paramarg0: number): VkImageMemoryRequirementsInfo2KHR;
    ...
    static malloc(): VkImageMemoryRequirementsInfo2KHR;
    static malloc(paramarg0: MemoryStack): VkImageMemoryRequirementsInfo2KHR;
    ...
    create(arg0: number, arg1: ByteBuffer): VkImageMemoryRequirementsInfo2KHR;
    image(): number;
    image(arg0: number): VkImageMemoryRequirementsInfo2KHR;
    pNext(): number;
    pNext(arg0: number): VkImageMemoryRequirementsInfo2KHR;
    ...
    sType(): number;
    sType(arg0: number): VkImageMemoryRequirementsInfo2KHR;
    sType$Default(): VkImageMemoryRequirementsInfo2KHR;
    set(arg0: number, arg1: number, arg2: number): VkImageMemoryRequirementsInfo2KHR;
    set(arg0: VkImageMemoryRequirementsInfo2): VkImageMemoryRequirementsInfo2;
    set(arg0: VkImageMemoryRequirementsInfo2KHR): VkImageMemoryRequirementsInfo2KHR;
}