...
export class VkPipelineRobustnessCreateInfo extends Struct<VkPipelineRobustnessCreateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPipelineRobustnessCreateInfo;
    images(): number;
    images(arg0: number): VkPipelineRobustnessCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkPipelineRobustnessCreateInfo;
    sType(): number;
    sType(arg0: number): VkPipelineRobustnessCreateInfo;
    sType$Default(): VkPipelineRobustnessCreateInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number): VkPipelineRobustnessCreateInfo;
    set(arg0: VkPipelineRobustnessCreateInfo): VkPipelineRobustnessCreateInfo;
    sizeof(): number;
    storageBuffers(): number;
    storageBuffers(arg0: number): VkPipelineRobustnessCreateInfo;
    uniformBuffers(): number;
    uniformBuffers(arg0: number): VkPipelineRobustnessCreateInfo;
    vertexInputs(): number;
    vertexInputs(arg0: number): VkPipelineRobustnessCreateInfo;
}