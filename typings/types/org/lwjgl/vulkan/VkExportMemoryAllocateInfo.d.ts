...
export class VkExportMemoryAllocateInfo extends Struct<VkExportMemoryAllocateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkExportMemoryAllocateInfo;
    handleTypes(): number;
    handleTypes(arg0: number): VkExportMemoryAllocateInfo;
    pNext(): number;
    pNext(arg0: number): VkExportMemoryAllocateInfo;
    sType(): number;
    sType(arg0: number): VkExportMemoryAllocateInfo;
    sType$Default(): VkExportMemoryAllocateInfo;
    set(arg0: number, arg1: number, arg2: number): VkExportMemoryAllocateInfo;
