...
export class VkDescriptorSetVariableDescriptorCountAllocateInfo extends Struct<VkDescriptorSetVariableDescriptorCountAllocateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkDescriptorSetVariableDescriptorCountAllocateInfo;
    descriptorSetCount(): number;
    pDescriptorCounts(): IntBuffer;
    pDescriptorCounts(arg0: IntBuffer): VkDescriptorSetVariableDescriptorCountAllocateInfo;
    pNext(): number;
    pNext(arg0: number): VkDescriptorSetVariableDescriptorCountAllocateInfo;
    sType(): number;
    sType(arg0: number): VkDescriptorSetVariableDescriptorCountAllocateInfo;
    sType$Default(): VkDescriptorSetVariableDescriptorCountAllocateInfo;
    set(arg0: number, arg1: number, arg2: IntBuffer): VkDescriptorSetVariableDescriptorCountAllocateInfo;
