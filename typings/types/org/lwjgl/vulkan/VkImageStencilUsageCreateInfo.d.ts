...
export class VkImageStencilUsageCreateInfo extends Struct<VkImageStencilUsageCreateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkImageStencilUsageCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkImageStencilUsageCreateInfo;
    sType(): number;
    sType(arg0: number): VkImageStencilUsageCreateInfo;
    sType$Default(): VkImageStencilUsageCreateInfo;
    set(arg0: number, arg1: number, arg2: number): VkImageStencilUsageCreateInfo;
    set(arg0: VkImageStencilUsageCreateInfo): VkImageStencilUsageCreateInfo;
    sizeof(): number;
    stencilUsage(): number;
    stencilUsage(arg0: number): VkImageStencilUsageCreateInfo;
}