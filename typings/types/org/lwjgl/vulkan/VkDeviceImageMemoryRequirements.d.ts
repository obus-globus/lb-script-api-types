...
export class VkDeviceImageMemoryRequirements extends Struct<VkDeviceImageMemoryRequirements> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkDeviceImageMemoryRequirements;
    pCreateInfo(): VkImageCreateInfo;
    pCreateInfo(arg0: VkImageCreateInfo): VkDeviceImageMemoryRequirements;
    pNext(): number;
    pNext(arg0: number): VkDeviceImageMemoryRequirements;
    planeAspect(): number;
    planeAspect(arg0: number): VkDeviceImageMemoryRequirements;
    sType(): number;
    sType(arg0: number): VkDeviceImageMemoryRequirements;
    sType$Default(): VkDeviceImageMemoryRequirements;
    set(arg0: number, arg1: number, arg2: VkImageCreateInfo, arg3: number): VkDeviceImageMemoryRequirements;
