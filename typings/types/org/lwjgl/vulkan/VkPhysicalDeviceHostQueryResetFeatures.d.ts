...
export class VkPhysicalDeviceHostQueryResetFeatures extends Struct<VkPhysicalDeviceHostQueryResetFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceHostQueryResetFeatures;
    hostQueryReset(): boolean;
    hostQueryReset(arg0: boolean): VkPhysicalDeviceHostQueryResetFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceHostQueryResetFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceHostQueryResetFeatures;
    sType$Default(): VkPhysicalDeviceHostQueryResetFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceHostQueryResetFeatures;
