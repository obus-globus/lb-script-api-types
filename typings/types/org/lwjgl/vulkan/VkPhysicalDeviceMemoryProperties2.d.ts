...
export class VkPhysicalDeviceMemoryProperties2 extends Struct<VkPhysicalDeviceMemoryProperties2> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceMemoryProperties2;
    memoryProperties(): VkPhysicalDeviceMemoryProperties;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceMemoryProperties2;
    pNext(arg0: VkPhysicalDeviceMemoryBudgetPropertiesEXT): VkPhysicalDeviceMemoryProperties2;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceMemoryProperties2;
    sType$Default(): VkPhysicalDeviceMemoryProperties2;
    set(arg0: number, arg1: number): VkPhysicalDeviceMemoryProperties2;
