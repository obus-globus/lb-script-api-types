...
export class VkPhysicalDeviceLineRasterizationFeatures extends Struct<VkPhysicalDeviceLineRasterizationFeatures> implements NativeResource {
    ...
    bresenhamLines(arg0: boolean): VkPhysicalDeviceLineRasterizationFeatures;
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceLineRasterizationFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceLineRasterizationFeatures;
    rectangularLines(): boolean;
    rectangularLines(arg0: boolean): VkPhysicalDeviceLineRasterizationFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceLineRasterizationFeatures;
    sType$Default(): VkPhysicalDeviceLineRasterizationFeatures;
    set(arg0: number, arg1: number, arg2: boolean, arg3: boolean, arg4: boolean, arg5: boolean, arg6: boolean, arg7: boolean): VkPhysicalDeviceLineRasterizationFeatures;
    set(arg0: VkPhysicalDeviceLineRasterizationFeatures): VkPhysicalDeviceLineRasterizationFeatures;
    sizeof(): number;
    smoothLines(): boolean;
    smoothLines(arg0: boolean): VkPhysicalDeviceLineRasterizationFeatures;
    stippledBresenhamLines(): boolean;
    stippledBresenhamLines(arg0: boolean): VkPhysicalDeviceLineRasterizationFeatures;
    stippledRectangularLines(): boolean;
    stippledRectangularLines(arg0: boolean): VkPhysicalDeviceLineRasterizationFeatures;
    stippledSmoothLines(): boolean;
    stippledSmoothLines(arg0: boolean): VkPhysicalDeviceLineRasterizationFeatures;
}