...
export class VkMemoryOpaqueCaptureAddressAllocateInfo extends Struct<VkMemoryOpaqueCaptureAddressAllocateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkMemoryOpaqueCaptureAddressAllocateInfo;
    opaqueCaptureAddress(): number;
    opaqueCaptureAddress(arg0: number): VkMemoryOpaqueCaptureAddressAllocateInfo;
    pNext(): number;
    pNext(arg0: number): VkMemoryOpaqueCaptureAddressAllocateInfo;
    sType(): number;
    sType(arg0: number): VkMemoryOpaqueCaptureAddressAllocateInfo;
    sType$Default(): VkMemoryOpaqueCaptureAddressAllocateInfo;
    set(arg0: number, arg1: number, arg2: number): VkMemoryOpaqueCaptureAddressAllocateInfo;
