...
export class VkPhysicalDeviceExternalImageFormatInfo extends Struct<VkPhysicalDeviceExternalImageFormatInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceExternalImageFormatInfo;
    handleType(): number;
    handleType(arg0: number): VkPhysicalDeviceExternalImageFormatInfo;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceExternalImageFormatInfo;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceExternalImageFormatInfo;
    sType$Default(): VkPhysicalDeviceExternalImageFormatInfo;
    set(arg0: number, arg1: number, arg2: number): VkPhysicalDeviceExternalImageFormatInfo;
