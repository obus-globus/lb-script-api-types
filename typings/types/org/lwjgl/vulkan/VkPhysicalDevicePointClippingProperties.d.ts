...
export class VkPhysicalDevicePointClippingProperties extends Struct<VkPhysicalDevicePointClippingProperties> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDevicePointClippingProperties;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDevicePointClippingProperties;
    pointClippingBehavior(): number;
    sType(): number;
    sType(arg0: number): VkPhysicalDevicePointClippingProperties;
    sType$Default(): VkPhysicalDevicePointClippingProperties;
    set(arg0: number, arg1: number): VkPhysicalDevicePointClippingProperties;
