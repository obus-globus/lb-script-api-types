...
import type { VkDescriptorSetVariableDescriptorCountLayoutSupportEXT } from '../../../org/lwjgl/vulkan/VkDescriptorSetVariableDescriptorCountLayoutSupportEXT.d.ts'
export class VkDescriptorSetLayoutSupportKHR extends VkDescriptorSetLayoutSupport {
    ...
    static calloc(): VkDescriptorSetLayoutSupport;
    static calloc(paramarg0: MemoryStack): VkDescriptorSetLayoutSupport;
    ...
    create(arg0: number, arg1: ByteBuffer): VkDescriptorSetLayoutSupportKHR;
    pNext(): number;
    pNext(arg0: number): VkDescriptorSetLayoutSupportKHR;
    pNext(arg0: VkDescriptorSetVariableDescriptorCountLayoutSupport): VkDescriptorSetLayoutSupport;
    pNext(arg0: VkDescriptorSetVariableDescriptorCountLayoutSupportEXT): VkDescriptorSetLayoutSupport;
    sType(): number;
    sType(arg0: number): VkDescriptorSetLayoutSupportKHR;
    sType$Default(): VkDescriptorSetLayoutSupportKHR;
    set(arg0: number, arg1: number): VkDescriptorSetLayoutSupportKHR;
    set(arg0: VkDescriptorSetLayoutSupport): VkDescriptorSetLayoutSupport;
    set(arg0: VkDescriptorSetLayoutSupportKHR): VkDescriptorSetLayoutSupportKHR;
}