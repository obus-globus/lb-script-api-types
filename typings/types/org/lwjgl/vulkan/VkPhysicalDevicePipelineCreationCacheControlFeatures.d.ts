...
export class VkPhysicalDevicePipelineCreationCacheControlFeatures extends Struct<VkPhysicalDevicePipelineCreationCacheControlFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDevicePipelineCreationCacheControlFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDevicePipelineCreationCacheControlFeatures;
    pipelineCreationCacheControl(): boolean;
    pipelineCreationCacheControl(arg0: boolean): VkPhysicalDevicePipelineCreationCacheControlFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDevicePipelineCreationCacheControlFeatures;
    sType$Default(): VkPhysicalDevicePipelineCreationCacheControlFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDevicePipelineCreationCacheControlFeatures;
