...
export class VkHostImageLayoutTransitionInfo extends Struct<VkHostImageLayoutTransitionInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkHostImageLayoutTransitionInfo;
    image(): number;
    image(arg0: number): VkHostImageLayoutTransitionInfo;
    newLayout(): number;
    newLayout(arg0: number): VkHostImageLayoutTransitionInfo;
    oldLayout(): number;
    oldLayout(arg0: number): VkHostImageLayoutTransitionInfo;
    pNext(): number;
    pNext(arg0: number): VkHostImageLayoutTransitionInfo;
    sType(): number;
    sType(arg0: number): VkHostImageLayoutTransitionInfo;
    sType$Default(): VkHostImageLayoutTransitionInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: VkImageSubresourceRange): VkHostImageLayoutTransitionInfo;
    set(arg0: VkHostImageLayoutTransitionInfo): VkHostImageLayoutTransitionInfo;
    sizeof(): number;
    subresourceRange(): VkImageSubresourceRange;
    subresourceRange(arg0: (param0: VkImageSubresourceRange) => void): VkHostImageLayoutTransitionInfo;
    subresourceRange(arg0: VkImageSubresourceRange): VkHostImageLayoutTransitionInfo;
}