...
export class VkSemaphoreTypeCreateInfo extends Struct<VkSemaphoreTypeCreateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkSemaphoreTypeCreateInfo;
    initialValue(): number;
    initialValue(arg0: number): VkSemaphoreTypeCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkSemaphoreTypeCreateInfo;
    sType(): number;
    sType(arg0: number): VkSemaphoreTypeCreateInfo;
    sType$Default(): VkSemaphoreTypeCreateInfo;
    semaphoreType(): number;
    semaphoreType(arg0: number): VkSemaphoreTypeCreateInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number): VkSemaphoreTypeCreateInfo;
