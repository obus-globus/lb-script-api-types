...
export class VkRenderPassFragmentDensityMapOffsetEndInfoEXT extends Struct<VkRenderPassFragmentDensityMapOffsetEndInfoEXT> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkRenderPassFragmentDensityMapOffsetEndInfoEXT;
    fragmentDensityOffsetCount(): number;
    pFragmentDensityOffsets(): (Object | null)[];
    pFragmentDensityOffsets(arg0: (Object | null)[]): VkRenderPassFragmentDensityMapOffsetEndInfoEXT;
    pNext(): number;
    pNext(arg0: number): VkRenderPassFragmentDensityMapOffsetEndInfoEXT;
    sType(): number;
    sType(arg0: number): VkRenderPassFragmentDensityMapOffsetEndInfoEXT;
    sType$Default(): VkRenderPassFragmentDensityMapOffsetEndInfoEXT;
    set(arg0: number, arg1: number, arg2: (Object | null)[]): VkRenderPassFragmentDensityMapOffsetEndInfoEXT;
