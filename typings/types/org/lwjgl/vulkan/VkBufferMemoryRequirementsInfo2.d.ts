...
export class VkBufferMemoryRequirementsInfo2 extends Struct<VkBufferMemoryRequirementsInfo2> implements NativeResource {
    ...
    buffer(): number;
    buffer(arg0: number): VkBufferMemoryRequirementsInfo2;
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkBufferMemoryRequirementsInfo2;
    pNext(): number;
    pNext(arg0: number): VkBufferMemoryRequirementsInfo2;
    sType(): number;
    sType(arg0: number): VkBufferMemoryRequirementsInfo2;
    sType$Default(): VkBufferMemoryRequirementsInfo2;
    set(arg0: number, arg1: number, arg2: number): VkBufferMemoryRequirementsInfo2;
