...
export class VkBindDescriptorSetsInfoKHR extends VkBindDescriptorSetsInfo {
    ...
    create(arg0: number, arg1: ByteBuffer): VkBindDescriptorSetsInfoKHR;
    dynamicOffsetCount(): number;
    dynamicOffsetCount(arg0: number): VkBindDescriptorSetsInfoKHR;
    firstSet(): number;
    firstSet(arg0: number): VkBindDescriptorSetsInfoKHR;
    layout(): number;
    layout(arg0: number): VkBindDescriptorSetsInfoKHR;
    pDescriptorSets(): LongBuffer;
    pDescriptorSets(arg0: LongBuffer): VkBindDescriptorSetsInfoKHR;
    pDynamicOffsets(): IntBuffer;
    pDynamicOffsets(arg0: IntBuffer): VkBindDescriptorSetsInfoKHR;
    pNext(): number;
    pNext(arg0: number): VkBindDescriptorSetsInfoKHR;
    pNext(arg0: VkPipelineLayoutCreateInfo): VkBindDescriptorSetsInfo;
    sType(): number;
    sType(arg0: number): VkBindDescriptorSetsInfoKHR;
    sType$Default(): VkBindDescriptorSetsInfoKHR;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: LongBuffer, arg6: number, arg7: IntBuffer): VkBindDescriptorSetsInfoKHR;
    set(arg0: VkBindDescriptorSetsInfo): VkBindDescriptorSetsInfo;
    set(arg0: VkBindDescriptorSetsInfoKHR): VkBindDescriptorSetsInfoKHR;
    stageFlags(): number;
    stageFlags(arg0: number): VkBindDescriptorSetsInfoKHR;
}