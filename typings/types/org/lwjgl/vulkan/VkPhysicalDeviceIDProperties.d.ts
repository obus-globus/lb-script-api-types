...
export class VkPhysicalDeviceIDProperties extends Struct<VkPhysicalDeviceIDProperties> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceIDProperties;
    ...
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceIDProperties;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceIDProperties;
    sType$Default(): VkPhysicalDeviceIDProperties;
    set(arg0: number, arg1: number): VkPhysicalDeviceIDProperties;
