...
export class VkPhysicalDeviceDynamicRenderingLocalReadFeatures extends Struct<VkPhysicalDeviceDynamicRenderingLocalReadFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceDynamicRenderingLocalReadFeatures;
    dynamicRenderingLocalRead(): boolean;
    dynamicRenderingLocalRead(arg0: boolean): VkPhysicalDeviceDynamicRenderingLocalReadFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceDynamicRenderingLocalReadFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceDynamicRenderingLocalReadFeatures;
    sType$Default(): VkPhysicalDeviceDynamicRenderingLocalReadFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceDynamicRenderingLocalReadFeatures;
