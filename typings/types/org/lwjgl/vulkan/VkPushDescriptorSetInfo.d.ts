...
export class VkPushDescriptorSetInfo extends Struct<VkPushDescriptorSetInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPushDescriptorSetInfo;
    descriptorWriteCount(): number;
    layout(): number;
    layout(arg0: number): VkPushDescriptorSetInfo;
    pDescriptorWrites(): (Object | null)[];
    pDescriptorWrites(arg0: (Object | null)[]): VkPushDescriptorSetInfo;
    pNext(): number;
    pNext(arg0: number): VkPushDescriptorSetInfo;
    pNext(arg0: VkPipelineLayoutCreateInfo): VkPushDescriptorSetInfo;
    sType(): number;
    sType(arg0: number): VkPushDescriptorSetInfo;
    sType$Default(): VkPushDescriptorSetInfo;
    set(): number;
    set(arg0: number): VkPushDescriptorSetInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: (Object | null)[]): VkPushDescriptorSetInfo;
    set(arg0: VkPushDescriptorSetInfo): VkPushDescriptorSetInfo;
    sizeof(): number;
    stageFlags(): number;
    stageFlags(arg0: number): VkPushDescriptorSetInfo;
}