...
export class VkSubpassBeginInfo extends Struct<VkSubpassBeginInfo> implements NativeResource {
    ...
    close(): void;
    contents(): number;
    contents(arg0: number): VkSubpassBeginInfo;
    create(arg0: number, arg1: ByteBuffer): VkSubpassBeginInfo;
    pNext(): number;
    pNext(arg0: number): VkSubpassBeginInfo;
    sType(): number;
    sType(arg0: number): VkSubpassBeginInfo;
    sType$Default(): VkSubpassBeginInfo;
    set(arg0: number, arg1: number, arg2: number): VkSubpassBeginInfo;
