...
export class VkPhysicalDeviceExternalFenceInfo extends Struct<VkPhysicalDeviceExternalFenceInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceExternalFenceInfo;
    handleType(): number;
    handleType(arg0: number): VkPhysicalDeviceExternalFenceInfo;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceExternalFenceInfo;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceExternalFenceInfo;
    sType$Default(): VkPhysicalDeviceExternalFenceInfo;
    set(arg0: number, arg1: number, arg2: number): VkPhysicalDeviceExternalFenceInfo;
