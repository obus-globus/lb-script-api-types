...
export class VkDescriptorSetVariableDescriptorCountLayoutSupport extends Struct<VkDescriptorSetVariableDescriptorCountLayoutSupport> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkDescriptorSetVariableDescriptorCountLayoutSupport;
    maxVariableDescriptorCount(): number;
    pNext(): number;
    pNext(arg0: number): VkDescriptorSetVariableDescriptorCountLayoutSupport;
    sType(): number;
    sType(arg0: number): VkDescriptorSetVariableDescriptorCountLayoutSupport;
    sType$Default(): VkDescriptorSetVariableDescriptorCountLayoutSupport;
    set(arg0: number, arg1: number): VkDescriptorSetVariableDescriptorCountLayoutSupport;
