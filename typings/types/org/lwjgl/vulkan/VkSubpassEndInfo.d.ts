...
export class VkSubpassEndInfo extends Struct<VkSubpassEndInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkSubpassEndInfo;
    pNext(): number;
    pNext(arg0: number): VkSubpassEndInfo;
    ...
    sType(): number;
    sType(arg0: number): VkSubpassEndInfo;
    sType$Default(): VkSubpassEndInfo;
    set(arg0: number, arg1: number): VkSubpassEndInfo;
