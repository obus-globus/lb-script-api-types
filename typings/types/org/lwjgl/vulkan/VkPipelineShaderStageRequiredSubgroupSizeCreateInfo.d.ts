...
export class VkPipelineShaderStageRequiredSubgroupSizeCreateInfo extends Struct<VkPipelineShaderStageRequiredSubgroupSizeCreateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPipelineShaderStageRequiredSubgroupSizeCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkPipelineShaderStageRequiredSubgroupSizeCreateInfo;
    requiredSubgroupSize(): number;
    requiredSubgroupSize(arg0: number): VkPipelineShaderStageRequiredSubgroupSizeCreateInfo;
    sType(): number;
    sType(arg0: number): VkPipelineShaderStageRequiredSubgroupSizeCreateInfo;
    sType$Default(): VkPipelineShaderStageRequiredSubgroupSizeCreateInfo;
    set(arg0: number, arg1: number, arg2: number): VkPipelineShaderStageRequiredSubgroupSizeCreateInfo;
