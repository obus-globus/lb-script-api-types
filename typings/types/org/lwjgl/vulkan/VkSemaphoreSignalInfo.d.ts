...
export class VkSemaphoreSignalInfo extends Struct<VkSemaphoreSignalInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkSemaphoreSignalInfo;
    pNext(): number;
    pNext(arg0: number): VkSemaphoreSignalInfo;
    sType(): number;
    sType(arg0: number): VkSemaphoreSignalInfo;
    sType$Default(): VkSemaphoreSignalInfo;
    semaphore(): number;
    semaphore(arg0: number): VkSemaphoreSignalInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number): VkSemaphoreSignalInfo;
    set(arg0: VkSemaphoreSignalInfo): VkSemaphoreSignalInfo;
    sizeof(): number;
    value(): number;
    value(arg0: number): VkSemaphoreSignalInfo;
}