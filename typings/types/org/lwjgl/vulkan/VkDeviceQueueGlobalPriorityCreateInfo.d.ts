...
export class VkDeviceQueueGlobalPriorityCreateInfo extends Struct<VkDeviceQueueGlobalPriorityCreateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkDeviceQueueGlobalPriorityCreateInfo;
    globalPriority(): number;
    globalPriority(arg0: number): VkDeviceQueueGlobalPriorityCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkDeviceQueueGlobalPriorityCreateInfo;
    sType(): number;
    sType(arg0: number): VkDeviceQueueGlobalPriorityCreateInfo;
    sType$Default(): VkDeviceQueueGlobalPriorityCreateInfo;
    set(arg0: number, arg1: number, arg2: number): VkDeviceQueueGlobalPriorityCreateInfo;
