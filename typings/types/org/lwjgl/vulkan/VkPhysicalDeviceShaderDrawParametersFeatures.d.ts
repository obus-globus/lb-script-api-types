...
export class VkPhysicalDeviceShaderDrawParametersFeatures extends Struct<VkPhysicalDeviceShaderDrawParametersFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceShaderDrawParametersFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceShaderDrawParametersFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceShaderDrawParametersFeatures;
    sType$Default(): VkPhysicalDeviceShaderDrawParametersFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceShaderDrawParametersFeatures;
    ...
    shaderDrawParameters(arg0: boolean): VkPhysicalDeviceShaderDrawParametersFeatures;
    sizeof(): number;
}