...
export class VkPhysicalDeviceShaderSubgroupRotateFeatures extends Struct<VkPhysicalDeviceShaderSubgroupRotateFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceShaderSubgroupRotateFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceShaderSubgroupRotateFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceShaderSubgroupRotateFeatures;
    sType$Default(): VkPhysicalDeviceShaderSubgroupRotateFeatures;
    set(arg0: number, arg1: number, arg2: boolean, arg3: boolean): VkPhysicalDeviceShaderSubgroupRotateFeatures;
    ...
    shaderSubgroupRotate(arg0: boolean): VkPhysicalDeviceShaderSubgroupRotateFeatures;
    shaderSubgroupRotateClustered(): boolean;
    shaderSubgroupRotateClustered(arg0: boolean): VkPhysicalDeviceShaderSubgroupRotateFeatures;
    sizeof(): number;
}