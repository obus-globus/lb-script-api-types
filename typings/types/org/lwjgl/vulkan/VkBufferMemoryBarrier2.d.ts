...
export class VkBufferMemoryBarrier2 extends Struct<VkBufferMemoryBarrier2> implements NativeResource {
    ...
    buffer(): number;
    buffer(arg0: number): VkBufferMemoryBarrier2;
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkBufferMemoryBarrier2;
    dstAccessMask(): number;
    dstAccessMask(arg0: number): VkBufferMemoryBarrier2;
    dstQueueFamilyIndex(): number;
    dstQueueFamilyIndex(arg0: number): VkBufferMemoryBarrier2;
    dstStageMask(): number;
    dstStageMask(arg0: number): VkBufferMemoryBarrier2;
    offset(): number;
    offset(arg0: number): VkBufferMemoryBarrier2;
    pNext(): number;
    pNext(arg0: number): VkBufferMemoryBarrier2;
    ...
    sType(): number;
    sType(arg0: number): VkBufferMemoryBarrier2;
    sType$Default(): VkBufferMemoryBarrier2;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: number, arg7: number, arg8: number, arg9: number, arg10: number): VkBufferMemoryBarrier2;
    set(arg0: VkBufferMemoryBarrier2): VkBufferMemoryBarrier2;
    size(): number;
    size(arg0: number): VkBufferMemoryBarrier2;
    sizeof(): number;
    srcAccessMask(): number;
    srcAccessMask(arg0: number): VkBufferMemoryBarrier2;
    srcQueueFamilyIndex(): number;
    srcQueueFamilyIndex(arg0: number): VkBufferMemoryBarrier2;
    srcStageMask(): number;
    srcStageMask(arg0: number): VkBufferMemoryBarrier2;
}