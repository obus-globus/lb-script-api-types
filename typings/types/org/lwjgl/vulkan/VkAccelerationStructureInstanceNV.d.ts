...
export class VkAccelerationStructureInstanceNV extends VkAccelerationStructureInstanceKHR {
    ...
    accelerationStructureReference(arg0: number): VkAccelerationStructureInstanceNV;
    create(arg0: number, arg1: ByteBuffer): VkAccelerationStructureInstanceNV;
    flags(): number;
    flags(arg0: number): VkAccelerationStructureInstanceNV;
    instanceCustomIndex(): number;
    instanceCustomIndex(arg0: number): VkAccelerationStructureInstanceNV;
    instanceShaderBindingTableRecordOffset(): number;
    instanceShaderBindingTableRecordOffset(arg0: number): VkAccelerationStructureInstanceNV;
    mask(): number;
    mask(arg0: number): VkAccelerationStructureInstanceNV;
    set(arg0: VkAccelerationStructureInstanceKHR): VkAccelerationStructureInstanceKHR;
    set(arg0: VkAccelerationStructureInstanceNV): VkAccelerationStructureInstanceNV;
    set(arg0: VkTransformMatrixKHR, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number): VkAccelerationStructureInstanceNV;
    transform(): VkTransformMatrixKHR;
    transform(arg0: (param0: VkTransformMatrixKHR) => void): VkAccelerationStructureInstanceNV;
    transform(arg0: VkTransformMatrixKHR): VkAccelerationStructureInstanceNV;
}