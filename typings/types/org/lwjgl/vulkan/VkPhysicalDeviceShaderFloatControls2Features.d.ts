...
export class VkPhysicalDeviceShaderFloatControls2Features extends Struct<VkPhysicalDeviceShaderFloatControls2Features> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceShaderFloatControls2Features;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceShaderFloatControls2Features;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceShaderFloatControls2Features;
    sType$Default(): VkPhysicalDeviceShaderFloatControls2Features;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceShaderFloatControls2Features;
    ...
    shaderFloatControls2(arg0: boolean): VkPhysicalDeviceShaderFloatControls2Features;
    sizeof(): number;
}