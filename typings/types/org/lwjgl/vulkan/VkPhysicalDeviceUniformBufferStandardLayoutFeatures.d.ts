...
export class VkPhysicalDeviceUniformBufferStandardLayoutFeatures extends Struct<VkPhysicalDeviceUniformBufferStandardLayoutFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceUniformBufferStandardLayoutFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceUniformBufferStandardLayoutFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceUniformBufferStandardLayoutFeatures;
    sType$Default(): VkPhysicalDeviceUniformBufferStandardLayoutFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceUniformBufferStandardLayoutFeatures;
    ...
    uniformBufferStandardLayout(arg0: boolean): VkPhysicalDeviceUniformBufferStandardLayoutFeatures;
}