...
export class VkPipelineCreationFeedbackCreateInfo extends Struct<VkPipelineCreationFeedbackCreateInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPipelineCreationFeedbackCreateInfo;
    pNext(): number;
    pNext(arg0: number): VkPipelineCreationFeedbackCreateInfo;
    pPipelineCreationFeedback(): VkPipelineCreationFeedback;
    pPipelineCreationFeedback(arg0: VkPipelineCreationFeedback): VkPipelineCreationFeedbackCreateInfo;
    pPipelineStageCreationFeedbacks(): (Object | null)[];
    pPipelineStageCreationFeedbacks(arg0: (Object | null)[]): VkPipelineCreationFeedbackCreateInfo;
    pipelineStageCreationFeedbackCount(): number;
    sType(): number;
    sType(arg0: number): VkPipelineCreationFeedbackCreateInfo;
    sType$Default(): VkPipelineCreationFeedbackCreateInfo;
    set(arg0: number, arg1: number, arg2: VkPipelineCreationFeedback, arg3: (Object | null)[]): VkPipelineCreationFeedbackCreateInfo;
