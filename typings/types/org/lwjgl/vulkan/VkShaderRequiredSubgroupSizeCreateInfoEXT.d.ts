...
export class VkShaderRequiredSubgroupSizeCreateInfoEXT extends VkPipelineShaderStageRequiredSubgroupSizeCreateInfo {
    ...
    create(arg0: number, arg1: ByteBuffer): VkShaderRequiredSubgroupSizeCreateInfoEXT;
    pNext(): number;
    pNext(arg0: number): VkShaderRequiredSubgroupSizeCreateInfoEXT;
    requiredSubgroupSize(): number;
    requiredSubgroupSize(arg0: number): VkShaderRequiredSubgroupSizeCreateInfoEXT;
    sType(): number;
    sType(arg0: number): VkShaderRequiredSubgroupSizeCreateInfoEXT;
    sType$Default(): VkShaderRequiredSubgroupSizeCreateInfoEXT;
    set(arg0: number, arg1: number, arg2: number): VkShaderRequiredSubgroupSizeCreateInfoEXT;
    set(arg0: VkPipelineShaderStageRequiredSubgroupSizeCreateInfo): VkPipelineShaderStageRequiredSubgroupSizeCreateInfo;
    set(arg0: VkShaderRequiredSubgroupSizeCreateInfoEXT): VkShaderRequiredSubgroupSizeCreateInfoEXT;
}