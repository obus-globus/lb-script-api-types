...
export class VkPhysicalDeviceHostImageCopyPropertiesEXT extends VkPhysicalDeviceHostImageCopyProperties {
    ...
    static calloc(): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    static calloc(paramarg0: MemoryStack): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    ...
    static create(): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    static create(paramarg0: number): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    static createSafe(paramarg0: number): VkPhysicalDeviceHostImageCopyProperties;
    static createSafe(paramarg0: number, paramarg1: number): (Object | null)[];
    static createSafe(paramarg0: number): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    ...
    static malloc(): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    static malloc(paramarg0: MemoryStack): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    ...
    copyDstLayoutCount(arg0: number): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    copySrcLayoutCount(): number;
    copySrcLayoutCount(arg0: number): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    identicalMemoryTypeRequirements(): boolean;
    identicalMemoryTypeRequirements(arg0: boolean): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    optimalTilingLayoutUUID(): ByteBuffer;
    optimalTilingLayoutUUID(arg0: ByteBuffer): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    optimalTilingLayoutUUID(arg0: number): number;
    optimalTilingLayoutUUID(arg0: number, arg1: number): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    pCopyDstLayouts(): IntBuffer;
    pCopyDstLayouts(arg0: IntBuffer): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    pCopySrcLayouts(): IntBuffer;
    pCopySrcLayouts(arg0: IntBuffer): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    sType$Default(): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    set(arg0: number, arg1: number, arg2: number, arg3: IntBuffer, arg4: number, arg5: IntBuffer, arg6: ByteBuffer, arg7: boolean): VkPhysicalDeviceHostImageCopyPropertiesEXT;
    set(arg0: VkPhysicalDeviceHostImageCopyProperties): VkPhysicalDeviceHostImageCopyProperties;
    set(arg0: VkPhysicalDeviceHostImageCopyPropertiesEXT): VkPhysicalDeviceHostImageCopyPropertiesEXT;
}