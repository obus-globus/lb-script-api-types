...
export class VkBindBufferMemoryInfo extends Struct<VkBindBufferMemoryInfo> implements NativeResource {
    ...
    buffer(): number;
    buffer(arg0: number): VkBindBufferMemoryInfo;
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkBindBufferMemoryInfo;
    memory(): number;
    memory(arg0: number): VkBindBufferMemoryInfo;
    memoryOffset(): number;
    memoryOffset(arg0: number): VkBindBufferMemoryInfo;
    pNext(): number;
    pNext(arg0: number): VkBindBufferMemoryInfo;
    ...
    sType(): number;
    sType(arg0: number): VkBindBufferMemoryInfo;
    sType$Default(): VkBindBufferMemoryInfo;
    set(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number): VkBindBufferMemoryInfo;
