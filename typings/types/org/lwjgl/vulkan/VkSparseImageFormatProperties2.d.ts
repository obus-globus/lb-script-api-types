...
export class VkSparseImageFormatProperties2 extends Struct<VkSparseImageFormatProperties2> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkSparseImageFormatProperties2;
    pNext(): number;
    pNext(arg0: number): VkSparseImageFormatProperties2;
    properties(): VkSparseImageFormatProperties;
    sType(): number;
    sType(arg0: number): VkSparseImageFormatProperties2;
    sType$Default(): VkSparseImageFormatProperties2;
    set(arg0: number, arg1: number): VkSparseImageFormatProperties2;
