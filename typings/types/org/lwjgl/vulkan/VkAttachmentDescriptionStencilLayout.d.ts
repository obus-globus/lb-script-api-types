...
export class VkAttachmentDescriptionStencilLayout extends Struct<VkAttachmentDescriptionStencilLayout> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkAttachmentDescriptionStencilLayout;
    pNext(): number;
    pNext(arg0: number): VkAttachmentDescriptionStencilLayout;
    sType(): number;
    sType(arg0: number): VkAttachmentDescriptionStencilLayout;
    sType$Default(): VkAttachmentDescriptionStencilLayout;
    set(arg0: number, arg1: number, arg2: number, arg3: number): VkAttachmentDescriptionStencilLayout;
    set(arg0: VkAttachmentDescriptionStencilLayout): VkAttachmentDescriptionStencilLayout;
    sizeof(): number;
    stencilFinalLayout(): number;
    stencilFinalLayout(arg0: number): VkAttachmentDescriptionStencilLayout;
    stencilInitialLayout(): number;
    stencilInitialLayout(arg0: number): VkAttachmentDescriptionStencilLayout;
}