...
export class VkPhysicalDevicePipelineProtectedAccessFeatures extends Struct<VkPhysicalDevicePipelineProtectedAccessFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDevicePipelineProtectedAccessFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDevicePipelineProtectedAccessFeatures;
    pipelineProtectedAccess(): boolean;
    pipelineProtectedAccess(arg0: boolean): VkPhysicalDevicePipelineProtectedAccessFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDevicePipelineProtectedAccessFeatures;
    sType$Default(): VkPhysicalDevicePipelineProtectedAccessFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDevicePipelineProtectedAccessFeatures;
