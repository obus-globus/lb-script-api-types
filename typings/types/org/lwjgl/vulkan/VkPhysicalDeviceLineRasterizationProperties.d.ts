...
export class VkPhysicalDeviceLineRasterizationProperties extends Struct<VkPhysicalDeviceLineRasterizationProperties> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceLineRasterizationProperties;
    lineSubPixelPrecisionBits(): number;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceLineRasterizationProperties;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceLineRasterizationProperties;
    sType$Default(): VkPhysicalDeviceLineRasterizationProperties;
    set(arg0: number, arg1: number): VkPhysicalDeviceLineRasterizationProperties;
