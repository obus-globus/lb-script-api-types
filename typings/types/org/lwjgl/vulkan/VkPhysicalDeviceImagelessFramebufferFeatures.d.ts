...
export class VkPhysicalDeviceImagelessFramebufferFeatures extends Struct<VkPhysicalDeviceImagelessFramebufferFeatures> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceImagelessFramebufferFeatures;
    imagelessFramebuffer(): boolean;
    imagelessFramebuffer(arg0: boolean): VkPhysicalDeviceImagelessFramebufferFeatures;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceImagelessFramebufferFeatures;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceImagelessFramebufferFeatures;
    sType$Default(): VkPhysicalDeviceImagelessFramebufferFeatures;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceImagelessFramebufferFeatures;
