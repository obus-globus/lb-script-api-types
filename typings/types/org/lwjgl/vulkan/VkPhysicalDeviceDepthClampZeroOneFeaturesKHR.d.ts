...
export class VkPhysicalDeviceDepthClampZeroOneFeaturesKHR extends Struct<VkPhysicalDeviceDepthClampZeroOneFeaturesKHR> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceDepthClampZeroOneFeaturesKHR;
    depthClampZeroOne(): boolean;
    depthClampZeroOne(arg0: boolean): VkPhysicalDeviceDepthClampZeroOneFeaturesKHR;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceDepthClampZeroOneFeaturesKHR;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceDepthClampZeroOneFeaturesKHR;
    sType$Default(): VkPhysicalDeviceDepthClampZeroOneFeaturesKHR;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDeviceDepthClampZeroOneFeaturesKHR;
