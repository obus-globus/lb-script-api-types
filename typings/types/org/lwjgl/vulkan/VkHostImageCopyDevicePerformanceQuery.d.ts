...
export class VkHostImageCopyDevicePerformanceQuery extends Struct<VkHostImageCopyDevicePerformanceQuery> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkHostImageCopyDevicePerformanceQuery;
    identicalMemoryLayout(): boolean;
    optimalDeviceAccess(): boolean;
    pNext(): number;
    pNext(arg0: number): VkHostImageCopyDevicePerformanceQuery;
    sType(): number;
    sType(arg0: number): VkHostImageCopyDevicePerformanceQuery;
    sType$Default(): VkHostImageCopyDevicePerformanceQuery;
    set(arg0: number, arg1: number): VkHostImageCopyDevicePerformanceQuery;
