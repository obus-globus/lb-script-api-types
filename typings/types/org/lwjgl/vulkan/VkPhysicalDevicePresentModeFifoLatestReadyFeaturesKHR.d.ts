...
export class VkPhysicalDevicePresentModeFifoLatestReadyFeaturesKHR extends Struct<VkPhysicalDevicePresentModeFifoLatestReadyFeaturesKHR> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDevicePresentModeFifoLatestReadyFeaturesKHR;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDevicePresentModeFifoLatestReadyFeaturesKHR;
    presentModeFifoLatestReady(): boolean;
    presentModeFifoLatestReady(arg0: boolean): VkPhysicalDevicePresentModeFifoLatestReadyFeaturesKHR;
    sType(): number;
    sType(arg0: number): VkPhysicalDevicePresentModeFifoLatestReadyFeaturesKHR;
    sType$Default(): VkPhysicalDevicePresentModeFifoLatestReadyFeaturesKHR;
    set(arg0: number, arg1: number, arg2: boolean): VkPhysicalDevicePresentModeFifoLatestReadyFeaturesKHR;
