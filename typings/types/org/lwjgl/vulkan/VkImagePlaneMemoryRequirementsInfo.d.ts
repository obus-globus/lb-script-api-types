...
export class VkImagePlaneMemoryRequirementsInfo extends Struct<VkImagePlaneMemoryRequirementsInfo> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkImagePlaneMemoryRequirementsInfo;
    pNext(): number;
    pNext(arg0: number): VkImagePlaneMemoryRequirementsInfo;
    planeAspect(): number;
    planeAspect(arg0: number): VkImagePlaneMemoryRequirementsInfo;
    sType(): number;
    sType(arg0: number): VkImagePlaneMemoryRequirementsInfo;
    sType$Default(): VkImagePlaneMemoryRequirementsInfo;
    set(arg0: number, arg1: number, arg2: number): VkImagePlaneMemoryRequirementsInfo;
