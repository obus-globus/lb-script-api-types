...
export class VkPhysicalDeviceTimelineSemaphoreProperties extends Struct<VkPhysicalDeviceTimelineSemaphoreProperties> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceTimelineSemaphoreProperties;
    maxTimelineSemaphoreValueDifference(): number;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceTimelineSemaphoreProperties;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceTimelineSemaphoreProperties;
    sType$Default(): VkPhysicalDeviceTimelineSemaphoreProperties;
    set(arg0: number, arg1: number): VkPhysicalDeviceTimelineSemaphoreProperties;
