...
export class VkPhysicalDeviceDepthStencilResolveProperties extends Struct<VkPhysicalDeviceDepthStencilResolveProperties> implements NativeResource {
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): VkPhysicalDeviceDepthStencilResolveProperties;
    independentResolve(): boolean;
    independentResolveNone(): boolean;
    pNext(): number;
    pNext(arg0: number): VkPhysicalDeviceDepthStencilResolveProperties;
    sType(): number;
    sType(arg0: number): VkPhysicalDeviceDepthStencilResolveProperties;
    sType$Default(): VkPhysicalDeviceDepthStencilResolveProperties;
    set(arg0: number, arg1: number): VkPhysicalDeviceDepthStencilResolveProperties;
