...
export class VkDrmFormatModifierPropertiesEXT extends Struct<VkDrmFormatModifierPropertiesEXT> {
    ...
    static create(paramarg0: number): VkDrmFormatModifierPropertiesEXT;
    static create(paramarg0: number, paramarg1: number): (Object | null)[];
    static createSafe(paramarg0: number): VkDrmFormatModifierPropertiesEXT;
    ...
    create(arg0: number, arg1: ByteBuffer): VkDrmFormatModifierPropertiesEXT;
