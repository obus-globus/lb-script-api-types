...
export class ANDROIDBlobCache extends Object {
    static eglSetBlobCacheFuncsANDROID(paramarg0: number, paramarg1: (param0: number, param1: number, param2: number, param3: number) => void, paramarg2: (param0: number, param1: number, param2: number, param3: number) => kotlin.Long): void;
