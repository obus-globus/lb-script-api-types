...
import type { ALC10 } from '../../../org/lwjgl/openal/ALC10.d.ts'
export class ALC11 extends ALC10 {
    static ALC_ALL_ATTRIBUTES: number;
    static ALC_ALL_DEVICES_SPECIFIER: number;
    ...
    static ALC_DEFAULT_ALL_DEVICES_SPECIFIER: number;
