...
export abstract class GLFWAllocateCallback extends Callback implements GLFWAllocateCallbackI {
    ...
    static create(paramarg0: (param0: number, param1: number) => kotlin.Long): GLFWAllocateCallback;
