...
export abstract class FT_DebugHook_Func extends Callback implements FT_DebugHook_FuncI {
    ...
    static create(paramarg0: (param0: number) => kotlin.Int): FT_DebugHook_Func;
