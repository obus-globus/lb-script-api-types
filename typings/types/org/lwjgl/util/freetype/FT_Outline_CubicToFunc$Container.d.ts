...
export class FT_Outline_CubicToFunc$Container extends FT_Outline_CubicToFunc {
    ...
    static create(paramarg0: (param0: number, param1: number, param2: number, param3: number) => kotlin.Int): FT_Outline_CubicToFunc;
    ...
    constructor(arg0: number, arg1: (param0: number, param1: number, param2: number, param3: number) => kotlin.Int)
    // private delegate: (param0: number, param1: number, param2: number, param3: number) => kotlin.Int;
