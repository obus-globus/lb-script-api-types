...
export class FT_Outline_Funcs extends Struct<FT_Outline_Funcs> implements NativeResource {
    ...
    static nconic_to(paramarg0: number, paramarg1: (param0: number, param1: number, param2: number) => kotlin.Int): void;
    static ncubic_to(paramarg0: number): FT_Outline_CubicToFunc;
    static ncubic_to(paramarg0: number, paramarg1: (param0: number, param1: number, param2: number, param3: number) => kotlin.Int): void;
    ...
    static nline_to(paramarg0: number, paramarg1: (param0: number, param1: number) => kotlin.Int): void;
    static nmove_to(paramarg0: number): FT_Outline_MoveToFunc;
    static nmove_to(paramarg0: number, paramarg1: (param0: number, param1: number) => kotlin.Int): void;
    ...
    conic_to(arg0: (param0: number, param1: number, param2: number) => kotlin.Int): FT_Outline_Funcs;
    create(arg0: number, arg1: ByteBuffer): FT_Outline_Funcs;
    cubic_to(): FT_Outline_CubicToFunc;
    cubic_to(arg0: (param0: number, param1: number, param2: number, param3: number) => kotlin.Int): FT_Outline_Funcs;
    delta(): number;
    delta(arg0: number): FT_Outline_Funcs;
    line_to(): FT_Outline_LineToFunc;
    line_to(arg0: (param0: number, param1: number) => kotlin.Int): FT_Outline_Funcs;
    move_to(): FT_Outline_MoveToFunc;
    move_to(arg0: (param0: number, param1: number) => kotlin.Int): FT_Outline_Funcs;
    set(arg0: FT_Outline_Funcs): FT_Outline_Funcs;
    set(arg0: (param0: number, param1: number) => kotlin.Int, arg1: (param0: number, param1: number) => kotlin.Int, arg2: (param0: number, param1: number, param2: number) => kotlin.Int, arg3: (param0: number, param1: number, param2: number, param3: number) => kotlin.Int, arg4: number, arg5: number): FT_Outline_Funcs;
    shift(): number;
