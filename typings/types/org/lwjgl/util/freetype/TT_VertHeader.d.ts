...
export class TT_VertHeader extends Struct<TT_VertHeader> {
    static ADVANCE_HEIGHT_MAX: number;
    ...
    static MIN_BOTTOM_SIDE_BEARING: number;
    static MIN_TOP_SIDE_BEARING: number;
    static NUMBER_OF_VMETRICS: number;
    ...
    static YMAX_EXTENT: number;
    static create(paramarg0: number): TT_VertHeader;
    static create(paramarg0: number, paramarg1: number): (Object | null)[];
    static createSafe(paramarg0: number): TT_VertHeader;
    ...
    static nadvance_Height_Max(paramarg0: number): number;
    ...
    static nmin_Bottom_Side_Bearing(paramarg0: number): number;
    static nmin_Top_Side_Bearing(paramarg0: number): number;
    static nnumber_Of_VMetrics(paramarg0: number): number;
    ...
    Version(): number;
    advance_Height_Max(): number;
    caret_Offset(): number;
    caret_Slope_Rise(): number;
    caret_Slope_Run(): number;
    create(arg0: number, arg1: ByteBuffer): TT_VertHeader;
    long_metrics(arg0: number): ByteBuffer;
    metric_Data_Format(): number;
    min_Bottom_Side_Bearing(): number;
    min_Top_Side_Bearing(): number;
    number_Of_VMetrics(): number;
