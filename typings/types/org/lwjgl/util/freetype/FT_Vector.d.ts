...
export class FT_Vector extends Struct<FT_Vector> implements NativeResource {
    ...
    static calloc(paramarg0: MemoryStack): FT_Vector;
    static calloc(paramarg0: number): (Object | null)[];
    static calloc(paramarg0: number, paramarg1: MemoryStack): (Object | null)[];
    static create(): FT_Vector;
    static create(paramarg0: number): FT_Vector;
    static create(paramarg0: number): (Object | null)[];
    static create(paramarg0: number, paramarg1: number): (Object | null)[];
    static createSafe(paramarg0: number): FT_Vector;
    static createSafe(paramarg0: number, paramarg1: number): (Object | null)[];
    static malloc(): FT_Vector;
    static malloc(paramarg0: MemoryStack): FT_Vector;
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): FT_Vector;
