...
export class FT_Outline_ConicToFunc$Container extends FT_Outline_ConicToFunc {
    ...
    static create(paramarg0: (param0: number, param1: number, param2: number) => kotlin.Int): FT_Outline_ConicToFunc;
