...
export class FT_SVG_Document extends Struct<FT_SVG_Document> {
    ...
    static create(paramarg0: number): FT_SVG_Document;
    static create(paramarg0: number, paramarg1: number): (Object | null)[];
    static createSafe(paramarg0: number): FT_SVG_Document;
    ...
    create(arg0: number, arg1: ByteBuffer): FT_SVG_Document;
    delta(): FT_Vector;
    end_glyph_id(): number;
