...
export abstract class FT_Incremental_FreeGlyphDataFunc extends Callback implements FT_Incremental_FreeGlyphDataFuncI {
    ...
    static create(paramarg0: number): FT_Incremental_FreeGlyphDataFunc;
