...
export class FT_Memory extends Struct<FT_Memory> implements NativeResource {
    ...
    static nalloc(paramarg0: number, paramarg1: (param0: number, param1: number) => number): void;
    ...
    static nrealloc(paramarg0: number, paramarg1: (param0: number, param1: number, param2: number, param3: number) => number): void;
    ...
    alloc(): FT_Alloc_Func;
    alloc(arg0: (param0: number, param1: number) => number): FT_Memory;
    close(): void;
    create(arg0: number, arg1: ByteBuffer): FT_Memory;
    free$(): FT_Free_Func;
    free$(arg0: (param0: number, param1: number) => void): FT_Memory;
    realloc(): FT_Realloc_Func;
    realloc(arg0: (param0: number, param1: number, param2: number, param3: number) => number): FT_Memory;
    set(arg0: number, arg1: (param0: number, param1: number) => number, arg2: (param0: number, param1: number) => void, arg3: (param0: number, param1: number, param2: number, param3: number) => number): FT_Memory;
