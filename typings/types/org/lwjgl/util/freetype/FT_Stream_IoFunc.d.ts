...
export abstract class FT_Stream_IoFunc extends Callback implements FT_Stream_IoFuncI {
    ...
    static create(paramarg0: (param0: number, param1: number, param2: number, param3: number) => kotlin.Long): FT_Stream_IoFunc;
