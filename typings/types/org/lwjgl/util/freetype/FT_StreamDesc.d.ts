...
export class FT_StreamDesc extends Struct<FT_StreamDesc> implements NativeResource {
    ...
    static calloc(paramarg0: MemoryStack): FT_StreamDesc;
    static calloc(paramarg0: number): (Object | null)[];
    static calloc(paramarg0: number, paramarg1: MemoryStack): (Object | null)[];
    static create(): FT_StreamDesc;
    static create(paramarg0: number): FT_StreamDesc;
    static create(paramarg0: number): (Object | null)[];
    static create(paramarg0: number, paramarg1: number): (Object | null)[];
    static createSafe(paramarg0: number): FT_StreamDesc;
    static createSafe(paramarg0: number, paramarg1: number): (Object | null)[];
    static malloc(): FT_StreamDesc;
    static malloc(paramarg0: MemoryStack): FT_StreamDesc;
    static malloc(paramarg0: number): (Object | null)[];
    static malloc(paramarg0: number, paramarg1: MemoryStack): (Object | null)[];
    static npointer(paramarg0: number): number;
    static npointer(paramarg0: number, paramarg1: number): void;
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): FT_StreamDesc;
    pointer(): number;
