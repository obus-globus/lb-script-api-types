...
export class APIUtil extends Object {
    ...
    static apiArray(paramarg0: MemoryStack, paramarg1: (Object | null)[]): number;
    static apiArray(paramarg0: MemoryStack, paramarg1: number[]): number;
    static apiArray(paramarg0: MemoryStack, paramarg1: APIUtil$Encoder, paramarg2: (Object | null)[]): number;
    static apiArrayFree(paramarg0: number, paramarg1: number): void;
    static apiArrayi(paramarg0: MemoryStack, paramarg1: APIUtil$Encoder, paramarg2: (Object | null)[]): number;
    ...
    static apiCreateCIF(paramarg0: number, paramarg1: FFIType, paramarg2: (Object | null)[]): FFICIF;
    static apiCreateCIF(paramarg0: FFIType, paramarg1: (Object | null)[]): FFICIF;
    static apiCreateCIFVar(paramarg0: number, paramarg1: number, paramarg2: FFIType, paramarg3: (Object | null)[]): FFICIF;
    static apiCreateCIFVar(paramarg0: number, paramarg1: FFIType, paramarg2: (Object | null)[]): FFICIF;
    static apiCreateLibrary(paramarg0: string): SharedLibrary;
    static apiCreateStruct(paramarg0: (Object | null)[]): FFIType;
    static apiCreateUnion(paramarg0: (Object | null)[]): FFIType;
