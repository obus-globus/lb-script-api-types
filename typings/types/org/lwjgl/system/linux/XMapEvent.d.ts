...
export class XMapEvent extends Struct<XMapEvent> implements NativeResource {
    ...
    static calloc(): XMapEvent;
    static calloc(paramarg0: MemoryStack): XMapEvent;
    static calloc(paramarg0: number): (Object | null)[];
    static calloc(paramarg0: number, paramarg1: MemoryStack): (Object | null)[];
    static create(): XMapEvent;
    static create(paramarg0: number): XMapEvent;
    static create(paramarg0: number): (Object | null)[];
    static create(paramarg0: number, paramarg1: number): (Object | null)[];
    static createSafe(paramarg0: number): XMapEvent;
    static createSafe(paramarg0: number, paramarg1: number): (Object | null)[];
    static malloc(): XMapEvent;
    static malloc(paramarg0: MemoryStack): XMapEvent;
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): XMapEvent;
    display(): number;
    display(arg0: number): XMapEvent;
    event(): number;
    event(arg0: number): XMapEvent;
    override_redirect(): number;
    override_redirect(arg0: number): XMapEvent;
    send_event(): boolean;
    send_event(arg0: boolean): XMapEvent;
    serial(): number;
    serial(arg0: number): XMapEvent;
    set(arg0: number, arg1: number, arg2: boolean, arg3: number, arg4: number, arg5: number, arg6: number): XMapEvent;
    set(arg0: XMapEvent): XMapEvent;
    sizeof(): number;
    type(): number;
    type(arg0: number): XMapEvent;
    window(): number;
    window(arg0: number): XMapEvent;
}