...
export class XKeyEvent extends Struct<XKeyEvent> implements NativeResource {
    ...
    static calloc(): XKeyEvent;
    static calloc(paramarg0: MemoryStack): XKeyEvent;
    static calloc(paramarg0: number): (Object | null)[];
    static calloc(paramarg0: number, paramarg1: MemoryStack): (Object | null)[];
    static create(): XKeyEvent;
    static create(paramarg0: number): XKeyEvent;
    static create(paramarg0: number): (Object | null)[];
    static create(paramarg0: number, paramarg1: number): (Object | null)[];
    static createSafe(paramarg0: number): XKeyEvent;
    static createSafe(paramarg0: number, paramarg1: number): (Object | null)[];
    static malloc(): XKeyEvent;
    static malloc(paramarg0: MemoryStack): XKeyEvent;
    static malloc(paramarg0: number): (Object | null)[];
    static malloc(paramarg0: number, paramarg1: MemoryStack): (Object | null)[];
    static ndisplay(paramarg0: number): number;
    static ndisplay(paramarg0: number, paramarg1: number): void;
    static nkeycode(paramarg0: number): number;
    static nkeycode(paramarg0: number, paramarg1: number): void;
    ...
    close(): void;
    create(arg0: number, arg1: ByteBuffer): XKeyEvent;
    display(): number;
    display(arg0: number): XKeyEvent;
    keycode(): number;
    keycode(arg0: number): XKeyEvent;
    root(): number;
    root(arg0: number): XKeyEvent;
    same_screen(): boolean;
    same_screen(arg0: boolean): XKeyEvent;
    send_event(): boolean;
    send_event(arg0: boolean): XKeyEvent;
    serial(): number;
    serial(arg0: number): XKeyEvent;
    set(arg0: number, arg1: number, arg2: boolean, arg3: number, arg4: number, arg5: number, arg6: number, arg7: number, arg8: number, arg9: number, arg10: number, arg11: number, arg12: number, arg13: number, arg14: boolean): XKeyEvent;
    set(arg0: XKeyEvent): XKeyEvent;
    sizeof(): number;
    state(): number;
    state(arg0: number): XKeyEvent;
    subwindow(): number;
    subwindow(arg0: number): XKeyEvent;
    time(): number;
    time(arg0: number): XKeyEvent;
    type(): number;
    type(arg0: number): XKeyEvent;
    window(): number;
    window(arg0: number): XKeyEvent;
    x(): number;
    x(arg0: number): XKeyEvent;
    x_root(): number;
    x_root(arg0: number): XKeyEvent;
    y(): number;
    y(arg0: number): XKeyEvent;
    y_root(): number;
    y_root(arg0: number): XKeyEvent;
}