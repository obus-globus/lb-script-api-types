...
export class LibraryResource extends Object {
    ...
    static load(paramarg0: Class<Object>, paramarg1: string, paramarg2: Configuration<string>, ...paramarg3: string[]): Path;
    static load(paramarg0: Class<Object>, paramarg1: string, paramarg2: Configuration<string>, paramarg3: () => Path, ...paramarg4: string[]): Path;
