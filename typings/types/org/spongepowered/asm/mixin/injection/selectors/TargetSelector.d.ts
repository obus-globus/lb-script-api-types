...
export class TargetSelector extends Object {
    static parse(paramarg0: (Object | null)[], paramarg1: ISelectorContext): ITargetSelector[];
    static parse(paramarg0: (Object | null)[], paramarg1: ISelectorContext, paramarg2: ITargetSelector[]): ITargetSelector[];
    ...
    static parseAndValidate(paramarg0: (Object | null)[], paramarg1: ISelectorContext): ITargetSelector[];
    ...
    static run(paramarg0: ITargetSelector[], paramarg1: (Object | null)[]): TargetSelector$Result<Object>;
    static run(paramarg0: ITargetSelector, paramarg1: (Object | null)[]): TargetSelector$Result<Object>;
    private constructor()
}