...
export interface ModifyArg extends Annotation, Object{
    constructor(allow: number, at: At, constraints: string, expect: number, index: number, method: string[], order: number, remap: boolean, require: number, slice: Slice, target: Desc[])
