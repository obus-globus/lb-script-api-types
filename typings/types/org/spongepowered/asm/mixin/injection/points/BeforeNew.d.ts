...
export class BeforeNew extends InjectionPoint {
    ...
    static findInitNodeFor(paramarg0: AbstractInsnNode[], paramarg1: TypeInsnNode, paramarg2: string): MethodInsnNode;
    ...
    // private matchesOwner(arg0: TypeInsnNode): boolean;
}