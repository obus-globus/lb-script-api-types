...
export interface ModifyVariable extends Annotation, Object{
    constructor(allow: number, argsOnly: boolean, at: At, constraints: string, expect: number, index: number, method: string[], name: string[], order: number, ordinal: number, print: boolean, remap: boolean, require: number, slice: Slice, target: Desc[])
