...
export class InnerClassGenerator extends Object implements IClassGenerator {
    ...
    // private innerClassNames: JavaMap<string, string>;
    // private innerClasses: JavaMap<string, InnerClassGenerator$InnerClassInfo>;
    ...
    getInnerClasses(arg0: MixinInfo, arg1: string): JavaMap<string, string>;
    getName(): string;
