...
export class HashBiMap$BiEntry<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends ImmutableEntry<K, V> {
    constructor(arg0: K, arg1: number, arg2: V, arg3: number)
