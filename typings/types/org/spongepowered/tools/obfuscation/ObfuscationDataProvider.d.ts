...
export class ObfuscationDataProvider extends Object implements IObfuscationDataProvider {
    ...
    getObfEntry(arg0: ITargetSelectorRemappable): ObfuscationType[];
    getObfEntry(arg0: IMapping<T>): ObfuscationType[];
    getObfEntryRecursive(arg0: ITargetSelectorRemappable): ObfuscationType[];
    // private getObfEntryRecursive(arg0: ITargetSelectorRemappable, arg1: string[]): ObfuscationType[];
    // private getObfEntryUsing(arg0: ITargetSelectorRemappable, arg1: TypeHandle): ObfuscationType[];
