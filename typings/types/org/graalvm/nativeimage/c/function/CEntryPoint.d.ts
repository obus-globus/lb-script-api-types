...
export interface CEntryPoint extends Annotation, Object {
    constructor(builtin: CEntryPoint$Builtin, documentation: string[], exceptionHandler: KClass<CEntryPoint$ExceptionHandler>, include: KClass<() => kotlin.Boolean>, name: string, publishAs: CEntryPoint$Publish)
    ...
    /*not mapped: */ include(): KClass<() => kotlin.Boolean>;
