...
export class Utility extends Object {
    ...
    static arrayRegionMatches(paramsource: Object[], paramsourceStart: number, paramtarget: Object[], paramtargetStart: number, paramlen: number): boolean;
    ...
    static lookup(paramsource: string, paramtarget: string[]): number;
    ...
    static split(params: string, paramdivider: string): string[];
    static split(params: string, paramdivider: string, paramoutput: string[]): void;
    static splitString(paramsrc: string, paramtarget: string): string[];
    static splitWhitespace(paramsrc: string): string[];
