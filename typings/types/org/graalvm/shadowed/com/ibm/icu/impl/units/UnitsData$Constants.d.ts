...
export class UnitsData$Constants extends Object {
    static CATEGORY_TABLE_NAME: string;
    static CONVERSION_UNIT_TABLE_NAME: string;
    ...
    static kPrefixOffset: number;
    static kSimpleUnitOffset: number;
    constructor()
}