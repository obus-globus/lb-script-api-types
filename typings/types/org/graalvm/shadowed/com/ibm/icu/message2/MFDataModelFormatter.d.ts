...
export class MFDataModelFormatter extends Object {
    ...
    // private findBestMatchingPattern(sm: MFDataModel$SelectMessage, variables: { [key: string]: Object }, arguments: { [key: string]: Object }): MFDataModel$Pattern;
    format(arguments: { [key: string]: Object }): string;
    // private formatExpression(expression: MFDataModel$Expression, variables: { [key: string]: Object }, arguments: { [key: string]: Object }): FormattedPlaceholder;
    ...
    // private resolveDeclarations(declarations: MFDataModel$Declaration[], arguments: { [key: string]: Object }): { [key: string]: Object };
}