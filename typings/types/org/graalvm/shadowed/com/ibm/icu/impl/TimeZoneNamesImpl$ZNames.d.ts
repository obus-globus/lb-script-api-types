...
export class TimeZoneNamesImpl$ZNames extends Object {
    ...
    static createMetaZoneAndPutInCache(paramcache: JavaMap<string, TimeZoneNamesImpl$ZNames>, paramnames: string[], parammzID: string): TimeZoneNamesImpl$ZNames;
    static createTimeZoneAndPutInCache(paramcache: JavaMap<string, TimeZoneNamesImpl$ZNames>, paramnames: string[], paramtzID: string): TimeZoneNamesImpl$ZNames;
