...
export class LocaleIDParser extends Object {
    ...
    constructor(localeID: string, canonicalize: boolean)
    baseName: string;
    ...
    setKeywordValue(keywordName: string, value: string): void;
    // private setKeywordValue(keywordName: string, value: string, reset: boolean): void;
