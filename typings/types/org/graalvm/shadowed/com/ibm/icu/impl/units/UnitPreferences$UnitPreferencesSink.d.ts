...
export class UnitPreferences$UnitPreferencesSink extends UResource$Sink {
    constructor()
    readonly mapToUnitPreferences: { [key: string]: { [key: string]: UnitPreferences$UnitPreference[] } };
    getMapToUnitPreferences(): { [key: string]: { [key: string]: UnitPreferences$UnitPreference[] } };
