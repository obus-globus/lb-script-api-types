...
import type { ICUResourceBundleImpl$ResourceContainer } from '../../../../../../../org/graalvm/shadowed/com/ibm/icu/impl/ICUResourceBundleImpl$ResourceContainer.d.ts'
...
export class ICUResourceBundleImpl$ResourceTable extends ICUResourceBundleImpl$ResourceContainer {
    static ALIAS: number;
    static ARRAY: number;
    ...
    constructor(wholeBundle: ICUResourceBundle$WholeBundle, rootRes: number)
