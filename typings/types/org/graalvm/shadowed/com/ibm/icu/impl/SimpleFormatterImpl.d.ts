...
export class SimpleFormatterImpl extends Object {
    ...
    static formatAndAppend(paramcompiledPattern: string, paramappendTo: StringBuilder, paramoffsets: number[], ...paramvalues: CharSequence[]): StringBuilder;
    static formatAndReplace(paramcompiledPattern: string, paramresult: StringBuilder, paramoffsets: number[], ...paramvalues: CharSequence[]): StringBuilder;
    static formatCompiledPattern(paramcompiledPattern: string, ...paramvalues: CharSequence[]): string;
    ...
    static formatRawPattern(parampattern: string, parammin: number, parammax: number, ...paramvalues: CharSequence[]): string;
