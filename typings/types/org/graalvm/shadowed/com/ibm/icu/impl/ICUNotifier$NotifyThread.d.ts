...
export class ICUNotifier$NotifyThread extends Thread {
    ...
    static yield(): void;
    constructor(notifier: ICUNotifier)
    // private notifier: ICUNotifier;
    // private queue: EventListener[][];
    queue(list: EventListener[]): void;
    run(): void;
}