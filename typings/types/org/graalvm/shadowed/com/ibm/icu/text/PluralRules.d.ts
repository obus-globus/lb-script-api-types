...
export class PluralRules extends Object implements Serializable {
    ...
    static getFunctionalEquivalent(paramlocale: ULocale, paramisAvailable: (Object | null)[]): ULocale;
    ...
    getAllKeywordDecimalQuantityValues(keyword: string): E[];
    getAllKeywordValues(keyword: string): E[];
    getAllKeywordValues(keyword: string, type: PluralRules$SampleType): E[];
    getDecimalQuantitySamples(keyword: string): E[];
    getDecimalQuantitySamples(keyword: string, sampleType: PluralRules$SampleType): E[];
    ...
    getSamples(keyword: string): E[];
    getSamples(keyword: string, sampleType: PluralRules$SampleType): E[];
