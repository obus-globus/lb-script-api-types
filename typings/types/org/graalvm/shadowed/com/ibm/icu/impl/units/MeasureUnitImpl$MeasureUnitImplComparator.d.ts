...
export class MeasureUnitImpl$MeasureUnitImplComparator extends Object implements Comparator<MeasureUnitImpl> {
    ...
    compare(o1: MeasureUnitImpl, o2: MeasureUnitImpl): number;
    ...
    thenComparing<U extends Object | number | string | boolean>(arg0: (param0: MeasureUnitImpl) => U, arg1: (param0: Object) => boolean): (param0: Object) => boolean;
