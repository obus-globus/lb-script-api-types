...
export class EscapeTransliterator extends Transliterator {
    ...
    constructor(ID: string, prefix: string, suffix: string, radix: number, minDigits: number, grokSupplementals: boolean, supplementalHandler: EscapeTransliterator)
    // private grokSupplementals: boolean;
    // private minDigits: number;
    // private prefix: string;
    // private radix: number;
    // private suffix: string;
    // private supplementalHandler: EscapeTransliterator;
