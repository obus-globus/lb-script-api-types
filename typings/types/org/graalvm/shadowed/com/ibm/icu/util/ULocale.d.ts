...
export class ULocale extends Object implements Serializable, Comparable<ULocale> {
    ...
    static acceptLanguage(paramacceptLanguageList: string, paramfallback: boolean[]): ULocale;
    static acceptLanguage(paramacceptLanguageList: string, paramavailableLocales: ULocale[], paramfallback: boolean[]): ULocale;
    static acceptLanguage(paramacceptLanguageList: ULocale[], paramfallback: boolean[]): ULocale;
    static acceptLanguage(paramacceptLanguageList: ULocale[], paramavailableLocales: ULocale[], paramfallback: boolean[]): ULocale;
    ...
    static getAvailableLocales(): ULocale[];
    static getAvailableLocalesByType(paramtype: ULocale$AvailableType): ULocale[];
