...
export class ChineseDateFormat$Field extends DateFormat$Field {
    ...
    static IS_LEAP_MONTH: ChineseDateFormat$Field;
    ...
    static ofCalendarField(paramcalendarField: number): DateFormat$Field;
