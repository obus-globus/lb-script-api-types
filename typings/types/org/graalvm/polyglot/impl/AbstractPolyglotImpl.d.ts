...
export abstract class AbstractPolyglotImpl extends Object {
    ...
    readonly next: AbstractPolyglotImpl;
    // private prev: AbstractPolyglotImpl;
    ...
    createAllEngineOptionDescriptors(): OptionDescriptor[];
    ...
    getNext(): AbstractPolyglotImpl;
    getNextOrNull(): AbstractPolyglotImpl;
    getPriority(): number;
    getRootImpl(): AbstractPolyglotImpl;
    ...
    newFileSystem(fs: FileSystem_2): Object;
    ...
    setNext(next: AbstractPolyglotImpl): void;
    validateVirtualThreadCreation(engineOptions: OptionValues): void;
}