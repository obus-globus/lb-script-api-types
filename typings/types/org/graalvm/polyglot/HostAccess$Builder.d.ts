...
export class HostAccess$Builder extends Object {
    ...
    targetTypeMapping(sourceType: Class<S>, targetType: Class<T>, accepts: (param0: S) => kotlin.Boolean, converter: (param0: S) => T): HostAccess$Builder;
    targetTypeMapping(sourceType: Class<S>, targetType: Class<T>, accepts: (param0: S) => kotlin.Boolean, converter: (param0: S) => T, precedence: HostAccess$TargetMappingPrecedence): HostAccess$Builder;
