...
export interface JNI$GetByteArrayRegion extends Object, CFunctionPointer{
    call(env: JNI$JNIEnv, array: JNI$JByteArray, start: number, len: number, buf: CCharPointer): void;
