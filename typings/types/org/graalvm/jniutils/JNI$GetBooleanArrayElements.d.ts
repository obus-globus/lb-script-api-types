...
export interface JNI$GetBooleanArrayElements extends Object, CFunctionPointer{
    call(env: JNI$JNIEnv, array: JNI$JBooleanArray, isCopy: JNI$JValue): CCharPointer;
