...
export interface JNI$CallStaticBooleanMethodA extends Object, CFunctionPointer{
    call(env: JNI$JNIEnv, clazz: JNI$JClass, methodID: JNI$JMethodID, args: JNI$JValue): boolean;
