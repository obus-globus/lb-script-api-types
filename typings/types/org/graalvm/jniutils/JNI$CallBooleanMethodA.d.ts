...
export interface JNI$CallBooleanMethodA extends Object, CFunctionPointer{
    call(env: JNI$JNIEnv, o: JNI$JObject, methodID: JNI$JMethodID, args: JNI$JValue): boolean;
