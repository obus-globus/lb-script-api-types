...
export class SeqLockPrefixTree$Node extends AtomicLong {
    ...
    // private bottomUp<R extends Object | number | string | boolean>(visitor: SeqLockPrefixTree$Visitor<R>): R;
    ...
    toString(): string;
    topDown<C extends Object | number | string | boolean>(currentContext: C, createContext: (param0: C, param1: number) => C, consumeValue: (param0: C, param1: number) => void): void;
