...
export class LSPLibraryGen$CachedDispatchFirst extends LSPLibraryGen$CachedDispatch {
    static getFactory(): LibraryFactory<LSPLibrary>;
    constructor(library: LSPLibrary, next: LSPLibraryGen$CachedDispatch, limit_: number)
