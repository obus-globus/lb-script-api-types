...
export class DocumentHighlightParams extends TextDocumentPositionParams {
    static create(paramtextDocument: TextDocumentIdentifier, paramposition: Position): DocumentHighlightParams;
    ...
    hashCode(): number;
    setPartialResultToken(partialResultToken: Object): DocumentHighlightParams;
    setWorkDoneToken(workDoneToken: Object): DocumentHighlightParams;
}