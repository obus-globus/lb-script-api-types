...
export class DocumentSymbolParams extends WorkDoneProgressParams {
    static create(paramtextDocument: TextDocumentIdentifier): DocumentSymbolParams;
    ...
    hashCode(): number;
    setPartialResultToken(partialResultToken: Object): DocumentSymbolParams;
    setTextDocument(textDocument: TextDocumentIdentifier): DocumentSymbolParams;
}