...
export class DefinitionParams extends TextDocumentPositionParams {
    static create(paramtextDocument: TextDocumentIdentifier, paramposition: Position): DefinitionParams;
    ...
    hashCode(): number;
    setPartialResultToken(partialResultToken: Object): DefinitionParams;
    setWorkDoneToken(workDoneToken: Object): DefinitionParams;
}