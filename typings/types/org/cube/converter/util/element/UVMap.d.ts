...
export class UVMap extends Object {
    ...
    readonly uvMap: JavaMap<Direction, number[]>;
    readonly uvRotation: JavaMap<Direction, number>;
    readonly uvType: UVMap$UVType;
    clone(): UVMap;
    getUvMap(): JavaMap<Direction, number[]>;
    getUvRotation(): JavaMap<Direction, number>;
