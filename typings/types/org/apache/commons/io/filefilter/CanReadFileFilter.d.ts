...
export class CanReadFileFilter extends AbstractFileFilter implements Serializable {
    static CANNOT_READ: IOFileFilter;
    static CAN_READ: IOFileFilter;
    static EMPTY_STRING_ARRAY: (Object | null)[];
    static READ_ONLY: IOFileFilter;
    constructor()
