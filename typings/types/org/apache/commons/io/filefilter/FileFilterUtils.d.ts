...
export class FileFilterUtils extends Object {
    ...
    static and(...paramarg0: IOFileFilter[]): IOFileFilter;
    ...
    static filter(paramarg0: IOFileFilter, ...paramarg1: File[]): File[];
    static filter(paramarg0: IOFileFilter, paramarg1: File[]): File[];
    ...
    static or(...paramarg0: IOFileFilter[]): IOFileFilter;
    ...
    static toList(...paramarg0: IOFileFilter[]): IOFileFilter[];
