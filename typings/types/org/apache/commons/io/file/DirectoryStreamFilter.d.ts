...
export class DirectoryStreamFilter extends Object implements DirectoryStream$Filter<Path[]> {
    constructor(arg0: (param0: Path[][], param1: BasicFileAttributes) => java.nio.file.FileVisitResult)
    readonly pathFilter: (param0: Path[][], param1: BasicFileAttributes) => java.nio.file.FileVisitResult;
    accept(arg0: Path[]): boolean;
    getPathFilter(): (param0: Path[][], param1: BasicFileAttributes) => java.nio.file.FileVisitResult;
}