...
export class CopyDirectoryVisitor extends CountingPathVisitor {
    ...
    constructor(arg0: Counters$PathCounters, arg1: (param0: Path[][], param1: BasicFileAttributes) => java.nio.file.FileVisitResult, arg2: (param0: Path[][], param1: BasicFileAttributes) => java.nio.file.FileVisitResult, arg3: Path[], arg4: Path[], arg5: CopyOption[])
