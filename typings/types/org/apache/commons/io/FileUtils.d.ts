...
export class FileUtils extends Object {
    ...
    static convertFileCollectionToFileArray(paramarg0: E[]): (Object | null)[];
    ...
    static copyDirectory(paramarg0: File, paramarg1: File, paramarg2: (param0: File) => kotlin.Boolean): void;
    static copyDirectory(paramarg0: File, paramarg1: File, paramarg2: (param0: File) => kotlin.Boolean, paramarg3: boolean): void;
    static copyDirectory(paramarg0: File, paramarg1: File, paramarg2: (param0: File) => kotlin.Boolean, paramarg3: boolean, paramarg4: (Object | null)[]): void;
    ...
    static listFiles(paramarg0: File, paramarg1: (Object | null)[], paramarg2: boolean): E[];
    static listFiles(paramarg0: File, paramarg1: IOFileFilter, paramarg2: IOFileFilter): E[];
    static listFilesAndDirs(paramarg0: File, paramarg1: IOFileFilter, paramarg2: IOFileFilter): E[];
    ...
    static writeLines(paramarg0: File, paramarg1: string, paramarg2: E[]): void;
    static writeLines(paramarg0: File, paramarg1: string, paramarg2: E[], paramarg3: boolean): void;
    static writeLines(paramarg0: File, paramarg1: string, paramarg2: E[], paramarg3: string): void;
    static writeLines(paramarg0: File, paramarg1: string, paramarg2: E[], paramarg3: string, paramarg4: boolean): void;
    static writeLines(paramarg0: File, paramarg1: E[]): void;
    static writeLines(paramarg0: File, paramarg1: E[], paramarg2: boolean): void;
    static writeLines(paramarg0: File, paramarg1: E[], paramarg2: string): void;
    static writeLines(paramarg0: File, paramarg1: E[], paramarg2: string, paramarg3: boolean): void;
