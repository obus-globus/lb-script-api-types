...
export class PathFileComparator extends AbstractFileComparator implements Serializable {
    static PATH_COMPARATOR: (param0: Object) => boolean;
    static PATH_INSENSITIVE_COMPARATOR: (param0: Object) => boolean;
    static PATH_INSENSITIVE_REVERSE: (param0: Object) => boolean;
    static PATH_REVERSE: (param0: Object) => boolean;
    static PATH_SYSTEM_COMPARATOR: (param0: Object) => boolean;
    static PATH_SYSTEM_REVERSE: (param0: Object) => boolean;
    constructor()
