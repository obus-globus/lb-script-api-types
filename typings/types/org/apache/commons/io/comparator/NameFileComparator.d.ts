...
export class NameFileComparator extends AbstractFileComparator implements Serializable {
    static NAME_COMPARATOR: (param0: Object) => boolean;
    static NAME_INSENSITIVE_COMPARATOR: (param0: Object) => boolean;
    static NAME_INSENSITIVE_REVERSE: (param0: Object) => boolean;
    static NAME_REVERSE: (param0: Object) => boolean;
    static NAME_SYSTEM_COMPARATOR: (param0: Object) => boolean;
    static NAME_SYSTEM_REVERSE: (param0: Object) => boolean;
    constructor()
