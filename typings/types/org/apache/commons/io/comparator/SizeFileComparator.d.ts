...
export class SizeFileComparator extends AbstractFileComparator implements Serializable {
    static SIZE_COMPARATOR: (param0: File, param1: File) => number;
    static SIZE_REVERSE: (param0: File, param1: File) => number;
    static SIZE_SUMDIR_COMPARATOR: (param0: File, param1: File) => number;
    static SIZE_SUMDIR_REVERSE: (param0: File, param1: File) => number;
    constructor()
