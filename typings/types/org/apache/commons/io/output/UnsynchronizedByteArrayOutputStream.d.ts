...
import type { UnsynchronizedByteArrayOutputStream$Builder } from '../../../../../org/apache/commons/io/output/UnsynchronizedByteArrayOutputStream$Builder.d.ts'
export class UnsynchronizedByteArrayOutputStream extends AbstractByteArrayOutputStream<UnsynchronizedByteArrayOutputStream> {
    static builder(): UnsynchronizedByteArrayOutputStream$Builder;
    ...
    write(arg0: CharSequence, arg1: Charset): UnsynchronizedByteArrayOutputStream;
    write(arg0: number): void;
