import type { ChunkedOutputStream$1 } from '../../../../../com/google/gson/LongSerializationPolicy$1.d.ts'
...
export class ChunkedOutputStream extends FilterOutputStream {
    ...
    constructor(arg0: ChunkedOutputStream$Builder, arg1: ChunkedOutputStream$1)
