...
export class EnumUtils extends Object {
    ...
    static getEnumMap<E extends Enum<E>, K extends unknown>(paramarg0: Class<E>, paramarg1: (param0: E) => K): Map<K, E>;
    static getEnumMap<E extends Enum<E>>(paramarg0: Class<E>): { [key: string]: E };
