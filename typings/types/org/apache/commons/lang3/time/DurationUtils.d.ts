...
export class DurationUtils extends Object {
    static accept<T extends Throwable>(paramarg0: (param0: number, param1: number) => void, paramarg1: Duration): void;
    ...
    static of<E extends Throwable>(paramarg0: (param0: Instant) => void): Duration;
    static of<E extends Throwable>(paramarg0: () => void): Duration;
