...
export class ClassUtils extends Object {
    ...
    static comparator(): (param0: Object | null) => kotlin.Boolean;
    static convertClassNamesToClasses(paramarg0: string[]): (Object | null)[];
    static convertClassesToClassNames(paramarg0: (Object | null)[]): string[];
    ...
    static getAllSuperclasses(paramarg0: Class<Object>): (Object | null)[];
    ...
    static hierarchy(paramarg0: Class<Object>): (Object | null)[];
    static hierarchy(paramarg0: Class<Object>, paramarg1: ClassUtils$Interfaces): (Object | null)[];
