...
export class Streams$FailableStream<T extends Object | number | string | boolean> extends Object {
    constructor(arg0: Stream<T>)
    // private stream: Stream<T>;
    // private terminated: boolean;
    allMatch(arg0: (param0: T) => Object | null): boolean;
    anyMatch(arg0: (param0: T) => Object | null): boolean;
    ...
    filter(arg0: (param0: T) => Object | null): Streams$FailableStream<T>;
    forEach(arg0: (param0: T) => void): void;
    makeTerminated(): void;
    map(arg0: (param0: T) => Object | null): Streams$FailableStream<R>;
