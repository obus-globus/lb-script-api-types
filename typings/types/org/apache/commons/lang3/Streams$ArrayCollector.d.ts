...
export class Streams$ArrayCollector<O extends Object | number | string | boolean> extends Object implements Collector<O, O[], O[]> {
    ...
    combiner(): (param0: O[], param1: Object | null) => Object | null;
    finisher(): (param0: O[]) => O[];
    supplier(): () => O[];
}