...
export class LockingVisitors$StampedLockVisitor<O extends Object | number | string | boolean> extends LockingVisitors$LockVisitor<O, StampedLock> {
    static builder(): LockingVisitors$StampedLockVisitor$Builder<Object>;
    constructor(arg0: O, arg1: StampedLock)
    private constructor(arg0: LockingVisitors$StampedLockVisitor$Builder<O>)
}