...
export class LockingVisitors$ReentrantLockVisitor$Builder<O extends Object | number | string | boolean> extends LockingVisitors$LockVisitor$LVBuilder<O, ReentrantLock, LockingVisitors$ReentrantLockVisitor$Builder<O>> {
