...
export class AtomicInitializer$Builder<I extends AtomicInitializer<T>, T extends unknown> extends AbstractConcurrentInitializer$AbstractBuilder<I, T, AtomicInitializer$Builder<I, T>, ConcurrentException> {
