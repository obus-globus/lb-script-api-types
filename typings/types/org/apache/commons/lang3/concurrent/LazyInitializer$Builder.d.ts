...
export class LazyInitializer$Builder<I extends LazyInitializer<T>, T extends Object | number | string | boolean> extends AbstractConcurrentInitializer$AbstractBuilder<I, T, LazyInitializer$Builder<I, T>, ConcurrentException> {
