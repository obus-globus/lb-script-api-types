...
export class BackgroundInitializer$Builder<I extends BackgroundInitializer<T>, T extends unknown> extends AbstractConcurrentInitializer$AbstractBuilder<I, T, BackgroundInitializer$Builder<I, T>, Exception> {
