...
export class MutableTriple<L extends Object | number | string | boolean, M extends Object | number | string | boolean, R extends Object | number | string | boolean> extends Triple<L, M, R> {
