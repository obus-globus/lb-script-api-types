...
export class Streams$FailableStream<O extends unknown> extends Object {
    ...
    collect<R extends unknown>(arg0: () => R, arg1: (param0: R, param1: O) => void, arg2: (param0: R, param1: R) => void): R;
    collect<R extends unknown, A extends unknown>(arg0: Collector<O, A, R>): R;
    filter(arg0: (param0: O) => boolean): Streams$FailableStream<O>;
    forEach(arg0: (param0: O) => void): void;
    makeTerminated(): void;
    map<R extends unknown>(arg0: (param0: O) => R): Streams$FailableStream<R>;
    reduce(arg0: O, arg1: (param0: O, param1: O) => O): O;
    stream(): Stream<O>;
}