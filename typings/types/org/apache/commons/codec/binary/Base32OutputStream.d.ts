import type { Base32OutputStream$1 } from '../../../../../com/google/gson/LongSerializationPolicy$1.d.ts'
...
export class Base32OutputStream extends BaseNCodecOutputStream<Base32, Base32OutputStream, Base32OutputStream$Builder> {
    ...
    private constructor(arg0: Base32OutputStream$Builder)
    constructor(arg0: Base32OutputStream$Builder, arg1: Base32OutputStream$1)
}