import type { Base64InputStream$1 } from '../../../../../com/google/gson/LongSerializationPolicy$1.d.ts'
...
export class Base64InputStream extends BaseNCodecInputStream<Base64, Base64InputStream, Base64InputStream$Builder> {
    ...
    private constructor(arg0: Base64InputStream$Builder)
    constructor(arg0: Base64InputStream$Builder, arg1: Base64InputStream$1)
}