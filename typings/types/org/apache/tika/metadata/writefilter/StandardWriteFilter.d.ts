...
export class StandardWriteFilter extends Object implements Serializable, MetadataWriteFilter {
    ...
    // private fieldSizes: JavaMap<string, number>;
    ...
    // private addAlwaysInclude(arg0: string, arg1: string, arg2: JavaMap<string, string[]>): void;
    // private appendValue(arg0: string[], arg1: string): string[];
    filterExisting(arg0: JavaMap<string, string[]>): void;
    // private filterKey(arg0: string, arg1: string, arg2: JavaMap<string, string[]>): StandardWriteFilter$StringSizePair;
    ...
    // private setAlwaysInclude(arg0: string, arg1: string, arg2: JavaMap<string, string[]>): void;
    // private setFilterKey(arg0: StandardWriteFilter$StringSizePair, arg1: string, arg2: JavaMap<string, string[]>): void;
    // private setTruncated(arg0: JavaMap<string, string[]>): void;
    // private truncate(arg0: string, arg1: number, arg2: JavaMap<string, string[]>): string;
}