...
export class Property extends Object implements Comparable<Property> {
    static composite(paramarg0: Property, paramarg1: Property[]): Property;
    static externalBoolean(paramarg0: string): Property;
    static externalBooleanSeq(paramarg0: string): Property;
    static externalClosedChoise(paramarg0: string, ...paramarg1: string[]): Property;
    static externalDate(paramarg0: string): Property;
    static externalInteger(paramarg0: string): Property;
    static externalOpenChoise(paramarg0: string, ...paramarg1: string[]): Property;
    ...
    static internalClosedChoise(paramarg0: string, ...paramarg1: string[]): Property;
    ...
    static internalOpenChoise(paramarg0: string, ...paramarg1: string[]): Property;
