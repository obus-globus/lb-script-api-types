...
export class ThrowableConsumingMessageFactory extends Object implements MessageFactory2 {
    constructor()
    ...
    // private newParameterizedMessage(throwable: Object, pattern: string, ...args: Object[]): Message;
}