import type { UnmodifiableArrayBackedMap$1 } from '../../../../../../com/google/gson/LongSerializationPolicy$1.d.ts'
...
export class UnmodifiableArrayBackedMap$UnmodifiableEntryIterator extends Object implements Iterator<Map$Entry<string, string>> {
    ...
    constructor(null_: { [key: string]: any }, arg1: UnmodifiableArrayBackedMap$1)
