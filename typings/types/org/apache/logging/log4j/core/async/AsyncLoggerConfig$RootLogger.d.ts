...
export class AsyncLoggerConfig$RootLogger extends LoggerConfig {
    ...
    static ROOT: string;
    static createLogger(paramadditivity: string, paramlevelName: string, paramincludeLocation: string, paramrefs: (Object | null)[], paramproperties: (Object | null)[], paramconfig: Configuration, paramfilter: Filter): LoggerConfig;
