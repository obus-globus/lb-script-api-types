...
export class AbstractStyleNameConverter$Blue extends AbstractStyleNameConverter {
    static CATEGORY: string;
    static newInstance(paramconfig: Configuration, paramoptions: (Object | null)[]): AbstractStyleNameConverter$Blue;
