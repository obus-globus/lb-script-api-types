...
export class AbstractStyleNameConverter$White extends AbstractStyleNameConverter {
    static CATEGORY: string;
    static newInstance(paramconfig: Configuration, paramoptions: (Object | null)[]): AbstractStyleNameConverter$White;
