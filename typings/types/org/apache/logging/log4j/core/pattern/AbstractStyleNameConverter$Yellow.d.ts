...
export class AbstractStyleNameConverter$Yellow extends AbstractStyleNameConverter {
    static CATEGORY: string;
    static newInstance(paramconfig: Configuration, paramoptions: (Object | null)[]): AbstractStyleNameConverter$Yellow;
