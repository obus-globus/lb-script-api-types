...
export class LineLocationPatternConverter extends LogEventPatternConverter implements LocationAware {
    static CATEGORY: string;
    static newInstance(paramoptions: string[]): LineLocationPatternConverter;
    private constructor()
