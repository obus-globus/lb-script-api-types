...
export class JAnsiTextRenderer extends Object implements TextRenderer {
    static DefaultExceptionStyleMap: JavaMap<string, string>;
    constructor(formats: string[], defaultStyleMap: JavaMap<string, string>)
    // private beginToken: string;
    // private beginTokenLen: number;
    // private endToken: string;
    // private endTokenLen: number;
    readonly styleMap: JavaMap<string, string>;
    getStyleMap(): JavaMap<string, string>;
