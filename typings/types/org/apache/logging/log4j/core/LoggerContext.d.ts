...
export class LoggerContext extends AbstractLifeCycle implements AutoCloseable, ConfigurationListener, LoggerContext, LoggerContextShutdownEnabled, Terminable {
    ...
    // private newInstance(name: string, messageFactory: MessageFactory): Logger;
    newInstance(context: LoggerContext, name: string, messageFactory: MessageFactory): Logger;
