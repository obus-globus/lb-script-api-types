...
export class Log4jThread extends Thread {
    ...
    static yield(): void;
    constructor()
    constructor(target: () => void)
    constructor(target: () => void, name: string)
    constructor(group: ThreadGroup, target: () => void)
    constructor(group: ThreadGroup, target: () => void, name: string)
    constructor(group: ThreadGroup, target: () => void, name: string, stackSize: number)
