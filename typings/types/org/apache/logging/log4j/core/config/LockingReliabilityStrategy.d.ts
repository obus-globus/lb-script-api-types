...
export class LockingReliabilityStrategy extends Object implements LocationAwareReliabilityStrategy, ReliabilityStrategy {
    constructor(loggerConfig: LoggerConfig)
    // private isStopping: boolean;
    // private loggerConfig: LoggerConfig;
    // private reconfigureLock: ReadWriteLock;
    afterLogEvent(): void;
