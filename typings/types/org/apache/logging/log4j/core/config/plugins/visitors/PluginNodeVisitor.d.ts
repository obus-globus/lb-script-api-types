...
import type { PluginNode } from '../../../../../../../../org/apache/logging/log4j/core/config/plugins/PluginNode.d.ts'
import type { AbstractPluginVisitor } from '../../../../../../../../org/apache/logging/log4j/core/config/plugins/visitors/AbstractPluginVisitor.d.ts'
export class PluginNodeVisitor extends AbstractPluginVisitor<PluginNode> {
    constructor()
