...
export class DefaultKeyValuePairComponentBuilder extends DefaultComponentAndConfigurationBuilder<KeyValuePairComponentBuilder> implements KeyValuePairComponentBuilder {
    constructor(builder: DefaultConfigurationBuilder<Configuration>, key: string, value: string)
}