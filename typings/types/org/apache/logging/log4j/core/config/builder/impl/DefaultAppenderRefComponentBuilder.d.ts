...
export class DefaultAppenderRefComponentBuilder extends DefaultComponentAndConfigurationBuilder<AppenderRefComponentBuilder> implements AppenderRefComponentBuilder {
    constructor(builder: DefaultConfigurationBuilder<Configuration>, ref: string)
    add(builder: FilterComponentBuilder): AppenderRefComponentBuilder;
}