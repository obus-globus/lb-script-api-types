...
import type { LoggerConfig$RootLogger$Builder } from '../../../../../../org/apache/logging/log4j/core/config/LoggerConfig$RootLogger$Builder.d.ts'
...
export class LoggerConfig$RootLogger extends LoggerConfig {
    ...
    static newRootBuilder<B extends LoggerConfig$RootLogger$Builder<B>>(): B;
    constructor()
}