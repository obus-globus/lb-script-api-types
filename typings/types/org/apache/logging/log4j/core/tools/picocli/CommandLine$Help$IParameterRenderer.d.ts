...
import type { CommandLine$Parameters } from '../../../../../../../org/apache/logging/log4j/core/tools/picocli/CommandLine$Parameters.d.ts'
export interface CommandLine$Help$IParameterRenderer extends Object{
    render(parameters: CommandLine$Parameters, field: Field, parameterLabelRenderer: CommandLine$Help$IParamLabelRenderer, scheme: CommandLine$Help$ColorScheme): CommandLine$Help$Ansi$Text[][];
}