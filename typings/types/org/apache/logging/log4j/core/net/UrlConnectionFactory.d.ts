...
export class UrlConnectionFactory extends Object {
    ...
    static createConnection<T extends URLConnection>(paramurl: URL, paramlastModifiedMillis: number, paramsslConfiguration: SslConfiguration, paramauthorizationProvider: AuthorizationProvider): T;
