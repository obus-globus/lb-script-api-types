...
export class JndiManager extends AbstractManager {
    static createProperties(paraminitialContextFactoryName: string, paramproviderURL: string, paramurlPkgPrefixes: string, paramsecurityPrincipal: string, paramsecurityCredentials: string, paramadditionalProperties: JavaMap<any, any>): JavaMap<any, any>;
    static getDefaultManager(): JndiManager;
    static getDefaultManager(paramname: string): JndiManager;
    static getJndiManager(paraminitialContextFactoryName: string, paramproviderURL: string, paramurlPkgPrefixes: string, paramsecurityPrincipal: string, paramsecurityCredentials: string, paramadditionalProperties: JavaMap<any, any>): JndiManager;
    static getJndiManager(paramproperties: JavaMap<any, any>): JndiManager;
