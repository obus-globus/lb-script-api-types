...
export class LevelRangeFilter extends AbstractFilter {
    static DEFAULT_MAX_LEVEL: Level;
    static DEFAULT_MIN_LEVEL: Level;
    static DEFAULT_ON_MATCH: Filter$Result;
    static DEFAULT_ON_MISMATCH: Filter$Result;
    static DEFAULT_STOP_TIMEOUT: number;
    static DEFAULT_STOP_TIMEUNIT: TimeUnit;
    static ELEMENT_TYPE: string;
    static EMPTY_ARRAY: Filter[];
    static createFilter(paramminLevel: Level, parammaxLevel: Level, paramonMatch: Filter$Result, paramonMismatch: Filter$Result): LevelRangeFilter;
    private constructor(minLevel: Level, maxLevel: Level, onMatch: Filter$Result, onMismatch: Filter$Result)
