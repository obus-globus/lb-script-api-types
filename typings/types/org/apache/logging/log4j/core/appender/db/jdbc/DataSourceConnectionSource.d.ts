...
export class DataSourceConnectionSource extends AbstractConnectionSource {
    static DEFAULT_STOP_TIMEOUT: number;
    static DEFAULT_STOP_TIMEUNIT: TimeUnit;
    static createConnectionSource(paramjndiName: string): DataSourceConnectionSource;
    private constructor(dataSourceName: string, dataSource: DataSource)
