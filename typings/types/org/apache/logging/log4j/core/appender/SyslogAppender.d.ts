...
import type { SyslogAppender$Builder } from '../../../../../../org/apache/logging/log4j/core/appender/SyslogAppender$Builder.d.ts'
...
export class SyslogAppender extends SocketAppender {
    ...
    static newSyslogAppenderBuilder<B extends SyslogAppender$Builder<B>>(): B;
