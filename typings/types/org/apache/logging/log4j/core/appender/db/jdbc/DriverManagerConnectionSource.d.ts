...
import type { DriverManagerConnectionSource$Builder } from '../../../../../../../../org/apache/logging/log4j/core/appender/db/jdbc/DriverManagerConnectionSource$Builder.d.ts'
import type { Property } from '../../../../../../../../org/apache/logging/log4j/core/config/Property.d.ts'
export class DriverManagerConnectionSource extends AbstractDriverManagerConnectionSource {
    static DEFAULT_STOP_TIMEOUT: number;
    static DEFAULT_STOP_TIMEUNIT: TimeUnit;
    static getLogger(): Logger;
    static newBuilder<B extends DriverManagerConnectionSource$Builder<B>>(): B;
