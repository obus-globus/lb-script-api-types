...
export class DeleteAction extends AbstractPathAction {
    static createDeleteAction(parambasePath: string, paramfollowLinks: boolean, parammaxDepth: number, paramtestMode: boolean, paramsorterParameter: PathSorter, parampathConditions: PathCondition[], paramscriptCondition: ScriptCondition, paramconfig: Configuration): DeleteAction;
