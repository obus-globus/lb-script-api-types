...
export class SystemPropertiesPropertySource extends Object implements PropertySource {
    static getSystemProperty(paramkey: string, paramdefaultValue: string): string;
