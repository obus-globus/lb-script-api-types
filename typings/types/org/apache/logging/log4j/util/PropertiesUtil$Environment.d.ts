...
export class PropertiesUtil$Environment extends Object {
    ...
    // private removePropertySource(propertySource: PropertySource): void;
    // private sourceContainsProperty(source: PropertySource, key: string): boolean;
    // private sourceGetProperty(source: PropertySource, key: string): string;
}