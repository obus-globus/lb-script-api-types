...
export abstract class AbstractLogger extends Object implements Serializable, ExtendedLogger, LocationAwareLogger {
    ...
    enter(fqcn: string, format: string, paramSuppliers: () => org.apache.logging.log4j.message.Message[]): EntryMessage;
    enter(fqcn: string, format: string, paramSuppliers: () => Object | null[]): EntryMessage;
    enter(fqcn: string, message: Message): EntryMessage;
    enter(fqcn: string, messageSupplier: () => org.apache.logging.log4j.message.Message): EntryMessage;
    entry(): void;
    entry(params: Object[]): void;
    entry(fqcn: string, params: Object[]): void;
    entryMsg(format: string, params: Object[]): EntryMessage;
    entryMsg(format: string, paramSuppliers: () => org.apache.logging.log4j.message.Message[]): EntryMessage;
    ...
    logIfEnabled(fqcn: string, level: Level, marker: Marker, messageSupplier: () => org.apache.logging.log4j.message.Message, throwable: Throwable): void;
