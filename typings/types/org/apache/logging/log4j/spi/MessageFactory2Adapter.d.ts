...
export class MessageFactory2Adapter extends Object implements MessageFactory2 {
    constructor(wrapped: MessageFactory)
    // private wrapped: MessageFactory;
    getOriginal(): MessageFactory;
