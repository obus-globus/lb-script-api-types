...
export abstract class AbstractStatefulPayloadEmitHandler<T extends Object | number | string | boolean> extends Object implements StatefulPayloadEmitHandler<T> {
    constructor()
