...
export class NonOptionArgumentSpec<V extends unknown> extends AbstractOptionSpec<V> {
    constructor()
    ...
    isRequired(): boolean;
    ofType<T extends unknown>(arg0: Class<T>): NonOptionArgumentSpec<T>;
    representsNonOptions(): boolean;
    requiresArgument(): boolean;
    withValuesConvertedBy<T extends unknown>(arg0: ValueConverter<T>): NonOptionArgumentSpec<T>;
}