...
import type { X11$XClientMessageEvent$Data } from '../../../../../com/sun/jna/platform/unix/X11$XClientMessageEvent$Data.d.ts'
import type { Class } from '../../../../../java/lang/Class.d.ts'
export class X11$XClientMessageEvent extends Structure {
    ...
    constructor()
    data: X11$XClientMessageEvent$Data;
    display: X11$Display;
    format: number;
