...
export class OaIdl$ARRAYDESC extends Structure {
    ...
    constructor(arg0: OaIdl$TYPEDESC, arg1: number, arg2: OaIdl$SAFEARRAYBOUND[])
    cDims: number;
    rgbounds: OaIdl$SAFEARRAYBOUND[];
    tdescElem: OaIdl$TYPEDESC;
}