...
export class Wbemcli$IWbemQualifierSet extends Unknown {
    static IID_IUNKNOWN: Guid$IID;
    constructor(arg0: Pointer)
    Get(arg0: WString, arg1: number, arg2: Variant$VARIANT$ByReference, arg3: IntByReference): WinNT$HRESULT;
    Get(arg0: string): string;
    GetNames(): string[];
    GetNames(arg0: number, arg1: PointerByReference): WinNT$HRESULT;
}