...
import type { OaIdl$SYSKIND } from '../../../../../com/sun/jna/platform/win32/OaIdl$SYSKIND.d.ts'
...
export class OaIdl$TLIBATTR extends Structure {
    ...
    guid: Guid$GUID;
    lcid: WinDef$LCID;
    syskind: OaIdl$SYSKIND;
    wLibFlags: WinDef$WORD;
