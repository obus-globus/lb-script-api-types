...
export class User32Util$MessageLoopThread extends Thread {
    ...
    static yield(): void;
    constructor()
    // private javaThreadId: number;
    // private nativeThreadId: number;
    // private workQueue: FutureTask<Object>[];
    exit(): void;
    getMessageFailed(): boolean;
    run(): void;
    runAsync<V extends unknown>(arg0: () => V): Future<V>;
    runOnThread<V extends unknown>(arg0: () => V): V;
}