...
export class Native extends Object implements Version {
    ...
    static load(paramarg0: Class<Library>): Library | null;
    static load(paramarg0: Class<Library>, paramarg1: { [key: string]: Object }): Library | null;
    static load(paramarg0: string, paramarg1: Class<Library>): Library | null;
    static load(paramarg0: string, paramarg1: Class<Library>, paramarg2: { [key: string]: Object }): Library | null;
