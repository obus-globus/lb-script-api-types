...
export class TokenCache extends Object implements ITokenCache {
    ...
    // private accessTokens: { [key: string]: AccessTokenCacheEntity };
    // private accounts: { [key: string]: AccountCacheEntity };
    // private appMetadata: { [key: string]: AppMetadataCacheEntity };
    // private idTokens: { [key: string]: IdTokenCacheEntity };
    // private lock: ReadWriteLock;
    // private refreshTokens: { [key: string]: RefreshTokenCacheEntity };
    ...
    // private deserializeCollection<T extends unknown>(arg0: JsonReader, arg1: { [key: string]: T }, arg2: (param0: JsonReader) => T): void;
    ...
    // private writeCollection<T extends unknown>(arg0: JsonWriter, arg1: string, arg2: { [key: string]: T }): void;
}