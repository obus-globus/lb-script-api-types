...
export class RefreshTokenParameters$RefreshTokenParametersBuilder extends Object {
    ...
    extraHttpHeaders(arg0: JavaMap<string, string>): RefreshTokenParameters$RefreshTokenParametersBuilder;
    extraQueryParameters(arg0: JavaMap<string, string>): RefreshTokenParameters$RefreshTokenParametersBuilder;
