...
export class HostToTypeNodeGen$Inlined extends HostToTypeNode implements UnadoptableNode {
    static inline(paramtarget: InlineSupport$InlineTarget): HostToTypeNode;
    private constructor(target: InlineSupport$InlineTarget)
    // private cached_cache: InlineSupport$ReferenceField<HostToTypeNodeGen$CachedData>;
