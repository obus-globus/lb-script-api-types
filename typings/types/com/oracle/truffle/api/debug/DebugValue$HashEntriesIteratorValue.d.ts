...
export class DebugValue$HashEntriesIteratorValue extends DebugValue$HeapValue {
    constructor(session: DebuggerSession, preferredLanguage: LanguageInfo, name: string, hashMap: Object, value: Object, kind: DebugValue$HashEntryValue$EntryKind)
