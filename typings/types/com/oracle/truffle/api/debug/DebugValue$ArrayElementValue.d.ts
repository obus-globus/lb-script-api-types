...
export class DebugValue$ArrayElementValue extends DebugValue$AbstractDebugCachedValue {
    constructor(session: DebuggerSession, preferredLanguage: LanguageInfo, scope: DebugScope, array: Object, index: number)
