...
export abstract class TruffleString$ParseLongNode extends AbstractPublicNode {
    ...
    constructor()
    doParse(a: AbstractTruffleString, radix: number, managedProfileA: InlinedConditionProfile, nativeProfileA: InlinedConditionProfile, impreciseAProfile: InlinedConditionProfile, parseLongNode: TStringInternalNodes$ParseLongNode, radixProfile: InlinedIntValueProfile): number;
