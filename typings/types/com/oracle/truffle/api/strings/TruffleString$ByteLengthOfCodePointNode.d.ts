...
export abstract class TruffleString$ByteLengthOfCodePointNode extends AbstractPublicNode {
    ...
    translate(a: AbstractTruffleString, byteIndex: number, encoding: TruffleString$Encoding, errorHandling: TruffleString$ErrorHandling, managedProfileA: InlinedConditionProfile, nativeProfileA: InlinedConditionProfile, impreciseProfile: InlinedConditionProfile, fixedProfile: InlinedConditionProfile, validProfile: InlinedConditionProfile): number;
}