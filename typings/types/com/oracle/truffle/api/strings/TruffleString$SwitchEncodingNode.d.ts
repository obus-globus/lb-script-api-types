...
export abstract class TruffleString$SwitchEncodingNode extends AbstractPublicNode {
    ...
    execute(a: AbstractTruffleString, encoding: TruffleString$Encoding, errorHandler: (param0: AbstractTruffleString, param1: number, param2: number, param3: TruffleString$Encoding, param4: TruffleString$Encoding) => TranscodingErrorHandler$ReplacementString): TruffleString;
    switchEncoding(a: AbstractTruffleString, encoding: TruffleString$Encoding, errorHandler: (param0: AbstractTruffleString, param1: number, param2: number, param3: TruffleString$Encoding, param4: TruffleString$Encoding) => TranscodingErrorHandler$ReplacementString, internalNode: TruffleString$InternalSwitchEncodingNode): TruffleString;
}