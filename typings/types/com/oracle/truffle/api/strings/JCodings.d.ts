...
export interface JCodings extends Object{
    ...
    readCodePoint(encoding: TruffleString$Encoding, array: number[], index: number, arrayEnd: number, errorHandler: (param0: AbstractTruffleString, param1: number, param2: number) => com.oracle.truffle.api.strings.DecodingErrorHandler.Result): number;
