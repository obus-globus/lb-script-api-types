...
export abstract class TruffleString$ParseIntNode extends AbstractPublicNode {
    ...
    doParse(a: AbstractTruffleString, radix: number, managedProfileA: InlinedConditionProfile, nativeProfileA: InlinedConditionProfile, impreciseAProfile: InlinedConditionProfile, parseIntNode: TStringInternalNodes$ParseIntNode, radixProfile: InlinedIntValueProfile): number;
