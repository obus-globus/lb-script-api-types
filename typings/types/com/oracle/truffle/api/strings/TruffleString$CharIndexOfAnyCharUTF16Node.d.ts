...
export abstract class TruffleString$CharIndexOfAnyCharUTF16Node extends AbstractPublicNode {
    ...
    indexOfRaw(a: AbstractTruffleString, fromCharIndex: number, maxCharIndex: number, values: string[], managedProfileA: InlinedConditionProfile, nativeProfileA: InlinedConditionProfile, impreciseProfile: InlinedConditionProfile, indexOfNode: TStringOpsNodes$IndexOfAnyCharUTF16Node): number;
}