...
export abstract class IndexOfCodePointSet$IndexOfTableNode extends IndexOfCodePointSet$OptimizedIndexOfNode {
    constructor(maxCodeRange: number, tables: number[])
