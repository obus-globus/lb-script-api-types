...
export abstract class TruffleString$FromNativePointerNode extends AbstractPublicNode {
    ...
    fromNativePointer(pointerObject: Object, byteOffset: number, byteLength: number, enc: TruffleString$Encoding, copy: boolean, interopLibrary: Node, rawPointerProfile: InlinedConditionProfile, utf8BrokenProfile: InlinedConditionProfile, utf16CompactProfile: InlinedConditionProfile, utf32Compact0Profile: InlinedConditionProfile, utf32Compact1Profile: InlinedConditionProfile, singleByteProfile: InlinedConditionProfile): TruffleString;
}