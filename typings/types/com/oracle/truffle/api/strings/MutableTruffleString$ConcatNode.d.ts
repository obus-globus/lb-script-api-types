...
export abstract class MutableTruffleString$ConcatNode extends AbstractPublicNode {
    ...
    constructor()
    concat(a: AbstractTruffleString, b: AbstractTruffleString, expectedEncoding: TruffleString$Encoding, managedProfileA: InlinedConditionProfile, nativeProfileA: InlinedConditionProfile, managedProfileB: InlinedConditionProfile, nativeProfileB: InlinedConditionProfile, outOfMemoryProfile: InlinedBranchProfile): MutableTruffleString;
