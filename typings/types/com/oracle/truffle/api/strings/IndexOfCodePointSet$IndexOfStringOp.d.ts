...
export class IndexOfCodePointSet$IndexOfStringOp extends IndexOfCodePointSet$OptimizedIndexOfOp {
    constructor(maxCodeRange: number, string: number[], stride: number)
    // private str: number[];
