...
export abstract class TruffleString$AsNativeNode extends AbstractPublicNode {
    ...
    constructor()
    execute(a: TruffleString, allocator: (param0: number) => kotlin.Any, expectedEncoding: TruffleString$Encoding, useCompaction: boolean, cacheResult: boolean): TruffleString;
}