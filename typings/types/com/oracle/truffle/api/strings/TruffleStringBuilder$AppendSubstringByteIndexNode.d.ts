...
export abstract class TruffleStringBuilder$AppendSubstringByteIndexNode extends AbstractPublicNode {
    ...
    constructor()
    append(sb: TruffleStringBuilderUTF16, a: AbstractTruffleString, fromByteIndex: number, byteLength: number, managedProfileA: InlinedConditionProfile, nativeProfileA: InlinedConditionProfile, impreciseProfile: InlinedConditionProfile, slowPathProfile: InlinedBranchProfile, inflateProfile: InlinedBranchProfile, bufferGrowProfile: InlinedBranchProfile, errorProfile: InlinedBranchProfile): void;
    ...
    execute(sb: TruffleStringBuilderUTF16, a: AbstractTruffleString, fromByteIndex: number, byteLength: number): void;
    execute(sb: TruffleStringBuilderUTF32, a: AbstractTruffleString, fromByteIndex: number, byteLength: number): void;
    execute(sb: TruffleStringBuilderUTF8, a: AbstractTruffleString, fromByteIndex: number, byteLength: number): void;
}