...
export class InstrumentationHandler extends Object {
    ...
    addExecutionBinding<T extends unknown>(binding: EventBinding$Source<T>): EventBinding<T>;
    ...
    addSourceExecutionBinding<T extends unknown>(binding: EventBinding$SourceExecuted<T>): EventBinding<T>;
    addSourceLoadedBinding<T extends unknown>(binding: EventBinding$SourceLoaded<T>): EventBinding<T>;
    addSourceSectionBinding<T extends unknown>(binding: EventBinding$Source<T>): EventBinding<T>;
    ...
    // private attachExecuteSourceListener<T extends unknown>(abstractInstrumenter: InstrumentationHandler$AbstractInstrumenter, filter: SourceSectionFilter, listener: T, notifyLoaded: boolean): EventBinding<T>;
    ...
    // private attachSourceSectionListener<T extends unknown>(abstractInstrumenter: InstrumentationHandler$AbstractInstrumenter, nearestFilter: NearestSectionFilter, baseFilter: SourceSectionFilter, listener: T, notifyLoaded: boolean): EventBinding<T>;
    ...
    lookup<T extends unknown>(key: Object, type: Class<T>): T;
