...
export class SourceInstrumentationHandler$SourcesNotificationQueue extends Object {
    ...
    // private clear(): void;
    // private enqueue(notification: SourceInstrumentationHandler$SourcesNotification): void;
    // private invalidate(): void;
    isSourcesInitializationRequired(): boolean;
    process(): void;
    // private removeFirst(): boolean;
    // private resolveFirst(): SourceInstrumentationHandler$SourcesNotification;
