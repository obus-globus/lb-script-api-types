...
export class UnsupportedTypeException extends InteropException {
    static create(paramsuppliedValues: Object[]): UnsupportedTypeException;
    static create(paramsuppliedValues: Object[], paramhint: string): UnsupportedTypeException;
    static create(paramsuppliedValues: Object[], paramhint: string, paramcause: Throwable): UnsupportedTypeException;
