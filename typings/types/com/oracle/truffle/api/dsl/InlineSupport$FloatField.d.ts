...
export class InlineSupport$FloatField extends InlineSupport$InlinableField {
    static create(paramdeclaringLookup: MethodHandles$Lookup, paramfield: string): InlineSupport$FloatField;
    constructor(declaringLookup: MethodHandles$Lookup, fieldName: string)
    createParentAccessor(parentClass: Class<Node>): InlineSupport$FloatField;
