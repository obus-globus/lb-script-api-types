...
export class LinkedImmutableMap$LinkedEntryIterator<K extends unknown, V extends unknown> extends LinkedImmutableMap$LinkedIterator<K, V> implements Iterator<Map$Entry<K, V>> {
