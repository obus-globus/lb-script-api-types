...
export class LinkedImmutableMap$LinkedValueIterator<K extends unknown, V extends unknown> extends LinkedImmutableMap$LinkedIterator<K, V> implements Iterator<V> {
