...
export class ShapeBasic extends ShapeImpl {
    ...
    constructor(layout: Layout, sharedData: Object, parent: ShapeImpl, objectType: Object, propertyMap: JavaMap<any, any>, transition: Transition, allocator: ShapeImpl$BaseAllocator, flags: number)
    constructor(layout: Layout, sharedData: Object, objectType: Object, flags: number, singleContextAssumption: Assumption)
    createShape(layout: Layout, sharedData: Object, parent: ShapeImpl, objectType: Object, propertyMap: JavaMap<any, any>, transition: Transition, allocator: ShapeImpl$BaseAllocator, flags: number): ShapeImpl;
}