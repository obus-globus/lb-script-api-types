...
export abstract class Accessor$LanguageSupport extends Accessor$Support {
    constructor()
    ...
    disposeThread(env: TruffleLanguage$Env, thread: Thread): void;
    exitContext(localEnv: TruffleLanguage$Env, exitMode: TruffleLanguage$ExitMode, exitCode: number): void;
    finalizeContext(localEnv: TruffleLanguage$Env): void;
    finalizeThread(env: TruffleLanguage$Env, thread: Thread): void;
    ...
    isThreadAccessAllowed(env: TruffleLanguage$Env, current: Thread, singleThread: boolean): boolean;
