...
export class Type extends Object {
    ...
    static getArgumentTypes(parammethodDescriptor: string): Type[];
    static getArgumentTypes(parammethod: Method): Type[];
    ...
    static getMethodDescriptor(paramreturnType: Type, ...paramargumentTypes: Type[]): string;
    static getMethodDescriptor(parammethod: Method): string;
    static getMethodType(paramreturnType: Type, ...paramargumentTypes: Type[]): Type;
