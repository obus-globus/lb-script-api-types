...
export class MethodInsnNode extends AbstractInsnNode {
    ...
    constructor(opcode: number, owner: string, name: string, descriptor: string)
    constructor(opcode: number, owner: string, name: string, descriptor: string, isInterface: boolean)
    desc: string;
    itf: boolean;
    name: string;
    owner: string;
