...
import type { DelegatingOutputStream } from '../../../../../com/oracle/truffle/api/impl/DelegatingOutputStream.d.ts'
...
export abstract class Accessor$InstrumentSupport extends Accessor$Support {
    constructor()
    collectEnvServices(collectTo: Object[], polyglotLanguageContext: Object, language: TruffleLanguage<Object>): void;
    createDelegatingOutput(out: OutputStream, delegate: DispatchOutputStream): DelegatingOutputStream;
    createDispatchOutput(out: OutputStream): DispatchOutputStream;
