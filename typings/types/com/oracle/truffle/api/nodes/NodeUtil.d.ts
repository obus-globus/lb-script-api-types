...
export class NodeUtil extends Object {
    ...
    static cloneNode(paramorig: Node | null): Node | null;
    ...
    static findAnnotation(paramclazz: Class<Object>, paramannotationClass: Class<Annotation>): Annotation | null;
    ...
    static nonAtomicReplace(paramoldNode: Node, paramnewNode: Node | null, paramreason: CharSequence): Node | null;
