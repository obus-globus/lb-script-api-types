...
export class NodeAccessor$AccessNodes extends Accessor$NodeSupport {
    constructor()
    ...
    getLanguage(rootNode: RootNode): TruffleLanguage<Object>;
    ...
    setSharingLayer(rootNode: RootNode, layer: Object): void;
    translateStackTraceElement(stackTraceElement: TruffleStackTraceElement): Object;
}