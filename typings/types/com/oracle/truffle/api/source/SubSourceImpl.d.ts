...
import type { SubSourceImpl$Key } from '../../../../../com/oracle/truffle/api/source/SubSourceImpl$Key.d.ts'
...
export class SubSourceImpl extends Source {
    ...
    private constructor(key: SubSourceImpl$Key)
    // private key: SubSourceImpl$Key;
    copy(): Source;
