...
export class SourceImpl$ReinitializableKey extends SourceImpl$Key {
    constructor(truffleFile: TruffleFile, content: Object, mimeType: string, languageId: string, url: URL, uri: URI, name: string, path: string, internal: boolean, interactive: boolean, cached: boolean, relativePathInLanguageHome: string, embedderSource: boolean, options: JavaMap<string, string>)
    // private path: Object;
