...
export class TracingSourceCacheListener extends Object implements SourceCacheListener {
    private constructor(traceSourceCacheDetails: boolean)
    // private traceSourceCacheDetails: boolean;
