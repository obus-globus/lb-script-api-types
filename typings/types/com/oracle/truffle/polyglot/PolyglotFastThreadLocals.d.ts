...
export class PolyglotFastThreadLocals extends Object {
    ...
    static getCurrentThreadContextThreadLocals(paramlayer: PolyglotSharingLayer): (Object | null)[];
    static getCurrentThreadContextThreadLocalsEngine(paramengine: PolyglotEngineImpl): (Object | null)[];
    ...
    static leave(paramprev: (Object | null)[]): void;
