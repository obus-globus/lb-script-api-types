...
export class SystemThread$InstrumentSystemThread extends SystemThread {
    ...
    static yield(): void;
    constructor(polyglotInstrument: PolyglotInstrument, runnable: () => void, threadGroup: ThreadGroup)
