...
export class PolyglotThreadTask$PolyglotThread extends Thread {
    ...
    static yield(): void;
    constructor(group: ThreadGroup, task: () => void, name: string, stackSize: number, polyglotContext: PolyglotContextImpl)
    // private creatorContext: Context;
    // private polyglotContext: PolyglotContextImpl;
    // private getAndClearContextAPI(): Context;
    start(): void;
}