...
export class EngineAccessor$EngineImpl extends Accessor$EngineSupport {
    ...
    getEngineFileTypeDetectors(engineFileSystemObject: Object): { [key: string]: E[] };
    ...
    getOrCreateRuntimeData<T extends Object | number | string | boolean>(layer: Object): T;
    ...
    leaveAndEnter<R extends Object | number | string | boolean, T extends Object | number | string | boolean>(polyglotContext: Object, interrupter: TruffleSafepoint$Interrupter, interruptible: (param0: T) => R, object: T): R;
    ...
    lookup<S extends Object | number | string | boolean>(info: LanguageInfo, serviceClass: Class<S>): S;
