...
export class TerminateResponse extends Response {
    ...
    static create(paramrequestSeq: number, paramsuccess: boolean, paramcommand: string, paramseq: number): TerminateResponse;
