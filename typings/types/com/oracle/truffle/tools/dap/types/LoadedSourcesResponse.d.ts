...
export class LoadedSourcesResponse extends Response {
    static create(parambody: LoadedSourcesResponse$ResponseBody, paramrequestSeq: number, paramsuccess: boolean, paramcommand: string, paramseq: number): LoadedSourcesResponse;
