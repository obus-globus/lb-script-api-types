...
export class VariablesResponse extends Response {
    ...
    static create(parambody: VariablesResponse$ResponseBody, paramrequestSeq: number, paramsuccess: boolean, paramcommand: string, paramseq: number): VariablesResponse;
    constructor(jsonData: JSONObject)
    equals(obj: Object | null): boolean;
    getBody(): VariablesResponse$ResponseBody;
    hashCode(): number;
    setBody(body: VariablesResponse$ResponseBody): VariablesResponse;
