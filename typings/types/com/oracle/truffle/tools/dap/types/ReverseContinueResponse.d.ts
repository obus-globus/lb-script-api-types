...
export class ReverseContinueResponse extends Response {
    ...
    static create(paramrequestSeq: number, paramsuccess: boolean, paramcommand: string, paramseq: number): ReverseContinueResponse;
