...
export class TerminateThreadsResponse extends Response {
    ...
    static create(paramrequestSeq: number, paramsuccess: boolean, paramcommand: string, paramseq: number): TerminateThreadsResponse;
