...
export class ConfigurationDoneResponse extends Response {
    static create(paramrequestSeq: number, paramsuccess: boolean, paramcommand: string, paramseq: number): ConfigurationDoneResponse;
