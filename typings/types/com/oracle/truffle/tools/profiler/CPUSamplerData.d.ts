...
export class CPUSamplerData extends Object {
    constructor(contextIndex: number, context: TruffleContext, threadData: Map<Thread, ProfilerNode<CPUSampler$Payload>[]>, biasStatistics: LongSummaryStatistics, durationStatistics: LongSummaryStatistics, samplesTaken: number, intervalMs: number, missedSamples: number)
    ...
    readonly threadData: Map<Thread, ProfilerNode<CPUSampler$Payload>[]>;
    ...
    getSamples(): number;
    getThreadData(): Map<Thread, ProfilerNode<CPUSampler$Payload>[]>;
