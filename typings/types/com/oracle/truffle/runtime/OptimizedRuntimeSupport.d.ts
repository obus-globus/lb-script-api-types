...
export class OptimizedRuntimeSupport extends Accessor$RuntimeSupport {
    ...
    tryLoadCachedEngine(options: OptionValues, loggerFactory: (param0: string) => TruffleLogger): Object;
