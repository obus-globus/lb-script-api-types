...
export abstract class ArrayFunctionBuiltins$JSArrayFunctionOperation extends ArrayPrototypeBuiltins$JSArrayOperation {
    ...
    constructOrArray(thisObj: Object, len: number, provideLengthArg: boolean): Object;
}