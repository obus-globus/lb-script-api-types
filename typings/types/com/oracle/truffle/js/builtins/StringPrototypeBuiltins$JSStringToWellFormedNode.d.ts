...
export abstract class StringPrototypeBuiltins$JSStringToWellFormedNode extends StringPrototypeBuiltins$JSStringOperation {
    ...
    doOther(thisObj: Object, toValidNode: TruffleString$ToValidStringNode): TruffleString;
}