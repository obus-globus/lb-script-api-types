...
export abstract class ConstructorBuiltins$ConstructShadowRealmNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    construct(newTarget: JSDynamicObject): JSObject;
    getIntrinsicDefaultProto(realm: JSRealm): JSDynamicObject;
    // private hostInitializeShadowRealm(shadowRealm: JSRealm): void;
}