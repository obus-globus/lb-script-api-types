...
export class ConstructorBuiltinsFactory$ConstructTemporalPlainYearMonthNodeGen extends ConstructorBuiltins$ConstructTemporalPlainYearMonth {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: JavaScriptNode[]): ConstructorBuiltins$ConstructTemporalPlainYearMonth;
