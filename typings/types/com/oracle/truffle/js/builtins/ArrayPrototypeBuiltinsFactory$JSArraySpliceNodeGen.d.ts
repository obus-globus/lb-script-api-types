...
export class ArrayPrototypeBuiltinsFactory$JSArraySpliceNodeGen extends ArrayPrototypeBuiltins$JSArraySpliceNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): ArrayPrototypeBuiltins$JSArraySpliceNode;
    ...
    // private spliceJSArray_: ArrayPrototypeBuiltins$JSArraySpliceNode$SpliceJSArrayNode;
