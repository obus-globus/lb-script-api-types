...
export abstract class ConstructorBuiltins$ConstructLocaleNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    // private initializeLocaleNode: InitializeLocaleNode;
    constructLocale(newTarget: JSDynamicObject, tag: Object, options: Object): JSLocaleObject;
