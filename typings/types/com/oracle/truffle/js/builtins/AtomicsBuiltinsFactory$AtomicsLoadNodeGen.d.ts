...
export class AtomicsBuiltinsFactory$AtomicsLoadNodeGen extends AtomicsBuiltins$AtomicsLoadNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): AtomicsBuiltins$AtomicsLoadNode;
    ...
    executeWithBufferAndIndex(frameValue: VirtualFrame, arguments0Value: Object, arguments1Value: Object): Object;
