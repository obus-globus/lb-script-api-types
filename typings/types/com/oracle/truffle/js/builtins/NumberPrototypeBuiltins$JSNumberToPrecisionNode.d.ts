...
export abstract class NumberPrototypeBuiltins$JSNumberToPrecisionNode extends JSBuiltinNode {
    ...
    toPrecisionUndefined(thisNumber: JSNumberObject, precision: Object, toStringNode: JSToStringNode): Object;
}