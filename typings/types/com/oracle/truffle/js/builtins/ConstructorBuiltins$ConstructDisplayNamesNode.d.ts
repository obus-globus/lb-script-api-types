...
export abstract class ConstructorBuiltins$ConstructDisplayNamesNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    // private initializeDisplayNamesNode: InitializeDisplayNamesNode;
    constructDisplayNames(newTarget: JSDynamicObject, locales: Object, options: Object): JSDisplayNamesObject;
