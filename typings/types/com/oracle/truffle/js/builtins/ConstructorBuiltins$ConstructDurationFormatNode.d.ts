...
export abstract class ConstructorBuiltins$ConstructDurationFormatNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    // private initializeDurationFormatNode: InitializeDurationFormatNode;
    constructDurationFormat(newTarget: JSDynamicObject, locales: Object, options: Object): JSDurationFormatObject;
