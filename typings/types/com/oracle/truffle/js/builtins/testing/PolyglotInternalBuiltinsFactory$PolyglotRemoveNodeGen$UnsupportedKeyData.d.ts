...
export class PolyglotInternalBuiltinsFactory$PolyglotRemoveNodeGen$UnsupportedKeyData extends Node implements DSLSupport$SpecializationDataNode {
    constructor()
    // private keyInterop_: InteropLibrary;
