...
export abstract class TestV8Builtins$TestV8ToPrimitiveNode extends JSBuiltinNode {
    ...
    constructor(context: JSContext, builtin: JSBuiltin, hint: JSToPrimitiveNode$Hint)
    // private hint: JSToPrimitiveNode$Hint;
    // private toPrimitiveNode: JSToPrimitiveNode;
    toPrimitive(obj: Object): Object;
}