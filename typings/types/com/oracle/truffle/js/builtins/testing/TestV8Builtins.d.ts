...
export class TestV8Builtins extends JSBuiltinsContainer$SwitchEnum<TestV8Builtins$TestV8> {
    ...
    constructor()
    createNode(context: JSContext, builtin: JSBuiltin, construct: boolean, newTarget: boolean, builtinEnum: TestV8Builtins$TestV8): Object;
}