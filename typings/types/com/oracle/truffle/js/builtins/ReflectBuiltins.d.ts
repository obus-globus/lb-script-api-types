...
import type { ReflectBuiltins$Reflect } from '../../../../../com/oracle/truffle/js/builtins/ReflectBuiltins$Reflect.d.ts'
...
export class ReflectBuiltins extends JSBuiltinsContainer$SwitchEnum<ReflectBuiltins$Reflect> {
    ...
    constructor()
    createNode(context: JSContext, builtin: JSBuiltin, construct: boolean, newTarget: boolean, builtinEnum: ReflectBuiltins$Reflect): Object;
}