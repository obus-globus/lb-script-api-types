...
export abstract class TypedArrayPrototypeBuiltins$TypedArraySortMethodNode extends ArrayPrototypeBuiltins$AbstractArraySortNode {
    ...
    constructor(context: JSContext, builtin: JSBuiltin, toSorted: boolean)
    // private toSorted: boolean;
    sortTypedArray(thisObj: Object, compare: Object, typedArraySortNode: JSTypedArraySortNode, typedArrayLengthNode: TypedArrayLengthNode, isCompareUndefined: InlinedConditionProfile): JSTypedArrayObject;
}