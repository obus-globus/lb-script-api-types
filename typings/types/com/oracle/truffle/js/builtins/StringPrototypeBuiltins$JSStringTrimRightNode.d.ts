...
export abstract class StringPrototypeBuiltins$JSStringTrimRightNode extends StringPrototypeBuiltins$JSStringOperation {
    ...
    trimRight(thisObj: Object, readRawNode: TruffleString$ReadCharUTF16Node, substringNode: TruffleString$SubstringByteIndexNode, lengthExceeded: InlinedConditionProfile): Object;
}