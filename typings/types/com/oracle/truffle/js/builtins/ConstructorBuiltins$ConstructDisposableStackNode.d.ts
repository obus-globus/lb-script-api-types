...
export abstract class ConstructorBuiltins$ConstructDisposableStackNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    constructDisposableStack(newTarget: JSDynamicObject): JSDynamicObject;
