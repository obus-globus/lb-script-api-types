...
export class ConstructorBuiltinsFactory$CallBigIntNodeGen extends ConstructorBuiltins$CallBigIntNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): ConstructorBuiltins$CallBigIntNode;
    ...
    // private toBigInt_toBigIntNode__field1_: JSNumberToBigIntNode;
    // private toBigInt_toBigIntNode__field2_: TruffleString$ToJavaStringNode;
