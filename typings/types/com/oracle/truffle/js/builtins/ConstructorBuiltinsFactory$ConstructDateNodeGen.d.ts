...
export class ConstructorBuiltinsFactory$ConstructDateNodeGen extends ConstructorBuiltins$ConstructDateNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: JavaScriptNode[]): ConstructorBuiltins$ConstructDateNode;
