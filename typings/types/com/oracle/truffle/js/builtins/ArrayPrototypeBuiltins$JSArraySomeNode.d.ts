...
export abstract class ArrayPrototypeBuiltins$JSArraySomeNode extends ArrayPrototypeBuiltins$ArrayForEachIndexCallOperation {
    ...
    some(thisObj: Object, callback: Object, thisArg: Object): boolean;
}