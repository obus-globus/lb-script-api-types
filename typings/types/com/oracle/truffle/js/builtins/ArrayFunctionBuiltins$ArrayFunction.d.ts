...
export class ArrayFunctionBuiltins$ArrayFunction extends Enum<ArrayFunctionBuiltins$ArrayFunction> implements BuiltinEnum<ArrayFunctionBuiltins$ArrayFunction> {
    static from: ArrayFunctionBuiltins$ArrayFunction;
    ...
    name(): "isArray" | "of" | "from" | "fromAsync";
}