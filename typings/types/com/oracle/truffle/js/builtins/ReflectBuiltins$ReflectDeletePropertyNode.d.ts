...
export abstract class ReflectBuiltins$ReflectDeletePropertyNode extends ReflectBuiltins$ReflectOperation {
    ...
    delete(target: Object, property: Object, isObjectNode: IsObjectNode, toPropertyKeyNode: JSToPropertyKeyNode, deletePropertyNode: DeletePropertyNode): boolean;
}