...
export abstract class SetPrototypeBuiltins$JSSetIsSupersetOfNode extends SetPrototypeBuiltins$JSSetNewOperation {
    ...
    isSupersetOf(set: JSSetObject, other: Object, getSetRecordNode: GetSetRecordNode, getIteratorFromMethodNode: GetIteratorFromMethodNode): boolean;
