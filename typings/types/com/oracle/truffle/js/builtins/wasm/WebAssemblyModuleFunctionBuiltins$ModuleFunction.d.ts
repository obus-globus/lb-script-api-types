...
export class WebAssemblyModuleFunctionBuiltins$ModuleFunction extends Enum<WebAssemblyModuleFunctionBuiltins$ModuleFunction> implements BuiltinEnum<WebAssemblyModuleFunctionBuiltins$ModuleFunction> {
    ...
    name(): "exports" | "imports" | "customSections";
}