...
export abstract class WebAssemblyMemoryPrototypeBuiltins$WebAssemblyMemoryGetBufferNode extends JSBuiltinNode {
    ...
    getBuffer(memory: JSWebAssemblyMemoryObject): JSArrayBufferObject;
}