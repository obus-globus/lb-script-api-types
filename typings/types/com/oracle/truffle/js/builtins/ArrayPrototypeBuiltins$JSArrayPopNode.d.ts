...
export abstract class ArrayPrototypeBuiltins$JSArrayPopNode extends ArrayPrototypeBuiltins$JSArrayOperation {
    ...
    popGeneric(thisObj: Object, deleteAndSetLength: ArrayPrototypeBuiltins$DeleteAndSetLengthNode, lengthIsZero: InlinedConditionProfile): Object;
}