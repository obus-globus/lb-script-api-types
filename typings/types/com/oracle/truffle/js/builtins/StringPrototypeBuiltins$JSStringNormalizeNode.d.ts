...
export abstract class StringPrototypeBuiltins$JSStringNormalizeNode extends StringPrototypeBuiltins$JSStringOperation {
    ...
    normalize(thisObj: Object, form: Object, stringEqualsNode: TruffleString$EqualNode, toJavaStringNode: TruffleString$ToJavaStringNode, fromJavaStringNode: TruffleString$FromJavaStringNode): TruffleString;
}