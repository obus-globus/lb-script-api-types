...
export abstract class StringPrototypeBuiltins$JSStringToLowerCaseNode extends StringPrototypeBuiltins$JSStringOperation {
    ...
    toLowerCaseGeneric(thisObj: Object, fromJavaString: TruffleString$FromJavaStringNode, toJavaString: TruffleString$ToJavaStringNode): Object;
    // private toLowerCaseJava(str: TruffleString, fromJavaString: TruffleString$FromJavaStringNode, toJavaString: TruffleString$ToJavaStringNode): TruffleString;
    toLowerCaseString(thisStr: TruffleString, codeRangeEquals: TruffleString$CodeRangeEqualsNode, indexOfCodePointSet: TruffleString$ByteIndexOfCodePointSetNode, switchEncodingNode: TruffleString$SwitchEncodingNode, copyToByteArrayNode: TruffleString$CopyToByteArrayNode, fromByteArrayNode: TruffleString$FromByteArrayNode, fromJavaString: TruffleString$FromJavaStringNode, toJavaString: TruffleString$ToJavaStringNode, isAscii: InlinedConditionProfile, isAlreadyLowerCase: InlinedConditionProfile): TruffleString;
}