...
export abstract class ArrayPrototypeBuiltins$JSArrayIncludesNode extends ArrayPrototypeBuiltins$JSArrayOperationWithToInt {
    ...
    includes(thisValue: Object, searchElement: Object, fromIndex: Object, identicalNode: JSIdenticalNode): boolean;
}