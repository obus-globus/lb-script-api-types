...
export class GlobalBuiltinsFactory$JSGlobalPrintNodeGen extends GlobalBuiltins$JSGlobalPrintNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramuseErr: boolean, paramnoNewline: boolean, paramarguments: (Object | null)[]): GlobalBuiltins$JSGlobalPrintNode;
