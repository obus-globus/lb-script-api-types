...
export abstract class ConstructorBuiltins$ConstructTemporalPlainYearMonth extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    constructTemporalPlainYearMonth(newTarget: JSDynamicObject, isoYear: Object, isoMonth: Object, calendarLike: Object, refISODay: Object, errorBranch: InlinedBranchProfile, toInteger: JSToIntegerWithTruncationNode, toJavaString: TruffleString$ToJavaStringNode, fromJavaString: TruffleString$FromJavaStringNode): JSDynamicObject;
