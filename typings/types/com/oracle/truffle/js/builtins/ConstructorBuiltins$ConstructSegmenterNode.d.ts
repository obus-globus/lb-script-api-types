...
export abstract class ConstructorBuiltins$ConstructSegmenterNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    // private initializeSegmenterNode: InitializeSegmenterNode;
    constructSegmenter(newTarget: JSDynamicObject, locales: Object, options: Object): JSSegmenterObject;
