...
export class TypedArrayPrototypeBuiltinsFactory$GetTypedArrayLengthOrOffsetNodeGen extends TypedArrayPrototypeBuiltins$GetTypedArrayLengthOrOffsetNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramgetter: TypedArrayPrototypeBuiltins$TypedArrayPrototype, paramarguments: (Object | null)[]): TypedArrayPrototypeBuiltins$GetTypedArrayLengthOrOffsetNode;
