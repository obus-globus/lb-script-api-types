...
export class TypedArrayPrototypeBuiltinsFactory$GetTypedArrayLengthOrOffsetNodeGen extends TypedArrayPrototypeBuiltins$GetTypedArrayLengthOrOffsetNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramgetter: TypedArrayPrototypeBuiltins$TypedArrayPrototype, paramarguments: JavaScriptNode[]): TypedArrayPrototypeBuiltins$GetTypedArrayLengthOrOffsetNode;
