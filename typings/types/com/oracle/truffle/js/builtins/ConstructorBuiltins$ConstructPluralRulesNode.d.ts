...
export abstract class ConstructorBuiltins$ConstructPluralRulesNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    // private initializePluralRulesNode: InitializePluralRulesNode;
    constructPluralRules(newTarget: JSDynamicObject, locales: Object, options: Object): JSPluralRulesObject;
