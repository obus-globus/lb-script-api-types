...
export abstract class IteratorFunctionBuiltins$IteratorZipNode extends IteratorFunctionBuiltins$IteratorZipMethodNode {
    ...
    iteratorZip(iterables: Object, options: Object, node: Node, isObjectNode: IsObjectNode, getOptionsObjectNode: GetOptionsObjectNode, getModeNode: PropertyGetNode, getPaddingNode: PropertyGetNode, getIteratorNode: GetIteratorNode, getIteratorFlattenableNode: GetIteratorFlattenableNode, iteratorStepNode: IteratorStepNode, iteratorValueNode: IteratorValueNode, iteratorCloseNode: IteratorCloseNode, equalNode: TruffleString$EqualNode, errorBranch: InlinedBranchProfile, growBranch: InlinedBranchProfile): JSIteratorHelperObject;
}