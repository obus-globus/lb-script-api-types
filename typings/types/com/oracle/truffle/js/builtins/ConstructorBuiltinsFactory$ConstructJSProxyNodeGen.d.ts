...
export class ConstructorBuiltinsFactory$ConstructJSProxyNodeGen extends ConstructorBuiltins$ConstructJSProxyNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructJSProxyNode;
