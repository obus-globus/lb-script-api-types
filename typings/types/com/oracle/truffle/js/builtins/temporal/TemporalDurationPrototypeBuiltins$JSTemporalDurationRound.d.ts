...
export abstract class TemporalDurationPrototypeBuiltins$JSTemporalDurationRound extends JSTemporalBuiltinOperation {
    ...
    round(duration: JSTemporalDurationObject, roundToParam: Object, node: Node, equalNode: TruffleString$EqualNode, roundToIsTString: InlinedConditionProfile, relativeToIsZonedDateTime: InlinedConditionProfile, toRelativeTemporalObjectNode: ToRelativeTemporalObjectNode, getOptionNode: TemporalGetOptionNode, getLargestUnit: GetTemporalUnitNode, getSmallestUnit: GetTemporalUnitNode, getRoundingIncrementOption: GetRoundingIncrementOptionNode, addDate: TemporalAddDateNode, differencePlainDateTimeWithRounding: DifferencePlainDateTimeWithRoundingNode, differenceZonedDateTimeWithRounding: DifferenceZonedDateTimeWithRoundingNode, addZonedDateTimeNode: TemporalAddZonedDateTimeNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalDurationObject;
}