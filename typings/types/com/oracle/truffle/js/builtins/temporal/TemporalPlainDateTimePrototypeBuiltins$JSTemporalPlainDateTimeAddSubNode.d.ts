...
export abstract class TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeAddSubNode extends JSTemporalBuiltinOperation {
    ...
    // private sign: number;
    addDurationToOrSubtractDurationFromPlainDateTime(dateTime: JSTemporalPlainDateTimeObject, temporalDurationLike: Object, options: Object, toTemporalDurationNode: ToTemporalDurationNode, getOptionNode: TemporalGetOptionNode, addDateTime: TemporalAddDateTimeNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalPlainDateTimeObject;
}