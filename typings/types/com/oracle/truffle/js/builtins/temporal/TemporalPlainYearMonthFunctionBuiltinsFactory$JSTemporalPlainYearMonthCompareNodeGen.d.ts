...
import type { TemporalPlainYearMonthFunctionBuiltins$JSTemporalPlainYearMonthCompareNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainYearMonthFunctionBuiltins$JSTemporalPlainYearMonthCompareNode.d.ts'
...
export class TemporalPlainYearMonthFunctionBuiltinsFactory$JSTemporalPlainYearMonthCompareNodeGen extends TemporalPlainYearMonthFunctionBuiltins$JSTemporalPlainYearMonthCompareNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainYearMonthFunctionBuiltins$JSTemporalPlainYearMonthCompareNode;
