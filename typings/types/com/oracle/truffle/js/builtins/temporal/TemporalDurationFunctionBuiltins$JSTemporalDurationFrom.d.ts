...
export abstract class TemporalDurationFunctionBuiltins$JSTemporalDurationFrom extends JSTemporalBuiltinOperation {
    ...
    from(item: Object, toTemporalDurationNode: ToTemporalDurationNode, errorBranch: InlinedBranchProfile): JSTemporalDurationObject;
}