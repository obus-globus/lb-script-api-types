...
import type { TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateWith } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateWith.d.ts'
...
export class TemporalPlainDatePrototypeBuiltinsFactory$JSTemporalPlainDateWithNodeGen extends TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateWith {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateWith;
