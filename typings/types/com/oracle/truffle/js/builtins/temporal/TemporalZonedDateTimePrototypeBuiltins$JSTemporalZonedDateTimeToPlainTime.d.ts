...
export abstract class TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeToPlainTime extends JSTemporalBuiltinOperation {
    ...
    toPlainTime(zdt: JSTemporalZonedDateTimeObject, errorBranch: InlinedBranchProfile): Object;
}