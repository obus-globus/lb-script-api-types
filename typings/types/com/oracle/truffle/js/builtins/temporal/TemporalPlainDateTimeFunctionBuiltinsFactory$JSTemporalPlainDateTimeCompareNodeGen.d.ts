...
import type { TemporalPlainDateTimeFunctionBuiltins$JSTemporalPlainDateTimeCompareNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainDateTimeFunctionBuiltins$JSTemporalPlainDateTimeCompareNode.d.ts'
...
export class TemporalPlainDateTimeFunctionBuiltinsFactory$JSTemporalPlainDateTimeCompareNodeGen extends TemporalPlainDateTimeFunctionBuiltins$JSTemporalPlainDateTimeCompareNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainDateTimeFunctionBuiltins$JSTemporalPlainDateTimeCompareNode;
