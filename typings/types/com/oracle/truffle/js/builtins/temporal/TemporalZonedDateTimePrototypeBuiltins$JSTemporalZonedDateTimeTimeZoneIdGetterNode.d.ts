...
export abstract class TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeTimeZoneIdGetterNode extends JSBuiltinNode {
    ...
    timeZoneId(zonedDateTime: JSTemporalZonedDateTimeObject, toTimeZoneIdentifier: ToTemporalTimeZoneIdentifierNode): TruffleString;
}