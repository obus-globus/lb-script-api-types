...
import type { TemporalDurationFunctionBuiltins$JSTemporalDurationCompare } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalDurationFunctionBuiltins$JSTemporalDurationCompare.d.ts'
...
export class TemporalDurationFunctionBuiltinsFactory$JSTemporalDurationCompareNodeGen extends TemporalDurationFunctionBuiltins$JSTemporalDurationCompare {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalDurationFunctionBuiltins$JSTemporalDurationCompare;
    ...
    // private addZonedDateTimeNode_: TemporalAddZonedDateTimeNode;
    // private arguments0_: JavaScriptNode;
    // private arguments1_: JavaScriptNode;
    // private arguments2_: JavaScriptNode;
    // private state_0_: number;
    // private toRelativeTemporalObjectNode_: ToRelativeTemporalObjectNode;
    // private toTemporalDurationNode_: ToTemporalDurationNode;
    // private unbalanceDurationRelativeNode_: TemporalUnbalanceDateDurationRelativeNode;
    execute(frameValue: VirtualFrame): Object;
    // private executeAndSpecialize(arguments0Value: Object, arguments1Value: Object, arguments2Value: Object): number;
