...
export abstract class TemporalInstantPrototypeBuiltins$JSTemporalInstantAddSubNode extends JSTemporalBuiltinOperation {
    ...
    // private sign: number;
    addDurationToOrSubtractDurationFromInstant(instant: JSTemporalInstantObject, temporalDurationLike: Object, toTemporalDurationNode: ToTemporalDurationNode, errorBranch: InlinedBranchProfile): JSTemporalInstantObject;
}