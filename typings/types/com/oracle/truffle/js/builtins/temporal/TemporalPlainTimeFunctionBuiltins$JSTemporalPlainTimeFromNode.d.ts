...
export abstract class TemporalPlainTimeFunctionBuiltins$JSTemporalPlainTimeFromNode extends JSTemporalBuiltinOperation {
    ...
    from(item: Object, options: Object, toTemporalTime: ToTemporalTimeNode): JSTemporalPlainTimeObject;
}