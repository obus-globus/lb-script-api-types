...
export abstract class TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateToZonedDateTimeNode extends JSTemporalBuiltinOperation {
    ...
    toZonedDateTime(td: JSTemporalPlainDateObject, item: Object, timeZoneIsUndefined: InlinedConditionProfile, timeIsUndefined: InlinedConditionProfile, toTemporalTime: ToTemporalTimeNode, toTimeZoneIdentifierNode: ToTemporalTimeZoneIdentifierNode, errorBranch: InlinedBranchProfile): JSTemporalZonedDateTimeObject;
}