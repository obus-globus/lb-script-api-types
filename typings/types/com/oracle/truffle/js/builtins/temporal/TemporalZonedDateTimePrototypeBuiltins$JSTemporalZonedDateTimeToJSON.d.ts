...
export abstract class TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeToJSON extends JSTemporalBuiltinOperation {
    ...
    toJSON(zonedDateTime: JSTemporalZonedDateTimeObject): TruffleString;
}