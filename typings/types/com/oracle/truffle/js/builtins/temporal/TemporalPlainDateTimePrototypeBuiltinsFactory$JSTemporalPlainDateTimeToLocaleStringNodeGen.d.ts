...
import type { TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeToLocaleString } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeToLocaleString.d.ts'
...
export class TemporalPlainDateTimePrototypeBuiltinsFactory$JSTemporalPlainDateTimeToLocaleStringNodeGen extends TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeToLocaleString {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeToLocaleString;
