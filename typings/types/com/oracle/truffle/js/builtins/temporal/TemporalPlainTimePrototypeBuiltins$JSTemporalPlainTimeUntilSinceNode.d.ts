...
export abstract class TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeUntilSinceNode extends JSTemporalBuiltinOperation {
    ...
    // private sign: number;
    differenceTemporalPlainTime(temporalTime: JSTemporalPlainTimeObject, otherObj: Object, options: Object, toTemporalTime: ToTemporalTimeNode, getDifferenceSettings: GetDifferenceSettingsNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalDurationObject;
}