...
import type { TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeWith } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeWith.d.ts'
...
export class TemporalPlainTimePrototypeBuiltinsFactory$JSTemporalPlainTimeWithNodeGen extends TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeWith {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeWith;
    ...
    // private with_toInt_: JSToIntegerAsIntNode;
    // private with_toIntegerWithTruncation_: JSToIntegerWithTruncationNode;
    execute(frameValue: VirtualFrame): Object;
    // private executeAndSpecialize(arguments0Value: Object, arguments1Value: Object, arguments2Value: Object): JSTemporalPlainTimeObject;
