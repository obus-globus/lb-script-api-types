...
export abstract class TemporalPlainYearMonthFunctionBuiltins$JSTemporalPlainYearMonthCompareNode extends JSTemporalBuiltinOperation {
    ...
    compare(one: Object, two: Object, toTemporalYearMonthNode: ToTemporalYearMonthNode): number;
}