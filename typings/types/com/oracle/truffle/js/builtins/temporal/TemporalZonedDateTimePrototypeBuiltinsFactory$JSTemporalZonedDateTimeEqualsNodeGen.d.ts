...
import type { TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeEquals } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeEquals.d.ts'
...
export class TemporalZonedDateTimePrototypeBuiltinsFactory$JSTemporalZonedDateTimeEqualsNodeGen extends TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeEquals {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeEquals;
    ...
    // private equals_toCalendarIdentifier_: ToTemporalCalendarIdentifierNode;
    // private equals_toTemporalZonedDateTime_: ToTemporalZonedDateTimeNode;
    // private equals_toTimeZoneIdentifier_: ToTemporalTimeZoneIdentifierNode;
