...
export abstract class TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeToInstant extends JSTemporalBuiltinOperation {
    ...
    toInstant(zonedDateTime: JSTemporalZonedDateTimeObject): Object;
}