...
import type { TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayToLocaleString } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayToLocaleString.d.ts'
...
export class TemporalPlainMonthDayPrototypeBuiltinsFactory$JSTemporalPlainMonthDayToLocaleStringNodeGen extends TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayToLocaleString {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayToLocaleString;
