...
export abstract class TemporalInstantPrototypeBuiltins$JSTemporalInstantUntilSinceNode extends JSTemporalBuiltinOperation {
    ...
    // private sign: number;
    differenceTemporalInstant(instant: JSTemporalInstantObject, otherObj: Object, options: Object, toTemporalInstantNode: ToTemporalInstantNode, getDifferenceSettings: GetDifferenceSettingsNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalDurationObject;
}