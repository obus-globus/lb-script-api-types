...
import type { TemporalInstantPrototypeBuiltins$JSTemporalInstantRound } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalInstantPrototypeBuiltins$JSTemporalInstantRound.d.ts'
...
export class TemporalInstantPrototypeBuiltinsFactory$JSTemporalInstantRoundNodeGen extends TemporalInstantPrototypeBuiltins$JSTemporalInstantRound {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalInstantPrototypeBuiltins$JSTemporalInstantRound;
