...
import type { TemporalInstantPrototypeBuiltins$JSTemporalInstantToString } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalInstantPrototypeBuiltins$JSTemporalInstantToString.d.ts'
...
export class TemporalInstantPrototypeBuiltinsFactory$JSTemporalInstantToStringNodeGen extends TemporalInstantPrototypeBuiltins$JSTemporalInstantToString {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalInstantPrototypeBuiltins$JSTemporalInstantToString;
