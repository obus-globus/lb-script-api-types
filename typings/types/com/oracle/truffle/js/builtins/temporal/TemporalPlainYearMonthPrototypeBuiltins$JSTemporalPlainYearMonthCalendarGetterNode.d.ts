...
export abstract class TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthCalendarGetterNode extends JSBuiltinNode {
    ...
    calendarId(yearMonth: JSTemporalPlainYearMonthObject, toCalendarIdentifier: ToTemporalCalendarIdentifierNode): TruffleString;
}