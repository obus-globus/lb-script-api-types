...
export abstract class TemporalInstantPrototypeBuiltins$JSTemporalInstantRound extends JSTemporalBuiltinOperation {
    ...
    round(instant: JSTemporalInstantObject, roundToParam: Object, equalNode: TruffleString$EqualNode, getOptionNode: TemporalGetOptionNode, getSmallestUnit: GetTemporalUnitNode, getRoundingIncrementOption: GetRoundingIncrementOptionNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalInstantObject;
}