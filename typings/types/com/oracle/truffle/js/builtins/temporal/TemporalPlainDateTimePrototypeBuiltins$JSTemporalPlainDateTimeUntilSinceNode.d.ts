...
export abstract class TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeUntilSinceNode extends JSTemporalBuiltinOperation {
    ...
    // private sign: number;
    differenceTemporalPlainDateTime(dateTime: JSTemporalPlainDateTimeObject, otherObj: Object, options: Object, node: Node, toTemporalDateTime: ToTemporalDateTimeNode, toCalendarIdentifier: ToTemporalCalendarIdentifierNode, differencePlainDateTimeWithRounding: DifferencePlainDateTimeWithRoundingNode, getDifferenceSettings: GetDifferenceSettingsNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalDurationObject;
}