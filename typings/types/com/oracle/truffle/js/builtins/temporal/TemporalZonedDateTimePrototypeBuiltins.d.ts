...
export class TemporalZonedDateTimePrototypeBuiltins extends JSBuiltinsContainer$SwitchEnum<TemporalZonedDateTimePrototypeBuiltins$TemporalZonedDateTimePrototype> {
    ...
    constructor()
    createNode(context: JSContext, builtin: JSBuiltin, construct: boolean, newTarget: boolean, builtinEnum: TemporalZonedDateTimePrototypeBuiltins$TemporalZonedDateTimePrototype): Object;
}