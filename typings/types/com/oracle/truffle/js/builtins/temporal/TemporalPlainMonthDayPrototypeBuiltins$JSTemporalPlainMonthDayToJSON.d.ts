...
export abstract class TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayToJSON extends JSTemporalBuiltinOperation {
    ...
    toJSON(thisMonthDay: JSTemporalPlainMonthDayObject): TruffleString;
}