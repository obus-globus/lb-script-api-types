...
export abstract class TemporalNowBuiltins$TemporalNowPlainTimeISONode extends JSBuiltinNode {
    ...
    plainTimeISO(temporalTimeZoneLike: Object, toTemporalIdentifier: ToTemporalTimeZoneIdentifierNode, errorBranch: InlinedBranchProfile): JSTemporalPlainTimeObject;
}