...
export class TemporalZonedDateTimePrototypeBuiltinsFactory$JSTemporalZonedDateTimeGetterNodeGen extends TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeGetterNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramproperty: TemporalZonedDateTimePrototypeBuiltins$TemporalZonedDateTimePrototype, paramarguments: JavaScriptNode[]): TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeGetterNode;
