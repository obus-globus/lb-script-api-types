...
export abstract class TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeCalendarGetterNode extends JSBuiltinNode {
    ...
    calendarId(zonedDateTime: JSTemporalZonedDateTimeObject, toCalendarIdentifier: ToTemporalCalendarIdentifierNode): TruffleString;
}