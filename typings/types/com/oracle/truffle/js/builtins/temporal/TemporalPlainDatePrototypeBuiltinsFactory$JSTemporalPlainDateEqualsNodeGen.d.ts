...
import type { TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateEquals } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateEquals.d.ts'
...
export class TemporalPlainDatePrototypeBuiltinsFactory$JSTemporalPlainDateEqualsNodeGen extends TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateEquals {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateEquals;
    ...
    // private equals_toTemporalDate_: ToTemporalDateNode;
