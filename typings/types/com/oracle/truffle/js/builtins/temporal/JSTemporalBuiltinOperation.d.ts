...
export abstract class JSTemporalBuiltinOperation extends JSBuiltinNode {
    ...
    getOptionsObject(options: Object, node: Node, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSDynamicObject;
