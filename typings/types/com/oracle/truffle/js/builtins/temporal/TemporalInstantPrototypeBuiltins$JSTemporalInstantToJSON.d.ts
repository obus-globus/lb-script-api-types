...
export abstract class TemporalInstantPrototypeBuiltins$JSTemporalInstantToJSON extends JSTemporalBuiltinOperation {
    ...
    toJSON(instant: JSTemporalInstantObject): TruffleString;
}