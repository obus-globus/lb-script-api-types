...
export abstract class TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateWith extends JSTemporalBuiltinOperation {
    ...
    with(temporalDate: JSTemporalPlainDateObject, temporalDateLike: Object, options: Object, isPartialTemporalObjectNode: IsPartialTemporalObjectNode, getOptionNode: TemporalGetOptionNode, dateFromFieldsNode: TemporalCalendarDateFromFieldsNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalPlainDateObject;
}