...
export class TemporalPlainTimePrototypeBuiltinsFactory$JSTemporalPlainTimeAddSubNodeGen extends TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeAddSubNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramsign: number, paramarguments: (Object | null)[]): TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeAddSubNode;
