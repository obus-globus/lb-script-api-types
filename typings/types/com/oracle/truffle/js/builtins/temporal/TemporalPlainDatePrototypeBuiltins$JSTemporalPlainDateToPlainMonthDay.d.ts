...
export abstract class TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateToPlainMonthDay extends JSTemporalBuiltinOperation {
    ...
    toPlainMonthDay(temporalDate: JSTemporalPlainDateObject, monthDayFromFieldsNode: TemporalMonthDayFromFieldsNode): JSTemporalPlainMonthDayObject;
}