...
export abstract class TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeToPlainTimeNode extends JSTemporalBuiltinOperation {
    ...
    toPlainTime(dt: JSTemporalPlainDateTimeObject, errorBranch: InlinedBranchProfile): JSTemporalPlainTimeObject;
}