...
export abstract class TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeStartOfDay extends JSTemporalBuiltinOperation {
    ...
    startOfDay(zonedDateTime: JSTemporalZonedDateTimeObject, errorBranch: InlinedBranchProfile): Object;
}