...
export abstract class TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeWith extends JSTemporalBuiltinOperation {
    ...
    with(temporalTime: JSTemporalPlainTimeObject, temporalTimeLike: Object, options: Object, isPartialTemporalObjectNode: IsPartialTemporalObjectNode, toIntegerWithTruncation: JSToIntegerWithTruncationNode, toInt: JSToIntegerAsIntNode, getOptionNode: TemporalGetOptionNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalPlainTimeObject;
}