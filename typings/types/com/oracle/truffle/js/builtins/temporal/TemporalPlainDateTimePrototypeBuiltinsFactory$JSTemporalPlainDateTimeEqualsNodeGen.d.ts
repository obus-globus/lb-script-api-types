...
import type { TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeEquals } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeEquals.d.ts'
...
export class TemporalPlainDateTimePrototypeBuiltinsFactory$JSTemporalPlainDateTimeEqualsNodeGen extends TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeEquals {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeEquals;
    ...
    // private equalsGeneric_toTemporalDateTime_: ToTemporalDateTimeNode;
    // private state_0_: number;
    // private toCalendarIdentifier: ToTemporalCalendarIdentifierNode;
