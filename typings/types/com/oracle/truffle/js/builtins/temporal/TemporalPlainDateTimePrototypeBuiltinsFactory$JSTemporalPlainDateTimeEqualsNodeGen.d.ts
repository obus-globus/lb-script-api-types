...
export class TemporalPlainDateTimePrototypeBuiltinsFactory$JSTemporalPlainDateTimeEqualsNodeGen extends TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeEquals {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: (Object | null)[]): TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeEquals;
