...
import type { TemporalInstantPrototypeBuiltins$JSTemporalInstantToLocaleString } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalInstantPrototypeBuiltins$JSTemporalInstantToLocaleString.d.ts'
...
export class TemporalInstantPrototypeBuiltinsFactory$JSTemporalInstantToLocaleStringNodeGen extends TemporalInstantPrototypeBuiltins$JSTemporalInstantToLocaleString {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalInstantPrototypeBuiltins$JSTemporalInstantToLocaleString;
