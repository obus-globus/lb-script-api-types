...
export abstract class TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthUntilSinceNode extends JSTemporalBuiltinOperation {
    ...
    // private sign: number;
    differenceTemporalPlainYearMonth(yearMonth: JSTemporalPlainYearMonthObject, otherParam: Object, options: Object, node: Node, toCalendarIdentifier: ToTemporalCalendarIdentifierNode, getDifferenceSettings: GetDifferenceSettingsNode, roundRelativeDuration: RoundRelativeDurationNode, toTemporalYearMonthNode: ToTemporalYearMonthNode, dateFromFieldsNode: TemporalCalendarDateFromFieldsNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalDurationObject;
}