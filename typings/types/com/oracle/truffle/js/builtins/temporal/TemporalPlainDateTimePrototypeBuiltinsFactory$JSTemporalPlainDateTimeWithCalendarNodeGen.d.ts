...
import type { TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeWithCalendarNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeWithCalendarNode.d.ts'
...
export class TemporalPlainDateTimePrototypeBuiltinsFactory$JSTemporalPlainDateTimeWithCalendarNodeGen extends TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeWithCalendarNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeWithCalendarNode;
