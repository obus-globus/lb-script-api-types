...
import type { TemporalDurationPrototypeBuiltins$JSTemporalDurationRound } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalDurationPrototypeBuiltins$JSTemporalDurationRound.d.ts'
...
export class TemporalDurationPrototypeBuiltinsFactory$JSTemporalDurationRoundNodeGen extends TemporalDurationPrototypeBuiltins$JSTemporalDurationRound {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalDurationPrototypeBuiltins$JSTemporalDurationRound;
    ...
    // private round_addDate_: TemporalAddDateNode;
    // private round_addZonedDateTimeNode_: TemporalAddZonedDateTimeNode;
