...
import type { TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeEquals } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeEquals.d.ts'
...
export class TemporalPlainTimePrototypeBuiltinsFactory$JSTemporalPlainTimeEqualsNodeGen extends TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeEquals {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeEquals;
    ...
    // private equalsGeneric_toTemporalTime_: ToTemporalTimeNode;
