...
import type { TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeRound } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeRound.d.ts'
...
export class TemporalZonedDateTimePrototypeBuiltinsFactory$JSTemporalZonedDateTimeRoundNodeGen extends TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeRound {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeRound;
