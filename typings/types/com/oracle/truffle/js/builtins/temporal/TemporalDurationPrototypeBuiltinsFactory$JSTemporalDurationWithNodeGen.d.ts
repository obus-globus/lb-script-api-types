...
import type { TemporalDurationPrototypeBuiltins$JSTemporalDurationWith } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalDurationPrototypeBuiltins$JSTemporalDurationWith.d.ts'
...
export class TemporalDurationPrototypeBuiltinsFactory$JSTemporalDurationWithNodeGen extends TemporalDurationPrototypeBuiltins$JSTemporalDurationWith {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalDurationPrototypeBuiltins$JSTemporalDurationWith;
    ...
    // private with_toTemporalPartialDurationRecord_: ToTemporalPartialDurationRecordNode;
