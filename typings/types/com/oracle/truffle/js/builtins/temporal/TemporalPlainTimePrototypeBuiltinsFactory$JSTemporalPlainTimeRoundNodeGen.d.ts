...
import type { TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeRound } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeRound.d.ts'
...
export class TemporalPlainTimePrototypeBuiltinsFactory$JSTemporalPlainTimeRoundNodeGen extends TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeRound {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeRound;
