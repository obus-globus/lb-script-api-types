...
import type { TemporalInstantPrototypeBuiltins$JSTemporalInstantUntilSinceNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalInstantPrototypeBuiltins$JSTemporalInstantUntilSinceNode.d.ts'
...
export class TemporalInstantPrototypeBuiltinsFactory$JSTemporalInstantUntilSinceNodeGen extends TemporalInstantPrototypeBuiltins$JSTemporalInstantUntilSinceNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramsign: number, paramarguments: JavaScriptNode[]): TemporalInstantPrototypeBuiltins$JSTemporalInstantUntilSinceNode;
    ...
    // private differenceTemporalInstant_getDifferenceSettings_: GetDifferenceSettingsNode;
    // private differenceTemporalInstant_toTemporalInstantNode_: ToTemporalInstantNode;
