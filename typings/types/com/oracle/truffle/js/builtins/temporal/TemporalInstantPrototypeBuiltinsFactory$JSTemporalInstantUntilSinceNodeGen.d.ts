...
export class TemporalInstantPrototypeBuiltinsFactory$JSTemporalInstantUntilSinceNodeGen extends TemporalInstantPrototypeBuiltins$JSTemporalInstantUntilSinceNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramsign: number, paramarguments: (Object | null)[]): TemporalInstantPrototypeBuiltins$JSTemporalInstantUntilSinceNode;
