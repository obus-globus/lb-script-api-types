...
export abstract class TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeAddSubNode extends JSTemporalBuiltinOperation {
    ...
    // private sign: number;
    addDurationToOrSubtractDurationFromZonedDateTime(zonedDateTime: JSTemporalZonedDateTimeObject, temporalDurationLike: Object, optionsParam: Object, toTemporalDurationNode: ToTemporalDurationNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile, addZonedDateTimeNode: TemporalAddZonedDateTimeNode): JSTemporalZonedDateTimeObject;
}