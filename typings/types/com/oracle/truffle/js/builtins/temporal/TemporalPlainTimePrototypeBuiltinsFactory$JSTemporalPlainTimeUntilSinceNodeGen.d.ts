...
import type { TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeUntilSinceNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeUntilSinceNode.d.ts'
...
export class TemporalPlainTimePrototypeBuiltinsFactory$JSTemporalPlainTimeUntilSinceNodeGen extends TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeUntilSinceNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramsign: number, paramarguments: JavaScriptNode[]): TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeUntilSinceNode;
    ...
    // private differenceTemporalPlainTime_getDifferenceSettings_: GetDifferenceSettingsNode;
    // private differenceTemporalPlainTime_toTemporalTime_: ToTemporalTimeNode;
