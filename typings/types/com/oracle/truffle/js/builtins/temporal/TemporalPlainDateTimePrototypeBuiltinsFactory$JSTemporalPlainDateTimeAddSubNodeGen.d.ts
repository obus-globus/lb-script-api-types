...
export class TemporalPlainDateTimePrototypeBuiltinsFactory$JSTemporalPlainDateTimeAddSubNodeGen extends TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeAddSubNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramsign: number, paramarguments: JavaScriptNode[]): TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeAddSubNode;
