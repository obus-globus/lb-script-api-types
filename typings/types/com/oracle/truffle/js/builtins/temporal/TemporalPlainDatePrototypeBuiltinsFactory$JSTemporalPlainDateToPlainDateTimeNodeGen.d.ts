...
import type { TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateToPlainDateTime } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateToPlainDateTime.d.ts'
...
export class TemporalPlainDatePrototypeBuiltinsFactory$JSTemporalPlainDateToPlainDateTimeNodeGen extends TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateToPlainDateTime {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateToPlainDateTime;
    ...
    // private toPlainDateTime_toTemporalTime_: ToTemporalTimeNode;
