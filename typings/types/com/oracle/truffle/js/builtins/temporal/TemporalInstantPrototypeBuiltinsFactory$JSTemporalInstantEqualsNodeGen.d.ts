...
import type { TemporalInstantPrototypeBuiltins$JSTemporalInstantEquals } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalInstantPrototypeBuiltins$JSTemporalInstantEquals.d.ts'
...
export class TemporalInstantPrototypeBuiltinsFactory$JSTemporalInstantEqualsNodeGen extends TemporalInstantPrototypeBuiltins$JSTemporalInstantEquals {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalInstantPrototypeBuiltins$JSTemporalInstantEquals;
    ...
    // private equals_toTemporalInstantNode_: ToTemporalInstantNode;
