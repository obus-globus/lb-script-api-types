...
import type { TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayWithNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayWithNode.d.ts'
...
export class TemporalPlainMonthDayPrototypeBuiltinsFactory$JSTemporalPlainMonthDayWithNodeGen extends TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayWithNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayWithNode;
    ...
    // private with_monthDayFromFieldsNode_: TemporalMonthDayFromFieldsNode;
