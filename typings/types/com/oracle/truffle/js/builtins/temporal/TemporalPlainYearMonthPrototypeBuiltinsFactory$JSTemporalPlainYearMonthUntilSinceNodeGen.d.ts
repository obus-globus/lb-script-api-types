...
import type { TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthUntilSinceNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthUntilSinceNode.d.ts'
...
export class TemporalPlainYearMonthPrototypeBuiltinsFactory$JSTemporalPlainYearMonthUntilSinceNodeGen extends TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthUntilSinceNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramsign: number, paramarguments: JavaScriptNode[]): TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthUntilSinceNode;
    ...
    // private differenceTemporalPlainYearMonth_dateFromFieldsNode_: TemporalCalendarDateFromFieldsNode;
    // private differenceTemporalPlainYearMonth_getDifferenceSettings_: GetDifferenceSettingsNode;
    // private differenceTemporalPlainYearMonth_roundRelativeDuration_: RoundRelativeDurationNode;
    // private differenceTemporalPlainYearMonth_toCalendarIdentifier_: ToTemporalCalendarIdentifierNode;
    // private differenceTemporalPlainYearMonth_toTemporalYearMonthNode_: ToTemporalYearMonthNode;
