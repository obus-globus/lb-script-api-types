...
export abstract class TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeToPlainDateTime extends JSTemporalBuiltinOperation {
    ...
    toPlainDateTime(zdt: JSTemporalZonedDateTimeObject): Object;
}