...
export abstract class TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthToJSON extends JSTemporalBuiltinOperation {
    ...
    toJSON(yearMonth: JSTemporalPlainYearMonthObject): TruffleString;
}