...
export abstract class TemporalPlainDateFunctionBuiltins$JSTemporalPlainDateFromNode extends JSTemporalBuiltinOperation {
    ...
    from(item: Object, options: Object, toTemporalDate: ToTemporalDateNode): JSTemporalPlainDateObject;
}