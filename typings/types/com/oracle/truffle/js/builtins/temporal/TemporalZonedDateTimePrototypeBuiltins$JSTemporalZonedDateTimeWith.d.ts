...
export abstract class TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeWith extends JSTemporalBuiltinOperation {
    ...
    with(zonedDateTime: JSTemporalZonedDateTimeObject, temporalZonedDateTimeLike: Object, options: Object, node: Node, isPartialTemporalObjectNode: IsPartialTemporalObjectNode, getOptionNode: TemporalGetOptionNode, equalNode: TruffleString$EqualNode, createHourDataPropertyNode: CreateDataPropertyNode, createMinuteDataPropertyNode: CreateDataPropertyNode, createSecondDataPropertyNode: CreateDataPropertyNode, createMillisecondDataPropertyNode: CreateDataPropertyNode, createMicrosecondDataPropertyNode: CreateDataPropertyNode, createNanosecondDataPropertyNode: CreateDataPropertyNode, createOffsetDataPropertyNode: CreateDataPropertyNode, dateFromFieldsNode: TemporalCalendarDateFromFieldsNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): Object;
}