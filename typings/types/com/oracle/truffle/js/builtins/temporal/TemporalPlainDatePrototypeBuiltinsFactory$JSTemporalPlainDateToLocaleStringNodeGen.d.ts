...
import type { TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateToLocaleString } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateToLocaleString.d.ts'
...
export class TemporalPlainDatePrototypeBuiltinsFactory$JSTemporalPlainDateToLocaleStringNodeGen extends TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateToLocaleString {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateToLocaleString;
