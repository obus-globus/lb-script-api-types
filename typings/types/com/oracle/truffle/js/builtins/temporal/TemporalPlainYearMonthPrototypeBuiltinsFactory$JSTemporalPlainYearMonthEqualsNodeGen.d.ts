...
import type { TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthEqualsNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthEqualsNode.d.ts'
...
export class TemporalPlainYearMonthPrototypeBuiltinsFactory$JSTemporalPlainYearMonthEqualsNodeGen extends TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthEqualsNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthEqualsNode;
    ...
    // private equals_toTemporalYearMonthNode_: ToTemporalYearMonthNode;
