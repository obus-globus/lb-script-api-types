...
export abstract class TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeToString extends JSTemporalBuiltinOperation {
    ...
    toString(): string;
    toString(dt: JSTemporalPlainDateTimeObject, optionsParam: Object, equalNode: TruffleString$EqualNode, getOptionNode: TemporalGetOptionNode, toFractionalSecondDigitsNode: ToFractionalSecondDigitsNode, getSmallestUnit: GetTemporalUnitValuedOptionNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): TruffleString;
}