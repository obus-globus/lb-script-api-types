...
import type { TemporalDurationFunctionBuiltins$JSTemporalDurationFrom } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalDurationFunctionBuiltins$JSTemporalDurationFrom.d.ts'
...
export class TemporalDurationFunctionBuiltinsFactory$JSTemporalDurationFromNodeGen extends TemporalDurationFunctionBuiltins$JSTemporalDurationFrom {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalDurationFunctionBuiltins$JSTemporalDurationFrom;
    ...
    // private executeAndSpecialize(arguments0Value: Object): JSTemporalDurationObject;
