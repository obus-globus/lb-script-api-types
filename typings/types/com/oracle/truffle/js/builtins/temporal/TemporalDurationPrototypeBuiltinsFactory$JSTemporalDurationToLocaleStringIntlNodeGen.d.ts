...
import type { TemporalDurationPrototypeBuiltins$JSTemporalDurationToLocaleStringIntl } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalDurationPrototypeBuiltins$JSTemporalDurationToLocaleStringIntl.d.ts'
...
export class TemporalDurationPrototypeBuiltinsFactory$JSTemporalDurationToLocaleStringIntlNodeGen extends TemporalDurationPrototypeBuiltins$JSTemporalDurationToLocaleStringIntl {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalDurationPrototypeBuiltins$JSTemporalDurationToLocaleStringIntl;
    ...
    // private toString_fromJavaString_: TruffleString$FromJavaStringNode;
    // private toString_initializeDurationFormatNode_: InitializeDurationFormatNode;
    // private toString_toTemporalDurationRecord_: ToTemporalDurationRecordNode;
