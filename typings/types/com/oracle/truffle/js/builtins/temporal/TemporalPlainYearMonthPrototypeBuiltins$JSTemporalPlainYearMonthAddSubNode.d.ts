...
export abstract class TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthAddSubNode extends JSTemporalBuiltinOperation {
    ...
    constructor(context: JSContext, builtin: JSBuiltin, operation: number)
    // private operation: number;
    addDurationToOrSubtractDurationFromPlainYearMonth(yearMonth: JSTemporalPlainYearMonthObject, temporalDurationLike: Object, options: Object, node: Node, toTemporalDurationNode: ToTemporalDurationNode, getOptionNode: TemporalGetOptionNode, addDateNode: TemporalAddDateNode, yearMonthFromFieldsNode: TemporalYearMonthFromFieldsNode, dateFromFieldsNode: TemporalCalendarDateFromFieldsNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalPlainYearMonthObject;
}