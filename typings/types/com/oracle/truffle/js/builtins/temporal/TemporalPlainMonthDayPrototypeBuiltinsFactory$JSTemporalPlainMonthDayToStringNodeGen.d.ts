...
import type { TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayToString } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayToString.d.ts'
...
export class TemporalPlainMonthDayPrototypeBuiltinsFactory$JSTemporalPlainMonthDayToStringNodeGen extends TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayToString {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayToString;
