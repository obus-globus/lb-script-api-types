...
export class TemporalPlainMonthDayPrototypeBuiltinsFactory$JSTemporalPlainMonthDayToStringNodeGen extends TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayToString {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: (Object | null)[]): TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayToString;
