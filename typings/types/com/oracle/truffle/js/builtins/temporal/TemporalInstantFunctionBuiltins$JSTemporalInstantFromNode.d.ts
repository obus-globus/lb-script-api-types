...
export abstract class TemporalInstantFunctionBuiltins$JSTemporalInstantFromNode extends JSBuiltinNode {
    ...
    from(item: Object, toTemporalInstantNode: ToTemporalInstantNode): JSTemporalInstantObject;
}