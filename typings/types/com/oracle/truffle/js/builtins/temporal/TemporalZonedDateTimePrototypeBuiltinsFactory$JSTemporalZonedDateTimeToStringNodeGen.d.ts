...
import type { TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeToString } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeToString.d.ts'
...
export class TemporalZonedDateTimePrototypeBuiltinsFactory$JSTemporalZonedDateTimeToStringNodeGen extends TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeToString {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalZonedDateTimePrototypeBuiltins$JSTemporalZonedDateTimeToString;
