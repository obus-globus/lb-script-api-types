...
export abstract class TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeEquals extends JSTemporalBuiltinOperation {
    ...
    equalsGeneric(thisDateTime: JSTemporalPlainDateTimeObject, other: Object, toTemporalDateTime: ToTemporalDateTimeNode, toCalendarIdentifier: ToTemporalCalendarIdentifierNode): boolean;
    equalsOtherObj(thisDateTime: JSTemporalPlainDateTimeObject, otherDateTime: JSTemporalPlainDateTimeObject, toCalendarIdentifier: ToTemporalCalendarIdentifierNode): boolean;
}