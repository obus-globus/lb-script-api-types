...
import type { TemporalPlainDateFunctionBuiltins$JSTemporalPlainDateCompareNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainDateFunctionBuiltins$JSTemporalPlainDateCompareNode.d.ts'
...
export class TemporalPlainDateFunctionBuiltinsFactory$JSTemporalPlainDateCompareNodeGen extends TemporalPlainDateFunctionBuiltins$JSTemporalPlainDateCompareNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainDateFunctionBuiltins$JSTemporalPlainDateCompareNode;
