...
import type { TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthToString } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthToString.d.ts'
...
export class TemporalPlainYearMonthPrototypeBuiltinsFactory$JSTemporalPlainYearMonthToStringNodeGen extends TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthToString {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthToString;
