...
export abstract class TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeRoundNode extends JSTemporalBuiltinOperation {
    ...
    round(dt: JSTemporalPlainDateTimeObject, roundToParam: Object, equalNode: TruffleString$EqualNode, getOptionNode: TemporalGetOptionNode, getSmallestUnit: GetTemporalUnitValuedOptionNode, getRoundingIncrementOption: GetRoundingIncrementOptionNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalPlainDateTimeObject;
}