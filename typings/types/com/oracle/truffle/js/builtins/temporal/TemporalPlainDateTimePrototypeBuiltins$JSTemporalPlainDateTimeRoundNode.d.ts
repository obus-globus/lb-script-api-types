...
export abstract class TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeRoundNode extends JSTemporalBuiltinOperation {
    ...
    round(dt: JSTemporalPlainDateTimeObject, roundToParam: Object, equalNode: TruffleString$EqualNode, getOptionNode: TemporalGetOptionNode, getSmallestUnit: GetTemporalUnitNode, getRoundingIncrementOption: GetRoundingIncrementOptionNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalPlainDateTimeObject;
}