...
export class TemporalInstantPrototypeBuiltinsFactory$JSTemporalInstantAddSubNodeGen extends TemporalInstantPrototypeBuiltins$JSTemporalInstantAddSubNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramsign: number, paramarguments: (Object | null)[]): TemporalInstantPrototypeBuiltins$JSTemporalInstantAddSubNode;
