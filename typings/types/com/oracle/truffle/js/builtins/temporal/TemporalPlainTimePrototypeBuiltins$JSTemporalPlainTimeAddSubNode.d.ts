...
export abstract class TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeAddSubNode extends JSTemporalBuiltinOperation {
    ...
    // private sign: number;
    addDurationToOrSubtractDurationFromPlainTime(temporalTime: JSTemporalPlainTimeObject, temporalDurationLike: Object, toTemporalDurationNode: ToTemporalDurationNode, errorBranch: InlinedBranchProfile): JSTemporalPlainTimeObject;
}