...
export abstract class TemporalNowBuiltins$TemporalNowPlainDateISONode extends JSBuiltinNode {
    ...
    plainDateISO(temporalTimeZoneLike: Object, toTemporalIdentifier: ToTemporalTimeZoneIdentifierNode, errorBranch: InlinedBranchProfile): JSTemporalPlainDateObject;
}