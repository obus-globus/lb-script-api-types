...
export abstract class TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeRound extends JSTemporalBuiltinOperation {
    ...
    round(temporalTime: JSTemporalPlainTimeObject, roundToParam: Object, equalNode: TruffleString$EqualNode, getOptionNode: TemporalGetOptionNode, getSmallestUnit: GetTemporalUnitNode, getRoundingIncrementOption: GetRoundingIncrementOptionNode, errorBranch: InlinedBranchProfile, optionUndefined: InlinedConditionProfile): JSTemporalPlainTimeObject;
}