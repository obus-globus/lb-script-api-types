...
import type { TemporalPlainTimeFunctionBuiltins$JSTemporalPlainTimeCompareNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainTimeFunctionBuiltins$JSTemporalPlainTimeCompareNode.d.ts'
...
export class TemporalPlainTimeFunctionBuiltinsFactory$JSTemporalPlainTimeCompareNodeGen extends TemporalPlainTimeFunctionBuiltins$JSTemporalPlainTimeCompareNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainTimeFunctionBuiltins$JSTemporalPlainTimeCompareNode;
