...
import type { TemporalDurationPrototypeBuiltins$JSTemporalDurationToLocaleString } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalDurationPrototypeBuiltins$JSTemporalDurationToLocaleString.d.ts'
...
export class TemporalDurationPrototypeBuiltinsFactory$JSTemporalDurationToLocaleStringNodeGen extends TemporalDurationPrototypeBuiltins$JSTemporalDurationToLocaleString {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalDurationPrototypeBuiltins$JSTemporalDurationToLocaleString;
