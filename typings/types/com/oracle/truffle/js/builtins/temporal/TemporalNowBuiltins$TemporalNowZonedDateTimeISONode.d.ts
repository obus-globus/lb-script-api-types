...
export abstract class TemporalNowBuiltins$TemporalNowZonedDateTimeISONode extends JSBuiltinNode {
    ...
    zonedDateTimeISO(temporalTimeZoneLike: Object, toTemporalIdentifier: ToTemporalTimeZoneIdentifierNode): JSTemporalZonedDateTimeObject;
}