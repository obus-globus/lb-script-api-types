...
export abstract class TemporalInstantPrototypeBuiltins$JSTemporalInstantToLocaleString extends JSTemporalBuiltinOperation {
    ...
    toLocaleString(instant: JSTemporalInstantObject, locales: Object, options: Object, initDateTimeFormatNode: InitializeDateTimeFormatNode): TruffleString;
}