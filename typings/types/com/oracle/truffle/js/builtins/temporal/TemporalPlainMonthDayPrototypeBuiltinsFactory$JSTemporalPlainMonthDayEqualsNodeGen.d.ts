...
export class TemporalPlainMonthDayPrototypeBuiltinsFactory$JSTemporalPlainMonthDayEqualsNodeGen extends TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayEqualsNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: (Object | null)[]): TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayEqualsNode;
