...
import type { TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayEqualsNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayEqualsNode.d.ts'
...
export class TemporalPlainMonthDayPrototypeBuiltinsFactory$JSTemporalPlainMonthDayEqualsNodeGen extends TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayEqualsNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainMonthDayPrototypeBuiltins$JSTemporalPlainMonthDayEqualsNode;
    ...
    // private equals_toTemporalMonthDayNode_: ToTemporalMonthDayNode;
