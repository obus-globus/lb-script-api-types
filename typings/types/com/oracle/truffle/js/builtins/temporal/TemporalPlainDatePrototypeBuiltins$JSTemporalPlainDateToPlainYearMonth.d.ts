...
export abstract class TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateToPlainYearMonth extends JSTemporalBuiltinOperation {
    ...
    toPlainYearMonth(temporalDate: JSTemporalPlainDateObject, yearMonthFromFieldsNode: TemporalYearMonthFromFieldsNode): JSTemporalPlainYearMonthObject;
}