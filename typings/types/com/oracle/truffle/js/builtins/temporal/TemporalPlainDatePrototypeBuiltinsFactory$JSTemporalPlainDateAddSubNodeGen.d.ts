...
export class TemporalPlainDatePrototypeBuiltinsFactory$JSTemporalPlainDateAddSubNodeGen extends TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateAddSubNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramsign: number, paramarguments: (Object | null)[]): TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateAddSubNode;
