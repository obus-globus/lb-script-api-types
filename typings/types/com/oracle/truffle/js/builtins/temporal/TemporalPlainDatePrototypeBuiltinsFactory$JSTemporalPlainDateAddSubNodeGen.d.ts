...
import type { TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateAddSubNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateAddSubNode.d.ts'
...
export class TemporalPlainDatePrototypeBuiltinsFactory$JSTemporalPlainDateAddSubNodeGen extends TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateAddSubNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramsign: number, paramarguments: JavaScriptNode[]): TemporalPlainDatePrototypeBuiltins$JSTemporalPlainDateAddSubNode;
    ...
    // private addDate_addDateNode_: TemporalAddDateNode;
    // private addDate_getOptionNode_: TemporalGetOptionNode;
    // private addDate_toTemporalDurationNode_: ToTemporalDurationNode;
    // private arguments0_: JavaScriptNode;
    // private arguments1_: JavaScriptNode;
    // private arguments2_: JavaScriptNode;
    // private state_0_: number;
    execute(frameValue: VirtualFrame): Object;
    // private executeAndSpecialize(arguments0Value: Object, arguments1Value: Object, arguments2Value: Object): JSTemporalPlainDateObject;
