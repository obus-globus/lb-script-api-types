...
import type { TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeWith } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeWith.d.ts'
...
export class TemporalPlainDateTimePrototypeBuiltinsFactory$JSTemporalPlainDateTimeWithNodeGen extends TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeWith {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeWith;
