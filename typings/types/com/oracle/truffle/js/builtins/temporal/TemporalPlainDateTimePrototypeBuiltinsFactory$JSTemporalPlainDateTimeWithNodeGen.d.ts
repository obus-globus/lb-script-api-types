...
export class TemporalPlainDateTimePrototypeBuiltinsFactory$JSTemporalPlainDateTimeWithNodeGen extends TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeWith {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: (Object | null)[]): TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeWith;
