...
export abstract class TemporalPlainTimePrototypeBuiltins$JSTemporalPlainTimeEquals extends JSTemporalBuiltinOperation {
    ...
    equalsGeneric(thisTime: JSTemporalPlainTimeObject, other: Object, toTemporalTime: ToTemporalTimeNode): boolean;
    equalsOtherObj(thisTime: JSTemporalPlainTimeObject, otherObj: JSTemporalPlainTimeObject): boolean;
}