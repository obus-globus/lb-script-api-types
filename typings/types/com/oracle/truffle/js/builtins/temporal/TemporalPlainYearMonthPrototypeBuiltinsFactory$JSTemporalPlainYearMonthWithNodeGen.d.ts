...
import type { TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthWithNode } from '../../../../../../com/oracle/truffle/js/builtins/temporal/TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthWithNode.d.ts'
...
export class TemporalPlainYearMonthPrototypeBuiltinsFactory$JSTemporalPlainYearMonthWithNodeGen extends TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthWithNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): TemporalPlainYearMonthPrototypeBuiltins$JSTemporalPlainYearMonthWithNode;
    ...
    // private with_getOptionsObject_: GetOptionsObjectNode;
    // private with_isPartialTemporalObjectNode_: IsPartialTemporalObjectNode;
    // private with_yearMonthFromFieldsNode_: TemporalYearMonthFromFieldsNode;
