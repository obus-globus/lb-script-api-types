...
export abstract class TemporalPlainDateTimePrototypeBuiltins$JSTemporalPlainDateTimeToPlainDateNode extends JSTemporalBuiltinOperation {
    ...
    toPlainDate(dt: JSTemporalPlainDateTimeObject, errorBranch: InlinedBranchProfile): JSTemporalPlainDateObject;
}