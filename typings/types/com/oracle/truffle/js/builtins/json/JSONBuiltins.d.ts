...
import type { JSONBuiltins$JSON } from '../../../../../../com/oracle/truffle/js/builtins/json/JSONBuiltins$JSON.d.ts'
...
export class JSONBuiltins extends JSBuiltinsContainer$SwitchEnum<JSONBuiltins$JSON> {
    ...
    constructor()
    createNode(context: JSContext, builtin: JSBuiltin, construct: boolean, newTarget: boolean, builtinEnum: JSONBuiltins$JSON): Object;
}