...
export abstract class ConstructorBuiltins$ConstructStringNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    constructString(newTarget: JSDynamicObject, args: Object[], toStringNode: JSToStringNode): JSStringObject;
    constructStringInt0(newTarget: JSDynamicObject, args: Object[]): JSStringObject;
