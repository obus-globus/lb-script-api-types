...
export abstract class TextEncoderBuiltins$EncodeNode extends JSBuiltinNode {
    ...
    // private constructTypedArrayNode: ArrayPrototypeBuiltins$ArraySpeciesConstructorNode;
    // private switchEncodingNode: TruffleString$SwitchEncodingNode;
    doOther(thisObj: JSTextEncoderObject, string: Object, toStringNode: JSToStringNode): JSTypedArrayObject;
    doString(thisObj: JSTextEncoderObject, string: TruffleString): JSTypedArrayObject;
    incompatibleReceiver(thisObj: Object, string: Object): Object;
}