...
export class JSTextDecoderObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, encoding: TruffleString, truffleStringEncoding: TruffleString$Encoding, fatal: boolean, ignoreBOM: boolean)
    readonly bomSeen: boolean;
    readonly encoding: TruffleString;
    readonly fatal: boolean;
    readonly ignoreBOM: boolean;
    readonly pendingBytes: number[];
    readonly truffleStringEncoding: TruffleString$Encoding;
    // private clearPendingBytes(): void;
    endDecode(stream: boolean, onError: boolean): void;
    getEncoding(): TruffleString;
    getPendingBytes(): number[];
    getTruffleStringEncoding(): TruffleString$Encoding;
    isBomSeen(): boolean;
    isFatal(): boolean;
    isIgnoreBOM(): boolean;
    setBomSeen(): void;
    setPendingBytes(pendingBytes: number[], start: number, end: number): void;
}