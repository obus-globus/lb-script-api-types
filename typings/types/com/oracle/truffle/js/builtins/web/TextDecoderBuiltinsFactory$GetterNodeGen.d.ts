...
export class TextDecoderBuiltinsFactory$GetterNodeGen extends TextDecoderBuiltins$GetterNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, parammethod: TextDecoderBuiltins$TextDecoderPrototype, paramarguments: (Object | null)[]): TextDecoderBuiltins$GetterNode;
