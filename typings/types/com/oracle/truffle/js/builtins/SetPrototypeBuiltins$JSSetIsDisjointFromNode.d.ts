...
export abstract class SetPrototypeBuiltins$JSSetIsDisjointFromNode extends SetPrototypeBuiltins$JSSetNewOperation {
    ...
    isDisjointFrom(set: JSSetObject, other: Object, getSetRecordNode: GetSetRecordNode, toBooleanNode: JSToBooleanNode, getIteratorFromMethodNode: GetIteratorFromMethodNode, thisSetSmallerProfile: InlinedBranchProfile): boolean;
    notSet(thisObj: Object, other: Object): boolean;
}