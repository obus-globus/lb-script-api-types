...
import type { RegExpPrototypeBuiltinsFactory$JSRegExpReplaceNodeGen$ReplaceStringCachedData } from '../../../../../com/oracle/truffle/js/builtins/RegExpPrototypeBuiltinsFactory$JSRegExpReplaceNodeGen$ReplaceStringCachedData.d.ts'
...
export class RegExpPrototypeBuiltinsFactory$JSRegExpReplaceNodeGen extends RegExpPrototypeBuiltins$JSRegExpReplaceNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): RegExpPrototypeBuiltins$JSRegExpReplaceNode;
    ...
    // private replaceAccordingToSpec: RegExpPrototypeBuiltins$JSRegExpReplaceNode$ReplaceAccordingToSpecNode;
    // private replaceInternal: RegExpPrototypeBuiltins$JSRegExpReplaceNode$ReplaceInternalNode;
    // private replaceStringCached_cache: RegExpPrototypeBuiltinsFactory$JSRegExpReplaceNodeGen$ReplaceStringCachedData;
