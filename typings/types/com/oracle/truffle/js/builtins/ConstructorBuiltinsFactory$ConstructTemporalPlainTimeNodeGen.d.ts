...
export class ConstructorBuiltinsFactory$ConstructTemporalPlainTimeNodeGen extends ConstructorBuiltins$ConstructTemporalPlainTimeNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructTemporalPlainTimeNode;
