...
export class NumberPrototypeBuiltinsFactory$JSNumberValueOfNodeGen extends NumberPrototypeBuiltins$JSNumberValueOfNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): NumberPrototypeBuiltins$JSNumberValueOfNode;
    ...
    // private valueOfForeignObject_getDoubleValue_: NumberPrototypeBuiltins$ForeignGetDoubleValueNode;
