...
export class TypedArrayPrototypeBuiltins extends JSBuiltinsContainer$SwitchEnum<TypedArrayPrototypeBuiltins$TypedArrayPrototype> {
    ...
    constructor()
    createNode(context: JSContext, builtin: JSBuiltin, construct: boolean, newTarget: boolean, builtinEnum: TypedArrayPrototypeBuiltins$TypedArrayPrototype): Object;
}