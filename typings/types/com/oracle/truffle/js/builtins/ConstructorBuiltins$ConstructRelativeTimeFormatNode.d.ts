...
export abstract class ConstructorBuiltins$ConstructRelativeTimeFormatNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    // private initializeRelativeTimeFormatNode: InitializeRelativeTimeFormatNode;
    constructRelativeTimeFormat(newTarget: JSDynamicObject, locales: Object, options: Object): JSRelativeTimeFormatObject;
