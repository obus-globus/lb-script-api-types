...
export abstract class IteratorHelperPrototypeBuiltins$IteratorHelperNextNode extends JSBuiltinNode {
    ...
    next(thisObj: JSIteratorHelperObject, executingProfile: InlinedBranchProfile, completedProfile: InlinedBranchProfile): Object;
