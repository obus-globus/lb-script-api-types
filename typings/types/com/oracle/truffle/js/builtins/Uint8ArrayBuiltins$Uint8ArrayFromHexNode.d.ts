...
export abstract class Uint8ArrayBuiltins$Uint8ArrayFromHexNode extends Uint8ArrayBuiltins$Uint8ArrayBaseNode {
    ...
    doString(string: TruffleString, constructTypedArrayNode: ArrayPrototypeBuiltins$ArraySpeciesConstructorNode, charAtNode: TruffleString$ReadCharUTF16Node): JSObject;
}