...
export class ConstructorBuiltinsFactory$ConstructTemporalZonedDateTimeNodeGen extends ConstructorBuiltins$ConstructTemporalZonedDateTime {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructTemporalZonedDateTime;
