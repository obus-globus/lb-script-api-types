...
export class ConstructorBuiltinsFactory$ConstructTemporalInstantNodeGen extends ConstructorBuiltins$ConstructTemporalInstant {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructTemporalInstant;
