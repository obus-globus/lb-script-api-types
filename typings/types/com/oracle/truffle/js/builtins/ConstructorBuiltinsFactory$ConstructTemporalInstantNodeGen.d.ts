...
import type { ConstructorBuiltins$ConstructTemporalInstant } from '../../../../../com/oracle/truffle/js/builtins/ConstructorBuiltins$ConstructTemporalInstant.d.ts'
...
export class ConstructorBuiltinsFactory$ConstructTemporalInstantNodeGen extends ConstructorBuiltins$ConstructTemporalInstant {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: JavaScriptNode[]): ConstructorBuiltins$ConstructTemporalInstant;
