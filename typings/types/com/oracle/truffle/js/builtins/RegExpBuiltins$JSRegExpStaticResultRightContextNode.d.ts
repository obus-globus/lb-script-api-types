...
export abstract class RegExpBuiltins$JSRegExpStaticResultRightContextNode extends RegExpBuiltins$JSRegExpStaticResultPropertyNode {
    ...
    rightContext(frame: VirtualFrame, substringNode: TruffleString$SubstringByteIndexNode, readIsMatch: TRegexUtil$InteropReadBooleanMemberNode, getEnd: TRegexUtil$InvokeGetGroupBoundariesMethodNode, getResultNode: RegExpBuiltins$GetStaticRegExpResultNode): TruffleString;
}