...
export abstract class Uint8ArrayBuiltins$ToBase64Node extends Uint8ArrayBuiltins$Uint8ArrayBaseNode {
    ...
    doUint8Array(thisObj: JSTypedArrayObject, options: Object, getOptionsObjectNode: GetOptionsObjectNode, getAlphabetNode: PropertyGetNode, getOmitPaddingOptionNode: GetBooleanOptionNode, interop: InteropLibrary, equalNode: TruffleString$EqualNode, fromJavaStringNode: TruffleString$FromJavaStringNode): TruffleString;
}