...
export abstract class ConstructorBuiltins$ConstructWebAssemblyInstanceNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    constructInstanceFromModule(newTarget: JSDynamicObject, module: JSWebAssemblyModuleObject, importObject: Object): JSObject;
    constructInstanceFromOther(newTarget: JSDynamicObject, other: Object, importObject: Object): JSObject;
