...
import type { IteratorFunctionBuiltins$IteratorZipKeyedNode } from '../../../../../com/oracle/truffle/js/builtins/IteratorFunctionBuiltins$IteratorZipKeyedNode.d.ts'
...
export class IteratorFunctionBuiltinsFactory$IteratorZipKeyedNodeGen extends IteratorFunctionBuiltins$IteratorZipKeyedNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): IteratorFunctionBuiltins$IteratorZipKeyedNode;
    ...
    // private listGet_: ListGetNode;
    // private listSize_: ListSizeNode;
    // private ownPropertyKeysNode_: OwnPropertyKeysNode;
