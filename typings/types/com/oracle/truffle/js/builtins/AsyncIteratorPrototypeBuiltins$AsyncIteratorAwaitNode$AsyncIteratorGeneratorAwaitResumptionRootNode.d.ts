...
export abstract class AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode$AsyncIteratorGeneratorAwaitResumptionRootNode<T extends AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode$AsyncIteratorArgs> extends AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode$AbstractAsyncIteratorGeneratorResumptionRootNode<T> {
    ...
    assertResumingAwait(frame: VirtualFrame): void;
