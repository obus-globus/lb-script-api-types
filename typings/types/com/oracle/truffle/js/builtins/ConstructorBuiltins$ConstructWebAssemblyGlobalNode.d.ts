...
export abstract class ConstructorBuiltins$ConstructWebAssemblyGlobalNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    // private getMutableNode: PropertyGetNode;
    // private getValueNode: PropertyGetNode;
    // private globalAllocLib: InteropLibrary;
    constructGlobal(newTarget: JSDynamicObject, descriptor: Object, args: Object[], isObjectNode: IsObjectNode, toBooleanNode: JSToBooleanNode, toStringNode: JSToStringNode, toJavaString: TruffleString$ToJavaStringNode, toWebAssemblyValueNode: ToWebAssemblyValueNode): JSObject;
