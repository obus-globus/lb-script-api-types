...
export abstract class StringPrototypeBuiltins$JSStringReplaceES5Node extends StringPrototypeBuiltins$JSStringReplaceBaseNode {
    ...
    // private replace<T extends unknown>(thisStr: TruffleString, result: Object, groupCount: number, replacer: StringPrototypeBuiltins$JSStringReplaceES5Node$Replacer<T>, replaceValue: T, tRegexCompiledRegex: Object, node: Node): TruffleString;
    ...
    // private replaceAll<T extends unknown>(regExp: JSRegExpObject, input: TruffleString, groupCount: number, replacer: StringPrototypeBuiltins$JSStringReplaceES5Node$Replacer<T>, replaceValue: T, tRegexCompiledRegex: Object, node: Node, ifIsMatch: InlinedCountingConditionProfile, readIsMatch: TRegexUtil$InteropReadBooleanMemberNode): TruffleString;
    // private replaceFirst<T extends unknown>(thisStr: TruffleString, searchStr: TruffleString, replacer: StringPrototypeBuiltins$JSStringReplaceES5Node$Replacer<T>, replaceValue: T, node: Node, ifIsMatch: InlinedCountingConditionProfile): Object;
    // private replaceFirst<T extends unknown>(thisStr: TruffleString, regExp: JSRegExpObject, groupCount: number, replacer: StringPrototypeBuiltins$JSStringReplaceES5Node$Replacer<T>, replaceValue: T, tRegexCompiledRegex: Object, node: Node, ifIsMatch: InlinedCountingConditionProfile, readIsMatch: TRegexUtil$InteropReadBooleanMemberNode): TruffleString;
