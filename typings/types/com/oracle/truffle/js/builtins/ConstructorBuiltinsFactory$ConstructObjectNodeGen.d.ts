...
export class ConstructorBuiltinsFactory$ConstructObjectNodeGen extends ConstructorBuiltins$ConstructObjectNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructObjectNode;
