...
import type { ConstructorBuiltins$ConstructTemporalPlainDateNode } from '../../../../../com/oracle/truffle/js/builtins/ConstructorBuiltins$ConstructTemporalPlainDateNode.d.ts'
...
export class ConstructorBuiltinsFactory$ConstructTemporalPlainDateNodeGen extends ConstructorBuiltins$ConstructTemporalPlainDateNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: JavaScriptNode[]): ConstructorBuiltins$ConstructTemporalPlainDateNode;
