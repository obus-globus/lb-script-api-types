...
export class ConstructorBuiltinsFactory$ConstructTemporalPlainDateNodeGen extends ConstructorBuiltins$ConstructTemporalPlainDateNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructTemporalPlainDateNode;
