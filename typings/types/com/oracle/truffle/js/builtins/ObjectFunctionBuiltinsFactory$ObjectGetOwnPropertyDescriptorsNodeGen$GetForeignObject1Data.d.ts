...
export class ObjectFunctionBuiltinsFactory$ObjectGetOwnPropertyDescriptorsNodeGen$GetForeignObject1Data extends Node implements DSLSupport$SpecializationDataNode {
    constructor()
    // private fromJavaString_: TruffleString$FromJavaStringNode;
    // private fromLong_: TruffleString$FromLongNode;
    // private getForeignObject1_state_0_: number;
