...
export abstract class Uint8ArrayBuiltins$SetFromBaseNode extends Uint8ArrayBuiltins$Uint8ArrayBaseNode {
    ...
    createResultObject(readLength: number, writtenLength: number): JSObject;
    setUint8ArrayBytes(into: JSTypedArrayObject, bytes: number[], resultLength: number): void;
    // private setUint8ArrayBytesInterop(into: JSTypedArrayObject, bytes: number[], resultLength: number): void;
}