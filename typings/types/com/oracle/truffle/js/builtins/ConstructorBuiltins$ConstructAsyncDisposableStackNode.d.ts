...
export abstract class ConstructorBuiltins$ConstructAsyncDisposableStackNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    constructAsyncDisposableStack(newTarget: JSDynamicObject): JSDynamicObject;
