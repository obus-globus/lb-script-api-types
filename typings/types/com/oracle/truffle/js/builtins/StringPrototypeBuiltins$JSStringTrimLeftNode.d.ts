...
export abstract class StringPrototypeBuiltins$JSStringTrimLeftNode extends StringPrototypeBuiltins$JSStringOperation {
    ...
    trimLeft(thisObj: Object, substringNode: TruffleString$SubstringByteIndexNode, readRawNode: TruffleString$ReadCharUTF16Node, lengthExceeded: InlinedConditionProfile, lengthZero: InlinedConditionProfile): Object;
}