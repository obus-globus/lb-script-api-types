...
export abstract class JavaBuiltins$JavaSuperNode extends JSBuiltinNode {
    ...
    superAdapter(adapter: Object, interop: InteropLibrary, toJSType: ImportValueNode, toJavaString: TruffleString$ToJavaStringNode): Object;
}