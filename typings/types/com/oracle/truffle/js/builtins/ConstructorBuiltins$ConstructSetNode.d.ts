...
export abstract class ConstructorBuiltins$ConstructSetNode extends ConstructorBuiltins$JSConstructIterableOperation {
    ...
    constructEmptySet(newTarget: JSDynamicObject, iterable: Object): JSObject;
    constructSetFromIterable(newTarget: JSDynamicObject, iterable: Object, node: Node, isCallableNode: IsCallableNode, getIteratorNode: GetIteratorNode, errorBranch: InlinedBranchProfile): JSObject;
    getIntrinsicDefaultProto(realm: JSRealm): JSDynamicObject;
    newSetObject(newTarget: JSDynamicObject): JSObject;
}