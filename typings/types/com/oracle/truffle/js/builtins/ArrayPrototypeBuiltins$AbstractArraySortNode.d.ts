...
export abstract class ArrayPrototypeBuiltins$AbstractArraySortNode extends ArrayPrototypeBuiltins$JSArrayOperation {
    ...
    checkCompareCallableOrUndefined(compare: Object): void;
}