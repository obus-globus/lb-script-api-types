...
import type { JSStringIteratorObject } from '../../../../../com/oracle/truffle/js/runtime/builtins/JSStringIteratorObject.d.ts'
import type { JSObject } from '../../../../../com/oracle/truffle/js/runtime/objects/JSObject.d.ts'
import type { Object } from '../../../../../java/lang/Object.d.ts'
export abstract class StringIteratorPrototypeBuiltins$StringIteratorNextNode extends JSBuiltinNode {
    ...
    // private isSurrogatePair: CountingConditionProfile;
    // private stringReadNode: TruffleString$ReadCharUTF16Node;
    doStringIterator(iterator: JSStringIteratorObject, fromCodePointNode: TruffleString$FromCodePointNode, substringNode: TruffleString$SubstringByteIndexNode): JSObject;
}