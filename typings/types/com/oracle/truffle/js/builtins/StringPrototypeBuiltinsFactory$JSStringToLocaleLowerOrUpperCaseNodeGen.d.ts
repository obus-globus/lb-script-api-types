...
export class StringPrototypeBuiltinsFactory$JSStringToLocaleLowerOrUpperCaseNodeGen extends StringPrototypeBuiltins$JSStringToLocaleLowerOrUpperCaseNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramtoUpperCase: boolean, paramarguments: (Object | null)[]): StringPrototypeBuiltins$JSStringToLocaleLowerOrUpperCaseNode;
