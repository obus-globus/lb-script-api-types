...
export class ArrayFunctionBuiltinsFactory$JSArrayFromNodeGen extends ArrayFunctionBuiltins$JSArrayFromNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisTypedArray: boolean, paramarguments: JavaScriptNode[]): ArrayFunctionBuiltins$JSArrayFromNode;
