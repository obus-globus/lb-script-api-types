...
export abstract class AsyncFromSyncIteratorPrototypeBuiltins$AsyncFromSyncNext extends AsyncFromSyncIteratorPrototypeBuiltins$AsyncFromSyncBaseNode {
    ...
    next(frame: VirtualFrame, thisObj: JSAsyncFromSyncIteratorObject, value: Object, valuePresenceProfile: InlinedConditionProfile): Object;
}