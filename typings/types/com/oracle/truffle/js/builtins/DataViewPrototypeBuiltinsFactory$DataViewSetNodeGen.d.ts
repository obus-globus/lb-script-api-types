...
import type { DataViewPrototypeBuiltins$DataViewSetNode } from '../../../../../com/oracle/truffle/js/builtins/DataViewPrototypeBuiltins$DataViewSetNode.d.ts'
...
export class DataViewPrototypeBuiltinsFactory$DataViewSetNodeGen extends DataViewPrototypeBuiltins$DataViewSetNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramtypedArrayFactory: TypedArrayFactory, paramarguments: JavaScriptNode[]): DataViewPrototypeBuiltins$DataViewSetNode;
    ...
    // private dataView_setBufferElement__field1_: InteropLibrary;
