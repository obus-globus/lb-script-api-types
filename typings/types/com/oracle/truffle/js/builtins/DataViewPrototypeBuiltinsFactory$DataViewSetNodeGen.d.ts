...
export class DataViewPrototypeBuiltinsFactory$DataViewSetNodeGen extends DataViewPrototypeBuiltins$DataViewSetNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): DataViewPrototypeBuiltins$DataViewSetNode;
    ...
    // private dataView_setBufferElement__field1_: Node;
