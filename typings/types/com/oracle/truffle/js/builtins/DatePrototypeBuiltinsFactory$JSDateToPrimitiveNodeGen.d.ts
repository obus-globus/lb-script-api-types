...
export class DatePrototypeBuiltinsFactory$JSDateToPrimitiveNodeGen extends DatePrototypeBuiltins$JSDateToPrimitiveNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): DatePrototypeBuiltins$JSDateToPrimitiveNode;
