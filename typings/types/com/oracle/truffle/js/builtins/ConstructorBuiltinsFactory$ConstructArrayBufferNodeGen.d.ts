...
export class ConstructorBuiltinsFactory$ConstructArrayBufferNodeGen extends ConstructorBuiltins$ConstructArrayBufferNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramuseShared: boolean, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructArrayBufferNode;
