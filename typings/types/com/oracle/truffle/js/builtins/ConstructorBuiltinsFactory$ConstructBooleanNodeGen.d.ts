...
import type { ConstructorBuiltins$ConstructBooleanNode } from '../../../../../com/oracle/truffle/js/builtins/ConstructorBuiltins$ConstructBooleanNode.d.ts'
...
export class ConstructorBuiltinsFactory$ConstructBooleanNodeGen extends ConstructorBuiltins$ConstructBooleanNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: JavaScriptNode[]): ConstructorBuiltins$ConstructBooleanNode;
