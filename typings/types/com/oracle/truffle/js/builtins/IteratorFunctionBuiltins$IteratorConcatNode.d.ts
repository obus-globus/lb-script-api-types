...
export abstract class IteratorFunctionBuiltins$IteratorConcatNode extends IteratorPrototypeBuiltins$IteratorFromGeneratorNode<IteratorFunctionBuiltins$ConcatArgs> {
    ...
    iteratorConcat(items: Object[], isObjectNode: IsObjectNode, getIteratorMethodNode: GetMethodNode, errorBranch: InlinedBranchProfile): Object;
}