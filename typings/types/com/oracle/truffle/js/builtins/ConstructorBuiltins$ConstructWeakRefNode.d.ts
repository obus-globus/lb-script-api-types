...
export abstract class ConstructorBuiltins$ConstructWeakRefNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    constructWeakRef(newTarget: JSDynamicObject, target: Object, canBeHeldWeakly: CanBeHeldWeaklyNode): JSObject;
