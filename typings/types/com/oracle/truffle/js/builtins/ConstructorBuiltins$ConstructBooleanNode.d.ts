...
export abstract class ConstructorBuiltins$ConstructBooleanNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    constructBoolean(newTarget: JSDynamicObject, value: Object, toBoolean: JSToBooleanNode): JSBooleanObject;
