...
export class AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode<T extends AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode$AsyncIteratorArgs> extends JavaScriptBaseNode {
    ...
    static create<T extends AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode$AsyncIteratorArgs>(paramcontext: JSContext, paramkey: JSContext$BuiltinFunctionKey, paramcreate: (param0: JSContext) => JSFunctionData, paramcloseOnAbrupt: boolean): AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode<T>;
    static create<T extends AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode$AsyncIteratorArgs>(paramcontext: JSContext, paramthenKey: JSContext$BuiltinFunctionKey, paramthenCreate: (param0: JSContext) => JSFunctionData, paramcatchKey: JSContext$BuiltinFunctionKey, paramcatchCreate: (param0: JSContext) => JSFunctionData): AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode<T>;
    static createGen<T extends AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode$AsyncIteratorArgs>(paramcontext: JSContext, paramkey: JSContext$BuiltinFunctionKey, paramcreate: (param0: JSContext) => JSFunctionData, paramcloseOnAbrupt: boolean): AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode<T>;
    static createGeneratorYield<T extends AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode$AsyncIteratorArgs>(paramcontext: JSContext): AsyncIteratorPrototypeBuiltins$AsyncIteratorAwaitNode<T>;
