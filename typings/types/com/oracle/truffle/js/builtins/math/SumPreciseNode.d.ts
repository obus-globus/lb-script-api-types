...
export abstract class SumPreciseNode extends MathOperation {
    ...
    sumPrecise(items: Object, requireObjectCoercible: RequireObjectCoercibleNode, getIteratorNode: GetIteratorNode, iteratorStepNode: IteratorStepNode, iteratorValueNode: IteratorValueNode, iteratorCloseNode: IteratorCloseNode, isNumberNode: IsNumberNode, toDoubleNode: JSNumberToDoubleNode, errorBranch: InlinedBranchProfile): number;
}