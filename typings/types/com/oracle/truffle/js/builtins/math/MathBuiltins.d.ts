...
import type { MathBuiltins$Math } from '../../../../../../com/oracle/truffle/js/builtins/math/MathBuiltins$Math.d.ts'
...
export class MathBuiltins extends JSBuiltinsContainer$SwitchEnum<MathBuiltins$Math> {
    ...
    constructor()
    createNode(context: JSContext, builtin: JSBuiltin, construct: boolean, newTarget: boolean, builtinEnum: MathBuiltins$Math): Object;
}