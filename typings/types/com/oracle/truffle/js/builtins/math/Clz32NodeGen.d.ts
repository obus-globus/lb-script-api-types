...
import type { Clz32Node } from '../../../../../../com/oracle/truffle/js/builtins/math/Clz32Node.d.ts'
...
export class Clz32NodeGen extends Clz32Node {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): Clz32Node;
    ...
    // private clz321_toUInt32Node_: JSToUInt32Node;
