...
import type { ObjectFunctionBuiltins$ObjectIsNode } from '../../../../../com/oracle/truffle/js/builtins/ObjectFunctionBuiltins$ObjectIsNode.d.ts'
...
export class ObjectFunctionBuiltinsFactory$ObjectIsNodeGen extends ObjectFunctionBuiltins$ObjectIsNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): ObjectFunctionBuiltins$ObjectIsNode;
