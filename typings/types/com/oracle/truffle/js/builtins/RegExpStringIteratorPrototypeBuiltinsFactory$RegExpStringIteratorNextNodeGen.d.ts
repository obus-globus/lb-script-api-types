...
export class RegExpStringIteratorPrototypeBuiltinsFactory$RegExpStringIteratorNextNodeGen extends RegExpStringIteratorPrototypeBuiltins$RegExpStringIteratorNextNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): RegExpStringIteratorPrototypeBuiltins$RegExpStringIteratorNextNode;
