...
export class SetPrototypeBuiltinsFactory$JSSetIsDisjointFromNodeGen extends SetPrototypeBuiltins$JSSetIsDisjointFromNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): SetPrototypeBuiltins$JSSetIsDisjointFromNode;
