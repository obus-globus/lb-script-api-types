...
export class NpmCompatibleESModuleLoader extends DefaultESModuleLoader {
    ...
    // private packageExportsResolve(packageURL: URI, subpath: string, exports: Object, conditions: string[], env: TruffleLanguage$Env): URI;
    // private packageImportsExportsResolve(matchKey: string, matchObj: JSObject, packageURL: URI, isImports: boolean, conditions: string[], env: TruffleLanguage$Env): URI;
    // private packageImportsResolve(specifier: string, parentURL: URI, conditions: string[], env: TruffleLanguage$Env): URI;
    // private packageResolve(packageSpecifier: string, parentURL: URI, env: TruffleLanguage$Env): URI;
    // private packageSelfResolve(packageName: string, packageSubpath: string, parentURL: URI, env: TruffleLanguage$Env): URI;
    // private packageTargetResolve(packageURL: URI, target: Object, patternMatch: string, isImports: boolean, conditions: string[], env: TruffleLanguage$Env): URI;
    ...
    // private tryLoadingAsCommonjsModule(referencingModule: ScriptOrModule, moduleRequest: Module$ModuleRequest, specifier: string): AbstractModuleRecord;
}