...
import type { ReflectBuiltins$ReflectGetNode } from '../../../../../com/oracle/truffle/js/builtins/ReflectBuiltins$ReflectGetNode.d.ts'
...
export class ReflectBuiltinsFactory$ReflectGetNodeGen extends ReflectBuiltins$ReflectGetNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): ReflectBuiltins$ReflectGetNode;
