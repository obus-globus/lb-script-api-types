...
import type { AtomicsBuiltins$AtomicsWaitNode } from '../../../../../com/oracle/truffle/js/builtins/AtomicsBuiltins$AtomicsWaitNode.d.ts'
...
export class AtomicsBuiltinsFactory$AtomicsWaitNodeGen extends AtomicsBuiltins$AtomicsWaitNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): AtomicsBuiltins$AtomicsWaitNode;
