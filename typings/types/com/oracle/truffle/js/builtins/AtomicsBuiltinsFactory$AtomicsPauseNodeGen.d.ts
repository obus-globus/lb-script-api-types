...
import type { AtomicsBuiltins$AtomicsPauseNode } from '../../../../../com/oracle/truffle/js/builtins/AtomicsBuiltins$AtomicsPauseNode.d.ts'
...
export class AtomicsBuiltinsFactory$AtomicsPauseNodeGen extends AtomicsBuiltins$AtomicsPauseNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): AtomicsBuiltins$AtomicsPauseNode;
