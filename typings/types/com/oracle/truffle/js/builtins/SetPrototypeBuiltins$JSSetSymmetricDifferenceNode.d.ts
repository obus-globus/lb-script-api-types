...
export abstract class SetPrototypeBuiltins$JSSetSymmetricDifferenceNode extends SetPrototypeBuiltins$JSSetNewOperation {
    ...
    symmetricDifference(set: JSSetObject, other: Object, getSetRecordNode: GetSetRecordNode, getIteratorFromMethodNode: GetIteratorFromMethodNode): JSDynamicObject;
}