...
export abstract class IteratorPrototypeBuiltins$IteratorMethodWithCallableNode extends IteratorPrototypeBuiltins$IteratorMethodNode {
    ...
    isCallable(fn: Object): boolean;
    iteratorCloseDirectAbrupt(iterator: Object): void;
}