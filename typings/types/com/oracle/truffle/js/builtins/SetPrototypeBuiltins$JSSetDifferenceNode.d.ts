...
export abstract class SetPrototypeBuiltins$JSSetDifferenceNode extends SetPrototypeBuiltins$JSSetNewOperation {
    ...
    difference(set: JSSetObject, other: Object, getSetRecordNode: GetSetRecordNode, toBooleanNode: JSToBooleanNode, getIteratorFromMethodNode: GetIteratorFromMethodNode, thisSetSmallerProfile: InlinedBranchProfile): JSDynamicObject;
