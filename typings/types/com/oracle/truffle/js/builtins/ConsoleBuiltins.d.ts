...
import type { ConsoleBuiltins$Console } from '../../../../../com/oracle/truffle/js/builtins/ConsoleBuiltins$Console.d.ts'
...
export class ConsoleBuiltins extends JSBuiltinsContainer$SwitchEnum<ConsoleBuiltins$Console> {
    ...
    constructor()
    createNode(context: JSContext, builtin: JSBuiltin, construct: boolean, newTarget: boolean, builtinEnum: ConsoleBuiltins$Console): Object;
}