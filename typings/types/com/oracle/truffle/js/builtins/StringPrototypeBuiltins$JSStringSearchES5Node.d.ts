...
export abstract class StringPrototypeBuiltins$JSStringSearchES5Node extends StringPrototypeBuiltins$JSStringOperationWithRegExpArgument {
    ...
    search(thisObj: Object, args: Object[], toRegExpNode: JSToRegExpNode, readIsMatch: TRegexUtil$InteropReadBooleanMemberNode, getStart: TRegexUtil$InvokeGetGroupBoundariesMethodNode): number;
}