...
export abstract class ConstructorBuiltins$ConstructWebAssemblyModuleNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    constructModule(newTarget: JSDynamicObject, bytes: Object): JSObject;
