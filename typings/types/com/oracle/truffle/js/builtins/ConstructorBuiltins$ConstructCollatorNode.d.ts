...
export abstract class ConstructorBuiltins$ConstructCollatorNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    // private initializeCollatorNode: InitializeCollatorNode;
    constructCollator(newTarget: JSDynamicObject, locales: Object, options: Object): JSCollatorObject;
