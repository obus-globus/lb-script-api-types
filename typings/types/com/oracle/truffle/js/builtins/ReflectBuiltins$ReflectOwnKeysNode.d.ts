...
export abstract class ReflectBuiltins$ReflectOwnKeysNode extends ReflectBuiltins$ReflectOperation {
    ...
    doForeignObject(target: Object, interop: InteropLibrary): Object;
    doNonObject(target: Object): Object;
    reflectOwnKeys(target: JSObject, jsclassProfile: JSClassProfile, listSize: ListSizeNode): JSDynamicObject;
}