...
export class ConstructorBuiltinsFactory$ConstructTemporalDurationNodeGen extends ConstructorBuiltins$ConstructTemporalDurationNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructTemporalDurationNode;
