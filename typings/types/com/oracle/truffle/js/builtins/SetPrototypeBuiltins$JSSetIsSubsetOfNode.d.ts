...
export abstract class SetPrototypeBuiltins$JSSetIsSubsetOfNode extends SetPrototypeBuiltins$JSSetNewOperation {
    ...
    isSubsetOf(set: JSSetObject, other: Object, getSetRecordNode: GetSetRecordNode, toBooleanNode: JSToBooleanNode): boolean;
