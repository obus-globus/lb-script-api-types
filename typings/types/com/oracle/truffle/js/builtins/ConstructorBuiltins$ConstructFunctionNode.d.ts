...
export abstract class ConstructorBuiltins$ConstructFunctionNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    constructor(context: JSContext, builtin: JSBuiltin, generatorFunction: boolean, asyncFunction: boolean, isNewTargetCase: boolean)
    // private asyncFunction: boolean;
    // private functionNode: ConstructorBuiltins$CreateDynamicFunctionNode;
    // private generatorFunction: boolean;
    // private toStringNode: JSToStringNode;
    constructFunction(newTarget: JSDynamicObject, args: Object[], hasArgsProfile: InlinedConditionProfile, hasParamsProfile: InlinedConditionProfile): JSFunctionObject;
