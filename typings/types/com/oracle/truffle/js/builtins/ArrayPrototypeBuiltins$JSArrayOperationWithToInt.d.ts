...
export abstract class ArrayPrototypeBuiltins$JSArrayOperationWithToInt extends ArrayPrototypeBuiltins$JSArrayOperation {
    ...
    // private toIntegerAsLongNode: JSToIntegerAsLongNode;
    toIntegerAsLong(target: Object): number;
}