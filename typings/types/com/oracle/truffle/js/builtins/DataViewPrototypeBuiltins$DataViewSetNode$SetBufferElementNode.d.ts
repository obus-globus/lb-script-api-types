...
export abstract class DataViewPrototypeBuiltins$DataViewSetNode$SetBufferElementNode extends JavaScriptBaseNode {
    ...
    execute(node: Node, buffer: JSArrayBufferObject, bufferIndex: number, littleEndian: boolean, value: Object, factory: TypedArrayFactory, byteBuffer: ByteBuffer): void;
}