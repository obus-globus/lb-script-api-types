...
import type { ConstructorBuiltins$ConstructDateTimeFormatNode } from '../../../../../com/oracle/truffle/js/builtins/ConstructorBuiltins$ConstructDateTimeFormatNode.d.ts'
...
export class ConstructorBuiltinsFactory$ConstructDateTimeFormatNodeGen extends ConstructorBuiltins$ConstructDateTimeFormatNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramnewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructDateTimeFormatNode;
