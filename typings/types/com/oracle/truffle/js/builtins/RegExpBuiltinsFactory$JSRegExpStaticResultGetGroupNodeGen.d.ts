...
import type { RegExpBuiltins$JSRegExpStaticResultGetGroupNode } from '../../../../../com/oracle/truffle/js/builtins/RegExpBuiltins$JSRegExpStaticResultGetGroupNode.d.ts'
...
export class RegExpBuiltinsFactory$JSRegExpStaticResultGetGroupNodeGen extends RegExpBuiltins$JSRegExpStaticResultGetGroupNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramgroupNumber: number, paramarguments: JavaScriptNode[]): RegExpBuiltins$JSRegExpStaticResultGetGroupNode;
    ...
    private constructor(context: JSContext, builtin: JSBuiltin, groupNumber: number, arguments: JavaScriptNode[])
