...
export class RegExpBuiltinsFactory$JSRegExpStaticResultGetGroupNodeGen extends RegExpBuiltins$JSRegExpStaticResultGetGroupNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramgroupNumber: number, paramarguments: (Object | null)[]): RegExpBuiltins$JSRegExpStaticResultGetGroupNode;
