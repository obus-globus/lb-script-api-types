...
export class ArrayPrototypeBuiltinsFactory$JSArrayToLocaleStringNodeGen extends ArrayPrototypeBuiltins$JSArrayToLocaleStringNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisTypedArrayImplementation: boolean, paramarguments: (Object | null)[]): ArrayPrototypeBuiltins$JSArrayToLocaleStringNode;
