...
export abstract class ConstructorBuiltins$ConstructListFormatNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    // private initializeListFormatNode: InitializeListFormatNode;
    constructListFormat(newTarget: JSDynamicObject, locales: Object, options: Object): JSListFormatObject;
