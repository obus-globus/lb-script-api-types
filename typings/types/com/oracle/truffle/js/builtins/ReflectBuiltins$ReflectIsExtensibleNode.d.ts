...
export abstract class ReflectBuiltins$ReflectIsExtensibleNode extends ReflectBuiltins$ReflectOperation {
    ...
    reflectIsExtensible(target: Object, isExtensibleNode: IsExtensibleNode): boolean;
}