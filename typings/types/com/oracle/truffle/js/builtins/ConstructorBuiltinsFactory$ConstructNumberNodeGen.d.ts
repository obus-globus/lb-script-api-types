...
export class ConstructorBuiltinsFactory$ConstructNumberNodeGen extends ConstructorBuiltins$ConstructNumberNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructNumberNode;
