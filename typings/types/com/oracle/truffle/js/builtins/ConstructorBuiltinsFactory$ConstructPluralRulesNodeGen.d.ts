...
import type { ConstructorBuiltins$ConstructPluralRulesNode } from '../../../../../com/oracle/truffle/js/builtins/ConstructorBuiltins$ConstructPluralRulesNode.d.ts'
...
export class ConstructorBuiltinsFactory$ConstructPluralRulesNodeGen extends ConstructorBuiltins$ConstructPluralRulesNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramnewTargetCase: boolean, paramarguments: JavaScriptNode[]): ConstructorBuiltins$ConstructPluralRulesNode;
