...
export class ConstructorBuiltinsFactory$ConstructPluralRulesNodeGen extends ConstructorBuiltins$ConstructPluralRulesNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramnewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructPluralRulesNode;
