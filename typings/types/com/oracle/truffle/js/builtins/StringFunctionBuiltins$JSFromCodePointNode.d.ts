...
export abstract class StringFunctionBuiltins$JSFromCodePointNode extends JSBuiltinNode {
    ...
    fromCodePoint(args: Object[], toNumberNode: JSToNumberNode, fromCodePointNode: TruffleString$FromCodePointNode, concatNode: TruffleString$ConcatNode): Object;
}