...
export abstract class RegExpPrototypeBuiltins$CompiledRegexFlagPropertyAccessor extends JSBuiltinNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramflagName: string, paramargs: JavaScriptNode[]): RegExpPrototypeBuiltins$CompiledRegexFlagPropertyAccessor;
