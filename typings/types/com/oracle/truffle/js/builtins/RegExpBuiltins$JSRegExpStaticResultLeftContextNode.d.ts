...
export abstract class RegExpBuiltins$JSRegExpStaticResultLeftContextNode extends RegExpBuiltins$JSRegExpStaticResultPropertyNode {
    ...
    leftContext(frame: VirtualFrame, substringNode: TruffleString$SubstringByteIndexNode, readIsMatch: TRegexUtil$InteropReadBooleanMemberNode, getStart: TRegexUtil$InvokeGetGroupBoundariesMethodNode, getResultNode: RegExpBuiltins$GetStaticRegExpResultNode): TruffleString;
}