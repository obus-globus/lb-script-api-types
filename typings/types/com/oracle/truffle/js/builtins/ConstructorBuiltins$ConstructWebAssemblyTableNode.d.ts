...
export abstract class ConstructorBuiltins$ConstructWebAssemblyTableNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    // private getElementNode: PropertyGetNode;
    // private getInitialNode: PropertyGetNode;
    // private getMaximumNode: PropertyGetNode;
    // private isObjectNode: IsObjectNode;
    // private tableAllocLib: InteropLibrary;
    // private toInitialSizeNode: ToWebAssemblyIndexOrSizeNode;
    // private toMaximumSizeNode: ToWebAssemblyIndexOrSizeNode;
    constructTable(newTarget: JSDynamicObject, descriptor: Object, args: Object[], toStringNode: JSToStringNode, toJavaString: TruffleString$ToJavaStringNode, toWebAssemblyValueNode: ToWebAssemblyValueNode): JSObject;
