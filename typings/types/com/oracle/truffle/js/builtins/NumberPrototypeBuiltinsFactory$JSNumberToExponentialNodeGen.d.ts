...
export class NumberPrototypeBuiltinsFactory$JSNumberToExponentialNodeGen extends NumberPrototypeBuiltins$JSNumberToExponentialNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): NumberPrototypeBuiltins$JSNumberToExponentialNode;
    ...
    // private getDoubleValue: NumberPrototypeBuiltins$ForeignGetDoubleValueNode;
