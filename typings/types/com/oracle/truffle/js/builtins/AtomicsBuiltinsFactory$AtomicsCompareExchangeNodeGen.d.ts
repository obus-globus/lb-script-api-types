...
import type { AtomicsBuiltins$AtomicsCompareExchangeNode } from '../../../../../com/oracle/truffle/js/builtins/AtomicsBuiltins$AtomicsCompareExchangeNode.d.ts'
...
export class AtomicsBuiltinsFactory$AtomicsCompareExchangeNodeGen extends AtomicsBuiltins$AtomicsCompareExchangeNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): AtomicsBuiltins$AtomicsCompareExchangeNode;
    ...
    // private execute_int_int1(state_0__: number, frameValue: VirtualFrame): Object;
    // private execute_int_int_int0(state_0__: number, frameValue: VirtualFrame): Object;
