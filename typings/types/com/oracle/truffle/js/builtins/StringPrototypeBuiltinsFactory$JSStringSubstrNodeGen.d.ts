...
import type { StringPrototypeBuiltins$JSStringSubstrNode } from '../../../../../com/oracle/truffle/js/builtins/StringPrototypeBuiltins$JSStringSubstrNode.d.ts'
...
export class StringPrototypeBuiltinsFactory$JSStringSubstrNodeGen extends StringPrototypeBuiltins$JSStringSubstrNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramarguments: JavaScriptNode[]): StringPrototypeBuiltins$JSStringSubstrNode;
