...
export abstract class StringPrototypeBuiltins$JSStringRepeatNode extends StringPrototypeBuiltins$JSStringOperation {
    ...
    repeat(thisObj: Object, count: Object, toNumberNode: JSToNumberNode, repeatNode: TruffleString$RepeatNode, errorBranch: InlinedBranchProfile): Object;
}