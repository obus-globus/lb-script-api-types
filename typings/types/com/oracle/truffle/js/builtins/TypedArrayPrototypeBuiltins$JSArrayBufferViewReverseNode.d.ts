...
export abstract class TypedArrayPrototypeBuiltins$JSArrayBufferViewReverseNode extends ArrayPrototypeBuiltins$JSArrayOperation {
    ...
    reverse(thisObj: JSTypedArrayObject, deletePropertyNode: DeletePropertyNode): JSDynamicObject;
    reverse(thisJSObj: Object): Object;
}