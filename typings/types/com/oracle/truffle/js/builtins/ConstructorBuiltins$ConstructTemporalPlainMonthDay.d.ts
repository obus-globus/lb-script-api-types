...
export abstract class ConstructorBuiltins$ConstructTemporalPlainMonthDay extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    constructTemporalPlainMonthDay(newTarget: JSDynamicObject, isoMonth: Object, isoDay: Object, calendarParam: Object, referenceISOYear: Object, errorBranch: InlinedBranchProfile, toInt: JSToIntegerWithTruncationNode, toJavaString: TruffleString$ToJavaStringNode, fromJavaString: TruffleString$FromJavaStringNode): JSDynamicObject;
