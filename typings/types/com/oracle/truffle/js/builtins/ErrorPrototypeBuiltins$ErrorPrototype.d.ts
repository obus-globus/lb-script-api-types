...
export class ErrorPrototypeBuiltins$ErrorPrototype extends Enum<ErrorPrototypeBuiltins$ErrorPrototype> implements BuiltinEnum<ErrorPrototypeBuiltins$ErrorPrototype> {
    ...
    asEnum(): ErrorPrototypeBuiltins$ErrorPrototype;
