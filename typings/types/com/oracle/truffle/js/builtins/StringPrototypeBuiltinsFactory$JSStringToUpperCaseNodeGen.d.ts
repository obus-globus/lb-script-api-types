...
import type { StringPrototypeBuiltins$JSStringToUpperCaseNode } from '../../../../../com/oracle/truffle/js/builtins/StringPrototypeBuiltins$JSStringToUpperCaseNode.d.ts'
...
export class StringPrototypeBuiltinsFactory$JSStringToUpperCaseNodeGen extends StringPrototypeBuiltins$JSStringToUpperCaseNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramlocale: boolean, paramarguments: JavaScriptNode[]): StringPrototypeBuiltins$JSStringToUpperCaseNode;
    ...
    // private toUpperCaseString_codeRangeEquals_: TruffleString$CodeRangeEqualsNode;
    // private toUpperCaseString_copyToByteArrayNode_: TruffleString$CopyToByteArrayNode;
    // private toUpperCaseString_fromByteArrayNode_: TruffleString$FromByteArrayNode;
    // private toUpperCaseString_indexOfCodePointSet_: TruffleString$ByteIndexOfCodePointSetNode;
    // private toUpperCaseString_switchEncodingNode_: TruffleString$SwitchEncodingNode;
