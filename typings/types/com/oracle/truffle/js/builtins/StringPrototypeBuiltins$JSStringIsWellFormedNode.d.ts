...
export abstract class StringPrototypeBuiltins$JSStringIsWellFormedNode extends StringPrototypeBuiltins$JSStringOperation {
    ...
    doOther(thisObj: Object, isValidNode: TruffleString$IsValidNode): Object;
}