...
import type { ConstructorBuiltins$ConstructTemporalPlainDateTimeNode } from '../../../../../com/oracle/truffle/js/builtins/ConstructorBuiltins$ConstructTemporalPlainDateTimeNode.d.ts'
...
export class ConstructorBuiltinsFactory$ConstructTemporalPlainDateTimeNodeGen extends ConstructorBuiltins$ConstructTemporalPlainDateTimeNode {
    static ARGUMENTS: string;
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: JavaScriptNode[]): ConstructorBuiltins$ConstructTemporalPlainDateTimeNode;
