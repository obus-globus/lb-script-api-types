...
export class ConstructorBuiltinsFactory$ConstructRegExpNodeGen extends ConstructorBuiltins$ConstructRegExpNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisCall: boolean, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructRegExpNode;
