...
export abstract class ConstructorBuiltins$ConstructFinalizationRegistryNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    constructFinalizationRegistry(newTarget: JSDynamicObject, cleanupCallback: Object): JSObject;
    constructFinalizationRegistryNonObject(newTarget: JSDynamicObject, cleanupCallback: Object): JSObject;
