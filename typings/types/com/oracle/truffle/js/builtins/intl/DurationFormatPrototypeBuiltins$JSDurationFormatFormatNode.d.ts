...
export abstract class DurationFormatPrototypeBuiltins$JSDurationFormatFormatNode extends JSBuiltinNode {
    ...
    format(durationFormat: JSDurationFormatObject, duration: Object, toTemporalDurationRecord: ToTemporalDurationRecordNode, fromJavaString: TruffleString$FromJavaStringNode): TruffleString;
    throwTypeError(bummer: Object, value: Object): TruffleString;
}