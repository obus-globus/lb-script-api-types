...
export abstract class LocalePrototypeBuiltins$JSLocaleFirstDayOfWeekAccessor extends JSBuiltinNode {
    ...
    doLocale(localeObject: JSLocaleObject, fromJavaScriptNode: TruffleString$FromJavaStringNode): Object;
