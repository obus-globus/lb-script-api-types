...
export class DurationFormatPrototypeBuiltins$DurationFormatPrototype extends Enum<DurationFormatPrototypeBuiltins$DurationFormatPrototype> implements BuiltinEnum<DurationFormatPrototypeBuiltins$DurationFormatPrototype> {
    static format: DurationFormatPrototypeBuiltins$DurationFormatPrototype;
