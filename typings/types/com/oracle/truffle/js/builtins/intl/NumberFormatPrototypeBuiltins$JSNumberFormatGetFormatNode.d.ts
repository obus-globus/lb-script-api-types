...
export abstract class NumberFormatPrototypeBuiltins$JSNumberFormatGetFormatNode extends JSBuiltinNode {
    ...
    doNumberFormat(numberFormatObj: JSNumberFormatObject, errorBranch: InlinedBranchProfile): Object;
}