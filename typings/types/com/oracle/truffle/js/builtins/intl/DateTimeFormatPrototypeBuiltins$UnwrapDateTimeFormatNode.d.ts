...
export abstract class DateTimeFormatPrototypeBuiltins$UnwrapDateTimeFormatNode extends JSBuiltinNode {
    ...
    // private readFallbackSymbolNode: ReadElementNode;
    unwrapDateTimeFormat(receiver: Object, errorBranch: InlinedBranchProfile): JSDateTimeFormatObject;
}