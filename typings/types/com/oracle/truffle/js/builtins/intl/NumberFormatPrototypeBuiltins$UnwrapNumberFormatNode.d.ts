...
export abstract class NumberFormatPrototypeBuiltins$UnwrapNumberFormatNode extends JSBuiltinNode {
    ...
    unwrapNumberFormat(receiver: Object, errorBranch: InlinedBranchProfile): JSNumberFormatObject;
}