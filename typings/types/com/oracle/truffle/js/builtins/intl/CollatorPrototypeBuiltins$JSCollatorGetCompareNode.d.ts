...
export abstract class CollatorPrototypeBuiltins$JSCollatorGetCompareNode extends JSBuiltinNode {
    ...
    doCollator(collatorObj: JSCollatorObject, errorBranch: InlinedBranchProfile): Object;
