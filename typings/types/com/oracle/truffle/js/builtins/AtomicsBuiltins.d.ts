...
import type { AtomicsBuiltins$Atomics } from '../../../../../com/oracle/truffle/js/builtins/AtomicsBuiltins$Atomics.d.ts'
...
export class AtomicsBuiltins extends JSBuiltinsContainer$SwitchEnum<AtomicsBuiltins$Atomics> {
    ...
    constructor()
    createNode(context: JSContext, builtin: JSBuiltin, construct: boolean, newTarget: boolean, builtinEnum: AtomicsBuiltins$Atomics): Object;
}