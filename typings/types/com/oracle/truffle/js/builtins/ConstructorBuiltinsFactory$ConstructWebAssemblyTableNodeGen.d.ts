...
export class ConstructorBuiltinsFactory$ConstructWebAssemblyTableNodeGen extends ConstructorBuiltins$ConstructWebAssemblyTableNode {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramnewTargetCase: boolean, paramarguments: JavaScriptNode[]): ConstructorBuiltins$ConstructWebAssemblyTableNode;
