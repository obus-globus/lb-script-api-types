...
export abstract class ConstructorBuiltins$ConstructTemporalInstant extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    constructTemporalInstant(newTarget: JSDynamicObject, epochNanoseconds: Object, errorBranch: InlinedBranchProfile): JSDynamicObject;
