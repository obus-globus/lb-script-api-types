...
export class ConstructorBuiltinsFactory$ConstructTemporalPlainMonthDayNodeGen extends ConstructorBuiltins$ConstructTemporalPlainMonthDay {
    ...
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: (Object | null)[]): ConstructorBuiltins$ConstructTemporalPlainMonthDay;
