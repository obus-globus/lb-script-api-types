...
import type { ConstructorBuiltins$ConstructTemporalPlainMonthDay } from '../../../../../com/oracle/truffle/js/builtins/ConstructorBuiltins$ConstructTemporalPlainMonthDay.d.ts'
...
export class ConstructorBuiltinsFactory$ConstructTemporalPlainMonthDayNodeGen extends ConstructorBuiltins$ConstructTemporalPlainMonthDay {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramisNewTargetCase: boolean, paramarguments: JavaScriptNode[]): ConstructorBuiltins$ConstructTemporalPlainMonthDay;
    ...
    // private toInt_: JSToIntegerWithTruncationNode;
