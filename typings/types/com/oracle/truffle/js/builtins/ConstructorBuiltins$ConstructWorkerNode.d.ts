...
export abstract class ConstructorBuiltins$ConstructWorkerNode extends ConstructorBuiltins$ConstructWithNewTargetNode {
    ...
    construct(newTarget: JSDynamicObject, codeParam: Object, options: Object): JSObject;
