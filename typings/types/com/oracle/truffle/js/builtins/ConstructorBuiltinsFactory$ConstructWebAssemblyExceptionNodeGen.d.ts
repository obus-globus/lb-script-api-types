...
import type { ConstructorBuiltins$ConstructWebAssemblyExceptionNode } from '../../../../../com/oracle/truffle/js/builtins/ConstructorBuiltins$ConstructWebAssemblyExceptionNode.d.ts'
...
export class ConstructorBuiltinsFactory$ConstructWebAssemblyExceptionNodeGen extends ConstructorBuiltins$ConstructWebAssemblyExceptionNode {
    static ARGUMENTS: string;
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, parambuiltin: JSBuiltin, paramnewTargetCase: boolean, paramarguments: JavaScriptNode[]): ConstructorBuiltins$ConstructWebAssemblyExceptionNode;
    ...
    // private stackTraceLimitNode_: ErrorStackTraceLimitNode;
    ...
    // private executeAndSpecialize(arguments0Value: Object, arguments1Value: Object, arguments2Value: Object, arguments3Value: Object): JSObject;
