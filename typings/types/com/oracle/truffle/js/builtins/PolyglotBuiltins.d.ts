...
import type { PolyglotBuiltins$Polyglot } from '../../../../../com/oracle/truffle/js/builtins/PolyglotBuiltins$Polyglot.d.ts'
...
export class PolyglotBuiltins extends JSBuiltinsContainer$SwitchEnum<PolyglotBuiltins$Polyglot> {
    ...
    constructor()
    createNode(context: JSContext, builtin: JSBuiltin, construct: boolean, newTarget: boolean, builtinEnum: PolyglotBuiltins$Polyglot): Object;
}