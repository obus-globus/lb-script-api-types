...
export class AsyncDisposeResourcesWrapperNode extends AbstractAwaitNode implements ResumableNode$WithIntState {
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramcontext: JSContext, paramstateSlot: number, paramcapabilityNode: JavaScriptNode, paramerrorNode: JavaScriptNode, paramasyncContextNode: JSReadFrameSlotNode, paramasyncResultNode: JSReadFrameSlotNode): JavaScriptNode;
    ...
    private constructor(context: JSContext, stateSlot: number, capabilityNode: JavaScriptNode, errorNode: JavaScriptNode, asyncContextNode: JSReadFrameSlotNode, asyncResultNode: JSReadFrameSlotNode)
