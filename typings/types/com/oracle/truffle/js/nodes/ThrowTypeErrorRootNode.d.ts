...
export class ThrowTypeErrorRootNode extends JavaScriptRealmBoundaryRootNode {
    ...
    constructor(language: JavaScriptLanguage, restrictedProperty: boolean)
    // private restrictedProperty: boolean;
