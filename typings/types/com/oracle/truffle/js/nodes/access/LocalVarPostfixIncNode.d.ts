...
export abstract class LocalVarPostfixIncNode extends LocalVarIncNode {
    ...
    doIntDouble(frame: Frame): number;
    doIntObject(frame: Frame): number;
    ...
    doSafeIntegerObject(frame: Frame): number;
