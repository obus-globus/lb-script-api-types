...
export class PropertyGetNode$JSProxyDispatcherRequiredPropertyGetNode extends PropertyGetNode$LinkedPropertyGetNode {
    ...
    // private proxyHas: JSProxyHasPropertyNode;
