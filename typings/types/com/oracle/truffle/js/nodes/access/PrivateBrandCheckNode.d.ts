...
export abstract class PrivateBrandCheckNode extends JSTargetableNode {
    ...
    constructor(targetNode: JavaScriptNode, brandNode: JavaScriptNode)
    // private brandNode: JavaScriptNode;
