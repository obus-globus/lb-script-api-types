...
export class LocalVarPrefixIncNodeGen$ObjectData extends Node implements DSLSupport$SpecializationDataNode {
    constructor()
    // private object_state_0_: number;
    // private overloadedOperatorNode_: JSOverloadedUnaryNode;
    // private toNumericOperand_: JSToNumericNode;
}