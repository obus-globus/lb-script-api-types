...
export abstract class WriteElementNode$JSObjectArrayWriteElementCacheNode extends WriteElementNode$RecursiveCachedArrayWriteElementCacheNode {
    static reportLoopCount(paramnode: Node, paramcount: number): void;
    constructor()
    doJSObjectArray(target: JSDynamicObject, jsobjectArray: AbstractJSObjectArray, index: number, value: Object, root: WriteElementNode, jsObjectValueBranch: InlinedBranchProfile, objectValueBranch: InlinedBranchProfile, inBoundsFastIf: InlinedConditionProfile, inBoundsIf: InlinedConditionProfile, supportedNonZeroIf: InlinedConditionProfile, supportedZeroIf: InlinedConditionProfile, supportedContiguousIf: InlinedConditionProfile, supportedHolesIf: InlinedConditionProfile, needPrototypeBranch: InlinedBranchProfile, setSupportedProfile: AbstractWritableArray$SetSupportedProfileAccess): boolean;
    // private executeWithJSObjectValueInner(target: JSDynamicObject, jsobjectArray: AbstractJSObjectArray, index: number, jsobjectValue: JSDynamicObject, root: WriteElementNode, inBoundsFastIf: InlinedConditionProfile, inBoundsIf: InlinedConditionProfile, supportedNonZeroIf: InlinedConditionProfile, supportedZeroIf: InlinedConditionProfile, supportedContiguousIf: InlinedConditionProfile, supportedHolesIf: InlinedConditionProfile, needPrototypeBranch: InlinedBranchProfile, setSupportedProfile: AbstractWritableArray$SetSupportedProfileAccess): boolean;
}