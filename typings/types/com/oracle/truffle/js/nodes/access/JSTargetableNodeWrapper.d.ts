...
export class JSTargetableNodeWrapper extends JSTargetableNode implements InstrumentableNode$WrapperNode {
    ...
    constructor(delegateNode: JSTargetableNode, probeNode: ProbeNode)
    ...
    getDelegateNode(): JSTargetableNode;
