...
export class EnumerableOwnPropertyNamesNodeGen$EnumerableOwnPropertyNamesForeign1Data extends Node implements DSLSupport$SpecializationDataNode {
    constructor()
    // private asString_: InteropLibrary;
    // private enumerableOwnPropertyNamesForeign1_state_0_: number;
