...
export abstract class DeclareGlobalVariableNode extends DeclareGlobalNode {
    ...
    doCached(globalObject: JSGlobalObject, context: JSContext, cache: PropertySetNode): void;
    doGeneric(globalObject: JSDynamicObject, context: JSContext): void;
    doUncached(globalObject: JSGlobalObject, context: JSContext): void;
    executeVoid(context: JSContext, realm: JSRealm): void;
    executeVoid(globalObject: JSDynamicObject, context: JSContext): void;
