...
export abstract class DifferenceZonedDateTimeWithRoundingNode extends JavaScriptBaseNode {
    ...
    constructor()
    execute(ns1: BigInt, ns2: BigInt, calendar: TruffleString, timeZone: TruffleString, precalculatedPlainDateTime: JSTemporalPlainDateTimeObject, largestUnit: TemporalUtil$Unit, roundingIncrement: number, smallestUnit: TemporalUtil$Unit, roundingMode: TemporalUtil$RoundingMode): JSTemporalDurationRecord;
}