...
export abstract class IsIdenticalBooleanNode extends IsIdenticalBaseNode {
    ...
    constructor(operand: JavaScriptNode, bool: boolean, leftConstant: boolean)
    // private bool: boolean;
    copyUninitialized(materializedTags: Class<Tag>[]): JavaScriptNode;
    doBoolean(a: boolean): boolean;
