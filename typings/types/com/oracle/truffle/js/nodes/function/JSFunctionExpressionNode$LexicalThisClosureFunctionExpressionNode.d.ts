...
export class JSFunctionExpressionNode$LexicalThisClosureFunctionExpressionNode extends JSFunctionExpressionNode {
    ...
    constructor(functionData: JSFunctionData, blockScopeSlot: number, thisNode: JavaScriptNode)
