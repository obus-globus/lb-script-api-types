...
export class JSFunctionCallNode$Invoke1Node extends JSFunctionCallNode$InvokeNode {
    ...
    constructor(targetNode: JavaScriptNode, functionNode: JSTargetableNode, argument0: JavaScriptNode, flags: number)
    constructor(functionNode: JSTargetableNode, argument0: JavaScriptNode, flags: number)
