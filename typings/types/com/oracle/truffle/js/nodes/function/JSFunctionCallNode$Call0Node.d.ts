...
export class JSFunctionCallNode$Call0Node extends JSFunctionCallNode$CallNode {
    ...
    constructor(targetNode: JavaScriptNode, functionNode: JavaScriptNode, flags: number)
