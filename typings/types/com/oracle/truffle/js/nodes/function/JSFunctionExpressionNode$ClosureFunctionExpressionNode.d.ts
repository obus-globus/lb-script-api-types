...
export class JSFunctionExpressionNode$ClosureFunctionExpressionNode extends JSFunctionExpressionNode {
    ...
    constructor(functionData: JSFunctionData, blockScopeSlot: number)
