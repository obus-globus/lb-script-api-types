...
export class NamedEvaluationTargetNodeWrapper extends NamedEvaluationTargetNode implements InstrumentableNode$WrapperNode {
    ...
    constructor(delegateNode: NamedEvaluationTargetNode, probeNode: ProbeNode)
    readonly delegateNode: NamedEvaluationTargetNode;
    ...
    getDelegateNode(): NamedEvaluationTargetNode;
