...
import type { JSBitwiseXorNode } from '../../../../../../com/oracle/truffle/js/nodes/binary/JSBitwiseXorNode.d.ts'
import type { JSBitwiseXorNodeGen$DoubleData } from '../../../../../../com/oracle/truffle/js/nodes/binary/JSBitwiseXorNodeGen$DoubleData.d.ts'
import type { JSBitwiseXorNodeGen$GenericData } from '../../../../../../com/oracle/truffle/js/nodes/binary/JSBitwiseXorNodeGen$GenericData.d.ts'
import type { JSOverloadedBinaryNode } from '../../../../../../com/oracle/truffle/js/nodes/binary/JSOverloadedBinaryNode.d.ts'
import type { Class } from '../../../../../../java/lang/Class.d.ts'
import type { Object } from '../../../../../../java/lang/Object.d.ts'
export class JSBitwiseXorNodeGen extends JSBitwiseXorNode {
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(paramleft: JavaScriptNode, paramright: JavaScriptNode): JavaScriptNode;
    static create(paramleft: JavaScriptNode, paramright: JavaScriptNode): JSBitwiseXorNode;
    static createInner(): JSBitwiseXorNode;
    ...
    // private double_cache: JSBitwiseXorNodeGen$DoubleData;
    // private generic_cache: JSBitwiseXorNodeGen$GenericData;
