...
export class JSModuloNodeGen$GenericData extends Node implements DSLSupport$SpecializationDataNode {
    constructor()
    // private generic_state_0_: number;
    // private nestedModuloNode_: JSModuloNode;
    // private toNumeric1Node_: JSToNumericNode;
    // private toNumeric2Node_: JSToNumericNode;
}