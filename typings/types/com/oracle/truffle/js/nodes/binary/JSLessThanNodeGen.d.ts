...
import type { JSLessThanNode } from '../../../../../../com/oracle/truffle/js/nodes/binary/JSLessThanNode.d.ts'
import type { JSLessThanNodeGen$GenericData } from '../../../../../../com/oracle/truffle/js/nodes/binary/JSLessThanNodeGen$GenericData.d.ts'
import type { JSLessThanNodeGen$OverloadedData } from '../../../../../../com/oracle/truffle/js/nodes/binary/JSLessThanNodeGen$OverloadedData.d.ts'
import type { JSStringToNumberNode } from '../../../../../../com/oracle/truffle/js/nodes/cast/JSStringToNumberNode.d.ts'
import type { Class } from '../../../../../../java/lang/Class.d.ts'
import type { Object } from '../../../../../../java/lang/Object.d.ts'
export class JSLessThanNodeGen extends JSLessThanNode {
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: (JavaScriptNode | null)[], parammaterializedTags: Class<Tag>[]): (JavaScriptNode | null)[];
    static create(): JSLessThanNode;
    static create(paramleft: JavaScriptNode, paramright: JavaScriptNode): JSLessThanNode;
    ...
    // private generic_cache: JSLessThanNodeGen$GenericData;
    // private overloaded_cache: JSLessThanNodeGen$OverloadedData;
