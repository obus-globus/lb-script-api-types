...
import type { JSLeftShiftConstantNode } from '../../../../../../com/oracle/truffle/js/nodes/binary/JSLeftShiftConstantNode.d.ts'
import type { JSLeftShiftConstantNodeGen$GenericData } from '../../../../../../com/oracle/truffle/js/nodes/binary/JSLeftShiftConstantNodeGen$GenericData.d.ts'
...
export class JSLeftShiftConstantNodeGen extends JSLeftShiftConstantNode {
    static cloneUninitialized(paramnode: JavaScriptNode | null, parammaterializedTags: Class<Tag>[]): JavaScriptNode | null;
    static cloneUninitialized(paramnodeArray: Object | null, parammaterializedTags: Class<Tag>[]): Object | null;
    static create(paramleft: JavaScriptNode, paramright: JavaScriptNode): JavaScriptNode;
    static create(paramoperand: JavaScriptNode, paramshiftValue: number): JSLeftShiftConstantNode;
    ...
    // private generic_cache: JSLeftShiftConstantNodeGen$GenericData;
