...
export abstract class JSAndNode extends JSLogicalNode {
    ...
    doBoolean(frame: VirtualFrame, leftValue: boolean, canShortCircuit: InlinedConditionProfile): Object;
    doGeneric(frame: VirtualFrame, leftValue: Object, toBoolean: JSToBooleanNode, canShortCircuit: InlinedConditionProfile): Object;
}