...
import type { JSGreaterThanNode } from '../../../../../../com/oracle/truffle/js/nodes/binary/JSGreaterThanNode.d.ts'
import type { JSGreaterThanNodeGen$GenericData } from '../../../../../../com/oracle/truffle/js/nodes/binary/JSGreaterThanNodeGen$GenericData.d.ts'
import type { JSGreaterThanNodeGen$OverloadedData } from '../../../../../../com/oracle/truffle/js/nodes/binary/JSGreaterThanNodeGen$OverloadedData.d.ts'
import type { JSStringToNumberNode } from '../../../../../../com/oracle/truffle/js/nodes/cast/JSStringToNumberNode.d.ts'
import type { Class } from '../../../../../../java/lang/Class.d.ts'
import type { Object } from '../../../../../../java/lang/Object.d.ts'
export class JSGreaterThanNodeGen extends JSGreaterThanNode {
    static cloneUninitialized<T extends JavaScriptNode>(paramnode: T, parammaterializedTags: Class<Tag>[]): T;
    static cloneUninitialized<T extends JavaScriptNode>(paramnodeArray: T[], parammaterializedTags: Class<Tag>[]): T[];
    static create(): JSGreaterThanNode;
    static create(paramleft: JavaScriptNode, paramright: JavaScriptNode): JSGreaterThanNode;
    ...
    // private generic_cache: JSGreaterThanNodeGen$GenericData;
    // private overloaded_cache: JSGreaterThanNodeGen$OverloadedData;
