...
export abstract class JSRightShiftNode extends JSBinaryNode {
    ...
    doBigInt(a: BigInt, b: BigInt, leftShift: JSLeftShiftNode): BigInt;
    doDouble(a: number, b: number, rightShift: JSRightShiftNode, leftInt32: JSToInt32Node, rightUInt32: JSToUInt32Node): Object;
    doIntDouble(a: number, b: number): number;
