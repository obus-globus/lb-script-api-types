...
export abstract class JSBitwiseOrConstantNode extends JSUnaryNode {
    ...
    doGenericIntCase(a: Object, toNumeric: JSToNumericNode, profileIsBigInt: InlinedConditionProfile, innerOrNode: JavaScriptNode): Object;
    ...
    makeCopy(): JSBitwiseOrConstantNode;
