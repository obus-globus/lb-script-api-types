...
export class JSAddConstantRightNumberNodeGen$PrimitiveConversionData extends Node implements DSLSupport$SpecializationDataNode {
    constructor()
    // private primitiveConversion_state_0_: number;
    // private toNumberA_: JSToNumberNode;
    // private toPrimitiveA_: JSToPrimitiveNode;
}