...
export abstract class JSExponentiateNode extends JSBinaryNode {
    ...
    doBigIntNegativeExponent(a: BigInt, b: BigInt): Object;
    doBigIntZero(a: BigInt, b: BigInt): BigInt;
    doBigIntZeroPowZero(a: BigInt, b: BigInt): BigInt;
