...
export abstract class ArrayLengthNode$SetArrayLengthOrDeleteNode extends ArrayLengthNode$ArrayLengthWriteNode {
    ...
    doGeneric(arrayObj: JSArrayObject, length: number, mustDeleteProfile: InlinedConditionProfile, setLengthProfile: ScriptArray$SetLengthProfileAccess): void;
}