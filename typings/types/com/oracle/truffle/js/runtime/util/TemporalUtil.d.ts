...
export class TemporalUtil extends Object {
    ...
    static TIME_LIKE_PROPERTIES: (Object | null)[];
    static UNTIL: number;
    ...
    static singularToPlural: Map<TruffleString, TruffleString>;
    static temporalFieldDefaults: Map<TruffleString, Object>;
    static unitMappingDate: Map<TruffleString, TemporalUtil$Unit>;
    static unitMappingDateOrAuto: Map<TruffleString, TemporalUtil$Unit>;
    static unitMappingDateTime: Map<TruffleString, TemporalUtil$Unit>;
    static unitMappingDateTimeOrAuto: Map<TruffleString, TemporalUtil$Unit>;
    static unitMappingTime: Map<TruffleString, TemporalUtil$Unit>;
    static unitMappingTimeOrAuto: Map<TruffleString, TemporalUtil$Unit>;
    static unitMappingTimeOrDay: Map<TruffleString, TemporalUtil$Unit>;
    static unitMappingYearMonth: Map<TruffleString, TemporalUtil$Unit>;
    static unitMappingYearMonthOrAuto: Map<TruffleString, TemporalUtil$Unit>;
