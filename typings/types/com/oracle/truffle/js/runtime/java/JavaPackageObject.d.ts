...
export class JavaPackageObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, packageName: TruffleString)
    readonly packageName: TruffleString;
    getClassName(): TruffleString;
    getPackageName(): TruffleString;
}