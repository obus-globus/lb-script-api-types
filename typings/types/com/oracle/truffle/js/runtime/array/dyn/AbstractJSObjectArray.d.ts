...
export abstract class AbstractJSObjectArray extends AbstractWritableArray {
    ...
    setInBounds(object: JSDynamicObject, index: number, value: JSDynamicObject, node: Node, profile: AbstractWritableArray$SetSupportedProfileAccess): void;
    setInBoundsFast(object: JSDynamicObject, index: number, value: JSDynamicObject): void;
    setSupported(object: JSDynamicObject, index: number, value: JSDynamicObject, node: Node, profile: AbstractWritableArray$SetSupportedProfileAccess): void;
    toDouble(object: JSDynamicObject, index: number, value: number): AbstractWritableArray;
    toHoles(object: JSDynamicObject, index: number, value: Object): AbstractJSObjectArray;
    toObject(object: JSDynamicObject, index: number, value: Object): AbstractWritableArray;
    withIntegrityLevel(newIntegrityLevel: number): AbstractJSObjectArray;
}