...
export class LazyRegexResultArray extends AbstractConstantLazyArray {
    ...
    static materializeGroup(paramcontext: JSContext, paramobject: JSDynamicObject, paramindex: number, paramlazyRegexResultNode: DynamicObjectLibrary, paramlazyRegexResultOriginalInputNode: DynamicObjectLibrary, paramnode: Node, paramsubstringNode: TruffleString$SubstringByteIndexNode, paramgetStartNode: TRegexUtil$InvokeGetGroupBoundariesMethodNode, paramgetEndNode: TRegexUtil$InvokeGetGroupBoundariesMethodNode): Object;
