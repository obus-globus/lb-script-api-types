...
export class ContiguousObjectArray extends AbstractContiguousObjectArray {
    ...
    static makeContiguousObjectArray(paramobject: JSDynamicObject, paramlength: number, paramarray: (Object | null)[], paramindexOffset: number, paramarrayOffset: number, paramusedLength: number, paramintegrityLevel: number): ContiguousObjectArray;
