...
export class ZeroBasedObjectArray extends AbstractObjectArray {
    ...
    static createZeroBasedObjectArray(): ZeroBasedObjectArray;
    ...
    static makeZeroBasedObjectArray(paramobject: JSDynamicObject, paramlength: number, paramusedLength: number, paramarray: (Object | null)[], paramintegrityLevel: number): ZeroBasedObjectArray;
    ...
    toContiguous(object: JSDynamicObject, index: number, value: Object): ContiguousObjectArray;
    toHoles(object: JSDynamicObject, index: number, value: Object): HolesObjectArray;
    withIntegrityLevel(newIntegrityLevel: number): ZeroBasedObjectArray;
}