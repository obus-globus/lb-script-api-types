...
export class ZeroBasedObjectArray extends AbstractObjectArray {
    ...
    static makeZeroBasedObjectArray(paramobject: JSDynamicObject, paramlength: number, paramusedLength: number, paramarray: Object[], paramintegrityLevel: number): ZeroBasedObjectArray;
