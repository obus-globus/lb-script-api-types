...
export class HolesJSObjectArray extends AbstractContiguousJSObjectArray {
    ...
    static makeHolesJSObjectArray(paramobject: JSDynamicObject, paramlength: number, paramarray: (Object | null)[], paramindexOffset: number, paramarrayOffset: number, paramusedLength: number, paramholeCount: number, paramintegrityLevel: number): HolesJSObjectArray;
