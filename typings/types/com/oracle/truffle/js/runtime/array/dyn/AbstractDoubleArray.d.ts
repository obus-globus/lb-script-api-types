...
export abstract class AbstractDoubleArray extends AbstractWritableArray {
    ...
    toHoles(object: JSDynamicObject, index: number, value: Object): AbstractDoubleArray;
    withIntegrityLevel(newIntegrityLevel: number): AbstractDoubleArray;
}