...
export class HolesObjectArray extends AbstractContiguousObjectArray {
    ...
    static makeHolesObjectArray(paramobject: JSDynamicObject, paramlength: number, paramarray: Object[], paramindexOffset: number, paramarrayOffset: number, paramusedLength: number, paramholeCount: number, paramintegrityLevel: number): HolesObjectArray;
