...
import type { JSLocale$InternalState } from '../../../../../../../com/oracle/truffle/js/runtime/builtins/intl/JSLocale$InternalState.d.ts'
...
export class JSLocale extends JSNonProxy implements JSConstructorFactory$Default, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSLocale;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject): JSLocaleObject;
    ...
    static isJSLocale(paramobj: Object): boolean;
    ...
    static setupInternalState(paramstate: JSLocale$InternalState, paramlocale: Locale): void;
