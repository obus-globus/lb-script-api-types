...
export class JSDateObject extends JSNonProxyObject {
    ...
    static create(paramshape: Shape, paramproto: JSDynamicObject, paramvalue: number): JSDateObject;
    ...
    constructor(shape: Shape, proto: JSDynamicObject, value: number)
    // private value: number;
    asDate(self: InteropLibrary): LocalDate;
    asTime(self: InteropLibrary): LocalTime;
    asTimeZone(self: InteropLibrary): ZoneId;
