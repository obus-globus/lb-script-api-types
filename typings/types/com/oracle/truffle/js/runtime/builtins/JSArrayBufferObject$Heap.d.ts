...
export class JSArrayBufferObject$Heap extends JSArrayBufferObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, byteArray: number[], byteLength: number, maxByteLength: number)
    byteArray: number[];
