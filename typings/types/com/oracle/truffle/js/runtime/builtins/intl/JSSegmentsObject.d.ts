...
export class JSSegmentsObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, segmentsSegmenter: JSSegmenterObject, segmentsString: TruffleString)
    readonly segmentsSegmenter: JSSegmenterObject;
    readonly segmentsString: TruffleString;
    getSegmentsSegmenter(): JSSegmenterObject;
    getSegmentsString(): TruffleString;
}