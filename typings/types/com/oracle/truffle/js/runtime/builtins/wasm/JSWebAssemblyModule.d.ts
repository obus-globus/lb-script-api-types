...
export class JSWebAssemblyModule extends JSNonProxy implements JSConstructorFactory$WithFunctions, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSWebAssemblyModule;
    static WEB_ASSEMBLY_MODULE: TruffleString;
    static checkProtoCycle(paramthisObj: JSDynamicObject, paramnewPrototype: JSDynamicObject): boolean;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramwasmModule: Object, paramwasmSource: Source): JSWebAssemblyModuleObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramwasmModule: Object, paramwasmSource: Source): JSWebAssemblyModuleObject;
