...
export class JSWrapForValidAsyncIterator extends JSNonProxy implements JSConstructorFactory$Default, PrototypeSupplier {
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSWrapForValidAsyncIterator;
    static checkProtoCycle(paramthisObj: JSDynamicObject, paramnewPrototype: JSDynamicObject): boolean;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramiteratorRecord: IteratorRecord): JSWrapForValidAsyncIteratorObject;
    ...
    static isWrapForAsyncIterator(paramobj: Object): boolean;
