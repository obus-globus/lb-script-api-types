...
export class JSDateTimeFormatObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, internalState: JSDateTimeFormat$InternalState)
    readonly internalState: JSDateTimeFormat$InternalState;
    getClassName(): TruffleString;
    getInternalState(): JSDateTimeFormat$InternalState;
}