...
import type { JSRelativeTimeFormat$InternalState } from '../../../../../../../com/oracle/truffle/js/runtime/builtins/intl/JSRelativeTimeFormat$InternalState.d.ts'
...
export class JSRelativeTimeFormatObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, internalState: JSRelativeTimeFormat$InternalState)
    readonly internalState: JSRelativeTimeFormat$InternalState;
    getClassName(): TruffleString;
    getInternalState(): JSRelativeTimeFormat$InternalState;
}