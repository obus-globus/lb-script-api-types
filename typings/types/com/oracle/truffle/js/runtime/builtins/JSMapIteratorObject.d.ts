...
import type { JSCollectionIteratorObject } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSCollectionIteratorObject.d.ts'
...
export class JSMapIteratorObject extends JSCollectionIteratorObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, iteratedObject: Object, nextIndex: JSHashMap$Cursor, iterationKind: number)
