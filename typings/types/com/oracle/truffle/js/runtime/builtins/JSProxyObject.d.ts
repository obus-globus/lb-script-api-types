...
import type { JSClassObject } from '../../../../../../com/oracle/truffle/js/runtime/objects/JSClassObject.d.ts'
...
export class JSProxyObject extends JSClassObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, proxyTarget: Object, proxyHandler: JSDynamicObject)
    readonly proxyHandler: JSDynamicObject;
    readonly proxyTarget: Object;
