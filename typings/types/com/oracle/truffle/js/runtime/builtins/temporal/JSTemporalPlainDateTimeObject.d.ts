...
export class JSTemporalPlainDateTimeObject extends JSTemporalCalendarHolder {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, year: number, month: number, day: number, hours: number, minutes: number, seconds: number, milliseconds: number, microseconds: number, nanoseconds: number, calendar: TruffleString)
    readonly day: number;
