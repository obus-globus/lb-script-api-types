...
export class JSWebAssemblyTable extends JSNonProxy implements JSConstructorFactory$Default, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSWebAssemblyTable;
    ...
    static isJSWebAssemblyTable(paramobject: Object): boolean;
