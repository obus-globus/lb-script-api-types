...
export abstract class JSArrayBufferViewBase extends JSNonProxyObject {
    ...
    readonly arrayBuffer: JSArrayBufferObject;
    // private length: number;
    // private offset: number;
    getArrayBuffer(): JSArrayBufferObject;
    getByteOffset(): number;
    hasAutoLength(): boolean;
}