...
export class JSTemporalPlainYearMonth extends JSNonProxy implements JSConstructorFactory$WithFunctions, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSTemporalPlainYearMonth;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramisoYear: number, paramisoMonth: number, paramcalendar: TruffleString, paramreferenceISODay: number, paramnode: Node, paramerrorBranch: InlinedBranchProfile): JSTemporalPlainYearMonthObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramisoYear: number, paramisoMonth: number, paramcalendar: TruffleString, paramreferenceISODay: number, paramnode: Node, paramerrorBranch: InlinedBranchProfile): JSTemporalPlainYearMonthObject;
    ...
    static isJSTemporalPlainYearMonth(paramobj: Object): boolean;
    ...
    static temporalYearMonthToString(paramym: JSTemporalPlainYearMonthObject, paramshowCalendar: TemporalUtil$ShowCalendar): TruffleString;
