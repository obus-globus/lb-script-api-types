...
import type { JSCopyableObject } from '../../../../../../com/oracle/truffle/js/runtime/objects/JSCopyableObject.d.ts'
...
export class JSArrayObject extends JSArrayBase implements JSCopyableObject {
    ...
    static create(paramshape: Shape, paramproto: JSDynamicObject, paramarrayType: DynamicArray, paramarray: Object, paramsite: ArrayAllocationSite, paramlength: number, paramusedLength: number, paramindexOffset: number, paramarrayOffset: number, paramholeCount: number): JSArrayObject;
    static createEmpty(paramshape: Shape, paramproto: JSDynamicObject, paramarrayType: DynamicArray): JSArrayObject;
    ...
    constructor(shape: Shape, proto: JSDynamicObject, arrayType: DynamicArray, array: Object, site: ArrayAllocationSite, length: number, usedLength: number, indexOffset: number, arrayOffset: number, holeCount: number)
    copy(): JSObject;
    ...
    isArrayElementModifiable(index: number, elements: ArrayElementInfoNode): boolean;
    isArrayElementReadable(index: number, thisLibrary: InteropLibrary): boolean;
    isArrayElementRemovable(index: number, elements: ArrayElementInfoNode): boolean;
    readArrayElement(index: number, self: InteropLibrary, readNode: ReadElementNode, exportNode: ExportValueNode): Object;
    removeArrayElement(index: number, elements: ArrayElementInfoNode): void;
    toDisplayStringImpl(allowSideEffects: boolean, format: ToDisplayStringFormat, depth: number): TruffleString;
    writeArrayElement(index: number, value: Object, elements: ArrayElementInfoNode, castValueNode: ImportValueNode, writeNode: WriteElementNode): void;
}