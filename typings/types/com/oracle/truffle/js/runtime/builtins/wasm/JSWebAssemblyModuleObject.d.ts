...
export class JSWebAssemblyModuleObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, wasmModule: Object, wasmSource: Source)
    // private wasmModule: Object;
    // private wasmSource: Source;
    getClassName(): TruffleString;
    getWASMModule(): Object;
    getWASMSource(): Source;
}