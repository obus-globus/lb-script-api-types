...
import type { JSAsyncContextSnapshotObject } from '../../../../../../../com/oracle/truffle/js/runtime/builtins/asynccontext/JSAsyncContextSnapshotObject.d.ts'
...
export class JSAsyncContextSnapshot extends JSNonProxy implements JSConstructorFactory$WithFunctions, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSAsyncContextSnapshot;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramasyncContextMapping: AsyncContext): JSAsyncContextSnapshotObject;
    ...
    static isJSAsyncContextSnapshot(paramobject: Object): boolean;
