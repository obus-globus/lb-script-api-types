...
export class JSWebAssemblyExceptionObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, wasmException: AbstractTruffleException, type: JSWebAssemblyTagObject, payload: Object[])
    // private payload: Object[];
    readonly stack: TruffleString;
    // private type: JSWebAssemblyTagObject;
    readonly wasmException: AbstractTruffleException;
    getClassName(): TruffleString;
    getStack(): TruffleString;
    getWasmException(): AbstractTruffleException;
    payload(): Object[];
    setStack(stack: TruffleString): void;
    type(): JSWebAssemblyTagObject;
}