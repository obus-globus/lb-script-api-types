...
export class JSGeneratorObject extends JSNonProxyObject {
    ...
    readonly generatorContext: MaterializedFrame;
    readonly generatorState: JSFunction$GeneratorState;
    readonly generatorTarget: CallTarget;
    getClassName(): TruffleString;
    getGeneratorContext(): MaterializedFrame;
    getGeneratorState(): JSFunction$GeneratorState;
    getGeneratorTarget(): CallTarget;
    setGeneratorContext(generatorContext: MaterializedFrame): void;
    setGeneratorState(generatorState: JSFunction$GeneratorState): void;
    setGeneratorTarget(generatorTarget: CallTarget): void;
}