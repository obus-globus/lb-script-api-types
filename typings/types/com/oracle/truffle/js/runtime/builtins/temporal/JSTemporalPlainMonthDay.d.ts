...
export class JSTemporalPlainMonthDay extends JSNonProxy implements JSConstructorFactory$WithFunctions, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSTemporalPlainMonthDay;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramisoMonth: number, paramisoDay: number, paramcalendar: TruffleString, paramreferenceISOYear: number, paramnode: Node, paramerrorBranch: InlinedBranchProfile): JSTemporalPlainMonthDayObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramisoMonth: number, paramisoDay: number, paramcalendar: TruffleString, paramreferenceISOYear: number, paramnode: Node, paramerrorBranch: InlinedBranchProfile): JSTemporalPlainMonthDayObject;
    ...
    static isJSTemporalPlainMonthDay(paramobj: Object): boolean;
    ...
    static temporalMonthDayToString(parammd: JSTemporalPlainMonthDayObject, paramshowCalendar: TemporalUtil$ShowCalendar): TruffleString;
