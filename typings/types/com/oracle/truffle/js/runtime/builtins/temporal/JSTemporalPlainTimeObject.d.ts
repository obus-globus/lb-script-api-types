...
export class JSTemporalPlainTimeObject extends JSTemporalCalendarHolder {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, hour: number, minute: number, second: number, millisecond: number, microsecond: number, nanosecond: number, calendar: TruffleString)
