...
export class JSPromiseObject extends JSNonProxyObject {
    ...
    static create(paramshape: Shape, paramproto: JSDynamicObject, parampromiseState: number): JSPromiseObject;
    ...
    constructor(shape: Shape, proto: JSDynamicObject, promiseState: number)
    readonly promiseFulfillReactions: SimpleArrayList<PromiseReactionRecord>;
    // private promiseIsHandled: boolean;
    readonly promiseRejectReactions: SimpleArrayList<PromiseReactionRecord>;
    readonly promiseResult: Object;
    readonly promiseState: number;
    allocatePromiseReactions(): void;
    clearPromiseReactions(): void;
    getClassName(): TruffleString;
    getPromiseFulfillReactions(): SimpleArrayList<PromiseReactionRecord>;
    getPromiseRejectReactions(): SimpleArrayList<PromiseReactionRecord>;
    getPromiseResult(): Object;
    getPromiseState(): number;
    isHandled(): boolean;
    setIsHandled(handled: boolean): void;
    setPromiseResult(promiseResult: Object): void;
    setPromiseState(promiseState: number): void;
