...
export class JSArrayBufferObject$Interop extends JSArrayBufferObject {
    ...
    static createHeapArrayBuffer(paramshape: Shape, paramproto: JSDynamicObject, parambyteArray: number[]): JSArrayBufferObject;
    ...
    constructor(shape: Shape, proto: JSDynamicObject, interopBuffer: Object)
    interopBuffer: Object;
    detachArrayBuffer(): void;
    getBufferSize(node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): number;
    getByteLength(): number;
    getByteLength(interop: InteropLibrary): number;
    getInteropBuffer(): Object;
    hasBufferElements(): boolean;
    isBufferWritable(interop: InteropLibrary): boolean;
    isDetached(): boolean;
    readBuffer(byteOffset: number, destination: number[], destinationOffset: number, length: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): void;
    readBufferByte(byteOffset: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): number;
    readBufferDouble(order: ByteOrder, byteOffset: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): number;
    readBufferFloat(order: ByteOrder, byteOffset: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): number;
    readBufferInt(order: ByteOrder, byteOffset: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): number;
    readBufferLong(order: ByteOrder, byteOffset: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): number;
    readBufferShort(order: ByteOrder, byteOffset: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): number;
    writeBufferByte(byteOffset: number, value: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): void;
    writeBufferDouble(order: ByteOrder, byteOffset: number, value: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): void;
    writeBufferFloat(order: ByteOrder, byteOffset: number, value: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): void;
    writeBufferInt(order: ByteOrder, byteOffset: number, value: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): void;
    writeBufferLong(order: ByteOrder, byteOffset: number, value: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): void;
    writeBufferShort(order: ByteOrder, byteOffset: number, value: number, node: Node, errorBranch: InlinedBranchProfile, interop: InteropLibrary): void;
}