...
export class JSAsyncGeneratorObject extends JSNonProxyObject {
    ...
    readonly asyncGeneratorContext: MaterializedFrame;
    readonly asyncGeneratorQueue: AsyncGeneratorRequest[];
    readonly asyncGeneratorState: JSFunction$AsyncGeneratorState;
    readonly asyncGeneratorTarget: CallTarget;
    readonly generatorBrand: Object;
    getAsyncGeneratorContext(): MaterializedFrame;
    getAsyncGeneratorQueue(): AsyncGeneratorRequest[];
    getAsyncGeneratorState(): JSFunction$AsyncGeneratorState;
    getAsyncGeneratorTarget(): CallTarget;
    getClassName(): TruffleString;
    getGeneratorBrand(): Object;
    hasGeneratorBrand(): boolean;
    setAsyncGeneratorContext(asyncGeneratorContext: MaterializedFrame): void;
    setAsyncGeneratorQueue(asyncGeneratorQueue: AsyncGeneratorRequest[]): void;
    setAsyncGeneratorState(asyncGeneratorState: JSFunction$AsyncGeneratorState): void;
    setAsyncGeneratorTarget(asyncGeneratorTarget: CallTarget): void;
    setGeneratorBrand(generatorBrand: Object): void;
}