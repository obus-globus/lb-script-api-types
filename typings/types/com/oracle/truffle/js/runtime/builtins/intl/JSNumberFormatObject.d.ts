...
export class JSNumberFormatObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, internalState: JSNumberFormat$InternalState)
    readonly internalState: JSNumberFormat$InternalState;
    getClassName(): TruffleString;
    getInternalState(): JSNumberFormat$InternalState;
}