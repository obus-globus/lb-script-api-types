...
export class JSDictionary extends JSNonProxy {
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSDictionary;
    ...
    static getValue(paramproperty: PropertyDescriptor, paramreceiver: Object, paramencapsulatingNode: Node): Object;
    ...
    static isJSDictionaryObject(paramobj: JSDynamicObject): boolean;
    static makeDictionaryObject(paramobj: JSDynamicObject, paramreason: string): void;
    static makeDictionaryShape(paramcontext: JSContext, paramprototype: JSDynamicObject): Shape;
