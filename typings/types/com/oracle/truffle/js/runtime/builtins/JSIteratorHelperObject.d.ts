...
export class JSIteratorHelperObject extends JSNonProxyObject {
    ...
    static create(paramfactory: JSObjectFactory, paramrealm: JSRealm, paraminitialState: JSFunction$GeneratorState, paramiteratorArgs: IteratorPrototypeBuiltins$IteratorArgs, paramnextImpl: JSFunctionObject): JSIteratorHelperObject;
    ...
    constructor(shape: Shape, proto: JSDynamicObject, initialState: JSFunction$GeneratorState, iteratorArgs: IteratorPrototypeBuiltins$IteratorArgs, nextImpl: JSFunctionObject)
    readonly generatorState: JSFunction$GeneratorState;
    readonly iteratorArgs: IteratorPrototypeBuiltins$IteratorArgs;
    readonly nextImpl: JSFunctionObject;
    getGeneratorState(): JSFunction$GeneratorState;
    getIteratorArgs(): IteratorPrototypeBuiltins$IteratorArgs;
    getNextImpl(): JSFunctionObject;
    setGeneratorState(generatorState: JSFunction$GeneratorState): void;
}