...
import type { JSFunctionObject$BoundOrWrapped } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSFunctionObject$BoundOrWrapped.d.ts'
...
export class JSFunctionObject$Bound extends JSFunctionObject$BoundOrWrapped {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, functionData: JSFunctionData, realm: JSRealm, classPrototype: Object, boundTargetFunction: Object, boundThis: Object, boundArguments: Object[])
    readonly boundArguments: Object[];
    readonly boundTargetFunction: Object;
    readonly boundThis: Object;
    getBoundArguments(): Object[];
    getBoundTargetFunction(): Object;
    getBoundThis(): Object;
    initializeName(): void;
}