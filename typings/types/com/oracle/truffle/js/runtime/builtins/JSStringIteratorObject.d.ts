...
export class JSStringIteratorObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, iteratedString: TruffleString, nextIndex: number)
    readonly iteratedString: TruffleString;
    readonly nextIndex: number;
    getClassName(): TruffleString;
    getIteratedString(): TruffleString;
    getNextIndex(): number;
    setIteratedString(iteratedString: TruffleString): void;
