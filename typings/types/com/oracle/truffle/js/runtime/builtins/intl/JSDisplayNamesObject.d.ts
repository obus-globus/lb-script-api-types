...
export class JSDisplayNamesObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, internalState: JSDisplayNames$InternalState)
    readonly internalState: JSDisplayNames$InternalState;
    getClassName(): TruffleString;
    getInternalState(): JSDisplayNames$InternalState;
}