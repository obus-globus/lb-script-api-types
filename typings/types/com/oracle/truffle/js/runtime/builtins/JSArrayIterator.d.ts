...
export class JSArrayIterator extends JSNonProxy implements JSConstructorFactory, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSArrayIterator;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramiteratedObject: Object, paramnextIndex: number, paramiterationKind: number): JSArrayIteratorObject;
