...
export class JSWebAssemblyTagObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, wasmTag: Object, parameterTypes: WebAssemblyType[])
    // private parameterTypes: WebAssemblyType[];
    readonly wasmTag: Object;
