...
export class JSDurationFormatObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, internalState: JSDurationFormat$InternalState)
    readonly internalState: JSDurationFormat$InternalState;
    getClassName(): TruffleString;
    getInternalState(): JSDurationFormat$InternalState;
}