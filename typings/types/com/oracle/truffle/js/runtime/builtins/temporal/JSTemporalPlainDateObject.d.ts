...
export class JSTemporalPlainDateObject extends JSTemporalCalendarHolder {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, year: number, month: number, day: number, calendar: TruffleString)
    readonly day: number;
