...
export class JSFinalizationRegistryObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, cleanupCallback: JobCallback, cells: FinalizationRecord[], referenceQueue: ReferenceQueue<Object>)
    cells: FinalizationRecord[];
    cleanupCallback: JobCallback;
    referenceQueue: ReferenceQueue<Object>;
    getCells(): FinalizationRecord[];
    getClassName(): TruffleString;
    getCleanupCallback(): JobCallback;
    getReferenceQueue(): ReferenceQueue<Object>;
