...
export class JSAsyncContextSnapshotObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, asyncContextMapping: AsyncContext)
    // private asyncContextMapping: AsyncContext;
    getAsyncSnapshotMapping(): AsyncContext;
