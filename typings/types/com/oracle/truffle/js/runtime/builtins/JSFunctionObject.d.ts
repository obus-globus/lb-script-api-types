...
export abstract class JSFunctionObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, functionData: JSFunctionData, enclosingFrame: MaterializedFrame, realm: JSRealm, classPrototype: Object)
    readonly classPrototype: Object;
    readonly enclosingFrame: MaterializedFrame;
    ...
    getClassPrototype(): Object;
    getEnclosingFrame(): MaterializedFrame;
    getFunctionData(): JSFunctionData;
    getLexicalThis(): Object;
    getMetaObjectName(): Object;
    getRealm(): JSRealm;
    getSourceLocation(): SourceSection;
    hasSourceLocation(): boolean;
    instantiate(args: Object[], self: InteropLibrary, callNode: JSInteropInstantiateNode, exportNode: ExportValueNode): Object;
    isExecutable(isCallable: IsCallableNode): boolean;
    isInstantiable(): boolean;
    isMetaInstance(instance: Object): boolean;
    isMetaObject(): boolean;
    setClassPrototype(classPrototype: Object): void;
