...
import type { JSArrayBufferObject$DirectBase } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSArrayBufferObject$DirectBase.d.ts'
...
export class JSArrayBufferObject$Shared extends JSArrayBufferObject$DirectBase {
    ...
    getByteLengthObject(): AtomicInteger;
    getClassName(): TruffleString;
    getWaiterList(): JSAgentWaiterList;
    isDetached(): boolean;
    setWaiterList(waiterList: JSAgentWaiterList): void;
    updateByteLength(expectedByteLength: number, newByteLength: number): boolean;
}