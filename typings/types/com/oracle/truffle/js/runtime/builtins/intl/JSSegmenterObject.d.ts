...
export class JSSegmenterObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, internalState: JSSegmenter$InternalState)
    readonly breakIterator: BreakIterator;
    readonly internalState: JSSegmenter$InternalState;
    getBreakIterator(): BreakIterator;
    getClassName(): TruffleString;
    getInternalState(): JSSegmenter$InternalState;
}