...
export class JSForInIterator extends JSNonProxy implements JSConstructorFactory, PrototypeSupplier {
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSForInIterator;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramiteratedObject: JSDynamicObject, paramiterateValues: boolean): JSForInIteratorObject;
