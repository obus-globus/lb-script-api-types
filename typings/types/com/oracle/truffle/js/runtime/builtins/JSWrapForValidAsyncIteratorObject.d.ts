...
import type { JSIteratorRecordObject } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSIteratorRecordObject.d.ts'
...
export class JSWrapForValidAsyncIteratorObject extends JSIteratorRecordObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, iterated: IteratorRecord)
