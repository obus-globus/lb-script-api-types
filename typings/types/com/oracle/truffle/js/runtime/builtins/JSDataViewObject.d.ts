...
export class JSDataViewObject extends JSArrayBufferViewBase {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, arrayBuffer: JSArrayBufferObject, length: number, offset: number)
    getByteLength(): number;
    getByteLengthFixed(): number;
