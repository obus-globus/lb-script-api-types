...
export class JSAdapterObject extends JSClassObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, adaptee: JSDynamicObject, overrides: JSDynamicObject)
    readonly adaptee: JSDynamicObject;
    readonly overrides: JSDynamicObject;
    getAdaptee(): JSDynamicObject;
    getClassName(): TruffleString;
    getMetaObject(): Object;
    getOverrides(): JSDynamicObject;
