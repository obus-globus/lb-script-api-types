...
export class JSWebAssemblyGlobalObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, wasmGlobal: Object, valueType: WebAssemblyValueType, mutable: boolean)
    readonly mutable: boolean;
    readonly valueType: WebAssemblyValueType;
    // private wasmGlobal: Object;
    getClassName(): TruffleString;
    getValueType(): WebAssemblyValueType;
    getWASMGlobal(): Object;
    isMutable(): boolean;
}