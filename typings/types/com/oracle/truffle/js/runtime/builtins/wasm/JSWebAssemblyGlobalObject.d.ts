...
export class JSWebAssemblyGlobalObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, wasmGlobal: Object, valueType: WebAssemblyType, mutable: boolean)
    readonly mutable: boolean;
    readonly valueType: WebAssemblyType;
    // private wasmGlobal: Object;
    getClassName(): TruffleString;
    getValueType(): WebAssemblyType;
