...
export class JSRegExpGroupsObject extends JSNonProxyObject implements JSCopyableObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, regexResult: Object, input: TruffleString, isIndices: boolean)
    // private input: TruffleString;
    // private isIndices: boolean;
    readonly regexResult: Object;
    copy(): JSObject;
    copyWithoutProperties(shape: Shape): JSObject;
    getClassName(): TruffleString;
    getInputString(): TruffleString;
    getRegexResult(): Object;
    isIndices(): boolean;
}