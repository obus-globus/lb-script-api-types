...
export class JSTemporalZonedDateTime extends JSNonProxy implements JSConstructorFactory$WithFunctions, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSTemporalZonedDateTime;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramnanoseconds: BigInt, paramtimeZone: TruffleString, paramcalendar: TruffleString): JSTemporalZonedDateTimeObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramnanoseconds: BigInt, paramtimeZone: TruffleString, paramcalendar: TruffleString): JSTemporalZonedDateTimeObject;
    ...
    static isJSTemporalZonedDateTime(paramobj: Object): boolean;
