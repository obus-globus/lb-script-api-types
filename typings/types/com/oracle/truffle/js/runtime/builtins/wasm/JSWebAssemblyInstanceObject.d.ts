...
export class JSWebAssemblyInstanceObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, wasmInstance: Object, exports: JSObject)
    readonly exports: JSObject;
    // private wasmInstance: Object;
    getClassName(): TruffleString;
    getExports(): JSObject;
    getWASMInstance(): Object;
}