...
import type { WorkerAgent } from '../../../../../../com/oracle/truffle/js/runtime/WorkerAgent.d.ts'
...
import type { JSWorkerObject } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSWorkerObject.d.ts'
...
export class JSWorker extends JSNonProxy implements JSConstructorFactory$Default, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSWorker;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramagent: WorkerAgent): JSWorkerObject;
    ...
    static isJSWorker(paramobject: Object): boolean;
