...
export class JSWebAssemblyTag extends JSNonProxy implements JSConstructorFactory$Default, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSWebAssemblyTag;
    static PROTOTYPE_NAME: TruffleString;
    static WEB_ASSEMBLY_TAG: TruffleString;
    static checkProtoCycle(paramthisObj: JSDynamicObject, paramnewPrototype: JSDynamicObject): boolean;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramwasmTag: Object, paramparameterTypes: WebAssemblyType[]): JSWebAssemblyTagObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramwasmTag: Object, paramparameterTypes: WebAssemblyType[]): JSWebAssemblyTagObject;
    ...
    static isJSWebAssemblyTag(paramobject: Object): boolean;
