...
export class JSNumberObject extends JSNonProxyObject {
    ...
    static create(paramshape: Shape, paramproto: JSDynamicObject, paramvalue: Number): JSNumberObject;
    ...
    constructor(shape: Shape, proto: JSDynamicObject, number: Number)
