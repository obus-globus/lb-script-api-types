...
export class WebAssemblyHostFunction extends Object implements TruffleObject {
    ...
    execute(args: Object[], node: Node, toWebAssemblyValueNode: ToWebAssemblyValueNode, toJSValueNode: ToJSValueNode, callNode: JSFunctionCallNode, errorBranch: InlinedBranchProfile, getIteratorNode: GetIteratorNode, iterableToListNode: IterableToListNode, self: InteropLibrary, exnAllocLib: InteropLibrary, getErrorObjectNode: TryCatchNode$GetErrorObjectNode): Object;
}