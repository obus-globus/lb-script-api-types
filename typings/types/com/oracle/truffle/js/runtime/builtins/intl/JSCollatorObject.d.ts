...
export class JSCollatorObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, internalState: JSCollator$InternalState)
    readonly internalState: JSCollator$InternalState;
    getClassName(): TruffleString;
    getInternalState(): JSCollator$InternalState;
}