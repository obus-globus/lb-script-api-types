...
export class JSAsyncContextVariableObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, asyncContextKey: Symbol, asyncContextDefaultValue: Object)
    readonly asyncContextDefaultValue: Object;
    readonly asyncContextKey: Symbol;
    getAsyncContextDefaultValue(): Object;
    getAsyncContextKey(): Symbol;
