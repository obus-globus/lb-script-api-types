...
import type { JSPluralRules$InternalState } from '../../../../../../../com/oracle/truffle/js/runtime/builtins/intl/JSPluralRules$InternalState.d.ts'
...
export class JSPluralRulesObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, internalState: JSPluralRules$InternalState)
    readonly internalState: JSPluralRules$InternalState;
    getClassName(): TruffleString;
    getInternalState(): JSPluralRules$InternalState;
}