...
export abstract class JSFunctionObject$BoundOrWrapped extends JSFunctionObject {
    ...
    readonly boundName: TruffleString;
    getBoundLength(): number;
    getBoundName(): TruffleString;
    initializeName(): void;
    setBoundLength(length: number): void;
    setBoundName(targetName: TruffleString, prefix: TruffleString): void;
}