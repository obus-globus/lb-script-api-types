...
export class JSOverloadedOperatorsObject extends JSOrdinaryObject {
    ...
    static create(paramcontext: JSContext, paramshape: Shape, paramproto: JSDynamicObject, paramoperatorSet: OperatorSet): JSOverloadedOperatorsObject;
    ...
    constructor(shape: Shape, proto: JSDynamicObject, operatorSet: OperatorSet)
    // private o0: Object;
    // private o1: Object;
    // private o2: Object;
    // private o3: Object;
    ...
    getOperatorSet(): OperatorSet;
    matchesOperatorCounter(operatorCounter: number): boolean;
}