...
export class JSTemporalPlainMonthDayObject extends JSTemporalCalendarHolder {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, isoMonth: number, isoDay: number, calendar: TruffleString, isoYear: number)
