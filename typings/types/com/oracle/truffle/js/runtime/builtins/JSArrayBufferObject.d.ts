...
export class JSArrayBufferObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, byteLength: number, maxByteLength: number)
    ...
    setByteLength(newByteLength: number): void;
}