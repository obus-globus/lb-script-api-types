...
import type { JSArrayBufferViewBase } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSArrayBufferViewBase.d.ts'
...
export class JSTypedArrayObject extends JSArrayBufferViewBase {
    static AUTO_LENGTH: number;
    ...
    static create(paramshape: Shape, paramproto: JSDynamicObject, paramarrayType: TypedArray, paramarrayBuffer: JSArrayBufferObject, paramlength: number, paramoffset: number): JSTypedArrayObject;
    ...
    constructor(shape: Shape, proto: JSDynamicObject, arrayType: TypedArray, arrayBuffer: JSArrayBufferObject, length: number, offset: number)
    readonly arrayType: TypedArray;
    getArraySize(self: InteropLibrary): number;
    getArrayType(): TypedArray;
    ...
    writeArrayElement(index: number, value: Object, castValueNode: ImportValueNode, writeNode: WriteElementNode, self: InteropLibrary): void;
}