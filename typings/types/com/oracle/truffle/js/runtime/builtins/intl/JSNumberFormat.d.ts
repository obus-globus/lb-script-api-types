...
export class JSNumberFormat extends JSNonProxy implements JSConstructorFactory$WithFunctions, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSNumberFormat;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm): JSNumberFormatObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject): JSNumberFormatObject;
    static createConstructor(paramrealm: JSRealm): JSConstructor;
    static currencyDigits(paramcontext: JSContext, paramcurrencyCode: string): number;
    static filterOwnPropertyKeys(paramownPropertyKeys: Object[], paramstrings: boolean, paramsymbols: boolean): Object[];
    static format(paramnumberFormatObj: JSNumberFormatObject, paramn: Object): TruffleString;
    static formatMV(paramnumberFormatObj: JSNumberFormatObject, parammv: Number): TruffleString;
    static formatRange(paramnumberFormatObj: JSNumberFormatObject, paramx: Number, paramy: Number): TruffleString;
    static formatRangeToParts(paramcontext: JSContext, paramrealm: JSRealm, paramnumberFormatObj: JSNumberFormatObject, paramx: Number, paramy: Number): JSArrayObject;
    static formatToParts(paramcontext: JSContext, paramrealm: JSRealm, paramnumberFormatObj: JSNumberFormatObject, paramx: Number): JSObject;
    ...
    static isJSNumberFormat(paramobj: Object): boolean;
    ...
    static resolvedOptions(paramcontext: JSContext, paramrealm: JSRealm, paramnumberFormatObj: JSNumberFormatObject): JSObject;
