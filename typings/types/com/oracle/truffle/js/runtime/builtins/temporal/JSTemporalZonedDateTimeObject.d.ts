...
export class JSTemporalZonedDateTimeObject extends JSTemporalCalendarHolder {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, nanoseconds: BigInt, timeZone: TruffleString, calendar: TruffleString)
    readonly nanoseconds: BigInt;
    readonly timeZone: TruffleString;
    asDate(): LocalDate;
    asTime(): LocalTime;
    asTimeZone(): ZoneId;
    getClassName(): TruffleString;
    getNanoseconds(): BigInt;
    getTimeZone(): TruffleString;
    // private getZoneIdIntl(): ZoneId;
    isTimeZone(): boolean;
    // private toInstant(): Instant;
}