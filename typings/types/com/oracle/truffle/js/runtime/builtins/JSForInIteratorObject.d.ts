...
export class JSForInIteratorObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, obj: JSDynamicObject, iterateValues: boolean)
    fastOwnKeys: boolean;
    iterateValues: boolean;
    object: JSDynamicObject;
    objectShape: Shape;
    objectWasVisited: boolean;
    protoDepth: number;
    remainingKeys: (Object | null)[];
    remainingKeysIndex: number;
    remainingKeysSize: number;
    visitedKeys: Object[];
    visitedShapes: Shape[];
    visitedShapesSize: number;
    addVisitedKey(key: Object): boolean;
    addVisitedShape(shape: Shape, node: Node, growBranch: InlinedBranchProfile): void;
    isVisitedKey(key: Object): boolean;
}