...
import type { JSIteratorObject } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSIteratorObject.d.ts'
...
export class JSIterator extends JSNonProxy implements JSConstructorFactory$WithFunctions, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSIterator;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject): JSIteratorObject;
