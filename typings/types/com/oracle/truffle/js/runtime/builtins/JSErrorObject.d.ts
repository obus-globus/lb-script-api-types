...
export class JSErrorObject extends JSNonProxyObject implements JSCopyableObject {
    ...
    static create(paramshape: Shape, paramproto: JSDynamicObject): JSErrorObject;
    ...
    readonly exception: GraalJSException;
    copy(): JSObject;
    copyWithoutProperties(shape: Shape): JSObject;
    getBuiltinToStringTag(): TruffleString;
    getClassName(): TruffleString;
    getException(): GraalJSException;
    getExceptionCause(exceptions: InteropLibrary): Object;
    getExceptionMessage(exceptions: InteropLibrary): Object;
    getExceptionStackTrace(exceptions: InteropLibrary): Object;
    getExceptionType(exceptions: InteropLibrary): ExceptionType;
    hasExceptionCause(exceptions: InteropLibrary): boolean;
    hasExceptionMessage(exceptions: InteropLibrary): boolean;
    hasExceptionStackTrace(exceptions: InteropLibrary): boolean;
    isException(): boolean;
    isExceptionIncompleteSource(exceptions: InteropLibrary): boolean;
    setException(exception: GraalJSException): void;
