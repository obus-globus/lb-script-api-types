...
export class JSModuleNamespaceObject extends JSNonProxyObject {
    ...
    static create(paramrealm: JSRealm, paramfactory: JSObjectFactory, parammodule: AbstractModuleRecord, paramexports: UnmodifiableEconomicMap<TruffleString, ExportResolution>, paramdeferred: boolean): JSModuleNamespaceObject;
    ...
    constructor(shape: Shape, module: AbstractModuleRecord, exports: UnmodifiableEconomicMap<TruffleString, ExportResolution>, deferred: boolean)
    readonly deferred: boolean;
    // private exports: UnmodifiableEconomicMap<TruffleString, ExportResolution>;
    readonly module: AbstractModuleRecord;
    getClassName(): TruffleString;
    // private getExports(): UnmodifiableEconomicMap<TruffleString, ExportResolution>;
    getModule(): AbstractModuleRecord;
    getModuleExportsList(): UnmodifiableEconomicMap<TruffleString, ExportResolution>;
    isDeferred(): boolean;
    isSymbolLikeNamespaceKey(key: Object): boolean;
    ...
    // private testIntegrityLevel(frozen: boolean, doThrow: boolean): boolean;
