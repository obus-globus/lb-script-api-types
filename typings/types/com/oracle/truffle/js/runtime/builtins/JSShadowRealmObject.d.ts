...
export class JSShadowRealmObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, shadowRealm: JSRealm)
    readonly shadowRealm: JSRealm;
    getClassName(): TruffleString;
    getShadowRealm(): JSRealm;
}