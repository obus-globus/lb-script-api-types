...
export class JSRawJSONObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, rawJSON: TruffleString)
    readonly rawJSON: TruffleString;
    getClassName(): TruffleString;
    getRawJSON(): TruffleString;
}