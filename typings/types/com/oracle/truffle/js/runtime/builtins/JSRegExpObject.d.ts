...
export class JSRegExpObject extends JSNonProxyObject implements JSCopyableObject {
    ...
    static create(paramshape: Shape, paramproto: JSDynamicObject, paramcompiledRegex: Object, paramrealm: JSRealm): JSRegExpObject;
    ...
    constructor(shape: Shape, proto: JSDynamicObject, compiledRegex: Object, groupsFactory: JSObjectFactory, realm: JSRealm, legacyFeaturesEnabled: boolean)
    readonly compiledRegex: Object;
    readonly groupsFactory: JSObjectFactory;
    readonly legacyFeaturesEnabled: boolean;
    ...
    getCompiledRegex(): Object;
    getGroupsFactory(): JSObjectFactory;
    getLegacyFeaturesEnabled(): boolean;
    getRealm(): JSRealm;
    setCompiledRegex(compiledRegex: Object): void;
    setGroupsFactory(groupsFactory: JSObjectFactory): void;
