...
export class JSAsyncDisposableStackObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, disposeCapability: DisposeCapability)
    readonly disposeCapability: DisposeCapability;
    readonly disposed: boolean;
    getClassName(): TruffleString;
    getDisposeCapability(): DisposeCapability;
    isDisposed(): boolean;
    setDisposed(disposed: boolean): void;
    takeDisposeCapability(): DisposeCapability;
