...
import type { JSSymbolObject } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSSymbolObject.d.ts'
...
export class JSSymbol extends JSNonProxy implements JSConstructorFactory$WithFunctions, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSSymbol;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramsymbol: Symbol): JSSymbolObject;
    ...
    static isJSSymbol(paramobj: Object): boolean;
