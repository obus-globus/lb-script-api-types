...
export class JSWeakRefObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, weakReference: JSWeakRef$TruffleWeakReference<Object>)
    readonly weakReference: JSWeakRef$TruffleWeakReference<Object>;
    getClassName(): TruffleString;
    getWeakReference(): JSWeakRef$TruffleWeakReference<Object>;
