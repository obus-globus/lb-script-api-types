...
export class JSTemporalPlainYearMonthObject extends JSTemporalCalendarHolder {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, isoYear: number, isoMonth: number, isoDay: number, calendar: TruffleString)
