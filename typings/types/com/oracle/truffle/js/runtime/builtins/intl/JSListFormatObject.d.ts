...
export class JSListFormatObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, internalState: JSListFormat$InternalState)
    readonly internalState: JSListFormat$InternalState;
    getClassName(): TruffleString;
    getInternalState(): JSListFormat$InternalState;
}