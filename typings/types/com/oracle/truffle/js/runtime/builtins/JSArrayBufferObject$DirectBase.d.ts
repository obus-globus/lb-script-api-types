...
export class JSArrayBufferObject$DirectBase extends JSArrayBufferObject {
    ...
    getContents(): ByteBuffer;
    hasBufferElements(): boolean;
    isBufferWritable(): boolean;
    libraryGetByteLength(): number;
    ...
    setByteBuffer(byteBuffer: ByteBuffer): void;
