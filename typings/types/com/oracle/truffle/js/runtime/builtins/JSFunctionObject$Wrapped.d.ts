...
export class JSFunctionObject$Wrapped extends JSFunctionObject$BoundOrWrapped {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, functionData: JSFunctionData, realm: JSRealm, wrappedTargetFunction: Object)
    readonly wrappedTargetFunction: Object;
    getWrappedTargetFunction(): Object;
    initializeName(): void;
}