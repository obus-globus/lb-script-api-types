...
export class JSNumber extends JSPrimitive implements JSConstructorFactory$WithFunctions {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSNumber;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject, paramvalue: Number): JSNumberObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramvalue: Number): JSNumberObject;
    ...
    static isJSNumber(paramobj: Object): boolean;
    ...
    static valueOf(paramobj: JSNumberObject): Number;
    private constructor()
