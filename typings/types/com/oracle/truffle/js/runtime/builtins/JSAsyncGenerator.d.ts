...
export class JSAsyncGenerator extends JSNonProxy implements JSConstructorFactory, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSAsyncGenerator;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm): JSAsyncGeneratorObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject): JSAsyncGeneratorObject;
    static create(paramfactory: JSObjectFactory, paramrealm: JSRealm): JSAsyncGeneratorObject;
    static create(paramfactory: JSObjectFactory, paramrealm: JSRealm, paramproto: JSDynamicObject): JSAsyncGeneratorObject;
