...
export class JSStringObject extends JSNonProxyObject {
    ...
    static create(paramshape: Shape, paramproto: JSDynamicObject, paramvalue: TruffleString): JSStringObject;
    ...
    constructor(shape: Shape, proto: JSDynamicObject, string: TruffleString)
    readonly string: TruffleString;
    asString(): string;
