...
export class JSLocaleObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, internalState: JSLocale$InternalState)
    readonly internalState: JSLocale$InternalState;
    getClassName(): TruffleString;
    getInternalState(): JSLocale$InternalState;
}