...
import type { JSWrapForValidIteratorObject } from '../../../../../../com/oracle/truffle/js/runtime/builtins/JSWrapForValidIteratorObject.d.ts'
...
export class JSWrapForValidIterator extends JSNonProxy implements JSConstructorFactory$Default, PrototypeSupplier {
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSWrapForValidIterator;
    static checkProtoCycle(paramthisObj: JSDynamicObject, paramnewPrototype: JSDynamicObject): boolean;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramiteratorRecord: IteratorRecord): JSWrapForValidIteratorObject;
    ...
    static isWrapForIterator(paramobj: Object): boolean;
