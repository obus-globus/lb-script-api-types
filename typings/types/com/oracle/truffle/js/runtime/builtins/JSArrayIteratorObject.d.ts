...
export class JSArrayIteratorObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, iteratedObject: Object, nextIndex: number, iterationKind: number)
