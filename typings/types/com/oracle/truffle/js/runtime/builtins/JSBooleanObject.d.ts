...
export class JSBooleanObject extends JSNonProxyObject {
    ...
    static create(paramshape: Shape, paramproto: JSDynamicObject, paramvalue: boolean): JSBooleanObject;
    ...
    constructor(shape: Shape, proto: JSDynamicObject, value: boolean)
