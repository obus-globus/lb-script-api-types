...
export class JSTemporalDurationObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, years: number, months: number, weeks: number, days: number, hours: number, minutes: number, seconds: number, milliseconds: number, microseconds: number, nanoseconds: number)
    ...
    asDuration(): Duration;
    // private calcNanoseconds(): number;
