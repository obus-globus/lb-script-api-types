...
export class JSGenerator extends JSNonProxy implements JSConstructorFactory, PrototypeSupplier {
    static CLASS_NAME: TruffleString;
    static GET_SYMBOL_SPECIES_NAME: TruffleString;
    static INSTANCE: JSGenerator;
    ...
    static create(paramcontext: JSContext, paramrealm: JSRealm): JSGeneratorObject;
    static create(paramcontext: JSContext, paramrealm: JSRealm, paramproto: JSDynamicObject): JSGeneratorObject;
    static create(paramfactory: JSObjectFactory, paramrealm: JSRealm): JSGeneratorObject;
    static create(paramfactory: JSObjectFactory, paramrealm: JSRealm, paramproto: JSDynamicObject): JSGeneratorObject;
