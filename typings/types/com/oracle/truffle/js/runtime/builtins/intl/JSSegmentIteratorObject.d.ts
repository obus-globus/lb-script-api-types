...
import type { JSSegmenter$IteratorState } from '../../../../../../../com/oracle/truffle/js/runtime/builtins/intl/JSSegmenter$IteratorState.d.ts'
...
export class JSSegmentIteratorObject extends JSNonProxyObject {
    ...
    constructor(shape: Shape, proto: JSDynamicObject, internalState: JSSegmenter$IteratorState)
    // private internalState: JSSegmenter$IteratorState;
    getIteratorState(): JSSegmenter$IteratorState;
}