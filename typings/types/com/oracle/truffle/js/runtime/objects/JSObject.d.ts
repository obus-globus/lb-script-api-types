...
export abstract class JSObject extends JSDynamicObject {
    ...
    hasMembers(): boolean;
    invokeMember(id: string, args: Object[], self: InteropLibrary, callNode: JSInteropInvokeNode, fromJavaString: TruffleString$FromJavaStringNode, exportNode: ExportValueNode): Object;
    isMemberInsertable(key: string, keyInfo: KeyInfoNode): boolean;
    isMemberInvocable(key: string, keyInfo: KeyInfoNode): boolean;
    isMemberModifiable(key: string, keyInfo: KeyInfoNode): boolean;
    isMemberReadable(key: string, keyInfo: KeyInfoNode): boolean;
    isMemberRemovable(key: string, keyInfo: KeyInfoNode): boolean;
    readMember(key: string, self: InteropLibrary, readNode: ReadElementNode, bindMemberFunctions: boolean, fromJavaString: TruffleString$FromJavaStringNode, exportNode: ExportValueNode): Object;
    ...
    writeMember(key: string, value: Object, self: InteropLibrary, keyInfo: KeyInfoNode, castValueNode: ImportValueNode, writeNode: WriteElementNode, fromJavaString: TruffleString$FromJavaStringNode): void;
}