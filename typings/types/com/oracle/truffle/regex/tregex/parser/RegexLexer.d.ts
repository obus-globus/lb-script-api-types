...
export abstract class RegexLexer extends Object {
    ...
    consumeChar(): string;
    consumingLookahead(predicate: (param0: number) => kotlin.Boolean, length: number): boolean;
    consumingLookahead(character: string): boolean;
    consumingLookahead(match: string): boolean;
    count(predicate: (param0: number) => kotlin.Boolean): number;
    count(predicate: (param0: number) => kotlin.Boolean, fromIndex: number, toIndex: number): number;
    countDecimalDigits(): number;
    // private countDecimalDigits(maxLength: number): number;
    countFrom(predicate: (param0: number) => kotlin.Boolean, fromIndex: number): number;
    countUpTo(predicate: (param0: number) => kotlin.Boolean, max: number): number;
    ...
    lookahead(predicate: (param0: number) => kotlin.Boolean, length: number): boolean;
