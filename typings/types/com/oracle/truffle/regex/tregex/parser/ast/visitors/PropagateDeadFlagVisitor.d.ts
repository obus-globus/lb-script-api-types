...
export class PropagateDeadFlagVisitor extends DepthFirstTraversalRegexASTVisitor {
    static propagateDeadFlag(paramrunRoot: RegexASTNode): void;
    constructor()
    // private deadFlagsSeen: number;
    // private decFlagsSeen(node: RegexASTNode): void;
    // private incFlagsSeen(node: RegexASTNode): void;
    ...
    // private mark(node: RegexASTNode): void;
