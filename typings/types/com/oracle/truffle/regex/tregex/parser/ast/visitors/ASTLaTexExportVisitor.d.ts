...
export class ASTLaTexExportVisitor extends DepthFirstTraversalRegexASTVisitor {
    static exportLatex(paramast: RegexAST, parampath: TruffleFile): void;
    private constructor(ast: RegexAST, writer: BufferedWriter)
    // private ast: RegexAST;
    // private indent: number;
    // private lbEntries: CharacterClass[];
    // private writer: BufferedWriter;
    // private closeNode(): void;
    // private drawLookBehindEntries(): void;
    ...
    // private node(node: RegexASTNode): string;
    // private openNode(str: string, node: RegexASTNode): void;
    // private style(node: RegexASTNode): string;
