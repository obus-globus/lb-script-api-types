...
import type { Token$Kind } from '../../../../../../com/oracle/truffle/regex/tregex/parser/Token$Kind.d.ts'
...
export class Token$BackReference extends Token {
    ...
    constructor(kind: Token$Kind, groupNumbers: number[], namedReference: boolean)
    readonly groupNumbers: number[];
    readonly namedReference: boolean;
    getGroupNumbers(): number[];
    isNamedReference(): boolean;
    toJson(): JsonObject;
}