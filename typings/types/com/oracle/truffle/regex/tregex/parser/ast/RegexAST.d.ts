...
export class RegexAST extends Object implements StateIndex<RegexASTNode>, JsonConvertible {
    ...
    addSourceSections(node: RegexASTNode, src: E[]): void;
