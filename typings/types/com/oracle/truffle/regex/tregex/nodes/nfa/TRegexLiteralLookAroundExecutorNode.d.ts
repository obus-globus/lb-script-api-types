...
export class TRegexLiteralLookAroundExecutorNode extends TRegexBacktrackerSubExecutorNode {
    ...
    private constructor(ast: RegexAST, numberOfTransitions: number, forward: boolean, negated: boolean, matchers: number[], matcherRefs: number[])
    readonly forward: boolean;
    // private matcherRefs: number[];
