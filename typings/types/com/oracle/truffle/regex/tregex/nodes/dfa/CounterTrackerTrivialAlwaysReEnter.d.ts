...
export class CounterTrackerTrivialAlwaysReEnter extends CounterTracker {
    ...
    constructor(min: number, numberOfCells: number, dataBuilder: CounterTrackerData$Builder)
