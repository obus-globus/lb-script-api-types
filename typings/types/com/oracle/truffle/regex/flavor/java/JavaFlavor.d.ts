...
export class JavaFlavor extends RegexFlavor {
    static INSTANCE: JavaFlavor;
    static getCaseFoldingAlgorithm(paramoptions: RegexOptions, paramisUnicodeCase: boolean): CaseFoldData$CaseFoldUnfoldAlgorithm;
    private constructor()
