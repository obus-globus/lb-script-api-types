...
export class InputStringGenerator$InputStringBuilder extends Object {
    private constructor()
    // private elements: InputStringGenerator$InputElement[];
    // private nPrepended: number;
    // private append(e: InputStringGenerator$InputElement, forward: boolean): void;
    // private get(index: number, forward: boolean): InputStringGenerator$InputElement;
    // private hasNext(index: number, forward: boolean): boolean;
