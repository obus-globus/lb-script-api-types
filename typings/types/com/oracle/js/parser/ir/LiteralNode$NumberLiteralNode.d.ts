...
export class LiteralNode$NumberLiteralNode extends LiteralNode$PrimitiveLiteralNode<Number> {
    ...
    private constructor(literalNode: LiteralNode$NumberLiteralNode)
    private constructor(token: number, finish: number, value: Number, toStringConverter: (param0: Number) => TruffleString)
    // private toStringConverter: (param0: Number) => TruffleString;
