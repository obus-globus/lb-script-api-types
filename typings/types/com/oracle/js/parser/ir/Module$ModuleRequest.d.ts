...
export class Module$ModuleRequest extends Record {
    ...
    static create(paramspecifier: TruffleString, paramattributes: JavaMap<TruffleString, TruffleString>): Module$ModuleRequest;
    static create(paramspecifier: TruffleString, paramattributes: JavaMap<TruffleString, TruffleString>, paramphase: Module$ImportPhase): Module$ModuleRequest;
    constructor(specifier: TruffleString, attributes: JavaMap<TruffleString, TruffleString>, phase: Module$ImportPhase)
    ...
    toString(): string;
    withAttributes(newAttributes: JavaMap<TruffleString, TruffleString>): Module$ModuleRequest;
}