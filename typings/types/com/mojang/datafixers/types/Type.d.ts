...
export abstract class Type<A extends Object | number | string | boolean> extends Object implements App<Type$Mu, A> {
    ...
    // private capWrite<T extends Object | number | string | boolean>(arg0: DynamicOps<T>, arg1: Type<Object>, arg2: T, arg3: A, arg4: View<A, B>): DataResult<T>;
    codec(): Codec<A>;
    ...
    findType(arg0: Type<FT>, arg1: Type<FR>, arg2: Type$TypeMatcher<FT, FR>, arg3: boolean): Either<TypedOptic<A, Object, FT, FR>, Type$FieldNotFoundException>;
    findTypeCached(arg0: Type<FT>, arg1: Type<FR>, arg2: Type$TypeMatcher<FT, FR>, arg3: boolean): Either<TypedOptic<A, Object, FT, FR>, Type$FieldNotFoundException>;
    ...
    getSetType(arg0: OpticFinder<FT>, arg1: Type<FR>): Type<Object>;
    ifSame(arg0: Typed<B>): Optional<A>;
    ifSame<B extends Object | number | string | boolean>(arg0: Type<B>, arg1: B): Optional<A>;
    ifSame(arg0: Type<B>, arg1: RewriteResult<B, Object>): Optional<RewriteResult<A, Object>>;
    ...
    readTyped(arg0: Dynamic<T>): DataResult<Pair<Typed<A>, T>>;
    ...
    write(arg0: DynamicOps<T>, arg1: A): DataResult<T>;
    writeDynamic(arg0: DynamicOps<T>, arg1: A): DataResult<Dynamic<T>>;
}