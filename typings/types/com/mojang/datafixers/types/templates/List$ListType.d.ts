...
export class List$ListType<A extends unknown> extends Type<A[]> {
    ...
    // private capLeft<FT extends unknown, FR extends unknown, B extends unknown>(arg0: TypedOptic<A, B, FT, FR>): TypedOptic<A[], Object, FT, FR>;
    ...
    fix<B extends unknown>(arg0: RewriteResult<A, B>): RewriteResult<A[], Object>;
    getElement(): Type<A>;
    hashCode(): number;
