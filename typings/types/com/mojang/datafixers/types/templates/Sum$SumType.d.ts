...
export class Sum$SumType<F extends Object | number | string | boolean, G extends Object | number | string | boolean> extends Type<Either<F, G>> {
    ...
    findTypeInChildren(arg0: Type<FT>, arg1: Type<FR>, arg2: Type$TypeMatcher<FT, FR>, arg3: boolean): Either<TypedOptic<Either<F, G>, Object, FT, FR>, Type$FieldNotFoundException>;
    first(): Type<F>;
    hashCode(): number;
    mergeViews(arg0: RewriteResult<F, F2>, arg1: RewriteResult<G, G2>): RewriteResult<Either<F, G>, Object>;
