...
export class Product$ProductType<F extends unknown, G extends unknown> extends Type<Pair<F, G>> {
    ...
    // private capLeft<FT extends unknown, FR extends unknown, F2 extends unknown>(arg0: TypedOptic<F, F2, FT, FR>): Either<TypedOptic<Pair<F, G>, Object, FT, FR>, Type$FieldNotFoundException>;
    // private capRight<FT extends unknown, FR extends unknown, G2 extends unknown>(arg0: TypedOptic<G, G2, FT, FR>): TypedOptic<Pair<F, G>, Object, FT, FR>;
    ...
    findTypeInChildren<FT extends unknown, FR extends unknown>(arg0: Type<FT>, arg1: Type<FR>, arg2: Type$TypeMatcher<FT, FR>, arg3: boolean): Either<TypedOptic<Pair<F, G>, Object, FT, FR>, Type$FieldNotFoundException>;
    first(): Type<F>;
    hashCode(): number;
    mergeViews<F2 extends unknown, G2 extends unknown>(arg0: RewriteResult<F, F2>, arg1: RewriteResult<G, G2>): RewriteResult<Pair<F, G>, Object>;
