...
export class CompoundList$CompoundListType<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends Type<Pair<K, V>[]> {
    ...
    // private capLeft<FT extends Object | number | string | boolean, FR extends Object | number | string | boolean, K2 extends Object | number | string | boolean>(arg0: TypedOptic<K, K2, FT, FR>): Either<TypedOptic<Pair<K, V>[], Object, FT, FR>, Type$FieldNotFoundException>;
    // private capRight<FT extends Object | number | string | boolean, FR extends Object | number | string | boolean, V2 extends Object | number | string | boolean>(arg0: TypedOptic<V, V2, FT, FR>): TypedOptic<Pair<K, V>[], Object, FT, FR>;
    equals(arg0: Object, arg1: boolean, arg2: boolean): boolean;
    equals(arg0: Object | null): boolean;
    findTypeInChildren<FT extends Object | number | string | boolean, FR extends Object | number | string | boolean>(arg0: Type<FT>, arg1: Type<FR>, arg2: Type$TypeMatcher<FT, FR>, arg3: boolean): Either<TypedOptic<Pair<K, V>[], Object, FT, FR>, Type$FieldNotFoundException>;
    getElement(): Type<V>;
    getKey(): Type<K>;
    hashCode(): number;
    mergeViews<K2 extends Object | number | string | boolean, V2 extends Object | number | string | boolean>(arg0: RewriteResult<K, K2>, arg1: RewriteResult<V, V2>): RewriteResult<Pair<K, V>[], Object>;
