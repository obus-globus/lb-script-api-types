...
export interface FunctionType<A extends unknown, B extends unknown> extends App<FunctionType$ReaderMu<A>, B>, App2<FunctionType$Mu, A, B>, Function<A, B>, Object {
    andThen<V extends unknown>(arg0: (param0: B) => V): (param0: A) => V;
    apply(arg0: A): B;
    compose<V extends unknown>(arg0: (param0: V) => A): (param0: V) => B;
}