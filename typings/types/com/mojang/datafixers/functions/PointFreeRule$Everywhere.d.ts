...
export class PointFreeRule$Everywhere extends Record implements PointFreeRule {
    constructor(topDown: PointFreeRule, bottomUp: PointFreeRule)
    // private bottomUp: PointFreeRule;
    // private topDown: PointFreeRule;
