...
export class Products$P5<F extends K1, T1 extends Object | number | string | boolean, T2 extends Object | number | string | boolean, T3 extends Object | number | string | boolean, T4 extends Object | number | string | boolean, T5 extends Object | number | string | boolean> extends Object {
    ...
    // private t4: App<F, T4>;
    // private t5: App<F, T5>;
    and(arg0: Products$P2<F, T6, T7>): Products$P7<F, T1, T2, T3, T4, T5, T6, T7>;
    and(arg0: Products$P3<F, T6, T7, T8>): Products$P8<F, T1, T2, T3, T4, T5, T6, T7, T8>;
    and(arg0: App<F, T6>): Products$P6<F, T1, T2, T3, T4, T5, T6>;
    apply(arg0: Applicative<F, Object>, arg1: App<F, Function5<T1, T2, T3, T4, T5, R>>): App<F, R>;
    apply(arg0: Applicative<F, Object>, arg1: Function5<T1, T2, T3, T4, T5, R>): App<F, R>;
    t1(): App<F, T1>;
    t2(): App<F, T2>;
    t3(): App<F, T3>;
    t4(): App<F, T4>;
