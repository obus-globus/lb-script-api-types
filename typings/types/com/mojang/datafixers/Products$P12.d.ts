...
export class Products$P12<F extends K1, T1 extends Object | number | string | boolean, T2 extends Object | number | string | boolean, T3 extends Object | number | string | boolean, T4 extends Object | number | string | boolean, T5 extends Object | number | string | boolean, T6 extends Object | number | string | boolean, T7 extends Object | number | string | boolean, T8 extends Object | number | string | boolean, T9 extends Object | number | string | boolean, T10 extends Object | number | string | boolean, T11 extends Object | number | string | boolean, T12 extends Object | number | string | boolean> extends Object {
    ...
    // private t8: App<F, T8>;
    // private t9: App<F, T9>;
    apply<R extends Object | number | string | boolean>(arg0: Applicative<F, any>, arg1: App<F, Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, R>>): App<F, R>;
    apply<R extends Object | number | string | boolean>(arg0: Applicative<F, any>, arg1: Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, R>): App<F, R>;
}