...
export interface CartesianLike<T extends K1, C extends unknown, Mu extends CartesianLike$Mu> extends Functor<T, Mu>, Traversable<T, Mu>, Object {
    flip<F extends K1, A extends unknown>(arg0: Applicative<F, any>, arg1: App<T, App<F, A>>): App<F, App<T, A>>;
    from<A extends unknown>(arg0: App<Pair$Mu<C>, A>): App<T, A>;
    to<A extends unknown>(arg0: App<T, A>): App<Pair$Mu<C>, A>;
