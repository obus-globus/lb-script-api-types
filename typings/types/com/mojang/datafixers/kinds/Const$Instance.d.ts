...
export class Const$Instance<C extends Object | number | string | boolean> extends Object implements Applicative<Const$Mu<C>, Const$Instance$Mu<C>> {
    ...
    lift1(arg0: App<Const$Mu<C>, (param0: A) => R>): (param0: App<Const$Mu<C>, A>) => App<Const$Mu<C>, R>;
    lift2(arg0: App<F, (param0: A, param1: B) => R>): (param0: App<F, A>, param1: App<F, B>) => App<F, R>;
    lift2(arg0: App<Const$Mu<C>, (param0: A, param1: B) => R>): (param0: App<Const$Mu<C>, A>, param1: App<Const$Mu<C>, B>) => App<Const$Mu<C>, R>;
    ...
    map(arg0: (param0: T) => R, arg1: App<Const$Mu<C>, T>): App<Const$Mu<C>, R>;
    point<A extends Object | number | string | boolean>(arg0: A): App<Const$Mu<C>, A>;
}