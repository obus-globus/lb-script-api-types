...
export class ReForgetE$Instance<R extends Object | number | string | boolean> extends Object implements App<ReForgetE$Instance$Mu<R>, ReForgetE$Mu<R>>, Cocartesian<ReForgetE$Mu<R>, ReForgetE$Instance$Mu<R>> {
    ...
    constructor()
    dimap<C extends Object | number | string | boolean, D extends Object | number | string | boolean, A extends Object | number | string | boolean, B extends Object | number | string | boolean>(arg0: App2<ReForgetE$Mu<R>, A, B>, arg1: (param0: C) => A, arg2: (param0: B) => D): App2<ReForgetE$Mu<R>, C, D>;
    dimap<A extends Object | number | string | boolean, B extends Object | number | string | boolean, C extends Object | number | string | boolean, D extends Object | number | string | boolean>(arg0: (param0: C) => A, arg1: (param0: B) => D): FunctionType<App2<ReForgetE$Mu<R>, A, B>, App2<ReForgetE$Mu<R>, C, D>>;
    dimap<C extends Object | number | string | boolean, D extends Object | number | string | boolean, A extends Object | number | string | boolean, B extends Object | number | string | boolean>(arg0: () => App2<ReForgetE$Mu<R>, A, B>, arg1: (param0: C) => A, arg2: (param0: B) => D): App2<ReForgetE$Mu<R>, C, D>;
    left<A extends Object | number | string | boolean, C extends Object | number | string | boolean, B extends Object | number | string | boolean>(arg0: App2<ReForgetE$Mu<R>, A, B>): App2<ReForgetE$Mu<R>, Either<A, C>, Either<B, C>>;
    right<C extends Object | number | string | boolean, A extends Object | number | string | boolean, B extends Object | number | string | boolean>(arg0: App2<ReForgetE$Mu<R>, A, B>): App2<ReForgetE$Mu<R>, Either<C, A>, Either<C, B>>;
