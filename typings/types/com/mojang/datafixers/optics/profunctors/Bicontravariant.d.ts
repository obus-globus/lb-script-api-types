...
export interface Bicontravariant<P extends K2, Mu extends Bicontravariant$Mu> extends Kind2<P, Mu>, Object {
    cimap<A extends unknown, B extends unknown, C extends unknown, D extends unknown>(arg0: (param0: C) => A, arg1: (param0: D) => B): FunctionType<() => App2<P, A, B>, App2<P, C, D>>;
    cimap<C extends unknown, D extends unknown, A extends unknown, B extends unknown>(arg0: () => App2<P, A, B>, arg1: (param0: C) => A, arg2: (param0: D) => B): App2<P, C, D>;
}