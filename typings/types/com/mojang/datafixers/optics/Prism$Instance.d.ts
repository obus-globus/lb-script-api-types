...
export class Prism$Instance<A2 extends unknown, B2 extends unknown> extends Object implements Cocartesian<Prism$Mu<A2, B2>, Cocartesian$Mu> {
    static unbox(paramarg0: App<Cocartesian$Mu, K2>): Cocartesian<K2, Cocartesian$Mu>;
    constructor()
    dimap<C extends unknown, D extends unknown, A extends unknown, B extends unknown>(arg0: App2<Prism$Mu<A2, B2>, A, B>, arg1: (param0: C) => A, arg2: (param0: B) => D): App2<Prism$Mu<A2, B2>, C, D>;
    dimap<A extends unknown, B extends unknown, C extends unknown, D extends unknown>(arg0: (param0: C) => A, arg1: (param0: B) => D): FunctionType<App2<Prism$Mu<A2, B2>, A, B>, App2<Prism$Mu<A2, B2>, C, D>>;
    dimap<C extends unknown, D extends unknown, A extends unknown, B extends unknown>(arg0: () => App2<Prism$Mu<A2, B2>, A, B>, arg1: (param0: C) => A, arg2: (param0: B) => D): App2<Prism$Mu<A2, B2>, C, D>;
    left<A extends unknown, C extends unknown, B extends unknown>(arg0: App2<Prism$Mu<A2, B2>, A, B>): App2<Prism$Mu<A2, B2>, Either<A, C>, Either<B, C>>;
    right<C extends unknown, A extends unknown, B extends unknown>(arg0: App2<Prism$Mu<A2, B2>, A, B>): App2<Prism$Mu<A2, B2>, Either<C, A>, Either<C, B>>;
