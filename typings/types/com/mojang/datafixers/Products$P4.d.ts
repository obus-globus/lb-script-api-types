...
export class Products$P4<F extends K1, T1 extends Object | number | string | boolean, T2 extends Object | number | string | boolean, T3 extends Object | number | string | boolean, T4 extends Object | number | string | boolean> extends Object {
    ...
    apply<R extends Object | number | string | boolean>(arg0: Applicative<F, any>, arg1: App<F, Function4<T1, T2, T3, T4, R>>): App<F, R>;
    apply<R extends Object | number | string | boolean>(arg0: Applicative<F, any>, arg1: Function4<T1, T2, T3, T4, R>): App<F, R>;
    t1(): App<F, T1>;
    t2(): App<F, T2>;
    t3(): App<F, T3>;
    t4(): App<F, T4>;
