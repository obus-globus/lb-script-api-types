...
export abstract class DynamicLike<T extends unknown> extends Object {
    ...
    asList<U extends unknown>(arg0: (param0: Dynamic<T>) => U): U[];
    asListOpt<U extends unknown>(arg0: (param0: Dynamic<T>) => U): DataResult<U[]>;
    ...
    getOps(): DynamicOps<T>;
    read<A extends unknown>(arg0: Decoder<A>): DataResult<A>;
    readList<E extends unknown>(arg0: Decoder<E>): DataResult<E[]>;
    readList<E extends unknown>(arg0: (param0: Dynamic<Object>) => DataResult<E>): DataResult<E[]>;
    readMap<R extends unknown>(arg0: DataResult<R>, arg1: Function3<R, Dynamic<T>, Dynamic<T>, DataResult<R>>): DataResult<R>;
    readMap<K extends unknown, V extends unknown>(arg0: Decoder<K>, arg1: Decoder<V>): DataResult<Pair<K, V>[]>;
    readMap<K extends unknown, V extends unknown>(arg0: Decoder<K>, arg1: (param0: K) => Decoder<V>): DataResult<Pair<K, V>[]>;
}