...
export abstract class MapCodec<A extends Object | number | string | boolean> extends CompressorHolder implements MapDecoder<A>, MapEncoder<A> {
    ...
    decoder(): Decoder<A>;
    dependent(arg0: MapCodec<E>, arg1: (param0: A) => Pair<E, MapCodec<E>>, arg2: (param0: A, param1: E) => A): MapCodec<A>;
    ...
    flatXmap(arg0: (param0: A) => DataResult<S>, arg1: (param0: S) => DataResult<A>): MapCodec<S>;
    forGetter(arg0: (param0: O) => A): RecordCodecBuilder<O, A>;
    ...
    orElse(arg0: (param0: string) => unknown, arg1: A): MapCodec<A>;
    orElseGet(arg0: (param0: string) => void, arg1: () => A): MapCodec<A>;
    orElseGet(arg0: () => A): MapCodec<A>;
    orElseGet(arg0: (param0: string) => unknown, arg1: () => A): MapCodec<A>;
    partialDispatch(arg0: (param0: E) => DataResult<A>, arg1: (param0: A) => DataResult<MapCodec<E>>): Codec<E>;
    ...
    xmap(arg0: (param0: A) => S, arg1: (param0: S) => A): MapCodec<S>;
}