...
import type { RecordCodecBuilder$Instance$Mu } from '../../../../com/mojang/serialization/codecs/RecordCodecBuilder$Instance$Mu.d.ts'
...
export class RecordCodecBuilder$Instance<O extends Object | number | string | boolean> extends Object implements Applicative<RecordCodecBuilder$Mu<O>, RecordCodecBuilder$Instance$Mu<O>> {
    ...
    ap2(arg0: App<RecordCodecBuilder$Mu<O>, (param0: A, param1: B) => R>, arg1: App<RecordCodecBuilder$Mu<O>, A>, arg2: App<RecordCodecBuilder$Mu<O>, B>): App<RecordCodecBuilder$Mu<O>, R>;
    ap3(arg0: App<F, Function3<T1, T2, T3, R>>, arg1: App<F, T1>, arg2: App<F, T2>, arg3: App<F, T3>): App<F, R>;
    ap3(arg0: App<RecordCodecBuilder$Mu<O>, Function3<T1, T2, T3, R>>, arg1: App<RecordCodecBuilder$Mu<O>, T1>, arg2: App<RecordCodecBuilder$Mu<O>, T2>, arg3: App<RecordCodecBuilder$Mu<O>, T3>): App<RecordCodecBuilder$Mu<O>, R>;
    ap4(arg0: App<F, Function4<T1, T2, T3, T4, R>>, arg1: App<F, T1>, arg2: App<F, T2>, arg3: App<F, T3>, arg4: App<F, T4>): App<F, R>;
    ap4(arg0: App<RecordCodecBuilder$Mu<O>, Function4<T1, T2, T3, T4, R>>, arg1: App<RecordCodecBuilder$Mu<O>, T1>, arg2: App<RecordCodecBuilder$Mu<O>, T2>, arg3: App<RecordCodecBuilder$Mu<O>, T3>, arg4: App<RecordCodecBuilder$Mu<O>, T4>): App<RecordCodecBuilder$Mu<O>, R>;
    ...
    deprecated<A extends Object | number | string | boolean>(arg0: A, arg1: number): App<RecordCodecBuilder$Mu<O>, A>;
    lift1(arg0: App<RecordCodecBuilder$Mu<O>, (param0: A) => R>): (param0: App<RecordCodecBuilder$Mu<O>, A>) => App<RecordCodecBuilder$Mu<O>, R>;
    ...
    map(arg0: (param0: T) => R, arg1: App<RecordCodecBuilder$Mu<O>, T>): App<RecordCodecBuilder$Mu<O>, R>;
    point<A extends Object | number | string | boolean>(arg0: A): App<RecordCodecBuilder$Mu<O>, A>;
    point<A extends Object | number | string | boolean>(arg0: A, arg1: Lifecycle): App<RecordCodecBuilder$Mu<O>, A>;
    stable<A extends Object | number | string | boolean>(arg0: A): App<RecordCodecBuilder$Mu<O>, A>;
}