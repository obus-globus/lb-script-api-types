...
export class SheetedDecalTextureGenerator extends Object implements VertexConsumer, VertexBufferWriter {
    ...
    constructor(delegate: VertexConsumer, cameraPose: PoseStack$Pose, textureScale: number)
    // private cameraInversePose: Matrix4f;
    // private canUseIntrinsics: boolean;
    // private delegate: VertexConsumer;
    // private normal: Vector3f;
    // private normalInversePose: Matrix3f;
    // private textureScale: number;
    // private worldPos: Vector3f;
    // private x: number;
    // private y: number;
    // private z: number;
