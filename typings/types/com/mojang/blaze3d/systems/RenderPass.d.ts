...
export class RenderPass extends Object implements AutoCloseable, RenderPassInterface {
    constructor(backend: RenderPassBackend, device: GpuDeviceBackend)
    // private backend: RenderPassBackend;
