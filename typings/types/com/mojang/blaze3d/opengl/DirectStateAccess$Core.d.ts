...
export class DirectStateAccess$Core extends DirectStateAccess {
    ...
    mapBufferRange(buffer: number, offset: number, length: number, flags: number, usage: number): ByteBuffer;
