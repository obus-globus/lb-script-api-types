...
export class RealmsPreferredRegionSelectionScreen$RegionSelectionList$Entry extends ObjectSelectionList$Entry<RealmsPreferredRegionSelectionScreen$RegionSelectionList$Entry> {
    ...
    constructor(null_: RealmsPreferredRegionSelectionScreen$RegionSelectionList, preference: RegionSelectionPreference, region: RealmsRegion)
    constructor(null_: RealmsPreferredRegionSelectionScreen$RegionSelectionList, regionSelection: RealmsSettingsTab$RegionSelection)
