...
export class RealmsCreateRealmScreen extends RealmsScreen {
    ...
    constructor(lastScreen: RealmsMainScreen, server: RealmsServer, isSnapshot: boolean)
    // private createWorldRunnable: () => void;
    // private descriptionBox: EditBox;
    // private lastScreen: RealmsMainScreen;
    // private layout: HeaderAndFooterLayout;
    // private nameBox: EditBox;
    // private createWorld(server: RealmsServer, initializeSnapshotRealm: boolean): void;
    init(): void;
    ...
    // private showResetWorldScreen(server: RealmsServer): void;
}