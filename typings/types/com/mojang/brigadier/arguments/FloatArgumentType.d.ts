...
export class FloatArgumentType extends Object implements ArgumentType<number> {
    static floatArg(): FloatArgumentType;
    static floatArg(paramarg0: number): FloatArgumentType;
    static floatArg(paramarg0: number, paramarg1: number): FloatArgumentType;
    static getFloat(paramarg0: CommandContext<Object>, paramarg1: string): number;
