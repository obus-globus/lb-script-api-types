...
export class ULocale extends Object implements Serializable, Cloneable, Comparable<ULocale> {
    ...
    static acceptLanguage(paramarg0: ULocale[], paramarg1: boolean[]): ULocale;
    static acceptLanguage(paramarg0: ULocale[], paramarg1: ULocale[], paramarg2: boolean[]): ULocale;
    static acceptLanguage(paramarg0: string, paramarg1: boolean[]): ULocale;
    static acceptLanguage(paramarg0: string, paramarg1: ULocale[], paramarg2: boolean[]): ULocale;
