import type { CalendarCache } from '../../../../com/ibm/icu/impl/CalendarCache.d.ts'
...
export class ChineseCalendar extends Calendar {
    ...
    // private handleComputeMonthStartWithLeap(arg0: number, arg1: number, arg2: number): number;
    ...
    // private handleGetMonthLengthWithLeap(arg0: number, arg1: number, arg2: number): number;
    // private hasNoMajorSolarTerm(arg0: number): boolean;
    haveDefaultCentury(): boolean;
    inTemporalLeapYear(): boolean;
    internalGetMonth(): number;
    internalGetMonth(arg0: number): number;
    // private isLeapMonthBetween(arg0: number, arg1: number): boolean;
    // private majorSolarTerm(arg0: number): number;
    // private millisToDays(arg0: number): number;
    // private newMoonNear(arg0: number, arg1: boolean): number;
    // private newYear(arg0: number): number;
    // private offsetMonth(arg0: number, arg1: number, arg2: number): void;
    // private readObject(arg0: ObjectInputStream): void;
    roll(arg0: number, arg1: boolean): void;
    roll(arg0: number, arg1: number): void;
    setTemporalMonthCode(arg0: string): void;
    // private synodicMonthsBetween(arg0: number, arg1: number): number;
    // private winterSolstice(arg0: number): number;
}