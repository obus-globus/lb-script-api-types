import type { CECalendar } from '../../../../com/ibm/icu/util/CECalendar.d.ts'
...
export class EthiopicCalendar extends CECalendar {
    ...
    static EthiopicToJD(paramarg0: number, paramarg1: number, paramarg2: number): number;
    ...
    setAmeteAlemEra(arg0: boolean): void;
