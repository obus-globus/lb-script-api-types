import type { UScript$ScriptUsage } from '../../../../com/ibm/icu/lang/UScript$ScriptUsage.d.ts'
...
export class UScript extends Object {
    ...
    static breaksBetweenLetters(paramarg0: number): boolean;
    static getCode(paramarg0: ULocale): number[];
    static getCode(paramarg0: string): number[];
    static getCode(paramarg0: Locale): number[];
    static getCodeFromName(paramarg0: string): number;
    static getName(paramarg0: number): string;
    static getSampleString(paramarg0: number): string;
    static getScript(paramarg0: number): number;
    static getScriptExtensions(paramarg0: number, paramarg1: BitSet): number;
    static getShortName(paramarg0: number): string;
    static getUsage(paramarg0: number): UScript$ScriptUsage;
    static hasScript(paramarg0: number, paramarg1: number): boolean;
    static isCased(paramarg0: number): boolean;
    static isRightToLeft(paramarg0: number): boolean;
    private constructor()
}