...
export class Collation extends Object {
    ...
    static incThreeBytePrimaryByOffset(paramarg0: number, paramarg1: boolean, paramarg2: number): number;
    static incTwoBytePrimaryByOffset(paramarg0: number, paramarg1: boolean, paramarg2: number): number;
    static makeCE(paramarg0: number): number;
    constructor()
}