...
export class SimpleFormatterImpl extends Object {
    ...
    static formatAndAppend(paramarg0: string, paramarg1: StringBuilder, paramarg2: number[], paramarg3: (Object | null)[]): StringBuilder;
    static formatAndReplace(paramarg0: string, paramarg1: StringBuilder, paramarg2: number[], paramarg3: (Object | null)[]): StringBuilder;
    static formatCompiledPattern(paramarg0: string, paramarg1: (Object | null)[]): string;
    ...
    static formatRawPattern(paramarg0: string, paramarg1: number, paramarg2: number, paramarg3: (Object | null)[]): string;
