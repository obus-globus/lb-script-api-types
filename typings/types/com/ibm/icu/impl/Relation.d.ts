...
export class Relation<K extends unknown, V extends unknown> extends Object implements Freezable<Relation<K, V>> {
    static of<K extends unknown, V extends unknown>(paramarg0: Map<K, V[]>, paramarg1: Class<Object>): Relation<K, V>;
    static of<K extends unknown, V extends unknown>(paramarg0: Map<K, V[]>, paramarg1: Class<Object>, paramarg2: (param0: V, param1: V) => number): Relation<K, V>;
