...
export class Relation<K extends unknown, V extends unknown> extends Object implements Freezable<Relation<K, V>> {
    static of<K extends unknown, V extends unknown>(paramarg0: JavaMap<K, V[]>, paramarg1: Class<Object>): Relation<K, V>;
    static of<K extends unknown, V extends unknown>(paramarg0: JavaMap<K, V[]>, paramarg1: Class<Object>, paramarg2: (param0: V, param1: V) => number): Relation<K, V>;
    constructor(arg0: JavaMap<K, V[]>, arg1: Class<Object>)
    constructor(arg0: JavaMap<K, V[]>, arg1: Class<Object>, arg2: (param0: V, param1: V) => number)
    ...
    addAllInverted(arg0: JavaMap<V, K>): Relation<K, V>;
    clear(): void;
