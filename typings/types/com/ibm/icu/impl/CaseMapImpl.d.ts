...
export class CaseMapImpl extends Object {
    ...
    static fold(paramarg0: number, paramarg1: CharSequence, paramarg2: Object | null, paramarg3: Edits): Object | null;
    ...
    static toLower(paramarg0: number, paramarg1: number, paramarg2: CharSequence, paramarg3: Object | null, paramarg4: Edits): Object | null;
    static toLower(paramarg0: number, paramarg1: number, paramarg2: CharSequence): string;
    static toTitle(paramarg0: number, paramarg1: number, paramarg2: BreakIterator, paramarg3: CharSequence, paramarg4: Object | null, paramarg5: Edits): Object | null;
    static toTitle(paramarg0: number, paramarg1: number, paramarg2: BreakIterator, paramarg3: CharSequence): string;
    static toUpper(paramarg0: number, paramarg1: number, paramarg2: CharSequence, paramarg3: Object | null, paramarg4: Edits): Object | null;
