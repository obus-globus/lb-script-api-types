...
export class TimeZoneNamesImpl$ZNames extends Object {
    ...
    static createMetaZoneAndPutInCache(paramarg0: JavaMap<string, TimeZoneNamesImpl$ZNames>, paramarg1: string[], paramarg2: string): TimeZoneNamesImpl$ZNames;
    static createTimeZoneAndPutInCache(paramarg0: JavaMap<string, TimeZoneNamesImpl$ZNames>, paramarg1: string[], paramarg2: string): TimeZoneNamesImpl$ZNames;
