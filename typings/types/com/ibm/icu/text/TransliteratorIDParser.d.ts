...
export class TransliteratorIDParser extends Object {
    ...
    static parseCompoundID(paramarg0: string, paramarg1: number, paramarg2: StringBuilder, paramarg3: TransliteratorIDParser$SingleID[], paramarg4: (Object | null)[]): boolean;
