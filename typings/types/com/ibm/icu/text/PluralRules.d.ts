...
export class PluralRules extends Object implements Serializable {
    ...
    getAllKeywordDecimalQuantityValues(arg0: string): DecimalQuantity[];
    getAllKeywordValues(arg0: string): number[];
    getAllKeywordValues(arg0: string, arg1: PluralRules$SampleType): DecimalQuantity[];
    getDecimalQuantitySamples(arg0: string): DecimalQuantity[];
    getDecimalQuantitySamples(arg0: string, arg1: PluralRules$SampleType): DecimalQuantity[];
    ...
    getSamples(arg0: string): number[];
    getSamples(arg0: string, arg1: PluralRules$SampleType): number[];
