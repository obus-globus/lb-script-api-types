...
export class DrawingUtil extends Object {
    static drawBadge(paramarg0: GuiGraphicsExtractor, paramarg1: number, paramarg2: number, paramarg3: number, paramarg4: (param0: (param0: number, param1: Style, param2: number) => kotlin.Boolean) => kotlin.Boolean, paramarg5: number, paramarg6: number, paramarg7: number): void;
