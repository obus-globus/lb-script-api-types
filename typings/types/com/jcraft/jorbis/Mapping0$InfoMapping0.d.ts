...
export class Mapping0$InfoMapping0 extends Object {
    ...
    // private coupling_steps: number;
    // private floorsubmap: number[];
    // private psysubmap: number[];
    // private residuesubmap: number[];
    // private submaps: number;
    // private timesubmap: number[];
    free(): void;
}