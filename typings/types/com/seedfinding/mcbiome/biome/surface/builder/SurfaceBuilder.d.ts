...
export abstract class SurfaceBuilder extends Object {
    ...
    getNoiseSurfaceBuilder(arg0: BiomeSource, arg1: number): SurfaceBuilder;
    getSurfaceConfig(): SurfaceConfig;
    setSurfaceConfig(arg0: SurfaceConfig): void;
}