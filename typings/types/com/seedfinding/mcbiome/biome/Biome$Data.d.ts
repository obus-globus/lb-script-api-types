...
export class Biome$Data extends Object {
    ...
    constructor(arg0: (param0: Biome) => kotlin.Boolean, arg1: Biome, arg2: number, arg3: number)
    constructor(arg0: (param0: Biome) => kotlin.Boolean, arg1: number, arg2: number)
    biome: Biome;
    predicate: (param0: Biome) => kotlin.Boolean;
    x: number;
    z: number;
