...
import type { IntLayerCache } from '../../../../com/seedfinding/mcbiome/layer/cache/IntLayerCache.d.ts'
import type { MCVersion } from '../../../../com/seedfinding/mccore/version/MCVersion.d.ts'
export abstract class IntBiomeLayer extends BiomeLayer {
    ...
    // private layerCache: IntLayerCache;
    _sample(arg0: number, arg1: number, arg2: number, arg3: number): void;
