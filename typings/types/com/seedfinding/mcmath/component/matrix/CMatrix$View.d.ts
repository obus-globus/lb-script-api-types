...
export class CMatrix$View extends CMatrix {
    ...
    constructor(arg0: number, arg1: number, arg2: (param0: number, param1: number) => com.seedfinding.mcmath.arithmetic.Complex, arg3: (param0: number, param1: number, param2: Complex) => void)
    readonly columns: number;
    // private getter: (param0: number, param1: number) => com.seedfinding.mcmath.arithmetic.Complex;
