...
export interface QMatrix$Mapper extends Object {
    asGenerator(): (param0: number, param1: number) => Rational;
    forColumn(arg0: number): (param0: number, param1: Rational) => Rational;
    forRow(arg0: number): (param0: number, param1: Rational) => Rational;
