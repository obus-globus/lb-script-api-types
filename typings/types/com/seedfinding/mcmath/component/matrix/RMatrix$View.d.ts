...
export class RMatrix$View extends RMatrix {
    ...
    constructor(arg0: number, arg1: number, arg2: (param0: number, param1: number) => Real, arg3: (param0: number, param1: number, param2: Real) => void)
    readonly columns: number;
    // private getter: (param0: number, param1: number) => Real;
