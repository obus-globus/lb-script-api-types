...
export class Combinatorics extends Object {
    ...
    static combine(paramarg0: number, paramarg1: number, paramarg2: (param0: number[]) => boolean): void;
    ...
    static permute(paramarg0: number, paramarg1: number, paramarg2: (param0: number[]) => boolean): void;
    constructor()
}