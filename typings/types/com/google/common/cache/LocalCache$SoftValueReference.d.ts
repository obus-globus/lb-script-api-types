...
export class LocalCache$SoftValueReference<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends SoftReference<V> implements LocalCache$ValueReference<K, V> {
