...
export class RemovalNotification<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends AbstractMap$SimpleImmutableEntry<K, V> {
