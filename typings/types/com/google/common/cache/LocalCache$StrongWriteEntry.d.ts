...
export class LocalCache$StrongWriteEntry<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends LocalCache$StrongEntry<K, V> {
