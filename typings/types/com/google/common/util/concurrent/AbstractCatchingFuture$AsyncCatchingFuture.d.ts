...
export class AbstractCatchingFuture$AsyncCatchingFuture<V extends Object | number | string | boolean, X extends Throwable> extends AbstractCatchingFuture<V, X, (param0: X) => ListenableFuture<V>, ListenableFuture<V>> {
