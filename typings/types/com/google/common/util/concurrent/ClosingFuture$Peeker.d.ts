...
export class ClosingFuture$Peeker extends Object {
    ...
    // private call<V extends Object | number | string | boolean>(combiner: (param0: ClosingFuture$DeferredCloser, param1: ClosingFuture$Peeker) => V, closeables: ClosingFuture$CloseableList): V;
    // private callAsync<V extends Object | number | string | boolean>(combiner: (param0: ClosingFuture$DeferredCloser, param1: ClosingFuture$Peeker) => ClosingFuture<V>, closeables: ClosingFuture$CloseableList): FluentFuture<V>;
