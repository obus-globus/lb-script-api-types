...
export class Futures extends GwtFuturesCatchingSpecialization {
    ...
    static allAsList(paramfutures: Object | null): ListenableFuture<Object>;
    static allAsList(paramfutures: (Object | null)[]): ListenableFuture<Object>;
    static catching(paraminput: ListenableFuture<Object>, paramexceptionType: Class<Object>, paramfallback: (param0: Object | null) => Object | null, paramexecutor: Executor): ListenableFuture<Object>;
    static catchingAsync(paraminput: ListenableFuture<Object>, paramexceptionType: Class<Object>, paramfallback: (param0: Object | null) => Object | null, paramexecutor: Executor): ListenableFuture<Object>;
    static getChecked(paramfuture: Future<Object>, paramexceptionClass: Class<Object>): Object | null;
    static getChecked(paramfuture: Future<Object>, paramexceptionClass: Class<Object>, paramtimeout: Duration): Object | null;
    static getChecked(paramfuture: Future<Object>, paramexceptionClass: Class<Object>, paramtimeout: number, paramunit: TimeUnit): Object | null;
    ...
    static inCompletionOrder(paramfutures: (Object | null)[]): (Object | null)[];
    static lazyTransform(paraminput: Future<Object>, paramfunction: (param0: Object | null) => Object | null): Future<Object>;
    static nonCancellationPropagating(paramfuture: ListenableFuture<Object>): ListenableFuture<Object>;
    static scheduleAsync(paramcallable: () => Object | null, paramdelay: Duration, paramexecutorService: ScheduledExecutorService): ListenableFuture<Object>;
    static scheduleAsync(paramcallable: () => Object | null, paramdelay: number, paramtimeUnit: TimeUnit, paramexecutorService: ScheduledExecutorService): ListenableFuture<Object>;
    ...
    static submitAsync(paramcallable: () => Object | null, paramexecutor: Executor): ListenableFuture<Object>;
    static successfulAsList(paramfutures: Object | null): ListenableFuture<Object>;
    static successfulAsList(paramfutures: (Object | null)[]): ListenableFuture<Object>;
    static transform(paraminput: ListenableFuture<Object>, paramfunction: (param0: Object | null) => Object | null, paramexecutor: Executor): ListenableFuture<Object>;
    static transformAsync(paraminput: ListenableFuture<Object>, paramfunction: (param0: Object | null) => Object | null, paramexecutor: Executor): ListenableFuture<Object>;
