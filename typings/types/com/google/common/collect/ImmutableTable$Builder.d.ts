...
export class ImmutableTable$Builder<R extends Object | number | string | boolean, C extends Object | number | string | boolean, V extends Object | number | string | boolean> extends Object {
    ...
    // private rowComparator: (param0: R) => kotlin.Boolean;
    ...
    orderColumnsBy(columnComparator: (param0: C) => kotlin.Boolean): ImmutableTable$Builder<R, C, V>;
    orderRowsBy(rowComparator: (param0: R) => kotlin.Boolean): ImmutableTable$Builder<R, C, V>;
