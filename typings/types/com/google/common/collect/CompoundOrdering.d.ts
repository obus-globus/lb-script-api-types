...
export class CompoundOrdering<T extends unknown> extends Ordering<T> implements Serializable {
    ...
    constructor(primary: (param0: T, param1: T) => number, secondary: (param0: T, param1: T) => number)
    constructor(comparators: (param0: T, param1: T) => number[])
    // private comparators: (param0: T, param1: T) => number[];
