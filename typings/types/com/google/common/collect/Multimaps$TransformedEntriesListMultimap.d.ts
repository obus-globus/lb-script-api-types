...
export class Multimaps$TransformedEntriesListMultimap<K extends Object | number | string | boolean, V1 extends Object | number | string | boolean, V2 extends Object | number | string | boolean> extends Multimaps$TransformedEntriesMultimap<K, V1, V2> implements ListMultimap<K, V2> {
