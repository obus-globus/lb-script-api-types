...
export class MapMakerInternalMap$WeakKeyStrongValueSegment<K extends unknown, V extends unknown> extends MapMakerInternalMap$Segment<K, V, MapMakerInternalMap$WeakKeyStrongValueEntry<K, V>, MapMakerInternalMap$WeakKeyStrongValueSegment<K, V>> {
