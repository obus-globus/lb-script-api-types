import type { RegularContiguousSet$1 } from '../../../../com/google/gson/LongSerializationPolicy$1.d.ts'
...
export class RegularContiguousSet$SerializedForm<C extends Comparable<Object>> extends Object implements Serializable {
    constructor(arg0: Range<Comparable<Object>>, arg1: DiscreteDomain<Comparable<Object>>, arg2: RegularContiguousSet$1)
    private constructor(range: Range<C>, domain: DiscreteDomain<C>)
