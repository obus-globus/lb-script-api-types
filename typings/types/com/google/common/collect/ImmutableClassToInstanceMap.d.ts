...
export class ImmutableClassToInstanceMap<B extends unknown> {
    ...
    static copyOf<B extends unknown, S extends B>(parammap: JavaMap<Class<S>, S>): JavaMap<any, any>;
    static of<B extends unknown, T extends B>(paramtype: Class<T>, paramvalue: T): JavaMap<any, any>;
