...
export class ImmutableMapEntry$NonTerminalImmutableBiMapEntry<K extends unknown, V extends unknown> extends ImmutableMapEntry$NonTerminalImmutableMapEntry<K, V> {
