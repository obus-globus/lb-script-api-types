...
export interface FilteredSetMultimap<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends FilteredMultimap<K, V>, SetMultimap<K, V>, Object{
