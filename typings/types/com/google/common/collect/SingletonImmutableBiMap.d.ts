...
export class SingletonImmutableBiMap<K extends unknown, V extends unknown> {
    ...
    static toImmutableBiMap<T extends unknown, K extends unknown, V extends unknown>(paramkeyFunction: (param0: Object) => K, paramvalueFunction: (param0: Object) => V): Collector<T, Object, JavaMap<K, V>>;
