...
export class MapMakerInternalMap$WeakKeyDummyValueEntry<K extends Object | number | string | boolean> extends MapMakerInternalMap$AbstractWeakKeyEntry<K, MapMaker$Dummy, MapMakerInternalMap$WeakKeyDummyValueEntry<K>> implements MapMakerInternalMap$StrongValueEntry<K, MapMaker$Dummy, MapMakerInternalMap$WeakKeyDummyValueEntry<K>> {
