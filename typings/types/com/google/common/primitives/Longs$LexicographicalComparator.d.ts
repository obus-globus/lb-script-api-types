...
export class Longs$LexicographicalComparator extends Enum<Longs$LexicographicalComparator> implements Comparator<number[]> {
    static INSTANCE: Longs$LexicographicalComparator;
    ...
    static valueOf(paramname: string): Longs$LexicographicalComparator;
    static values(): Longs$LexicographicalComparator[];
    private constructor()
