...
export class Booleans extends Object {
    ...
    static falseFirst(): (param0: boolean) => kotlin.Boolean;
    ...
    static lexicographicalComparator(): (param0: (Object | null)[]) => kotlin.Boolean;
    ...
    static toArray(paramcollection: E[]): (Object | null)[];
    static trueFirst(): (param0: boolean) => kotlin.Boolean;
    private constructor()
}