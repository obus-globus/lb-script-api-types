...
export class UnsignedBytes$ArraysCompareUnsignedComparator extends Enum<UnsignedBytes$ArraysCompareUnsignedComparator> implements Comparator<number[]> {
    static INSTANCE: UnsignedBytes$ArraysCompareUnsignedComparator;
    ...
    static valueOf(paramname: string): UnsignedBytes$ArraysCompareUnsignedComparator;
    static values(): UnsignedBytes$ArraysCompareUnsignedComparator[];
    private constructor()
