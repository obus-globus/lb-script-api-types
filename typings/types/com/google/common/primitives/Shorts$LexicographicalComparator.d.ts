...
export class Shorts$LexicographicalComparator extends Enum<Shorts$LexicographicalComparator> implements Comparator<number[]> {
    static INSTANCE: Shorts$LexicographicalComparator;
    static valueOf<T extends Enum<T>>(paramarg0: Class<T>, paramarg1: string): T;
    static valueOf(paramname: string): Shorts$LexicographicalComparator;
    static values(): Shorts$LexicographicalComparator[];
    private constructor()
