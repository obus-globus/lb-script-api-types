...
export class Doubles$LexicographicalComparator extends Enum<Doubles$LexicographicalComparator> implements Comparator<number[]> {
    static INSTANCE: Doubles$LexicographicalComparator;
    ...
    static valueOf(paramname: string): Doubles$LexicographicalComparator;
    static values(): Doubles$LexicographicalComparator[];
    private constructor()
