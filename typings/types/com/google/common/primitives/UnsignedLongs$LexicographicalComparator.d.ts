...
export class UnsignedLongs$LexicographicalComparator extends Enum<UnsignedLongs$LexicographicalComparator> implements Comparator<number[]> {
    static INSTANCE: UnsignedLongs$LexicographicalComparator;
    ...
    static valueOf(paramname: string): UnsignedLongs$LexicographicalComparator;
    static values(): UnsignedLongs$LexicographicalComparator[];
    private constructor()
