...
export abstract class Converter<A extends Object | number | string | boolean, B extends Object | number | string | boolean> extends Object implements Function<A, B> {
    ...
    andThen<C extends Object | number | string | boolean>(secondConverter: Converter<B, C>): Converter<A, C>;
    ...
    doAndThen<C extends Object | number | string | boolean>(secondConverter: Converter<B, C>): Converter<A, C>;
    doBackward(b: B): A;
    doForward(a: A): B;
