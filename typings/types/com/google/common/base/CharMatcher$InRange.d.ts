...
export class CharMatcher$InRange extends CharMatcher$FastMatcher {
    ...
    constructor(startInclusive: string, endInclusive: string)
    // private endInclusive: string;
    // private startInclusive: string;
