...
export class SmallCharMatcher extends CharMatcher$NamedFastMatcher {
    ...
    private constructor(table: string[], filter: number, containsZero: boolean, description: string)
    // private containsZero: boolean;
    // private filter: number;
    // private table: string[];
    // private checkFilter(c: number): boolean;
