...
export class Closer extends Object implements Closeable {
    ...
    rethrow<X extends Exception>(e: Throwable, declaredType: Class<X>): RuntimeException;
    rethrow<X1 extends Exception, X2 extends Exception>(e: Throwable, declaredType1: Class<X1>, declaredType2: Class<X2>): RuntimeException;
}