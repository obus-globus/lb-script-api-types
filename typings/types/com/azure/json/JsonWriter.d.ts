...
export abstract class JsonWriter extends Object implements Closeable {
    ...
    writeArray<T extends unknown>(arg0: T[], arg1: (param0: JsonWriter, param1: T) => void): JsonWriter;
    writeArray<T extends unknown>(arg0: T[], arg1: (param0: JsonWriter, param1: T) => void, arg2: boolean): JsonWriter;
    writeArrayField<T extends unknown>(arg0: string, arg1: T[], arg2: (param0: JsonWriter, param1: T) => void): JsonWriter;
    writeArrayField<T extends unknown>(arg0: string, arg1: T[], arg2: (param0: JsonWriter, param1: T) => void, arg3: boolean): JsonWriter;
    // private writeArrayInternal<T extends unknown>(arg0: T[], arg1: (param0: JsonWriter, param1: T) => void, arg2: string, arg3: boolean): JsonWriter;
