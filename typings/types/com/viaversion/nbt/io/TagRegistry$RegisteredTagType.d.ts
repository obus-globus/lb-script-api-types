...
export class TagRegistry$RegisteredTagType extends Object {
    private constructor(arg0: Class<T>, arg1: (param0: T, param1: DataInput, param2: TagLimiter) => unknown)
    // private supplier: (param0: Tag, param1: DataInput, param2: TagLimiter) => unknown;
