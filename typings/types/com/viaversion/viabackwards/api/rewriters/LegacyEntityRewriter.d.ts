...
export abstract class LegacyEntityRewriter<C extends ClientboundPacketType, T extends BackwardsProtocol<C, Object, Object, Object>> extends EntityRewriterBase<C, T> {
    constructor(arg0: T)
