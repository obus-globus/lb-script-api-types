...
export class BackwardsStructuredItemRewriter<C extends ClientboundPacketType, S extends ServerboundPacketType, T extends BackwardsProtocol<C, Object, Object, S>> extends StructuredItemRewriter<C, S, T> {
    ...
    eitherHolderToTag(arg0: EitherHolder<V>, arg1: (param0: V, param1: Map$Entry<string, Tag>[]) => void): Tag;
    ...
    restoreHolder(arg0: Map$Entry<string, Tag>[], arg1: string, arg2: (param0: Map$Entry<string, Tag>[]) => V): Holder<V>;
    restoreHolderData(arg0: StructuredDataKey<Holder<V>>, arg1: StructuredDataContainer, arg2: Map$Entry<string, Tag>[], arg3: (param0: Map$Entry<string, Tag>[]) => V): void;
    ...
    saveEitherHolderData(arg0: StructuredDataKey<EitherHolder<V>>, arg1: StructuredDataContainer, arg2: Map$Entry<string, Tag>[], arg3: (param0: V, param1: Map$Entry<string, Tag>[]) => void): void;
    ...
    saveHolderData(arg0: StructuredDataKey<Holder<V>>, arg1: StructuredDataContainer, arg2: Map$Entry<string, Tag>[], arg3: (param0: V, param1: Map$Entry<string, Tag>[]) => void): void;
