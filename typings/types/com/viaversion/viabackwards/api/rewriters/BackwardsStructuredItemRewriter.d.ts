...
export class BackwardsStructuredItemRewriter<C extends ClientboundPacketType, S extends ServerboundPacketType, T extends BackwardsProtocol<C, any, any, S>> extends StructuredItemRewriter<C, S, T> {
    ...
    holderToTag<V extends unknown>(arg0: Holder<V>, arg1: (param0: V, param1: Map$Entry<string, Tag>[]) => void): Tag;
    nbtTagName(): string;
    ...
    restoreEitherHolder<V extends unknown>(arg0: Map$Entry<string, Tag>[], arg1: string, arg2: (param0: Map$Entry<string, Tag>[]) => V): EitherHolder<V>;
    restoreFloatData(arg0: StructuredDataKey<number>, arg1: StructuredDataContainer, arg2: Map$Entry<string, Tag>[]): void;
    restoreHolder<V extends unknown>(arg0: Map$Entry<string, Tag>[], arg1: string, arg2: (param0: Map$Entry<string, Tag>[]) => V): Holder<V>;
    restoreHolderData<V extends unknown>(arg0: StructuredDataKey<Holder<V>>, arg1: StructuredDataContainer, arg2: Map$Entry<string, Tag>[], arg3: (param0: Map$Entry<string, Tag>[]) => V): void;
    ...
    saveEitherHolderData<V extends unknown>(arg0: StructuredDataKey<EitherHolder<V>>, arg1: StructuredDataContainer, arg2: Map$Entry<string, Tag>[], arg3: (param0: V, param1: Map$Entry<string, Tag>[]) => void): void;
    ...
    saveHolderData<V extends unknown>(arg0: StructuredDataKey<Holder<V>>, arg1: StructuredDataContainer, arg2: Map$Entry<string, Tag>[], arg3: (param0: V, param1: Map$Entry<string, Tag>[]) => void): void;
