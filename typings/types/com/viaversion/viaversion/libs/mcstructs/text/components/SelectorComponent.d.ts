...
export class SelectorComponent extends TextComponent {
    ...
    constructor(arg0: string, arg1: TextComponent)
    ...
    hashCode(): number;
    setSelector(arg0: string): SelectorComponent;
    setSeparator(arg0: TextComponent): SelectorComponent;
