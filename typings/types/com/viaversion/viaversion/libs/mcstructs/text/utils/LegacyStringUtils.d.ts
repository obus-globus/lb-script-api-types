...
export class LegacyStringUtils extends Object {
    ...
    static split(paramarg0: string, paramarg1: string, paramarg2: boolean): string[];
    static split(paramarg0: string, paramarg1: string, paramarg2: (param0: string) => TextFormatting): string[];
    constructor()
}