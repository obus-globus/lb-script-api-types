...
export class TextCodecs_v1_20_3$ComponentType extends Enum<TextCodecs_v1_20_3$ComponentType> implements TextCodecs_v1_20_3$TextComponentType {
    static KEYBIND: TextCodecs_v1_20_3$ComponentType;
    static NBT: TextCodecs_v1_20_3$ComponentType;
    static SCORE: TextCodecs_v1_20_3$ComponentType;
    static SELECTOR: TextCodecs_v1_20_3$ComponentType;
    static STRING: TextCodecs_v1_20_3$ComponentType;
    static TRANSLATION: TextCodecs_v1_20_3$ComponentType;
