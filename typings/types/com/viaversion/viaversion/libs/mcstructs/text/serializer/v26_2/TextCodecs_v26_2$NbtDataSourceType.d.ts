...
export class TextCodecs_v26_2$NbtDataSourceType extends Enum<TextCodecs_v26_2$NbtDataSourceType> implements NamedType {
    static BLOCK: TextCodecs_v26_2$NbtDataSourceType;
    static ENTITY: TextCodecs_v26_2$NbtDataSourceType;
    static STORAGE: TextCodecs_v26_2$NbtDataSourceType;
    static forDataSource(paramarg0: NbtDataSource): TextCodecs_v26_2$NbtDataSourceType;
    static valueOf<T extends Enum<T>>(paramarg0: Class<T>, paramarg1: string): T;
    static valueOf(paramarg0: string): TextCodecs_v26_2$NbtDataSourceType;
    static values(): TextCodecs_v26_2$NbtDataSourceType[];
