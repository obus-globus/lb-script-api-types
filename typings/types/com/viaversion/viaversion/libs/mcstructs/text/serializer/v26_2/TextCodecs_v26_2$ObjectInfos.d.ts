...
export class TextCodecs_v26_2$ObjectInfos extends Enum<TextCodecs_v26_2$ObjectInfos> implements NamedType {
    static ATLAS_SPRITE: TextCodecs_v26_2$ObjectInfos;
    static PLAYER_SPRITE: TextCodecs_v26_2$ObjectInfos;
    static forObjectInfo(paramarg0: ObjectComponent$ObjectInfo): TextCodecs_v26_2$ObjectInfos;
    static valueOf<T extends Enum<T>>(paramarg0: Class<T>, paramarg1: string): T;
    static valueOf(paramarg0: string): TextCodecs_v26_2$ObjectInfos;
    static values(): TextCodecs_v26_2$ObjectInfos[];
