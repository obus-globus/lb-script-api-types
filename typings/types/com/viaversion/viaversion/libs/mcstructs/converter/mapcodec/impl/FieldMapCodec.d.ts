...
export class FieldMapCodec<T extends unknown> extends Object implements MapCodec<T> {
    static UNIT: MapCodec<boolean>;
    static builder<T extends unknown>(paramarg0: Codec<T>, paramarg1: string): FieldMapCodec$Builder$Stage1<T>;
