...
export class SerializedData<T extends unknown> extends Object {
    constructor(arg0: T, arg1: DataConverter<T>)
    readonly converter: DataConverter<T>;
    readonly data: T;
    convert<S extends unknown>(arg0: DataConverter<S>): Result<S>;
    deserialize<O extends unknown>(arg0: Codec<O>): Result<O>;
