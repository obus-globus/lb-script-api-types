...
export class HashConverter_v1_21_5 extends Object implements DataConverter<HashCode> {
    ...
    asMap(arg0: HashCode): Result<JavaMap<HashCode, HashCode>>;
    asNumber(arg0: HashCode): Result<Number>;
    asString(arg0: HashCode): Result<string>;
    asStringTypeMap(arg0: HashCode): Result<JavaMap<string, HashCode>>;
    ...
    createMergedMap(arg0: JavaMap<HashCode, HashCode>): Result<HashCode>;
    createNumber(arg0: Number): HashCode;
    createShort(arg0: number): HashCode;
    createString(arg0: string): HashCode;
    createUnsafeMap(arg0: JavaMap<HashCode, HashCode>): HashCode;
    empty(): HashCode;
    emptyList(): HashCode;
    emptyMap(): HashCode;
    ...
    mergeMap(arg0: HashCode, arg1: JavaMap<HashCode, HashCode>): Result<HashCode>;
