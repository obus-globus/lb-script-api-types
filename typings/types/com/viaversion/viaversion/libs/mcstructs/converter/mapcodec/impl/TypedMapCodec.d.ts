...
export class TypedMapCodec<K extends Object | number | string | boolean, V extends Object | number | string | boolean> extends Object implements MapCodec<V> {
    ...
    asCodec(): Codec<T>;
    defaulted<T extends Object | number | string | boolean>(arg0: T): MapCodec<T>;
    defaulted(arg0: (param0: T) => kotlin.Boolean, arg1: () => T): MapCodec<T>;
    deserialize(arg0: DataConverter<S>, arg1: Map<S, S>): Result<V>;
    ...
    serialize(arg0: DataConverter<S>, arg1: Map<S, S>, arg2: V): Result<Map<S, S>>;
