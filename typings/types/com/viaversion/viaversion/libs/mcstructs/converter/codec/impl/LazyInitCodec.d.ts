...
export class LazyInitCodec<T extends unknown> extends Object implements Codec<T> {
    ...
    static identified(paramarg0: (IdentifiedType | null)[]): Codec<IdentifiedType>;
    ...
    static named(...paramarg0: (NamedType | null)[]): Codec<NamedType>;
    ...
    static oneOf(...paramarg0: Codec<Object>[]): Codec<Object>;
