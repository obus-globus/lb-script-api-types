...
export class Reference2ObjectOpenHashMap$MapEntry extends Object implements Reference2ObjectMap$Entry<K, V>, ReferenceObjectPair<K, V>, Map$Entry<K, V> {
    ...
    constructor(null_: Reference2ObjectOpenHashMap$MapEntry)
    constructor(null_: Reference2ObjectOpenHashMap$MapEntry, arg1: number)
    ...
    right<K extends Object | number | string | boolean, V extends Object | number | string | boolean>(arg0: V): ReferenceObjectPair<K, V>;
