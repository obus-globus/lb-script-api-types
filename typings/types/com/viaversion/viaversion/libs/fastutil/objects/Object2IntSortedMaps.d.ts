...
export class Object2IntSortedMaps extends Object {
    ...
    static fastIterable<K extends unknown>(paramarg0: { [key: string]: any }): Object2IntMap$Entry<K>[];
    static fastIterator<K extends unknown>(paramarg0: { [key: string]: any }): ObjectBidirectionalIterator<Object2IntMap$Entry<K>>;
