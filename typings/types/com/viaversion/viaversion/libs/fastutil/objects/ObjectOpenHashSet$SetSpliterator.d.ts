...
export class ObjectOpenHashSet$SetSpliterator extends Object implements ObjectSpliterator<K> {
    ...
    trySplit<K extends unknown>(): ObjectOpenHashSet$SetSpliterator;
}