...
export class ObjectComparators$OppositeImplicitComparator extends Object implements Serializable, Comparator<Object> {
    ...
    reversed(): (param0: Object) => kotlin.Boolean;
