...
export class IntLinkedOpenHashSet {
    ...
    static of(...paramarg0: number[]): (Object | null)[];
    static toSet(paramarg0: IntStream): (Object | null)[];
    static toSetWithExpectedSize(paramarg0: IntStream, paramarg1: number): (Object | null)[];
}