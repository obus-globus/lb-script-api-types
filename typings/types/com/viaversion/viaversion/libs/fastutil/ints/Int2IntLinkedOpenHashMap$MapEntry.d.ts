...
export class Int2IntLinkedOpenHashMap$MapEntry extends Object implements Int2IntMap$Entry, IntIntPair, Map$Entry<number, number> {
    ...
    constructor(null_: Int2IntLinkedOpenHashMap$MapEntry)
    constructor(null_: Int2IntLinkedOpenHashMap$MapEntry, arg1: number)
