...
export class Int2IntOpenHashMap$ValueIterator extends Int2IntOpenHashMap$MapIterator<(param0: number) => void> implements IntIterator {
    constructor(null_: Int2IntOpenHashMap$ValueIterator)
