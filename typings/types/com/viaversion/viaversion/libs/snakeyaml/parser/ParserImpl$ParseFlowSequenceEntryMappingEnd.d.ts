...
export class ParserImpl$ParseFlowSequenceEntryMappingEnd extends Object implements Production {
    private constructor(null_: ParserImpl$ParseFlowSequenceEntryMappingEnd)
    produce(): Event;
}