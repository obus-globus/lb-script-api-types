...
export class ParserImpl$ParseBlockSequenceFirstEntry extends Object implements Production {
    private constructor(null_: ParserImpl$ParseBlockSequenceFirstEntry)
    produce(): Event;
}