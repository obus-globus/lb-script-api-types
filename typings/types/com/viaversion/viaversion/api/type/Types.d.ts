...
export class Types extends Object {
    ...
    static BLOCK_CHANGE_ARRAY: Type<BlockChangeRecord[]>;
    ...
    static BOOLEAN_ARRAY_PRIMITIVE: Type<boolean[]>;
    ...
    static HEIGHTMAP_ARRAY: Type<Heightmap[]>;
    static HOLDER_SET: Type<HolderSet>;
    static IDENTIFIER: Type<Key>;
    static IDENTIFIER_ARRAY: Type<Key[]>;
    static INT: IntType;
    static INT_ARRAY_PRIMITIVE: Type<number[]>;
    static ITEM1_13: Type<Item>;
    static ITEM1_13_2: Type<Item>;
    static ITEM1_13_2_ARRAY: Type<Item[]>;
    static ITEM1_13_2_SHORT_ARRAY: Type<Item[]>;
    static ITEM1_13_ARRAY: Type<Item[]>;
    static ITEM1_13_SHORT_ARRAY: Type<Item[]>;
    static ITEM1_20_2: Type<Item>;
    static ITEM1_20_2_ARRAY: Type<Item[]>;
    static ITEM1_8: Type<Item>;
    static ITEM1_8_SHORT_ARRAY: Type<Item[]>;
    ...
    static NAMED_COMPOUND_TAG_ARRAY: Type<Map$Entry<string, Tag>[][]>;
    ...
    static PLAYER_MESSAGE_SIGNATURE_ARRAY: Type<PlayerMessageSignature[]>;
    ...
    static PROFILE_PROPERTY_ARRAY: Type<GameProfile$Property[]>;
    static QUATERNION: Type<Quaternion>;
    static REGISTRY_ENTRY: Type<RegistryEntry>;
    static REGISTRY_ENTRY_ARRAY: Type<RegistryEntry[]>;
    ...
    static VAR_LONG_BLOCK_CHANGE_ARRAY: Type<BlockChangeRecord[]>;
