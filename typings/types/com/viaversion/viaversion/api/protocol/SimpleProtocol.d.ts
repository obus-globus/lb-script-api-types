...
export interface SimpleProtocol extends Protocol<SimpleProtocol$DummyPacketTypes, SimpleProtocol$DummyPacketTypes, SimpleProtocol$DummyPacketTypes, SimpleProtocol$DummyPacketTypes>, Object {
    ...
    hasRegisteredClientbound(arg0: SimpleProtocol$DummyPacketTypes): boolean;
    hasRegisteredServerbound(arg0: SimpleProtocol$DummyPacketTypes): boolean;
    init(arg0: UserConnection): void;
    isBaseProtocol(): boolean;
    mappedTypes(): VersionedTypesHolder;
    register(arg0: ViaProviders): void;
    registerClientbound(arg0: SimpleProtocol$DummyPacketTypes, arg1: SimpleProtocol$DummyPacketTypes): void;
    registerClientbound(arg0: SimpleProtocol$DummyPacketTypes, arg1: SimpleProtocol$DummyPacketTypes, arg2: (param0: PacketWrapper) => void): void;
    ...
    registerServerbound(arg0: SimpleProtocol$DummyPacketTypes, arg1: SimpleProtocol$DummyPacketTypes): void;
    registerServerbound(arg0: SimpleProtocol$DummyPacketTypes, arg1: SimpleProtocol$DummyPacketTypes, arg2: (param0: PacketWrapper) => void): void;
