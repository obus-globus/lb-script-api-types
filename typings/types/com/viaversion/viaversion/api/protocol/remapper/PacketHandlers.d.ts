...
export abstract class PacketHandlers extends Object implements PacketHandler {
    ...
    create<T extends unknown>(arg0: Type<T>, arg1: T): void;
    ...
    handlersSize(): number;
    map<T extends unknown>(arg0: (param0: PacketWrapper) => T, arg1: (param0: PacketWrapper, param1: T) => void): void;
    map<T1 extends unknown, T2 extends unknown>(arg0: ValueTransformer<T1, T2>): void;
    map(arg0: Type<Object>, arg1: Type<Object>): void;
    map<T extends unknown>(arg0: Type<T>): void;
    map<T1 extends unknown, T2 extends unknown>(arg0: Type<T1>, arg1: ValueTransformer<T1, T2>): void;
    map<T1 extends unknown, T2 extends unknown>(arg0: Type<T1>, arg1: Type<T2>, arg2: (param0: T1) => T2): void;
