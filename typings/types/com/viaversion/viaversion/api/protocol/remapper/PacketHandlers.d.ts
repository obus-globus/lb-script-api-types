...
export abstract class PacketHandlers extends Object implements PacketHandler {
    ...
    handlersSize(): number;
    map(arg0: (param0: T) => unknown, arg1: (param0: T, param1: PacketWrapper) => void): void;
    map(arg0: ValueTransformer<T1, T2>): void;
    map(arg0: Type<Object>, arg1: Type<Object>): void;
    map(arg0: Type<T>): void;
    map(arg0: Type<T1>, arg1: ValueTransformer<T1, T2>): void;
    map(arg0: Type<T1>, arg1: Type<T2>, arg2: (param0: T1) => T2): void;
