...
export class DumpTemplate extends Record {
    constructor(versionInfo: VersionInfo, configuration: { [key: string]: Object }, platformDump: JsonObject, injectionDump: JsonObject, playerSample: JsonObject)
    // private configuration: { [key: string]: Object };
