...
export class ComponentRewriter1_20_5<C extends ClientboundPacketType> extends JsonNBTComponentRewriter<C> {
    ...
    bundleContentsToTag(arg0: UserConnection, arg1: Item[]): T[];
    ...
    chargedProjectilesToTag(arg0: UserConnection, arg1: Item[]): T[];
    ...
    componentsToTag(arg0: Tag[], arg1: number): T[];
    ...
    containerToTag(arg0: UserConnection, arg1: Item[]): T[];
    ...
    dataConverter(arg0: StructuredDataKey<T>): (param0: T, param1: UserConnection) => com.viaversion.nbt.tag.Tag;
    ...
    itemArrayFromTag(arg0: UserConnection, arg1: T[]): Item[];
    itemArrayToTag(arg0: UserConnection, arg1: Item[]): T[];
    ...
    potDecorationsToTag(arg0: PotDecorations): T[];
    ...
    readFromTag(arg0: UserConnection, arg1: StructuredDataKey<T>, arg2: number, arg3: Tag): StructuredData<T>;
    ...
    register(arg0: StructuredDataKey<T>, arg1: (param0: T, param1: UserConnection) => com.viaversion.nbt.tag.Tag, arg2: (param0: T, param1: UserConnection) => unknown): void;
    register(arg0: StructuredDataKey<T>, arg1: (param0: T) => com.viaversion.nbt.tag.Tag, arg2: (param0: T) => unknown): void;
    registerEmpty(arg0: StructuredDataKey<T>): void;
    ...
    suspiciousStewEffectsToTag(arg0: SuspiciousStewEffect[]): T[];
    tagConverter(arg0: StructuredDataKey<T>): (param0: T, param1: UserConnection) => unknown;
