...
export class WallConnectionHandler extends AbstractFenceConnectionHandler {
    constructor(arg0: string)
    // private getBlockFaces(arg0: UserConnection, arg1: BlockPosition): number;
    getStates(arg0: UserConnection, arg1: BlockPosition): number;
    getStates(arg0: WrappedBlockData): number;
    // private isWall(arg0: number): boolean;
    statesSize(): number;
    up(arg0: UserConnection, arg1: BlockPosition): boolean;
}