...
export class CompactArrayUtil extends Object {
    static createCompactArray(paramarg0: number, paramarg1: number, paramarg2: (param0: number) => kotlin.Long): number[];
    static createCompactArrayWithPadding(paramarg0: number, paramarg1: number, paramarg2: (param0: number) => kotlin.Int): number[];
