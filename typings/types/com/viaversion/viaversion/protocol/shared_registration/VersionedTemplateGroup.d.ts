...
export class VersionedTemplateGroup extends Record {
    constructor(action: (param0: RegistrationContext<Object, Object>) => void, min: ProtocolVersion, max: ProtocolVersion)
    // private action: (param0: RegistrationContext<Object, Object>) => void;
    // private max: ProtocolVersion;
    // private min: ProtocolVersion;
    action(): (param0: RegistrationContext<Object, Object>) => void;
