...
export class PacketWrapperImpl extends Object implements PacketWrapper {
    ...
    // private attemptTransform<T extends unknown>(arg0: Type<T>, arg1: Object): T;
    cancel(): void;
    ...
    // private pollReadableObject<T extends unknown>(arg0: Type<T>): PacketWrapperImpl$PacketValue<T>;
    read<T extends unknown>(arg0: Type<T>): T;
    // private readFromBuffer<T extends unknown>(arg0: Type<T>): T;
    resetReader(): void;
