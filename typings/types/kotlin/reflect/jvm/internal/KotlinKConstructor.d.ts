...
export class KotlinKConstructor extends KotlinKFunction {
    constructor(container: KDeclarationContainerImpl, signature: string, rawBoundReceiver: Object | null, kmConstructor: KmConstructor)
