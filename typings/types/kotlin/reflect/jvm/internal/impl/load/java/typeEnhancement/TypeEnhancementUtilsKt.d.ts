...
export class TypeEnhancementUtilsKt extends Object {
    static computeQualifiersForOverride(paramarg0: JavaTypeQualifiers, paramarg1: JavaTypeQualifiers[], paramarg2: boolean, paramarg3: boolean, paramarg4: boolean): JavaTypeQualifiers;
