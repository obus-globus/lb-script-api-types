...
export class JvmAnnotationNames extends Object {
    static DEFAULT_ANNOTATION_MEMBER_NAME: Name;
    static DEPRECATED_ANNOTATION: FqName;
    static DOCUMENTED_ANNOTATION: FqName;
    ...
    static MUTABLE_ANNOTATION: FqName;
    static OVERRIDE_ANNOTATION: FqName;
    static PURELY_IMPLEMENTS_ANNOTATION: FqName;
    static READONLY_ANNOTATION: FqName;
