...
export class SpecialGenericSignatures$Companion extends Object {
    ...
    getJVM_SHORT_NAME_TO_BUILTIN_SHORT_NAMES_MAP(): JavaMap<Name, Name>;
    getORIGINAL_SHORT_NAMES(): Name[];
    getREMOVE_AT_NAME_AND_SIGNATURE(): SpecialGenericSignatures$Companion$NameAndSignature;
    getSIGNATURE_TO_DEFAULT_VALUES_MAP(): JavaMap<string, SpecialGenericSignatures$TypeSafeBarrierDescription>;
    getSIGNATURE_TO_JVM_REPRESENTATION_NAME(): JavaMap<string, Name>;
