...
export class SmallSortedMap$Entry{
    constructor(null_: JavaMap<Comparable<K>, Object>, arg1: Comparable<K>, arg2: Object)
    constructor(null_: JavaMap<Comparable<K>, Object>, arg1: Map$Entry<Comparable<K>, Object>)
    readonly key: K;
    readonly key: K;
    readonly value: V;
    readonly value: V;
