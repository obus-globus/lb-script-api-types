...
import type { ProtoBuf$Contract$Builder } from '../../../../../../kotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Contract$Builder.d.ts'
...
export class ProtoBuf$Contract extends GeneratedMessageLite implements ProtoBuf$ContractOrBuilder {
    static PARSER: Parser<ProtoBuf$Contract>;
    static getDefaultInstance(): ProtoBuf$Contract;
    static newBuilder(): ProtoBuf$Contract$Builder;
    static newBuilder(paramarg0: ProtoBuf$Contract): ProtoBuf$Contract$Builder;
    ...
    getEffectList(): ProtoBuf$Effect[];
    getParserForType(): Parser<ProtoBuf$Contract>;
    getSerializedSize(): number;
    // private initFields(): void;
    isInitialized(): boolean;
    newBuilderForType(): ProtoBuf$Contract$Builder;
    toBuilder(): ProtoBuf$Contract$Builder;
