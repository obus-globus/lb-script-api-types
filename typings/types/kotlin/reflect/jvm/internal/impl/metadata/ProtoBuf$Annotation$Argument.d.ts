...
export class ProtoBuf$Annotation$Argument extends GeneratedMessageLite implements ProtoBuf$Annotation$ArgumentOrBuilder {
    static PARSER: Parser<ProtoBuf$Annotation$Argument>;
    static getDefaultInstance(): ProtoBuf$Annotation$Argument;
    static newBuilder(): ProtoBuf$Annotation$Argument$Builder;
    ...
    getNameId(): number;
    getParserForType(): Parser<ProtoBuf$Annotation$Argument>;
    ...
    newBuilderForType(): ProtoBuf$Annotation$Argument$Builder;
    toBuilder(): ProtoBuf$Annotation$Argument$Builder;
