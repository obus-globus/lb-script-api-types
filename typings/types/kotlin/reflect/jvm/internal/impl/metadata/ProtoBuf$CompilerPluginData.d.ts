...
export class ProtoBuf$CompilerPluginData extends GeneratedMessageLite implements ProtoBuf$CompilerPluginDataOrBuilder {
    static PARSER: Parser<ProtoBuf$CompilerPluginData>;
    static getDefaultInstance(): ProtoBuf$CompilerPluginData;
    static newBuilder(): ProtoBuf$CompilerPluginData$Builder;
    static newBuilder(paramarg0: ProtoBuf$CompilerPluginData): ProtoBuf$CompilerPluginData$Builder;
    ...
    getParserForType(): Parser<ProtoBuf$CompilerPluginData>;
    getPluginId(): number;
    ...
    newBuilderForType(): ProtoBuf$CompilerPluginData$Builder;
    toBuilder(): ProtoBuf$CompilerPluginData$Builder;
