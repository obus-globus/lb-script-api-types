...
export class InlineClassesUtilsKt extends Object {
    static isGetterOfUnderlyingPropertyOfValueClass(paramarg0: CallableDescriptor): boolean;
    ...
    static isUnderlyingPropertyOfValueClass(paramarg0: VariableDescriptor): boolean;
    static isValueClass(paramarg0: DeclarationDescriptor): boolean;
    static isValueClassType(paramarg0: KotlinType): boolean;
