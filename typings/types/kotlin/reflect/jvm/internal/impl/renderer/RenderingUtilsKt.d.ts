...
export class RenderingUtilsKt extends Object {
    ...
    static renderFlexibleMutabilityOrArrayElementVarianceType(paramarg0: string, paramarg1: string, paramarg2: () => string, paramarg3: () => string, paramarg4: (param0: Object | null) => string): string;
