...
export class NullableArrayMapAccessor<K extends unknown, V extends unknown, T extends V> extends AbstractArrayMapOwner$AbstractArrayMapAccessor<K, V, T> implements ReadOnlyProperty<V[], V> {
