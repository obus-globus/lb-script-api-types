...
import type { EnumEntrySyntheticClassDescriptor } from '../../../../../../../kotlin/reflect/jvm/internal/impl/descriptors/impl/EnumEntrySyntheticClassDescriptor.d.ts'
...
export class EnumEntrySyntheticClassDescriptor$EnumEntryScope extends MemberScopeImpl {
    ...
    constructor(null_: EnumEntrySyntheticClassDescriptor, arg1: StorageManager)
