...
export class DescriptorKMutableProperty1$Setter<T extends Object | number | string | boolean, V extends Object | number | string | boolean> extends DescriptorKProperty$Setter<V> implements KMutableProperty1$Setter<T, V> {
