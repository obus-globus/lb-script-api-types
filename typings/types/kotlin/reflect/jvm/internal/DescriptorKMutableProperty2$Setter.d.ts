...
export class DescriptorKMutableProperty2$Setter<D extends Object | number | string | boolean, E extends Object | number | string | boolean, V extends Object | number | string | boolean> extends DescriptorKProperty$Setter<V> implements KMutableProperty2$Setter<D, E, V> {
