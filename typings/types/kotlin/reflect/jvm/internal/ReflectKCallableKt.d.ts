...
export class ReflectKCallableKt extends Object {
    static callAnnotationConstructor<R extends unknown>(self: ReflectKCallable<R>, args: JavaMap<KParameter, Object | null>): R;
    static callDefaultMethod<R extends unknown>(self: ReflectKCallable<R>, args: JavaMap<KParameter, Object | null>, continuationArgument: Continuation<Object> | null): R;
