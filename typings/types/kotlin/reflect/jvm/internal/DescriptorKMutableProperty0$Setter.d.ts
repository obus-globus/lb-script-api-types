...
export class DescriptorKMutableProperty0$Setter<R extends Object | number | string | boolean> extends DescriptorKProperty$Setter<R> implements KMutableProperty0$Setter<R> {
