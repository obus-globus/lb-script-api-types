...
export class DescriptorKProperty0<V extends Object | number | string | boolean> extends DescriptorKProperty<V> implements KProperty0<V> {
    ...
    // private _getter: Lazy<DescriptorKProperty0$Getter<V>>;
