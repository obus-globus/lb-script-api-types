...
export interface KMutableProperty2<D extends Object | number | string | boolean, E extends Object | number | string | boolean, V extends Object | number | string | boolean> extends Object, KMutableProperty<V>, KProperty2<D, E, V>{
