...
export class ComparisonsKt___ComparisonsKt extends ComparisonsKt___ComparisonsJvmKt {
    ...
    static maxOf<T extends unknown>(a: T, b: T, c: T, comparator: (param0: T, param1: T) => number): T;
    static maxOf<T extends unknown>(a: T, b: T, comparator: (param0: T, param1: T) => number): T;
    static maxOf<T extends unknown>(a: T, other: T[], comparator: (param0: T, param1: T) => number): T;
    ...
    static minOf<T extends unknown>(a: T, b: T, c: T, comparator: (param0: T, param1: T) => number): T;
    static minOf<T extends unknown>(a: T, b: T, comparator: (param0: T, param1: T) => number): T;
    static minOf<T extends unknown>(a: T, other: T[], comparator: (param0: T, param1: T) => number): T;
