...
export class UCollectionsKt extends UCollectionsKt___UCollectionsKt {
    ...
    static toUByteArray(paramarg0: E[]): number[];
    static toUIntArray(paramarg0: E[]): number[];
    static toULongArray(paramarg0: E[]): number[];
    static toUShortArray(paramarg0: E[]): number[];
}