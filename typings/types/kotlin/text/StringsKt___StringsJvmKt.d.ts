...
export class StringsKt___StringsJvmKt extends StringsKt__StringsKt {
    ...
    static maxBy(paramarg0: CharSequence, paramarg1: (param0: Object | null) => Object | null): string;
    static maxWith(paramarg0: CharSequence, paramarg1: (param0: Object | null) => kotlin.Boolean): string;
    static min(paramarg0: CharSequence): string;
    static minBy(paramarg0: CharSequence, paramarg1: (param0: Object | null) => Object | null): string;
    static minWith(paramarg0: CharSequence, paramarg1: (param0: Object | null) => kotlin.Boolean): string;
