...
// (invalid TS: name contains '-')     static compareTo-6eNON_k(other: TimeSource$Monotonic$ValueTimeMark): number;
...
// (invalid TS: name contains '-')     static elapsedNow-UwyO8pc(): Duration;
...
// (invalid TS: name contains '-')     static hasNotPassedNow-impl(): boolean;
// (invalid TS: name contains '-')     static hasPassedNow-impl(): boolean;
// (invalid TS: name contains '-')     static hashCode-impl(paramarg0: number): number;
// (invalid TS: name contains '-')     static minus-6eNON_k(other: TimeSource$Monotonic$ValueTimeMark): Duration;
// (invalid TS: name contains '-')     static minus-LRDsOJo(duration: Duration): TimeSource$Monotonic$ValueTimeMark;
// (invalid TS: name contains '-')     static minus-UwyO8pc(other: ComparableTimeMark): Duration;
// (invalid TS: name contains '-')     static plus-LRDsOJo(duration: Duration): TimeSource$Monotonic$ValueTimeMark;
