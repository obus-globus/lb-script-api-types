...
export class ObjectName extends Object implements QueryExp, Comparable<ObjectName> {
    ...
    static getInstance(paramarg0: string, paramarg1: JavaMap<string, string>): ObjectName;
    ...
    // private _propertyList: JavaMap<string, string>;
    // private _getKeyPropertyList(): JavaMap<string, string>;
    // private addProperty(arg0: ObjectName$Property, arg1: number, arg2: JavaMap<string, ObjectName$Property>, arg3: string): void;
    apply(arg0: ObjectName): boolean;
    compareTo(arg0: ObjectName): number;
    // private construct(arg0: string): void;
    // private construct(arg0: string, arg1: JavaMap<string, string>): void;
    ...
    getKeyPropertyList(): JavaMap<string, string>;
    ...
    // private setCanonicalName(arg0: string[], arg1: string[], arg2: string[], arg3: JavaMap<string, ObjectName$Property>, arg4: number, arg5: number): void;
